...
```
mbx run -p omega -- --build-dir samples/cli/systems/logger/build --target windows_x86_64 samples/cli/systems/logger/main.omg
./samples/cli/systems/logger/build/omega-program.exe
echo $?   # 70
```
