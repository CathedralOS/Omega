...
: "${OMEGA_PATH_ALPHA_ASSEMBLER_RUST:=$OMEGA_PATH_ON_RAMP_ROOT/rust/alpha-assembler}"
: "${OMEGA_PATH_BETA:=$OMEGA_PATH_SOURCE_ROOT/beta}"
: "${OMEGA_PATH_BETA_RUST:=$OMEGA_PATH_ON_RAMP_ROOT/rust/beta}"
...
: "${OMEGA_PATH_DELTA_RUST:=$OMEGA_PATH_ON_RAMP_ROOT/rust/delta}"
