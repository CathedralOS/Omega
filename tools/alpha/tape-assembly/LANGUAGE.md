# Alpha Tape Assembly language and encoding

This document defines the source language whose deterministic encoding produces
an Alpha bytecode payload. [`source/alpha/SEMANTICS.md`](../../../source/alpha/SEMANTICS.md)
defines execution of that payload; Alpha Tape Assembly defines only the
