...
OMEGA_PATH_DELTA_VALIDATION=$OMEGA_PATH_DELTA_COMPILER/validation
...
OMEGA_PATH_LATTICE_CORPUS=$OMEGA_PATH_LATTICE_TEST_ROOT/corpus
...
export OMEGA_PATH_DELTA_VALIDATION OMEGA_PATH_DELTA_MEANING
export OMEGA_PATH_OMEGA OMEGA_PATH_OMEGA_PSI
export OMEGA_PATH_ALPHA_CHECKER OMEGA_PATH_LATTICE_CORPUS
...
lattice_path() {
  case "$1" in
    ...
    delta-validation) printf '%s\n' "$OMEGA_PATH_DELTA_VALIDATION" ;;
    omega) printf '%s\n' "$OMEGA_PATH_OMEGA" ;;
