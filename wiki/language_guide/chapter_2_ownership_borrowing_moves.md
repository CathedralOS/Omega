...
padding. Fully specialized type plus scalar-integer `const` record instances
participate under their exact synthesized symbol, validated carrier/value
origin, and substituted-field eligibility. Runtime or merely bounded offsets,
slices, total zero-size targets, open/unresolved or structured-const/lifetime/
machine/proposition generic instances, and invariant-bearing/erased/cased
records remain conservative. Last-use accounting compares the canonical
