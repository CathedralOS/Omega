...
The complete package model is design-blocked on `OWNER_QUESTIONS.md` Q14. Its
...
inserted into an author-owned namespace. Q14 must settle the exact canonical
...
`OWNER_QUESTIONS.md` Q14. Generic package application is design-blocked on Q12.
Explicit discard is design-blocked on Q13.
...
The intended guarded shape below remains illustrative pending Q14.
