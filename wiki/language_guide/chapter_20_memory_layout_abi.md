...
plan entry. Third through sixth represented record levels are now available
under the same restrictions. All six enclosing identities remain in each
erased-leaf path, and bounded complete-descendant replay rejects hidden
unsupported custody. A seventh represented record level, structurally
