...
plan entry. Third through ninth represented record levels are now available
under the same restrictions. All nine enclosing identities remain in each
erased-leaf path, and bounded complete-descendant replay rejects hidden
unsupported custody. A tenth represented record level, structurally
