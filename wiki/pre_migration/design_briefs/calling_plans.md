# Calling-plan material awaiting consolidation

> **Needs porting.** The boundary contract now lives in
> [calling plans](../../spec/build/calling_plans.md),
> [boundary shapes](../../spec/build/boundary_shapes.md), and
> [machine-state evidence](../../spec/build/machine_state_evidence.md).
> The sections below still need review for duplication, implementation history,
> and useful material not yet ported. They are not an alternate specification.
...
## Remaining implementation material

Normalized plan and policy evaluation details now live beside
[calling conventions](../../../omega-rust/omega/representations/calling-conventions/README.md).
Final footprint replay has a separate
[implementation-status note](../../../omega-rust/omega/backend/images/image/footprint_replay.md);
the old route's certificate implementation does not establish production coverage.
