...
which admission checks once and lowering retains. Its current reusable grant is
...
and exclusivity, destructive external reads remain distinct, external compound
mutation is unavailable, and atomic permissions distinguish exact operation
families. See
