...
Third through tenth represented record levels are also live under the same
...
shape could hide erased custody. This is ordinary conformance checking only; an
eleventh represented record level, zero-layout wrappers, arrays, generic,
