...
- and the modular environment-premise surface in `OWNER_QUESTIONS.md` #7.
...
composition rules for those premises remain owner question #7.
...
`OWNER_QUESTIONS.md` #2. Blocking creates no safe point; absent a finite wait
...
- Normalized bounded-work plan after owner question #2.
