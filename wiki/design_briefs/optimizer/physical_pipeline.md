...
Its first eighteen families reconstruct parameterless straight-line integer and
...
bitwise-AND, bitwise-OR, bitwise-XOR, wrapping-add, or wrapping-subtract of two
same-type integer parameters, without
