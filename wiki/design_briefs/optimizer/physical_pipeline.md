...
Its first nineteen families reconstruct parameterless straight-line integer and
...
bitwise-AND, bitwise-OR, bitwise-XOR, wrapping-add, wrapping-subtract, or
wrapping-multiply of two same-type integer parameters, without
...
while integer bitwise-not, bitwise-AND, bitwise-OR, bitwise-XOR, wrapping-add,
wrapping-subtract, and wrapping-multiply retain
