...
to twenty-five unary, binary, primitive-cast, member-projection, or indexing shells
under that same call budget. A twenty-sixth shell or a generic, reference-valued,
