...
to twenty-four unary, binary, primitive-cast, member-projection, or indexing shells
under that same call budget. A twenty-fifth shell or a generic, reference-valued,
