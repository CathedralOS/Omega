...
to twenty-six unary, binary, primitive-cast, member-projection, or indexing shells
under that same call budget. A twenty-seventh shell or a generic, reference-valued,
