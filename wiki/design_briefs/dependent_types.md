...
to twenty-eight unary, binary, primitive-cast, member-projection, or indexing shells
under that same call budget. A twenty-ninth shell or a generic, reference-valued,
