...
to thirty-three unary, binary, primitive-cast, member-projection, or indexing shells
under that same call budget. A thirty-fourth shell or a generic, reference-valued,
