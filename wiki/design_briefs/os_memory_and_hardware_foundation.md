...
indexed, and frame-indexed machine-storage AArch64 shapes, with exact rodata
and storage/index relocation identity.
...
`omega.final-footprint-certificate` format v61, with a domain-separated
