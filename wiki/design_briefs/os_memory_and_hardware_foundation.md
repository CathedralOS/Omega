...
direct, pointee, frame-indexed, inline-frame-indexed, and frame-indexed machine-
storage AArch64 shapes, with exact rodata and storage/index relocation identity.
...
`omega.final-footprint-certificate` format v60, with a domain-separated
