...
direct unsigned two-runtime Exact-subtract bound, and current v47 adds its
signed nonnegative-subtrahend lower-bound form.
...
validation, and fuel cover the complete v47 row. Artifact-root native lowering
