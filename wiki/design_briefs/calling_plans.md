...
Final footprint certificate format v60 now retains an exact
...
and the direct, pointee, frame-indexed, inline-frame-indexed, and frame-indexed
machine-storage AArch64 shapes, including exact rodata and storage/index
relocations plus a separate `CompilerBodyPlaceStringWrite` footprint. Immediate bounded-buffer
