...
Final footprint certificate format v24 now retains an exact
...
runtime-indexed machine-array elements. Their `Ordinary` role remains distinct
from hidden-result copies; final validation replays the exact target encoder
