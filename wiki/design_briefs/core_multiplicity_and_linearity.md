...
and five under one exact rule. A claim-free, unqualified affine
...
length-five successor therefore carries eight no-code residuals while retaining
the same five call/return fuel units. Inner length six, another outer length,
