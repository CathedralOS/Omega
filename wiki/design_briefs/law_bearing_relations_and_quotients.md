...
distinct selected terms once each as dense ordered named requirements of one
direct tail state.
...
projections, thirteen-or-more arguments, repeated term use, later invalidation,
