...
one, two, three, four, five, six, seven, eight, or nine distinct selected terms
once each as dense ordered named requirements of one direct tail state. The tail accepts
only the saved whole result and returns it unchanged. Terminal retains the tail as a third,
...
call or fuel. Payload projections, ten-or-more arguments, repeated term use,
