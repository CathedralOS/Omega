...
thirteen, or fourteen distinct selected terms once each as dense ordered named requirements
of one direct tail state.
...
projections, fifteen-or-more arguments, repeated term use, later invalidation,
