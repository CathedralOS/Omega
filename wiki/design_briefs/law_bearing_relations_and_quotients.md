...
thirteen, fourteen, or fifteen distinct selected terms once each as dense
ordered named requirements of one direct tail state.
...
projections, sixteen-or-more arguments, repeated term use, later invalidation,
