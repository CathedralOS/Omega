...
Continue with the remaining quotient, ownership, concurrency, and optimizer references
...
Next: consolidate the remaining quotient, ownership, and concurrency references. Complete
