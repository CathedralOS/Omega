...
| `04_selected-instructions-to-selected-instructions/src/rewrites/allocation_recovery/mod.rs` | `selected_allocation_recovery_rule` | `05_selected-instructions-to-register-homes/src/register_allocation.rs` |
| `09_resolved-layout-to-resolved-layout/src/x86_branch_relaxation/mod.rs` | `stage_optimized_x86_branch_relaxation` | `09_resolved-layout-to-resolved-layout/src/phase.rs` |
...
| `StagedOptimizedPostAllocationMachinePlan` | omega/pipeline/06_register-homes-to-post-allocation-machine | 0 | — | — | — |
