...
and checker depth/time, and remaining uncertainty. Until then, the existing
encoder plan's pause on isolated helper/provision expansion remains. Independent
bootstrap work can continue; small proof successes are not new authorization.
