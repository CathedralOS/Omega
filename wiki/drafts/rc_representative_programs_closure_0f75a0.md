...
Status: narrow re-verification of the representative-programs matrix row at
`0f75a052f0` (linux x86-64, cargo — no mbx). Gate remains OPEN (red); the two
probed single-test legs confirm the recorded failure families are unchanged.
