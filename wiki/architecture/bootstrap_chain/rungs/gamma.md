...
[`bootstrap/2_gamma/LANGUAGE.md`](../../../../bootstrap/2_gamma/LANGUAGE.md). Its customers
...
The selected addressed Beta source is 46,484 bytes. Its AlphaBootstrapV4 heap
...
Exact function lookup uses a sorted pointer index inside the private
`0x04000000..0x04300000` partition. Its 65,536-function limit admits generated
Delta helpers beyond the former 4,096-row ceiling. Authored row order and
application-marker ownership are unchanged; the evaluator still retains no AST.
