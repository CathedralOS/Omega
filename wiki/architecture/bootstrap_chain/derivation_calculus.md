...
checks conservative definitions under a bounded component profile. Ground-term
validation, explicit derivations, the complete checker soundness argument, and
