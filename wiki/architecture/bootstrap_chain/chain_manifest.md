...
| Gamma evaluator | Beta source | `gamma_evaluator_bytecode.tape` | provisional 1,314-line typed scalar/effect evaluator; 6,880-byte tape; static validation, 100,000-step proper tails, provenance-tagged immutable pairs, readable character literals, and self-augmentation pass |
