...
| --- | --- | --- | --- |
| Alpha VM | audited native source/listing per host | Alpha execution | AlphaBootstrapV3 macOS arm64 and Windows x86-64 seeds retained; 33 macOS conformance checks and native-source reconstruction pass; Windows runtime unvalidated |
...
| --- | --- | --- |
| Darwin arm64 | `bootstrap/alpha/alpha_arm64_macos` | `bdc2bef146167e5ce0b975608b1d28b433a558932198a870ec05695a947f4cac` |
| Windows x86-64 | `bootstrap/alpha/alpha_x64_windows.exe` | `0b6c9b5375c5fe21bc89b178af2eaa10d54712986cbdd4335f504d58a51030ec` |
