...
| Delta compiler | Gamma source transformer to canonical Gamma | exact `GammaComposedV1` identity and staged receipts | 1,457-line stage enforces source bytes, lexical atoms, global declarations, lexical local scopes, exact function resolution/arity, capture-proof lowering names, and recursive ADTs; List, rope, and 3,001-function witnesses pass; normative Bytes and complete type checking remain open |
