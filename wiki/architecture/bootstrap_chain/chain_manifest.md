...
| Delta compiler | Gamma source transformer to canonical Gamma | exact `GammaComposedV1` identity and staged receipts | 1,276-line stage enforces source bytes, lexical atoms, global declarations, exact function resolution/arity, builtin-safe name lowering, and recursive ADTs; List, rope, and 3,001-function witnesses pass; normative Bytes and complete checking remain open |
