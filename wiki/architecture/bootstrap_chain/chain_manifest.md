...
| Delta compiler | Gamma application to canonical Gamma | exact `GammaComposedV1` identity and staged receipts | 2,236-line canonical entry plus 14 shared manifested members; catalogs exact nominal/function metadata in sparse tries and checks source bytes, declarations, scalar/Bytes/nominal scopes and types, signatures, exhaustive matches, checked arithmetic, immutable Bytes ropes, and proper tails; strict DCREQ admission publishes exact malformed-request, unknown-profile, and source-provision DCOUT frames; ConformanceBytesV1 executes; frontend/schema and later resource/internal DCOUT outcomes remain open |
