...
| Epsilon evaluator | Delta source executed through the selected lower route | interpreted Epsilon behavior | incomplete `bootstrap/epsilon/compiler/epsilon_compiler.delta`; complete checking and empty-entry execution slice pass; final composition absent |
