...
| Delta compiler | Gamma source transformer to canonical Gamma | exact `GammaComposedV1` identity and staged receipts | 1,192-line stage enforces source bytes, identifiers, reserved names, literal range, and global declaration shape/uniqueness while lowering recursive ADTs; List, rope, and 3,001-function witnesses pass; normative Bytes and complete checking remain open |
