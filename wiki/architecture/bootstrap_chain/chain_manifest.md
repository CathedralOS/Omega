...
| Gamma evaluator | Beta source | `gamma_evaluator_bytecode.tape` | provisional 1,472-line typed scalar/effect evaluator; 8,119-byte tape; static validation, 100,000-step proper tails, immutable pairs, readable character literals, and self-augmentation pass |
