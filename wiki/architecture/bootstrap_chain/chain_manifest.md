...
| Delta compiler | Gamma application to canonical Gamma | exact `GammaComposedV1` identity and staged receipts | 2,378-line composition of the canonical entry and 16 shared manifested members; source envelope and complete lexical admission precede global identity census, declaration types, and body checking, with application schema last; downstream numeric checks consume lexical admission; scalar/Bytes/nominal checking and emission execute; strict DCREQ, source-byte (3), invalid token spelling (partial syntax code 4), integer range (5), duplicate identity (6/7/8), missing-main (19), and schema (20) failures publish owned DCOUT; structural syntax/type/body failures still use unpublished Gamma 249; remaining frontend and resource/internal outcomes and edge closure remain open |
