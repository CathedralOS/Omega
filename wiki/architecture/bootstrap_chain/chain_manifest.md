...
| Delta compiler | Gamma source transformer to canonical Gamma | exact `GammaComposedV1` identity and staged receipts | 1,821-line stage enforces source bytes, global declarations, scalar/nominal scopes and types, exact signatures, capture-proof names, recursive ADTs, checked signed arithmetic, and proper tails; arithmetic boundaries, 100,000-node, rope, and 3,001-function witnesses pass; normative Bytes, application profiles, and failure closure remain open |
