...
| Delta compiler | Gamma application to canonical Gamma | exact `GammaComposedV1` identity and staged receipts | 2,326-line composition of the canonical entry and 15 shared manifested members; complete global identity census precedes declaration types and body checking, with application schema last; scalar/Bytes/nominal checking and emission execute; strict DCREQ, source-byte (3), duplicate identity (6/7/8), missing-main (19), and schema (20) failures publish owned DCOUT; other syntax/type/body failures still use unpublished Gamma 249; remaining frontend and resource/internal outcomes and edge closure remain open |
