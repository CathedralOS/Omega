...
SSA equality for that literal. Reconstruction still selects the legacy
sufficient proposition, so no producer, reducer, or operation row is promoted
by this proof-calculus capability alone.
