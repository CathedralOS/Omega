...
Terminal-module validation likewise has a 4,765-line parent, down from 7,498,
over separate structural/service foundation (956 lines), public error
vocabulary (803), content-conservation validation/replay (534),
evidence/proposition custody (410), and call-graph acyclicity (68) modules. The
public validation vocabulary remains re-exported at the crate boundary.
