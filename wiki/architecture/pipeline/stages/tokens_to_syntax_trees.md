...
- `parser/machine/clauses.rs` owns machine `satisfies`, `terminates;`,
  `terminates by ...;`, `effects`, `requires`, and `ensures` clauses. Decision
  23's block form and standalone direction clauses are hard parser errors.
