...
| Delta compiler | Gamma | exact Gamma source under `DeltaCompilerV1` refines the exact Delta-compiler tape | D17 fixes Delta v1 and its `DCOUT` boundary, D22/D24/D36 fix declaration and callable identity, D31 fixes structural type formation, D34 fixes bounded-witness storage refusal, and D37 fixes body/control premise composition; incomplete source owns syntax, the source-shaped census, structural type formation, a source-backed resolution catalog, ordered local resolution, scalar/aggregate value-place facts, and symbolic encoding, while Q4-blocked entry diagnostics, Q6 `.as_slice` receiver validity, D36/D37 enforcement, remaining body/control checking, storage implementation, lowering, tape, executable suite, and refinement remain open |
