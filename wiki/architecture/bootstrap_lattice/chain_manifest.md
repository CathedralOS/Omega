...
| Gamma compiler | Beta | exact Beta source refines the exact Gamma-compiler tape | D16 fixes the language and D19 fixes its sealed application profiles; incomplete source exists, while adapter emission, lowering, tape, and refinement remain open |
