...
| Delta compiler | Gamma | exact Gamma source under `DeltaCompilerV1` refines the exact Delta-compiler tape | D17 fixes Delta v1 and its `DCOUT` boundary, D22/D24 fix declaration identity, and D31 fixes structural type formation; incomplete source owns syntax, the source-shaped census, structural type formation, and symbolic encoding, while Q5-blocked entry diagnostics, body/control checking, Q4-blocked storage refusal, lowering, tape, executable suite, and refinement remain open |
