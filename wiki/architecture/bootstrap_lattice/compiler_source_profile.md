...
| ordinary named record fields | presumptively retain | the frontend probe and closed CKIR3 constant tranche establish checking, layout, aggregate copy, and exact artifact evidence; CKIR4 freezes the still-open runtime construction/structural Call/Copy cost needed by `source.omg`, after which compare the complete cost with the clarity and regularity loss from positional compiler data |
