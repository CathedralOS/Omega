...
| direct full-width `u32 in Trapping` subtraction | presumptively retain; selected lower-rooted cost closed | checkpoint 000001 has 15 authored subtractions: OMGRSW5/OMGLOWE/CKIR13 and OMGRFN15 close the two direct leaf-minus-leaf and four direct leaf-minus-literal forms in assignment, guard, call, and transition contexts, with exact `0..=4294967295` custody, independent reference meaning, Rust-free Gamma publication, runtime underflow, least-version behavior, conservative `sub`/borrow-trap emission, and byte-complete persisted-Beta R1–R5 reconstruction; nine UTF-8 subtractions nested inside multiplication/addition remain outside |
...
| direct full-width `u32 in Trapping` subtraction | OMGRSW5, OMGLOWE/CKIR13, Rust-free Gamma publication, conservative backend, and OMGRFN15 R1–R5 | [`OMEGA_BOOTSTRAP_RESOLUTION_V5.md`](../../../bootstrap/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_RESOLUTION_V5.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V13.md`](../../../bootstrap/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V13.md), and [`OMGCOMP_REFINEMENT_WITNESS_V15.md`](../../../bootstrap/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V15.md) |
