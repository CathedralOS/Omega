...
the Delta rung's
[`FEATURE_LEDGER.md`](../../../source/delta/FEATURE_LEDGER.md).
...
| ordinary named record fields | presumptively retain; selected TokenStream cost closed | the frontend probe and CKIR3/CKIR4 establish nominal layout, aggregate copy, runtime named construction, and direct fields. OMGRSWC12/OMGLOWL21/CKIR20/OMGRFN23 now carry the exact eight-record TokenStream owner, independently derived nested layouts, two structural record/sum copies, fifteen selected data writes, and nested `source.value` readback without positional source data. Compare remaining general coverage with the clarity and regularity loss from positional compiler data |
| fixed arrays and checked indexing | presumptively retain; selected guarded full-`u64` TokenStream cost closed | OMGRSWC12/OMGLOWL21/CKIR20/OMGRFN23 close the actual `[Token; 16384]`, `[TokenObservation; 16384]`, and `[u8; 65536]` owner through guarded full-width indexing, exact strides/layouts, semantic active-payload Copy, authored Exact count increment, modular Rust-free meaning, defensive checked-IR traps, exact conservative artifacts, native/self variants, resources, and lower-rooted R1–R5. This subsumes the preceding record-array cost but not computed/effectful indexes, mutable slices, general allocation, or the full lexer `push_token` roster |
...
| payload-bearing enums/sum data | presumptively retain; selected pure-copyable cost closed | OMGRSWC12/CKIR20/OMGRFN23 close five unnumbered nongeneric pure-sum families, 105 declaration-order cases, eight active payload leaves, semantic aliased Copy, constructors, and exhaustive indexed `TokenKind::Float(true,false,true)` dispatch. Compare remaining general syntax/IR modeling with explicit-tag records; splitting is a cost option, not a prior ruling. Explicit discriminants, generic/mixed sums, sum equality, and noncopy payload ownership remain separate |
...
| --- | --- | --- |
| finite calls, constant aggregates, runtime named records, and same-module direct-field receivers | source production through CKIR4, Rust-free meaning, conservative artifacts, and lower-rooted reconstruction | [`SOURCE_CUSTODY_FRONTEND_PROBE.md`](../../../source/on-ramp/omega-bootstrap/compiler/SOURCE_CUSTODY_FRONTEND_PROBE.md) and versioned checked-IR contracts under [`source/on-ramp/omega-bootstrap/compiler/`](../../../source/on-ramp/omega-bootstrap/compiler/) |
| payload-bearing pure sums | OMGRSW3, CKIR5, conservative backend, and OMGRFN7 R1–R5 | versioned checked-IR contracts and [`OMGCOMP_REFINEMENT_WITNESS_V7.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V7.md) |
| bool-only logical negation | CKIR6 and OMGRFN8 R1–R5 | [`OMEGA_BOOTSTRAP_CHECKED_IR_V6.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V6.md) and [`OMGCOMP_REFINEMENT_WITNESS_V8.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V8.md) |
| pure, total, nontrapping bool-only `&&` and `||` | CKIR7 and OMGRFN9 R1–R5 | [`OMEGA_BOOTSTRAP_CHECKED_IR_V7.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V7.md) and [`OMGCOMP_REFINEMENT_WITNESS_V9.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V9.md) |
| exact primitive same-carrier `bool`/`u8`/`u32` equality | CKIR8 and OMGRFN10 R1–R5 | [`OMEGA_BOOTSTRAP_CHECKED_IR_V8.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V8.md) and [`OMGCOMP_REFINEMENT_WITNESS_V10.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V10.md) |
| pure, total, nontrapping same-carrier unsigned `u8`/`u32` `>` and `>=` | CKIR9 and OMGRFN11 R1–R5 | [`OMEGA_BOOTSTRAP_CHECKED_IR_V9.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V9.md) and [`OMGCOMP_REFINEMENT_WITNESS_V11.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V11.md) |
| explicit exact pure-leaf `u8 as u32 in Trapping` | CKIR10 and OMGRFN12 R1–R5 | [`OMEGA_BOOTSTRAP_CHECKED_IR_V10.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V10.md) and [`OMGCOMP_REFINEMENT_WITNESS_V12.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V12.md) |
| canonical `u32 in Trapping` leaf-plus-anonymous-literal addition | CKIR11 and OMGRFN13 R1–R5 | [`OMEGA_BOOTSTRAP_CHECKED_IR_V11.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V11.md) and [`OMGCOMP_REFINEMENT_WITNESS_V13.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V13.md) |
| program-static shared byte views with a guarded head and one-byte tail | OMGRSW4, OMGLOWD/CKIR12, conservative backend, and OMGRFN14 R1–R5 | [`OMEGA_BOOTSTRAP_RESOLUTION_V4.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_RESOLUTION_V4.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V12.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V12.md), and [`OMGCOMP_REFINEMENT_WITNESS_V14.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V14.md) |
| recursive pure full-width trapping-`u32` `+`/`-`/`*` | OMGRSW7, OMGLOWF/CKIR14, independent meaning, conservative backend, and persisted lower-rooted OMGRFN16 R1–R5 | [`OMEGA_BOOTSTRAP_RESOLUTION_V7.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_RESOLUTION_V7.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V14.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V14.md), and [`OMGCOMP_REFINEMENT_WITNESS_V16.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V16.md) |
| recurrent guarded head/tail over a runtime-capable direct shared-byte view | OMGRSW4, OMGLOWG/CKIR15, exact ordered direct-binder pass-through vectors, runtime-only/no-static-root custody, independent meaning, conservative backend, and persisted lower-rooted OMGRFN17 R1–R5 | [`OMEGA_BOOTSTRAP_CHECKED_IR_V15.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V15.md), [`OMEGA_BOOTSTRAP_LOWERING_V16.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_LOWERING_V16.md), and [`OMGCOMP_REFINEMENT_WITNESS_V17.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V17.md) |
| direct pure full-width same-carrier `u64 < u64` with true-edge range custody | OMGRSW8, OMGLOWH/CKIR16, exact paired-word meaning, conservative unsigned backend, and persisted lower-rooted OMGRFN18 R1–R5 | [`OMEGA_BOOTSTRAP_RESOLUTION_V8.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_RESOLUTION_V8.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V16.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V16.md), and [`OMGCOMP_REFINEMENT_WITNESS_V18.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V18.md) |
| guarded full-width fixed-buffer indexing, mutation, and Exact increment | OMGRSWA10, OMGLOWJ19/CKIR18, modular Rust-free meaning, conservative backend, and OMGRFN21 R1–R5 over actual native/self producers | [`OMEGA_BOOTSTRAP_RESOLUTION_V10.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_RESOLUTION_V10.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V18.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V18.md), and [`OMGCOMP_REFINEMENT_WITNESS_V21.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V21.md) |
| guarded full-width record-array indexing, nested scalar mutation/readback, and wide finite calls | OMGRSWB11, OMGLOWK20/CKIR19, modular Rust-free meaning, conservative backend, and OMGRFN22 R1–R5 over actual native/self producers | [`OMEGA_BOOTSTRAP_RESOLUTION_V11.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_RESOLUTION_V11.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V19.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V19.md), and [`OMGCOMP_REFINEMENT_WITNESS_V22.md`](../../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V22.md) |
...
[`OMEGA_BOOTSTRAP_COMPILATION.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_COMPILATION.md)
and the exact target/configuration successor
[`OMEGA_BOOTSTRAP_COMPILATION_V2.md`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_COMPILATION_V2.md).
The bounded Delta
[`SHA-256 producer`](../../../source/on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_SHA256.md)
