...
implementation, but OWNER Q8 has not yet selected one executable language from the
...
oracles and useful implementation material. Neither defines Gamma before OWNER Q8,
