...
row; authored names end at resolved-to-typed lowering. Symbol-resolved
machines and signatures retain those names long enough to build the row and
report source-facing diagnostics. Removing those resolved staging spans is an
implementation cleanup, not a second semantic contract.
