...
- **PCC-CANONICAL-SEMANTIC-LEDGER.** Replace the current trusted Rust fusion of
  ...
  scalar/type/value results. The bounded spike narrows identities to a zero high
  half, types to Boolean/i8/i16, and signed integer values to canonical i8 sign
  extension only in explicit adapters after complete decoding;
  ...
  7,498 to 2,232 lines, with structural/service foundation (956 lines), public
  error vocabulary (803), structural ownership/frontier cleanup (750),
  per-machine registration/orchestration (716),
  ...
  and call-graph acyclicity (68) in separate responsibilities. Public
  validation types remain re-exported from the crate boundary.
  These
