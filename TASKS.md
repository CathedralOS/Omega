...
`omega.final-footprint-certificate` schema, format version 53, and a certificate
...
source storage and mixed buffer/source/target relocation set. String-descriptor writes now
