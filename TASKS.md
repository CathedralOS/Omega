...
`omega.final-footprint-certificate` schema, format version 44, and a certificate
...
relocations. Composed-place conversion, string/bit-field writes, and calls
remain incomplete. Pointee-pair
