...
- **PSIIR.** Extend the accepted terminal vocabulary as complete vertical
  ...
  unsigned under a retained direct subtrahend-to-minuend bound or
  ...
  or by an unsigned runtime count under direct count and value upper bounds, or
  exact division/remainder by a landed nonzero unsigned constant, a landed
  signed constant other than `0` or
