...
- **R5:** continue exact inferred may-write summaries and relational candidates.
  ...
  call producers in up to nineteen unary, binary, primitive-cast,
  member-projection, or indexing shells without widening that call budget. A
  twentieth direct scalar shell remains fenced; aggregate fields and projected
  ...
  aggregate/literal computed shell, a twentieth direct scalar computed shell,
