...
- **R5:** continue exact inferred may-write summaries and relational candidates.
  ...
  call producers in up to sixteen unary, binary, primitive-cast,
  member-projection, or indexing shells without widening that call budget. A
  seventeenth direct scalar shell remains fenced; aggregate fields and projected
  ...
  aggregate/literal computed shell, a seventeenth direct scalar computed shell,
