...
- **ALPHA-WINDOWS-SEED-EXECUTION** — mined candidate; verify scope then implement.
...
- **BASELINE-T2C-FAILURE-CLUSTER-TRIAGE** — mined candidate; verify scope then implement.
