...
- **PSIIR — IMPLEMENTATION WORK:** build the terminal Psi boundary settled in
  ...
  cast-form, operator-spelling, inline-assembly, resolved-language-semantics,
  arithmetic-domain, float-semantics, and literal-payload aliases are retired; their
