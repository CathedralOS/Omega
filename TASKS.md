...
- **ENTRY-CONTENT-ROOTS.** Complete the physical entry bridge and explicit-entry
  ...
  termination/ranking proof fixtures, and pure ownership-checker clusters now
  use explicit checked-only harnesses; ownership fixtures with dedicated backend
