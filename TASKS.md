...
`omega.final-footprint-certificate` schema, format version 46, and a certificate
...
string writes, and calls remain incomplete. Immediate compact bit-field writes
