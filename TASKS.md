...
- **TERMINATION-RANKING-CHECKS.** Complete the documented flow-dependent
  ...
  Custom struct-view ranges beyond enforced static field bounds, scalar views
  beyond `u64` identity forwarding, and slice lengths over projected storage
  need their produced-rank facts.
