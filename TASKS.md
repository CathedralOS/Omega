...
`omega.final-footprint-certificate` schema, format version 61, and a certificate
...
frame-indexed, inline-frame-indexed, and frame-indexed machine-storage AArch64
shapes, binding the exact rodata and storage/index relocations to
