...
- **PCC-CANONICAL-SEMANTIC-LEDGER.** Replace the current trusted Rust fusion of
  ...
  7,498 to 3,899 lines, with structural/service foundation (956 lines), public
  ...
  (410), contract proposition scope (120), and call-graph acyclicity (68) in
  separate responsibilities. Public validation types remain re-exported from
  the crate boundary.
  These
