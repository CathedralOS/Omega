...
`omega.final-footprint-certificate` schema, format version 84, and a certificate
...
root. Authored aggregate-result shapes remain incomplete alongside composite
import adapters.
...
too, along with their direct-frame-source to frame-indexed-target mirror and
frame-indexed-source to frame-held-pointee form. Runtime-indexed reads from
