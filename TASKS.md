...
- **PSIIR.** Extend the accepted terminal vocabulary as complete vertical
  ...
  One proof-bearing exact operation may also appear beneath one bitwise-not,
  integer-widening, or proof-free binary shell; the other binary subtree remains
  proof-free. Other nested proof-bearing shells, computed exact-cast and wider
