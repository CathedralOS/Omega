...
- [x] Establish the canonical owner layout for every implementation that
  ...
  - [ ] **DESIGN-BLOCKED — OWNER Q4.** Materialize the Gamma compiler source, tape,
    and adjacent validation in `source/gamma/compiler/`; section 3 owns the
    implementation.
  - [ ] **DESIGN-BLOCKED — OWNER Q3/Q4.** Materialize the Delta compiler source,
    tape, and adjacent validation in `source/delta/compiler/`; section 4 owns
    the implementation.
  - [ ] **DESIGN-BLOCKED — OWNER Q3.** Author
  ...
  - [ ] **DEPENDENCY-BLOCKED — OWNER Q4, missing Gamma/Delta compilers, and missing
...
- [ ] **BLOCKED — OWNER Q6 (Beta compiler outcome): ADMIT-ALPHA-BETA-COMPILER.** Audit the canonical
  ...
  - [ ] **DESIGN-BLOCKED — OWNER Q5:** Enforce Beta definite initialization across
  ...
  - [x] Bind the compiler's practical fixed resource profile and exercise exact
    ...
    source capacities.
  - [ ] **OWNER-BLOCKED — OWNER Q6:** Project malformed source and each private
...
- [ ] **DESIGN-BLOCKED — OWNER Q4: BUILD-GAMMA-COMPILER.** Define the complete Gamma source contract, then
  ...
  compilation. OWNER Q4 must first select one typed executable grammar, entry/stream
...
- [ ] **DEPENDENCY-BLOCKED — OWNER Q4 and missing `gamma_compiler.beta`.** Check the
...
- [ ] **DESIGN-BLOCKED — OWNER Q3: FREEZE-DELTA-V1.** Finish one self-contained Delta grammar, static
...
- [ ] **DESIGN-BLOCKED — OWNER Q3/Q4: BUILD-DELTA-COMPILER.** Implement
  ...
  participates.
- [ ] **DESIGN-BLOCKED — OWNER Q3.** Derive compact positive, negative, trap, and
  ...
  translator.
- [ ] **DEPENDENCY-BLOCKED — OWNER Q4 and missing `delta_compiler.gamma`.** Run that
  ...
  - [x] Delete the unrun 43-file pre-migration Delta corpus rather than
    ...
    After OWNER Q3 freezes Delta v1, derive a compact positive/negative suite from
    the frozen contract and run it through the actual Gamma-written compiler.
- [ ] **DEPENDENCY-BLOCKED — OWNER Q3/Q4 and missing Gamma/Delta compilers.** Check
...
- [ ] **DESIGN-BLOCKED — OWNER Q3: OWN-OMEGA-D.** Author one exact package-resolved closure `D` at
...
- [ ] **DEPENDENCY-BLOCKED — OWNER Q3 and missing `D`.** Make `D` implement the
