...
- **Toward Omega's proof surface — STARTED.** rungs/omega.md: Omega = the lower rungs PLUS contracts +
  ...
  accepts every proof emitted). `prover-test.sh` (816 ok): propositional tautologies (or-comm, distribution,
