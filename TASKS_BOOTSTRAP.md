...
- [x] Establish the canonical owner layout for every implementation that
  ...
  - [ ] **DESIGN-BLOCKED — OWNER Q8.** Materialize the Gamma compiler source, tape,
    and adjacent validation in `source/gamma/compiler/`; section 3 owns the
    implementation.
  - [ ] **DESIGN-BLOCKED — OWNER Q7/Q8.** Materialize the Delta compiler source,
    tape, and adjacent validation in `source/delta/compiler/`; section 4 owns
    the implementation.
  - [ ] **DESIGN-BLOCKED — OWNER Q7.** Author
  ...
  - [ ] **DEPENDENCY-BLOCKED — OWNER Q8, missing Gamma/Delta compilers, and missing
...
- [ ] **BLOCKED — OWNER Q10 (Beta compiler outcome): ADMIT-ALPHA-BETA-COMPILER.** Audit the canonical
  ...
  - [ ] **DESIGN-BLOCKED — OWNER Q9:** Enforce Beta definite initialization across
  ...
  - [x] Bind the compiler's practical fixed resource profile and exercise exact
    ...
    source capacities.
  - [ ] **OWNER-BLOCKED — OWNER Q10:** Project malformed source and each private
...
- [ ] **OWNER-BLOCKED — OWNER Q12.** Close exact
  ...
  - [ ] **OWNER-BLOCKED — OWNER Q12:** Turn the ground assembly judgment into a derivation certificate
    ...
    - OWNER Q12 must choose between bounded subject-bound chunk equalities whose exact
...
- [ ] **DESIGN-BLOCKED — OWNER Q8: BUILD-GAMMA-COMPILER.** Define the complete Gamma source contract, then
  ...
  compilation. OWNER Q8 must first select one typed executable grammar, entry/stream
...
- [ ] **DEPENDENCY-BLOCKED — OWNER Q8 and missing `gamma_compiler.beta`.** Check the
...
- [ ] **DESIGN-BLOCKED — OWNER Q7: FREEZE-DELTA-V1.** Finish one self-contained Delta grammar, static
...
- [ ] **DESIGN-BLOCKED — OWNER Q7/Q8: BUILD-DELTA-COMPILER.** Implement
  ...
  participates.
- [ ] **DESIGN-BLOCKED — OWNER Q7.** Derive compact positive, negative, trap, and
  ...
  translator.
- [ ] **DEPENDENCY-BLOCKED — OWNER Q8 and missing `delta_compiler.gamma`.** Run that
  ...
  - [x] Delete the unrun 43-file pre-migration Delta corpus rather than
    ...
    After OWNER Q7 freezes Delta v1, derive a compact positive/negative suite from
    the frozen contract and run it through the actual Gamma-written compiler.
- [ ] **DEPENDENCY-BLOCKED — OWNER Q7/Q8 and missing Gamma/Delta compilers.** Check
...
- [ ] **DESIGN-BLOCKED — OWNER Q7: OWN-OMEGA-D.** Author one exact package-resolved closure `D` at
...
- [ ] **DEPENDENCY-BLOCKED — OWNER Q7 and missing `D`.** Make `D` implement the
...
- [ ] **DEPENDENCY-BLOCKED — OWNER Q13 and current ranked-runtime acceptance.**
