...
- Prefer parent-owned contiguous child ranges for symbol lookup. Linear sibling scans are the default because real scopes are usually small and cache-friendly; global hash maps are an optimization for measured pathological scopes, not the baseline design.
