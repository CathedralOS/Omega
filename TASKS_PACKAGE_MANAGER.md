...
- [x] **PACKAGE-SCAFFOLDING-AUDIT.** Review every production path in
  ...
  [`omega-packages/SCAFFOLDING_AUDIT.md`](source/omega-rust/omega/packages/omega-packages/SCAFFOLDING_AUDIT.md).
...
- **HARDEN-SOURCE-RESOLVER.** Re-audit the current Git/local resolver as a
  ...
  [`SOURCE_RESOLVER_SECURITY.md`](source/omega-rust/omega/packages/omega-packages/SOURCE_RESOLVER_SECURITY.md).
