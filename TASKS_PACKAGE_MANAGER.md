...
- [ ] **BUILD-OBSERVATION-EVIDENCE.** Generalize the existing exact
  Source-input/empty-Output and one-file Output replay lanes into a complete
  receipted build-operation and output grammar. Add replay for every remaining
  admitted service and staged-output shape, exact staged-output
