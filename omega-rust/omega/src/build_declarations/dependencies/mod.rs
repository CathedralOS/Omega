...
use tokens_to_syntax_trees::syntax_trees::statement::{StatementHandle, StatementNode};

use crate::build_declarations::BuildEntrySyntaxProjection;
...
/// validated by [`crate::build_declarations::project_build_entry_syntax`].
///
...
mod tests {
    ...
    use crate::build_declarations::{BuildDeclarationError, project_build_entry_syntax};
