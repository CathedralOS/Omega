...
//! (`typed_trees_to_checked_trees::checked_trees::CheckedTrees`, which derefs to `symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees`)
...
#[cfg(test)]
#[path = "../tests/checked_interpreter/support/front_end.rs"]
mod front_end;
