...
use crate::build_evaluation::{BuildEvaluationUsage, BuildObservationSummary};
...
use crate::package_source::{ImmutableSourceResolution, SourceResolveError};
...
pub enum AcceptedOrdinaryEvidenceError {
    ...
    SourceSelectionCustody {
        package: PackageKey,
        error: crate::package_manager::resolution::source::PackageSourceSelectionEvidenceError,
    },
