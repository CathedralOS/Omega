...
use crate::compiler::{CompileOptions, CompileOutputKind, CompileReport, TrustAdmission};
...
impl PreparedLocalProjectCheckRequest {
    ...
    pub fn with_build_snapshot(
        mut self,
        snapshot: crate::build_evaluation::BuildSnapshotRequest,
    ) -> Self {
...
pub fn check_prepared_local_project_for_inspection(
    ...
    build_dir: &Path,
    target_profile: TargetProfile,
) -> Result<crate::compiler::CheckedCompilation, CompileResolvedPackageReviewsError> {
...
pub fn check_prepared_local_project(
    ...
    let admission =
        crate::compiler::admit_checked_compilation(&checked, &accepted_trust_admissions)
