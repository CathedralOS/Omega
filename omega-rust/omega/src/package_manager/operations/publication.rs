...
impl PackagePublicationLimits {
    fn files(self) -> crate::platform_custody::record_file::RecordFileLimits {
        crate::platform_custody::record_file::RecordFileLimits {
            maximum_bytes: self.maximum_file_bytes,
        }
    }

    fn journal(self) -> crate::platform_custody::record_file::RecordFileLimits {
        crate::platform_custody::record_file::RecordFileLimits {
