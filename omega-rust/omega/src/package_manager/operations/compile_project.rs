...
use crate::compiler::{CompileReport, OptimizationRollback, TrustAdmission};
use crate::package_manager::admission::{
...
pub fn compile_prepared_local_project_for_native<Observation>(
    ...
    observe: impl FnOnce(&crate::compiler::CheckedCompilation) -> Observation,
    ...
    let admission = crate::compiler::admit_checked_compilation(
...
mod tests {
    ...
    use crate::package_manager::review::ReviewOnlyRootPolicyDisposition;
...
"#,
            ...
            std::fs::write(
                path.join("main.omg"),
                r#"use crate::language::core::binding;
