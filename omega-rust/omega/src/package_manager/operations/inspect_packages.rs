...
pub struct PackageInspectionOptions {
    ...
    pub build_inputs: Option<crate::package_compilation::BuildSourceCaptureRequest>,
}
...
pub fn inspect_packages(
    ...
    let build_snapshot = options
        .build_inputs
        .map(|inputs| crate::build_evaluation::BuildSnapshotRequest::scoped(Vec::new(), inputs));
    execution::inspect(
        &transaction,
        options.targets,
        options.details,
