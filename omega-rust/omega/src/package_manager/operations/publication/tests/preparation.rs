...
use crate::package_manager::operations::{PrepareLocalProjectError, prepare_local_project};
use crate::package_manager::resolution::graph::ResolvedSourceIdentity;
...
fn proposed_lock(project: &Project) -> String {
    ...
    use crate::package_manager::operations::review_package_change;
    use crate::package_manager::review::resolve_package_policy_decisions;
