...
//! printing stay in the binary. Compiler preparation is separate in [`crate::package_manager::operations`].
...
use crate::package_manager::declarations::BuildFileReplacement;
use crate::package_manager::lock::{PackageLock, PackageLockRecoveryLimits};
...
use crate::package_manager::review::CandidateSourcePreparation;
...
pub fn execute_package_command(
    ...
    let context =
        ExternalSourceContext::derive(crate::package_manager::operations::LOCAL_PROJECT_CONTEXT);
