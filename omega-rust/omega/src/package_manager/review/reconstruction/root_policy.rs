...
fn validate_open_obligation_rows(
    ...
    use crate::package_manager::review::compare::resources::{
        ComparisonInputBudget, account_review_resources,
    };
...
fn validate_kind_rows<'row>(
    ...
    open: impl ExactSizeIterator<
        Item = &'row crate::package_evidence::ledger::OrdinaryPackageObligationRow,
    >,
