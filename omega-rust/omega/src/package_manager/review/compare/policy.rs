...
use crate::package_evidence::record::PackagePolicyRowKind;
use crate::package_manager::declarations::BuildDeclarationKind;
use crate::package_manager::declarations::PackageKey;
use crate::package_manager::declarations::dependencies::DependencyPurpose;
use crate::package_manager::lock::PackageLockTarget;
use crate::package_manager::lock::{PackageAcceptanceRow, PackageCheckedContext};
use crate::package_manager::resolution::graph::CanonicalSourceClosureSubjectFingerprint;
use crate::package_manager::resolution::graph::{
    CanonicalSourceClosureSubject, ExactTargetPackageSourceClosure,
};
use crate::package_manager::review::timings;
use crate::package_manager::review::{
...
impl PackagePolicyPackageChange {
    ...
    /// the host.
    pub fn restricted_build_requests(&self) -> &[crate::build_evaluation::RestrictedBuildRequest] {
