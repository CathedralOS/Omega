...
impl SourcePreparationFixture {
    ...
    fn closure(&self) -> crate::package_manager::resolution::graph::ResolvedPackageSourceClosure {
...
fn assert_root_console_permissions(
    ...
    expected: &[(
        &str,
        abstract_operations_to_target_operations::effects::TerminalAuthorityClass,
    )],
) {
    use crate::package_compilation::AcceptedSemanticBindingRole;
    use crate::package_evidence::record::PackageReviewCanonicalRowKind;
...
"#,
    ...
    let snapshot = crate::build_evaluation::BuildSnapshotRequest::scoped(
        Vec::new(),
        crate::package_compilation::BuildSourceCaptureRequest::new([
            (
                b"build.omg".to_vec(),
    ...
    let conflicts = crate::package_manager::review::compare_review_only_initial_capabilities(
        &reviews,
        &exact,
...
const INDEPENDENT_COMPONENT_SOURCE: &str = r#"use crate::language::core::binding;
