...
"#,
    ...
    let sponsor = crate::checked_interpreter::FilesystemSponsor::new(&output).unwrap();
    let evaluation_limits = crate::checked_interpreter::BuildEvaluationSponsorLimits::new(
        100_000_000,
        1_048_576,
        65_536,
        4_096,
    ...
    .unwrap();
    let evaluation = crate::checked_interpreter::BuildEvaluationSponsor::new(evaluation_limits);
    ...
    let mut wider_limits = crate::checked_interpreter::FilesystemSponsorLimits::default();
    wider_limits.maximum_entries += 1;
    let wider_sponsor =
        crate::checked_interpreter::FilesystemSponsor::with_limits(&wider_output, wider_limits)
            .unwrap();
    let wider_reviews = super::super::package_pass::compile_dependency_closure(
        ...
        &wider_output,
        &wider_sponsor,
        &crate::checked_interpreter::BuildEvaluationSponsor::new(evaluation_limits),
        &Default::default(),
        None,
        None,
        None,
    ...
    review.generated_source_bundle =
        crate::package_compilation::PackageGeneratedSourceBundle::from_checked(
            bundle.package(),
...
fn decided_lock(
    ...
    exact: &crate::package_manager::resolution::graph::ExactTargetPackageSourceClosure<'_>,
    reviews: &crate::package_manager::review::CompilerIssuedPackageReviewSet,
) -> PackageLock {
    let changes =
