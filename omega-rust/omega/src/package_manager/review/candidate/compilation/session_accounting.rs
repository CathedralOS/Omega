...
use crate::checked_interpreter::BuildEvaluationSponsor;
...
pub(super) fn verify_build_session_accounting(
    ...
    discarded: &[crate::build_evaluation::BuildEvaluationUsage],
...
fn reported_usages<'a>(
    ...
    discarded: &'a [crate::build_evaluation::BuildEvaluationUsage],
) -> Option<Vec<crate::build_evaluation::BuildEvaluationUsage>> {
    reviews
        .iter()
...
fn observed_usages<'a>(
    reviews: &'a [CompilerIssuedPackageReview],
    discarded: &'a [crate::build_evaluation::BuildEvaluationUsage],
) -> impl Iterator<Item = crate::build_evaluation::BuildEvaluationUsage> + 'a {
    reviews
        .iter()
