...
use crate::build_evaluation::{
    BuildEvaluationUsage, BuildObservationSummary, RestrictedBuildRequest,
};
...
use crate::package_evidence::record::{CheckedPackageReviewProjection, PackageReviewCanonicalRow};
...
pub struct CompilerIssuedPackageReview {
    ...
    pub(super) policy: crate::package_evidence::record::PackagePolicyBaseline,
...
impl CompilerIssuedPackageReview {
    ...
    pub fn checked_context(&self) -> crate::package_manager::lock::PackageCheckedContext {
        crate::package_manager::lock::PackageCheckedContext::new(
    ...
    pub const fn policy(&self) -> &crate::package_evidence::record::PackagePolicyBaseline {
        &self.policy
    }
...
pub struct ReviewedPackageProductionCandidate {
    ...
    pub(super) root_role: crate::package_compilation::BuildDeclarationKind,
    ...
    pub(super) checked_root: Box<crate::compiler::CheckedCompilation>,
}
...
impl ReviewedPackageProductionCandidate {
    ...
    pub const fn root_role(&self) -> crate::package_compilation::BuildDeclarationKind {
        self.root_role
    }
    ...
    pub(crate) const fn checked_root(&self) -> &crate::compiler::CheckedCompilation {
        &self.checked_root
    }
