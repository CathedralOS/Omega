...
use crate::package_manager::review::CompilerIssuedPackageReviewSet;
...
pub(crate) fn validate_review_only_closure<'review>(
    ...
    ValidatedReviewOnlyClosure<
        'review,
        crate::package_manager::review::CompilerIssuedPackageReview,
    >,
...
mod tests {
    ...
    use crate::package_source::{GitCommitId, GitTreeId, SourceLineage};
