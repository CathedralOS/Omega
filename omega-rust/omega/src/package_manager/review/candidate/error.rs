...
use crate::checked_interpreter::FilesystemSponsorError;
...
use crate::package_manager::resolution::source::PackageSourceSelectionEvidenceError;
...
pub enum CompileResolvedPackageReviewsError {
    ...
    UngrantedRestrictedBuildRequests {
        package: PackageKey,
        ungranted: Vec<crate::package_manager::review::UngrantedRestrictedBuildRequest>,
    },
}
