...
fn checked_context(
    output: &mut Output,
    prefix: &str,
    context: Option<crate::package_manager::lock::PackageCheckedContext>,
) -> fmt::Result {
    match context {
...
fn purposes(
    output: &mut Output,
    prefix: &str,
    values: &[crate::package_manager::lock::PackageCheckedContext],
) -> fmt::Result {
...
fn role(role: crate::package_manager::declarations::BuildDeclarationKind) -> &'static str {
...
fn policy(
    output: &mut Output,
    prefix: &str,
    row: Option<&crate::package_manager::lock::PackageAcceptanceRow>,
) -> fmt::Result {
    match row {
        Some(row) => {
