...
fn hex_length(algorithm: crate::package_source::GitObjectIdAlgorithm) -> usize {
    match algorithm {
        crate::package_source::GitObjectIdAlgorithm::Sha1 => 40,
        crate::package_source::GitObjectIdAlgorithm::Sha256 => 64,
    }
}
