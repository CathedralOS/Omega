...
use crate::package_source::{LocalSourceLimits, SourceLineage, SourceRelativePath};
...
fn resolves_the_authored_local_graph_fixture() {
    ...
    let closure = resolve_package_source_closure(
        ...
        root,
        |requester, request| {
            let crate::package_manager::declarations::dependencies::read::DependencySourceRequest::Path {
                location,
                ..
            } = request
            else {
...
fn reference_breadth_first_path(
    ...
    target: &crate::package_manager::declarations::PackageKey,
