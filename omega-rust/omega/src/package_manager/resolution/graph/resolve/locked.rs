...
use crate::package_manager::resolution::source::{PackageSourceCustody, ResolvePackageSourceError};
    ...
    fn dependency(
        ...
        let selected = match request {
            DependencySourceRequest::Git {
                ...
                let request =
                    crate::package_manager::resolution::source::GitPackageSourceRequest::new(
                        acquisition,
                        selection.clone(),
                    );
