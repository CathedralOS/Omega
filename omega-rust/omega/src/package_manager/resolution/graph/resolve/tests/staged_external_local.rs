...
use crate::package_manager::resolution::source::ResolvePackageSourceError;
use crate::package_manager::review::SemanticBindingReview;
use crate::package_source::PrimaryGitChoices;
use crate::package_source::git::resolution::GitExactRevisionAcquisition;
use crate::package_source::local::staging::{
    StagedLocalSnapshot, stage_local_source_replacement_in_lane,
};
use crate::package_source::{ExternalLocalLineage, SourceResolveError};
...
fn staged_project_adds_relative_and_nested_path_dependencies_from_live_directories() {
    ...
    crate::package_manager::resolution::package_compilation_inputs(&candidate)
        .expect("staged compiler inputs");
