...
use crate::package_manager::resolution::graph::resolve::dependencies::resolve_registered_package_closure;
use crate::package_manager::resolution::source::{GitPackageSourceRequest, ResolvedPackageSource};
use crate::package_source::PrimaryGitChoices;
use crate::package_source::ResolvedGitSource;
    ...
    fn request(&self, locator: &str, revision: &str, member: &str) -> GitPackageSourceRequest {
        GitPackageSourceRequest::new(
            ...
            crate::package_manager::declarations::PackageSelection::Named(
                crate::package_manager::declarations::PackageName::parse(member).unwrap(),
            ),
        )
    }
