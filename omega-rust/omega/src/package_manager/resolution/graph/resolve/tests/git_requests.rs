...
use crate::package_source::PrimaryGitChoices;
#[test]
fn resolves_repository_root_git_closure_and_retains_the_exact_request() {
    ...
    let resolved = crate::package_manager::resolution::source::resolve_git_package_source(
        &request,
        &storage,
...
fn repository_root_project_retains_application_role_and_package_entry_rejects() {
    ...
    crate::package_manager::resolution::graph::resolve_git_package_closure(
        &request,
        &storage,
        LocalSourceLimits::default(),
        PackageSourceClosureLimits::default(),
    ...
    let closure = crate::package_manager::resolution::graph::resolve_git_project_closure(
        &request,
        &storage,
        LocalSourceLimits::default(),
        PackageSourceClosureLimits::default(),
    ...
    assert_eq!(
        closure.root_role(),
        crate::package_manager::declarations::BuildDeclarationKind::Application
    );
...
"#,
    ...
    run_test_git(&repository, ["add", "."]);
    run_test_git(&repository, ["commit", "--quiet", "-m", "root"]);
    let request = crate::package_manager::resolution::source::GitPackageSourceRequest::new(
        ...
        .expect("validated local Git root request"),
        crate::package_manager::declarations::PackageSelection::Named(
            crate::package_manager::declarations::PackageName::parse("matrix")
                .expect("package name"),
        ),
    );
    let storage = SourceResolverStorage::for_hardened_base(&cache, PrimaryGitChoices::default())
    ...
    let closure = crate::package_manager::resolution::graph::resolve_selected_git_package_closure(
        &request,
        &storage,
        LocalSourceLimits::default(),
        PackageSourceClosureLimits::default(),
    ...
    assert!(matches!(
        root.navigation(),
        crate::package_manager::resolution::source::PackageSourceNavigation::Member(path)
...
"#,
    ...
    let request = crate::package_manager::resolution::source::GitPackageSourceRequest::new(
        ...
        crate::package_manager::declarations::PackageSelection::Named(
            crate::package_manager::declarations::PackageName::parse("driver_console")
                .expect("project name"),
        ),
    );
    let storage = SourceResolverStorage::for_hardened_base(&cache, PrimaryGitChoices::default())
    ...
    let closure = crate::package_manager::resolution::graph::resolve_selected_git_project_closure(
        &request,
        &storage,
        LocalSourceLimits::default(),
        PackageSourceClosureLimits::default(),
    ...
    assert!(evidence.members().iter().any(|member| {
        member.package_name().as_str() == "driver_protocol"
            && member.role() == crate::package_manager::declarations::BuildDeclarationKind::Package
    }));
...
"#,
    ...
    let request = crate::package_manager::resolution::source::GitPackageSourceRequest::new(
        ...
        .expect("validated local Git root request"),
        crate::package_manager::declarations::PackageSelection::Named(
            crate::package_manager::declarations::PackageName::parse("left").expect("package name"),
        ),
    );
    let storage = SourceResolverStorage::for_hardened_base(&cache, PrimaryGitChoices::default())
        .expect("create retained Git resolver storage");
    ...
    let canonical =
        crate::package_manager::resolution::graph::CanonicalSourceClosureSubject::from_resolved(
            ...
            crate::package_manager::resolution::graph::CanonicalSourceClosureSubjectLimits::default(
            ),
        )
    ...
    crate::package_manager::resolution::package_compilation_inputs(&closure)
...
"#,
    ...
    let error = crate::package_manager::resolution::graph::resolve_selected_git_package_closure(
        &request,
        &storage,
        LocalSourceLimits::default(),
        PackageSourceClosureLimits::default(),
