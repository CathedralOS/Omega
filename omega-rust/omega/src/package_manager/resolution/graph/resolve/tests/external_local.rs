...
use crate::package_manager::resolution::graph::GitResolutionOptions;
...
fn project_resolution_retains_an_application_root_role() {
    ...
    let recovered =
        crate::package_manager::resolution::graph::CanonicalSourceClosureSubject::recover(
    ...
    let compiler_inputs = crate::package_manager::resolution::package_compilation_inputs(&closure)
