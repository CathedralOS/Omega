...
fn workspace_project_entry_retains_application_root_role() {
    ...
    crate::package_manager::resolution::graph::resolve_workspace_package_closure(
        &fixture_lineage(),
    ...
    let closure = crate::package_manager::resolution::graph::resolve_workspace_project_closure(
        &fixture_lineage(),
        SourceRelativePath::parse("projects/console").expect("root member"),
        &workspace,
        &storage,
