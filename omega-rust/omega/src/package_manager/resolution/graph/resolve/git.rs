...
fn git_package_root_request_matches(
    request: &GitPackageSourceRequest,
    resolved: &crate::package_manager::resolution::source::ResolvedPackageSource<ResolvedGitSource>,
) -> bool {
    ...
    match (request.selection(), resolved.navigation()) {
        (
            crate::package_manager::declarations::dependencies::read::PackageSelection::Root,
            PackageSourceNavigation::Root,
        ) => true,
        (
            crate::package_manager::declarations::dependencies::read::PackageSelection::Named(
                package,
            ),
