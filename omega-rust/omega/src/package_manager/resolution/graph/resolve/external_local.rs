...
use crate::package_source::local::staging::StagedLocalSnapshot;
use crate::package_source::{ExternalSourceContext, SourceLineage};
...
fn verify_pin_root(
    ...
    use crate::package_manager::resolution::graph::CanonicalRootSourceRequest;
