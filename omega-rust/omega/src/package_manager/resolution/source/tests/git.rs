...
use crate::package_manager::resolution::source::{
...
use crate::package_source::{ExternalSourceContext, GitSourceRequest, LocalSourceLimits};
use std::path::Path;
...
fn named_git_binding_rejects_missing_and_duplicate_declared_names() {
    ...
    let storage = crate::package_source::SourceResolverStorage::for_hardened_base(
        &cache,
    ...
    let missing = resolve_selected_git_package_source(
        &GitPackageSourceRequest::new(
            ...
            crate::package_manager::declarations::PackageSelection::Named(
                crate::package_manager::declarations::PackageName::parse("missing").unwrap(),
            ),
        ),
        &storage,
        LocalSourceLimits::default(),
    ...
    assert!(matches!(
        ...
        ResolvePackageSourceError::GitWorkspaceSelection(
            crate::package_manager::resolution::source::git::workspace::GitWorkspaceSelectionError::PackageMissing {
                package_name
            }
    ...
    let duplicate = resolve_selected_git_package_source(
        &GitPackageSourceRequest::new(
            acquisition,
            crate::package_manager::declarations::PackageSelection::Named(
                crate::package_manager::declarations::PackageName::parse("same_name").unwrap(),
            ),
        ),
        &storage,
        LocalSourceLimits::default(),
    ...
    assert!(matches!(
        duplicate,
        ResolvePackageSourceError::GitWorkspaceSelection(
            crate::package_manager::resolution::source::git::workspace::GitWorkspaceSelectionError::PackageDuplicate {
                package_name,
                member_paths,
            }
...
fn named_git_binding_rejects_symlink_member_navigation() {
    ...
    let error = resolve_selected_git_package_source(
        &GitPackageSourceRequest::new(
            acquisition,
            crate::package_manager::declarations::PackageSelection::Named(
                crate::package_manager::declarations::PackageName::parse("linked_package").unwrap(),
            ),
        ),
        &storage,
        LocalSourceLimits::default(),
    ...
    assert!(matches!(
        ...
        ResolvePackageSourceError::Source(
            crate::package_source::SourceResolveError::GitTreeInvalid { path, .. }
...
"#,
    ...
    .into_custody();
    let error =
        crate::package_manager::resolution::graph::reconcile::resolve_package_source_closure::<
            std::convert::Infallible,
            _,
        >(
            crate::package_manager::resolution::graph::PackageRootSourceRequest::ExternalLocal {
