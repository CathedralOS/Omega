...
use crate::build_declarations::{
    BuildDeclaration, BuildDeclarationKind, ProjectName, WorkspaceMemberPath,
};
use crate::package_manager::declarations::dependencies::read::validate_static_dependency_source;
use crate::package_manager::declarations::roles::project_build_declaration_source;
