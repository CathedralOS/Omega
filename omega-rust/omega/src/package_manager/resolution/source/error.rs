use crate::package_manager::declarations::dependencies::read::DependencyProjectionError;
use crate::package_manager::declarations::roles::BuildDeclarationError;
use crate::package_manager::resolution::source::git::workspace::GitWorkspaceSelectionError;
use crate::package_source::IdentityError;
use crate::package_source::SourceRelativePath;
