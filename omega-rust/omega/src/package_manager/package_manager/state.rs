...
use crate::package_manager::operations::{PackageFileTransaction, PackagePublicationError};
use crate::platform_custody::record_file::{RecordFileLimits, RecordFileRoot, RootRecordRead};
...
pub(super) fn file_failure(
    error: crate::platform_custody::record_file::RecordFileError,
) -> PackageCommandError {
