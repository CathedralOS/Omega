...
use crate::package_compilation::{BuildSourceCaptureObligation, BuildSourceCaptureRequest};
use crate::package_manager::resolution::graph::{
    CanonicalSourceClosureSubject, CanonicalSourceClosureSubjectLimits,
};
use crate::package_manager::resolution::source::git::workspace::MAX_BUILD_DECLARATION_BYTES;
...
const MAXIMUM_BUILD_INPUTS: usize =
    crate::checked_interpreter::CANONICAL_FILESYSTEM_METADATA_ROW_LIMIT - 1;
const MAXIMUM_BUILD_INPUT_PATH_BYTES: usize =
    crate::checked_interpreter::FILESYSTEM_ROOT_RELATIVE_PATH_BYTE_LIMIT;
