use crate::build_declarations as shared;
use crate::package_manager::declarations::dependencies::read::error::DependencyProjectionError;
use crate::package_manager::declarations::dependencies::read::source_literal::{
...
use tokens_to_syntax_trees::syntax_trees::statement::StatementHandle;
