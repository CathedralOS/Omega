...
impl PackageName {
    pub fn parse(value: impl Into<String>) -> Result<Self, String> {
        ...
        crate::build_declarations::ProjectName::parse(value.clone())?;
        Ok(Self(value))
    }
...
impl From<crate::build_declarations::ProjectName> for PackageName {
    fn from(value: crate::build_declarations::ProjectName) -> Self {
