...
use crate::package_evidence::record::{PACKAGE_POLICY_ROW_VERSION, PackagePolicyRowKind};
use crate::package_manager::lock::{
    PackageAcceptanceRow, PackageLockError as Error, PackagePolicyAcceptance,
};
use semantic_vocabulary::PackageKeyIdentity;
use std::fmt::Write as _;
use target::TargetProfile;

pub(in crate::package_manager::lock) fn write(
    policy: &PackagePolicyAcceptance,
) -> Result<String, Error> {
...
pub(in crate::package_manager::lock) fn read(
    text: &str,
