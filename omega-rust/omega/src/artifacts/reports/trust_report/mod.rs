...
pub struct TrustReportRow {
    ...
    pub machine_contract_commitment:
        Option<typed_trees_to_checked_trees::checked_trees::MachineContractCommitment>,
...
pub struct TrustProviderRequirementRow {
    ...
    pub provider_plan_digest: abstract_operations_to_target_operations::effects::provider_plan::ProviderPlanDigest,
    ...
    pub calling_plan_commitment: Option<symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment>,
    pub selected: bool,
...
pub enum TrustProviderRealization {
    ...
    Import {
        evaluated: abstract_operations_to_target_operations::effects::provider_plan::EvaluatedForeignImport,
    },
    Syscall {
        number: i64,
    },
...
pub struct TrustGenericAcceptedInstanceRow {
    ...
    pub instance_contract_commitment: typed_trees_to_checked_trees::checked_trees::MachineContractCommitment,
    ...
    pub machine_argument_contract_commitments: Vec<typed_trees_to_checked_trees::checked_trees::MachineContractCommitment>,
    /// Compatibility/report coordinates corresponding positionally to the
    ...
    pub conformance_argument_commitments:
        Vec<symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::ClosedConformanceApplicationCommitment>,
}
...
pub struct TrustReport {
    ...
    pub selected_provider_closure_digest:
        abstract_operations_to_target_operations::effects::SelectedProviderClosureDigest,
