...
use abstract_operations_to_target_operations::effects::{
    ForeignLocatorCandidate, NormalizedForeignLocator, normalize_foreign_locator,
};
...
fn test_provider_plan_digest()
-> abstract_operations_to_target_operations::effects::provider_plan::ProviderPlanDigest {
    abstract_operations_to_target_operations::effects::provider_plan::ProviderPlan::default()
        .identity_digest()
}
