...
pub fn settle_selected_execution_dispatch(
    ...
    crate::selected_dispatch::boundary_dispatch::settle_selected_boundary_adapter_dispatch(
        &mut checked,
        selected_provider_plans,
    )?;
    if crate::selected_dispatch::boundary_dispatch::has_top_level_requirement_dispatch(&checked) {
