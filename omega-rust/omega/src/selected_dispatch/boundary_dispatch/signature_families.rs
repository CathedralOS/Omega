...
//! (`symbol_resolved_trees_to_typed_trees::typed_trees::finite_family`) so the local `dyn` surface and the
...
pub(crate) use symbol_resolved_trees_to_typed_trees::typed_trees::finite_family::FamilyProbe;
