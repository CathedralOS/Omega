...
use crate::selected_dispatch::boundary_dispatch::adapter_rows::{
    AdapterRow, GenericBoundaryRequirement,
};
use crate::selected_dispatch::boundary_dispatch::signature_families::call_argument_const_identity;
...
pub(crate) fn exact_conformance_requirement_identity(
    ...
    owner: &symbol_resolved_trees_to_typed_trees::typed_trees::trait_definition::TraitDefinition,
    requirement: &str,
) -> Option<String> {
...
pub(crate) fn exact_boundary_trait<'typed>(
    ...
    &'typed symbol_resolved_trees_to_typed_trees::typed_trees::trait_definition::TraitDefinition,
    Diagnostic,
> {
    if name.is_empty() {
...
pub(crate) fn exact_adapter_receiver_shape(
    typed: &TypedTrees,
    actual_parameters: &[&symbol_resolved_trees_to_typed_trees::typed_trees::signature::StateParameter],
