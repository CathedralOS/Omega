...
use crate::selected_dispatch::selected_dispatch::float_intrinsic::intrinsic_resolution::{
...
pub(super) struct StagedNamedFloatRewrite {
    ...
    pub(super) origin: typed_trees_to_checked_trees::checked_trees::CheckedValueOrigin,
