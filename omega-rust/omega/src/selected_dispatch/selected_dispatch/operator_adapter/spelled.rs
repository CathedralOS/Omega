...
pub(super) fn resolve_selected_spelled_operator_adapter_call(
    ...
    operator_use: &typed_trees_to_checked_trees::checked_trees::CheckedOperatorUseFact,
...
mod tests {
    ...
    struct Fixture {
        ...
        use_handle:
            arena::Handle<typed_trees_to_checked_trees::checked_trees::CheckedOperatorUseFact>,
    }
    ...
    fn fixture() -> Fixture {
        ...
        let plans = crate::provider_planning::derive_satisfies_plans(
            &typed,
            crate::provider_planning::ProviderPlanDerivation::unevaluated(None),
        )
        .into_iter()
    ...
    fn exact_fixed_token_use_rewrites_to_selected_checked_adapter() {
        ...
        let settled =
            crate::selected_dispatch::settle_selected_execution_dispatch(settled, &selected)
    ...
    fn fixed_token_drift_rejects_before_mutation() {
        for drift in ["spelling", "status", "expression"] {
            ...
            *fixture
            ...
            let diagnostics = crate::selected_dispatch::settle_selected_execution_dispatch(
