...
use typed_trees_to_checked_trees::checked_trees::{
    CheckedBoundaryOperatorApplicationUseSite, CheckedTrees,
};
...
pub struct CheckedNongenericOperatorApplicationRealization {
    ...
    pub provider_plan_commitment:
        typed_trees_to_checked_trees::checked_trees::CheckedProviderPlanCommitment,
    pub realization_machine: SymbolHandle,
    pub realization_state: SymbolHandle,
    pub realization_contract_report_fingerprint: u64,
    pub realization_contract_commitment:
        typed_trees_to_checked_trees::checked_trees::MachineContractCommitment,
}
