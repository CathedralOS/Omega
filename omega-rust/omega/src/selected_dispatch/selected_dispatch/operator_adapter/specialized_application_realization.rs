...
pub struct CheckedSpecializedOperatorApplicationRealization {
    ...
    pub provider_plan_commitment: typed_trees_to_checked_trees::checked_trees::CheckedProviderPlanCommitment,
    pub realization_template: SymbolHandle,
    pub realization_machine: SymbolHandle,
    pub realization_state: SymbolHandle,
    pub specialization_commitment: symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::MachineSpecializationCommitment,
    pub realization_contract_report_fingerprint: u64,
    pub realization_contract_commitment: typed_trees_to_checked_trees::checked_trees::MachineContractCommitment,
}
...
fn derive_one(
    ...
    let replayed = typed_trees_to_checked_trees::validation::recompute_checked_machine_specialization_commitment(
        checked,
        realization_machine,
    )
    .map_err(|error| {
...
pub(super) fn applications_match(
    checked: &CheckedTrees,
    demand_row: &typed_trees_to_checked_trees::checked_trees::CheckedBoundaryOperatorApplicationDemand,
