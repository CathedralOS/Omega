...
use crate::provider_planning::{CompilerIntrinsicExecutionIdentity, ProviderSchemaDeclaration};
...
use abstract_operations_to_target_operations::effects::provider_plan::{
    ProviderBinding, ProviderPlan, ProviderPlanRow,
};
...
pub fn derive_selected_compiler_intrinsic_execution_identity_for_row_with_binding(
    ...
    realization_symbol: SymbolHandle,
    selected_target: Option<&str>,
    accepted_binding: Option<&crate::package_compilation::AcceptedSemanticBinding>,
...
pub fn derive_selected_compiler_intrinsic_execution_identity_for_row_with_resolved_binding(
    ...
    realization_symbol: SymbolHandle,
    selected_target: Option<&str>,
    accepted_binding: Option<&crate::selected_dispatch::ResolvedAcceptedSemanticBinding>,
    accepted_process_exit_binding: Option<
        &crate::selected_dispatch::ResolvedAcceptedSemanticBinding,
    >,
) -> Result<Option<SelectedCompilerIntrinsicExecutionIdentity>, Diagnostic> {
    derive_selected_compiler_intrinsic_execution_identity_for_row_with_binding_and_symbol(
        checked,
        ...
        realization_symbol,
        selected_target,
        accepted_binding.map(crate::selected_dispatch::ResolvedAcceptedSemanticBinding::accepted),
        accepted_binding
            .map(crate::selected_dispatch::ResolvedAcceptedSemanticBinding::declaration_symbol),
        accepted_process_exit_binding
            .map(crate::selected_dispatch::ResolvedAcceptedSemanticBinding::accepted),
        accepted_process_exit_binding
            .map(crate::selected_dispatch::ResolvedAcceptedSemanticBinding::declaration_symbol),
    )
}
    ...
    if matches!(schema, ProviderSchemaDeclaration::BoundaryOperator(_))
        || (matches!(schema, ProviderSchemaDeclaration::BoundaryRequirement(_))
            ...
            .is_some_and(|requirement| {
                requirement.kind
                    == crate::provider_planning::IntrinsicRequirementKind::TopLevelRequirement
            }))
    {
...
fn boundary_row_shape(
    ...
    if !crate::provider_planning::service_schema::schema_binds_exact_boundary_trait(
        typed,
        &plan.schema,
        definition,
...
pub(crate) fn accepted_binding_matches_selected_row_identity(
    ...
    let typed = &checked.typed;
    binding.role() == crate::package_compilation::AcceptedSemanticBindingRole::ConsoleExitProcessI32
...
fn exact_realization_contracts(
    ...
    matches!(
        ...
        symbol_resolved_trees_to_typed_trees::typed_trees::signature::SignatureContractKind::Crashes {
            cause: symbol_resolved_trees_to_typed_trees::typed_trees::signature::CrashCause::Trap,
        }
