...
pub struct ResolvedAcceptedSemanticBinding {
    accepted: crate::package_compilation::AcceptedSemanticBinding,
    declaration_symbol: SymbolHandle,
}

impl ResolvedAcceptedSemanticBinding {
    pub const fn accepted(&self) -> &crate::package_compilation::AcceptedSemanticBinding {
        &self.accepted
    }
    ...
    pub const fn role(&self) -> crate::package_compilation::AcceptedSemanticBindingRole {
        self.accepted.role()
    }
}
...
pub fn resolve_accepted_service_binding(
    ...
    binding: &crate::package_compilation::AcceptedSemanticBinding,
    ...
    if !matches!(
        ...
        crate::package_compilation::AcceptedSemanticBindingRole::FilesystemHostService
            ...
            | crate::package_compilation::AcceptedSemanticBindingRole::UefiX64ProgramEntry
            | crate::package_compilation::AcceptedSemanticBindingRole::MacosArm64ProgramEntry
            | crate::package_compilation::AcceptedSemanticBindingRole::MacosX64ProgramEntry
            | crate::package_compilation::AcceptedSemanticBindingRole::LinuxX86_64ProgramEntry
            | crate::package_compilation::AcceptedSemanticBindingRole::LinuxArm64ProgramEntry
            | crate::package_compilation::AcceptedSemanticBindingRole::WindowsX64ProgramEntry
    ...
    let matches = checked
        ...
        .filter_map(|definition| {
            ...
            let schema =
                crate::provider_planning::service_schema::from_typed(&checked.typed, definition)?;
            (schema.trait_package_identity == Some(binding.package())
                && crate::package_compilation::accepted_service_schema_digest(
                    binding.role(),
                    &schema,
...
pub fn retain_selected_compiler_intrinsic_review_identities(
    ...
    accepted_console_binding: Option<&crate::package_compilation::AcceptedSemanticBinding>,
    accepted_process_exit_binding: Option<&crate::package_compilation::AcceptedSemanticBinding>,
            ...
            match derive_selected_compiler_intrinsic_execution_identity_for_row_with_binding(
                ...
                *realization_symbol,
                ...
                Ok(Some(SelectedCompilerIntrinsicExecutionIdentity::Closed(identity))) => {
                    if identity == abstract_operations_to_target_operations::effects::CompilerIntrinsicExecutionIdentity::HostedExitProcessI32
                    {
                        accumulate_accepted_row_match(
                            checked,
                            plan,
...
fn accumulate_accepted_row_match(
    ...
    row: &abstract_operations_to_target_operations::effects::provider_plan::ProviderPlanRow,
    ...
    if let Some(binding) = accepted_console_binding {
        match crate::selected_dispatch::compiler_intrinsic::accepted_binding_matches_console_exit_process_i32_row(
            checked,
            plan,
            row,
            schema_symbol,
    ...
    if let Some(binding) = accepted_process_exit_binding {
        match crate::selected_dispatch::compiler_intrinsic::accepted_binding_matches_process_exit_i32_row(
            checked,
            plan,
            row,
            schema_symbol,
...
fn validate_terminal_authority_permissions(
    binding: &crate::package_compilation::AcceptedSemanticBinding,
    schema: &abstract_operations_to_target_operations::effects::provider_plan::ServiceSchema,
) -> Result<(), Diagnostic> {
...
mod tests {
    ...
    fn binding(requirement_identity: &str) -> crate::package_compilation::AcceptedSemanticBinding {
        let schema = schema();
        let schema_digest = schema.identity_digest();
        crate::package_compilation::AcceptedSemanticBinding::new_service(
            crate::package_compilation::AcceptedSemanticBindingRole::FilesystemHostService,
            package(),
            "FilesystemHost",
            schema_digest,
