...
use abstract_operations_to_target_operations::function_identity::{
    MachineFunctionIdentity, StateKey,
};
use std::sync::Arc;
...
mod tests {
    ...
    fn resource_receipt(
        ...
        typed_trees_to_checked_trees::checked_trees::CheckedCallbackResourceReceipt::try_from_entry_envelope(
            &typed_trees_to_checked_trees::checked_trees::CheckedEntryResourceEnvelope::from_checked_contract(
                machine,
                entry,
                0xfeed,
                typed_trees_to_checked_trees::checked_trees::MachineContractCommitment::from_digest([0x55; 32]),
            ),
        )
    ...
    fn placement() -> BoundNominalCallbackPlacement {
        ...
        let validated = abstract_operations_to_target_operations::calling_conventions::evaluate_ordinary_boundary_entry_plan(
        ...
        BoundNominalCallbackPlacement {
            site: NominalMachineUseSite::Expression(
                typed_trees_to_checked_trees::checked_trees::expression::ExpressionHandle::from_arena_index(9),
            ),
    ...
    fn replay_rejects_placement_thunk_and_private_symbol_substitution() {
        ...
        compact_equal_placement.boundary_entry_plan.state.preemption =
            abstract_operations_to_target_operations::calling_conventions::Preemption::ProviderDefined;
        assert_eq!(
