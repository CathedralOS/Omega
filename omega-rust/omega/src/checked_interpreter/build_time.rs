...
use crate::checked_interpreter::value::{Cell, Value};
...
pub struct SelectedBuildTimeBinaryOperator {
    ...
    pub origin: typed_trees_to_checked_trees::checked_trees::CheckedValueOrigin,
    pub requirement: symbols::SymbolHandle,
    pub operation: symbol_resolved_trees_to_typed_trees::typed_trees::expression::BinaryOperator,
    pub operands:
        [symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionHandle; 2],
    pub format: numerics::literals::FloatFormat,
    pub policy: typed_trees_to_checked_trees::checked_trees::CheckedArithmeticPolicyAdapter,
    pub provider: typed_trees_to_checked_trees::checked_trees::CheckedProviderPlanCommitment,
}

impl SelectedBuildTimeBinaryOperator {
    /// Inspect only this supplied selection, never unrelated operator overloads.
    pub fn has_crash_contract(
        &self,
