...
use crate::checked_interpreter::BuildEvaluationSponsorLimits;
use crate::checked_interpreter::FilesystemRootedPathOperandResolution;
use crate::checked_interpreter::interpreter::evaluator::BuildEvaluationSponsor;
use crate::checked_interpreter::interpreter::evaluator::Evaluator;
use crate::checked_interpreter::interpreter::evaluator::FilesystemLogicalHandleInput;
use crate::checked_interpreter::interpreter::evaluator::FilesystemLogicalHandleInputResolution;
use crate::checked_interpreter::interpreter::evaluator::FilesystemLogicalHandleKind;
use crate::checked_interpreter::interpreter::evaluator::FilesystemObservationProvider;
use crate::checked_interpreter::interpreter::evaluator::FilesystemOperationAttempt;
use crate::checked_interpreter::interpreter::evaluator::Halt;
use crate::checked_interpreter::interpreter::evaluator::MAX_FILESYSTEM_OBSERVATION_EVIDENCE_BYTES;
use crate::checked_interpreter::interpreter::evaluator::PreparedByteOutput;
use crate::checked_interpreter::interpreter::evaluator::PreparedFilesystemCall;
use crate::checked_interpreter::interpreter::evaluator::PreparedFilesystemLogicalHandleOutput;
use crate::checked_interpreter::interpreter::evaluator::VIRTUAL_GID;
use crate::checked_interpreter::interpreter::evaluator::VIRTUAL_UID;
use crate::checked_interpreter::interpreter::evaluator::Value;
use crate::checked_interpreter::interpreter::evaluator::checked_directory_name_snapshot_total;
use crate::checked_interpreter::interpreter::evaluator::checked_directory_record_snapshot_total;
use crate::checked_interpreter::interpreter::evaluator::filesystem::filesystem_calls::checked_observation_evidence_total;
use crate::checked_interpreter::interpreter::evaluator::pack_dirent_records;
use crate::checked_interpreter::interpreter::evaluator::portable_directory_entry_name;
...
fn rooted_path_resolution_budget_failure_is_atomic() {
    ...
    let resolution = FilesystemRootedPathOperandResolution {
        operand_ordinal: 0,
        root: crate::checked_interpreter::FilesystemGrantRootIdentity::new(1)
