...
use crate::checked_interpreter::interpreter::evaluator::{
    EvalResult, PreparedFilesystemCall, VIRTUAL_MTIME_SECS,
};
...
impl<'program> crate::checked_interpreter::interpreter::evaluator::Evaluator<'program> {
    ...
    pub(super) fn serve_open_create(&mut self, call: PreparedFilesystemCall) -> EvalResult<i64> {
        ...
        Ok({
            ...
            if crate::checked_interpreter::interpreter::evaluator::filesystem::host_open_flags::o_creat(flags)
                && crate::checked_interpreter::interpreter::evaluator::filesystem::host_open_flags::o_excl(flags)
                && exists
            {
