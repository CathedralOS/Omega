...
use crate::checked_interpreter::{
    FilesystemMetadataObservation, FilesystemMetadataObservationKind,
};
...
impl<'program> Evaluator<'program> {
    ...
    pub(crate) fn virtual_open_flags(&mut self, path: Vec<u8>, flags: i32) -> i32 {
        ...
        let o_creat = crate::checked_interpreter::interpreter::evaluator::filesystem::host_open_flags::o_creat(flags);
        let o_trunc = crate::checked_interpreter::interpreter::evaluator::filesystem::host_open_flags::o_trunc(flags);
        let o_append = crate::checked_interpreter::interpreter::evaluator::filesystem::host_open_flags::o_append(flags);
