...
#[derive(Debug)]
pub(in crate::checked_interpreter::interpreter::evaluator) enum FilesystemLogicalHandleError {
    IdentityExhausted,
...
#[derive(Debug)]
pub(in crate::checked_interpreter::interpreter::evaluator) struct FilesystemLogicalHandles {
    next_identity: u64,
...
impl FilesystemLogicalHandles {
    pub(in crate::checked_interpreter::interpreter::evaluator) fn resolve(
        &self,
        kind: FilesystemLogicalHandleKind,
        raw: i64,
        null_allowed: bool,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn conflicts_with_live_domain(
        &self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn create(
        &mut self,
        kind: FilesystemLogicalHandleKind,
        raw: i64,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn borrow_native(
        &mut self,
        raw: i64,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn retire(
        &mut self,
        kind: FilesystemLogicalHandleKind,
