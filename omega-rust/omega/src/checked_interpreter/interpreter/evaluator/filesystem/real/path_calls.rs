...
impl<'program> crate::checked_interpreter::interpreter::evaluator::Evaluator<'program> {
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_create(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_open_create(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
        ...
        Ok({
            ...
            let wants_write = access == 1
                || access == 2
                || crate::checked_interpreter::interpreter::evaluator::filesystem::host_open_flags::o_creat(flags)
                || crate::checked_interpreter::interpreter::evaluator::filesystem::host_open_flags::o_trunc(flags)
                || crate::checked_interpreter::interpreter::evaluator::filesystem::host_open_flags::o_append(flags);
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_open_path_handle(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_remove(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_remove_dir(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_rename(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_canonicalize(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_hard_link(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_create_hard_link(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_symlink(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_read_link(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_set_permissions(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_change_owner(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_unlink_at(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn real_open_at(
        &mut self,
        call: PreparedFilesystemCall,
    ) -> EvalResult<i64> {
