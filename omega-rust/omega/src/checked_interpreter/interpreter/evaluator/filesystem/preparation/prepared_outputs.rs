...
use crate::checked_interpreter::interpreter::evaluator::filesystem::preparation::check_byte_len;
use crate::checked_interpreter::interpreter::evaluator::{Cell, EvalResult, Halt, Value, trap};
...
pub(crate) enum PreparedByteOutput {
    Text {
        text: crate::checked_interpreter::value::TextBuffer,
        capacity: usize,
    },
    Array(Vec<Cell>),
}
