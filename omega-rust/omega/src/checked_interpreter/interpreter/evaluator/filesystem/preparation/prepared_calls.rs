...
use crate::checked_interpreter::interpreter::evaluator::filesystem::preparation::MAX_FILESYSTEM_TRANSFER_BYTES;
use crate::checked_interpreter::interpreter::evaluator::filesystem::preparation::logical_handle_plans::{
...
use crate::checked_interpreter::interpreter::evaluator::filesystem::preparation::prepared_outputs::{
    PreparedByteOutput, PreparedI64Output, PreparedMutableByteInput, PreparedTransferCount,
    prepared_byte,
};
use crate::checked_interpreter::interpreter::evaluator::filesystem::preparation::{
        ...
        let Some((root, relative)) = rooted_build_path_parts(&value)? else {
            if self.evaluator.rooted_build_paths_required
                && self
                    ...
                    .real_fs
                    .as_ref()
                    .is_some_and(crate::checked_interpreter::interpreter::evaluator::filesystem::real::RealFs::is_scoped)
            {
