...
impl<'program> Evaluator<'program> {
    ...
    fn resolved_logical_handle_input(
        ...
        operand_ordinal: u8,
        kind: FilesystemLogicalHandleKind,
    ) -> Option<crate::checked_interpreter::FilesystemLogicalHandleIdentity> {
        self.filesystem_operation_attempts[attempt_index]
            .logical_handle_inputs
            .iter()
...
fn filesystem_logical_handle_halt(
    ...
    use crate::checked_interpreter::interpreter::evaluator::filesystem::logical_handle_store::FilesystemLogicalHandleError as Error;
    match error {
