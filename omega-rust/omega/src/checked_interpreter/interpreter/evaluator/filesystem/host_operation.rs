...
pub(in crate::checked_interpreter::interpreter::evaluator) enum FilesystemHostOperandKind {
    PathBytes,
    Bytes,
    I32,
    U32,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::checked_interpreter::interpreter::evaluator) enum FilesystemHostResultKind {
    I32,
    I64,
}
