...
impl<'program> Evaluator<'program> {
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_build_log_write_line_value_call(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_build_log_write_line_statement(
        &mut self,
