...
use crate::checked_interpreter::{ExecutedProviderSelection, ExecutedProviderSelectionSite};
use language_semantics::declaration_selection::BuildOperation;

impl<'program> Evaluator<'program> {
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_provider_selection_statement(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_provider_selection_value_call(
        &mut self,
