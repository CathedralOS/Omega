...
impl<'program> Evaluator<'program> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_behavior_exclusion_statement(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_behavior_exclusion_value_call(
        &mut self,
