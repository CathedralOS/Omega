...
pub(in crate::checked_interpreter::interpreter::evaluator) const ROOTED_BUILD_PATH_TYPE: &str =
    "$OmegaBuildRootedPath";
const SOURCE_ROOT_FACET_TYPE: &str = "$OmegaBuildSourceRoot";
pub(in crate::checked_interpreter::interpreter::evaluator) const OUTPUT_ROOT_FACET_TYPE: &str =
    "$OmegaBuildOutputRoot";
...
impl<'program> Evaluator<'program> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_build_named_input_value_call(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn enable_rooted_build_paths_from_arguments(
        &mut self,
        arguments: &[crate::checked_interpreter::build_time::BuildTimeValue],
    ) {
        self.rooted_build_paths_required = arguments.iter().any(|argument| {
            let crate::checked_interpreter::build_time::BuildTimeValue::Struct { fields, .. } = argument else {
                return false;
            };
            fields.iter().any(|(_, value)| {
                matches!(
                    value,
                    crate::checked_interpreter::build_time::BuildTimeValue::Struct { type_name, .. }
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_build_root_resolve_value_call(
        &mut self,
        call: &symbol_resolved_trees_to_typed_trees::typed_trees::expression::TableCallExpression,
        frame: &mut Frame,
    ) -> EvalResult<Option<Value>> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_build_facet_filesystem_value_call(
        &mut self,
        call: &symbol_resolved_trees_to_typed_trees::typed_trees::expression::TableCallExpression,
        frame: &mut Frame,
    ) -> EvalResult<Option<Value>> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_build_facet_filesystem_statement(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_build_output_include_source_value_call(
        &mut self,
        call: &symbol_resolved_trees_to_typed_trees::typed_trees::expression::TableCallExpression,
        frame: &mut Frame,
    ) -> EvalResult<Option<Value>> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_build_output_include_source_statement(
        &mut self,
        call: &symbol_resolved_trees_to_typed_trees::typed_trees::statement::TableCall,
        frame: &mut Frame,
    ) -> EvalResult<bool> {
    ...
    fn try_include_source(
        ...
        let scoped_real_output = self.real_fs.as_ref().is_some_and(
            crate::checked_interpreter::interpreter::evaluator::filesystem::real::RealFs::is_scoped,
        );
        ...
        self.build_included_sources
            .push(crate::checked_interpreter::BuildIncludedSource::new(
                included_root,
                relative_path,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn statement_receiver_cell(
        &self,
        call: &TableCall,
        frame: &Frame,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn exact_build_facet_method(
        &self,
        expected_attached: &str,
        expected_state: &str,
        target_symbol: SymbolHandle,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn symbol_has_build_prelude_source(
        &self,
        symbol: SymbolHandle,
    ) -> bool {
        self.program
...
pub(in crate::checked_interpreter::interpreter::evaluator) fn rooted_build_path_parts(
    value: &Value,
...
pub(in crate::checked_interpreter::interpreter::evaluator) fn validate_build_relative_path(
    relative: &[u8],
) -> EvalResult<()> {
