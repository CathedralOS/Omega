...
pub(in crate::checked_interpreter::interpreter::evaluator) const PRODUCT_FACET_TYPE: &str =
    "$OmegaBuildProductFacet";
...
impl<'program> Evaluator<'program> {
    ...
    /// description marker.
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_build_product_entry_value_call(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_build_product_entry_statement(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn described_product_entry(
        &self,
        value: &Value,
    ) -> EvalResult<crate::checked_interpreter::DescribedProductEntry> {
        let Value::Struct {
            type_name, fields, ..
        } = value
        else {
    ...
    fn issue_product_entry_description(
        ...
        self.product_entry_descriptions
            .push(crate::checked_interpreter::DescribedProductEntry {
...
#[cfg(test)]
mod tests {
    use crate::checked_interpreter::interpreter::evaluator::{Evaluator, Halt};
    ...
    fn product_entry_description_requires_the_slot_compatibility_owner() {
        ...
        let typed = crate::checked_interpreter::front_end::typed_program_from_source_map(
            sources,
            &[(source_id, source)],
        );
