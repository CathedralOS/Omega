...
impl<'program> Evaluator<'program> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn exact_filesystem_host_operation(
        &self,
    ...
    /// Byte-exact custody for `crate::language::core::process_exit`: the
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn read_stdin_byte_value(
        &mut self,
        target: SymbolHandle,
    ) -> EvalResult<Value> {
        let requirement =
            typed_trees_to_checked_trees::validation::exact_compiler_intrinsic_boundary_requirement(self.program, target)
        ...
        let type_symbol = self
            ...
            .and_then(|signature| {
                typed_trees_to_checked_trees::validation::exact_byte_read_result_type(
                    self.program,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn read_stdin_line(
        &mut self,
    ) -> String {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn exit_process_call_requirement(
        &self,
        call: &TableCall,
        frame: &Frame,
    ...
    /// `crate::language::core::process_exit` toolchain custody owns one closed
    ...
    /// identity.
    pub(in crate::checked_interpreter::interpreter::evaluator) fn is_canonical_process_exit_requirement(
        &self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn is_boundary_call(
        &self,
        call: &TableCall,
        frame: &Frame,
    ) -> bool {
