...
use symbol_resolved_trees_to_typed_trees::typed_trees::expression::{
    MatchPattern, TableMatchArm, TableMatchExpression,
};
use typed_trees_to_checked_trees::checked_trees::CheckedOperatorOccurrence;

impl Evaluator<'_> {
    pub(in crate::checked_interpreter::interpreter::evaluator) fn select_match_arm(
        &mut self,
