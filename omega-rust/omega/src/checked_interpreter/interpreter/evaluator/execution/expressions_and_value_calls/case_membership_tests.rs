use crate::checked_interpreter::BuildMachineEntry;
use crate::checked_interpreter::InterpretOptions;
use crate::checked_interpreter::interpreter::evaluator::TypedTrees;
...
fn program(source: &str) -> TypedTrees {
    let mut program = crate::checked_interpreter::front_end::typed_program(source);
...
fn case_membership_rejects_invalid_classifier_and_foreign_runtime_owner() {
    ...
    *invalid.expression_table.expression_mut(classifier) = ExpressionNode::Boolean(true);
    ...
    literal.type_name =
        symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier::generated("Foreign");
...
fn case_membership_executes_checked_nested_structural_equality_synthesis() {
    for (right_case, right_active, expected) in [
        ...
        let typed = crate::checked_interpreter::front_end::typed_program(&source);
        ...
        let outcome = crate::checked_interpreter::interpret_entry(
            &checked,
