...
impl<'program> Evaluator<'program> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_wire_encode_call(
        &mut self,
        call: &TableCall,
        frame: &mut Frame,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn wire_encode_fields(
        &self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn wire_encode_body(
        &self,
        schema_name: &str,
        era: u64,
        ...
        use symbol_resolved_trees_to_typed_trees::typed_trees::wire::{
            WireFieldEncoding, wire_varint_bytes,
        };
            ...
            match content {
                ...
                WireInterpField::Repeated(repeated) => {
                    ...
                    let (items, live) = match repeated.carrier {
                        symbol_resolved_trees_to_typed_trees::typed_trees::wire::WireRepeatedCarrier::FixedArray => {
                            (raw.clone(), repeated.max_count)
                        }
                        symbol_resolved_trees_to_typed_trees::typed_trees::wire::WireRepeatedCarrier::FixedVec => {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn wire_encode_commit(
        &self,
        schema_name: &str,
        bytes: &[u8],
        has_text_field: bool,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn try_wire_decode_call(
        &mut self,
        call: &TableCall,
        frame: &mut Frame,
    ) -> EvalResult<Option<Value>> {
        ...
        let fields = self.wire_decode_fields(&schema_name, schema, |name| {
            symbol_resolved_trees_to_typed_trees::typed_trees::wire::data_field_type(
                self.program,
                value_type,
                name,
            )
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn wire_decode_fields(
        &self,
        schema_name: &str,
        schema: &symbol_resolved_trees_to_typed_trees::typed_trees::wire::WireSchema,
        ...
        for member in self.program.wire_members(schema.members) {
            ...
            if self.program.is_borrowed_byte_slice(field.type_reference) {
                ...
                for (domain_name, predicate) in
                    symbol_resolved_trees_to_typed_trees::typed_trees::byte_predicates::type_reference_domain_predicates(
                        self.program,
            ...
            fields.push((
                ...
                WireInterpScalarField::Scalar {
                    encoding,
                    range: typed_trees_to_checked_trees::validation::scalar_representation_range(
                        self.program,
                        target_type,
                    ),
                },
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn wire_decode_body(
        &mut self,
        schema_name: &str,
        era: u64,
        ...
        use symbol_resolved_trees_to_typed_trees::typed_trees::wire::wire_varint_bytes;
...
pub(in crate::checked_interpreter::interpreter::evaluator) enum WireInterpField {
    Direct(symbol_resolved_trees_to_typed_trees::typed_trees::wire::WireFieldEncoding),
    Nested(
        Vec<(
            String,
            u64,
            symbol_resolved_trees_to_typed_trees::typed_trees::wire::WireScalarEncoding,
        )>,
    ),
    Repeated(symbol_resolved_trees_to_typed_trees::typed_trees::wire::WireRepeatedEncoding),
    ScalarSlice(
        symbol_resolved_trees_to_typed_trees::typed_trees::wire::WireBorrowedScalarSliceEncoding,
    ),
...
pub(in crate::checked_interpreter::interpreter::evaluator) enum WireInterpScalarField {
    Scalar {
        encoding: symbol_resolved_trees_to_typed_trees::typed_trees::wire::WireScalarEncoding,
    ...
    Repeated {
        encoding: symbol_resolved_trees_to_typed_trees::typed_trees::wire::WireRepeatedEncoding,
        range: Option<language_semantics::wire::WireScalarRange>,
    },
    ...
    ByteSlice {
        predicates: Vec<symbol_resolved_trees_to_typed_trees::typed_trees::byte_predicates::ByteSequencePredicate>,
    },
}
...
pub(in crate::checked_interpreter::interpreter::evaluator) fn wire_nested_scalar_fields(
    program: &TypedTrees,
    child: &symbol_resolved_trees_to_typed_trees::typed_trees::wire::WireSchema,
) -> Result<
    Vec<(
        String,
        u64,
    ...
    Halt,
> {
    use symbol_resolved_trees_to_typed_trees::typed_trees::wire::{WireMember, WireScalarEncoding};
...
> {
    ...
    for member in program.wire_members(child.members) {
        ...
        let target_type = symbol_resolved_trees_to_typed_trees::typed_trees::wire::data_field_type(
            program,
            value_type,
            field.name.as_str(),
        )
    ...
    match program.expression_table.expression(expression) {
        ...
        ExpressionNode::Name(path) => {
            ...
            for member in members.iter().skip(1) {
                current = symbol_resolved_trees_to_typed_trees::typed_trees::wire::data_field_type(
                    program,
                    current,
                    member.as_str(),
                )?;
...
pub(in crate::checked_interpreter::interpreter::evaluator) fn wire_scalar_varint_value(
    raw: i64,
    scalar: symbol_resolved_trees_to_typed_trees::typed_trees::wire::WireScalarEncoding,
) -> Result<u64, Halt> {
...
pub(in crate::checked_interpreter::interpreter::evaluator) fn zigzag64(value: i64) -> u64 {
