...
impl<'program> Evaluator<'program> {
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_unary(
        &self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn named_float_operation_name(
        &self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_rewritten_ternary_float(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_rewritten_directed_binary(
        &mut self,
        arguments: &[ExpressionHandle],
        format: SemanticFloatFormat,
        intrinsic: &str,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_rewritten_directed_square_root(
        &mut self,
        arguments: &[ExpressionHandle],
        format: SemanticFloatFormat,
        intrinsic: &str,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_binary(
        &self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_float_binary(
        &self,
        operator: BinaryOperator,
        l: f64,
        r: f64,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_min_max(
        &self,
