...
impl<'program> Evaluator<'program> {
    pub(in crate::checked_interpreter::interpreter::evaluator) fn selected_boundary_adapter(
        &self,
    ...
    ) -> Option<typed_trees_to_checked_trees::checked_trees::CheckedBoundaryAdapterDispatch> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_boundary_receiver_path(
        &mut self,
        call: &TableCall,
        frame: &Frame,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn run_boundary_adapter(
        &mut self,
        dispatch: typed_trees_to_checked_trees::checked_trees::CheckedBoundaryAdapterDispatch,
