...
impl<'program> Evaluator<'program> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn cast_target_primitive(
        &self,
        target_type: symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_cast(
        &self,
        value: Value,
    ...
    /// (validation recasts.rs, rung A) guarantees equal scalar widths
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_interior_recast(
        &mut self,
