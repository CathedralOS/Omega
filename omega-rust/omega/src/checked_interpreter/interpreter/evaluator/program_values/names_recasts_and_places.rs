...
impl<'program> Evaluator<'program> {
    pub(in crate::checked_interpreter::interpreter::evaluator) fn field_cell(
        &self,
        container: &Cell,
        field: &str,
    ) -> EvalResult<Cell> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_name(
        &mut self,
        path: &TableNamePath,
        frame: &Frame,
    ) -> EvalResult<Value> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn mutable_scalar_recast_initializer(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn mutable_scalar_recast_target(
        &self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn mutable_recast_path(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn read_mutable_record_recast_target(
        &mut self,
        handle: ExpressionHandle,
        frame: &mut Frame,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn write_mutable_record_recast_target(
        &mut self,
        handle: ExpressionHandle,
        frame: &mut Frame,
        value: Value,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn enum_value_from_path(
        &self,
        path: &TableNamePath,
    ) -> EvalResult<Option<Value>> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn resolve_place(
        &mut self,
        handle: ExpressionHandle,
        frame: &mut Frame,
    ) -> EvalResult<Cell> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn declared_type_is_fixed_array(
        &self,
        ...
        {
            symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceNode::FixedArray { .. } => true,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn declared_type_is_bounded_byte_buffer(
        &self,
        type_reference: symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle,
    ) -> bool {
        if !type_reference.is_valid() {
        ...
        let has_value_domain = self
            ...
            .any(|constraint| match constraint {
                symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeConstraintNode::Domain(name) => {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn assignment_target_coercion(
        &mut self,
        handle: ExpressionHandle,
        frame: &mut Frame,
    ) -> Option<(
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn coerce_scalar_with(
        &self,
        value: Value,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn coerce_scalar_value(
        &self,
        value: Value,
        type_reference: symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle,
    ) -> EvalResult<Value> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn assignment_target_type_reference(
        &mut self,
        handle: ExpressionHandle,
        frame: &mut Frame,
    ) -> Option<symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn field_type_reference(
        &self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn deref_cell(
        &self,
        cell: Cell,
    ) -> Cell {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_index(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn element_cell(
        &self,
        container: &Cell,
        index: usize,
    ) -> EvalResult<Cell> {
    ...
    /// one.
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_subslice(
        &mut self,
...
mod tests {
    ...
    fn assert_exit_seven(source: &str) {
        let checked = crate::checked_interpreter::front_end::checked_program(source);
        let outcome = crate::checked_interpreter::interpret_entry(
            &checked,
            BuildMachineEntry::Name("main"),
            &[],
            crate::checked_interpreter::InterpretOptions::default(),
        );
...
"#,
    ...
    fn borrow_of_value_producing_call_still_fails() {
        ...
        let checked = crate::checked_interpreter::front_end::checked_program(
            r#"
machine once() -> i32 {
    transition { _ -> 0 }
}
