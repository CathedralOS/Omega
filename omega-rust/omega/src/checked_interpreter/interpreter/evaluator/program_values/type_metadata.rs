...
impl<'program> Evaluator<'program> {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_state_argument(
        &mut self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn expression_type_reference(
        &self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn collection_element_type(
        &self,
        mut type_reference: TypeReferenceHandle,
    ) -> Option<TypeReferenceHandle> {
        loop {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_recast_to_type(
        &self,
        value: Value,
    ...
    /// never be corrupted.
    pub(in crate::checked_interpreter::interpreter::evaluator) fn expression_is_unsigned64(
        &self,
    ...
    /// ADD itself).
    pub(in crate::checked_interpreter::interpreter::evaluator) fn expression_scalar_type(
        &self,
        expression: typed_trees_to_checked_trees::checked_trees::expression::ExpressionHandle,
        frame: &Frame,
