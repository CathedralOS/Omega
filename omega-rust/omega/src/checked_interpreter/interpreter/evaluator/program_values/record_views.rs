...
impl<'program> Evaluator<'program> {
    pub(in crate::checked_interpreter::interpreter::evaluator) fn assemble_scalar_byte_region(
        &self,
        cells: &[Cell],
        offset: usize,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn write_scalar_byte_region(
        &self,
        cells: &[Cell],
        offset: usize,
        target: PrimitiveType,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn write_stored_integer_byte_region(
        &self,
        cells: &[Cell],
        offset: usize,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn assemble_record_view_type(
        &self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn assemble_stored_integer_byte_region(
        &self,
        cells: &[Cell],
        offset: usize,
        target: PrimitiveType,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn record_view_type_layout(
        &self,
        type_reference: TypeReferenceHandle,
        visiting: &mut HashSet<String>,
    ) -> Option<(usize, usize)> {
    ...
    fn record_view_fields(
        ...
        Vec<(
            ...
            TypeReferenceHandle,
            usize,
            Option<symbol_resolved_trees_to_typed_trees::typed_trees::PlanLaidIntegerField>,
            Option<symbol_resolved_trees_to_typed_trees::typed_trees::PlanLaidRepeatedField>,
        )>,
    > {
        let data = self.find_data_by_name(type_name)?;
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn record_view_type_projection(
        &mut self,
        type_reference: TypeReferenceHandle,
        path: &[MutableRecordProjectionStep],
        base_offset: usize,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn declared_type_is_slice(
        &self,
        type_reference: TypeReferenceHandle,
    ) -> bool {
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn snapshot_typed_value_bytes(
        &self,
        source: &Cell,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn commit_typed_value_bytes(
        &self,
        source: &Cell,
        source_type: TypeReferenceHandle,
        cells: &[Cell],
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn write_record_view_type(
        &self,
        type_reference: TypeReferenceHandle,
        cells: &[Cell],
        base_offset: usize,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn eval_recast(
        &self,
        value: Value,
