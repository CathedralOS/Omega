use crate::checked_interpreter::interpreter::evaluator::{
    DataDefinition, Evaluator, Machine, State,
};
...
impl<'program> Evaluator<'program> {
    pub(in crate::checked_interpreter::interpreter::evaluator) fn find_machine_by_name(
        &self,
        name: &str,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn find_machine_by_symbol(
        &self,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn find_state(
        &self,
        machine: &Machine,
        name: &str,
    ...
    pub(in crate::checked_interpreter::interpreter::evaluator) fn find_data_by_name(
        &self,
        name: &str,
