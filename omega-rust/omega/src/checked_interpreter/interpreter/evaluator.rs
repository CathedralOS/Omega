...
use crate::checked_interpreter::build_evaluation_sponsor::BuildEvaluationLiveFilesystemHandleLease;
use crate::checked_interpreter::value::{Cell, CellMeter, TextByteMeter, Value};
...
use typed_trees_to_checked_trees::checked_trees::{CheckedOperatorFacts, CheckedTrees};
...
use crate::checked_interpreter::interpreter::evaluator::filesystem::logical_handle_store::FilesystemLogicalHandles;
...
struct MutableRecordProjection {
    ...
    stored_integer: Option<symbol_resolved_trees_to_typed_trees::typed_trees::PlanLaidIntegerField>,
}
...
pub(crate) struct Evaluator<'program> {
    ...
    boundary_adapter_dispatch:
        &'program [typed_trees_to_checked_trees::checked_trees::CheckedBoundaryAdapterDispatch],
    pub(super) selected_build_time_operators:
        &'program [crate::checked_interpreter::SelectedBuildTimeBinaryOperator],
    ...
    pub(super) executed_root_bindings: Vec<crate::checked_interpreter::ExecutedRootBinding>,
    /// Executed `exclude_crash`/`exclude_service` selections on the root
    /// Build, in evaluation order.
    pub(super) executed_behavior_exclusions:
        Vec<crate::checked_interpreter::ExecutedBehaviorExclusion>,
    pub(super) executed_provider_selections:
        Vec<crate::checked_interpreter::ExecutedProviderSelection>,
    ...
    /// selection payload.
    product_entry_descriptions: Vec<crate::checked_interpreter::DescribedProductEntry>,
    pub(super) product_entry_compatibility:
        Option<&'program dyn crate::checked_interpreter::ProductEntryCompatibility>,
    ...
    product_schema_descriptions: Vec<crate::checked_interpreter::DescribedProductSchema>,
    ...
    /// sanctioned inspection.
    product_provider_descriptions: Vec<crate::checked_interpreter::DescribedProductProvider>,
    stdin: &'program [u8],
    stdin_cursor: usize,
    ...
    /// real disk.
    pub(super) real_fs:
        Option<crate::checked_interpreter::interpreter::evaluator::filesystem::real::RealFs>,
    ...
    pub(super) build_included_sources: Vec<crate::checked_interpreter::BuildIncludedSource>,
    ...
    pub(super) output_obligations: Vec<crate::checked_interpreter::BuildOutputObligation>,
    ...
    pub(super) output_receipts: Vec<crate::checked_interpreter::BuildOutputReceipt>,
    ...
    filesystem_live_handle_leases: BTreeMap<
        crate::checked_interpreter::FilesystemLogicalHandleIdentity,
        BuildEvaluationLiveFilesystemHandleLease,
    >,
