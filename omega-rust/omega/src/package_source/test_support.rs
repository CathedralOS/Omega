...
use crate::package_source::git::resolution::resolve_git_source;
use crate::package_source::limits::LocalSourceLimits;
use crate::package_source::local::operations::resolve_local_source_snapshot;
use crate::package_source::local::resolution_observations::ResolvedLocalSnapshot;
...
#[cfg(unix)]
pub(crate) fn shell_command(script: &str) -> crate::resolver_execution::ResolverPreparedExecution {
