...
use crate::package_source::test_support::temp_root;
...
fn source_identity_excludes_host_change_indicators() {
    ...
    let before = crate::package_source::resolve_local_source(
        &fixture.root,
    ...
    let after = crate::package_source::resolve_local_source(
        &fixture.root,
        crate::package_source::LocalSourceLimits::default(),
    )
