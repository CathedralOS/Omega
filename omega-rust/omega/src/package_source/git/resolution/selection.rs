...
use crate::package_source::git::objects::authentication::verify_exact_git_revision;
use crate::package_source::git::request::GitSourceRequest;
use crate::package_source::identity::{GitCommitId, GitObjectIdAlgorithm, GitTreeId};
use crate::package_source::observations::resolved::GitAcquisitionPin;
