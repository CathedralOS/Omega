...
use crate::package_source::git::objects::authentication::authenticate_git_commit;
...
use crate::package_source::limits::{GIT_CONFIG_SHA1, GIT_CONFIG_SHA256, LocalSourceLimits};
