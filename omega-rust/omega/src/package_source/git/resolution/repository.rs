...
use crate::package_source::git::objects::authentication::{
    authenticate_git_commit, verify_exact_git_revision,
};
use crate::package_source::git::objects::identity::{git_object_algorithm, is_object_id};
use crate::package_source::git::objects::{ExactGitObjectAvailability, probe_exact_git_object};
...
use crate::package_source::identity::SourceLineage;
use crate::package_source::limits::LocalSourceLimits;
use crate::package_source::observations::resolved::PendingResolvedGitSource;
