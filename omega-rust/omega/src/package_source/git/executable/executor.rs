...
use crate::package_source::git::git_command::capture::duration_millis;
...
use crate::resolver_execution::ResolverExecutionBackend;
use std::cell::Cell;
#[cfg(all(test, unix))]
use std::path::Path;
...
impl crate::package_source::custody::lock::CacheLockBudget for GitExecutor {
...
pub(crate) fn git_resolution_captured_output_ceiling(limits: LocalSourceLimits) -> u64 {
    limits
        .max_bytes
        .saturating_add(crate::package_source::limits::GIT_CAPTURED_OUTPUT_FIXED_ALLOWANCE)
        .min(crate::package_source::limits::GIT_CAPTURED_OUTPUT_ABSOLUTE_LIMIT)
}
