...
use crate::package_source::identity::digest::format_sha256;
use crate::package_source::identity::{GitTransport, IdentityError, SourceLineage};
use crate::package_source::limits::{GIT_LOCATOR_BYTE_LIMIT, GIT_REVISION_BYTE_LIMIT};
#[cfg(any(test, feature = "test-fixtures"))]
