...
use crate::package_source::identity::SourceRelativePath;
use crate::package_source::limits::{CANONICAL_DIRECTORY_MODE, LocalSourceLimits};
...
fn replace_file(
    ...
    let Some(crate::package_source::tree::capture::CapturedLocalEntry {
