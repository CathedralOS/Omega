use crate::package_source::git::request::GitTransportProfile;
use crate::package_source::git::workspace::GitWorkspaceProjectionCustody;
use crate::package_source::identity::{GitObjectIdAlgorithm, SourceLineage, SourceRelativePath};
