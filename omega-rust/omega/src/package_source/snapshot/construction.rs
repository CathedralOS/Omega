...
#[cfg(not(unix))]
use crate::package_source::error::git_tree_invalid;
...
pub(crate) fn open_or_create_snapshot_directory(
...
pub(crate) fn write_snapshot_file_from_open_root(
    kind: CacheCustodyKind,
    root: &CapabilityDirectory,
    relative_path: &Path,
    display_root: &Path,
...
#[cfg(unix)]
pub(crate) fn create_snapshot_symlink_from_open_root(
    kind: CacheCustodyKind,
    root: &CapabilityDirectory,
    relative_path: &Path,
    display_root: &Path,
