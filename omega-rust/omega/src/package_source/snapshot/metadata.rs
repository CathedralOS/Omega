...
use crate::package_source::custody::tree::{CacheCustodyKind, read_bounded_cache_record};
use crate::package_source::error::local_snapshot_invalid;
use crate::package_source::identity::digest::append_framed_bytes;
...
use crate::package_source::tree::capture::{SourceTreePolicy, capture_local_source_from_open_root};
...
pub(crate) fn local_snapshot_metadata(local: &ResolvedLocalSource) -> Vec<u8> {
...
pub(crate) fn verify_local_snapshot(
    publication: &Path,
