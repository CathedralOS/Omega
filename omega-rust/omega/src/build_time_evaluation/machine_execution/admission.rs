...
use crate::checked_interpreter::{BuildMachineEvaluationRequest, BuildTimeOperationEvaluation};
...
pub struct BuildTimeAdmissionPlan {
    service_reaches: typed_trees_to_checked_trees::flow_effects::ServiceReachInferencePlan,
    ...
    selected_operators: Vec<crate::build_time_evaluation::SelectedBuildTimeBinaryOperator>,
}
...
impl BuildTimeAdmissionPlan {
    pub fn infer(
        ...
        let operational = typed_trees_to_checked_trees::validation::infer_operational_may(program);
        let service_reaches =
            typed_trees_to_checked_trees::validation::infer_service_reaches(program, &operational);
    ...
    pub fn with_selected_operators(
        ...
        crate::build_time_evaluation::validate_selected_operators(program, operators)?;
    ...
    fn require_floor(
        ...
        crate::build_time_evaluation::validate_selected_operators(
            program,
    ...
    pub fn evaluate_machine(
        ...
        crate::checked_interpreter::evaluate_build_time_machine(
            program,
    ...
    pub fn evaluate_machine_symbol_for_invocation_measured(
        ...
        arguments: Vec<BuildTimeValue>,
        custody: BuildTimeInvocationCustody,
    ) -> Result<crate::build_time_evaluation::MeasuredEvaluation<BuildTimeValue>, String> {
        let machine = program
            .machines()
            .iter()
    ...
    pub fn evaluate_const_evaluable_machine(
        ...
        let value = crate::checked_interpreter::evaluate_build_time_machine(
            program,
    ...
    pub fn evaluate_const_evaluable_machine_symbol_for_invocation(
        ...
        .map(crate::build_time_evaluation::MeasuredEvaluation::into_value)
    }
    ...
    fn evaluate_const_evaluable_invocation_measured(
        ...
        let measured = crate::checked_interpreter::evaluate_build_time_machine(
            program,
            BuildMachineEvaluationRequest {
                product_entry_compatibility: None,
                operators: &self.selected_operators,
...
fn project_operational_axes(
    operational: &typed_trees_to_checked_trees::flow_effects::OperationalPlan,
) -> (
...
mod tests {
    ...
    use typed_trees_to_checked_trees::flow_effects::{
