...
pub(crate) fn defer_pending_const_qualifications(
    probe: &mut tokens_to_syntax_trees::syntax_trees::SyntaxTrees,
    arguments: &[tokens_to_syntax_trees::syntax_trees::types::TypeReferenceHandle],
) {
...
mod tests {
    ...
    fn pending_index_probe_retains_unrelated_constant_qualifications() {
        let original = crate::build_time_evaluation::front_end::syntax_program(
