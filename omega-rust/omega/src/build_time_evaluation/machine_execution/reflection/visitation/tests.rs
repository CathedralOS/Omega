...
use crate::build_time_evaluation::machine_execution::reflection::{
...
fn record_plan_composes_calls_in_declaration_order() {
    let typed = crate::build_time_evaluation::front_end::typed_program(ENCODE_PROGRAM);
...
fn sum_plan_covers_cases_and_payloads_with_member_kinds() {
    let typed = crate::build_time_evaluation::front_end::typed_program(SUM_PROGRAM);
...
fn erased_member_with_a_selection_rejects_at_compose() {
    let typed = crate::build_time_evaluation::front_end::typed_program(ERASED_PROGRAM);
...
fn compose_rejects_a_snapshot_that_does_not_replay() {
    let program = crate::build_time_evaluation::front_end::typed_program(ENCODE_PROGRAM);
    ...
    let other = crate::build_time_evaluation::front_end::typed_program(
