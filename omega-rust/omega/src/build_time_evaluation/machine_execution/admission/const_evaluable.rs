...
mod tests {
    ...
    fn closed_generic_instance_snapshots_are_value_sensitive() {
        let typed = crate::build_time_evaluation::front_end::typed_program_with_generic_data(
            r#"
    ...
    fn nominal_spelling_uses_selected_home_identity() {
        ...
        let mut typed = crate::build_time_evaluation::front_end::typed_program(SOURCE);
        let return_type = {
            let machine = typed
