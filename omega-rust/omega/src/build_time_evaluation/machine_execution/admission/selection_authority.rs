...
pub(super) fn selection_authority_violation(
    ...
    selected: &[crate::build_time_evaluation::SelectedBuildTimeBinaryOperator],
    ...
    if let Some(authority) = authority {
        ...
        for (occurrence_offset, occurrence) in occurrences.iter().copied().enumerate() {
            ...
            if typed_trees_to_checked_trees::typed_build_provider_selection(program, expression) {
                use symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionKind as Kind;
                ...
                if selection.kind() == Kind::StaticArgument {
                    ...
                    if let symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionTarget::Resolved(retained) =
                        selection.target()
            ...
            let owner = match selection.target() {
                symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionTarget::Intrinsic(_) => continue,
                symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionTarget::LateBound(binding) => {
                    if binding
                        == symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionLateBinding::CheckedOperator
                ...
                symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionTarget::Resolved(selected) => {
...
fn unresolved_spelling_confinement(
    ...
    requester: PackageCustody,
    authority: &dyn BuildTimeSelectionAuthority,
    binding: symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionLateBinding,
) -> Result<(), String> {
    use symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionLateBinding as Binding;
...
fn late_bound_selection_symbol(
    program: &TypedTrees,
    expression: ExpressionHandle,
    prior_occurrences: &[symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionOccurrenceId],
    binding: symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionLateBinding,
) -> Option<SymbolHandle> {
    use symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionLateBinding as Binding;
...
mod tests {
    ...
    fn unresolved_named_operator_call_rejoins_its_exact_typed_declaration() {
        ...
        let operational = typed_trees_to_checked_trees::validation::infer_operational_may(&typed);
    ...
    fn builtin_static_argument_uses_exact_compiler_type_identity() {
        let mut typed =
            crate::build_time_evaluation::front_end::typed_program("machine probe() -> u64 { 7 }");
        let builtin = typed
            .symbols
    ...
    fn builtin_static_argument_does_not_admit_missing_symbol_custody() {
        ...
        assert!(
            typed
                .record_resolved_authored_declaration_selection_once(
                    source::SourceSpan::default(),
                    symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionExposure::PrivateImplementation,
                    symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionKind::StaticArgument,
                    missing,
                )
                .is_err()
        );
        ...
        program
            ...
            .find_map(|member| match member {
                symbol_resolved_trees_to_typed_trees::typed_trees::data::DataMember::Variant(
                    variant,
                ) if variant.name.as_str() == case => program
    ...
    fn destructure_payload_member_resolves_to_its_exact_owner_not_a_same_spelled_member() {
        let typed =
            crate::build_time_evaluation::front_end::typed_program(PAYLOAD_PROJECTION_SOURCE);
        for name in ["first_field", "field_count"] {
            ...
            assert_eq!(
                late_bound_selection_symbol(
                    ...
                    expression,
                    &[],
                    symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionLateBinding::CheckedMember,
                ),
    ...
    fn packaged_typed_from_source(source: &str) -> TypedTrees {
        ...
        let source_id = sources
            ...
            .source_id;
        crate::build_time_evaluation::front_end::typed_program_from_source_map(
            sources,
            &[(source_id, source)],
        )
    }
