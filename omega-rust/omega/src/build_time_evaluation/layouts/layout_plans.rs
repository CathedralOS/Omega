...
pub use crate::checked_interpreter::BuildTimeValue;
...
pub use terminal_psi::layout_plans::{
...
pub type NativeLayoutPlanReport = terminal_psi::layout_plans::NativeLayoutPlanReport<
    symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::ClosedConformanceApplication,
>;
pub type PrivateCallbackLayoutDemandReport = terminal_psi::layout_plans::PrivateCallbackLayoutDemandReport<
    symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::ClosedConformanceApplication,
>;
...
pub fn compute_layout_plan(
    ...
    policy_machine: &str,
    schema_data: &str,
    selection: Option<crate::build_time_evaluation::AuthorizedSelection>,
...
pub fn compute_native_layout_plan(
    ...
    let evaluation = crate::checked_interpreter::evaluate_build_time_machine(
        typed,
...
fn normalize_private_callback_demands(
    typed: &TypedTrees,
    policy_machine: &symbol_resolved_trees_to_typed_trees::typed_trees::machine::Machine,
    receipts: &[crate::checked_interpreter::PrivateLayoutPlacementReceipt],
    policy_name: &str,
