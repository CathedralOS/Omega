...
use crate::build_time_evaluation::layouts::layout_plans::normalized_schema_report_fingerprint;
use crate::build_time_evaluation::layouts::layout_plans::{
    checked_align_up, reflected_nested_member_layout,
};
use terminal_psi::layout_plans::LayoutPlacementReport;
...
fn one_nested_sum_retains_both_layouts_selection_byte_order_and_zero_padding() {
    let typed = crate::build_time_evaluation::front_end::typed_program(SOURCE);
