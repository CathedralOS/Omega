...
use crate::build_time_evaluation::layouts::layout_plans::const_record_with_nested_sum_materializable::derivation::{
...
struct NestedPathOccurrenceView<'a> {
    outer_field: &'a str,
    outer_member_identity: Option<u64>,
    inner_layout: &'a terminal_psi::layout_plans::LayoutPlanReport,
    child_sum_layouts: &'a [terminal_psi::layout_plans::ConventionalSumFieldLayoutReport],
}
...
impl<'a> NestedPathsView<'a> {
    fn outer_layout(self) -> &'a terminal_psi::layout_plans::LayoutPlanReport {
        match self {
