...
pub fn normalized_schema_report_fingerprint(
    ...
    symbol_resolved_trees_to_typed_trees::typed_trees::identity::normalized_schema_report_fingerprint(typed, data)
}
...
fn declared_source_bits(
    ...
    let Some(range) = typed_trees_to_checked_trees::validation::scalar_representation_range(
        typed,
        type_reference,
    ) else {
        return byte_size * 8;
