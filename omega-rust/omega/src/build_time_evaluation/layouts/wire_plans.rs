...
use symbol_resolved_trees_to_typed_trees::typed_trees::wire::{WireMember, WirePlacement};
...
pub fn compute_wire_plans(
    ...
    let admission = policy_exists.then(|| {
        crate::build_time_evaluation::BuildTimeAdmissionPlan::infer(typed, selection_authority)
    });
    ...
    for (symbol, schema_name, fields) in classified {
        ...
        if policy_exists {
            ...
            let authored = evaluate_wire_policy(
                ...
                &schema_name,
                &fields,
                crate::build_time_evaluation::BuildTimeInvocationCustody::Symbol(symbol),
            )
        ...
        let obligations = fields
            ...
            .filter_map(|&(field_number, shape)| {
                ...
                Some(symbol_resolved_trees_to_typed_trees::typed_trees::wire::WireEncodeObligation {
                    field_number,
                    element,
