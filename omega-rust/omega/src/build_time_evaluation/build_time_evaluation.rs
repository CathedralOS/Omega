...
pub struct BuildTimeEvaluationRequest<'source> {
    pub syntax_trees: tokens_to_syntax_trees::syntax_trees::SyntaxTrees,
...
pub struct AuthorizedSelection {
    ...
    pub custody: crate::build_time_evaluation::BuildTimeInvocationCustody,
}
...
pub struct PreResolutionEvaluation {
    syntax_trees: tokens_to_syntax_trees::syntax_trees::SyntaxTrees,
    pre_check: PreCheckEvaluation,
}
...
impl PreResolutionEvaluation {
    ...
    pub fn into_syntax_and_pre_check(
        self,
    ) -> (
