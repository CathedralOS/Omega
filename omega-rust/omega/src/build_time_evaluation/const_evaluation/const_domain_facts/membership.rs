use crate::checked_interpreter::BuildTimeValue;
...
pub(in crate::build_time_evaluation::const_evaluation) fn evaluate_closed_membership(
    typed: &TypedTrees,
    admission: &BuildTimeAdmissionPlan,
...
pub(super) fn domain_facts_need_operator_selection(
    typed: &TypedTrees,
    admission: &BuildTimeAdmissionPlan,
    facts: &typed_trees_to_checked_trees::checked_trees::CheckedOperatorFacts,
    domain_symbol: symbols::SymbolHandle,
...
fn evaluate_machine_fact(
    ...
    let fact_holds = match admission.evaluate_const_evaluable_machine_for_invocation(
        ...
        crate::build_time_evaluation::BuildTimeInvocationCustody::Source(
