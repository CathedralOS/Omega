...
use tokens_to_syntax_trees::syntax_trees::item::{Item, Machine, State};
...
use tokens_to_syntax_trees::syntax_trees::types::{
    ConstArgumentOrigin, TypeReferenceHandle, TypeReferenceNode,
};
...
pub(super) fn expression_custody(
    ...
    public: bool,
    syntax: &SyntaxTrees,
    admitted_calls: &std::collections::HashSet<
    ...
    while let Some(expression) = pending.pop() {
            ...
            .authored_selection_occurrences(expression)
        {
            ...
            if selection.kind() == Kind::Call {
                // A call statically admitted beneath a successfully folded bound
                // owes invocation custody, not a normalized-constant origin.
                // The endpoint evaluator checks every call before selective
                // execution; this set makes no claim that a skipped call ran.
                if !admitted_calls.contains(&expression)
...
fn inherits_normalized_constant_call(
    program: &symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees,
    expression: symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionHandle,
    call_occurrence: symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionOccurrenceId,
) -> bool {
...
pub(super) fn call_expressions(
    program: &symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees,
    roots: &[symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionHandle],
) -> Result<
...
pub(crate) fn validate_retained_initializer_call_custody(
    ...
    state: &symbol_resolved_trees_to_typed_trees::typed_trees::state::State,
    root: symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionHandle,
    materialized: symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionHandle,
...
fn evaluate_probe_internal(
    ...
    let symbol_resolved_trees_to_typed_trees::typed_trees::statement::TransitionTargetNode::Value(
        expression,
