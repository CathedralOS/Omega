...
pub(in crate::build_time_evaluation::const_evaluation) use membership::evaluate_closed_membership;
...
pub fn evaluate_const_domain_facts(
    ...
    evaluate_selected_domain_facts(
        typed,
        selection_authority,
        crate::build_time_evaluation::SelectedBuildTimeOperators::default(),
    )
}
