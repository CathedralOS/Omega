...
use crate::build_time_evaluation::machine_execution::admission::{
    expression_children, require_closed_expression_custody,
};
...
fn evaluate_const_application(
    ...
    let carrier = crate::build_time_evaluation::const_evaluation::const_generic_expressions::exact_probe_destination(
        execution,
        destination,
    )
    .ok_or(
    ...
    let invocation =
        crate::build_time_evaluation::const_evaluation::range_endpoints::arguments::Invocation {
            working: typed,
            execution,
            admission,
    ...
    let (value, additions) =
        crate::build_time_evaluation::const_evaluation::const_generic_expressions::value::evaluate_closed_const_argument(
            execution,
            application.root,
            carrier,
            &invocation,
...
) -> Result<crate::build_time_evaluation::const_evaluation::range_endpoints::EndpointCallee, String>
{
    crate::build_time_evaluation::const_evaluation::range_endpoints::resolve_endpoint_callee(
        execution,
        &crate::build_time_evaluation::const_evaluation::range_endpoints::PendingEndpoint {
...
fn generic_type_parameters(
    typed: &TypedTrees,
    base_symbol: SymbolHandle,
) -> Option<&[symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameter]> {
...
fn visit_argument(
    ...
    match typed.type_reference_table.type_reference(reference) {
        TypeReferenceNode::ConstExpression(root) => {
            ...
            if crate::build_time_evaluation::const_evaluation::range_endpoints::selected_endpoint_machine(typed, *root)
                .is_none()
            {
                return;
            }
            ...
            plan.calls.extend(calls.into_iter().map(|call| {
                let (machine, static_application) =
                    crate::build_time_evaluation::const_evaluation::range_endpoints::selected_endpoint_machine(
                        typed, call,
                    )
