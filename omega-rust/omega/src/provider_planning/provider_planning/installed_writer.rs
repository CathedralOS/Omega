...
pub struct SelectedExternalRootProviderPlan {
    pub identity: crate::external_roots::ProviderPlanId,
    pub digest:
...
pub struct SelectedExternalRootPostHandoffWriterPreparation<'installed, 'mapping, 'bytes> {
    ...
    lowered: crate::post_handoff_writer::LoweredPostHandoffWriter,
    installed_code: &'installed crate::executable_installation::InstalledCode,
    prepared: crate::external_roots::PreparedExternalRootPostHandoffWriterInvocation,
    ...
    SelectedExternalRootPostHandoffWriterPreparation<'installed, 'mapping, 'bytes>
{
    ...
    pub const fn prepared(
        &self,
    ) -> &crate::external_roots::PreparedExternalRootPostHandoffWriterInvocation {
        &self.prepared
    }

    pub const fn lowered(&self) -> &crate::post_handoff_writer::LoweredPostHandoffWriter {
        &self.lowered
    }

    pub const fn installed_code(
        &self,
    ) -> &'installed crate::executable_installation::InstalledCode {
        self.installed_code
    }
...
pub struct SelectedExternalRootWriterPreparationError<'mapping, 'bytes> {
    ...
    lowered: crate::post_handoff_writer::LoweredPostHandoffWriter,
    destination:
        crate::executable_installation::PreparedPostHandoffWriterDestination<'mapping, 'bytes>,
    diagnostic: crate::external_roots::ExternalRootDiagnostic,
}

impl<'mapping, 'bytes> SelectedExternalRootWriterPreparationError<'mapping, 'bytes> {
    pub const fn diagnostic(&self) -> &crate::external_roots::ExternalRootDiagnostic {
        &self.diagnostic
    }
    ...
    pub fn into_parts(
        ...
        crate::post_handoff_writer::LoweredPostHandoffWriter,
        crate::executable_installation::PreparedPostHandoffWriterDestination<'mapping, 'bytes>,
    ) {
...
pub struct WrittenBoundExternalRootPostHandoffWriterDestination<'installed, 'mapping, 'bytes> {
    ...
    installed_code: &'installed crate::executable_installation::InstalledCode,
    written:
        crate::external_roots::WrittenExternalRootPostHandoffWriterDestination<'mapping, 'bytes>,
}
...
> {
    ...
    lowered: crate::post_handoff_writer::LoweredPostHandoffWriter,
    installed_code: &'installed crate::executable_installation::InstalledCode,
    written: crate::external_roots::ValidatedWrittenExternalRootPostHandoffWriterDestination<
        'mapping,
        'bytes,
    >,
}
    ...
    WrittenBoundExternalRootPostHandoffWriterDestination<'installed, 'mapping, 'bytes>
{
    ...
    pub fn validate_for_consumer(
        ...
        crate::post_handoff_writer::validate_lowered_post_handoff_writer(&self.lowered).map_err(
            |diagnostic| terminal_psi::layout_plans::MaterializationDiagnostic(diagnostic.message),
        )?;
    ...
    pub fn into_validated_for_consumer(
        self,
        installed_code: &crate::executable_installation::InstalledCode,
    ) -> Result<
    ...
    > {
        let diagnostic = if !std::ptr::eq(self.installed_code, installed_code) {
            Some(terminal_psi::layout_plans::MaterializationDiagnostic(
    ...
    ValidatedWrittenBoundExternalRootPostHandoffWriterDestination<'installed, 'mapping, 'bytes>
{
    ...
    pub const fn provider_execution(&self) -> crate::external_roots::AdmittedProviderExecution {
        self.written.provider_execution()
    }

    pub const fn selected_entry(&self) -> terminal_psi::layout_plans::EntryStubId {
    ...
    pub fn into_parts(
        ...
        crate::post_handoff_writer::LoweredPostHandoffWriter,
        &'installed crate::executable_installation::InstalledCode,
        crate::external_roots::ValidatedWrittenExternalRootPostHandoffWriterDestination<
            'mapping,
            'bytes,
        >,
    ) {
...
fn validate_selected_provider_written_source(
    selected_provider: &SelectedExternalRootProviderPlan,
    written: &crate::external_roots::WrittenExternalRootPostHandoffWriterDestination<'_, '_>,
) -> Result<(), terminal_psi::layout_plans::MaterializationDiagnostic> {
    validate_selected_provider_source(
        selected_provider,
...
fn validate_selected_provider_source(
    ...
    boundary_contract_commitment: abstract_operations_to_target_operations::effects::provider_plan::BoundaryCallingPlanCommitment,
    root_entry_claims: &[crate::external_roots::ExternalRootEntryClaim],
    provider_plan: u64,
    provider_plan_digest: abstract_operations_to_target_operations::effects::provider_plan::ProviderPlanDigest,
) -> Result<(), terminal_psi::layout_plans::MaterializationDiagnostic> {
...
> {
    ...
    if let Err(diagnostic) =
        crate::post_handoff_writer::validate_lowered_post_handoff_writer(lowered)
    {
...
pub struct SelectedExternalRootEntryFactBinding {
    provider_plan: crate::external_roots::ProviderPlanId,
    ...
    checked_fact: typed_trees_to_checked_trees::fact_plan::FactHandle,
}
...
pub struct AdmittedExternalRootEntryFactHandoff<'entry, 'storage> {
    occurrence: &'entry crate::external_roots::AdmittedEntryQualification,
    implementation_machine: symbols::SymbolHandle,
    implementation_state: symbols::SymbolHandle,
    checked_fact: typed_trees_to_checked_trees::fact_plan::FactHandle,
    parameter_symbol: symbols::SymbolHandle,
    storage: &'storage resolved_layout_to_resolved_layout::program_entry_plan::DerivedBoundaryEntryParameterStorage,
}

impl<'entry, 'storage> AdmittedExternalRootEntryFactHandoff<'entry, 'storage> {
    pub const fn occurrence(&self) -> &'entry crate::external_roots::AdmittedEntryQualification {
        self.occurrence
    }
    ...
    pub const fn checked_fact(&self) -> typed_trees_to_checked_trees::fact_plan::FactHandle {
        self.checked_fact
    }
    ...
    pub const fn storage(
        &self,
    ) -> &'storage resolved_layout_to_resolved_layout::program_entry_plan::DerivedBoundaryEntryParameterStorage{
        self.storage
    }
}

impl SelectedExternalRootEntryFactBinding {
    pub const fn provider_plan(&self) -> crate::external_roots::ProviderPlanId {
        self.provider_plan
    }
    ...
    pub fn matches_occurrence(
        &self,
        occurrence: &crate::external_roots::AdmittedEntryQualification,
    ) -> bool {
    ...
    fn admit_acknowledgement<'entry>(
        &self,
        acknowledgement: &'entry crate::external_roots::InterruptAcknowledgement,
    ) -> Result<
        &'entry crate::external_roots::AdmittedEntryQualification,
        crate::external_roots::ExternalRootDiagnostic,
    > {
    ...
    fn admit_acknowledgement_handoff<'entry, 'storage, Write>(
        &self,
        acknowledgement: &'entry crate::external_roots::InterruptAcknowledgement,
        storage: &'storage resolved_layout_to_resolved_layout::program_entry_plan::DerivedBoundaryEntryStorage<Write>,
    ) -> Result<
    ...
    > {
        ...
        let parameter = storage.parameter(self.parameter_index).ok_or_else(|| {
            crate::external_roots::ExternalRootDiagnostic(format!(
        ...
        if !occurrence.matches_parameter_placement(self.parameter_index, &parameter.placement) {
            return Err(crate::external_roots::ExternalRootDiagnostic(format!(
    ...
    ) -> Result<Output, crate::external_roots::ExternalRootDiagnostic> {
...
impl SelectedExternalRootProviderPlan {
    ...
    ) -> Result<Self, crate::external_roots::ExternalRootDiagnostic> {
        Ok(Self {
            identity: crate::external_roots::ProviderPlanId::from_normalized_identity(
    ...
    pub fn prepare_post_handoff_entry_writer<'installed, 'mapping, 'bytes>(
        self,
        lowered: crate::post_handoff_writer::LoweredPostHandoffWriter,
        execution: &crate::external_roots::ProviderExecution,
        installed_code: &'installed crate::executable_installation::InstalledCode,
        writer: &terminal_psi::layout_plans::PostHandoffWriterPlan,
        destination: crate::executable_installation::PreparedPostHandoffWriterDestination<
            'mapping,
            'bytes,
        >,
    ) -> Result<
    ...
    > {
            ...
            crate::post_handoff_writer::validate_lowered_post_handoff_writer(&lowered)
        {
            return Err(SelectedExternalRootWriterPreparationError {
                ...
                lowered,
                destination,
                diagnostic: crate::external_roots::ExternalRootDiagnostic(diagnostic.message),
            });
        }
        ...
        let replayed_invocation = match writer.lower_reusable_fragment() {
            ...
            Err(diagnostic) => {
                return Err(SelectedExternalRootWriterPreparationError {
                    ...
                    lowered,
                    destination,
                    diagnostic: crate::external_roots::ExternalRootDiagnostic(diagnostic.0),
                });
            }
        };
        ...
        let destination = match destination.into_validated_for_writer_preparation() {
            ...
            Err(error) => {
                let diagnostic =
                    crate::external_roots::ExternalRootDiagnostic(error.diagnostic().0.clone());
                return Err(SelectedExternalRootWriterPreparationError {
                    selected_provider: self,
                    lowered,
    ...
    pub fn entry_claims(
        ...
        Vec<crate::external_roots::ExternalRootEntryClaim>,
        crate::external_roots::ExternalRootDiagnostic,
    > {
        if !self.has_valid_exact_identity() {
            return Err(crate::external_roots::ExternalRootDiagnostic(
                "selected external-root provider plan lost its exact strong identity".into(),
            ));
        }
        let matches = self
        ...
        for claim in &method.entry_claims {
            ...
            claims.push(crate::external_roots::ExternalRootEntryClaim {
    ...
    pub fn result_claims(
        ...
        Vec<crate::external_roots::ExternalRootResultClaim>,
        crate::external_roots::ExternalRootDiagnostic,
    > {
        if !self.has_valid_exact_identity() {
            return Err(crate::external_roots::ExternalRootDiagnostic(
        ...
        let mut claims = method
            .result_claims
            .iter()
            .map(|claim| crate::external_roots::ExternalRootResultClaim {
...
pub fn selected_external_root_provider_plan_id(
    ...
    boundary_trait: &str,
) -> Result<crate::external_roots::ProviderPlanId, crate::external_roots::ExternalRootDiagnostic> {
...
pub fn selected_external_root_provider_plan(
    selected_provider_plans: &abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts,
    boundary_trait: &str,
) -> Result<SelectedExternalRootProviderPlan, crate::external_roots::ExternalRootDiagnostic> {
...
pub fn optional_selected_external_root_provider_plan(
    selected_provider_plans: &abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts,
    boundary_trait: &str,
) -> Result<Option<SelectedExternalRootProviderPlan>, crate::external_roots::ExternalRootDiagnostic>
{
    let matches = selected_provider_plans
        .plans()
        .iter()
    ...
    match matches.as_slice() {
        ...
        plans => Err(crate::external_roots::ExternalRootDiagnostic(format!(
...
pub fn selected_external_root_entry_fact_bindings(
    ...
    selected_provider_plans: &abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts,
    boundary_trait: &str,
) -> Result<Vec<SelectedExternalRootEntryFactBinding>, crate::external_roots::ExternalRootDiagnostic>
{
    use abstract_operations_to_target_operations::effects::provider_plan::ProviderBinding;
    use typed_trees_to_checked_trees::fact_plan::{
        FactOrigin, FactPayload, FactPlace, PlaceRoot, ProgramPoint,
    };
    ...
    let provider_plan =
        crate::external_roots::ProviderPlanId::from_normalized_identity(plan.report_fingerprint())?;
        ...
        for claim in &method.entry_claims {
            ...
            let implementation =
                exact_checked_adapter(&checked.typed, plan, row).map_err(|diagnostic| {
                    crate::external_roots::ExternalRootDiagnostic(diagnostic.message)
                })?;
            let state = checked
                .typed
