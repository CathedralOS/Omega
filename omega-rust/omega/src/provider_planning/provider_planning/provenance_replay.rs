...
use crate::provider_planning::provider_planning::provenance_replay::plan_derivation::derive_provider_plans;
...
pub struct ProviderPlanDerivation<'a> {
    ...
    pub evaluated_bindings:
        Option<&'a crate::provider_planning::evaluated_via_bindings::EvaluatedViaBindingTable>,
...
impl<'a> ProviderPlanDerivation<'a> {
    ...
    pub fn evaluated(
        ...
        evaluated_bindings: &'a crate::provider_planning::evaluated_via_bindings::EvaluatedViaBindingTable,
