...
use symbol_resolved_trees_to_typed_trees::typed_trees::{TypedTrees, expression::BinaryOperator};
...
pub fn primitive_float_binary_intrinsic_execution_identity(
    ...
    let requirement =
        crate::provider_planning::IntrinsicRequirement::from_operator(typed, operator)?;
...
pub fn primitive_float_binary_intrinsic_execution_identity_for(
    typed: &TypedTrees,
    requirement: &crate::provider_planning::IntrinsicRequirement<'_>,
) -> Option<CompilerIntrinsicExecutionIdentity> {
