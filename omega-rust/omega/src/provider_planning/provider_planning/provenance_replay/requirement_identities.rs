...
use crate::provider_planning::provider_planning::provenance_replay::SelectedTargetMachineOrigin;
use crate::provider_planning::provider_planning::{ProviderBinding, TypedTrees};
...
pub fn satisfied_requirement_identity(
    ...
    if let Some(identity) = typed
        ...
        .find_map(|conformance| {
            let symbol_resolved_trees_to_typed_trees::typed_trees::machine::SatisfiedDeclaration::TopLevelRequirement(requirement) =
                symbol_resolved_trees_to_typed_trees::typed_trees::machine::resolve_satisfied_declaration(typed, machine, conformance)?
            else {
                return None;
            };
            typed
...
pub(crate) fn inferred_hosted_console_compiler_intrinsic(
    ...
    let symbol_resolved_trees_to_typed_trees::typed_trees::machine::SatisfiedDeclaration::Trait {
        definition,
        requirement,
