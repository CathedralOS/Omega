...
pub(crate) fn checked_adapter_has_exact_conformance(
    typed: &TypedTrees,
    adapter: &symbol_resolved_trees_to_typed_trees::typed_trees::machine::Machine,
...
pub(crate) fn exact_schema_method_for_row<'plan>(
    ...
    &'plan abstract_operations_to_target_operations::effects::provider_plan::ServiceMethod,
...
pub(crate) fn exact_canonical_provider_schema(
    ...
    match (
        ...
        ([definition], [], []) => {
            let argument_matches = typed
                ...
                .filter(|conformance| {
                    typed.data_definitions().iter().any(|carrier| {
                        ...
                        && crate::provider_planning::service_schema::is_product_declaration(typed, conformance.carrier_symbol)
            ...
            crate::provider_planning::service_schema::from_typed_instance(typed, definition, &arguments).ok_or_else(|| {
        ...
        ([], [], [operator]) => crate::provider_planning::service_schema::from_typed_operator(typed, operator).ok_or_else(|| {
            diagnostics::Diagnostic::error(format!(
...
fn exact_invocation_service_name(
    ...
    target: typed_trees_to_checked_trees::flow_effects::InvocationTarget,
...
pub(crate) fn exact_checked_adapter_invocations(
    typed: &TypedTrees,
    inferred: &typed_trees_to_checked_trees::flow_effects::InvocationInferencePlan,
    plan: &ProviderPlan,
    method: &abstract_operations_to_target_operations::effects::provider_plan::ServiceMethod,
    row: &ProviderPlanRow,
