...
fn bind_selected_provider_plan_facts_for_test(
    ...
    facts: abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts,
    root_grants: &[String],
) -> Result<
...
fn family_selection_from_typed(
    ...
    crate::provider_planning::ProviderSelection {
        subject: crate::provider_planning::ProviderSelectionSubject::BoundaryOperatorFamily(
            crate::provider_planning::ProviderOperatorFamilySelection::derive(
                typed,
        ...
        composition_mode: crate::provider_planning::CompositionMode::Fused,
        selecting_machine,
        source_span,
    }
}
...
fn selected_operator_binding_fixture() -> (
...
fn selection_plan(name: &str, methods: &[&str], rows: &[&str]) -> ProviderPlan {
    ProviderPlan {
        ...
        schema: ServiceSchema {
            ...
            methods: methods
                .iter()
                .map(|method| abstract_operations_to_target_operations::effects::provider_plan::ServiceMethod {
...
fn package_selection(
    ...
    let mut selection =
        crate::provider_planning::ProviderSelection::exact_for_test(boundary_trait, provider_type);
    let crate::provider_planning::ProviderSelectionSubject::BoundaryTrait(subject) =
        &mut selection.subject
    else {
...
fn append_admitted_fact(
    ...
    owner_symbol: symbols::SymbolHandle,
    requirement_symbol: symbols::SymbolHandle,
) -> typed_trees_to_checked_trees::fact_plan::FactHandle {
    let place = checked.facts.semantic.append_symbol_place(subject_symbol);
    checked.facts.semantic.append_fact(typed_trees_to_checked_trees::fact_plan::Fact {
        place: typed_trees_to_checked_trees::fact_plan::FactPlace::Place(place),
        point: typed_trees_to_checked_trees::fact_plan::ProgramPoint::Global,
        origin: typed_trees_to_checked_trees::fact_plan::FactOrigin::CallEnsures,
        evidence: typed_trees_to_checked_trees::fact_plan::QualificationEvidence::from_admitted_requirement(
            owner_symbol,
            requirement_symbol,
        ),
        payload: typed_trees_to_checked_trees::fact_plan::FactPayload::DomainMembership {
...
fn checked_invocation_fixture(
    ...
    TypedTrees,
    ProviderPlan,
    typed_trees_to_checked_trees::flow_effects::InvocationInferencePlan,
) {
    ...
    let type_reference = typed.type_reference_table.insert(
    ...
    let mut entry = symbol_resolved_trees_to_typed_trees::typed_trees::state::State::default();
    ...
    let inferred = typed_trees_to_checked_trees::flow_effects::InvocationInferencePlan {
        machines: vec![
            typed_trees_to_checked_trees::flow_effects::MachineInvocationInference {
                machine: machine_symbol,
                published: Vec::new(),
                inferred_direct: vec![
                    typed_trees_to_checked_trees::flow_effects::InvocationTarget::Parameter(0),
                ],
                inferred_transitive: vec![
                    typed_trees_to_checked_trees::flow_effects::InvocationTarget::Parameter(0),
                ],
                effective: vec![
                    typed_trees_to_checked_trees::flow_effects::InvocationTarget::Parameter(0),
