...
use crate::provider_planning::provider_planning::ProviderBinding;
...
fn integer_comparison_satisfies_provider_binds_the_exact_requirement() {
    ...
    assert_eq!(
        crate::provider_planning::primitive_integer_comparison_intrinsic_execution_identity(&typed, operator),
        Some(
            crate::provider_planning::CompilerIntrinsicExecutionIdentity::PrimitiveIntegerComparison {
                operation: crate::provider_planning::CompilerPrimitiveIntegerComparisonOperation::Equal,
                integer_type: crate::provider_planning::CompilerNumericType::I32,
            }
        ),
    );
    assert_eq!(
        crate::provider_planning::compiler_intrinsic_diagnostic_label(&typed, operator).as_deref(),
...
fn integer_comparison_identity_commits_to_authored_spelling_and_type() {
    for (spelling, expected, label) in [
        (
            "==",
            crate::provider_planning::CompilerPrimitiveIntegerComparisonOperation::Equal,
            "integer-comparison.equal.u64",
        ),
        (
            "!=",
            crate::provider_planning::CompilerPrimitiveIntegerComparisonOperation::NotEqual,
            "integer-comparison.not_equal.u64",
        ),
        (
            "<",
            crate::provider_planning::CompilerPrimitiveIntegerComparisonOperation::Less,
            "integer-comparison.less.u64",
        ),
        (
            "<=",
            crate::provider_planning::CompilerPrimitiveIntegerComparisonOperation::LessOrEqual,
            "integer-comparison.less_or_equal.u64",
        ),
        (
            ">",
            crate::provider_planning::CompilerPrimitiveIntegerComparisonOperation::Greater,
            "integer-comparison.greater.u64",
        ),
        (
            ">=",
            crate::provider_planning::CompilerPrimitiveIntegerComparisonOperation::GreaterOrEqual,
        ...
        assert_eq!(
            ...
            Some(
                crate::provider_planning::CompilerIntrinsicExecutionIdentity::PrimitiveIntegerComparison {
                    operation: expected,
                    integer_type: crate::provider_planning::CompilerNumericType::U64,
                }
            ),
            "spelling {spelling}",
        );
        assert_eq!(
            crate::provider_planning::compiler_intrinsic_diagnostic_label(&typed, operator)
                .as_deref(),
            Some(label),
        );
    }
...
fn integer_comparison_identity_fails_closed_outside_the_roster() {
    for source in [
        ...
        assert_eq!(
            crate::provider_planning::primitive_integer_comparison_intrinsic_execution_identity(
                &typed, operator
            ),
            None,
            "source `{source}`",
