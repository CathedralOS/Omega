...
use crate::provider_planning::{CompositionMode, SelectedProviderPlanWithProvenance};
use abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts;
use abstract_operations_to_target_operations::effects::provider_plan::ProviderPlan;
...
fn independent_selection(mode: CompositionMode) -> IndependentSelection {
    ...
    let selection = crate::provider_planning::ProviderSelection {
        subject: crate::provider_planning::ProviderSelectionSubject::BoundaryRequirement(
            crate::provider_planning::ProviderSelectionIdentity {
        ...
        provider_type: crate::provider_planning::ProviderSelectionIdentity {
