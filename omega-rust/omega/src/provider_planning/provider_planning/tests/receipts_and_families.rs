...
fn admitted_receipt_owner_and_signature_custody_is_exact_and_atomic() {
    ...
    let mut cross_owned = typed_trees_to_checked_trees::checked_trees::CheckedTrees::default();
    ...
    let mut duplicate_signature =
        typed_trees_to_checked_trees::checked_trees::CheckedTrees::default();
    push_boundary_requirement(
...
fn admitted_receipt_for_a_shared_requirement_binds_the_owner_plan() {
    ...
    let selected_facts = abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts::from_selection(
        &candidates,
        &candidates
            .iter()
...
fn explicit_selection_resolves_covering_ambiguity_by_provider_type() {
    ...
    let selected = select_provider_plans(
        ...
        &[],
        &[crate::provider_planning::ProviderSelection::exact_for_test(
            "Pair",
            "SecondProvider",
        )],
    )
...
fn operator_family_selection_atomically_selects_every_exact_coordinate() {
    ...
    let selected = select_provider_plans(
        ...
        &[],
        &[
            crate::provider_planning::ProviderSelection::operator_family_for_test(
                "Math::convert",
                "MathProvider",
...
fn operator_family_selection_canonicalizes_coordinate_order() {
    let first_coordinate = "operator::Math::convert(i32)->i64";
    let second_coordinate = "operator::Math::convert(u32)->u64";
    let selection = crate::provider_planning::ProviderSelection::operator_family_for_test(
        "Math::convert",
        "MathProvider",
        &[second_coordinate, first_coordinate],
    );
    let crate::provider_planning::ProviderSelectionSubject::BoundaryOperatorFamily(family) =
        selection.subject
    else {
...
fn replay_family_selection(
    ...
    selection: crate::provider_planning::ProviderSelection,
    ...
    let table =
        crate::provider_planning::evaluated_via_bindings::evaluate_via_bindings(typed, None, None)
...
) -> crate::provider_planning::ProviderSelection {
...
fn conflicting_target_defaults_are_loud() {
    ...
    let diagnostics = select_provider_plans(
        ...
        target::NativeTarget::host(),
        &[
            crate::provider_planning::ProviderSelection::exact_for_test("Pair", "FirstProvider"),
            crate::provider_planning::ProviderSelection::exact_for_test("Pair", "SecondProvider"),
        ],
        &[],
    )
