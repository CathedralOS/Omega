...
pub(super) fn plan_admitted_receipt_updates(
    ...
    provider_grants: &[crate::trust_model::ResolvedSelectedProviderGrant],
) -> Result<
    Vec<(typed_trees_to_checked_trees::fact_plan::FactHandle, u64)>,
...
> {
    ...
    for grant in provider_grants {
        ...
        if !granted_plans.iter().any(
            |retained: &&crate::trust_model::ResolvedSelectedProviderGrant| {
