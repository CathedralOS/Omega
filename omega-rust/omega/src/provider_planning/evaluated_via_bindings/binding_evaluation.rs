...
use crate::provider_planning::evaluated_via_bindings::binding_digests::{
    at, evaluation_digest, materialization_digest, producer_closure_digest,
};
use crate::provider_planning::evaluated_via_bindings::binding_values::{
...
use symbol_resolved_trees_to_typed_trees::typed_trees::data::{
    DataDefinition, DataMember, TypeParameterKind,
};
...
pub(crate) fn evaluate_one(
    ...
    let binding_identity_digest = match &decoded {
        ...
        DecodedBindingValue::Syscall { number } => {
            ...
            abstract_operations_to_target_operations::effects::provider_plan::evaluated_syscall_identity_digest(target, number)
        }
    };
...
pub(crate) fn exact_binding_vocabulary(
    ...
    let source_digest = crate::package_compilation::toolchain_source_identity_digest(source)?;
