...
struct CoordinateFixture {
    ...
    flow_state: arena::Handle<typed_trees_to_checked_trees::checked_trees::FlowStateFact>,
    first_call: arena::Handle<typed_trees_to_checked_trees::checked_trees::FlowCallFact>,
    second_call: arena::Handle<typed_trees_to_checked_trees::checked_trees::FlowCallFact>,
...
fn coordinate_fixture() -> CoordinateFixture {
    ...
    for (machine_symbol, state_symbol, machine_name) in [
        ...
        let mut state_definition = typed_trees_to_checked_trees::checked_trees::state::State {
            symbol: state_symbol,
    ...
    let flow_state = checked.facts.flow.control.states.append(
...
fn checked_coordinates_preserve_exact_order_and_identity() {
    ...
    assert_eq!(
        ...
        vec![
            abstract_operations_to_target_operations::effects::BoundaryCallCoordinate {
...
fn checked_coordinates_ignore_genuine_non_boundary_calls() {
    ...
    assert_eq!(
        ...
        Vec::<abstract_operations_to_target_operations::effects::BoundaryCallCoordinate>::new(),
    );
}
...
fn attach_boundary_edge(
...
) -> arena::Handle<typed_trees_to_checked_trees::checked_trees::FlowBoundaryEdgeFact> {
    ...
    let edge = fixture.checked.facts.flow.boundaries.edges.append_to_span(
        &mut boundary_edges,
        typed_trees_to_checked_trees::checked_trees::FlowBoundaryEdgeFact {
            statement_index: 0,
            call_ordinal: 0,
