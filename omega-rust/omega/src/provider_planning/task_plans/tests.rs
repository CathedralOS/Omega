...
use crate::provider_planning::task_plans::carry_crossings::{
    activation_carry_crossings, exact_activation_carry_subtree,
};
use crate::provider_planning::task_plans::runtime_requirements::exact_task_runtime_requirement;
use crate::provider_planning::task_plans::start_selections::TaskStartSelection;
use crate::provider_planning::task_plans::{CheckedTrees, Diagnostic};
use abstract_operations_to_target_operations::task_plans::TaskStartOperation;
...
fn activation_operational_fixture() -> (CheckedTrees, symbols::SymbolHandle, symbols::SymbolHandle)
{
    ...
    program.facts.contract_plans.machines = vec![
        typed_trees_to_checked_trees::checked_trees::MachineContractPlan {
            machine: target,
    ...
    program.facts.suspensions.machines = vec![
        typed_trees_to_checked_trees::checked_trees::MachineSuspensionFact {
            machine: target,
    ...
    program.facts.blocking.machines = vec![
        typed_trees_to_checked_trees::checked_trees::MachineBlockingFact {
            machine: target,
...
fn activation_requirement_fixture(duplicate_requirement: bool) -> ActivationRequirementFixture {
    ...
    let mut task_runtime =
        typed_trees_to_checked_trees::checked_trees::trait_definition::TraitDefinition {
            symbol: owner,
            is_boundary: true,
            name: typed_trees_to_checked_trees::checked_trees::name::Identifier::generated(
                "core::TaskRuntime",
            ),
            ..Default::default()
        };
    program.typed.push_trait_machine_signature(
        &mut task_runtime,
        typed_trees_to_checked_trees::checked_trees::signature::StateSignature {
            symbol: requirement,
            name: typed_trees_to_checked_trees::checked_trees::name::Identifier::generated("start"),
            ..Default::default()
        },
    );
...
fn activation_target_fixture() -> (
    ...
    let mut first = typed_trees_to_checked_trees::checked_trees::machine::Machine {
    ...
    program.typed.push_machine_state(
        ...
        typed_trees_to_checked_trees::checked_trees::state::State {
            symbol: first_entry,
            name: typed_trees_to_checked_trees::checked_trees::name::Identifier::generated("run"),
            ..Default::default()
        },
    );
    program.typed.push_machine(first);

    let mut second = typed_trees_to_checked_trees::checked_trees::machine::Machine {
...
fn activation_crossing_validation_fixture() -> (
    ...
    let mut root_machine = typed_trees_to_checked_trees::checked_trees::machine::Machine {
        symbol: root,
        name: typed_trees_to_checked_trees::checked_trees::name::Identifier::generated("Root::run"),
        ..Default::default()
    };
    let mut root_state_definition = typed_trees_to_checked_trees::checked_trees::state::State {
        symbol: root_state,
        name: typed_trees_to_checked_trees::checked_trees::name::Identifier::generated("run"),
        ..Default::default()
    };
    ...
    let mut child_machine = typed_trees_to_checked_trees::checked_trees::machine::Machine {
        symbol: child,
        name: typed_trees_to_checked_trees::checked_trees::name::Identifier::generated(
            "Child::run",
        ),
    ...
    let mut child_state_definition = typed_trees_to_checked_trees::checked_trees::state::State {
        symbol: child_state,
        name: typed_trees_to_checked_trees::checked_trees::name::Identifier::generated("run"),
        ..Default::default()
    };
    ...
    program.facts.flow.control.calls.append_to_span(
        &mut calls,
        typed_trees_to_checked_trees::checked_trees::FlowCallFact {
            statement_index: 0,
            call_ordinal: 0,
    ...
    program.facts.flow.control.states.append(
        typed_trees_to_checked_trees::checked_trees::FlowStateFact {
    ...
    let targets = program.facts.carry.contained_targets.insert_many([
        typed_trees_to_checked_trees::checked_trees::ContainedMachineTargetFact { machine: child },
    ]);
    let fields = program.facts.carry.contained_fields.insert_many([
        typed_trees_to_checked_trees::checked_trees::ContainedMachineFieldFact {
            field,
            data,
    ...
    program.facts.carry.machine_topologies.insert(
        typed_trees_to_checked_trees::checked_trees::MachineCarryTopologyFact {
            machine: root,
            fields,
        },
    );
...
fn concrete_task_start_fixture() -> (
    ...
    let provider_plans = crate::provider_planning::provider_planning::derive_satisfies_plans(
        &typed,
    ...
    assert!(
        crate::provider_planning::provider_planning::validate_provider_plan_candidates(
            &typed,
            &provider_plans,
        )
        .is_empty()
