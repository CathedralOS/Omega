...
use crate::provider_planning::task_plans::{StableHash, entry_report_fingerprint};
...
fn append_task_start_selection(
    ...
    target_name: &str,
    machine_arguments: &[typed_trees_to_checked_trees::checked_trees::expression::StaticMachineArgument],
