...
fn activation_target_rejects_duplicate_entry_within_owner() {
    ...
    let mut machine = typed_trees_to_checked_trees::checked_trees::machine::Machine {
...
fn activation_topology_preserves_target_order_and_allows_cycles() {
    ...
    let ordered_targets = program.facts.carry.contained_targets.insert_many([
        existing_target,
        typed_trees_to_checked_trees::checked_trees::ContainedMachineTargetFact {
            machine: sibling,
        },
    ]);
    program
    ...
    let type_reference = program
        ...
        .1
        .type_reference;
    let cycle_targets = program.facts.carry.contained_targets.insert_many([
        typed_trees_to_checked_trees::checked_trees::ContainedMachineTargetFact { machine: root },
    ]);
