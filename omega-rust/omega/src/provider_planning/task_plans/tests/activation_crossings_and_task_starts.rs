...
use crate::provider_planning::task_plans::carry_crossings::validate_activation_carry_crossing;
use crate::provider_planning::task_plans::runtime_requirements::selected_task_runtime_provider;
use crate::provider_planning::task_plans::specialization_commitments::{
    exact_task_machine_contract, task_specialization_commitment,
};
use crate::provider_planning::task_plans::start_selections::{
    exact_task_activation_target, task_start_selections,
};
use crate::provider_planning::task_plans::{
...
use abstract_operations_to_target_operations::task_plans::{
    ActivationCarryObligations, TaskStartOperation,
};
...
fn nested_checked_call_composes_whole_graph_wcsu_and_roster() {
    ...
    assert_eq!(
        projection
            ...
            .collect::<Vec<_>>(),
        vec![
            abstract_operations_to_target_operations::task_plans::UnresolvedCallKind::NonCheckedSupply,
            abstract_operations_to_target_operations::task_plans::UnresolvedCallKind::NonCheckedSupply
        ]
    );
...
fn suspending_task_plan_retains_the_exact_live_frontier() {
    ...
    assert!(
        crossing.live_carry.iter().any(|live| live.storage
            == abstract_operations_to_target_operations::task_plans::LiveCarryStorage::Local),
...
fn concrete_task_start_specialization_elaborates_a_validated_plan() {
    ...
    let foreign_leaf_selected = abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts::from_selection(
    ...
    let wrong_method_owner_selected = abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts::from_selection(
