...
pub(super) fn mutual_call_fixture() -> (
    ...
    for (machine_symbol, machine_name, state_symbol) in [
        ...
        let mut state = typed_trees_to_checked_trees::checked_trees::state::State {
            symbol: state_symbol,
...
fn admission_binding_joins_the_bound_subtrees_canonical_crossings() {
    ...
    let diagnostic = abstract_operations_to_target_operations::task_plans::TaskRuntimeAdmission::bind_call_targets(
        &plan,
        &[CallTargetBinding {
            frame: site.frame,
            state: site.state.clone(),
    ...
    let covered = abstract_operations_to_target_operations::task_plans::TaskRuntimeAdmission::bind_call_targets(
        &plan,
        &[CallTargetBinding {
            frame: site.frame,
            state: site.state.clone(),
