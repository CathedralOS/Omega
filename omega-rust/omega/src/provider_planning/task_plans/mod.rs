...
use crate::provider_planning::task_plans::runtime_requirements::{
...
pub fn elaborate_task_activation_plans(
    ...
    for selection in selections {
        ...
        let argument_layout =
            abstract_operations_to_target_operations::task_plans::TaskArgumentLayout::new(
                normalized_id(
...
fn signature_value_layouts(
    ...
    types: impl IntoIterator<
        Item = typed_trees_to_checked_trees::checked_trees::types::TypeReferenceHandle,
    >,
) -> Result<
    Vec<(
        typed_trees_to_checked_trees::checked_trees::types::TypeReferenceHandle,
        resolved_layout_to_resolved_layout::layout::TypeLayout,
    )>,
    Vec<Diagnostic>,
> {
    types
        .into_iter()
        .map(|type_reference| {
            resolved_layout_to_resolved_layout::layout::layout_type_reference(
                program,
                target,
                opaque_representation_selections,
                type_reference,
...
fn entry_report_fingerprint(
    ...
    entry: &typed_trees_to_checked_trees::checked_trees::state::State,
) -> u64 {
    let mut hash = StableHash::new();
    hash.byte(0x45);
...
fn normalized_id<T>(
    ...
    constructor: impl FnOnce(
        ...
        T,
        abstract_operations_to_target_operations::task_plans::TaskPlanDiagnostic,
    >,
