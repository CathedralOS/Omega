...
use resolved_layout_to_resolved_layout::layout::TypeLayout;
use symbols::SymbolHandle;
use target::NativeTarget;
use typed_trees_to_checked_trees::checked_trees::{CheckedTrees, SuspensionCrossingStorage};
...
pub(crate) fn task_call_graph<'program>(
    ...
    root_machine: &typed_trees_to_checked_trees::checked_trees::machine::Machine,
    root_entry: &typed_trees_to_checked_trees::checked_trees::state::State,
...
fn task_frame_summary<'program>(
    ...
    opaque_representation_selections: &[crate::representation_planning::OpaqueRepresentationSelection],
    layouts: &resolved_layout_to_resolved_layout::layout::LayoutPlan,
    machine: &'program typed_trees_to_checked_trees::checked_trees::machine::Machine,
    entry: &'program typed_trees_to_checked_trees::checked_trees::state::State,
    pending: &mut Vec<SymbolHandle>,
    reachable_crossings: &mut Vec<
        &'program typed_trees_to_checked_trees::checked_trees::SuspensionCrossingCarryFact,
    >,
...
fn frame_state_closure<'program>(
    ...
    machine: &'program typed_trees_to_checked_trees::checked_trees::machine::Machine,
    entry: &'program typed_trees_to_checked_trees::checked_trees::state::State,
) -> Result<Vec<&'program typed_trees_to_checked_trees::checked_trees::state::State>, Vec<Diagnostic>>
{
