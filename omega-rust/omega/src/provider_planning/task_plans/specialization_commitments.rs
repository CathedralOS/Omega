...
use crate::provider_planning::task_plans::start_selections::{
    TaskStartSelection, unique_task_activation_target,
};
...
pub(crate) fn exact_task_machine_contract<'program>(
    ...
    &'program typed_trees_to_checked_trees::checked_trees::MachineContractPlan,
    Vec<Diagnostic>,
> {
...
pub(crate) fn task_specialization_commitment(
    ...
    target_machine: &typed_trees_to_checked_trees::checked_trees::machine::Machine,
    target_entry: &typed_trees_to_checked_trees::checked_trees::state::State,
    target_contract: &typed_trees_to_checked_trees::checked_trees::MachineContractPlan,
...
impl ExactSpecializationEncoder {
    ...
    fn target_machine_specialization(
        ...
        let operator_realizations =
            typed_trees_to_checked_trees::validation::canonical_closed_operator_realization_bytes(
                &program.typed,
    ...
    fn state(
        &mut self,
        program: &CheckedTrees,
        owner: &typed_trees_to_checked_trees::checked_trees::machine::Machine,
...
fn exact_specialization_machine<'program>(
    ...
    role: &str,
) -> Result<&'program typed_trees_to_checked_trees::checked_trees::machine::Machine, Vec<Diagnostic>>
{
    let mut matches = program
        .machines()
        .iter()
