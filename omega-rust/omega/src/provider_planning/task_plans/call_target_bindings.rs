...
use crate::provider_planning::task_plans::carry_crossings::canonical_suspension_crossing;
use crate::provider_planning::task_plans::stack_graphs::{exact_frame_target, task_call_graph};
use abstract_operations_to_target_operations::task_plans::{
    CallTargetBinding, TaskStackFrameId, ValidatedActivationPlan,
};
...
pub fn derive_call_target_bindings(
    ...
    layouts: &resolved_layout_to_resolved_layout::layout::LayoutPlan,
