...
impl<'typed> IntrinsicRequirement<'typed> {
    pub fn from_operator(
        ...
        operator: &'typed symbol_resolved_trees_to_typed_trees::typed_trees::operator::OperatorDefinition,
    ) -> Option<Self> {
    ...
    pub fn schema_binds(&self, typed: &TypedTrees, schema: &ServiceSchema) -> bool {
        match self.kind {
            IntrinsicRequirementKind::Operator => self.operator.is_some_and(|operator| {
                crate::provider_planning::service_schema::schema_binds_exact_boundary_operator(typed, schema, operator)
            }),
                ...
                && typed
                    ...
                    .any(|conformance| match self.kind {
                        ...
                        IntrinsicRequirementKind::TopLevelRequirement => matches!(
                            ...
                            Some(symbol_resolved_trees_to_typed_trees::typed_trees::machine::SatisfiedDeclaration::TopLevelRequirement(
                                requirement,
