...
pub use abstract_operations_to_target_operations::effects::{
...
use crate::trust_model::AuthoredRootGrant;
#[cfg(test)]
use crate::trust_model::ProviderGrantSelectorKind;
use crate::trust_model::resolve_selected_provider_grants;
...
use crate::provider_planning::provider_planning::selected_plan_bindings::SelectedProviderProgramUpdates;
use crate::provider_planning::provider_planning::selection_provenance::select_provider_plan_indices;
...
pub fn bind_selected_provider_plan_facts(
    program: &Arc<typed_trees_to_checked_trees::checked_trees::CheckedTrees>,
    ...
    let authored_provider_grants = crate::trust_model::resolve_authored_selected_provider_grants(
        candidates,
        &facts,
