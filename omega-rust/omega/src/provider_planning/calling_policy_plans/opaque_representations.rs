...
pub struct BoundaryOpaqueRepresentationUse {
    pub(super) opaque: symbols::SymbolHandle,
    pub(super) conformance: symbols::SymbolHandle,
    pub(super) carrier: symbols::SymbolHandle,
    ...
    pub(super) origin: crate::representation_planning::OpaqueRepresentationApplicationOrigin,
    pub(super) lifecycle: crate::representation_planning::OpaqueRepresentationLifecycleDisposition,
    pub(super) copy_disposition:
        crate::representation_planning::OpaqueRepresentationCopyDisposition,
    pub(super) selected_application_commitment: [u8; 32],
}

impl BoundaryOpaqueRepresentationUse {
    pub const fn opaque(&self) -> symbols::SymbolHandle {
        self.opaque
    }

    pub const fn carrier(&self) -> symbols::SymbolHandle {
        self.carrier
    }

    pub const fn conformance(&self) -> symbols::SymbolHandle {
        self.conformance
    }
    ...
    pub const fn origin(
        &self,
    ) -> crate::representation_planning::OpaqueRepresentationApplicationOrigin {
        self.origin
    }

    pub const fn lifecycle(
        &self,
    ) -> crate::representation_planning::OpaqueRepresentationLifecycleDisposition {
        self.lifecycle
    }
...
mod tests {
    ...
    use crate::representation_planning::{
    ...
    fn selected_application_replay_rejects_copy_disposition_drift() {
        ...
        let mut use_ = BoundaryOpaqueRepresentationUse {
            opaque: symbols::SymbolHandle::invalid(),
            conformance: symbols::SymbolHandle::invalid(),
            carrier: symbols::SymbolHandle::invalid(),
            shape_root: 0,
