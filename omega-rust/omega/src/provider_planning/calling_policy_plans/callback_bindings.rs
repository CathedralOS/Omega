...
use crate::provider_planning::calling_policy_plans::build_time_decoding::CALLBACK_MATERIALIZATION_CAPACITY;
use crate::provider_planning::calling_policy_plans::callback_layout_catalog;
use crate::provider_planning::calling_policy_plans::callback_layout_catalog::BoundaryCallbackLayoutEntry;
use crate::provider_planning::calling_policy_plans::plan_computation::{
...
pub struct BoundaryCallingPlanRealization {
    ...
    pub commitment: symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment,
...
impl BoundaryCallingPlanRealization {
    ...
    > {
        ...
        if self.callback_context_closed {
            ...
            abstract_operations_to_target_operations::calling_conventions::validate_boundary_entry_plan(
                self.boundary_entry_plan.clone(),
                &signature,
            )
        }
    ...
    pub fn replayed_validated_application(
        ...
        (
            ValidatedBoundaryEntryPlan,
            u64,
            symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment,
        ),
        abstract_operations_to_target_operations::calling_conventions::PlanDiagnostic,
    >{
        if self.callback_context_closed {
...
pub fn validate_nominal_callback_placement_bindings(
...
) -> Result<Vec<crate::backend_plan::BoundNominalCallbackPlacement>, Vec<Diagnostic>> {
    ...
    for nominal_use in &checked.facts.nominal_machine_uses.uses {
        ...
        bound.push(crate::backend_plan::BoundNominalCallbackPlacement {
...
fn bound_private_callback_materialization(
    nominal_use: &typed_trees_to_checked_trees::checked_trees::CheckedNominalMachineUse,
    realizations: &[BoundaryCallingPlanRealization],
) -> Result<Option<crate::backend_plan::BoundCallbackPrivateMaterialization>, String> {
    ...
    let direct_registrar_parameter_application = match row.destination {
        NativePlace::Parameter(parameter) => {
            ...
            Some(abstract_operations_to_target_operations::calling_conventions::NativeParameterApplication {
                parameter,
    ...
    Ok(Some(
        crate::backend_plan::BoundCallbackPrivateMaterialization {
            binder: binder.binder,
...
pub fn close_outbound_callback_materializations(
    ...
    let layout_plan = resolved_layout_to_resolved_layout::layout::build_layout_plan(
        checked,
        native_target,
    ...
    for realization in realizations {
        ...
        realization.commitment =
            symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment::from_digest(new_commitment);
        ...
        checked.typed.record_boundary_calling_plan(
            symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanIdentity {
...
pub(crate) fn reconcile_closed_callback_plan_identity(
    nominal_uses: &mut [typed_trees_to_checked_trees::checked_trees::CheckedNominalMachineUse],
    boundary_trait: symbols::SymbolHandle,
    requirement_machine: symbols::SymbolHandle,
    old_report_fingerprint: u64,
    old_commitment: symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment,
    new_report_fingerprint: u64,
    new_commitment: symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment,
) {
    for nominal_use in nominal_uses {
            ...
            })
        {
            let resource_receipt = nominal_use
                ...
                .resource_receipt;
            nominal_use.callback_placement = Some(
                typed_trees_to_checked_trees::checked_trees::CheckedCallbackPlacementIdentity {
