...
use crate::provider_planning::calling_policy_plans::boundary_signatures::boundary_shape_path;
use crate::provider_planning::calling_policy_plans::boundary_signatures::compatibility_call_signature;
use crate::provider_planning::calling_policy_plans::boundary_signatures::exact_boundary_layout_root_symbol;
use crate::provider_planning::calling_policy_plans::boundary_signatures::exact_compatibility_overload_index;
use crate::provider_planning::calling_policy_plans::build_time_decoding::decode_native_place;
use crate::provider_planning::calling_policy_plans::build_time_decoding::field;
use crate::provider_planning::calling_policy_plans::build_time_decoding::struct_parts;
use crate::provider_planning::calling_policy_plans::build_time_decoding::uint;
use crate::provider_planning::calling_policy_plans::callback_bindings::callback_plan_report_fingerprint;
use crate::provider_planning::calling_policy_plans::callback_bindings::reconcile_closed_callback_plan_identity;
use crate::provider_planning::calling_policy_plans::callback_bindings::validate_callback_requirement_report_collision;
use crate::provider_planning::calling_policy_plans::callback_bindings::validate_fresh_native_parameter_report_identity;
use crate::provider_planning::calling_policy_plans::plan_computation::boundary_plan_application_identity;
use crate::provider_planning::calling_policy_plans::plan_computation::build_boundary_signature;
use crate::provider_planning::calling_policy_plans::plan_computation::validate_authored_abi_shape;
use crate::provider_planning::calling_policy_plans::plan_computation::validate_materialized_boundary_plan_result;
use crate::provider_planning::calling_policy_plans::value_shapes::case;
use abstract_operations_to_target_operations::calling_conventions::BoundaryPlanResult;
use abstract_operations_to_target_operations::calling_conventions::CallSignature;
use abstract_operations_to_target_operations::calling_conventions::CallbackBinderRequirement;
use abstract_operations_to_target_operations::calling_conventions::CallbackMaterialization;
use abstract_operations_to_target_operations::calling_conventions::CallbackMaterializationContext;
use abstract_operations_to_target_operations::calling_conventions::CallbackRequirementId;
use abstract_operations_to_target_operations::calling_conventions::CallingPolicy;
use abstract_operations_to_target_operations::calling_conventions::LayoutPlanId;
use abstract_operations_to_target_operations::calling_conventions::LayoutSlotId;
use abstract_operations_to_target_operations::calling_conventions::NativeCallbackDemand;
use abstract_operations_to_target_operations::calling_conventions::NativeParameterId;
use abstract_operations_to_target_operations::calling_conventions::NativePlace;
use abstract_operations_to_target_operations::calling_conventions::StaticMachineBinderId;
...
use abstract_operations_to_target_operations::calling_conventions::evaluate_ordinary_boundary_entry_plan;
use abstract_operations_to_target_operations::calling_conventions::nominal_callback_native_parameter_id;
use abstract_operations_to_target_operations::calling_conventions::validate_boundary_entry_plan_with_callback_materializations;
use sha2::Digest;
use sha2::Sha256;
...
fn test_opaque_representation_use(shape_root: u16) -> BoundaryOpaqueRepresentationUse {
    ...
    let lifecycle = crate::representation_planning::OpaqueRepresentationLifecycleDisposition::Inert;
    ...
    BoundaryOpaqueRepresentationUse {
        ...
        representation_schema_version:
            crate::representation_planning::OPAQUE_REPRESENTATION_APPLICATION_SCHEMA_VERSION,
        origin,
        lifecycle,
        copy_disposition,
        selected_application_commitment:
            crate::representation_planning::selected_application_commitment(
                conformance_application_commitment,
                lifecycle,
                copy_disposition,
                origin,
...
fn boundary_application_replay_rejects_stale_opaque_custody_lanes() {
    ...
    let stale_uses = [
        ...
        BoundaryOpaqueRepresentationUse {
            representation_schema_version:
                crate::representation_planning::OPAQUE_REPRESENTATION_APPLICATION_SCHEMA_VERSION + 1,
            ..test_opaque_representation_use(0)
        },
        BoundaryOpaqueRepresentationUse {
...
fn nominal_callback_fixture() -> (
    ...
    let (report_fingerprint, application_commitment) =
        boundary_plan_application_identity(&materialized_signature, &validated);
    let commitment = symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment::from_digest(
        application_commitment,
    );
    ...
    let resource_envelope = typed_trees_to_checked_trees::checked_trees::CheckedEntryResourceEnvelope::from_checked_contract(
        selected_machine,
        selected_entry,
        selected_actual_fingerprint,
        typed_trees_to_checked_trees::checked_trees::MachineContractCommitment::from_digest([8; 32]),
    );
    let resource_receipt =
        typed_trees_to_checked_trees::checked_trees::CheckedCallbackResourceReceipt::try_from_entry_envelope(&resource_envelope)
            .expect("canonical callback resource receipt");
    let nominal_use = typed_trees_to_checked_trees::checked_trees::CheckedNominalMachineUse {
        site: typed_trees_to_checked_trees::checked_trees::NominalMachineUseSite::Expression(
            symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionHandle::from_arena_index(1),
        ),
        ...
        published_requirement_envelope: typed_trees_to_checked_trees::checked_trees::CheckedMachineContractEnvelopeIdentity {
            contract_report_fingerprint: 6,
            contract_commitment: typed_trees_to_checked_trees::checked_trees::MachineContractCommitment::from_digest([6; 32]),
        },
        selected_actual_envelope: typed_trees_to_checked_trees::checked_trees::CheckedMachineContractEnvelopeIdentity {
            contract_report_fingerprint: selected_actual_fingerprint,
            contract_commitment: typed_trees_to_checked_trees::checked_trees::MachineContractCommitment::from_digest([8; 32]),
        },
        callback_placement: Some(typed_trees_to_checked_trees::checked_trees::CheckedCallbackPlacementIdentity {
            boundary_calling_plan_report_fingerprint: report_fingerprint,
            boundary_calling_plan_commitment: commitment,
            resource_receipt,
        }),
        refinement: typed_trees_to_checked_trees::checked_trees::CheckedMachineContractRefinement {
            published_requirement_report_fingerprint: 6,
            published_requirement_commitment: typed_trees_to_checked_trees::checked_trees::MachineContractCommitment::from_digest(
                [6; 32],
            ),
            selected_actual_report_fingerprint: selected_actual_fingerprint,
            selected_actual_commitment: typed_trees_to_checked_trees::checked_trees::MachineContractCommitment::from_digest(
                [8; 32],
            ),
        },
    };
    ...
    checked.facts.contract_plans.crash_capsules = vec![
        typed_trees_to_checked_trees::checked_trees::CrashContractCapsule::new_with_commitment(
            boundary_trait,
            requirement,
            6,
            typed_trees_to_checked_trees::checked_trees::MachineContractCommitment::from_digest(
    ...
    checked.facts.contract_plans.realized_envelopes =
        vec![typed_trees_to_checked_trees::checked_trees::RealizedMachineContractEnvelope {
            machine: selected_machine,
            contract_report_fingerprint: selected_actual_fingerprint,
            contract_commitment: typed_trees_to_checked_trees::checked_trees::MachineContractCommitment::from_digest([8; 32]),
            ...
            checked_crash: typed_trees_to_checked_trees::checked_trees::CrashPlan::default(),
            mutation: Vec::new(),
            capabilities: Vec::new(),
            resources:
                typed_trees_to_checked_trees::checked_trees::CheckedMachineResourceEnvelopes::from_checked_contract_entries(
                    selected_machine,
                    selected_actual_fingerprint,
                    typed_trees_to_checked_trees::checked_trees::MachineContractCommitment::from_digest([8; 32]),
                    [selected_entry],
    ...
    checked.facts.nominal_machine_uses =
        typed_trees_to_checked_trees::checked_trees::NominalMachineUseFacts::try_with_uses([
            nominal_use,
        ])
...
fn nominal_callback_placement_rejects_self_consistent_legacy_v2_evidence() {
    ...
    let legacy_commitment =
        symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment::from_digest(legacy_digest);
...
fn nominal_callback_placement_rejoins_the_current_entry_resource_envelope() {
    ...
    let foreign = typed_trees_to_checked_trees::checked_trees::CheckedEntryResourceEnvelope::from_checked_contract(
    ...
    nominal_use
        ...
        .resource_receipt =
        typed_trees_to_checked_trees::checked_trees::CheckedCallbackResourceReceipt::try_from_entry_envelope(&foreign)
...
fn nominal_callback_placement_rejects_compact_equal_resource_contract_substitution() {
    let (mut checked, realizations) = nominal_callback_fixture();
    let nominal_use = &mut checked.facts.nominal_machine_uses.uses[0];
    let substituted = typed_trees_to_checked_trees::checked_trees::CheckedEntryResourceEnvelope::from_checked_contract(
        nominal_use.selected_machine,
        nominal_use.selected_entry,
        nominal_use
            .selected_actual_envelope
            .contract_report_fingerprint,
        typed_trees_to_checked_trees::checked_trees::MachineContractCommitment::from_digest([0x77; 32]),
    );
    nominal_use
        .callback_placement
        .as_mut()
        .expect("callback placement")
        .resource_receipt =
        typed_trees_to_checked_trees::checked_trees::CheckedCallbackResourceReceipt::try_from_entry_envelope(&substituted)
...
fn nominal_callback_consumer_replays_exact_materialization_context() {
    ...
    realization.commitment =
        symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment::from_digest(commitment);
    ...
    direct_row_on_field
        ...
        .as_mut()
        .unwrap()
        .direct_registrar_parameter_application = Some(
        abstract_operations_to_target_operations::calling_conventions::NativeParameterApplication {
    ...
    assert!(
        crate::backend_plan::validate_bound_nominal_callback_placement(&direct_row_on_field)
            .is_err(),
...
fn nominal_callback_placement_rejects_missing_or_drifting_plan() {
    ...
    compact_equal_checked.facts.nominal_machine_uses.uses[0]
        ...
        symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment::from_digest([0x5a; 32]);
...
fn callback_closure_reconciliation_requires_the_preclosure_strong_commitment() {
    ...
    let substituted_old =
        symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment::from_digest([0x5a; 32]);
    let closed = symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment::from_digest([0x6b; 32]);
