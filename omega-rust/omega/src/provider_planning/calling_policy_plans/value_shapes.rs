...
use crate::provider_planning::calling_policy_plans::opaque_representations::BoundaryOpaqueRepresentationUse;
...
use crate::representation_planning::{OpaqueRepresentationSelection, selection_for_opaque};
use abstract_operations_to_target_operations::calling_conventions::{
    CallingPolicy, SystemVEightbyteClass, ValueClass, ValueShape,
};
...
pub fn selected_program_storage_source_extent_value_layout(
    ...
    resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntrySourceExtentValueLayout,
    String,
> {
    ...
    let [
        symbol_resolved_trees_to_typed_trees::typed_trees::data::DataMember::Field(base),
        symbol_resolved_trees_to_typed_trees::typed_trees::data::DataMember::Field(length),
    ...
    resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntrySourceExtentValueLayout::from_checked_record(
        *data_symbol,
        base.symbol,
