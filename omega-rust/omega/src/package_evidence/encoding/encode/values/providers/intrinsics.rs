...
use crate::package_evidence::record::PackageReviewCompilerIntrinsicExecution;
...
fn encode_primitive_integer_comparison_operation(
    ...
    use crate::provider_planning::CompilerPrimitiveIntegerComparisonOperation;
...
fn encode_compiler_numeric_type(
    encoder: &mut Encoder,
    numeric_type: crate::provider_planning::CompilerNumericType,
) {
