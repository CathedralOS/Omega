...
pub(crate) fn encode_boundary_application_demand_key(
    ...
    encoder.sequence(&demand.arguments, |encoder, argument| {
        match argument {
            crate::package_evidence::record::PackageReviewSymbolicBoundaryApplicationArgument::TypeBinder {
...
pub(in crate::package_evidence::encoding::encode) fn encode_boundary_application(
    encoder: &mut Encoder,
            ...
            encoder.field("arguments", |encoder| {
                encoder.sequence(arguments, |encoder, argument| {
                    encoder.field("argument", |encoder| {
                        match argument {
                            crate::package_evidence::record::PackageReviewBoundaryApplicationArgument::Type {
                                binder_ordinal,
                                type_identity,
                            } => {
                                encoder.tag("type", 0);
                            ...
                            crate::package_evidence::record::PackageReviewBoundaryApplicationArgument::Const {
                                binder_ordinal,
                                declared_carrier,
                                value_type,
                                value_encoding,
