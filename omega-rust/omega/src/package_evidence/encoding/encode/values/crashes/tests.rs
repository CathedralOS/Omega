use crate::package_evidence::encoding::encode::encode_boolean_expression;
use crate::package_evidence::encoding::encode::encode_scalar_expression;
use crate::package_evidence::encoding::encode::values::crashes::Encoder;
use crate::package_evidence::encoding::encode::values::crashes::integer_binary_tag;
...
fn closed_integer_literal_retains_the_existing_canonical_bytes() {
    let expression = PackageReviewScalarExpression::IntegerLiteral(
        crate::package_evidence::record::PackageReviewIntegerLiteral {
            canonical_text: "7".to_owned(),
            landing: Some(
                crate::package_evidence::record::PackageReviewIntegerLiteralLanding {
