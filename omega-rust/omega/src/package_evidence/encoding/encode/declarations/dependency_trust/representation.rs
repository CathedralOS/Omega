    ...
    match &row.kind {
        ...
        PackageReviewRepresentationTcbKind::SelectedCopyReceipt {
            ...
            encoder.byte(match origin {
                crate::package_evidence::record::PackageReviewOpaqueRepresentationApplicationOrigin::NamedConformance => 1,
            });
            encoder.byte(match lifecycle {
                crate::package_evidence::record::PackageReviewOpaqueRepresentationLifecycleDisposition::Inert => 1,
            });
            encoder.byte(match copy_disposition {
                crate::package_evidence::record::PackageReviewOpaqueRepresentationCopyDisposition::PlacementOnly => 1,
                crate::package_evidence::record::PackageReviewOpaqueRepresentationCopyDisposition::CheckedSemanticCopy => 2,
            });
