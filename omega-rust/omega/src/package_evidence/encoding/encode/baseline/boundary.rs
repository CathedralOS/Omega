...
pub(in crate::package_evidence::encoding::encode) fn applications(
    encoder: &mut Encoder,
    applications: &PackagePolicyBoundaryApplications,
) -> Result<(), PackageReviewEncodingError> {
    encoder.field("demands", |encoder| {
        encoder.sequence(&applications.demands, demand)
    })?;
    encoder.field("realizations", |encoder| {
        encoder.sequence(&applications.realizations, realization)
    })
}

pub(in crate::package_evidence::encoding::encode) fn demand(
    encoder: &mut Encoder,
...
pub(in crate::package_evidence::encoding::encode) fn realization(
    encoder: &mut Encoder,
    realization: &PackagePolicyBoundaryApplicationRealization,
) -> Result<(), PackageReviewEncodingError> {
    encoder.field("operator_coordinate", |encoder| {
