...
use crate::package_evidence::encoding::encode::policy_rows::Encoder;
use crate::package_evidence::encoding::encode::policy_rows::rejected;
use crate::package_evidence::record::PACKAGE_POLICY_ROW_VERSION;
use crate::package_evidence::record::PackagePolicyBaseline;
use crate::package_evidence::record::PackagePolicyRow;
use crate::package_evidence::record::PackagePolicyRowKind;
use crate::package_evidence::record::PackagePolicyRowLimits;
use crate::package_evidence::record::PackagePolicyRowUsage;
...
pub(super) fn frame_row(
    ...
    encoder.field("baseline_schema", |encoder| {
        encoder.u16(crate::package_evidence::encoding::PACKAGE_POLICY_BASELINE_VERSION);
        Ok(())
    })?;
