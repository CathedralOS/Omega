...
impl Encoder<'_> {
    pub(in crate::package_evidence::encoding) fn row_measure(
        maximum_bytes: usize,
    ...
    pub(in crate::package_evidence::encoding) fn row_output(
        bytes: usize,
        text: Option<usize>,
        elements: usize,
        depth: usize,
    ...
    pub(in crate::package_evidence::encoding) fn row_metrics(
        &self,
    ...
    pub(in crate::package_evidence::encoding) fn finish_row(
        self,
