...
mod framing;
mod writer;
pub(in crate::package_evidence::encoding) use framing::{HEADER, MAXIMUM_MARKUP_DEPTH, label};
pub(in crate::package_evidence::encoding) use writer::Writer;

pub const PACKAGE_POLICY_TEXT_VERSION: u16 = 1;
pub(in crate::package_evidence::encoding) const MAXIMUM_TEXT_BYTES: usize = 32 * 1024 * 1024;
...
pub(in crate::package_evidence::encoding) fn render(
...
fn render_with_element_count(
    ...
    let elements = crate::package_evidence::encoding::PackagePolicyRecoveryLimits::default()
...
impl<'text> Encoder<'text> {
    pub(in crate::package_evidence::encoding) fn policy_text(writer: Writer<'text>) -> Self {
        Self {
            text: Some(writer),
    ...
    pub(in crate::package_evidence::encoding) fn finish_text(
        self,
    ) -> Result<String, PackageReviewEncodingError> {
        self.check()?;
        self.text
