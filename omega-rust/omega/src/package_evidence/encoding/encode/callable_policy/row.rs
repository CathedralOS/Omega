...
use crate::package_evidence::encoding::encode::callable_policy::behavior;
use crate::package_evidence::encoding::encode::declarations::encode_conformance_bound;
use crate::package_evidence::encoding::encode::declarations::encode_type_identity;
use crate::package_evidence::encoding::encode::encoder::Encoder;
use crate::package_evidence::encoding::encode::values::contracts::encode_callable_contract;
use crate::package_evidence::encoding::encode::values::declarations::{
    encode_operator_coordinate, operator_spelling_name, operator_spelling_tag,
};
use crate::package_evidence::encoding::encode::values::effects::encode_installation_reach;
use crate::package_evidence::encoding::encode::values::effects::encode_synchronous_invocation;
use crate::package_evidence::encoding::encode::values::identity::encode_nominal;
use crate::package_evidence::encoding::encode::values::identity::encode_supply;
...
pub(in crate::package_evidence::encoding) fn encode_callable(
    encoder: &mut Encoder,
