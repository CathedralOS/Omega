...
pub(in crate::package_evidence::encoding) fn crash_route(
    encoder: &mut Encoder,
...
pub(in crate::package_evidence::encoding) fn termination(
    encoder: &mut Encoder,
