...
use crate::package_evidence::encoding::encode::public_api::Encoder;
use crate::package_evidence::encoding::encode::public_api::type_parameter;
...
use crate::package_evidence::record::PackageReviewConformanceSubject;
use crate::package_evidence::record::PackageReviewDataKind;
use crate::package_evidence::record::PackageReviewDomainClassification;
use crate::package_evidence::record::PackageReviewDomainSemanticRole;

pub(in crate::package_evidence::encoding::encode) fn trait_shape(
    encoder: &mut Encoder,
...
pub(in crate::package_evidence::encoding) fn conformance_shape(
    encoder: &mut Encoder,
...
pub(in crate::package_evidence::encoding::encode) fn domain_shape(
    encoder: &mut Encoder,
...
pub(in crate::package_evidence::encoding::encode) fn operator_shape(
    encoder: &mut Encoder,
...
pub(in crate::package_evidence::encoding::encode) fn data_shape(
    encoder: &mut Encoder,
