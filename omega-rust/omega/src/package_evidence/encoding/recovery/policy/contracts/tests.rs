...
use crate::package_evidence::encoding::encode::declarations::encode_machine_parameter_contract;
...
use crate::package_evidence::record::PackageReviewEvidenceRequirement;
use crate::package_evidence::record::PackageReviewMachineParameterContract;
use crate::package_evidence::record::PackageReviewMachineParameterSignature;
...
use crate::package_evidence::record::PackageReviewPropositionBinderArgument;
use crate::package_evidence::record::PackageReviewPropositionBinderArgumentKind;
use crate::package_evidence::record::PackageReviewPropositionBinderKind;
use crate::package_evidence::record::PackageReviewPropositionBinderValue;
use crate::package_evidence::record::PackageReviewPropositionEvidence;
use crate::package_evidence::record::PackageReviewPropositionParameterApplication;
use crate::package_evidence::record::PackageReviewPropositionParameterSignature;
use crate::package_evidence::record::PackageReviewPropositionParameterValue;
use crate::package_evidence::record::PackageReviewResultCaseIdentity;
...
use crate::package_evidence::record::PackageReviewTypeParameterKind;
...
fn property_decoder_preserves_every_closed_carry_axis_and_multiplicity() {
    for multiplicity in [
        ...
        for axes in 0..16 {
            ...
            crate::package_evidence::encoding::encode::declarations::encode_data_properties(
                &mut encoder,
                properties,
            );
            let bytes = encoder.finish().unwrap();
...
fn conformance_bounds_preserve_binder_free_and_selected_application_shapes() {
    ...
    for bound in [unselected, selected] {
        let mut encoder = Encoder::bounded(1024 * 1024);
        crate::package_evidence::encoding::encode::declarations::encode_conformance_bound(
            &mut encoder,
            &bound,
        )
        .unwrap();
