use super::Error;
use crate::package_evidence::PACKAGE_CALLABLE_POLICY_VERSION;
use crate::package_evidence::encoding::CALLABLE_POLICY_MAGIC;
use crate::package_evidence::encoding::PackagePolicyRecoveryLimits;
use crate::package_evidence::encoding::encode::text_test_support::{Component, component};
...
use crate::package_evidence::record::PackageReviewBooleanExpression;
...
use crate::package_evidence::record::PackageReviewContractExpression;
...
use crate::package_evidence::record::PackageReviewIntegerComparisonKind;
use crate::package_evidence::record::PackageReviewNominalIdentity;
use crate::package_evidence::record::PackageReviewNominalOwner;
use crate::package_evidence::record::PackageReviewPrimitiveType;
...
pub(in crate::package_evidence::encoding::recovery::policy) fn fixture() -> PackagePolicyCallables {
    ...
    let mut callable = PackagePolicyCallable {
        ...
        checked_termination: PackagePolicyTermination::Terminates { premises: vec![PackagePolicyProgressPremise {
            ...
            establishment_routes: vec![PackagePolicyServiceProgressRoute {
                kind: abstract_operations_to_target_operations::effects::provider_plan::ServiceProgressEstablishmentRouteKind::CheckedRequirement,
    ...
    callable.capability_flows = [
        typed_trees_to_checked_trees::flow_effects::CapabilityFlowKind::Uses,
        typed_trees_to_checked_trees::flow_effects::CapabilityFlowKind::Returns,
        typed_trees_to_checked_trees::flow_effects::CapabilityFlowKind::Acquires,
        typed_trees_to_checked_trees::flow_effects::CapabilityFlowKind::Stores,
        typed_trees_to_checked_trees::flow_effects::CapabilityFlowKind::Derives,
    ]
    .into_iter()
...
pub(super) fn unchecked_bytes(policy: &PackagePolicyCallables) -> Vec<u8> {
    let mut encoder = crate::package_evidence::encoding::encode::encoder::Encoder::policy_bounded(
        4 * 1024 * 1024,
    );
    ...
    encoder
        .sequence(
            &policy.callables,
            crate::package_evidence::encoding::encode::encode_policy_callable,
        )
        .unwrap();
...
fn named_callable_text_retains_progress_subjects_routes_and_authority_payloads() {
    for subject in [
        ...
        premises[0].establishment_routes[0].kind =
            abstract_operations_to_target_operations::effects::provider_plan::ServiceProgressEstablishmentRouteKind::BoundaryRequirement;
