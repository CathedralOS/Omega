...
use crate::package_evidence::encoding::CALLING_POLICY_MAGIC;
...
pub(in crate::package_evidence::encoding::recovery::policy) fn fixture_elements(
...
fn inner_calling_codec_keeps_bytes_and_shares_aggregate_budgets() {
    use crate::package_evidence::encoding::encode::{
        calling::encode_application, encoder::Encoder,
    };
