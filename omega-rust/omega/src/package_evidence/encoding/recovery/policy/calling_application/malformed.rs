...
use crate::package_evidence::encoding::PACKAGE_CALLING_POLICY_VERSION;
use crate::package_evidence::encoding::PackagePolicyRecoveryLimits;
use crate::package_evidence::encoding::recovery::policy::calling_application::callbacks;
use crate::package_evidence::encoding::recovery::policy::calling_application::shapes;
use crate::package_evidence::encoding::recovery::policy::calling_application::tests;
use crate::package_evidence::encoding::recovery::policy::reader::Reader;
use crate::package_evidence::record::PackagePolicyCallingPlan;
...
fn opaque_selection_lifetimes_cannot_borrow_the_callback_telescope() {
    ...
    for trait_arguments in [false, true] {
        ...
        let mut encoder =
            crate::package_evidence::encoding::encode::encoder::Encoder::policy_bounded(
                4 * 1024 * 1024,
            );
        encoder.fixed_bytes(CALLING_POLICY_MAGIC);
        encoder.u16(PACKAGE_CALLING_POLICY_VERSION);
        crate::package_evidence::encoding::encode::calling::encode_application(
            &mut encoder,
            &changed,
        )
        .unwrap();
