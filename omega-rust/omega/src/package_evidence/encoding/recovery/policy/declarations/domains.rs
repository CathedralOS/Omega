...
#[cfg(test)]
pub(in crate::package_evidence::encoding::recovery::policy) fn domain_shape(
    reader: &mut Reader<'_>,
...
pub(in crate::package_evidence::encoding::recovery::policy) fn alias_atom(
    reader: &mut Reader<'_>,
...
pub(in crate::package_evidence::encoding::recovery::policy) fn establishment_route(
    reader: &mut Reader<'_>,
