...
use crate::package_evidence::record::{PackageReviewDataField, PackageReviewDataMember};
#[cfg(test)]
use crate::package_evidence::record::{PackageReviewDataKind, PackageReviewDataShape};

#[cfg(test)]
pub(in crate::package_evidence::encoding::recovery::policy) fn data_shape(
    reader: &mut Reader<'_>,
...
pub(in crate::package_evidence::encoding::recovery::policy) fn data_member(
    reader: &mut Reader<'_>,
