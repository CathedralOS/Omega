...
use crate::package_evidence::record::{
    PackageReviewTraitCompositionKind, PackageReviewTraitParent,
};

#[cfg(test)]
pub(in crate::package_evidence::encoding::recovery::policy) fn trait_shape(
    reader: &mut Reader<'_>,
...
pub(in crate::package_evidence::encoding::recovery::policy) fn trait_parent(
    reader: &mut Reader<'_>,
...
#[cfg(test)]
pub(in crate::package_evidence::encoding::recovery::policy) fn conformance_shape(
    reader: &mut Reader<'_>,
