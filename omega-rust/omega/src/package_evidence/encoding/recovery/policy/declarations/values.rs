...
#[cfg(test)]
use crate::package_evidence::record::{PackageReviewCallableParameter, PackageReviewOperatorShape};
...
pub(in crate::package_evidence::encoding::recovery::policy) fn proposition_shape(
    reader: &mut Reader<'_>,
...
pub(in crate::package_evidence::encoding::recovery::policy) fn const_shape(
    reader: &mut Reader<'_>,
...
#[cfg(test)]
pub(in crate::package_evidence::encoding::recovery::policy) fn operator_shape(
    reader: &mut Reader<'_>,
...
pub(in crate::package_evidence::encoding::recovery::policy) fn operator_spelling(
    reader: &mut Reader<'_>,
