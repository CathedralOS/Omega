...
use crate::package_evidence::encoding::encode::declarations::{
...
use crate::package_evidence::encoding::recovery::policy::declarations::const_shape;
use crate::package_evidence::encoding::recovery::policy::declarations::data_shape;
use crate::package_evidence::encoding::recovery::policy::declarations::domain_shape;
use crate::package_evidence::encoding::recovery::policy::declarations::operator_shape;
use crate::package_evidence::encoding::recovery::policy::declarations::proposition_shape;
use crate::package_evidence::encoding::recovery::policy::declarations::trait_shape;
...
fn exact_machine_routes_keep_requirement_bytes_and_bound_new_payloads() {
    ...
    use crate::package_evidence::encoding::encode::declarations::encode_domain_establishment_route;
    for (tag, route) in [
        (
            0,
            PackageReviewDomainEstablishmentRoute::CheckedRequirement {
