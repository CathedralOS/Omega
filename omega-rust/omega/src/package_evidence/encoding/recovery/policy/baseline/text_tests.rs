...
use crate::package_evidence::encoding::PackagePolicyTextRecoveryLimits;
...
fn named_text_recovers_exact_binary_and_typed_meaning() {
    ...
    let (binary, _) = crate::package_evidence::encoding::recovery::decode_policy_text_scalars(
        &text,
...
fn labels_variants_whitespace_and_scalar_spellings_are_authoritative() {
    ...
    let version = crate::package_evidence::encoding::PACKAGE_POLICY_BASELINE_VERSION;
    for changed in [
