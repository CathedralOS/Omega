...
use crate::package_evidence::encoding::encode::encoder::text::{
    HEADER, MAXIMUM_MARKUP_DEPTH, Writer,
};
use crate::package_evidence::encoding::{PackagePolicyRecoveryLimits, encode::encoder::Encoder};

fn fields(
    encoder: &mut Encoder,
) -> Result<(), crate::package_evidence::encoding::PackageReviewEncodingError> {
...
fn malformed_framing_never_allocates_from_untrusted_counts() {
    use crate::package_evidence::encoding::PackagePolicyRecoveryError as Error;
    for body in [
