...
pub struct PackagePolicyRecoveryUsage {
    pub(in crate::package_evidence::encoding) owned_bytes: usize,
    pub(in crate::package_evidence::encoding) sequence_elements: usize,
}
...
pub struct PackagePolicyRecoveryLimits {
    pub(in crate::package_evidence::encoding) maximum_bytes: usize,
    pub(in crate::package_evidence::encoding) maximum_field_bytes: usize,
    pub(in crate::package_evidence::encoding) maximum_sequence_elements: usize,
    pub(in crate::package_evidence::encoding) maximum_owned_bytes: usize,
    pub(in crate::package_evidence::encoding) maximum_depth: usize,
}
...
impl PackagePolicyRecoveryLimits {
    ...
    pub(in crate::package_evidence::encoding) fn bounded(self) -> Self {
