use super::Error;
use crate::package_evidence::encoding::PHYSICAL_CALLING_POLICY_MAGIC;
use crate::package_evidence::encoding::PackagePolicyRecoveryLimits;
use crate::package_evidence::encoding::recovery::policy::physical_calling_policy::placement;
use crate::package_evidence::encoding::recovery::policy::reader::Reader;
use crate::package_evidence::record::PackagePolicyPhysicalCallingContract;
use crate::package_evidence::record::PackageReviewBoundaryCallingPolicy;
...
fn envelope_rejects_every_truncated_prefix_unknown_version_and_trailing_bytes() {
    ...
    crate::package_evidence::encoding::encode::text_test_support::component(
        crate::package_evidence::encoding::encode::text_test_support::Component::Physical(
            &component,
        ),
    );
...
fn malformed_nested_locations_and_optional_copy_tags_reject() {
    ...
    component.parameters = vec![PackageReviewBoundaryValuePlacement {
        ...
        locations: vec![PackageReviewBoundaryValueLocation::Indirect {
            pointer:
                crate::package_evidence::record::PackageReviewIndirectPointerLocation::Register(
                    PackageReviewMachineRegister::X86Rax,
                ),
