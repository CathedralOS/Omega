...
use crate::package_evidence::encoding::TERMINAL_PERMISSION_POLICY_MAGIC;
use crate::package_evidence::record::PackagePolicyTerminalPermission;
...
pub(in crate::package_evidence::encoding::recovery::policy) fn fixture()
...
fn complete_schema_and_nested_calling_survive_without_nested_envelopes() {
    ...
    crate::package_evidence::encoding::encode::text_test_support::component(
        crate::package_evidence::encoding::encode::text_test_support::Component::TerminalPermissions(&policy),
    );
    assert!(
        !bytes
            .windows(crate::package_evidence::encoding::CALLING_POLICY_MAGIC.len())
            .any(|window| window == crate::package_evidence::encoding::CALLING_POLICY_MAGIC)
    );
...
fn unpermitted_schema_and_declaration_order_changes_remain_observable() {
    ...
    for changed in cases {
        ...
        crate::package_evidence::encoding::encode::text_test_support::component(
            crate::package_evidence::encoding::encode::text_test_support::Component::TerminalPermissions(&changed),
        );
    }
}
