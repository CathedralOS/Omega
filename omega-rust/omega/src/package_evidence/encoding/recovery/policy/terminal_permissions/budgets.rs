...
fn method_elements(method: &crate::package_evidence::record::PackagePolicyServiceMethod) -> usize {
                    ...
                    service.static_parameters.len()
                        + service
                            ...
                            .map(|parameter| match &parameter.kind {
                                crate::package_evidence::record::PackagePolicyTypeParameterKind::Machine(_) => 1,
                                crate::package_evidence::record::PackagePolicyTypeParameterKind::Proposition(
                                    signature,
