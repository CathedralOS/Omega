...
use symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionKind;
use symbol_resolved_trees_to_typed_trees::typed_trees::AuthoredDeclarationSelectionTarget;
...
pub(super) fn checked_case_classifier(
    ...
    let exact_meaning = if let Some((machine_symbol, state_symbol)) = machine_owner {
        ...
        let state = state_symbol
            ...
            .transpose()?;
        typed_trees_to_checked_trees::validation::has_exact_case_membership_meaning(
            &compilation.typed,
            machine,
            state,
            expression,
        ...
        typed_trees_to_checked_trees::validation::has_exact_domain_case_membership_meaning(
            &compilation.typed,
            domain,
            expression,
            binary,
        ...
        typed_trees_to_checked_trees::validation::has_exact_data_case_membership_meaning(
            &compilation.typed,
            data,
            expression,
            binary,
        ...
        typed_trees_to_checked_trees::validation::has_exact_parameter_case_membership_meaning(
            &compilation.typed,
            context.parameters,
            expression,
            binary,
    ...
    let carrier = typed_trees_to_checked_trees::validation::exact_case_reference_owner(
        &compilation.typed,
        binary.right,
    )
    .ok_or_else(rejected)?;
