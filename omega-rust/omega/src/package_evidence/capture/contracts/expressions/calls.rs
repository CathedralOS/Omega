...
pub(crate) fn resolved_contract_call_symbol(
    ...
    call.target_symbol
        ...
        .or_else(|| {
            symbol_resolved_trees_to_typed_trees::typed_trees::operator::resolve_named_expression_call(&compilation.typed, call)
...
pub(crate) fn exact_fact_call_projection<'compilation>(
    ...
    context: &ContractProjectionContext<'_>,
    projection_expression: symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionHandle,
    ...
    &'compilation typed_trees_to_checked_trees::checked_trees::CheckedFactCallProjection,
    Vec<Diagnostic>,
> {
