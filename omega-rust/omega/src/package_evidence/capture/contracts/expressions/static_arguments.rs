...
use crate::package_evidence::capture::semantics::types::lifetimes::substituted_lifetime_binder_ordinal;
use crate::package_evidence::capture::semantics::types::missing_exact_toolchain_type_owner;
use crate::package_evidence::record::{
    PackageReviewContractStaticArgument, PackageReviewTypeIdentity,
};
...
pub(crate) fn contract_call_static_parameter_kind(
    parameter: &symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameter,
) -> ContractCallStaticParameterKind {
    match parameter.kind {
        symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameterKind::Type => ContractCallStaticParameterKind::Type,
...
pub(crate) fn contract_call_static_parameter_kinds(
    ...
    let project = |parameters: &[symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameter]| {
        parameters
            .iter()
