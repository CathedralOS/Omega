...
pub(crate) fn project_contract_call_evidence_arguments(
    ...
    checked
        ...
        .map(|(lane_position, binding)| {
            ...
            if source.kind != typed_trees_to_checked_trees::checked_trees::ContractProofFactKind::Requires
                ...
                || parameter.kind != typed_trees_to_checked_trees::checked_trees::ContractProofFactKind::Requires
...
fn evidence_owner_visible_from(
    term_owner: typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner,
    fact_owner: typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner,
) -> bool {
...
fn evidence_owner_belongs_to_target(
    owner: typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner,
    ...
    matches!(
        ...
        owner,
        typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner::StateSignature {
            owner_symbol,
            state_symbol,
...
fn project_term(
    compilation: &PackageReviewInput<'_>,
    term: &typed_trees_to_checked_trees::checked_trees::CheckedEvidenceTerm,
) -> Result<PackageReviewContractEvidenceTerm, Vec<Diagnostic>> {
    let owner = match term.owner {
        typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner::Machine { machine_symbol } => machine_symbol,
        typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner::MachineState { state_symbol, .. }
        | typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner::StateSignature { state_symbol, .. } => {
            state_symbol
        }
        typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner::OperatorDeclaration { operator_symbol }
        | typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner::OperatorUse {
            operator_symbol, ..
        } => operator_symbol,
        typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner::Unknown => {
