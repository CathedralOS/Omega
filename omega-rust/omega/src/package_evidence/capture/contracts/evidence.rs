...
pub(crate) fn checked_outcome_specific_guarantee<'a>(
    ...
    binding: Option<&symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier>,
) -> Result<
    &'a typed_trees_to_checked_trees::checked_trees::OutcomeSpecificGuaranteeFact,
    Vec<Diagnostic>,
> {
    let typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner::Machine {
        machine_symbol,
    } = context.owner
    else {
...
) -> Result<&'a typed_trees_to_checked_trees::checked_trees::ContractProofFact, Vec<Diagnostic>> {
...
pub(crate) fn validate_checked_contract_evidence(
    ...
    context: &ContractProjectionContext<'_>,
    binding: Option<&symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier>,
    checked: &typed_trees_to_checked_trees::checked_trees::ContractProofFact,
...
pub(crate) fn validate_checked_contract_evidence_components(
    ...
    context: &ContractProjectionContext<'_>,
    binding: Option<&symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier>,
    checked_owner: typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner,
    checked_kind: typed_trees_to_checked_trees::checked_trees::ContractProofFactKind,
    checked_evidence_term: Option<
        arena::Handle<typed_trees_to_checked_trees::checked_trees::CheckedEvidenceTerm>,
    >,
    projected: &PackageReviewContractFact,
) -> Result<Option<u32>, Vec<Diagnostic>> {
