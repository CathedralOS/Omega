...
use symbol_resolved_trees_to_typed_trees::typed_trees::{TypedTrees, domain::ProofMembershipFact};
...
mod tests {
    ...
    use crate::package_evidence::capture::contracts::memberships::require_declaration_membership;
        ...
        for index in [7, 9] {
            let argument =
                program
                    ...
                    .insert(symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceNode::Named {
                        symbol: symbols::SymbolHandle::invalid(),
                        name: symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier::generated(index.to_string()),
                    });
