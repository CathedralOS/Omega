...
pub(crate) struct ContractProjectionContext<'a> {
    ...
    pub(crate) owner: typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner,
    ...
    pub(crate) lifetime_binders:
        &'a [symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier],
