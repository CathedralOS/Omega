...
use crate::package_evidence::capture::callables::project_contract_entailment_open_contract;
...
pub(in crate::package_evidence::capture) fn project_package_contract_entailment_open_obligations(
...
) -> Result<Vec<ProjectedReviewRow<PackageReviewContractEntailmentOpenObligation>>, Vec<Diagnostic>>
{
        ...
        })
    {
        ...
        let reason = match stand_down.reason {
            typed_trees_to_checked_trees::validation::ContractEntailmentStandDownReason::UnsupportedEnsuresFact => {
            ...
            typed_trees_to_checked_trees::validation::ContractEntailmentStandDownReason::OutsideEntailmentLanguage => {
...
pub(in crate::package_evidence::capture) fn project_package_contract_entailment_assumption_discharges(
    compilation: &PackageReviewInput<'_>,
    package: PackageKeyIdentity,
