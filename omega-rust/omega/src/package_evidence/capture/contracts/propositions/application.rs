...
use crate::package_evidence::capture::contracts::expressions::names::portable_parameter_position;
use crate::package_evidence::capture::contracts::expressions::projection::project_contract_expression_with_substitutions;
...
fn require_exact_reference_argument(
    ...
    expected_type: symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle,
    ...
    ) && !typed_trees_to_checked_trees::validation::checked_argument_matches_type_reference(
        &compilation.typed,
        argument,
        expected_type,
    ) {
...
pub(crate) fn project_contract_proposition(
            ...
            == symbols::SymbolKind::PropositionParameter
    {
        ...
        let symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameterKind::Proposition { contract } = &parameter.kind else {
            return Err(vec![Diagnostic::error(format!(
