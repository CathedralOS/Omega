...
use crate::package_evidence::capture::semantics::types::lifetimes::lifetime_binder_ordinal;
use crate::package_evidence::capture::semantics::types::{
...
pub(crate) fn project_evidence_interface(
    ...
    evidence: symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle,
...
pub(crate) fn collect_evidence_requirements(
    ...
    trait_arguments: &[symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle],
    trait_lifetime_arguments: &[symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier],
    proposition_binders: &[(SymbolHandle, String)],
    lifetime_binders: Option<
        ...
        !matches!(
            ...
            symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameterKind::Type
                ...
                | symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameterKind::Machine {
                    contract: symbol_resolved_trees_to_typed_trees::typed_trees::data::MachineParameterContract::RequirementIdentity
                }
        )
    }) {
        return Err(vec![Diagnostic::error(format!(
