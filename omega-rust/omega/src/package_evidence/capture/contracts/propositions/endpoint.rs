...
pub(crate) fn project_proposition_endpoint(
    ...
    use symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionBody;
...
pub(crate) fn project_proposition_signature(
    ...
    Vec<Diagnostic>,
> {
    use symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionBinderKind;
