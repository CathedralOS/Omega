...
use crate::package_evidence::capture::semantics::types::missing_exact_toolchain_type_owner;
...
pub(crate) fn project_proposition_evidence_projection(
    compilation: &PackageReviewInput<'_>,
    context: &ContractProjectionContext<'_>,
    projection: &symbol_resolved_trees_to_typed_trees::typed_trees::expression::EvidenceProjection,
