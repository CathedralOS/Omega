...
use crate::package_evidence::record::{PackageReviewNominalIdentity, PackageReviewNominalOwner};
use crate::provider_planning::ProviderSchemaDeclaration;
use abstract_operations_to_target_operations::effects::ServiceTerminalAuthorityPermission;
use abstract_operations_to_target_operations::effects::provider_plan::ServiceSchema;
...
pub(super) fn resolve_services<'a>(
    ...
    for accepted in compilation.custody.resolved_semantic_bindings() {
        ...
        let schema =
            crate::provider_planning::service_schema::from_typed(&compilation.typed, definition)
        ...
        let digest =
            crate::package_compilation::accepted_service_schema_digest(accepted.role(), &schema);
