...
pub(in crate::package_evidence::capture::behavior) fn project_boolean_expression(
...
fn project_scalar_expression(
    ...
    use typed_trees_to_checked_trees::checked_trees::CheckedScalarExpression;
...
fn project_structural_path(
    ...
    path.iter()
        .map(|segment| match segment {
            typed_trees_to_checked_trees::checked_trees::CheckedStructuralPredicatePathSegment::Field(field) => {
                PackageReviewStructuralPredicatePathSegment::Field(field.clone())
            }
            typed_trees_to_checked_trees::checked_trees::CheckedStructuralPredicatePathSegment::Case(case) => {
...
const fn project_integer_comparison_kind(
    kind: typed_trees_to_checked_trees::checked_trees::CheckedIntegerComparisonKind,
) -> PackageReviewIntegerComparisonKind {
    match kind {
        typed_trees_to_checked_trees::checked_trees::CheckedIntegerComparisonKind::Equal => {
            PackageReviewIntegerComparisonKind::Equal
        }
        typed_trees_to_checked_trees::checked_trees::CheckedIntegerComparisonKind::LessThan => {
            PackageReviewIntegerComparisonKind::LessThan
        }
        typed_trees_to_checked_trees::checked_trees::CheckedIntegerComparisonKind::LessOrEqual => {
...
const fn project_integer_binary_kind(
    kind: typed_trees_to_checked_trees::checked_trees::CheckedIntegerBinaryKind,
) -> PackageReviewIntegerBinaryKind {
    use typed_trees_to_checked_trees::checked_trees::CheckedIntegerBinaryKind;
    match kind {
