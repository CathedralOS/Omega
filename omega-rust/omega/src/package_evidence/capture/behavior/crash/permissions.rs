...
pub(super) fn project_crash_predicates(
    predicates: &[typed_trees_to_checked_trees::checked_trees::CrashPredicateIdentity],
...
pub(super) fn project_crash_predicate(
    predicate: &typed_trees_to_checked_trees::checked_trees::CrashPredicateIdentity,
