...
use crate::package_evidence::record::{PackagePolicyMutation, PackageReviewWriteFrameCompleteness};
...
pub(crate) fn mutation<'program>(
    ...
    source: &'program symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees,
    resolver: &typed_trees_to_checked_trees::validation::CallFrameResolver<'program>,
    machine: &Machine,
    entry: &State,
