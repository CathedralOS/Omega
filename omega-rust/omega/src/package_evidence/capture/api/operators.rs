...
use crate::package_evidence::capture::behavior::project_crash_cause;
use crate::package_evidence::capture::contracts::expressions::projection::project_contract_expression;
use crate::package_evidence::capture::contracts::facts::{
...
use crate::package_evidence::capture::semantics::signatures::parameters::project_type_parameters;
...
use crate::package_evidence::capture::source::contracts::project_contract_source_locations;
use crate::package_evidence::capture::source::parameters::{
...
pub(crate) fn project_operator_coordinate(
    ...
    declaration: &symbol_resolved_trees_to_typed_trees::typed_trees::operator::OperatorDefinition,
...
pub(crate) fn project_public_operators(
    ...
    for declaration in operators.filter(|declaration| declaration.is_public) {
        ...
        let context = ContractProjectionContext {
            ...
            owner: typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner::OperatorDeclaration {
...
pub(crate) fn project_operator_crash_routes(
    compilation: &PackageReviewInput<'_>,
    checked: &typed_trees_to_checked_trees::checked_trees::CheckedOperatorCrashContract,
