...
use crate::package_evidence::capture::api::domains::facts::{
...
pub(crate) fn project_public_data(
    ...
    let quotient_formations =
        typed_trees_to_checked_trees::validation::validate_quotient_formations(compilation)?;
