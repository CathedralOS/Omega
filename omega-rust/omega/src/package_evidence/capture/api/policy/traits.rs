...
use crate::package_evidence::capture::semantics::signatures::policy_crashes;
...
fn project_requirement(
    ...
    offset: usize,
    outer_lifetimes: &[symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier],
    ...
    let context = ContractProjectionContext {
        ...
        owner: typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner::StateSignature { owner_symbol: owner, state_symbol: source.symbol },
        point: typed_trees_to_checked_trees::fact_plan::ProgramPoint::State { machine_symbol: owner, state_symbol: source.symbol },
