...
pub(crate) fn project_trait_parent(
    compilation: &PackageReviewInput<'_>,
    parent: &symbol_resolved_trees_to_typed_trees::typed_trees::trait_definition::TraitRequirement,
...
pub(crate) fn project_trait_requirement(
    ...
    trait_lifetime_parameters: &[symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier],
