...
use crate::package_evidence::capture::api::policy::conformances as project_public_conformances;
...
use crate::package_evidence::record::{
    PackagePolicyRepresentationAvailability, PackageReviewConformanceSubject,
};
...
pub(super) fn project(
    ...
    for declaration in compilation.conformances().iter().filter(|declaration| {
        declaration.is_public
            ...
            && crate::representation_planning::is_compiler_owned_opaque_representation_trait(
                &compilation.typed,
