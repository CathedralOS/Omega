...
use crate::package_evidence::capture::behavior::canonical_checked_invocation_targets;
...
pub(crate) fn validate_machine_invocations(
    ...
    let declarations = compilation.machine_invokes(machine);
    let declared = typed_trees_to_checked_trees::validation::declared_machine_invocations(
        compilation,
        machine,
    );
...
pub(crate) fn project_signature_invocation_source_locations(
    ...
    let targets = typed_trees_to_checked_trees::validation::declared_signature_invocations(
        compilation,
        signature,
    );
