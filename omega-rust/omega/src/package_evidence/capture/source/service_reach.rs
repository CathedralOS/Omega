...
use typed_trees_to_checked_trees::flow_effects::ServiceReachInferencePlan;
...
fn checked_machine_service_reach<'a>(
    ...
    Option<
        &'a symbol_resolved_trees_to_typed_trees::typed_trees::signature::AuthoredServiceReachRow,
    >,
    Vec<Diagnostic>,
> {
    ...
    let declared = derive_declared_service_reach(
        compilation,
        authored,
        &typed_trees_to_checked_trees::validation::declared_machine_invocations(
            compilation,
            machine,
        ),
        parameters,
...
pub(crate) fn project_signature_service_reach_source_locations(
    ...
    let declared = derive_declared_service_reach(
        compilation,
        authored,
        &typed_trees_to_checked_trees::validation::declared_signature_invocations(
            compilation,
            signature,
        ),
...
fn derive_declared_service_reach(
    compilation: &PackageReviewInput<'_>,
    authored: Option<
        &symbol_resolved_trees_to_typed_trees::typed_trees::signature::AuthoredServiceReachRow,
    >,
    invocations: &[typed_trees_to_checked_trees::flow_effects::InvocationTarget],
    ...
    for invocation in invocations {
        let symbol = match invocation {
            typed_trees_to_checked_trees::flow_effects::InvocationTarget::Parameter(ordinal) => non_self_parameters
            ...
            typed_trees_to_checked_trees::flow_effects::InvocationTarget::Service(symbol) => *symbol,
        };
