...
pub(crate) fn project_application(
    ...
    boundary_arguments: &[symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle],
...
fn project_with_binders(
    compilation: &PackageReviewInput<'_>,
    mut projected: symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees,
    boundary_trait: symbols::SymbolHandle,
    boundary_arguments: &[symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle],
    requirement_machine: symbols::SymbolHandle,
