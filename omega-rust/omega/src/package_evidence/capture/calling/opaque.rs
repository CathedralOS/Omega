...
use crate::package_evidence::capture::representation::physical_contract::{
...
use crate::package_evidence::capture::semantics::conformances::project_checked_conformance_policy;
use crate::package_evidence::capture::semantics::declarations::{nominal_identity, nominal_owner};
...
use abstract_operations_to_target_operations::calling_conventions::ValidatedBoundaryEntryPlan;
...
pub(super) fn project(
    ...
    let selections =
        crate::package_evidence::capture::representation::rederive_selections(compilation)?;
