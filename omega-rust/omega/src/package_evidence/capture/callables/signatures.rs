...
use crate::package_evidence::capture::semantics::conformances::project_conformance_bounds;
    ...
    let static_parameters = type_parameters
        ...
        .map(|parameter| match &parameter.kind {
            ...
            symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameterKind::Const { type_reference } => {
                if parameter.bounds != symbol_resolved_trees_to_typed_trees::typed_trees::data::DataProperties::default() {
