...
use crate::package_evidence::record::{
    PackagePolicyExternalBinding, PackagePolicyExternalExecutableSupply,
};
...
pub fn project_checked_external_supply_policy<'a>(
    ...
    if let crate::package_evidence::record::PackagePolicyExternalRequirement::TopLevelRequirement {
        signature: required,
        ..
    } = &requirement
