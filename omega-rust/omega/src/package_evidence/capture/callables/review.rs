...
pub(in crate::package_evidence::capture) fn project_callable(
...
pub(in crate::package_evidence::capture) fn project_contract_entailment_open_contract(
    compilation: &PackageReviewInput<'_>,
    machine: &symbol_resolved_trees_to_typed_trees::typed_trees::machine::Machine,
    contract_index: usize,
    fact_index: usize,
) -> Result<crate::package_evidence::record::PackageReviewCallableContract, Vec<Diagnostic>> {
...
pub(in crate::package_evidence::capture) fn project_private_external_executable_supply(
    compilation: &PackageReviewInput<'_>,
    machine: &symbol_resolved_trees_to_typed_trees::typed_trees::machine::Machine,
    identity: &PackageReviewNominalIdentity,
