...
pub(super) fn project_evaluated_binding(
    ...
    row: &crate::provider_planning::evaluated_via_bindings::EvaluatedViaBindingRow,
) -> Result<PackageReviewExternalBinding, Vec<Diagnostic>> {
    match row.evaluated() {
        crate::provider_planning::evaluated_via_bindings::EvaluatedViaBinding::Import(
            evaluated,
        ) => project_evaluated_import(compilation, row, evaluated),
        crate::provider_planning::evaluated_via_bindings::EvaluatedViaBinding::Syscall(
            evaluated,
...
fn project_evaluated_syscall(
    compilation: &PackageReviewInput<'_>,
    row: &crate::provider_planning::evaluated_via_bindings::EvaluatedViaBindingRow,
    evaluated: &abstract_operations_to_target_operations::effects::provider_plan::EvaluatedForeignSyscall,
) -> Result<PackageReviewExternalBinding, Vec<Diagnostic>> {
    let receipt = evaluated.receipt();
    let usage = receipt.evaluation_usage();
...
pub(super) fn external_binding_matches_provider_binding(
    ...
    selected: &abstract_operations_to_target_operations::effects::provider_plan::ProviderBinding,
) -> bool {
    ...
    match (binding, selected) {
        ...
        (
            ...
            abstract_operations_to_target_operations::effects::provider_plan::ProviderBinding::Syscall {
        ...
        (
            ...
            abstract_operations_to_target_operations::effects::provider_plan::ProviderBinding::VtableSlot {
                index: selected_index,
            },
        ) => index == selected_index,
        (
            PackageReviewExternalBinding::VtableField { field },
            abstract_operations_to_target_operations::effects::provider_plan::ProviderBinding::VtableField {
                table,
        ...
        (
            ...
            abstract_operations_to_target_operations::effects::provider_plan::ProviderBinding::TableFunction {
                table,
                field: selected_field,
            },
        ) => table == &expected_table && field == selected_field,
