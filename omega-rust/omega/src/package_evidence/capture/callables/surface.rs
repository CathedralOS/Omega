...
pub(super) struct ProjectedSurface<'a> {
    ...
    pub realized: &'a typed_trees_to_checked_trees::checked_trees::RealizedMachineContractEnvelope,
...
pub(super) fn project<'a>(
    ...
    if policy_mode {
        crate::package_evidence::capture::source::invocations::validate_machine_invocations(
            compilation,
            machine,
        )?;
        crate::package_evidence::capture::source::suspension::validate_machine_operational(
            compilation,
            machine,
        )?;
    }
