                ...
                row: PackageReviewRepresentationTcb {
                    ...
                    kind: PackageReviewRepresentationTcbKind::SelectedCopyReceipt {
                        ...
                        origin: match selection.origin() {
                            crate::representation_planning::OpaqueRepresentationApplicationOrigin::NamedConformance => PackageReviewOpaqueRepresentationApplicationOrigin::NamedConformance,
                        },
                        lifecycle: match selection.lifecycle() {
                            crate::representation_planning::OpaqueRepresentationLifecycleDisposition::Inert => PackageReviewOpaqueRepresentationLifecycleDisposition::Inert,
                        },
                        copy_disposition:
                ...
                .map(|representation| {
                    ...
                    Ok(PackageReviewOpaqueRepresentationOccurrence {
                        ...
                        role: match movement.role() {
                            crate::provider_planning::calling_policy_plans::BoundaryOpaqueRepresentationMovementRole::Parameter {
                                formal_ordinal,
                                native_ordinal,
                            ...
                            crate::provider_planning::calling_policy_plans::BoundaryOpaqueRepresentationMovementRole::Result => {
                        ...
                        path: movement
                            ...
                            .map(|element| match element {
                                crate::provider_planning::calling_policy_plans::BoundaryOpaqueRepresentationPathElement::FixedArrayElement => {
                                    PackageReviewOpaqueRepresentationPathElement::FixedArrayElement
                                }
                                crate::provider_planning::calling_policy_plans::BoundaryOpaqueRepresentationPathElement::RecordField { ordinal } => {
