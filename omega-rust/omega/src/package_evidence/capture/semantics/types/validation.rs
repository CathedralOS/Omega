                ...
                match constraint {
                    ...
                    TypeConstraintNode::Domain(domain) => {
                        ...
                        match domain.subject {
                            DomainConstraintSubject::Declared => {
                                if domain.name.as_str() == "OmegaLayout"
                                    || symbol_resolved_trees_to_typed_trees::typed_trees::wire::is_layout_domain_name(
                                        domain.name.as_str(),
                                    )
                                {
                        ...
                        let declared_parameters = (domain.subject
                            == symbol_resolved_trees_to_typed_trees::typed_trees::types::DomainConstraintSubject::Declared)
                            .then(|| {
                                program
                                    .domain_definitions()
                                    .iter()
...
mod tests {
    ...
    fn value_dispatch_cannot_be_erased_from_package_structural_index_identity() {
        ...
        let subject = program.expression_table.insert(
        ...
        let arms =
            program
                .expression_table
                .insert_match_arms([symbol_resolved_trees_to_typed_trees::typed_trees::expression::TableMatchArm {
        ...
        let expression =
            program
                .expression_table
                .insert(symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionNode::Match(
                    symbol_resolved_trees_to_typed_trees::typed_trees::expression::TableMatchExpression { subject, arms },
                ));
