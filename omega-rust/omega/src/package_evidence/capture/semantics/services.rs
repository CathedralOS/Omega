...
use abstract_operations_to_target_operations::effects::provider_plan::ServiceMethod;
use diagnostics::Diagnostic;
use symbols::SymbolHandle;

pub(crate) use crate::package_evidence::capture::calling::application::signature::declaration_parameters;
...
fn project_inner(
    ...
    crate::package_evidence::capture::providers::selection::validate_selected_provider_declaration_owner(
        &owner,
