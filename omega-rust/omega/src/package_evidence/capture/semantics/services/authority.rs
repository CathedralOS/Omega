...
use crate::package_evidence::capture::nominal_identity;
use crate::package_evidence::capture::semantics::services::rejected;
use crate::provider_planning::ProviderSchemaDeclaration;
use diagnostics::Diagnostic;
use symbols::SymbolHandle;

mod progress;
use crate::package_evidence::capture::behavior::{
    project_service_row, project_synchronous_invocations,
};
use crate::package_evidence::record::PackagePolicyServiceAuthority;
...
pub(super) fn project(
    ...
    let (row, implicit_service, invocations, parameters, guarantee) = match declaration {
        ...
        ProviderSchemaDeclaration::BoundaryOperator(_) => {
            // crate::provider_planning::service_schema::from_typed_operator exposes no service-reach,
