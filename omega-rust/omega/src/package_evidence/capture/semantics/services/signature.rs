...
use crate::package_evidence::capture::semantics::services::calling;
...
pub(super) fn project_declaration(
    ...
    calling: Option<&crate::package_evidence::record::PackagePolicyCallingPlan>,
    ...
    let projected =
        crate::package_evidence::capture::calling::application::signature::project_declaration(
            compilation,
            schema,
            requirement,
        )?;
...
fn from_application(
    projected: crate::package_evidence::capture::calling::application::signature::CallingSignatureProjection,
    identity: &PackageReviewNominalIdentity,
) -> Result<PackagePolicyServiceSignature, Vec<Diagnostic>> {
...
pub(super) fn project(
    ...
    if let ProviderSchemaDeclaration::BoundaryTrait(symbol) = schema {
        ...
        let projected =
            crate::package_evidence::capture::calling::application::signature::project_application(
                compilation,
                symbol,
                arguments,
                requirement,
    ...
    if !parameters.is_empty() {
        let lifetime_substitutions = lifetimes
            ...
            .collect::<Vec<_>>();
        crate::package_evidence::capture::calling::application::signature::instantiate_static_parameters(
            projected.to_mut(),
            &mut parameters,
            &[],
