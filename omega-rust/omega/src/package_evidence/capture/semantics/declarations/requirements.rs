...
pub(crate) fn provider_requirement_identity(
    compilation: &PackageReviewInput<'_>,
    schema: crate::provider_planning::ProviderSchemaDeclaration,
    requirement_symbol: SymbolHandle,
) -> Result<PackageReviewNominalIdentity, Vec<Diagnostic>> {
    match provider_requirement_schema(compilation, schema, requirement_symbol)? {
        crate::provider_planning::ProviderSchemaDeclaration::BoundaryTrait(trait_symbol) => {
        ...
        crate::provider_planning::ProviderSchemaDeclaration::BoundaryRequirement(schema_symbol) => {
        ...
        crate::provider_planning::ProviderSchemaDeclaration::BoundaryOperator(_) => {
            ...
            Ok(PackageReviewNominalIdentity {
                owner: nominal.owner,
                path: symbol_resolved_trees_to_typed_trees::typed_trees::operator::boundary_operator_requirement_identity(
                    &compilation.typed,
                    operator,
                ),
            })
