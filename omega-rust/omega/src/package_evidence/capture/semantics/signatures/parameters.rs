...
pub(crate) struct CallingContractScope {
    ...
    pub parameters:
        Vec<symbol_resolved_trees_to_typed_trees::typed_trees::signature::StateParameter>,
    pub original_signature:
...
impl Projection<'_> {
    fn value_type(
        ...
        lifetimes: &[symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier],
    ) -> Result<crate::package_evidence::record::PackageReviewTypeIdentity, Vec<Diagnostic>> {
...
fn project_type_parameters_inner(
    ...
    for parameter in parameters {
        let kind = match &parameter.kind {
            symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameterKind::Type => PackageReviewTypeParameterKind::Type,
            ...
            symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameterKind::Machine { contract } => {
...
pub(crate) fn project_machine_parameter_contract(
    ...
    contract: &symbol_resolved_trees_to_typed_trees::typed_trees::data::MachineParameterContract,
    declaration_kind: &str,
    declaration_path: &str,
    outer_binders: &[(SymbolHandle, String)],
    nested_ordinal_offset: usize,
    outer_lifetime_binders: &[symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier],
    depth: usize,
    ...
    match contract {
        ...
        symbol_resolved_trees_to_typed_trees::typed_trees::data::MachineParameterContract::Structural(signature) => {
            ...
            let context = ContractProjectionContext {
                ...
                owner: typed_trees_to_checked_trees::checked_trees::ContractProofFactOwner::StateSignature {
                    owner_symbol: parameter_symbol,
                    state_symbol: signature.symbol,
                },
                point: typed_trees_to_checked_trees::fact_plan::ProgramPoint::State {
            ...
            Ok(PackageReviewMachineParameterContract::Structural(
                PackageReviewMachineParameterSignature {
                    ...
                    synchronous_invocations: project_synchronous_invocations(
                        compilation,
                        &typed_trees_to_checked_trees::validation::declared_signature_invocations(compilation, source_signature),
                    )?,
