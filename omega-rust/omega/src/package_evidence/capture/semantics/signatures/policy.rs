...
use crate::package_evidence::capture::calling::application::signature::instantiate_static_parameters;
use crate::package_evidence::capture::semantics::signatures::parameters::project_policy_type_parameters_after;
...
pub(crate) struct PreparedRequirement {
    pub typed: symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees,
    pub signature: symbol_resolved_trees_to_typed_trees::typed_trees::signature::StateSignature,
    pub lifetimes: Vec<Identifier>,
    pub scopes: Vec<
        crate::package_evidence::capture::semantics::signatures::parameters::CallingContractScope,
    >,
}
...
pub(crate) fn requirement(
    ...
    owner: SymbolHandle,
    source: &symbol_resolved_trees_to_typed_trees::typed_trees::signature::StateSignature,
    subject: &str,
