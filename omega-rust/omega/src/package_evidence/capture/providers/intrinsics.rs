...
fn execution_identity_label(identity: CompilerIntrinsicExecutionIdentity) -> String {
    match identity {
        ...
        CompilerIntrinsicExecutionIdentity::HostedReadByte => {
            "Hosted read-byte returning `ByteRead`".to_owned()
        }
        CompilerIntrinsicExecutionIdentity::BuiltinFunction(function) => {
...
mod tests {
    ...
    use crate::package_evidence::record::PackageReviewCompilerIntrinsicExecution;
    use crate::selected_dispatch::SelectedCompilerIntrinsicExecutionIdentity;
        ...
        for (derived, retained, expected) in [
            ...
            (
                ...
                Some(PrimitiveFloatBinary {
                    operation:
                        crate::provider_planning::CompilerPrimitiveFloatBinaryOperation::Subtract,
                    format: FloatFormat::F32,
                }),
