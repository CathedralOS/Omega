...
use crate::package_evidence::capture::providers::installation::project_selected_installation_reach;
use crate::package_evidence::capture::providers::intrinsics::project_compiler_intrinsic_execution;
use crate::package_evidence::capture::providers::selection::validate_selected_provider_declaration_owner;
...
use crate::package_evidence::record::PackagePolicyProviderRow;
use crate::provider_planning::{ProviderSchemaDeclaration, SelectedProviderReviewProvenance};
...
fn validate_lifetime_partition(
    ...
    if symbol_resolved_trees_to_typed_trees::typed_trees::machine::normalize_requirement_lifetime_partition(
