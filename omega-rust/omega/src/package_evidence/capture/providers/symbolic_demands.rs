...
pub(crate) fn project_boundary_application_demands(
    ...
    for demand in &compilation.facts.operators.symbolic_boundary_applications {
        ...
        let typed_trees_to_checked_trees::checked_trees::CheckedBoundaryOperatorApplicationUseSite::Expression {
            expression,
            origin,
        } = demand.site
        else {
        ...
        let requirement_identity = symbol_resolved_trees_to_typed_trees::typed_trees::operator::boundary_operator_requirement_identity(
            &compilation.typed,
            operator,
        );
...
fn symbolic_demand_authored_use_kind(
...
) -> Result<crate::selected_dispatch::CheckedOperatorAuthoredUseKind, Vec<Diagnostic>> {
    ...
    {
        kinds.push(crate::selected_dispatch::CheckedOperatorAuthoredUseKind::Named);
    }
    kinds.extend(
        compilation
            .facts
            ...
            .filter_map(|(_, operator_use)| {
                ...
                .then_some(
                    crate::selected_dispatch::CheckedOperatorAuthoredUseKind::FixedToken(
...
fn demand_key(
    ...
    &crate::package_evidence::record::PackageReviewOperatorCoordinate,
    &str,
    &crate::package_evidence::record::PackageReviewNominalIdentity,
    &[PackageReviewSymbolicBoundaryApplicationArgument],
) {
    (
