...
fn project_exact_application(
    ...
    arguments: &[typed_trees_to_checked_trees::checked_trees::CheckedBoundaryOperatorApplicationArgument],
...
fn expression_is_owned_by_package(
    ...
    use_kind: crate::selected_dispatch::CheckedOperatorAuthoredUseKind,
...
fn authored_application_selection_kind(
    ...
    match use_kind {
        crate::selected_dispatch::CheckedOperatorAuthoredUseKind::Named => {
            AuthoredDeclarationSelectionKind::Call
        }
        crate::selected_dispatch::CheckedOperatorAuthoredUseKind::FixedToken(_) => {
