...
pub(super) fn project(
    ...
    for application in &compilation.facts.operators.boundary_applications {
        ...
        let selection_target = crate::provider_planning::IntrinsicRequirement::by_symbol(
            &compilation.typed,
        ...
        let implicit_source_span = match application.site {
            typed_trees_to_checked_trees::checked_trees::CheckedBoundaryOperatorApplicationUseSite::MatchEquality {
                ...
                let symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionNode::Match(dispatch) =
        ...
        let joined = crate::provider_planning::selected_use_plan(
            compilation.program,
            selected_plans,
            application.requirement_symbol,
            actual_use.origin,
        ...
        // for either species.
        let requirement_identity = crate::provider_planning::IntrinsicRequirement::by_symbol(
            &compilation.typed,
            application.requirement_symbol,
        )
...
struct ExactApplicationUse {
    kind: crate::selected_dispatch::CheckedOperatorAuthoredUseKind,
    origin: typed_trees_to_checked_trees::checked_trees::CheckedValueOrigin,
}

fn exact_application_uses(
    compilation: &PackageReviewInput<'_>,
    site: typed_trees_to_checked_trees::checked_trees::CheckedBoundaryOperatorApplicationUseSite,
        ...
        .filter_map(|(_, operator_use)| {
            (site
                ...
                .then_some(ExactApplicationUse {
                    kind: crate::selected_dispatch::CheckedOperatorAuthoredUseKind::Named,
                    origin: operator_use.origin,
                })
        })
        .chain(
        ...
        .chain(
            compilation
                ...
                .filter_map(|(_, operator_use)| {
                    ...
                    .then_some(ExactApplicationUse {
                        kind: crate::selected_dispatch::CheckedOperatorAuthoredUseKind::FixedToken(
