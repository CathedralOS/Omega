...
pub struct PackagePolicyCapabilityFlow {
    ...
    pub(crate) kind: typed_trees_to_checked_trees::flow_effects::CapabilityFlowKind,
}
...
impl PackagePolicyCapabilityFlow {
    ...
    pub const fn kind(&self) -> typed_trees_to_checked_trees::flow_effects::CapabilityFlowKind {
        self.kind
    }
    ...
    fn kind_tag(&self) -> u8 {
        match self.kind {
            typed_trees_to_checked_trees::flow_effects::CapabilityFlowKind::Uses => 0,
            typed_trees_to_checked_trees::flow_effects::CapabilityFlowKind::Returns => 1,
            typed_trees_to_checked_trees::flow_effects::CapabilityFlowKind::Acquires => 2,
            typed_trees_to_checked_trees::flow_effects::CapabilityFlowKind::Stores => 3,
            typed_trees_to_checked_trees::flow_effects::CapabilityFlowKind::Derives => 4,
        }
    }
}
