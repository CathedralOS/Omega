...
impl PackagePolicyCallingPlan {
    pub(crate) fn validate_canonical_structure(&self) -> Result<(), &'static str> {
        ...
        let scope = crate::package_evidence::record::public_policy::validation::scope(
        ...
        crate::package_evidence::record::public_policy::validation::signatures::parameters(
            &scope, 0,
        )?;
...
fn validate_application_lifetimes(
    ...
    application: &crate::package_evidence::record::PackagePolicyClosedConformanceApplication,
) -> Result<(), &'static str> {
    let count = policy
        .boundary_lifetime_parameter_count
...
fn validate_nominal(
    identity: &crate::package_evidence::record::PackageReviewNominalIdentity,
) -> Result<(), &'static str> {
    if identity.path.is_empty()
        || identity.owner == crate::package_evidence::record::PackageReviewNominalOwner::Unresolved
    {
