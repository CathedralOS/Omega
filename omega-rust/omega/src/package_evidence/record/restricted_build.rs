...
//! `crate::build_evaluation::RestrictedBuildRequest` in evidence vocabulary so an
...
/// capability state.
impl From<&crate::build_evaluation::RestrictedBuildRequest>
    for PackagePolicyRestrictedBuildRequest
{
    fn from(request: &crate::build_evaluation::RestrictedBuildRequest) -> Self {
