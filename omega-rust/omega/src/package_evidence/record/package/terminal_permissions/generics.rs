...
pub(super) fn validate(service: &PackagePolicyTerminalService) -> Result<(), &'static str> {
    let scope =
        crate::package_evidence::record::package::callable_policy::validation::signature::Scope {
            outer: None,
            statics: &[],
    ...
    crate::package_evidence::record::public_policy::validation::signatures::parameters(&scope, 0)?;
