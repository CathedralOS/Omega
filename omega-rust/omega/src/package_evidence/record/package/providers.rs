...
pub enum PackageReviewCompilerIntrinsicExecution {
    ...
    PrimitiveFloatBinary {
        operation: crate::provider_planning::CompilerPrimitiveFloatBinaryOperation,
    ...
    PrimitiveIntegerComparison {
        operation: crate::provider_planning::CompilerPrimitiveIntegerComparisonOperation,
        integer_type: crate::provider_planning::CompilerNumericType,
    },
    NamedFloatNegation(numerics::literals::FloatFormat),
    NamedFloatConversion {
        source: crate::provider_planning::CompilerNumericType,
        target: crate::provider_planning::CompilerNumericType,
...
pub struct CheckedPackageProviderReview {
    ...
    pub(crate) rows:
        Vec<abstract_operations_to_target_operations::effects::provider_plan::ProviderPlanRow>,
...
impl CheckedPackageProviderReview {
    ...
    pub fn compiler_intrinsic_methods(
        ...
        Item = &abstract_operations_to_target_operations::effects::provider_plan::ServiceMethod,
    > {
    ...
    pub fn selected_plan_digest(
        &self,
    ) -> abstract_operations_to_target_operations::effects::provider_plan::ProviderPlanDigest {
        abstract_operations_to_target_operations::effects::provider_plan::ProviderPlan {
