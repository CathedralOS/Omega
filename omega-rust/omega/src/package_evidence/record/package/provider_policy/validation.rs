...
use crate::package_evidence::record::PackagePolicyProviderPlan;
...
pub(super) fn same_target(
    profile: crate::package_evidence::record::PackageReviewRepresentationTargetProfile,
    target: target::TargetProfile,
) -> bool {
    use crate::package_evidence::record::PackageReviewRepresentationTargetProfile as Profile;
