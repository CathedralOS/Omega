...
pub(in crate::package_evidence::record) fn contract(
...
pub(in crate::package_evidence::record) fn fact(
...
fn proposition(
    ...
    for (binder, argument) in value.binders.iter().zip(&value.binder_arguments) {
        use crate::package_evidence::record::PackageReviewPropositionBinderArgumentKind as Kind;
        ...
        use crate::package_evidence::record::PackageReviewPropositionBinderValue as Value;
...
pub(in crate::package_evidence::record) fn evidence(
