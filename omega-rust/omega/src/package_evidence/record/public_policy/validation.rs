...
mod data;
mod declarations;
pub(in crate::package_evidence::record) mod signatures;
#[cfg(test)]
mod tests;

use crate::package_evidence::record::package::callable_policy::validation::{
    signature::{self as shared, *},
    signature_contracts as contracts, signature_expressions as expressions,
};
use semantic_vocabulary::PackageKeyIdentity;

pub(in crate::package_evidence::record) fn validate_conformance_shape(
...
pub(in crate::package_evidence::record) fn scope(
