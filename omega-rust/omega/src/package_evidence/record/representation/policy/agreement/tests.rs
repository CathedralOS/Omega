...
use crate::package_evidence::record::PackagePolicyRepresentationAgreementError;
use crate::package_evidence::record::PackagePolicyRepresentationProducerInstance;
...
fn opaque_use(
    ...
    PackagePolicyCallingOpaqueUse {
        ...
        application: PackagePolicyClosedConformanceApplication {
            ...
            trait_identity: nominal(
                PackageReviewNominalOwner::ToolchainSource(
                    crate::package_evidence::record::PackageReviewToolchainSourceIdentity { digest: [7; 32] },
                ),
        ...
        origin: crate::package_evidence::record::PackageReviewOpaqueRepresentationApplicationOrigin::NamedConformance,
        lifecycle: crate::package_evidence::record::PackageReviewOpaqueRepresentationLifecycleDisposition::Inert,
        copy_disposition:
            crate::package_evidence::record::PackageReviewOpaqueRepresentationCopyDisposition::PlacementOnly,
        occurrences: Vec::new(),
    }
}
...
fn policy(
    ...
    let calling = PackagePolicyCallingPlan {
        boundary_trait: nominal(
            PackageReviewNominalOwner::ToolchainSource(
                crate::package_evidence::record::PackageReviewToolchainSourceIdentity {
                    digest: [8; 32],
                },
            ),
            "Calling",
        ...
        target,
        shape_graph: crate::package_evidence::record::PackageReviewBoundaryShapeGraph {
            shapes: Vec::new(),
            fields: Vec::new(),
            parameters: Vec::new(),
            result: None,
        ...
        producer_availability: availability
            .then_some(PackagePolicyRepresentationAvailability {
                ...
                conformance: PackagePolicyConformanceShape {
                    ...
                    subject: crate::package_evidence::record::PackageReviewConformanceSubject::Nominal(
                        carrier.clone(),
                    ),
...
fn rejects_producer_selection_mismatch_at_the_exchange() {
    ...
    application
        .type_arguments
        .push(crate::package_evidence::record::PackageReviewTypeIdentity {
    ...
    disposition.selected_availability.push(
        PackagePolicyRepresentationSelection {
            ...
            lifecycle: use_.lifecycle(),
            copy_disposition:
                crate::package_evidence::record::PackageReviewOpaqueRepresentationCopyDisposition::CheckedSemanticCopy,
        },
    );
    assert!(matches!(
        consumer.rejoin_foreign_demands(|_| Some(producer_instance(
