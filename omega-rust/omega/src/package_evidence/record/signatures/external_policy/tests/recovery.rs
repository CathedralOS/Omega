...
use crate::package_evidence::encoding::{PackagePolicyRecoveryError, PackagePolicyRecoveryLimits};
use crate::package_evidence::record::PackagePolicyCallableConformance;
use crate::package_evidence::record::PackagePolicyExternalBinding;
use crate::package_evidence::record::PackagePolicyExternalCallableSignature;
use crate::package_evidence::record::PackagePolicyExternalExecutableSupply;
use crate::package_evidence::record::PackagePolicyExternalRequirement;
use crate::package_evidence::record::PackagePolicyMachineParameterContract;
use crate::package_evidence::record::PackageReviewDataProperties;
use crate::package_evidence::record::PackageReviewExternalBinding;
use crate::package_evidence::record::PackageReviewNominalOwner;
use crate::package_evidence::record::PackageReviewOperatorCoordinate;
use crate::package_evidence::record::signatures::external_policy::tests::bytes;
use crate::package_evidence::record::signatures::external_policy::tests::import;
use crate::package_evidence::record::signatures::external_policy::tests::locators;
use crate::package_evidence::record::signatures::external_policy::tests::static_parameter;
use crate::package_evidence::record::signatures::external_policy::tests::supply;
use crate::package_evidence::record::signatures::external_policy::tests::syscall;
...
fn assert_round_trip(policy: &PackagePolicyExternalExecutableSupply) {
    crate::package_evidence::encoding::assert_external_policy_text(policy);
    let encoded = policy
        .canonical_bytes()
