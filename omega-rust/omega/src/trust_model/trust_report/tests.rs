...
fn trust_report_rejects_compact_equal_selected_plan_substitution() {
    ...
    let classifications =
        crate::trust_model::AcceptedTemplateClassifications::capture(&checked.typed);
    let candidate = abstract_operations_to_target_operations::effects::provider_plan::ProviderPlan {
        ...
        schema: abstract_operations_to_target_operations::effects::provider_plan::ServiceSchema {
            ...
            methods: vec![abstract_operations_to_target_operations::effects::provider_plan::ServiceMethod {
                name: "run".to_owned(),
        ...
        rows: vec![abstract_operations_to_target_operations::effects::provider_plan::ProviderPlanRow {
            method: "run".to_owned(),
            requirement_identity: "Pair::run".to_owned(),
            requirement_lifetime_partition: Vec::new(),
            binding: abstract_operations_to_target_operations::effects::provider_plan::ProviderBinding::VtableSlot { index: 0 },
        }],
        ..Default::default()
    };
...
fn trust_realization_retains_normalized_locator() {
    ...
    let usage = abstract_operations_to_target_operations::effects::provider_plan::EvaluatedBindingUsage::from_evaluator(
        7, 1, 10, 1_000, 0, 0, 4, 12, 3, 0,
    )
    .expect("valid fixture usage");
    let receipt = abstract_operations_to_target_operations::effects::provider_plan::EvaluatedBindingReceipt::from_evaluation(
        None,
        "fixture::producer".to_owned(),
        abstract_operations_to_target_operations::effects::provider_plan::EvaluatedBindingProducerClosureDigest::from_bytes([11; 32])
            .unwrap(),
        1,
        usage,
        abstract_operations_to_target_operations::effects::provider_plan::EvaluatedBindingEvaluationDigest::from_bytes([12; 32]).unwrap(),
        1,
        abstract_operations_to_target_operations::effects::provider_plan::EvaluatedBindingMaterializationDigest::from_bytes([13; 32])
            .unwrap(),
        locator.identity_digest(),
    )
    .expect("valid fixture receipt");
    let evaluated = abstract_operations_to_target_operations::effects::provider_plan::EvaluatedForeignImport::from_retained_evidence(
        locator.clone(),
        receipt,
    )
    .expect("receipt matches locator");
    let normalized = trust_provider_realization(&abstract_operations_to_target_operations::effects::provider_plan::ProviderBinding::Import {
