...
use abstract_operations_to_target_operations::effects::provider_plan::{
    ProviderPlan, ProviderPlanDigest,
};
...
pub struct AuthoredRootGrant {
    pub selector: String,
    pub selecting_machine: symbols::SymbolHandle,
...
mod tests {
    ...
    fn plan_and_slot_coincidence_rejects_compact_equal_structural_substitution() {
        ...
        plan.schema.methods.push(
            abstract_operations_to_target_operations::effects::provider_plan::ServiceMethod {
