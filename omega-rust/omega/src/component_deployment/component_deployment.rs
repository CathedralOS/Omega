...
use crate::component_publication::bind_installed_artifact;
use crate::component_publication::{InstalledRunnableComponent, bind_installed_runnable_component};
...
fn preflight_component_deployment(
    ...
    let memory = crate::component_publication::project_installed_artifact_memory_images(
        candidate.object(),
        candidate.image(),
    )
...
impl ProgressClosedComponentDeployment {
    ...
    pub fn finalize(
        ...
        let selected_provider_plan_identities = candidate
            ...
            .plans()
            .iter()
            .map(abstract_operations_to_target_operations::effects::provider_plan::ProviderPlan::report_fingerprint)
            .collect::<Vec<_>>();
