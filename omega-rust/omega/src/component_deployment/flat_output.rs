...
use crate::component_publication::InstalledRunnableComponent;
...
pub struct ComponentFlatOutputReceipt {
    output_path: PathBuf,
    installation_fingerprint:
        resolved_layout_to_resolved_layout::image_emission::InstallationFingerprint,
    image_fingerprint: resolved_layout_to_resolved_layout::image_emission::ImageFingerprint,
    byte_count: usize,
}
...
impl ComponentFlatOutputReceipt {
    ...
    pub const fn image_fingerprint(
        &self,
    ) -> resolved_layout_to_resolved_layout::image_emission::ImageFingerprint {
