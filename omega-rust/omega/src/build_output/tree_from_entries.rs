...
use crate::build_output::materialization::retained_native_path;
use crate::build_output::materialization::validate_retained_tree;
use crate::build_output::portable_paths::canonical_symlink_target;
use crate::build_output::portable_paths::reserve_path_bytes;
use crate::build_output::staged_output_tree::MAX_STAGED_OUTPUT_ENTRIES;
use crate::build_output::staged_output_tree::MAX_STAGED_OUTPUT_UNIQUE_FILE_BYTES;
use crate::build_output::staged_output_tree::RetainedStagedOutputEntry;
use crate::build_output::staged_output_tree::RetainedStagedOutputEntryKind;
use crate::build_output::staged_output_tree::commitment_for_retained_entries;
use crate::build_output::staged_output_tree::diagnostics;
...
mod tests {
    ...
    fn charges_symbolic_link_targets_to_the_shared_path_byte_ceiling() {
        let target =
            vec![b'a'; crate::build_output::staged_output_tree::MAX_STAGED_OUTPUT_PATH_BYTES];
