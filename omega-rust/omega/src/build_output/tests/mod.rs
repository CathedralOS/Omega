...
use crate::build_output::portable_paths::validate_portable_component;
use crate::build_output::staged_output_tree::RetainedStagedOutputEntryKind;
use crate::build_output::{capture, empty, select_included_sources};
use crate::checked_interpreter::FilesystemSponsor;
use sha2::Digest;
use sha2::Sha256;
use std::path::Path;
...
impl Fixture {
    ...
    fn bind(&self, relative: &Path) -> crate::checked_interpreter::FilesystemSponsorPath {
