...
use crate::external_roots::platform_bringup::uefi_bootstrap::PlannedUefiExitBootServicesInvocation;
use crate::external_roots::platform_bringup::uefi_bootstrap::get_memory_map::invocation_planning::UefiGetMemoryMapFunction;
use crate::external_roots::platform_bringup::uefi_bootstrap::get_memory_map::{
...
use resolved_layout_to_resolved_layout::program_entry_plan::UefiOsHandoffStatusRole;
use std::ffi::c_void;
...
impl UefiMemoryMapAcquisition {
    ...
    pub(in crate::external_roots::platform_bringup::uefi_bootstrap) fn for_test(
        session: UefiFirmwareSessionId,
        invocation: UefiPhysicalInvocationId,
        snapshot: UefiMemoryMapSnapshotId,
        map_key: UefiMemoryMapKeyId,
