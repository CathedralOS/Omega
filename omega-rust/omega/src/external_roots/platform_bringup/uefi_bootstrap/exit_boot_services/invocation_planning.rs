...
use crate::external_roots::platform_bringup::uefi_bootstrap::UefiOsHandoffMapAcquired;
use crate::external_roots::platform_bringup::uefi_bootstrap::exit_boot_services::LifecycleScopedUefiExitBootServicesProvider;
...
use resolved_layout_to_resolved_layout::program_entry_plan::{
    UefiOsHandoffLegPlan, plan_uefi_os_handoff_invocation,
};
use std::ffi::c_void;
