...
use abstract_operations_to_target_operations::calling_conventions::{CallSignature, CallingPolicy};
...
fn physical_contract(
    ...
    mutate_plan: impl FnOnce(
        &mut abstract_operations_to_target_operations::calling_conventions::BoundaryEntryPlan,
    ),
...
fn authenticated_adapter_budget(
    ...
    plan_uefi_application_bootstrap_same_stack_budget_with_generated_adapter(
        readiness,
        4 * 1024,
        crate::external_roots::tests::generated_program_storage_adapter_live_frame_demand(),
        96 * 1024,
        16 * 1024,
    )
