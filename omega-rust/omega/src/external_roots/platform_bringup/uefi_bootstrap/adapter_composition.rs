...
use crate::external_roots::platform_bringup::uefi_bootstrap::{
...
use crate::external_roots::{
    ExternalRootDiagnostic, UefiApplicationBootstrapLedgerId, UefiPhysicalInvocationId,
};
use abstract_operations_to_target_operations::calling_conventions::{
    CallSignature, CallingPolicy, validate_boundary_entry_plan,
};
