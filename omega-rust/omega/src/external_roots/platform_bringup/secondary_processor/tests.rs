...
fn installed_trampoline(
    ...
    crate::external_roots::tests::installed_code_in_placement(
        0x600,
        startup_entry(),
        bytes,
        0x601,
...
fn processor_account(
    ...
    SecondaryProcessorAccount::new(
        ...
        crate::external_roots::tests::secondary_processor_boundary(
...
fn admission_rejects_boundary_beginning_outside_the_installed_regime() {
    ...
    account.boundary = crate::external_roots::tests::secondary_processor_boundary(
...
fn admission_rejects_entry_not_arriving_on_the_accounted_dedicated_stack() {
    ...
    for stack in [
        ...
        let account = SecondaryProcessorAccount::new(
            ...
            WCSU_BYTES,
            WCSU_ALIGNMENT,
            crate::external_roots::tests::minted_secondary_processor_state(2100, 0x2_0000, 0x1000),
        )
        .expect("secondary-processor account");
        let error = ledger
            .admit_secondary_processor(account)
...
fn account_rejects_state_geometry_that_cannot_host_the_stack() {
    ...
    assert!(
        SecondaryProcessorAccount::new(
            ...
            0,
            WCSU_ALIGNMENT,
            crate::external_roots::tests::minted_secondary_processor_state(2200, 0x2_0000, 0x1000),
        )
        .is_err(),
    ...
    assert!(
        SecondaryProcessorAccount::new(
            ...
            WCSU_BYTES,
            0x180,
            crate::external_roots::tests::minted_secondary_processor_state(2201, 0x2_0000, 0x1000),
        )
        .is_err(),
    ...
    assert!(
        SecondaryProcessorAccount::new(
            ...
            WCSU_BYTES,
            WCSU_ALIGNMENT,
            crate::external_roots::tests::minted_secondary_processor_state(2202, 0x2_0000, 0x400),
        )
        .is_err(),
    ...
    assert!(
        SecondaryProcessorAccount::new(
            ...
            WCSU_BYTES,
            WCSU_ALIGNMENT,
            crate::external_roots::tests::minted_secondary_processor_state(2203, 0x2_0080, 0x1000),
        )
        .is_err(),
...
fn completion_rejects_drifted_foreign_or_replayed_receipts() {
    ...
    let foreign_code = crate::external_roots::tests::installed_code_in_placement(
        0x610,
        startup_entry(),
        vec![0xCC; 96],
        0x611,
