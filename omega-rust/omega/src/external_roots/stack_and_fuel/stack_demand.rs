...
use abstract_operations_to_target_operations::calling_conventions::{
    EntryStack, ValidatedBoundaryEntryPlan, ValidatedX86_64DeriverStub,
};
...
use crate::external_roots::root_entry::root_admission::bind_terminal_function;
...
mod deriver_stub_tests {
    ...
    use crate::external_roots::tests::{installed_code_in_placement, root_id};
    use crate::external_roots::{
    ...
    fn dedicated_interrupt_boundary(class: u16) -> ValidatedBoundaryEntryPlan {
        ...
        call.ordinary_clobbers = RegisterSet::new([
            abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rax,
            abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rcx,
            abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rdx,
        ]);
    ...
    fn installed_stub_image() -> (InstalledCode, Vec<u8>) {
        ...
        let constraints = terminal_psi::layout_plans::PlacementConstraints::new(
            Some(
                terminal_psi::layout_plans::PlacementAddressRange::new(0x1000, 0x1_0000)
                    .expect("placement range"),
            ),
            4096,
            terminal_psi::layout_plans::PlacementPhase::PostHandoff,
            None,
            Some(
                terminal_psi::layout_plans::ArtifactInstallationScopeId::from_normalized_identity(
                    61,
                )
    ...
    fn arrival_and_contract(
        ...
        crate::external_roots::InstalledX86_64TargetDerivedHardwareArrival,
    ...
    fn deriver_stub_entry_stack_binds_and_composes_dedicated_demand() {
        ...
        assert_eq!(
            ...
            crate::external_roots::AdapterStackRealizationOrigin::None
        );
