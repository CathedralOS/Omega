...
pub struct InstalledEntryFuelCertificate {
    certificate: crate::terminal_fixed_fuel::FixedEntryFuelCertificate,
...
impl InstalledEntryFuelCertificate {
    pub const fn certificate(&self) -> &crate::terminal_fixed_fuel::FixedEntryFuelCertificate {
        &self.certificate
    }
...
pub struct InstalledSegmentFuelCertificate {
    certificate: crate::terminal_fixed_fuel::FixedSegmentFuelCertificate,
    installed_code: InstalledCodeId,
    installed_code_context: InstalledCodeContext,
    artifact: ArtifactId,
    entry: EntryStubId,
...
pub struct InstalledSegmentFuelCatalog {
    segments: crate::terminal_fixed_fuel::ValidatedFixedSafePointFuelSegments,
    installed_code: InstalledCodeId,
    installed_code_context: InstalledCodeContext,
    artifact: ArtifactId,
    entry: EntryStubId,
...
impl InstalledSegmentFuelCatalog {
    pub const fn psi(&self) -> terminal_codec::TerminalPsiIdentity {
    ...
    pub fn segments(&self) -> &[crate::terminal_fixed_fuel::FixedSegmentFuelCertificate] {
...
impl InstalledSegmentFuelCertificate {
    pub const fn certificate(&self) -> &crate::terminal_fixed_fuel::FixedSegmentFuelCertificate {
        &self.certificate
    }
