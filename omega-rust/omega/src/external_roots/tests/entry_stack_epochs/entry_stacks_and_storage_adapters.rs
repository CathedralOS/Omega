use crate::external_roots::tests::{
...
use abstract_operations_to_target_operations::calling_conventions::{
    EntryStackStage, StackDomainRef,
};
...
fn generated_program_storage_adapter_replays_emitted_operations_and_composes_three_epochs() {
    ...
    for epoch in epochs {
        ...
        assert_eq!(
            ...
            [
                abstract_operations_to_target_operations::calling_conventions::StackOccupancy {
...
fn generated_program_storage_adapter_rejects_mutation_and_installed_subject_substitution() {
    ...
    let incompatible_boundary = crate::external_roots::tests::boundary();
    let error = bind_x86_64_generated_program_storage_adapter_stack_realization(
        &summary,
