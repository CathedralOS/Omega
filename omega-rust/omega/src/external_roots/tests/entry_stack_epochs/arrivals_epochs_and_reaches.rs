...
fn x86_target_arrival_binds_exact_installation_and_composes_mixed_contexts() {
    ...
    assert!(matches!(
        ...
        abstract_operations_to_target_operations::calling_conventions::X86_64HardwareStackSelection::PrivilegeTransition {
            dedicated_class: 7
        }
    ));
    ...
    assert!(matches!(
        ...
        abstract_operations_to_target_operations::calling_conventions::X86_64HardwareStackSelection::Current
    ));
    ...
    changed_ist
        .tss
        .interrupt_stacks
        .push(abstract_operations_to_target_operations::calling_conventions::X86_64InstalledInterruptStack {
            slot: 3,
            dedicated_class: 7,
        });
    ...
    let ist_realization = X86_64InstalledGateTssRealization {
        ...
        tss: X86_64InstalledTaskStateSegmentRealization {
            ...
            interrupt_stacks: vec![abstract_operations_to_target_operations::calling_conventions::X86_64InstalledInterruptStack {
                slot: 3,
                dedicated_class: 9,
            }],
        },
    ...
    assert!(
        ist_facts
            ...
            .all(|context| matches!(
                ...
                abstract_operations_to_target_operations::calling_conventions::X86_64HardwareStackSelection::InterruptStackTable {
                    slot: 3,
                    dedicated_class: 9
                }
            ))
