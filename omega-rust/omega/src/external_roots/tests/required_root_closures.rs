...
fn installed_root_teardown_preflight_rejects_incomplete_ambiguous_and_stale_state() {
...

    {
        ...
        ledger.active_interrupts.insert(
            ...
            crate::external_roots::interrupts::interrupt_entries::ActiveInterruptEntry {
                arrival_context: abstract_operations_to_target_operations::calling_conventions::ArrivalContextId::new(1)
                    .expect("arrival context"),
                stage: abstract_operations_to_target_operations::calling_conventions::EntryStackStage::Body,
                depth: 1,
                interrupted: None,
                fatal: false,
            },
