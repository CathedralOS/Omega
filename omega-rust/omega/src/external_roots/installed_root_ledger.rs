...
use crate::external_roots::AdmittedProgressProfileEstablishment;
use crate::external_roots::ComponentVersionPin;
use crate::external_roots::ExternalRootEntryClaim;
use crate::external_roots::ExternalRootResultClaim;
use crate::external_roots::InstalledProviderOccurrenceClosure;
use crate::external_roots::InstalledRequiredRootSlotClosure;
use crate::external_roots::LogicalFuelResourceColumn;
use crate::external_roots::MachineStateResourceColumn;
use crate::external_roots::OpaqueProviderExitAssurance;
use crate::external_roots::ProviderExecution;
use crate::external_roots::StackResourceColumn;
use crate::external_roots::ValidatedExternalRoot;
use crate::external_roots::identities::Fnv1a;
use crate::external_roots::interrupts::interrupt_entries::ActiveInterruptEntry;
...
pub struct InstalledRootRecord {
    ...
    pub installation_reach_resolutions:
...
pub struct InstalledRootLedger {
    ...
    >,
    pub(crate) accepted_component_progress:
        Vec<abstract_operations_to_target_operations::effects::ComponentProgressManifest>,
