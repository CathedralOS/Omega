...
fn native_package_evidence_digest(
    ...
    application_identifier: &crate::build_evaluation::ApplicationIdentifier,
...
pub struct NativePackagePublicationReceipt {
    ...
    pub(crate) application_identifier: crate::build_evaluation::ApplicationIdentifier,
...
impl NativePackagePublicationReceipt {
    ...
    pub const fn application_identifier(&self) -> &crate::build_evaluation::ApplicationIdentifier {
...
pub(crate) fn publish_macos_application_package(
    ...
    let encoded_identifier =
        resolved_layout_to_resolved_layout::image_macho::code_signature_identifier(
            executable_bytes,
        )
        .ok_or_else(|| {
    ...
    if let Err(error) = crate::compiler::report::executable_publication::make_executable(
        &app_root.join(&executable_leaf),
    ) {
