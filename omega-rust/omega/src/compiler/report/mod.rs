...
pub use terminal_product::{
    ...
    TerminalIntegerComparisonOccurrenceProposal, TerminalNativeRealizationInputs,
...
pub use resolved_layout_to_resolved_layout::native_artifact::NativeArtifact as RetainedNativeArtifact;
