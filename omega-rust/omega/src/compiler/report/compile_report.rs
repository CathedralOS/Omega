...
use crate::artifacts::compile_timings::PhaseTiming;
use crate::compiler::report::executable_publication::{
...
use crate::compiler::report::package;
use crate::compiler::report::pcc::build_native_proof_sidecar;
use crate::compiler::report::{
...
pub struct CompileReport {
    ...
    build_outputs: Option<crate::compiler::report::RetainedBuildOutputs>,
    ...
    build_observation: Option<crate::build_evaluation::BuildObservationIdentity>,
    root_path: PathBuf,
    ...
    trust_admission_settlement: crate::trust_model::TrustAdmissionSettlement,
    ...
    pcc_requests: crate::build_evaluation::PccRequests,
...
impl CompileReport {
    ...
    pub fn with_build_outputs(
        mut self,
        outputs: Option<crate::compiler::report::RetainedBuildOutputs>,
        expected_observation: Option<crate::build_evaluation::BuildObservationIdentity>,
    ) -> Result<Self, &'static str> {
    ...
    pub fn build_outputs(&self) -> Option<&crate::compiler::report::RetainedBuildOutputs> {
        self.build_outputs.as_ref()
    }

    pub const fn build_observation_identity(
        &self,
    ) -> Option<crate::build_evaluation::BuildObservationIdentity> {
    ...
    pub fn take_build_outputs(&mut self) -> Option<crate::compiler::report::RetainedBuildOutputs> {
        if matches!(
            self.output_kind,
    ...
    pub fn checked(
        ...
        let report = Self {
            ...
            pcc_requests: crate::build_evaluation::PccRequests::default(),
    ...
    pub fn require_package_native_physical_evidence(
        ...
        &resolved_layout_to_resolved_layout::native_artifact::NativePhysicalEvidence,
        FinalRealizationEvidenceError,
    > {
        if !self.has_consistent_executable_publication_custody() {
    ...
    pub fn with_trust_admission_settlement(
        mut self,
        settlement: crate::trust_model::TrustAdmissionSettlement,
    ) -> Self {
    ...
    pub const fn pcc_requests(&self) -> crate::build_evaluation::PccRequests {
        self.pcc_requests
    }
    ...
    pub const fn trust_admission_settlement(
        &self,
    ) -> &crate::trust_model::TrustAdmissionSettlement {
    ...
    pub fn terminal_callback_placements(
        &self,
    ) -> Option<&[crate::backend_plan::BoundNominalCallbackPlacement]> {
        self.artifact
            .as_ref()
