...
pub(crate) fn native_publication_certificate_digest(
    ...
    final_image_symbol_digest: resolved_layout_to_resolved_layout::image::FinalImageSymbolDigest,
    boundary_contract_report_fingerprint: Option<u64>,
    text_validation_digest: resolved_layout_to_resolved_layout::image::CompilerTextDerivationDigest,
    function_validation_digest: resolved_layout_to_resolved_layout::image::CompilerFunctionValidationDigest,
    function_validation_report_fingerprint: u64,
    inventory_digest: resolved_layout_to_resolved_layout::image::PlacedExecutableRegionInventoryDigest,
...
pub(crate) fn validate_native_pair(
    ...
    let policy =
        terminal_codec::PccReceiverPolicy::for_offered_claim(sidecar, admission_profile.clone());
    match crate::compiler::report::pcc::verify_native_proof_sidecar(
        executable_bytes,
        &sidecar.to_bytes(),
        &policy,
    ) {
...
pub struct ExecutablePublicationReceipt {
    ...
    pub(crate) inventory_digest:
        resolved_layout_to_resolved_layout::image::PlacedExecutableRegionInventoryDigest,
    /// Compact report compatibility only. Publication and replay authority is
    /// `inventory_digest`.
    pub(crate) inventory_report_fingerprint: u64,
    pub(crate) compiler_text_validation_digest:
        resolved_layout_to_resolved_layout::image::CompilerTextDerivationDigest,
    pub(crate) compiler_function_validation_digest:
        resolved_layout_to_resolved_layout::image::CompilerFunctionValidationDigest,
...
impl ExecutablePublicationReceipt {
    pub fn new(
        ...
        inventory_digest: resolved_layout_to_resolved_layout::image::PlacedExecutableRegionInventoryDigest,
        inventory_report_fingerprint: u64,
        compiler_text_validation_digest: resolved_layout_to_resolved_layout::image::CompilerTextDerivationDigest,
        compiler_function_validation_digest: resolved_layout_to_resolved_layout::image::CompilerFunctionValidationDigest,
