...
pub(super) fn validate_integer_comparison_coverage(
    ...
    realizations: &resolved_layout_to_resolved_layout::boundary_applications::TerminalBoundaryApplicationRealizations,
...
pub(super) fn validate_integer_comparison_occurrences(
    ...
    for occurrence in occurrences {
        ...
        let (left, right) = match (occurrence.comparison, &operation.kind) {
            ...
            | (
                checked_trees_to_lowered_psi::lowered_psi::LoweredSelectedIntegerComparisonOperation::LessOrEqual,
