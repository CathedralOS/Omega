...
pub struct PreparedNativeCompilation {
    ...
    pub(super) rollback: crate::compiler::checked::OptimizationRollbackSettlement,
    pub(super) terminal: ProgramEntryTerminalArtifact,
    pub(super) production_subject: Option<crate::compiler::report::ProductionCompilationSubject>,
...
impl PreparedNativeCompilation {
    pub(super) fn new(
        ...
        rollback: crate::compiler::checked::OptimizationRollbackSettlement,
        terminal: ProgramEntryTerminalArtifact,
        production_subject: Option<crate::compiler::report::ProductionCompilationSubject>,
...
impl PreparedNativeCompilation {
    pub(super) fn prepare_reusable_input(
        &self,
    ) -> Result<crate::compiler::native::PreparedNativeRealizationInput, Vec<Diagnostic>> {
        let post_terminal = self.rollback.effective().project_post_terminal();
        crate::compiler::native::prepare_native_realization_input(
