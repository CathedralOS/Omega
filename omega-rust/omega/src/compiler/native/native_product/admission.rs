...
pub(super) struct NativeCompilationAdmission {
    pub(super) program_entry: crate::build_evaluation::SelectedCompilerProgramEntry,
...
pub(super) fn admit(
    ...
    crate::provider_planning::component_progress::reject_undischarged_build_bound_progress(
