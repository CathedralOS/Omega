...
use crate::provider_planning::calling_policy_plans::BoundaryCallingPlanRealization;
...
pub struct NativeProgramEntrySettlement<'entry> {
    ...
    pub(crate) source: &'entry resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramEntrySourceSignature,
    ...
    pub(crate) storage_entry: Option<&'entry resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramStorageEntryPlan>,
    pub(crate) fused_service_establishments:
        &'entry [resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntryFusedServiceEstablishment],
}

impl<'entry> NativeProgramEntrySettlement<'entry> {
    pub const fn new(
        source: &'entry resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramEntrySourceSignature,
        calling_plans: Option<(
            &'entry BoundaryCallingPlanRealization,
            &'entry BoundaryCallingPlanRealization,
            &'entry resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramStorageEntryPlan,
        )>,
        fused_service_establishments: &'entry [
            resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntryFusedServiceEstablishment
        ],
    ) -> Self {
    ...
    pub const fn source(self) -> &'entry resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramEntrySourceSignature{
        self.source
    }
    ...
    pub const fn semantic_boundary_entry_plan(
        ...
        &'entry abstract_operations_to_target_operations::calling_conventions::BoundaryEntryPlan,
    > {
    ...
    pub const fn storage_entry(
        self,
    ) -> Option<&'entry resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramStorageEntryPlan>{
        self.storage_entry
    }
...
pub struct ValidatedNativeProgramEntrySettlement {
    ...
    pub(crate) source: resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramEntrySourceSignature,
    ...
    pub(crate) storage_entry: Option<resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramStorageEntryPlan>,
    pub(crate) fused_service_establishments:
        Vec<resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntryFusedServiceEstablishment>,
...
impl ValidatedNativeProgramEntrySettlement {
    ...
    pub const fn source(
        &self,
    ) -> &resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramEntrySourceSignature
    {
        &self.source
    }
    ...
    pub const fn semantic_boundary_entry_plan(
        &self,
    ) -> Option<&abstract_operations_to_target_operations::calling_conventions::BoundaryEntryPlan>
    {
    ...
    pub const fn storage_entry(
        ...
        &resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramStorageEntryPlan,
    > {
