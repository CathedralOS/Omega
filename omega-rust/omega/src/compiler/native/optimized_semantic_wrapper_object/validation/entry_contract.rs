...
> {
    ...
    if shape.class != abstract_operations_to_target_operations::calling_conventions::ValueClass::BorrowedReference
...
fn validate_receiver_fields(
    ...
    rows: &[resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntryFusedServiceEstablishment],
