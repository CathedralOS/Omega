...
//! `resolved_layout_to_resolved_layout::native_artifact::semantic_wrapper_object`; this stage binds them to the
...
use resolved_layout_to_resolved_layout::object_file::{
    StagedValidatedOptimizedObjectArtifact, validate_optimized_object_artifact,
};
