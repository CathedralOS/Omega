...
fn realize_image(
    ...
    crate::compiler::native::entry_settlement::validate_fused_program_entry_establishments(
        &artifact,
...
fn validate_executable_entry_receiver(
    plan: &terminal_psi_to_abstract_operations::abstract_operations::AbstractOperationPlan,
    ...
    artifact: &terminal_codec::CanonicalTerminalArtifact,
    request: &NativeRealizationRequest<'_>,
) -> Result<Option<crate::compiler::native::ValidatedNativeProgramEntrySettlement>, Vec<Diagnostic>>
{
    ...
    let settled = crate::compiler::native::validate_native_program_entry_settlement(
        artifact,
        checked_entry,
        request.program_entry,
        request.target,
...
fn validate_emitted_receiver_binding(
    ...
    admitted: Option<&crate::compiler::native::ValidatedNativeProgramEntrySettlement>,
