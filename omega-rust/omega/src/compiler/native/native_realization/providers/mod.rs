...
use resolved_layout_to_resolved_layout::native_artifact::NativeProviderExecution;
...
pub(crate) struct AdmittedNativeProviders<'execution> {
    ...
    pub(crate) terminal_authority_policy_identity: abstract_operations_to_target_operations::effects::TerminalAuthorityPolicyIdentity,
    ...
    pub(crate) terminal_authority_permission_policy_identity:
        Option<abstract_operations_to_target_operations::effects::TerminalAuthorityPermissionPolicyIdentity>,
    pub(crate) terminal_authority_closure_review: abstract_operations_to_target_operations::effects::TerminalAuthorityClosureReviewReceipt,
...
pub(crate) struct AdmittedTerminalMechanism {
    ...
    pub(crate) mechanism:
        abstract_operations_to_target_operations::effects::TerminalMechanismIdentity,
}
...
pub(crate) fn admit_native_providers<'request>(
    ...
    let effective_policy = if cohort_rows.is_empty() {
        ...
        Some(
            crate::compiler::native::native_realization::terminal_authority_policy::terminal_authority_policy_with_rows(
                rows,
            )
            .map_err(|error| {
    ...
    let terminal_authority_closure_review =
        crate::compiler::native::native_realization::terminal_authority_review::review_terminal_authority_closure(
        ...
        .map_err(|error| {
            crate::compiler::native::native_realization::realization_diagnostics::realization_error(
