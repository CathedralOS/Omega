...
use crate::compiler::native::native_realization::terminal_authority_policy::TerminalAuthorityPolicyRow;
...
struct ImportCoverageRows<'input> {
    ...
    external: Option<
        &'input abstract_operations_to_target_operations::calling_conventions::ExternalBindingRow,
    >,
...
pub(super) fn validate_source_evaluated_import_coverage(
    ...
    selected_plans: &abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts,
    policy: &crate::compiler::native::native_realization::TerminalAuthorityPolicy,
    ...
    for (requirement, rows) in demanded {
        ...
        match &row.binding {
            ProviderBinding::Syscall { number } => {
                ...
                let abstract_operations_to_target_operations::calling_conventions::ExternalBindingKind::Syscall {
                ...
                let mechanism = crate::compiler::native::native_realization::terminal_authority_policy::conservative_syscall_terminal_mechanism(
                    target_profile,
                    number,
                    plan,
                    rows.boundary,
            ...
            ProviderBinding::Import { evaluated } => {
                ...
                let mechanism = match (rows.callback_count, rows.callback) {
                    (0, _) => crate::compiler::native::native_realization::normalized_foreign_terminal_mechanism(
                        evaluated.locator(),
                        boundary_entry_plan,
                    ),
                    (1, Some(callback))
                    ...
                    {
                        crate::compiler::native::native_realization::normalized_foreign_terminal_mechanism_with_callback_materializations(
                            evaluated.locator(),
                            boundary_entry_plan,
...
fn settled_host_cohort_row(
    ...
    row: &ProviderPlanRow,
    mechanism: abstract_operations_to_target_operations::effects::TerminalMechanismIdentity,
    ...
    crate::compiler::native::native_realization::terminal_authority_policy::filesystem_mechanism_row(
        mechanism, method,
    )
    .ok()
    .or_else(|| {
        crate::compiler::native::native_realization::terminal_authority_policy::time_host_mechanism_row(
            mechanism, method,
        )
        .ok()
    })
    .or_else(|| {
        crate::compiler::native::native_realization::terminal_authority_policy::console_mechanism_row(
            mechanism, method,
        )
        .ok()
    })
...
fn classify_terminal_mechanism(
    ...
    crate::compiler::native::native_realization::terminal_authority_policy::UnclassifiedTerminalMechanism,
>{
...
fn join_import_coverage_rows<'input>(
    plan: &'input terminal_psi_to_abstract_operations::abstract_operations::AbstractOperationPlan,
    selected_plans: &'input abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts,
    external_binding_rows: &'input [abstract_operations_to_target_operations::calling_conventions::ExternalBindingRow],
