...
> {
    ...
    let realization = match settlement.realization {
        NativeBoundaryRealization::NormalizedForeignCall(same_stack) => {
            abstract_operations_to_target_operations::target_operations::BoundarySettlementRealization::NormalizedForeignCall(
        ...
        NativeBoundaryRealization::Builtin(realization) => {
            abstract_operations_to_target_operations::target_operations::BoundarySettlementRealization::Builtin(realization)
        }
    };
