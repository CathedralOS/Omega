...
fn run_abstract_optimization_stage(
    ...
    Vec<Diagnostic>,
> {
    let optimization_request = crate::compiler::native::compiler_baseline_request_v1(
        request.optimization_selections.selections(),
    );
    crate::compiler::native::optimize_verified_abstract_input(input, optimization_request)
