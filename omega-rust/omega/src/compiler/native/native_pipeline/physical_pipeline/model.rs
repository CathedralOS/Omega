use resolved_layout_to_resolved_layout::machine_emission::StagedOptimizedFunctionFragmentEmissionSource;
...
impl StagedOptimizedVerifiedPhysicalPipeline {
    ...
    pub fn function_relative_manifest(
        &self,
    ) -> &resolved_layout_to_resolved_layout::machine_emission::ValidatedFunctionRelativeOptimizationRealizationManifest{
...
impl From<resolved_layout_to_resolved_layout::machine_emission::StagedFixedFrameFunctionRelativeRealization>
    for StagedOptimizedVerifiedPhysicalPipeline
{
    fn from(realization: resolved_layout_to_resolved_layout::machine_emission::StagedFixedFrameFunctionRelativeRealization) -> Self {
        Self {
