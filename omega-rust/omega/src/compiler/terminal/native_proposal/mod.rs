...
use crate::compiler::terminal::application_coverage::project_terminal_boundary_application_coverage;
use crate::compiler::terminal::terminal_artifact::verification::verify_terminal_artifact;
use crate::compiler::terminal::{float_comparisons, integer_comparisons};
...
pub(crate) fn project_terminal_native_realization_proposal(
    ...
    callback_placements: &[crate::backend_plan::BoundNominalCallbackPlacement],
    source_call_occurrences: &[checked_trees_to_lowered_psi::lowered_psi::LoweredSourceCallOccurrence],
    selected_ieee_float_comparison_occurrences: &[checked_trees_to_lowered_psi::lowered_psi::LoweredSelectedIeeeFloatComparisonOccurrence],
    selected_integer_comparison_occurrences: &[checked_trees_to_lowered_psi::lowered_psi::LoweredSelectedIntegerComparisonOccurrence],
    selections: &optimization_core::OptimizationSelections,
) -> Result<crate::compiler::report::TerminalNativeRealizationProposal, Vec<Diagnostic>> {
    ...
    let builtin_proposals =
        ...
        .into_iter()
        .map(|proposal| {
            crate::compiler::report::TerminalCompilerBuiltinProposal::new(
    ...
    let callback_occurrences = callback_placements
        ...
        .map(|(placement_index, placement)| {
            ...
            let callback_thunk_identity =
                crate::backend_plan::canonical_callback_thunk_identity(placement_index, placement)
                    .ok_or_else(|| {
                        vec![Diagnostic::error(format!(
            ...
            Ok(crate::compiler::report::TerminalCallbackOccurrenceProposal::new(
                placement_index,
    ...
    let package_terminal_authority_permissions = checked
        ...
        .cloned()
        .collect();
    crate::compiler::report::TerminalNativeRealizationProposal::new(
        artifact,
        crate::compiler::report::TerminalNativeRealizationInputs {
            target_profile,
            native_target,
            ...
            boundary_application_realizations,
            checked_boundary_operator_scope,
            behavior_exclusions: crate::build_evaluation::authored_behavior_exclusion_set_in(
                checked.behavior_exclusions(),
                &terminal_module,
                &crate::compiler::terminal::terminal_artifact::behavior_exclusions::boundary_trait_identity(
                    checked,
                ),
            ),
        },
...
fn callback_closed_external_binding_rows(
    ...
    callback_placements: &[crate::backend_plan::BoundNominalCallbackPlacement],
    callback_occurrences: &[crate::compiler::report::TerminalCallbackOccurrenceProposal],
) -> Result<
...
fn produce_callback_thunk_artifact(
    checked: &CheckedCompilation,
    profile: &proof_admission::AdmissionProfile,
    placement: &crate::backend_plan::BoundNominalCallbackPlacement,
) -> Result<crate::compiler::report::TerminalCallbackThunkArtifact, Vec<Diagnostic>> {
    ...
    let produced = lowered_psi_to_terminal_psi::terminal_production::TerminalProductionRequest {
    ...
    // entry's.
    crate::compiler::terminal::terminal_artifact::behavior_exclusions::verify_entry_behavior_exclusions(
        checked,
    ...
    crate::compiler::report::TerminalCallbackThunkArtifact::new(
