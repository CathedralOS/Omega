...
pub(crate) fn verify_entry_behavior_exclusions(
    checked: &CheckedCompilation,
    unoptimized: Option<&checked_trees_to_lowered_psi::lowered_psi::LoweredPsi>,
    entry_machine_symbol: symbols::SymbolHandle,
...
pub(crate) fn boundary_service_owners(
    checked: &CheckedCompilation,
    module: &terminal_psi::TerminalModule,
) -> crate::build_evaluation::BoundaryServiceOwners {
    ...
    crate::build_evaluation::BoundaryServiceOwners::from_module(module, &|boundary_identity| {
...
fn describe_exclusion(
    module: &terminal_psi::TerminalModule,
    exclusion: crate::build_evaluation::BehaviorExclusion,
) -> String {
    match exclusion {
        crate::build_evaluation::BehaviorExclusion::CrashCause(cause) => {
            format!("crash cause {cause:?}")
        }
        crate::build_evaluation::BehaviorExclusion::Service(service) => {
            match module
                .services
                .iter()
        ...
        crate::build_evaluation::BehaviorExclusion::PhysicalAuthorityClass(class) => {
