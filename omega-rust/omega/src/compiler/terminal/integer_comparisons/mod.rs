...
pub(crate) fn associate(
    ...
    occurrences: &[checked_trees_to_lowered_psi::lowered_psi::LoweredSelectedIntegerComparisonOccurrence],
) -> Result<
    Vec<crate::compiler::report::TerminalIntegerComparisonOccurrenceProposal>,
    Vec<Diagnostic>,
> {
    ...
    crate::compiler::report::TerminalIntegerComparisonOccurrenceProposal::validate_roster(
        module,
        selected.plans(),
        &proposals,
    )
...
fn associate_one(
    ...
    selected: &abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts,
    provenance: &[crate::provider_planning::SelectedProviderReviewProvenance],
    occurrence: &checked_trees_to_lowered_psi::lowered_psi::LoweredSelectedIntegerComparisonOccurrence,
) -> Result<crate::compiler::report::TerminalIntegerComparisonOccurrenceProposal, Diagnostic> {
    let fail = |reason: &str| {
    ...
    if !occurrence.operator_use.is_valid()
        ...
        || selected_meaning.and_then(|(operation, primitive)| {
            checked_trees_to_lowered_psi::lowered_psi::LoweredSelectedIntegerComparisonOperation::admitted_emission(operation)
    ...
    let proposal = crate::compiler::report::TerminalIntegerComparisonOccurrenceProposal {
