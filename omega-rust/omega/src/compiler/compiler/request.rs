...
use crate::compiler::{CompileOptions, OptimizationRollback};
...
pub struct TargetCompileConfiguration {
    ...
    pub(super) build_snapshot: Option<crate::build_evaluation::BuildSnapshotRequest>,
    ...
    accepted_trust_admissions: Vec<crate::trust_model::TrustAdmission>,
...
impl TargetCompileConfiguration {
    ...
    fn from_options(target_name: Option<String>, build_dir: Option<PathBuf>) -> Self {
        Self {
            ...
            terminal_authority_policy: crate::compiler::native::current_terminal_authority_policy(),
    ...
    pub fn with_terminal_authority_policy(
        mut self,
        policy: crate::compiler::native::TerminalAuthorityPolicy,
    ) -> Self {
    ...
    pub fn with_accepted_trust_admissions(
        mut self,
        admissions: Vec<crate::trust_model::TrustAdmission>,
    ) -> Self {
...
impl ValidatedTargetCompilation {
    ...
    pub(super) fn accepted_trust_admissions(&self) -> &[crate::trust_model::TrustAdmission] {
    ...
    pub(super) fn into_native_product_request(
        self,
    ) -> crate::compiler::native::NativeProductRequest {
        crate::compiler::native::NativeProductRequest {
