...
use crate::compiler::{CheckedCompilation, CompileReport, OptimizationRollback};
use crate::component_description::{ComponentDescriptionFacts, encode_component_description};
use crate::package_compilation::IndependentComponentDescription;
...
pub fn retained_terminal_report_from_checked_package(
    ...
    crate::compiler::checked::run_on_compile_thread(move || {
        ...
        crate::compiler::terminal::produce_terminal_report(
            root_path,
            checked,
            &profile,
...
pub fn published_independent_component_description(
    ...
    let description = crate::component_description::describe_component_facts(ComponentDescriptionFacts {
        artifact,
