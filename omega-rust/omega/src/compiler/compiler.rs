...
use crate::compiler::compiler::request::{SharedCompileInputs, ValidatedTargetCompilation};
use crate::compiler::native::{NativeInputReuse, prepare_native_product};
use crate::compiler::terminal::produce_terminal_report;
use crate::compiler::{
...
struct GeneratedSources {
    ...
    purpose: crate::build_declarations::DependencyPurpose,
    sources: Vec<crate::build_output::PackageGeneratedSource>,
}
