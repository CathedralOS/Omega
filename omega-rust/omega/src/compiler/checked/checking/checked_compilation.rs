...
///
/// ```compile_fail
/// fn replace_program(checked: &mut crate::compiler::CheckedCompilation) {
///     checked.typed = symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees::default();
/// }
/// ```
#[derive(Debug, Clone)]
...
struct CheckedSourceCustody {
    ...
    package_purpose: Option<crate::build_declarations::DependencyPurpose>,
    build_execution_profile: Option<target::TargetProfile>,
    package_subject: Option<crate::package_compilation::PackageCompilationSubject>,
    ...
    own_generated_sources: Vec<crate::build_output::PackageGeneratedSource>,
}
...
impl CheckedCompilation {
    pub(crate) fn seal(
        ...
        let package_subject = package_inputs
            .map(|inputs| {
                crate::package_compilation::derive_package_compilation_subject(
        ...
        let exact_toolchain_sources =
            crate::package_compilation::toolchain_source_identities(&execution.settled.program)?;
        if package_subject.is_some() {
            crate::package_compilation::verify_current_files(
                &execution.settled.program,
                &sources.generated_source_custody,
            )?;
        }
...
impl CheckedCompilation {
    ...
    pub const fn application_name(&self) -> Option<&crate::build_declarations::ProjectName> {
    ...
    pub fn behavior_exclusions(&self) -> &[crate::build_evaluation::AuthoredBehaviorExclusion] {
    ...
    pub const fn dependency_closure(
        &self,
    ) -> Option<&crate::package_compilation::PackageDependencyClosure> {
        match &self.sources.package_subject {
    ...
    pub const fn package_compilation_subject(
        &self,
    ) -> Option<&crate::package_compilation::PackageCompilationSubject> {
    ...
    pub fn resolved_semantic_binding(
        &self,
        role: crate::package_compilation::AcceptedSemanticBindingRole,
    ) -> Option<&crate::selected_dispatch::ResolvedAcceptedSemanticBinding> {
        self.execution
            .settled
    ...
    pub fn resolved_semantic_bindings(
        &self,
    ) -> impl ExactSizeIterator<Item = &crate::package_compilation::AcceptedSemanticBinding> {
        self.execution
            .settled
            .resolved_semantic_bindings
            .iter()
    ...
    pub fn candidate_service_binding(
    ...
    ) -> Result<crate::package_compilation::AcceptedSemanticBinding, Diagnostic> {
        let matches = self
            .execution
            .settled
            .program
            ...
            .filter_map(|definition| {
                crate::provider_planning::service_schema::from_typed(
        ...
        crate::package_compilation::AcceptedSemanticBinding::new_service(
            ...
            package,
            declaration_path,
            crate::package_compilation::accepted_service_schema_digest(role, schema),
        )
    ...
    pub fn package_generated_source_bundle(
        &self,
    ) -> Result<crate::package_compilation::PackageGeneratedSourceBundle, &'static str> {
        let package = self
            .package_identity()
    ...
    pub fn x86_scalar_fma_plan_associations(
        &self,
    ) -> &[crate::provider_planning::x86_fma_plan_association::CheckedX86ScalarFmaPlanAssociation]
    {
    ...
    pub fn selected_program_entry_machine(&self) -> Option<&str> {
        self.execution
            ...
            .as_ref()
            .map(crate::build_evaluation::SelectedCompilerProgramEntry::machine_name)
    }
    ...
    pub fn opaque_representation_selections(
        &self,
    ) -> &[crate::representation_planning::OpaqueRepresentationSelection] {
    ...
    pub fn boundary_opaque_applications(
        &self,
    ) -> Result<resolved_layout_to_resolved_layout::boundary_applications::BoundaryOpaqueRepresentationApplications, &'static str>{
        let rows = self
            .execution
            ...
            .collect();
        resolved_layout_to_resolved_layout::boundary_applications::BoundaryOpaqueRepresentationApplications::new(rows)
    }
    ...
    pub fn selected_provider_grants(
        &self,
    ) -> &[crate::trust_model::ResolvedAuthoredSelectedProviderGrant] {
        &self.execution.settled.selected_provider_grants
    }

    #[doc(hidden)]
    pub fn provider_plans(
        &self,
    ...
    pub fn selected_provider_provenance(
        &self,
    ) -> &[crate::provider_planning::SelectedProviderReviewProvenance] {
    ...
    pub const fn build_evaluation_usage(
        &self,
    ) -> Option<crate::build_evaluation::BuildEvaluationUsage> {
    ...
    pub const fn build_observation_summary(
        &self,
    ) -> Option<&crate::build_evaluation::BuildObservationSummary> {
        self.execution.build_observation_summary.as_ref()
    }

    pub fn build_observation_identity(
        &self,
    ...
    pub fn completed_build_outputs(
        &self,
    ) -> Result<Option<crate::compiler::report::RetainedBuildOutputs>, Vec<Diagnostic>> {
        self.build_observation_summary()
            .map(crate::compiler::report::RetainedBuildOutputs::from_observation)
            .transpose()
            .map(Option::flatten)
    ...
    pub fn independent_component_descriptions(
        &self,
    ) -> &[crate::package_compilation::IndependentComponentDescription] {
    ...
    pub fn contract_entailment_stand_downs(
        &self,
    ) -> &[typed_trees_to_checked_trees::validation::ContractEntailmentStandDown] {
    ...
    pub fn selected_program_entry_service_requirements(&self) -> Vec<symbols::SymbolHandle> {
        ...
        crate::selected_dispatch::program_entry_service_requirements(
            &self.execution.settled.program,
