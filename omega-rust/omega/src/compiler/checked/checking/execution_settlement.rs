...
use crate::build_time_evaluation::SelectedBuildTimeOperators;
use crate::compiler::checked::checking::phase_transitions::{
...
pub(crate) struct CheckedExecution {
    ...
    pub(super) application_intent: Option<crate::build_evaluation::HostedApplicationIntent>,
    pub(super) application_identifier: Option<crate::build_evaluation::ApplicationIdentifier>,
    ...
    pub(super) application: Option<crate::build_declarations::ApplicationDeclaration>,
    pub(super) pcc_requests: crate::build_evaluation::PccRequests,
    ...
    pub(super) x86_scalar_fma_plan_associations:
        Vec<crate::provider_planning::x86_fma_plan_association::CheckedX86ScalarFmaPlanAssociation>,
    pub(super) selected_program_entry:
        Option<crate::build_evaluation::SelectedCompilerProgramEntry>,
    ...
    pub(super) opaque_representation_selections:
        Vec<crate::representation_planning::OpaqueRepresentationSelection>,
    pub(super) boundary_calling_plan_realizations:
        Vec<crate::provider_planning::calling_policy_plans::BoundaryCallingPlanRealization>,
    pub(super) optimization:
        crate::compiler::checked::optimization::checked_handoff::CheckedOptimizationHandoff,
    ...
    pub(super) provider_plans:
        Vec<abstract_operations_to_target_operations::effects::provider_plan::ProviderPlan>,
    pub(super) evaluated_via_bindings:
        crate::provider_planning::evaluated_via_bindings::EvaluatedViaBindingTable,
    pub(super) external_binding_rows:
        Vec<abstract_operations_to_target_operations::calling_conventions::ExternalBindingRow>,
    ...
    pub(super) behavior_exclusions: Vec<crate::build_evaluation::AuthoredBehaviorExclusion>,
    pub(super) build_evaluation_usage: Option<crate::build_evaluation::BuildEvaluationUsage>,
    pub(super) build_observation_summary: Option<crate::build_evaluation::BuildObservationSummary>,
    /// The normalized restricted build-host requests the admitted build
    /// activation asked of the host before it executed.
    pub(super) restricted_build_requests: Vec<crate::build_evaluation::RestrictedBuildRequest>,
    ...
    pub(super) independent_component_descriptions:
        Vec<crate::package_compilation::IndependentComponentDescription>,
...
pub(crate) fn check_selected_execution(
    ...
    let mut boundary_calling_plan_realizations =
        crate::provider_planning::calling_policy_plans::compute_boundary_calling_plans(
            &mut typed,
    ...
    let optimization =
        crate::compiler::checked::optimization::checked_handoff::CheckedOptimizationHandoff::retain(
    ...
    crate::build_evaluation::validate_wire_protocol(
        &typed,
    ...
    let program_entry_binding_role = selected_target_profile
        ...
        .map(crate::build_evaluation::program_entry_semantic_binding_role);
    let mut selected_program_entry = crate::build_evaluation::select_compiler_program_entry(
        &typed,
        &build_config,
    ...
    let accepted_component_assumptions: std::collections::BTreeSet<[u8; 32]> = build_config
        ...
        .collect();
    let crate::build_evaluation::CheckedProviderSelection {
        provider_plans,
        evaluated_via_bindings,
        selected_provider_plan_facts,
        selected_provider_provenance,
        external_binding_rows,
    } = crate::build_evaluation::settle_checked_providers(
        &mut typed,
        selected_target_machine_declarations,
        selected_target_profile,
        package_inputs,
    ...
    if !pending_pre_checks.is_empty() {
        typed_trees_to_checked_trees::validation::land_float_literal_destinations(&mut typed);
    ...
    if package_inputs.is_some() {
        crate::trust_model::reject_package_non_provider_grants(
            &typed,
            &root_grants,
            &provider_plans,
            &selected_provider_plan_facts,
    ...
    if let Some(package_inputs) = package_inputs {
        crate::compiler::checked::package::declaration_admission::validate_authored_declaration_selections(
            &checked.program,
            package_inputs,
        )?;
    }
    ...
    let (checked, product_selection) =
        crate::compiler::checked::optimization::checked_trees::execute(
            checked,
    ...
    let exact_component_progress_root = selected_program_entry.as_ref().map(|entry| {
        ...
        crate::provider_planning::component_progress::ExactComponentProgressRoot::new(
    ...
    let selected_execution_settlement = settle_selected_execution(
        ...
        SelectedExecutionSettlementInput {
            ...
            accepted_filesystem_binding: package_inputs.and_then(|inputs| {
                inputs.accepted_semantic_binding(
                    crate::package_compilation::AcceptedSemanticBindingRole::FilesystemHostService,
                )
            }),
            accepted_time_host_binding: package_inputs.and_then(|inputs| {
                inputs.accepted_semantic_binding(
                    crate::package_compilation::AcceptedSemanticBindingRole::TimeHostService,
                )
            }),
    ...
    let x86_scalar_fma_plan_associations =
        crate::provider_planning::x86_fma_plan_association::bind_checked_x86_scalar_fma_plan_associations(
    ...
    if let Some(entry) = selected_program_entry.as_mut() {
        let establishments = crate::selected_dispatch::derive_fused_program_entry_establishments(
            &selected_execution_settlement.program,
