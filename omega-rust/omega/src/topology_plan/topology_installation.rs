...
use crate::topology_plan::plan_verification::CheckedPlan;
use crate::topology_plan::verified_components::{AdmittedComponent, component_subject_identity};
...
///
/// ```compile_fail
/// use crate::topology_plan::topology_installation::InstallationAuthorization;
...
///
/// ```compile_fail
/// use crate::topology_plan::topology_installation::{InstallationAuthorization, InstallationRequest};
/// use std::sync::Arc;
...
pub trait ProcessSupervisor {
    ...
    ///
    /// ```compile_fail
    /// use crate::topology_plan::topology_installation::{InstallationLifecycle, ProcessSupervisor};
