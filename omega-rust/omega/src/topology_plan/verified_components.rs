...
use crate::component_description::{ComponentVerificationRequest, VerifiedComponent};
...
/// `crate::component_description::verify_component`, so the pair is evidence: the
