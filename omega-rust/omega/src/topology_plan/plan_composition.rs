...
//! from verified component descriptions (see [`crate::topology_plan::verified_components`]),
...
use crate::topology_plan::deployment_plan::graph::{GraphError, NormalizedGraph};
use crate::topology_plan::deployment_plan::predicate::{
    PolicyEvaluation, SelectorError, evaluate_policy,
};
use crate::topology_plan::deployment_plan::{
...
use crate::topology_plan::verified_components::{
...
/// supplied request; encode with `crate::topology_plan::deployment_plan::codec::encode_plan`.
pub fn compose_plan(
...
fn describe_call(call: &crate::topology_plan::deployment_plan::PolicyCall) -> String {
    let names = |selector: &crate::topology_plan::deployment_plan::PolicySelector| {
        selector
            .members
            .iter()
    ...
    match call.predicate {
        crate::topology_plan::deployment_plan::PolicyPredicate::NoRoute => format!(
            "no_route({{{}}}, {{{}}})",
            names(&call.sources),
            names(&call.targets)
        ),
        crate::topology_plan::deployment_plan::PolicyPredicate::OnlyVia => format!(
            "only_via({{{}}}, {{{}}}, {{{}}})",
            names(&call.sources),
            names(&call.targets),
            names(&call.via)
