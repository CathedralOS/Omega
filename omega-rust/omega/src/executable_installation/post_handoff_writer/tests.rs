...
use crate::executable_installation::artifacts::{Artifact, ArtifactEntry};
...
use crate::executable_installation::post_handoff_writer::{
    DestinationPreparationReceipt, PreparedPostHandoffWriterDestination,
};
use target::Architecture;
use terminal_psi::extents::ExtentRights;
use terminal_psi::layout_plans::PlacementSite;
