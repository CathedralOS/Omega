...
use crate::executable_installation::post_handoff_writer::DestinationPreparationReceipt;
...
use terminal_psi::layout_plans::{EntryStubId, PlacementConstraints};
...
pub(super) fn extent_provider_issuance(seed: u64) -> terminal_psi::extents::ExtentProviderIssuance {
    let base = seed * 16;
