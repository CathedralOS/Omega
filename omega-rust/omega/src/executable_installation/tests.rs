...
use crate::executable_installation::artifacts::{
    Artifact, ArtifactAdmissionEvidence, ArtifactEntry, InstallationAudience,
};
use crate::executable_installation::authority_digests::{
    AdmissionReceiptId, ArtifactId, CodePlacementId, EntryContractDigest, EntryReferenceFactDigest,
    EntrySetId, FinalValidationId, InstallationFactDigest, InstallationScopeId, InstalledCodeId,
    MachineContractSetId, MachineFootprintId, MappingQuarantineId, PlacementPlanId,
    RelocationSetId, ReplacementFactDigest, RetirementFactDigest,
};
use crate::executable_installation::entry_references::{
    EntryReferenceAuthority, EntryReferenceReceipt,
};
use crate::executable_installation::executable_installation::{
    admit_executable, install_validated, materialize_and_freeze, retire_installed,
    validate_final_placement,
};
use crate::executable_installation::installation::{
    InstallAuthority, InstallationReceipt, InstalledCode, WxEnforcement,
};
use crate::executable_installation::placement::materializer::materialize_admitted_artifact;
use crate::executable_installation::placement::{
    CodePlacement, CodePlacementAuthority, FinalValidationCertificate, MaterializationReceipt,
    ValidatedPlacement,
};
use crate::executable_installation::retirement::quarantine::{
    MappingQuarantineCause, MappingQuarantineReceipt, quarantine_installed,
};
use crate::executable_installation::retirement::replacement::{
    ReplacementAuthority, ReplacementOutcome, ReplacementReceipt, replace_installed,
};
use crate::executable_installation::retirement::uninstall::{
    UninstallOutcome, uninstall_installed,
};
use crate::executable_installation::retirement::{RetirementAuthority, RetirementReceipt};
use target::Architecture;
use terminal_psi::extents::{Extent, ExtentLineageId, ExtentRootGrant, MappingEraId};
use terminal_psi::layout_plans::{ArtifactInstallationScopeId, EntryStubId, PlacementPhase};
use terminal_psi::layout_plans::{PlacementConstraints, RelocationTarget};

use super::test_support::*;
use terminal_psi::extents::{AddressSpaceId, ExtentProvenanceId, ExtentRights};
use terminal_psi::layout_plans::{MachineRegimeId, PlacementAddressRange, PlacementSite};
...
fn local_fnv_sites_are_explicitly_non_authoritative() {
    ...
    let container = include_str!("artifacts/container.rs");
    let container_bytes = include_str!("artifacts/container_bytes.rs");
    let materializer = include_str!("placement/materializer.rs");
