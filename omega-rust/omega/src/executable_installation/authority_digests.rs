...
use sha2::Digest;
use sha2::Sha256;
use terminal_psi::layout_plans::PlacementConstraints;
...
impl ArtifactAuthorityCommitments {
    ...
    pub fn from_canonical_evidence(
        ...
        footprint_bytes: &[u8],
        regime: Option<(terminal_psi::layout_plans::MachineRegimeId, &[u8])>,
        scope: Option<(
            terminal_psi::layout_plans::ArtifactInstallationScopeId,
            &[u8],
        )>,
    ) -> Self {
