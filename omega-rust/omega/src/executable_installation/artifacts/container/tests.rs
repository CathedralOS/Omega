...
use crate::executable_installation::artifacts::ArtifactAdmissionEvidence;
...
use crate::executable_installation::authority_digests::ArtifactAuthorityCommitments;
...
use crate::executable_installation::executable_installation::admit_executable;
use crate::executable_installation::installation::InstallationDiagnostic;
use target::Architecture;
use terminal_psi::layout_plans::EntryStubId;
use terminal_psi::layout_plans::{ArtifactInstallationScopeId, DataSymbolId, MachineRegimeId};
...
fn decoded() -> DecodedArtifactContainer {
    ...
    let mut decoded = DecodedArtifactContainer {
        ...
        placement_constraints: PlacementConstraints::unconstrained(
            terminal_psi::layout_plans::PlacementPhase::Load,
        ),
        entry_set,
...
fn canonical_bounded_container_produces_only_an_artifact_candidate() {
    ...
    assert_eq!(
        ...
        PlacementConstraints::unconstrained(terminal_psi::layout_plans::PlacementPhase::Load)
    );
}
