...
use crate::executable_installation::artifacts::{
    AdmittedArtifact, Artifact, ArtifactAdmissionEvidence, ArtifactEntry,
};
...
fn fingerprint_placement(
    ...
    content_commitment_bytes(
        ...
        &[match placement.phase() {
            terminal_psi::layout_plans::PlacementPhase::Build => 1,
            terminal_psi::layout_plans::PlacementPhase::Load => 2,
            terminal_psi::layout_plans::PlacementPhase::PostHandoff => 3,
        }],
    );
