...
use crate::executable_installation::artifacts::{AdmittedArtifact, Artifact, InstallationAudience};
...
use crate::executable_installation::placement::materializer::MaterializedArtifactBytes;
use terminal_psi::extents::{AddressSpaceId, Extent, ExtentProvenanceId, ExtentRights};
use terminal_psi::layout_plans::{PlacementConstraints, PlacementSite};
...
struct CodePlacementExtentEvidence {
    ...
    era: terminal_psi::extents::MappingEraId,
    lineage: terminal_psi::extents::ExtentLineageId,
}
...
pub(crate) struct ValidatedPlacementEvidence {
    ...
    pub(crate) era: terminal_psi::extents::MappingEraId,
    pub(crate) lineage: terminal_psi::extents::ExtentLineageId,
    pub(crate) final_bytes: Vec<u8>,
    pub(crate) realized_footprint: MachineFootprintId,
    pub(crate) validation: FinalValidationId,
}
