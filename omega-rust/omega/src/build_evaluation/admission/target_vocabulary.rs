...
fn type_reference_names_exact_data(
    ...
    match typed.type_reference_table.type_reference(type_reference) {
        ...
        symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceNode::Named { symbol, .. } => *symbol == expected,
        _ => false,
    }
}
        ...
        typed
            ...
            .filter_map(|member| match member {
                symbol_resolved_trees_to_typed_trees::typed_trees::data::DataMember::Field(
                    field,
                ) if field.name.as_str() == "x86_deployment_features" => Some(field),
                _ => None,
            })
            .collect::<Vec<_>>();
...
pub(crate) fn validate_build_activation_integrity(
    ...
    use symbol_resolved_trees_to_typed_trees::typed_trees::{
        data::DataMember, expression::ExpressionNode, statement::StatementNode,
    };
