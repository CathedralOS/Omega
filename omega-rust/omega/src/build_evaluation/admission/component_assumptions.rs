...
pub fn harvest_component_assumption_acceptances(
    ...
    let mut record = |target: &str,
                      value_arguments: &[symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionHandle],
        ...
        let symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionNode::String(spelling) =
