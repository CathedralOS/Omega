...
use crate::build_evaluation::BuildConfig;
...
impl crate::checked_interpreter::ProductEntryCompatibility for ProductEntryQueryCompatibility {
    fn validate_entry(
        &self,
        typed: &TypedTrees,
...
fn validate_program_entry_source_compatibility<'typed>(
    ...
    (
        ...
        &'typed symbol_resolved_trees_to_typed_trees::typed_trees::state::State,
    ),
    Vec<Diagnostic>,
> {
...
> {
    ...
    let receiver = self_parameters.first().map_or(
        ...
        |receiver| resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntrySourceReceiverSignature::ProvisionedMutable {
    ...
    let visible_parameters = visible
        ...
        .map(|(index, parameter)| -> Result<_, Diagnostic> {
            let role = match index {
                0 => resolved_layout_to_resolved_layout::program_entry_plan::ProgramStorageEntryRootRole::Image,
                1 => resolved_layout_to_resolved_layout::program_entry_plan::ProgramStorageEntryRootRole::InitialStorage,
                _ => unreachable!("selected source shape validation fixed visible arity"),
            };
            let extent_value_layout =
                crate::provider_planning::calling_policy_plans::selected_program_storage_source_extent_value_layout(
                    typed,
                    selected.slot,
            ...
            Ok(resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramEntrySourceSignature::visible_parameter(
                role,
                index,
                typed
...
pub struct SelectedCompilerProgramEntry {
    source_signature: resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramEntrySourceSignature,
    calling_plans: Option<SelectedProgramEntryCallingPlans>,
    fused_service_establishments: Vec<resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntryFusedServiceEstablishment>,
}
...
impl SelectedCompilerProgramEntry {
    ...
    pub fn bind_fused_service_establishments(
        &mut self,
        mut establishments: Vec<resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntryFusedServiceEstablishment>,
    ) -> Result<(), &'static str> {
...
pub fn select_compiler_program_entry(
    ...
    config: &BuildConfig,
    selected_profile: Option<target::TargetProfile>,
    realizations: &[crate::provider_planning::calling_policy_plans::BoundaryCallingPlanRealization],
    accepted_entry_binding: Option<&crate::package_compilation::AcceptedSemanticBinding>,
...
pub fn validate_selected_program_entry_calling_plan(
    ...
    let service_schema = crate::provider_planning::service_schema::from_typed(typed, schema)
        .ok_or_else(|| {
            vec![Diagnostic::error(format!(
    ...
    .map_err(|diagnostic| vec![diagnostic])?;
    let storage_entry = resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramStorageEntryPlan::from_target_slot(
        selected.slot,
        service_schema,
    ...
    let physical_contract = resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntryPhysicalContractPlan::new(
        selected.slot,
...
struct TargetOwnedPhysicalContractSource {
    ...
    package_source_digest: resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntryPhysicalContractPackageSourceDigest,
...
fn target_owned_physical_contract_source(
    ...
    service_schema: &abstract_operations_to_target_operations::effects::provider_plan::ServiceSchema,
    ...
    let package_source_digest =
        resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntryPhysicalContractPackageSourceDigest::from_package_source(
            expected_package,
...
pub fn program_entry_semantic_binding_role(
    package: target::ProgramEntryPhysicalContractPackage,
) -> crate::package_compilation::AcceptedSemanticBindingRole {
    match package {
...
fn exact_bundled_physical_contract_package_source_digest(
    package: target::ProgramEntryPhysicalContractPackage,
) -> resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntryPhysicalContractPackageSourceDigest{
    match package {
        target::ProgramEntryPhysicalContractPackage::UefiX64 => {
            resolved_layout_to_resolved_layout::program_entry_plan::exact_uefi_x64_physical_contract_package_source_digest()
        }
        target::ProgramEntryPhysicalContractPackage::MacosArm64 => {
            resolved_layout_to_resolved_layout::program_entry_plan::exact_macos_arm64_physical_contract_package_source_digest()
        }
        target::ProgramEntryPhysicalContractPackage::MacosX64 => {
            resolved_layout_to_resolved_layout::program_entry_plan::exact_macos_x86_64_physical_contract_package_source_digest()
        }
        target::ProgramEntryPhysicalContractPackage::LinuxX86_64 => {
            resolved_layout_to_resolved_layout::program_entry_plan::exact_linux_x86_64_physical_contract_package_source_digest()
        }
        target::ProgramEntryPhysicalContractPackage::LinuxArm64 => {
            resolved_layout_to_resolved_layout::program_entry_plan::exact_linux_arm64_physical_contract_package_source_digest()
        }
        target::ProgramEntryPhysicalContractPackage::WindowsX64 => {
            resolved_layout_to_resolved_layout::program_entry_plan::exact_windows_x86_64_physical_contract_package_source_digest()
        }
    }
}
...
struct ArrivalRequirementParameterType {
    identity:
        symbol_resolved_trees_to_typed_trees::typed_trees::type_identity::NormalizedTypeIdentity,
    display: String,
    is_const: bool,
    is_mutable: bool,
}
