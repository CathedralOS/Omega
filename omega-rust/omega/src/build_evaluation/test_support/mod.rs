...
pub fn unknown_descriptor_summary() -> BuildObservationSummary {
    BuildObservationSummary {
        ...
        filesystem_operation_schema_version:
            crate::checked_interpreter::FILESYSTEM_OPERATION_ATTEMPT_SCHEMA_VERSION,
        ...
        activation: crate::build_evaluation::BuildActivation::default(),
...
fn query_chain_open(
    ...
    open.authorized_paths.push(BuildFilesystemAuthorizedPath {
        operand_ordinal: 0,
        access: crate::build_evaluation::BuildFilesystemGrantAccess::Read,
