...
//! [`abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts::with_toolchain_settled_plan`], which
...
use crate::package_compilation::AcceptedSemanticBinding;
...
fn resolve_time_host_binding<'trees>(
    ...
    (
        &'trees symbol_resolved_trees_to_typed_trees::typed_trees::trait_definition::TraitDefinition,
        abstract_operations_to_target_operations::effects::provider_plan::ServiceSchema,
    ),
    Diagnostic,
>{
    let matches = typed
        ...
        .filter_map(|definition| {
            ...
            let schema = crate::provider_planning::service_schema::from_typed(typed, definition)?;
...
pub fn mint_canonical_time_host_plan(
    ...
    let plan = ProviderPlan {
        name: crate::provider_planning::satisfies_plan_name(
            target_name,
            &schema.trait_name,
