...
use crate::build_evaluation::admission::component_assumptions::harvest_component_assumption_acceptances;
use crate::build_evaluation::admission::configuration::{BuildConfig, extract_build_config};
use crate::build_evaluation::admission::declarations::{
    harvest_behavior_exclusions, harvest_root_grants, harvest_wire_compatibility_demands,
};
use crate::build_evaluation::admission::selection::root_bindings::collect_root_bindings;
use crate::build_evaluation::admitted_build_program::{
    AdmittedBuildMachine, SelectedAdmittedBuildMachine,
};
use crate::build_evaluation::evidence::observations::{
    BUILD_OBSERVATION_SCHEMA_VERSION, BuildObservationSummary,
};
use crate::build_evaluation::{AdmittedBuildProgram, ComputedBuildConfig};
...
fn execute_admitted_build_occurrence(
    ...
    let provider_selections =
        crate::build_evaluation::admission::declarations::collect_executed_provider_selections(
            typed,
    ...
    config.opaque_representation_selections =
        crate::representation_planning::harvest_opaque_representation_selections(typed, machine)?;
