...
use crate::build_evaluation::evidence::filesystem_scope::{
    BUILD_OUTPUT_ROOT_IDENTITY, BUILD_SOURCE_ROOT_IDENTITY,
};
...
use crate::checked_interpreter::EvaluationObservations;
...
pub(super) fn project_filesystem_operation_attempts(
    ...
    filesystem_scope: &crate::build_evaluation::BuildMachineFilesystemScope,
    machine_name: &str,
    ...
    observations
        ...
        .map(|attempt| {
                ...
                .map(|path| {
                    ...
                    Ok(BuildFilesystemAuthorizedPath {
                        ...
                        access: match path.access() {
                            crate::checked_interpreter::FilesystemGrantAccess::Read => {
                                BuildFilesystemGrantAccess::Read
                            }
                            crate::checked_interpreter::FilesystemGrantAccess::Write => {
            ...
            Ok(BuildFilesystemOperationAttempt {
                ...
                crate::checked_interpreter::FilesystemObservationProvider::Virtual => {
                    BuildFilesystemProvider::Virtual
                }
                crate::checked_interpreter::FilesystemObservationProvider::RealUnscoped => {
                    BuildFilesystemProvider::RealUnscoped
                }
                crate::checked_interpreter::FilesystemObservationProvider::RealScoped => {
                ...
                grant_refusals: attempt
                    ...
                    .map(|refusal| BuildFilesystemGrantRefusal {
                        ...
                        reason: match refusal.reason() {
                            crate::checked_interpreter::FilesystemGrantRefusalReason::Unresolvable => {
                                BuildFilesystemGrantRefusalReason::Unresolvable
                            }
                            crate::checked_interpreter::FilesystemGrantRefusalReason::OutsideGrantedRoots => {
                                BuildFilesystemGrantRefusalReason::OutsideGrantedRoots
                            }
                            crate::checked_interpreter::FilesystemGrantRefusalReason::UnrepresentableRootedPath => {
                                BuildFilesystemGrantRefusalReason::UnrepresentableRootedPath
                            }
                            crate::checked_interpreter::FilesystemGrantRefusalReason::ObservationEvidenceLimitExceeded => {
