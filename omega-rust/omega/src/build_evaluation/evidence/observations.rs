...
pub(crate) const fn project_logical_handle_identity(
    identity: crate::checked_interpreter::FilesystemLogicalHandleIdentity,
...
pub(crate) const fn project_logical_handle_kind(
    kind: crate::checked_interpreter::FilesystemLogicalHandleKind,
) -> BuildFilesystemLogicalHandleKind {
    match kind {
        crate::checked_interpreter::FilesystemLogicalHandleKind::Descriptor => {
            BuildFilesystemLogicalHandleKind::Descriptor
        }
        crate::checked_interpreter::FilesystemLogicalHandleKind::Native => {
            BuildFilesystemLogicalHandleKind::Native
        }
        crate::checked_interpreter::FilesystemLogicalHandleKind::Find => {
...
pub(crate) const fn project_logical_handle_input_resolution(
    resolution: crate::checked_interpreter::FilesystemLogicalHandleInputResolution,
) -> BuildFilesystemLogicalHandleInputResolution {
    match resolution {
        crate::checked_interpreter::FilesystemLogicalHandleInputResolution::Resolved(identity) => {
            BuildFilesystemLogicalHandleInputResolution::Resolved(project_logical_handle_identity(
                identity,
            ))
        }
        crate::checked_interpreter::FilesystemLogicalHandleInputResolution::Null => {
            BuildFilesystemLogicalHandleInputResolution::Null
        }
        crate::checked_interpreter::FilesystemLogicalHandleInputResolution::Unknown => {
...
pub(crate) const fn project_logical_handle_output_source(
    source: crate::checked_interpreter::FilesystemLogicalHandleOutputSource,
) -> BuildFilesystemLogicalHandleOutputSource {
    match source {
        crate::checked_interpreter::FilesystemLogicalHandleOutputSource::Created => {
            BuildFilesystemLogicalHandleOutputSource::Created
        }
        crate::checked_interpreter::FilesystemLogicalHandleOutputSource::Duplicated(identity) => {
            BuildFilesystemLogicalHandleOutputSource::Duplicated(project_logical_handle_identity(
                identity,
            ))
        }
        crate::checked_interpreter::FilesystemLogicalHandleOutputSource::Borrowed(identity) => {
...
pub(crate) const fn project_operation_result(
    result: crate::checked_interpreter::FilesystemOperationResult,
) -> BuildFilesystemOperationResult {
    match result {
        crate::checked_interpreter::FilesystemOperationResult::Scalar(value) => {
            BuildFilesystemOperationResult::Scalar(value)
        }
        crate::checked_interpreter::FilesystemOperationResult::LogicalHandle(identity) => {
