...
#[cfg(test)]
use crate::build_evaluation::{BUILD_OBSERVATION_SCHEMA_VERSION, BuildCapturedSourceInventory};
...
const fn declaration_role_tag(
    role: Option<crate::package_compilation::BuildDeclarationKind>,
) -> u8 {
    match role {
        None => 0,
        Some(crate::package_compilation::BuildDeclarationKind::Package) => 1,
        Some(crate::package_compilation::BuildDeclarationKind::Application) => 2,
        Some(crate::package_compilation::BuildDeclarationKind::Workspace) => 3,
    }
}
...
mod tests {
    ...
    use crate::build_evaluation::BuildActivation;
    ...
    fn identity_binds_top_level_observation_contract() {
        ...
        changed.captured_source_inventory = Some(BuildCapturedSourceInventory {
            ...
            file_bytes: 7,
            source_metadata_identity:
                crate::build_evaluation::BuildCanonicalSourceMetadataIdentity::new(1, [1; 32]),
        });
        assert_ne!(baseline, changed.identity());
        ...
        changed
            ...
            .unwrap()
            .source_metadata_identity =
            crate::build_evaluation::BuildCanonicalSourceMetadataIdentity::new(1, [2; 32]);
    ...
    fn named_input_identity_includes_unread_inventory_and_exact_slot_binding() {
        ...
        summary
            ...
            .push(crate::build_evaluation::BuildNamedInputInventory {
                ...
                inventory: BuildCapturedSourceInventory {
                    ...
                    file_bytes: 7,
                    source_metadata_identity:
                        crate::build_evaluation::BuildCanonicalSourceMetadataIdentity::new(
                            1, [1; 32],
                        ),
                },
            });
