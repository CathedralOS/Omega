...
use crate::checked_interpreter::FilesystemSponsorEntry;
...
pub struct BuildMachineFilesystemScope {
    source_root: PathBuf,
    canonical_source_metadata: Option<crate::checked_interpreter::CanonicalFilesystemMetadataIndex>,
    ...
    root_role: Option<crate::package_compilation::BuildDeclarationKind>,
...
impl BuildMachineFilesystemScope {
    ...
    pub fn for_package_root(
        ...
        build_dir: PathBuf,
        sponsor: Option<BuildMachineFilesystemSponsor>,
        metadata: Option<crate::checked_interpreter::CanonicalFilesystemMetadataIndex>,
    ) -> Self {
        let admitted_build_dir_key = overlap_key(&build_dir);
        Self {
            source_root,
    ...
    pub fn with_package_activation(
        ...
        root_role: crate::package_compilation::BuildDeclarationKind,
    ) -> Self {
    ...
    pub(crate) fn named_input_facet(&self) -> crate::build_time_evaluation::BuildTimeValue {
    ...
    pub fn with_required_outputs(
        ...
        for name in required_outputs {
            ...
            if !crate::checked_interpreter::canonical_filesystem_metadata_path_is_canonical(
                &name, false,
            ) {
                return Err(vec![Diagnostic::error(format!(
...
mod tests {
    ...
    use crate::build_output::{CapturedBuildSourceInput, CapturedSourceEntry};
    use crate::build_time_evaluation::BuildMachineFilesystemAccess;
    ...
    fn build_scope_attaches_canonical_metadata_only_to_source() {
        let metadata = crate::checked_interpreter::CanonicalFilesystemMetadataIndex::version_1(
            [0x5a; 32],
            [
                crate::checked_interpreter::CanonicalFilesystemMetadataRow::new(
                    Vec::new(),
                    crate::checked_interpreter::CanonicalFilesystemMetadataRowKind::Directory,
                ),
            ],
        )
    ...
    fn benign_snapshot_execution_requires_exact_private_staging_custody() {
        ...
        broader.read_roots.push(
            crate::build_time_evaluation::BuildMachineFilesystemGrantRoot::new(
                crate::build_time_evaluation::BuildMachineFilesystemGrantRootIdentity::new(9)
                    .unwrap(),
                fixture.join("live"),
            ),
        );
    ...
    fn required_output_completion_is_linear_against_sealed_custody() {
        ...
        let tree = crate::build_output::from_entries(&[
            crate::build_output::OutputTreeEntry::regular_file(b"artifact.txt", b"done", false),
        ])
        ...
        let dirs_only =
            crate::build_output::from_entries(&[crate::build_output::OutputTreeEntry::directory(
                b"artifact.txt",
            )])
            .expect("dir tree");
        let diagnostics = scope
