use crate::build_evaluation::admission::vocabulary::is_exact_toolchain_build_prelude_data;
        ...
        typed
            ...
            .filter_map(|member| match member {
                symbol_resolved_trees_to_typed_trees::typed_trees::data::DataMember::Field(
                    field,
                ) if field.name.as_str() == "optimizations" => Some(field),
                _ => None,
            })
            .collect::<Vec<_>>();
