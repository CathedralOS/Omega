...
pub struct ComponentDescriptionFacts<'a> {
    ...
    pub selected_provider_plans:
        &'a abstract_operations_to_target_operations::effects::SelectedProviderPlanFacts,
    /// Any retained build-bound progress manifest.
    pub component_progress:
        Option<&'a abstract_operations_to_target_operations::effects::ComponentProgressManifest>,
