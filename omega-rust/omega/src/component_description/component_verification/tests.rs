...
use crate::component_description::component_description::{
...
fn describe(module: &TerminalModule, selected: &SelectedProviderPlanFacts) -> ComponentDescription {
    ...
    crate::component_description::describe_component_facts(ComponentDescriptionFacts {
        artifact: &artifact,
...
fn publishes_installation_bounds_separately_from_concrete_reach() {
    ...
    masquerade.outgoing.push(
        crate::component_description::component_description::OutgoingAuthority {
