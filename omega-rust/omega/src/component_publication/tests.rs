...
use crate::component_publication::stack_provision::check_external_stack_provision;
...
use crate::component_publication::{
...
use abstract_operations_to_target_operations::target_operations::{
    ScalarAbiValue, ScalarFunctionAbi, TerminalPsiProvenance,
};
...
use resolved_layout_to_resolved_layout::image_emission::{
    build_installation_record, build_installation_record_with_evidence,
    build_object_artifact_with_private_functions, emit_direct_executable_image,
};
...
fn unprovisioned_runnable_fixture_at(seed: u64, placement_base: u64) -> RunnableFixture {
    ...
    let artifact = bind_installed_artifact(
        ...
        image,
        installation,
        &resolved_layout_to_resolved_layout::boundary_applications::BoundaryOpaqueRepresentationApplications::EMPTY,
        installed,
    )
...
fn callback_fuel(_root: ExternalRootId) -> crate::external_roots::ComposedFuelDemand {
