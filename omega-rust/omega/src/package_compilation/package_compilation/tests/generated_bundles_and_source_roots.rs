...
use crate::package_compilation::package_compilation::{
    ...
    let inputs = PackageCompilationInputs::new_package(
        ...
        vec![
            ...
            PackageDependencyBinding::for_purpose(
                ...
                "shared",
                identity(2),
                crate::build_declarations::DependencyPurpose::Build,
            ),
        ],
    )
    .unwrap();
    use crate::build_declarations::DependencyPurpose::{Build, Product};
...
fn generated_source_execution_profile_is_exact_even_for_empty_bundles() {
    ...
    let bundle = |package, profile| {
        PackageGeneratedSourceBundle::from_checked(
            package,
            crate::build_declarations::DependencyPurpose::Product,
            target::TargetProfile::WindowsX64,
            profile,
            inputs.dependency_closure_for(package),
