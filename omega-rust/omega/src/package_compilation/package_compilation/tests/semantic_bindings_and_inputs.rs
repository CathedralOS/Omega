...
fn accepted_semantic_binding_canonicalizes_explicit_terminal_permissions() {
    let schema = abstract_operations_to_target_operations::effects::provider_plan::ServiceSchemaDigest::from_digest([7; 32]);
    let permission = |requirement: &str, class| {
        abstract_operations_to_target_operations::effects::ServiceTerminalAuthorityPermission::new(
            schema,
            requirement,
            abstract_operations_to_target_operations::effects::TerminalAuthorityDisposition::from_classes([class]),
        )
    };
    let binding = accepted_console_binding(identity(1), 7)
        .with_terminal_authority_permissions(vec![
            permission(
                ...
                abstract_operations_to_target_operations::effects::TerminalAuthorityClass::ProcessOutput,
            ),
            permission(
...
fn filesystem_binding_retains_explicit_portable_facet_permissions() {
    let schema = abstract_operations_to_target_operations::effects::provider_plan::ServiceSchemaDigest::from_digest([9; 32]);
    ...
    .with_terminal_authority_permissions(vec![
        abstract_operations_to_target_operations::effects::ServiceTerminalAuthorityPermission::for_filesystem_facets(
            schema,
            "FilesystemHost::open#exact",
            [
                abstract_operations_to_target_operations::effects::PortableFilesystemAuthorityFacet::ContentRead,
                abstract_operations_to_target_operations::effects::PortableFilesystemAuthorityFacet::ContentWrite,
                abstract_operations_to_target_operations::effects::PortableFilesystemAuthorityFacet::MetadataQuery,
            ],
        ),
    ])
    ...
    assert_eq!(
        ...
        &[
            abstract_operations_to_target_operations::effects::TerminalAuthorityClass::FilesystemContentRead,
            abstract_operations_to_target_operations::effects::TerminalAuthorityClass::FilesystemContentWrite,
            abstract_operations_to_target_operations::effects::TerminalAuthorityClass::FilesystemMetadataQuery,
        ]
    );
}
...
fn accepted_semantic_binding_rejects_permission_schema_and_key_substitution() {
    let schema = abstract_operations_to_target_operations::effects::provider_plan::ServiceSchemaDigest::from_digest([7; 32]);
    let other_schema = abstract_operations_to_target_operations::effects::provider_plan::ServiceSchemaDigest::from_digest([8; 32]);
    let disposition = abstract_operations_to_target_operations::effects::TerminalAuthorityDisposition::from_classes([
        abstract_operations_to_target_operations::effects::TerminalAuthorityClass::ProcessTermination,
    ]);
