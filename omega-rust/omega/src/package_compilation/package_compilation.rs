...
use crate::build_output::PackageGeneratedSource;
use crate::checked_interpreter::CanonicalFilesystemMetadataIndex;
use crate::package_compilation::source_snapshot;
...
impl PackageSourceBinding {
    ...
    pub fn with_cached_canonical_source_metadata(
        mut self,
        cache: &crate::package_compilation::checked_source_cache::CheckedSourceCache,
    ) -> Result<Self, String> {
...
impl crate::build_time_evaluation::BuildTimeSelectionAuthority for PackageCompilationInputs {
