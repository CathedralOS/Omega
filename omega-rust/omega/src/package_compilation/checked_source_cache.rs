...
impl CheckedSourceCache {
    ...
    pub fn capture(&self, source_root: &Path) -> Result<CachedSourceIndex, String> {
        let canonical_root =
            crate::package_compilation::package_compilation::canonical_source_root(source_root)?;
        ...
        let index = crate::package_compilation::source_snapshot::capture(&canonical_root)?;
