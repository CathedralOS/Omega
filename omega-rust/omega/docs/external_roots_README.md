...
Start at [lib.rs](../src/external_roots.rs); [root_validation.rs](../src/external_roots/root_entry/root_validation.rs)
owns admission and [provider_execution.rs](../src/external_roots/root_entry/provider_execution.rs) owns the
validated execution binding.

[stack_demand.rs](../src/external_roots/stack_and_fuel/stack_demand.rs) composes artifact/root demand.
[epoch_stack_demand.rs](../src/external_roots/stack_and_fuel/epoch_stack_demand.rs) joins the complete entry
...
[calling-conventions/stack_realizations.rs](../pipeline/02_abstract-operations-to-target-operations/src/calling_conventions/stack_realizations/mod.rs).
...
[fixed_fuel.rs](../src/external_roots/stack_and_fuel/fixed_fuel.rs) retains schedule identity and distinguishes
...
[interrupt_table.rs](../src/external_roots/interrupts/interrupt_table.rs) accounts one descriptor table's
