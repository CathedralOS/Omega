...
[lib.rs](../../src/compiler.rs) exposes source checking and one `CompileRequest`/`compile`
...
[compiler.rs](../../src/compiler/compiler.rs) owns request admission, the shared checked
...
[Native input reuse](../../src/compiler/native/native_product/input_reuse.rs) retains exactly matching
...
their product owners; [package.rs](../../src/compiler/compiler/package.rs) owns package-custody
...
The [checked entrance](../../src/compiler/checked/checking.rs) shows the lifecycle:
[admit and execute the build, then continue generated source](../../src/compiler/checked/checking/build_continuation.rs),
[check selected execution](../../src/compiler/checked/checking/execution_settlement.rs),
then [seal the result against current source custody](../../src/compiler/checked/checking/checked_compilation.rs).
...
[Native compilation](../../src/compiler/native/native_product/prepared.rs) prepares and realizes the native
...
[Request validation](../../src/compiler/compiler/request.rs) checks the requested product and
...
source-shaped path. [Native artifacts](../../pipeline/09_resolved-layout-to-resolved-layout/native_artifact.md)
...
[Checked admission](../../src/compiler/checked/admission/mod.rs)
...
[intrinsic_settlements.rs](../../src/provider_planning/compiler_intrinsics/mod.rs) validates all
...
[Explicit targets](../../src/compiler/compiler/request/targets.rs) accepts an optional
...
[Request admission](../../src/compiler/compiler/request.rs) stores root, product, observation
...
([source preparation](../../src/compiler/sources/source_assembly/checkpoint.rs))
...
[phase_transitions.rs](../../src/compiler/checked/checking/phase_transitions.rs).
...
Start at [native_realization.rs](../../src/compiler/native/native_realization.rs):
...
artifact. [PreparedNativeRealizationInput](../../src/compiler/native/native_realization/input_preparation.rs)
...
contract. [entry_settlement](../../src/compiler/native/entry_settlement/mod.rs) independently replays
...
[service_establishment.rs](../../src/compiler/native/entry_settlement/service_establishment.rs) joins
...
the same spelling. The [entry controls](../../src/compiler/native/entry_settlement/mod.rs)
...
[callback_custody.rs](../../src/compiler/native/native_realization/callback_thunks.rs) returns the caller's
...
primitives in [component-publication](../../src/component_publication/callback_registration.rs)
