...
pub(crate) fn associate(
...
) -> Result<Vec<crate::report::TerminalIntegerComparisonOccurrenceProposal>, Vec<Diagnostic>> {
    ...
    crate::report::TerminalIntegerComparisonOccurrenceProposal::validate_roster(
        module,
        selected.plans(),
        &proposals,
    )
...
) -> Result<crate::report::TerminalIntegerComparisonOccurrenceProposal, Diagnostic> {
    let fail = |reason: &str| {
