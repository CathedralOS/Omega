...
use crate::checked::CheckedCompilation;
...
) -> Result<Vec<crate::report::TerminalIeeeFloatFmaOccurrenceProposal>, Vec<Diagnostic>> {
    occurrences
        .iter()
...
fn associate_one(
...
) -> Result<crate::report::TerminalIeeeFloatFmaOccurrenceProposal, Vec<Diagnostic>> {
    ...
    let x86_admission = if native_target.architecture == target::Architecture::X86_64 {
        ...
        Some(crate::report::TerminalX86ScalarFmaAdmission::new(
            association.slot(),
    ...
    Ok(crate::report::TerminalIeeeFloatFmaOccurrenceProposal::new(
