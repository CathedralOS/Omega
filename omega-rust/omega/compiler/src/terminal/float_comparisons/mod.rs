...
pub(crate) fn associate(
...
) -> Result<Vec<crate::report::TerminalIeeeFloatComparisonOccurrenceProposal>, Vec<Diagnostic>> {
    ...
    crate::report::TerminalIeeeFloatComparisonOccurrenceProposal::validate_roster(
        module,
        selected.plans(),
        &proposals,
    )
...
fn associate_one(
...
) -> Result<crate::report::TerminalIeeeFloatComparisonOccurrenceProposal, Diagnostic> {
    let fail = |reason: &str| {
    ...
    let proposal = crate::report::TerminalIeeeFloatComparisonOccurrenceProposal {
