...
impl ProductionCompilationManifest {
    ...
    /// Mint the honest manifest over arbitrary retained parts: canonical bytes
    ...
    pub fn for_test(
        ...
        Self::new(subject, artifact)
    }

    /// Store manifest parts verbatim: the claimed subject, artifact
...
fn canonical_manifest_bytes(
    ...
    bytes.push(match closure.root_role() {
        ...
        package_compilation::BuildDeclarationKind::Workspace => {
