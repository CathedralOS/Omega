...
use crate::checked::checking::phase_transitions::{
...
pub(crate) struct CheckedExecution {
    ...
    pub(super) optimization:
        crate::checked::optimization::checked_handoff::CheckedOptimizationHandoff,
...
pub(crate) fn check_selected_execution(
    ...
    let optimization =
        crate::checked::optimization::checked_handoff::CheckedOptimizationHandoff::retain(
    ...
    if let Some(package_inputs) = package_inputs {
        crate::checked::package::declaration_admission::validate_authored_declaration_selections(
            &checked.program,
            package_inputs,
        )?;
    }
    ...
    let (checked, product_selection) = crate::checked::optimization::checked_trees::execute(
        checked,
