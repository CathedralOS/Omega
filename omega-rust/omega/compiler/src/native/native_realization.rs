...
fn validate_executable_entry_receiver(
    ...
    artifact: &terminal_codec::CanonicalTerminalArtifact,
    request: &NativeRealizationRequest<'_>,
) -> Result<Option<crate::native::ValidatedNativeProgramEntrySettlement>, Vec<Diagnostic>> {
    ...
    let settled = crate::native::validate_native_program_entry_settlement(
        artifact,
        checked_entry,
        request.program_entry,
        request.target,
...
fn validate_emitted_receiver_binding(
    ...
    admitted: Option<&crate::native::ValidatedNativeProgramEntrySettlement>,
