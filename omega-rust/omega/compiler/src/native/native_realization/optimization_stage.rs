...
> {
    let optimization_request =
        crate::native::compiler_baseline_request_v1(request.optimization_selections.selections());
    crate::native::optimize_verified_abstract_input(input, optimization_request)
