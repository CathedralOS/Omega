...
pub struct PreparedNativeCompilation {
    ...
    pub(super) rollback: crate::checked::OptimizationRollbackSettlement,
    pub(super) terminal: ProgramEntryTerminalArtifact,
    pub(super) production_subject: Option<crate::report::ProductionCompilationSubject>,
...
impl PreparedNativeCompilation {
    pub(super) fn new(
        ...
        rollback: crate::checked::OptimizationRollbackSettlement,
        terminal: ProgramEntryTerminalArtifact,
        production_subject: Option<crate::report::ProductionCompilationSubject>,
...
impl PreparedNativeCompilation {
    pub(super) fn prepare_reusable_input(
        &self,
    ) -> Result<crate::native::PreparedNativeRealizationInput, Vec<Diagnostic>> {
        let post_terminal = self.rollback.effective().project_post_terminal();
        crate::native::prepare_native_realization_input(
