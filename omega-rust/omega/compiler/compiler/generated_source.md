...
- [build_scope.rs](src/compiler/request.rs) binds request staging and sponsor
...
- [checked_entry.rs](../../pipeline/assembled-syntax-to-checked-compilation/src/checking.rs): `AdmittedBuildCheckpoint`
