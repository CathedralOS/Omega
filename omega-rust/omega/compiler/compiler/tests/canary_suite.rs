...
const CROSS_TARGET_PASS_CANARIES: &[(&str, &str)] = &[
    ...
    (
        "inline_asm/asm_machine_control_wrapper_reach",
        "uefi_x86_64",
    ),
...
const CHECKED_ONLY_PASS_CANARIES: &[&str] = &[
    ...
    "expressions/owned_match_call_values",
    ...
    "dependent/mutable_referent_alias_corruption_restored_compile",
    ...
    "dependent/local_alias_forwards_entry_origin",
    ...
    "proofs/kernel_theorem_equality_certificates",
    "proofs/kernel_integer_discreteness",
    "proofs/kernel_integer_subtract_order",
    "proofs/kernel_integer_subtract_bound",
    ...
    "dependent/case_where_bound_literal_proves",
    "dependent/case_where_payload_write_restores",
    "dependent/case_where_replacement_clears",
    "dependent/case_where_match_contributes",
    "dependent/case_where_match_arm_facts",
    "dependent/case_where_generic_instance_carried",
    "dependent/case_where_generic_const_bound",
    "dependent/case_where_generic_type_bound",
    "dependent/case_where_generic_type_bound_coverage",
    "dependent/case_where_zero_decided_first_case",
    "dependent/case_where_linear_payload_moves",
    "dependent/case_where_common_field_window",
    ...
    "parameters/mutable_parameter_field_write_compile",
    "parameters/mutable_parameter_sequential_field_writes_compile",
    "parameters/nested_receiver_mutable_parameter_field_writes_compile",
    ...
    "proofs/proof_integer_quotient_remainder",
    ...
    "termination/auxiliary_payload_computed_arrival",
    ...
    "termination/measure_field_fresh_arrival",
    "termination/constrained_measure_parameter_compile",
    "termination/measure_field_projection",
    "termination/measure_field_rank_range",
    "termination/measure_field_rank_endpoint",
    "termination/measure_field_rank_arithmetic",
    "termination/named_computed_rank_endpoints",
    "termination/quotient_endpoint_call_component",
    "termination/remainder_actual_call_component",
    "termination/remainder_literal_call_component",
    "termination/symbolic_quotient_endpoints",
    "termination/measure_field_rank_step",
    ...
    "termination/stored_reference_endpoint_arrivals",
    "termination/rank_range_remainder_computed_copy",
    "termination/rank_range_state_cycle",
    "termination/lexicographic_state_call",
    "termination/rank_range_state_call",
    "termination/rank_range_state_call_internal_cycle",
    "termination/rank_range_state_call_invariant",
    "termination/rank_range_state_call_requires_bridge",
    "termination/rank_range_field_state_call_requires_bridge",
    "termination/rank_range_projected_endpoint_requires_bridge",
    "termination/rank_range_slice_state_call",
    "termination/rank_range_entry_reentry",
    "termination/rank_range_slice_length",
    "termination/rank_range_slice_length_call_component",
    "termination/rank_range_call_component",
    "termination/rank_range_distance_call_component",
    "termination/rank_range_increasing_call_component",
    "termination/increasing_call_component",
    "termination/natural_call_variable_step",
    "termination/mutable_natural_call_variable_step",
    "termination/mixed_call_rank_ranges",
    "termination/mixed_call_member_endpoint",
    "termination/rank_range_clamped_call_component",
    "termination/rank_range_scratch_input_write",
    "termination/rank_range_mutable_bounded_endpoint",
    "termination/rank_range_call_scratch_input_write",
    "termination/rank_range_call_copies_with_scratch_write",
    "termination/rank_range_call_computed_copy",
    "termination/rank_range_call_stepped_copy",
    "termination/rank_range_call_slice_stepped_copy",
    "termination/rank_range_slice_stepped_copy",
    "termination/rank_range_field_stepped_copy",
    "termination/rank_range_record_lockstep_copies",
    "termination/rank_range_declared_step_copies",
    "termination/rank_range_call_declared_step_copy",
    "termination/rank_range_record_stepped_copy",
    "termination/rank_range_indexed_store_write",
    "termination/rank_range_borrowed_prefix_operand",
    ...
    "termination/computed_measure_call_component",
    "termination/measure_field_call_component",
    "termination/measure_field_call_component_borrowed",
    "termination/measure_field_call_component_member_borrow",
    "termination/measure_field_call_component_member_forward",
    "termination/measure_field_call_component_member_nested",
    "termination/measure_nested_projection_rank",
    "termination/measure_nested_projection_rank_range",
    "termination/measure_borrowed_projection",
    "termination/measure_nested_projection_range_relational",
    "termination/measure_nested_projection_range_pinned_limit",
    "termination/measure_borrowed_projection_range",
    "termination/rank_range_projected_slice_length",
    "termination/rank_range_nested_slice_length",
    "termination/rank_range_nested_slice_carrier",
    "termination/rank_range_nested_slice_carrier_borrowed",
    "termination/rank_range_call_nested_slice_carrier",
    "termination/rank_range_bare_nested_slice",
    "termination/rank_range_bare_nested_scalar",
    "termination/rank_range_len_endpoint_call_component",
    "termination/rank_range_len_endpoint_mixed_component",
    "termination/rank_range_len_endpoint_record_carrier",
    "termination/computed_measure_projected_subject",
...
const CHECKED_ONLY_FAIL_CANARIES: &[&str] = &[
    ...
    "modules/match_initializer_range",
    ...
    "termination/stored_reference_endpoint_reseat",
    "termination/explicit_self_without_descent",
    "termination/identity_measure_unbound_name",
    "termination/measure_unbound_projection",
    "termination/measure_nested_projection",
    "termination/measure_field_rank_ceiling",
    "termination/measure_field_rank_endpoint_replaced",
    "termination/measure_field_rank_arithmetic_replaced",
    "termination/named_computed_rank_endpoint_changed",
    "termination/quotient_endpoint_call_changed",
    "termination/remainder_actual_call_component_changed",
    "termination/remainder_literal_call_component_changed",
    "termination/symbolic_quotient_endpoint_changed",
    "termination/measure_field_rank_zero_step",
    "termination/measure_field_relational_endpoint_changed",
    "termination/rank_range_distance_endpoint_changed",
    "termination/rank_range_distance_intervening_write",
    "termination/rank_range_slice_endpoint_changed",
    "termination/rank_range_slice_intervening_write",
    "termination/measure_field_limit_changed",
    "termination/measure_field_computed_limit_overflow",
    "termination/measure_field_remainder_limit_changed",
    "termination/rank_range_remainder_moved_copy",
    "termination/measure_field_fresh_arrival_stalled",
    "termination/constrained_measure_parameter_domain",
    "termination/rank_range_subject_intervening_write",
    "termination/rank_range_endpoint_intervening_write",
    "termination/rank_range_endpoint_unformed",
    "termination/rank_range_call_copied_input_write",
    "termination/rank_range_call_computed_copy_unproven",
    "termination/rank_range_call_stepped_copy_stale",
    "termination/rank_range_call_slice_stepped_copy_stale",
    "termination/rank_range_slice_stepped_copy_stale",
    "termination/rank_range_record_stepped_copy_stale",
    "termination/rank_range_record_stepped_copy_divergent",
    "termination/rank_range_record_stepped_copy_reseeded",
    "termination/rank_range_call_declared_step_stale",
    "termination/rank_range_declared_step_unbounded",
    ...
    "termination/identity_measure_call_component_mixed_view",
    "termination/computed_measure_rank_range_overflow",
    "termination/computed_measure_rank_range_narrow",
    "termination/computed_measure_non_monotone_body",
    "termination/computed_measure_authored_operator",
    "termination/computed_measure_call_component_overflow",
    "termination/computed_measure_call_component_mixed_measure",
    "termination/computed_measure_call_component_unbounded",
    "termination/measure_field_call_component_stalled",
    "termination/measure_field_call_component_premise_write",
    "termination/measure_field_call_component_mixed_measure",
    "termination/measure_field_call_component_member_foreign",
    "termination/measure_field_call_component_member_premise_write",
    "termination/mixed_call_member_endpoint_foreign",
    "termination/measure_nested_projection_stalled",
    "termination/measure_nested_projection_wrong_field",
    "termination/measure_borrowed_projection_rebound",
    "termination/measure_nested_projection_range_endpoint_changed",
    "termination/measure_nested_projection_range_limit_written",
    "termination/measure_borrowed_projection_range_endpoint_changed",
    "termination/rank_range_projected_slice_stalled",
    "termination/rank_range_projected_slice_endpoint_changed",
    "termination/rank_range_projected_slice_premise_write",
    "termination/rank_range_projected_slice_divergent",
    "termination/rank_range_projected_slice_foreign",
    "termination/rank_range_nested_slice_carrier_stalled",
    "termination/rank_range_nested_slice_carrier_ambiguous",
    "termination/rank_range_bare_nested_slice_stalled",
    "termination/rank_range_bare_nested_slice_ambiguous",
    "termination/rank_range_bare_nested_scalar_ambiguous",
    "termination/rank_range_len_endpoint_changed",
    "termination/rank_range_len_endpoint_intervening_write",
    "termination/rank_range_len_endpoint_foreign_carrier",
    "termination/rank_range_len_endpoint_ambiguous_carrier",
    "termination/computed_measure_projected_subject_stalled",
    "arithmetic/field_singleton_authored_equality",
    "termination/measure_field_arrival_contract",
    ...
    "targets/sibling_body_type_error_rejected",
    ...
    "arithmetic/bounded_index_max_unproven",
    "recast/guarded_offset_footprint_rejected",
    "recast/multi_edge_offset_meet_rejected",
    "recast/unbounded_offset_names_the_bound",
    "dependent/cross_machine_field_equality_unproven_rejected",
    "domains/nested_field_domain_write_unestablished",
    "ranges/exact_range_unproven_assignment_rejected",
    "ranges/exact_range_unproven_local_rejected",
    ...
    "core/translation_unmap_before_activation",
    "core/translation_shootdown_scope_loss",
    "core/translation_source_use_after_map",
    "core/translation_mapping_construction_rejected",
    ...
    "generics/declared_range_endpoint_template_bound_out_of_range",
    "generics/declared_range_endpoint_template_bound_unclosable_rejected",
    "generics/omitted_data_binder_explicit_conflict",
    "generics/omitted_data_binder_repeat_conflict",
    "generics/omitted_data_binder_missing_range_shell",
    "generics/omitted_data_binder_empty_interval",
    "generics/omitted_data_binder_occurs_cycle",
    "generics/omitted_data_binder_kind_mismatch",
    "generics/omitted_data_binder_underdetermined",
    ...
    "proofs/quotient_define_standalone_identity_rejected",
    ...
    "proofs/quotient_theorem_result_bearing_rejected",
    "proofs/quotient_transport_roles_reversed_rejected",
    ...
    "proofs/inductive_climbing_sum_unbounded_accumulator",
    ...
    "termination/rank_range_state_call_increase",
    "termination/rank_range_state_call_internal_stall",
    "termination/rank_range_state_call_endpoint_changed",
    "termination/rank_range_state_call_intervening_write",
    "termination/rank_range_state_call_arrival_unproven",
    "termination/rank_range_state_call_carried_increase",
    "termination/rank_range_state_call_requires_unproven",
    ...
    "expressions/token_bound_machine_duplicate_shape_rejected",
    "expressions/token_bound_machine_foreign_family_rejected",
    ...
    "arithmetic/bitwise_result_overflow",
    "arithmetic/bitwise_result_declared_range",
    "arithmetic/complement_nested_overflow",
    "arithmetic/undeclared_bare_name_rejected",
    "arithmetic/unqualified_case_value_rejected",
    ...
    "dependent/mutable_referent_alias_corruption_return_rejected",
    "dependent/reference_return_alias_corruption_rejected",
    "dependent/local_alias_mutable_origin_rejected",
    "dependent/local_alias_unrelated_origin_rejected",
    "dependent/case_where_reversed_bound_rejected",
    "dependent/case_where_unproved_bound_rejected",
    "dependent/case_where_generic_data_unsupported",
    "dependent/case_where_generic_const_bound_rejected",
    "dependent/case_where_generic_reversed_bound_rejected",
    "dependent/case_where_generic_type_bound_rejected",
    "dependent/case_where_generic_type_bound_uncovered",
    "dependent/case_where_payload_write_unclosed",
    "dependent/case_where_payload_write_exit_open",
    "dependent/case_where_match_swapped_rejected",
    "dependent/case_where_match_arm_reversed_rejected",
    "dependent/case_where_zero_refuted_first_case_rejected",
    "dependent/case_where_open_constraint_uncovered",
    "dependent/case_where_sibling_payload_scope",
    ...
    "proofs/kernel_theorem_equality_false_twin",
    "proofs/kernel_integer_discreteness_false_twin",
    "proofs/kernel_integer_subtract_order_false_twin",
    "proofs/kernel_integer_subtract_bound_false_twin",
    ...
    "control_flow/transition_empty_arms_rejected",
    "control_flow/transition_empty_subject_arms_rejected",
    "control_flow/transition_arm_subject_type_mismatch_rejected",
    ...
    "effects/structural_callback_fixed_const_reach",
    ...
    "memory/bump_allocator_borrowed_strategy_carve",
    "memory/bump_allocator_unestablished_resident",
...
const ROOTED_BACKEND_PASS_CANARIES: &[&str] = &[
    ...
    "targets/sibling_bodies_checked",
    ...
    "collections/runtime_vec_u32_growth_exit",
    ...
    "arithmetic/qualified_case_value",
