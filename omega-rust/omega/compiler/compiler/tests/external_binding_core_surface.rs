...
use typed_trees::types::{FixedArrayLength, PrimitiveType, TypeReferenceNode};
...
fn assert_toolchain_source(typed: &typed_trees::TypedTrees, symbol: symbols::SymbolHandle) {
    let source = typed
        .symbols
