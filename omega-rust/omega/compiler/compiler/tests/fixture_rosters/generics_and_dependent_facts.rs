...
pub(crate) const MUTABLE_CARRIER_SLICE_LENGTH_COMPILE: &str =
    "dependent/call_requires_mutable_carrier_slice_length_compile";
pub(crate) const MUTABLE_CARRIER_SLICE_REBOUND_REJECTED: &str =
    "dependent/call_requires_mutable_carrier_slice_rebound_rejected";
...
pub(crate) const PASS_CANARIES: &[&str] = &[
    ...
    MUTABLE_CARRIER_SLICE_LENGTH_COMPILE,
];
...
pub(crate) const FILE_EXPECTATION_FAIL_CANARIES: &[&str] = &[
    ...
    MUTABLE_CARRIER_SLICE_REBOUND_REJECTED,
];
