...
pub const PROOFS_ACCUMULATOR_GUARANTEE_EXIT: &str = "proofs/accumulator_guarantee_exit";
...
pub const PASS_CANARIES: &[&str] = &[
    ...
    PROOFS_ACCUMULATOR_GUARANTEE_EXIT,
...
pub const FAIL_CANARIES: &[&str] = &[
    ...
    FLOAT_EXCLUSIVE_RANGE_ENDPOINT_REJECTED,
];
