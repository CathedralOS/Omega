...
pub const WIRE_COMPATIBILITY_MIGRATION_RETIRED_IDENTITY_FRESH: &str =
    "wire/wire_compatibility_migration_retired_identity_fresh";
pub const WIRE_COMPATIBILITY_MIGRATION_RETIRED_IDENTITY_REUSE: &str =
...
pub const PASS_CANARIES: &[&str] = &[
    ...
    WIRE_COMPATIBILITY_MIGRATION_RETIRED_IDENTITY_FRESH,
...
pub const FAIL_CANARIES: &[&str] = &[
    ...
    WIRE_COMPATIBILITY_MIGRATION_RETIRED_IDENTITY_REUSE,
