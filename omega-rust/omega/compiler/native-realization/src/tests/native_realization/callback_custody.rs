//! Callback thunk custody through native realization: materialization of
//! private callback functions and rejection of foreign, duplicate, or
//! optimization-retained callbacks.
...
fn callback_thunks_request<'a>(
    ...
    NativeRealizationRequest {
        ...
        native_callbacks: &[],
        callback_thunks,
        behavior_exclusions: &crate::tests::fixtures::NO_BEHAVIOR_EXCLUSIONS,
    }
}
