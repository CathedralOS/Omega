...
use crate::native_realization::providers::project_selected_provider_adapters_for_requirements;
...
fn selected_checked_adapter_projection_is_exact_and_fail_closed() {
    let selected =
        effects::SelectedProviderPlanFacts::from_selected_plans(vec![checked_adapter_plan(
            "program-storage",
    ...
    let external = effects::SelectedProviderPlanFacts::from_selected_plans(vec![external])
    ...
    let duplicate = effects::SelectedProviderPlanFacts::from_selected_plans(vec![
    ...
    let unrelated_duplicates = effects::SelectedProviderPlanFacts::from_selected_plans(vec![
        checked_adapter_plan(
            "program-storage",
            "ProgramStorageProvider",
            "ProgramStorageEntry",
    ...
    *machine_package_identity = Some(package);
    assert!(
        effects::SelectedProviderPlanFacts::from_selected_plans(vec![drifted])
