pub(crate) fn validate_paired_calling_plans(
    ...
    semantic: &calling_conventions::BoundaryEntryPlan,
    ...
    let validated_semantic =
        calling_conventions::validate_boundary_entry_plan(semantic.clone(), &signature)
    ...
    let physical_signature = calling_conventions::CallSignature {
    ...
    let validated_physical = calling_conventions::validate_boundary_entry_plan(
        physical_plan.clone(),
        &physical_signature,
    )
