...
use crate::native_realization::terminal_authority_review::review_terminal_authority_closure;
use effects::{
...
fn checked_adapter_port_write_requires_exact_physical_and_service_policy() {
    ...
    for wrong_policy in [
        crate::native_realization::terminal_authority_policy::current_terminal_authority_policy(),
    ...
    let physical =
        crate::native_realization::terminal_authority_policy::terminal_authority_policy_with_rows(
            [0x03f8, 0x0080]
                .into_iter()
                .map(|port| {
                    crate::native_realization::terminal_authority_policy::TerminalAuthorityPolicyRow::new(
