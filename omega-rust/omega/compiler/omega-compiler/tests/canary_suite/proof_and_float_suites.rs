...
fn linux_arm64_float_semantic_edge_twin_retains_artifact_evidence() {
    ...
    retain(
        &mut build_artifact_identity,
        &(omega_target::NativeTarget::linux_arm64().pointer_size as u64).to_le_bytes(),
    );
    retain(
        &mut build_artifact_identity,
        &(omega_target::NativeTarget::linux_arm64().pointer_alignment as u64).to_le_bytes(),
    );
    retain(
        &mut build_artifact_identity,
...
fn linux_x64_baseline_float_semantic_edge_twin_retains_artifact_evidence() {
    ...
    retain(
        &mut build_artifact_identity,
        &(omega_target::NativeTarget::linux_x64().pointer_size as u64).to_le_bytes(),
    );
    retain(
        &mut build_artifact_identity,
        &(omega_target::NativeTarget::linux_x64().pointer_alignment as u64).to_le_bytes(),
    );
    retain(
        &mut build_artifact_identity,
