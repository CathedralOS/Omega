//! The public builder entries and the single validating construction pass
//! that replays every retained machine-code record against final bytes
//! before sealing text, data, symbols and relocations.
