...
use machine_code::{MachineCodeFunction, SemanticCodeAttribution, SemanticCodeSite};
...
pub(crate) fn validate_unit_dynamic_descriptor_join(
    target: NativeTarget,
    ...
    if function.provenance.operations.as_slice() != [first.psi_operation, second.psi_operation]
        ...
        || parameter.placement.shape != calling_conventions::ValueShape::integer(1, 1)
