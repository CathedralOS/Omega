...
use super::cleanup_preservation::validate_scalar_cleanup_preservation_record;
use super::conditional_regions::collect_conditional_tree_regions;
use crate::ObjectError;

pub(crate) fn validate_scalar_control_cleanup_evidence(
...
pub(crate) fn cleanup_for_owner(
    records: &[ScalarControlAffineCleanupRecord],
    owner: CallSiteOwner,
