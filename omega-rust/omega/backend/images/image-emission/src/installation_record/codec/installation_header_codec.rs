...
pub(crate) struct DecodedInstallationHeader {
    ...
    pub(crate) component_progress: Option<crate::installation_record::InstalledComponentProgress>,
    pub(crate) image: ImageFingerprint,
    pub(crate) image_sections: crate::installation_record::InstalledImageSections,
...
pub(crate) fn decode_installation_header(
    ...
    let component_progress = component_progress_present
        .then(|| {
            ...
            Ok(crate::installation_record::InstalledComponentProgress {
                manifest,
                acceptance,
            })
        })
    ...
    let image_sections = crate::installation_record::InstalledImageSections {
        ...
        data_byte_count: usize::try_from(reader.u64()?)
            .map_err(|_| InstallationError::InvalidImageSectionLayout)?,
        final_data_fingerprint: crate::installation_record::InitializedDataFingerprint(
            reader.array()?,
        ),
