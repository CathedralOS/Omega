...
pub(crate) fn encode_internal_unit_scalar_calls(
    bytes: &mut Vec<u8>,
    count: u32,
...
pub(crate) fn decode_internal_unit_scalar_calls(
    reader: &mut Reader<'_>,
...
pub(crate) fn encode_argument_source(
    bytes: &mut Vec<u8>,
...
pub(crate) fn decode_argument_source(
    reader: &mut Reader<'_>,
...
pub(crate) fn encode_offset(bytes: &mut Vec<u8>, value: usize) -> Result<(), InstallationError> {
    push_u64(
        bytes,
        u64::try_from(value)
            .map_err(|_| InstallationError::InstalledScalarOffsetNotRepresentable)?,
...
pub(crate) fn decode_offset(reader: &mut Reader<'_>) -> Result<usize, InstallationError> {
