...
pub(crate) fn encode_scalar_abi(
    bytes: &mut Vec<u8>,
...
pub(crate) fn decode_scalar_abi(
    reader: &mut Reader<'_>,
...
mod tests {
    ...
    fn scalar_abi_transport_preserves_boolean_kind_and_integer_bytes() {
        ...
        assert!(
            crate::installation_record::installed_unit_scalar_transport::installed_scalar_abi_is_canonical(
                &abi,
