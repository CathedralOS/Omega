...
use crate::installation_record::{InstallationError, Reader, push_u64};

pub(crate) fn encode_provider_execution(bytes: &mut Vec<u8>, execution: ProviderExecutionRecord) {
...
pub(crate) fn decode_provider_execution(
    reader: &mut Reader<'_>,
