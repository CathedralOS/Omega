...
use crate::installation_record::{InstallationError, Reader, decode_boolean, push_u16};

pub(crate) fn encode_boundary_result_scalar_type(bytes: &mut Vec<u8>, scalar_type: ScalarType) {
    match scalar_type {
...
pub(crate) fn decode_boundary_result_scalar_type(
    reader: &mut Reader<'_>,
