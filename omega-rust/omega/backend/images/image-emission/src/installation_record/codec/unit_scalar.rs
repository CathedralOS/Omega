...
pub(crate) fn encode_integer_type(
    bytes: &mut Vec<u8>,
...
pub(crate) fn decode_integer_type(
    reader: &mut Reader<'_>,
...
pub(crate) fn encode_scalar_type(
    bytes: &mut Vec<u8>,
...
pub(crate) fn decode_scalar_type(reader: &mut Reader<'_>) -> Result<ScalarType, InstallationError> {
    let tag = reader.u8()?;
...
pub(crate) fn encode_integer_value(bytes: &mut Vec<u8>, value: IntegerValue) {
    match value {
...
pub(crate) fn decode_integer_value(
    reader: &mut Reader<'_>,
...
pub(crate) fn encode_unit_scalar_home(
    bytes: &mut Vec<u8>,
...
pub(crate) fn decode_unit_scalar_home(
    reader: &mut Reader<'_>,
...
pub(crate) fn encode_unit_scalar_homes(
    bytes: &mut Vec<u8>,
...
pub(crate) fn decode_unit_scalar_homes(
    reader: &mut Reader<'_>,
...
pub(crate) fn encode_unit_integer_constants(
    bytes: &mut Vec<u8>,
...
pub(crate) fn decode_unit_integer_constants(
    reader: &mut Reader<'_>,
...
pub(crate) fn encode_unit_affine_scalar_records(
    bytes: &mut Vec<u8>,
...
pub(crate) fn decode_unit_affine_scalar_records(
    reader: &mut Reader<'_>,
