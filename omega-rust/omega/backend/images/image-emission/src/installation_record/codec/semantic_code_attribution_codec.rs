...
use crate::installation_record::{
    InstallationError, ObjectCodeAttribution, Reader, push_u32, push_u64,
};

pub(crate) fn encode_semantic_code_attributions(
    bytes: &mut Vec<u8>,
    count: u32,
...
pub(crate) fn decode_semantic_code_attributions(
    reader: &mut Reader<'_>,
