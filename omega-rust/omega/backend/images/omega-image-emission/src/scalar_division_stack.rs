...
use omega_machine_code::{ScalarDivisionBranchEvidence, ScalarStackEvidence, ScalarStackMutation};
...
fn replay_x86_scalar_linear_region(
    ...
    call_sites: &mut std::collections::BTreeMap<usize, omega_machine_code::InternalCallRelocation>,
    evidence: &ScalarStackEvidence,
