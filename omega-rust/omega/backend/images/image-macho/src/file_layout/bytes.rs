...
pub(crate) fn write_be_u32(bytes: &mut Vec<u8>, value: u32) {
    bytes.extend(value.to_be_bytes());
}

pub(crate) fn write_be_u64(bytes: &mut Vec<u8>, value: u64) {
    bytes.extend(value.to_be_bytes());
}

pub(crate) fn write_fixed_string_16(bytes: &mut Vec<u8>, value: &str) {
