...
fn plural_depth_twenty_one_paths_compose_depth_twenty_custody_and_retain_fences() {
    ...
    let carrier = psi_build_time_evaluation::validate_const_materializable_record_with_depth_twenty_one_nested_sums(
        &checked,
        "Outer",
        &paths,
        &value,
    ...
    let big_endian = psi_build_time_evaluation::validate_const_materializable_record_with_depth_twenty_one_nested_sums(
        &checked,
        "Outer",
        &paths,
        &value,
    ...
    let rejects =
        |mutated: &psi_layout_plans::ConventionalDepthTwentyOneRecordSumPathsLayoutReport| {
            assert!(
                carrier
    ...
    assert!(
        psi_build_time_evaluation::validate_const_materializable_record_with_depth_twenty_one_nested_sums(
            &recursive_checked,
            "Outer",
            &paths,
            &value,
