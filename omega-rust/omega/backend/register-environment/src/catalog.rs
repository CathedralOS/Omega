...
pub(super) fn selected_constraint_keys(target: NativeTarget) -> Option<SelectedConstraintKeys> {
    match (target.architecture, target.object_format) {
        (Architecture::X86_64, ObjectFormat::Elf) => Some(SelectedConstraintKeys {
            ...
            saturating_subtract_u64: isa_x86_64::X86_64_SATURATING_SUBTRACT_U64,
            ...
            saturating_add_i32: isa_x86_64::X86_64_SATURATING_ADD_I32,
            saturating_subtract_i32: isa_x86_64::X86_64_SATURATING_SUBTRACT_I32,
            saturating_divide_i32: isa_x86_64::X86_64_SATURATING_DIVIDE_I32,
        ...
        (Architecture::Aarch64, ObjectFormat::Elf) => Some(SelectedConstraintKeys {
            ...
            saturating_subtract_u64: isa_aarch64::AARCH64_SATURATING_SUBTRACT_U64,
            ...
            saturating_add_i32: isa_aarch64::AARCH64_SATURATING_ADD_I32,
            saturating_subtract_i32: isa_aarch64::AARCH64_SATURATING_SUBTRACT_I32,
            saturating_divide_i32: isa_aarch64::AARCH64_SATURATING_DIVIDE_I32,
