...
) -> Result<calling_conventions::MachineRegister, EmissionError> {
...
pub(super) fn emit_x86_64_unit_scalar_argument(
    ...
    match argument.source {
        AssignedUnitScalarArgumentSource::Parameter {
            ...
            assigned_target_operations::AssignedScalarLocation::IncomingStack { byte_offset } => {
...
fn canonical_integer_bits(
    ...
    if matches!(scalar_type.sign(), semantic_vocabulary::IntegerSign::Signed)
        && scalar_type.bits() < 64
    {
