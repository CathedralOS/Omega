...
fn assigned_x86_fma_emits_raw_bits_exact_plan_custody_and_canonical_mxcsr() {
    ...
    for (format, values) in [
        ...
        let assigned_target_operations::AssignedUnitOperation::NearestIeeeFloatFusedMultiplyAdd {
            addend,
            ..
...
fn admitted_foreign_stack() -> task_plans::AdmittedSameStackContribution {
    let provider_plan_commitment =
        task_plans::SameStackProviderPlanCommitment::from_digest([0x73; 32]);
        ...
        match target.architecture {
            target::Architecture::X86_64 => {
                ...
                assert_eq!(
                    ...
                    isa_x86_64::encode_stmxcsr_rsp_displacement(0)
                        .unwrap()
                        .as_slice()
                );
                assert_eq!(
                    ...
                    isa_x86_64::encode_ldmxcsr_rsp_displacement(0)
                        .unwrap()
                        .as_slice()
                );
            }
            target::Architecture::Aarch64 => {
                ...
                assert_eq!(
                    &function.bytes
                        [control.save_offset..control.save_offset + control.save_byte_count],
                    &isa_aarch64::encode_save_fpcr_to_sp_displacement(0).unwrap()
                );
                assert_eq!(
                    &function.bytes[control.restore_offset
                        ..control.restore_offset + control.restore_byte_count],
                    &isa_aarch64::encode_restore_fpcr_from_sp_displacement(0).unwrap()
                );
            }
        }
...
fn normalized_foreign_integer_literal_uses_only_the_evaluated_register_before_the_call() {
    ...
    let source_value = semantic_vocabulary::ValueId::new(710).unwrap();
    let scalar_type =
        semantic_vocabulary::IntegerType::new(semantic_vocabulary::IntegerSign::Signed, 64)
            .unwrap();
    let immediate = semantic_vocabulary::IntegerValue::Signed(-37);
    let provider_execution = ProviderExecutionBinding::from_execution_record(
    ...
    for profile in [
                    ...
                    operations: vec![
                        ...
                        TargetUnitOperation::NormalizedForeignCall {
                            ...
                            scalar_arguments: vec![NormalizedForeignScalarArgument {
                                parameter_index: 0,
                                source: target_operations::TargetUnitScalarArgumentSource::IntegerImmediate {
        ...
        let assigned = assign_registers(&plan).unwrap();
        let mutate_argument = |mut assigned: assigned_target_operations::AssignedOperationPlan,
                               mutate: &dyn Fn(
            &mut assigned_target_operations::AssignedNormalizedForeignScalarArgument,
        )| {
            let assigned_target_operations::AssignedOperation::UnitBody(body) =
                &mut assigned.functions[0].operation
            else {
        ...
        mutate_argument(assigned.clone(), &|argument| {
            let assigned_target_operations::AssignedUnitScalarArgumentSource::IntegerImmediate {
                source_value,
                ..
            } = &mut argument.source
            else {
            ...
            *source_value = semantic_vocabulary::ValueId::new(711).unwrap();
        });
        mutate_argument(assigned.clone(), &|argument| {
            let assigned_target_operations::AssignedUnitScalarArgumentSource::IntegerImmediate {
                scalar_type,
        ...
        mutate_argument(assigned.clone(), &|argument| {
            ...
            *value = semantic_vocabulary::IntegerValue::Signed(-38);
        });
        mutate_argument(assigned.clone(), &|argument| {
            argument.parameter_index = 1;
        });
        mutate_argument(assigned.clone(), &|argument| {
            argument.placement.locations = vec![calling_conventions::ValueLocation::Stack {
                stack_byte_offset: 0,
                value_byte_offset: 0,
                byte_size: 4,
                alignment: 4,
        ...
        mutate_argument(assigned.clone(), &|argument| {
            argument.placement.locations[0] = calling_conventions::ValueLocation::Register {
                register: match target.architecture {
                    target::Architecture::X86_64 => MachineRegister::X86Rsi,
                    target::Architecture::Aarch64 => MachineRegister::Aarch64X(1),
                },
                value_byte_offset: 0,
                byte_size: 8,
            };
        ...
        let assigned_target_operations::AssignedUnitOperation::IntegerConstant {
            scalar_type,
            value,
            ..
        } = &mut body.operations[0]
        ...
        *scalar_type = semantic_vocabulary::IntegerType::address(64).unwrap();
        *value = semantic_vocabulary::IntegerValue::Unsigned((-37_i64) as u64 as u128);
        let assigned_target_operations::AssignedUnitOperation::NormalizedForeignCall {
            scalar_arguments,
            ..
        } = &mut body.operations[1]
        ...
        scalar_arguments[0].source =
            assigned_target_operations::AssignedUnitScalarArgumentSource::IntegerImmediate {
                defining_operation: constant_operation,
                source_value,
                scalar_type: semantic_vocabulary::IntegerType::address(64).unwrap(),
                value: semantic_vocabulary::IntegerValue::Unsigned((-37_i64) as u64 as u128),
...
fn linux_exit_group_consumes_i32_and_traps_on_both_linux_architectures() {
    ...
    let source_value = semantic_vocabulary::ValueId::new(990).unwrap();
    let i32_type =
        semantic_vocabulary::IntegerType::new(semantic_vocabulary::IntegerSign::Signed, 32)
            .unwrap();
    ...
    assert_eq!(
        ...
        isa_x86_64::encode_linux_exit_group_i32(37)
    );
    ...
    assert_eq!(
        ...
        isa_aarch64::encode_linux_exit_group_i32(37).unwrap()
    );
    assert_eq!(
...
fn linux_write_line_then_exit_owns_exact_code_data_and_argument_custody() {
    ...
    let exit_value = semantic_vocabulary::ValueId::new(980).unwrap();
    ...
    for (target, destination) in [
        ...
        assert_eq!(
            ...
            semantic_vocabulary::IntegerValue::Signed(37)
        );
...
fn partial_cleanup_partition_rejects_noncanonical_type_closures() {
            ...
            shape: terminal_psi::StructuralTypeShape::Record {
                fields: vec![
                    terminal_psi::StructuralFieldDeclaration {
                        id: semantic_vocabulary::StructuralFieldId::new(1).expect("moved field"),
                        identity: "moved".into(),
                        relevance: terminal_psi::BindingRelevance::Relevant,
                        field_type: terminal_psi::StructuralFieldType::Structural(moved_type),
                    },
                    terminal_psi::StructuralFieldDeclaration {
                        id: semantic_vocabulary::StructuralFieldId::new(2).expect("scalar field"),
                        identity: "count".into(),
                        relevance: terminal_psi::BindingRelevance::Relevant,
                    ...
                    terminal_psi::StructuralFieldDeclaration {
                        id: semantic_vocabulary::StructuralFieldId::new(4).expect("float field"),
                        identity: "ratio".into(),
                        relevance: terminal_psi::BindingRelevance::Relevant,
                    ...
                    terminal_psi::StructuralFieldDeclaration {
                        id: semantic_vocabulary::StructuralFieldId::new(5).expect("byte field"),
                        identity: "bytes".into(),
                        relevance: terminal_psi::BindingRelevance::Relevant,
                    ...
                    terminal_psi::StructuralFieldDeclaration {
                        id: semantic_vocabulary::StructuralFieldId::new(3).expect("residual field"),
                        identity: "residual".into(),
                        relevance: terminal_psi::BindingRelevance::Relevant,
                        field_type: terminal_psi::StructuralFieldType::Structural(residual_type),
                    },
                ],
            },
        },
    ...
    let residual = terminal_psi::StructuralAffineDiscard {
    ...
    let scalar_residual = terminal_psi::StructuralAffineDiscard {
        place: PlaceId::new(1).expect("place"),
        path: scalar_path,
        structural_type: residual_type,
    };
    ...
    let float_residual = terminal_psi::StructuralAffineDiscard {
        place: PlaceId::new(1).expect("place"),
        path: float_path,
        structural_type: residual_type,
    };
    ...
    let bytes_residual = terminal_psi::StructuralAffineDiscard {
        place: PlaceId::new(1).expect("place"),
        path: bytes_path,
        structural_type: residual_type,
    };
    ...
    let terminal_psi::StructuralTypeShape::Record { fields } = &mut borrowed_view[0].shape else {
        unreachable!()
    };
    fields
        .iter_mut()
    ...
    let terminal_psi::StructuralTypeShape::Record { fields } = &mut scalar_as_structural[0].shape
    else {
        unreachable!()
    };
    fields[1].field_type = terminal_psi::StructuralFieldType::Structural(residual_type);
    assert!(
    ...
    let terminal_psi::StructuralTypeShape::Record { fields } = &mut moved_as_scalar[0].shape else {
        unreachable!()
    };
...
fn partial_cleanup_partition_accepts_only_opposite_element_of_affine_pair() {
    ...
    let same_as_moved = terminal_psi::StructuralAffineDiscard {
    ...
    let wrong_type = terminal_psi::StructuralAffineDiscard {
    ...
    let terminal_psi::StructuralTypeShape::FixedArray { length, .. } = &mut wrong_length[0].shape
    else {
        unreachable!()
    };
    *length = 3;
...
fn two_nominal_one_executable_plan(
    ...
    let actions = match executable_action_ordinal {
        0 => vec![
            terminal_psi::TerminalAffineCleanupAction::InvokeNominal(cleanup_for(
                second_place,
                cleanup_machine,
            )),
            terminal_psi::TerminalAffineCleanupAction::InvokeNominal(cleanup_for(
...
fn two_nominal_cleanups_emit_the_exact_executable_action_owner() {
    for target in [NativeTarget::linux_x64(), NativeTarget::linux_arm64()] {
        ...
        let terminal_psi::TerminalAffineCleanupAction::InvokeNominal(second) =
...
fn x86_unit_call_port_write_and_settlement_keep_exact_order() {
    ...
    let mut expected = x86_encoding::encode_immediate_port_write(0x20, 0x20).to_vec();
    expected.push(0xc3);
    ...
    assert_eq!(
        ...
        machine_code::BoundaryExecutionRecord::AdmittedProvider(provider_execution.into())
    );
...
fn forty_byte_unit_argument_is_copied_for_sysv_and_forwarded_indirectly_elsewhere() {
    for (target, expected_length, expected_relocation) in [
        ...
        let shape = calling_conventions::ValueShape::integer(40, 8);
        let call_plan = evaluate_call_plan(
            CallingPolicy::native_for_target(target),
            &CallSignature {
...
fn aarch64_unit_calls_cover_stack_fragments_and_stack_indirect_copies() {
    for final_shape in [
        ...
        calling_conventions::ValueShape::integer(24, 16),
    ] {
        let target = NativeTarget::linux_arm64();
...
fn unit_argument_fragments_cover_native_scalar_widths() {
    for target in [
        ...
        for byte_size in [1_u16, 2, 4, 8, 12, 16] {
            ...
            let shape = calling_conventions::ValueShape::integer(byte_size, alignment);
            let call_plan = evaluate_call_plan(
                CallingPolicy::native_for_target(target),
                &CallSignature {
                    parameters: vec![shape],
...
fn mutable_scalar_store_return_plan(
    ...
    let store = TargetScalarStructuralFieldStore {
        ...
        path: projected_store
            .then(|| terminal_psi::StructuralPathSegment::Field("flags".into()))
            .into_iter()
            .collect(),
        field,
                            ...
                            shape: StructuralTypeShape::Record {
                                fields: vec![
                                    ...
                                    terminal_psi::StructuralFieldDeclaration {
                                        ...
                                        identity: "flags".into(),
                                        relevance: terminal_psi::BindingRelevance::Relevant,
                                        field_type: terminal_psi::StructuralFieldType::Structural(
                    ...
                    vec![StructuralTypeDeclaration {
                        ...
                        shape: StructuralTypeShape::Record {
                            fields: if boolean_store {
                                ...
                                vec![terminal_psi::StructuralFieldDeclaration {
                                    id: field,
                                    identity: "value".into(),
                                    relevance: terminal_psi::BindingRelevance::Relevant,
                                    field_type: terminal_psi::StructuralFieldType::Scalar(
...
fn mutable_two_scalar_store_return_plan(target: NativeTarget) -> TargetOperationPlan {
    ...
    second.immediate = target_operations::TargetScalarImmediate::Integer {
...
fn rejects_repeated_scalar_store_destination_before_assignment() {
    ...
    assert!(matches!(
        ...
        Err(target_operations_to_assigned_target_operations::AssignmentError::StructuralScalarFieldStoreCustodyMismatch { .. })
    ));
}
...
fn rejects_projected_scalar_store_path_or_accumulated_offset_drift_before_emission() {
    ...
    rejects(plan.clone(), |store| {
        store.path[0] = terminal_psi::StructuralPathSegment::Field("missing".into());
    });
    rejects(plan.clone(), |store| {
        store.path.push(terminal_psi::StructuralPathSegment::Field(
            "too-deep".into(),
        ));
    });
    rejects(plan, |store| {
        store.path[0] = terminal_psi::StructuralPathSegment::FixedIndex(0);
    });
}
