...
use isa_x86_64::resolve_x86_64_structural_unit_internal_call;
use machine_code::StructuralUnitCallFragmentSpan;
use machine_code::{
...
use selected_instructions::{SelectedBlockId, SelectedStructuralUnitCallInstruction};
