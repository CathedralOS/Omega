...
#[cfg(test)]
use assigned_target_operations::AssignedBooleanControl;
...
use semantic_vocabulary::{IntegerType, MachineId, ValueId};
...
fn assigned_direct_scalar_type(
    ...
    match operation {
        ...
        | AssignedOperation::ReturnIntegerExpression { scalar_type, .. } => {
            Some(semantic_vocabulary::ScalarType::Integer(*scalar_type))
        }
...
fn retained_scalar_cleanup_abi_matches(
    operation: &AssignedOperation,
    row: &target_operations::MixedStructuralScalarFunctionAbi,
) -> bool {
    match operation {
...
fn callback_destination(
    destination: assigned_target_operations::AssignedCallDestination,
) -> machine_code::CallbackAddressDestination {
    match destination {
...
fn emit_function(
    ...
    let bytes = match &function.operation {
        ...
        AssignedOperation::ReturnBoundaryPortReadU8 {
            ...
            scalar_stack_eligible = true;
            let mut bytes = x86_encoding::encode_immediate_port_read_u8(realization.port).to_vec();
            ...
            boundary_settlements.push(BoundarySettlementRecord {
                ...
                boundary: *boundary,
                execution,
                realization: target_operations::BoundaryRealization::DirectPortReadU8(*realization),
        ...
        AssignedOperation::ExitProcessI32 {
            ...
            let value = match (argument.scalar_type, argument.immediate) {
                ...
                ) if actual == i32_type => i32::try_from(value)
            ...
            let bytes = match architecture {
                Architecture::X86_64 => isa_x86_64::encode_linux_exit_group_i32(value),
            ...
            boundary_settlements.push(BoundarySettlementRecord {
                ...
                boundary: *boundary,
                execution,
                realization: target_operations::BoundaryRealization::LinuxExitGroupI32(
                    *realization,
                ),
...
pub enum EmissionError {
    ...
    InvalidUnitScalarCallCustody(semantic_vocabulary::OperationId),
    InvalidUnitBooleanConstantCustody(semantic_vocabulary::OperationId),
    InvalidInstalledProviderScalarCallCustody(semantic_vocabulary::OperationId),
    InvalidWriteOnlyPrimitiveStoreCustody(semantic_vocabulary::OperationId),
    InvalidStructuralScalarFieldStoreCustody(semantic_vocabulary::OperationId),
    EmptyStructuralScalarFieldStores(semantic_vocabulary::MachineId),
    InvalidStructuralScalarCallCustody(semantic_vocabulary::OperationId),
    InvalidMixedStructuralScalarFunctionAbi(MachineId),
    InvalidDynamicDescriptorCallCustody(semantic_vocabulary::OperationId),
    InvalidStoredDynamicDescriptorCustody(semantic_vocabulary::OperationId),
    InvalidStoredDynamicCallCustody(semantic_vocabulary::OperationId),
    InvalidDynamicCallCustody(semantic_vocabulary::OperationId),
    InvalidDynamicParameterCallCustody(semantic_vocabulary::OperationId),
    ...
    MissingUnitParameterHome(semantic_vocabulary::PlaceId),
    UnitParameterHomeMismatch(semantic_vocabulary::PlaceId),
    UnsupportedUnitRegister(MachineRegister),
    UnsupportedStructuralReturnPlacement(semantic_vocabulary::PlaceId),
    ...
    LinuxExitGroupArgumentMismatch(semantic_vocabulary::BoundaryMachineId),
    LinuxExitGroupEncoding,
    InvalidLinuxReadByteCustody(semantic_vocabulary::BoundaryMachineId),
    ...
    InvalidIeeeFloatFmaCustody(semantic_vocabulary::OperationId),
