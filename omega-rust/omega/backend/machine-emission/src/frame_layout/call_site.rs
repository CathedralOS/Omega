...
use crate::frame_layout::{FrameAbiPreservationConvention, ValidatedTargetRegisterEnvironment};
...
pub(super) fn call_site_stack_contract(
    ...
    let stack_alignment_bytes = register_environment::selected_abi_preservation(environment)
        .ok()?
        .convention
        .stack_alignment;
...
mod tests {
    ...
    use crate::frame_layout::FrameAbiPreservationConvention;
