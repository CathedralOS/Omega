...
fn plural_depth_seventeen_paths_compose_depth_sixteen_custody_and_retain_fences() {
    ...
    let carrier = build_time_evaluation::validate_const_materializable_record_with_depth_seventeen_nested_sums(
        &checked,
        "Outer",
        &paths,
        &value,
    ...
    let big_endian = build_time_evaluation::validate_const_materializable_record_with_depth_seventeen_nested_sums(
        &checked,
        "Outer",
        &paths,
        &value,
    ...
    let rejects = |mutated: &layout_plans::ConventionalDepthSeventeenRecordSumPathsLayoutReport| {
        assert!(
            carrier
    ...
    assert!(
        build_time_evaluation::validate_const_materializable_record_with_depth_seventeen_nested_sums(
            &recursive_checked,
            "Outer",
            &paths,
            &value,
