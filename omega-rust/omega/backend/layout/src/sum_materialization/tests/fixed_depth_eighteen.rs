...
fn plural_depth_eighteen_paths_compose_depth_seventeen_custody_and_retain_fences() {
    ...
    let carrier = build_time_evaluation::validate_const_materializable_record_with_depth_eighteen_nested_sums(
        &checked,
        "Outer",
        &paths,
        &value,
    ...
    let big_endian = build_time_evaluation::validate_const_materializable_record_with_depth_eighteen_nested_sums(
        &checked,
        "Outer",
        &paths,
        &value,
    ...
    let rejects = |mutated: &layout_plans::ConventionalDepthEighteenRecordSumPathsLayoutReport| {
        assert!(
            carrier
    ...
    assert!(
        build_time_evaluation::validate_const_materializable_record_with_depth_eighteen_nested_sums(
            &recursive_checked,
            "Outer",
            &paths,
            &value,
