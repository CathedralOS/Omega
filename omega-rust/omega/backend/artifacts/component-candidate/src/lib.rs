...
pub struct ComponentCandidate {
    ...
    stack_demand: image_emission::StackDemand,
}
...
pub struct ComponentCandidateParts {
    ...
    pub component_progress: Option<effects::ComponentProgressManifest>,
    pub stack_demand: image_emission::StackDemand,
}
...
impl ComponentCandidate {
    ...
    pub const fn stack_demand(&self) -> &image_emission::StackDemand {
        &self.stack_demand
    }
...
fn validate_terminal_component_stack_demand(
    native_artifact: &NativeArtifact,
    supplied: &image_emission::StackDemand,
) -> Result<(), &'static str> {
    let expected = image_emission::derive_stack_demand(
