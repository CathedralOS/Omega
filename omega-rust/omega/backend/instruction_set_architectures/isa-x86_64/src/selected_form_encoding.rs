use calling_conventions::{CallingPolicy, EntryControl, MachineRegister};
use register_model::{
...
fn validate_structural_unit_call_request(
    ...
    let expected_layout = selected_instructions::SelectedMicrosoftX64OwnedIndirectPairLayout {
...
#[cfg(test)]
mod tests {
    use calling_conventions::{CallPlan, RegisterSet};
    use optimization_core::AcceptedObligationFactIdentity;
    use optimization_unit::EffectLink;
    use register_model::{ValidatedRegisterConstraintCatalog, validate_physical_register_model};
    ...
    fn structural_layout() -> selected_instructions::SelectedMicrosoftX64OwnedIndirectPairLayout {
        selected_instructions::SelectedMicrosoftX64OwnedIndirectPairLayout {
            shadow_byte_count: 32,
            outgoing_frame_byte_count: 72,
            pre_call_stack_alignment: 16,
            bindings: [
    ...
    fn structural_fixture() -> (
        ...
        let call = SelectedStructuralUnitCallInstruction {
            id: selected_instructions::SelectedInstructionId(0),
            source: selected_instructions::SelectedStructuralUnitCallSource::AuthoredCallUnit,
