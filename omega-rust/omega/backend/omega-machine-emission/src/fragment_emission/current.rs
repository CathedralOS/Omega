...
pub(super) struct CurrentFunctionFragmentInput {
    ...
    pub(super) machine: omega_register_homes_to_post_allocation_machine::StagedOptimizedPostAllocationMachinePlan,
    pub(super) layout: omega_selected_form_encoding_to_resolved_layout::StagedOptimizedResolvedSelectedFormLayout,
    ...
    pub(super) target_input: Arc<omega_abstract_operations_to_target_operations::ValidatedOptimizedTargetOperations>,
