...
fn exit_custody_matches(
    ...
    custody: omega_machine_code::WholeFunctionExitLayoutCustody,
) -> bool {
    match custody {
        omega_machine_code::WholeFunctionExitLayoutCustody::PostAllocationMachineOptimizationV1 {
            optimization,
            artifact_identity,
        } => {
        ...
        omega_machine_code::WholeFunctionExitLayoutCustody::Aarch64FuseCompareI64ZeroBranchNonZeroToCbnzV1 {
            fusion,
        } => {
        ...
        omega_machine_code::WholeFunctionExitLayoutCustody::Aarch64SelectShortestMovnSeededI64MaterializationV1 {
            materialization,
        } => {
            normalized.optimization()
        ...
        omega_machine_code::WholeFunctionExitLayoutCustody::BaselineNearLayoutV1
        | omega_machine_code::WholeFunctionExitLayoutCustody::X86RelaxConditionalBranchesToRel8V1 { .. } => {
            false
        }
    }
}
