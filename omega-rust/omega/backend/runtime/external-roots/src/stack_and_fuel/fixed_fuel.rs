...
pub struct InstalledEntryFuelCertificate {
    certificate: terminal_fixed_fuel::FixedEntryFuelCertificate,
...
impl InstalledEntryFuelCertificate {
    pub const fn certificate(&self) -> &terminal_fixed_fuel::FixedEntryFuelCertificate {
        &self.certificate
    }
...
pub struct InstalledSegmentFuelCertificate {
    certificate: terminal_fixed_fuel::FixedSegmentFuelCertificate,
    installed_code: InstalledCodeId,
    installed_code_context: InstalledCodeContext,
    artifact: ArtifactId,
    entry: EntryStubId,
...
pub struct InstalledSegmentFuelCatalog {
    segments: terminal_fixed_fuel::ValidatedFixedSafePointFuelSegments,
    installed_code: InstalledCodeId,
    installed_code_context: InstalledCodeContext,
    artifact: ArtifactId,
    entry: EntryStubId,
...
impl InstalledSegmentFuelCatalog {
    ...
    pub fn segments(&self) -> &[terminal_fixed_fuel::FixedSegmentFuelCertificate] {
...
impl InstalledSegmentFuelCertificate {
    pub const fn certificate(&self) -> &terminal_fixed_fuel::FixedSegmentFuelCertificate {
        &self.certificate
    }
