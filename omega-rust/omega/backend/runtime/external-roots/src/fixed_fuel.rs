...
pub struct InstalledRankedCountdownSafePointFuelCatalog {
    segments: terminal_fixed_fuel::ValidatedRankedCountdownSafePointFuelSegments,
    installed_code: InstalledCodeId,
    installed_code_context: InstalledCodeContext,
    artifact: ArtifactId,
    entry: EntryStubId,
...
impl InstalledRankedCountdownSafePointFuelCatalog {
    ...
    pub fn segments(&self) -> &[terminal_fixed_fuel::RankedCountdownSafePointFuelCertificate] {
