...
use calling_conventions::{BoundaryEntryPlan, EntryControl, ValuePlacement};
#[cfg(test)]
...
use executable_installation::{InstallationRegistryAuthority, InstalledCode, InstalledCodeContext};
...
pub struct InstalledInterruptCompletionRoute {
    ...
    resolution: effects::InstallationReachResolution,
    entry_receipt: InterruptEntryReceiptId,
    invocation: InterruptInvocationId,
    policy: AcknowledgementPolicyId,
...
pub struct InstalledRootLedger {
    ...
    admitted_progress_invocations: BTreeMap<
        ...
        ProgressProfileEstablishmentReceiptId,
    >,
    accepted_component_progress: Vec<effects::ComponentProgressManifest>,
