...
fn terminal_image(
    ...
    let bytes = isa_x86_64::encode_linux_exit_group_i32(0);
            ...
            boundary_settlements: vec![
                ...
                BoundarySettlementRecord {
                    ...
                    scalar_arguments: vec![BoundaryScalarArgument {
                        source_value: semantic_vocabulary::ValueId::new(1).expect("value"),
                        scalar_type,
                        immediate: semantic_vocabulary::IntegerValue::Signed(0),
    ...
    let assigned_private =
        target_operations_to_assigned_target_operations::assign_registers(&private_plan)
            .expect("private callback register assignment");
    let private_machine = machine_emission::emit_machine_code(&assigned_private)
    ...
    ExternalRootCandidate {
        ...
        logical_fuel: LogicalFuelResourceColumn {
            ...
            validation_receipt: root_id(
                751,
                external_roots::FuelValidationReceiptId::from_normalized_identity,
            ),
        },
        machine_state: MachineStateResourceColumn {
            ...
            validation_receipt: root_id(
                752,
                external_roots::StateValidationReceiptId::from_normalized_identity,
            ),
        },
