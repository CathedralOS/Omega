...
fn render_operations(operations: &[Operation]) -> String {
    ...
    writeln!(
        generated,
        "    #[cfg(test)]\n    pub(in crate::checked_interpreter::interpreter::evaluator) const ALL: [Self; {}] = [",
        operations.len()
    )
    .unwrap();
    ...
    generated.push_str(
        "    pub(in crate::checked_interpreter::interpreter::evaluator) fn from_canonical_name(name: &str) -> Option<Self> {\n        Some(match name {\n",
    );
    for operation in operations {
        writeln!(
            generated,
    ...
    generated.push_str(
        "    pub(in crate::checked_interpreter::interpreter::evaluator) const fn operation_tag(self) -> u16 {\n        self as u16\n    }\n\n",
    );

    generated.push_str(
        "    pub(in crate::checked_interpreter::interpreter::evaluator) const fn operand_kinds(self) -> &'static [FilesystemHostOperandKind] {\n        use FilesystemHostOperandKind as K;\n        match self {\n",
    );
    for operation in operations {
    ...
    generated.push_str(
        "    pub(in crate::checked_interpreter::interpreter::evaluator) const fn result_kind(self) -> FilesystemHostResultKind {\n        use FilesystemHostResultKind as R;\n        match self {\n",
    );
    for operation in operations {
        writeln!(
            generated,
    ...
    generated.push_str(
        "    pub(in crate::checked_interpreter::interpreter::evaluator) const fn canonical_name(self) -> &'static str {\n        match self {\n",
    );
    for operation in operations {
        writeln!(
            generated,
