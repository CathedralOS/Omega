// Current encoded rows and their evidence; constructing data grants no admission.
...
pub struct SelectedFormMachineOptimizationCustody {
    ...
    pub fusion: Aarch64CbnzFusionIdentity,
}
...
pub struct SelectedFormMovnOptimizationCustody {
    pub selections: OptimizationSelectionIdentity,
    pub post_allocation_machine_selections: OptimizationSelectionIdentity,
    pub materialization: Aarch64MovnMaterializationIdentity,
}
...
pub struct SelectedFormEncoding {
    ...
    pub rows: std::sync::Arc<Vec<SelectedFormEncodingRow>>,
    pub structural_unit_functions: std::sync::Arc<Vec<SelectedStructuralUnitFunctionEncoding>>,
