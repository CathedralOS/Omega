...
pub struct DynamicInstanceMaterializationRecord {
    ...
    pub source: target_operations::TargetStructuralArgument,
...
pub enum DynamicParameterCallMechanismRecord {
    X86MemoryIndirect {
        table: target_operations::MachineRegister,
    },
    Aarch64LoadedIndirect {
        table: target_operations::MachineRegister,
        target: target_operations::MachineRegister,
    },
}
...
pub struct DynamicParameterCallRecord {
    ...
    pub instance: target_operations::MachineRegister,
    pub table: target_operations::MachineRegister,
...
pub struct ForwardedDynamicParameterCallRecord {
    ...
    pub instance: target_operations::MachineRegister,
    pub table: target_operations::MachineRegister,
    pub instance_destination: target_operations::MachineRegister,
    pub table_destination: target_operations::MachineRegister,
...
pub struct ForwardedDynamicDescriptorArgumentRecord {
    ...
    pub instance: target_operations::TargetDynamicDescriptorInstanceArgument,
    pub instance_destination: target_operations::MachineRegister,
    pub table_destination: target_operations::MachineRegister,
    pub source_home_byte_offset: u32,
    pub source_home_indirect: bool,
