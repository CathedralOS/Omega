...
pub(in crate::register_homes::recovery::fixed_view_copy::codec::selected) fn encode_semantic_argument(
    bytes: &mut Vec<u8>,
...
pub(in crate::register_homes::recovery::fixed_view_copy::codec::selected) fn decode_semantic_argument(
    cursor: &mut Cursor<'_>,
