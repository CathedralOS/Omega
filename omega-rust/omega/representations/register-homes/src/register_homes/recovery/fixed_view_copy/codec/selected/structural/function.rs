...
pub(in crate::register_homes::recovery::fixed_view_copy::codec::selected) fn decode_local_slot(
    cursor: &mut Cursor<'_>,
...
pub(in crate::register_homes::recovery::fixed_view_copy::codec::selected) fn encode_contracts(
    bytes: &mut Vec<u8>,
...
pub(in crate::register_homes::recovery::fixed_view_copy::codec::selected) fn decode_contracts(
    cursor: &mut Cursor<'_>,
    ...
    for _ in 0..count {
        ...
        let role = match cursor.byte()? {
            ...
            10 => SelectedMemoryAccessRole::ReadElementView {
                index: decode_id(cursor, semantic_vocabulary::ValueId::new)?,
                length: decode_id(cursor, semantic_vocabulary::ValueId::new)?,
                obligation: decode_id(cursor, semantic_vocabulary::ObligationId::new)?,
                accepted_fact: optimization_core::AcceptedObligationFactIdentity::from_bytes(
...
mod local_slot_tests {
    ...
    use crate::register_homes::recovery::fixed_view_copy::codec::selected::structural::decode_contracts;
    use crate::register_homes::recovery::fixed_view_copy::codec::selected::structural::decode_local_slot;
