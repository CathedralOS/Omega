...
mod tests {
    ...
    use crate::register_homes::recovery::fixed_view_copy::codec::selected::register::decode_register;
    use crate::register_homes::recovery::fixed_view_copy::codec::selected::register::encode_register;
