...
pub use register_homes::{
    ...
    classification, codec, constraints, fixed_precolored_interval_plan_identity,
    fixed_precolored_intervals, fixed_precolored_segment_home_plan_identity,
    fixed_precolored_segment_homes, fixed_precolored_split_requirement_plan_identity,
    fixed_precolored_split_requirements, fixed_view_copy, fixed_view_copy_identity, identity,
    logical_spill_operation_identity, logical_spill_operations, post_allocation_manifest,
    preservation, recovery, recovery_classification_identity, register_home_identity, spill_choice,
    spill_choice_identity, stack_slot_coloring, stack_slot_coloring_identity, storage, view,
};
