...
- Determinism and bounded-work evidence: `omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/pass_manager/tests/evidence_matrix/dead_pure_scalar_elimination.rs::repeated_runs_are_deterministic` and `omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/pass_manager/tests/evidence_matrix/dead_pure_scalar_elimination.rs::measured_budget_admits_exact_usage_and_refuses_one_less`
