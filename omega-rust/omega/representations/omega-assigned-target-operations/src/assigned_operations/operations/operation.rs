//! operations operation in the assigned operations program.

use crate::AssignedAggregateCopy;
use crate::AssignedBooleanControl;
...
use omega_target_operations::BoundaryExecutionBinding;
use omega_target_operations::BoundaryScalarArgument;
use omega_target_operations::CompletionClaimSource;
use omega_target_operations::DirectPortReadU8Realization;
use omega_target_operations::LinuxExitGroupI32Realization;
use omega_target_operations::MachineRegister;
use omega_target_operations::TargetStructuralParameter;
...
use psi_terminal::StructuralResultClaimTransfer;
use psi_terminal::StructuralResultDeclaration;
use psi_terminal::StructuralTypeDeclaration;
use psi_terminal::TerminalAffineCleanupAction;
use psi_terminal::TerminalDynamicDescriptorParameter;
use psi_terminal::TerminalDynamicRequirement;
...
pub enum AssignedOperation {
    ...
    ReturnForwardedDynamicParameterScalarCall {
        ...
        scalar_type: ScalarType,
        callee: MachineId,
        argument: omega_target_operations::AbstractDynamicDescriptorArgument,
        parameter_abi: AssignedDynamicDescriptorParameterAbi,
        instance_destination: MachineRegister,
        table_destination: MachineRegister,
        function_call_plan: CallPlan,
