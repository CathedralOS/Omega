...
use target_operations::BoundaryExecutionBinding;
use target_operations::BoundaryScalarArgument;
use target_operations::CompletionClaimSource;
use target_operations::DirectPortReadU8Realization;
use target_operations::LinuxExitGroupI32Realization;
...
use terminal_psi::TerminalDynamicDescriptorParameter;
use terminal_psi::TerminalDynamicRequirement;
...
pub enum AssignedOperation {
    ...
    ReturnForwardedDynamicParameterScalarCall {
        ...
        scalar_type: ScalarType,
        callee: MachineId,
        argument: target_operations::AbstractDynamicDescriptorArgument,
        parameter_abi: AssignedDynamicDescriptorParameterAbi,
    ...
    ScalarReturnAfterStructuralScalarFieldStores {
        stores: Vec<target_operations::TargetScalarStructuralFieldStore>,
        scalar: Box<AssignedOperation>,
        structural_types: Vec<StructuralTypeDeclaration>,
        call_plan: CallPlan,
        structural_parameters: Vec<TargetStructuralParameter>,
