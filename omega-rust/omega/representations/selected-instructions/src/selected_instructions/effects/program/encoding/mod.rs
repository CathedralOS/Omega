...
pub use v6::{
    ...
    decode_alternative_without_scalar_call, decode_effect_link, decode_ownership,
    decode_provenance, decode_target, decode_terminal_pre_allocation_machine_effect_plan,
