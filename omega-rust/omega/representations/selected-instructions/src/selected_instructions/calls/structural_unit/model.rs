...
use semantic_vocabulary::{BlockId, EdgeId, MachineId, ObligationId, OperationId, ServiceId};
use target_operations::{MachineRegister, TerminalPsiProvenance};
use terminal_psi::{
...
pub type SelectedBoundarySettlement = legalized_operations::LegalizedBoundarySettlement;
...
pub struct SelectedStructuralUnitCallArgument {
    pub semantic: terminal_psi::StructuralArgument,
...
pub use legalized_operations::LegalizedCallUnitSource as SelectedStructuralUnitCallSource;
