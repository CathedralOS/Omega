...
pub use selected_instructions::{
    ...
    MachineSizeKnowledge, MachineTrapBehavior, OperandPosition, OutgoingArgumentSlotId,
    OutgoingArgumentSlotRole, PackedByteWidth, PreAllocationMachineEffectDecodeError,
    PreAllocationMachineEffectIdentity, PreAllocationMachineEffectPlan,
    PressureRematerializationIdentity, SaturatingCarrier, SaturatingOperation, SelectedBlock,
    SelectedBlockId, SelectedBlockOrigin, SelectedBoundarySettlement,
    SelectedBoundarySettlementPayload, SelectedCallContract, SelectedCasePayloadBinding,
    ...
    SelectedValueTransport, SuccessorLiveness, ValidatedMachineEffectCatalog,
