...
pub use selected_instructions::{
    ...
    SelectedCallContract, SelectedCaseDispatchSource, SelectedCasePayloadBinding,
    SelectedCasePayloadTransport, SelectedConstraintKeys, SelectedFixedInputConstraint,
    SelectedFunction, SelectedFunctions, SelectedInstruction, SelectedInstructionId,
    ...
    SelectedMemoryAccessOrigin, SelectedMemoryAccessRole, SelectedNormalizedForeignCall,
    SelectedOperand, SelectedOutgoingArgumentSlot, SelectedSelectionConstraints,
    ...
    SelectedValueTransport, SuccessorLiveness, TrappingForm, TrappingOperation,
    ValidatedMachineEffectCatalog, VirtualFixedConstraint, VirtualFixedConstraintSite,
    VirtualInterference, VirtualLiveRange, VirtualOccurrence, VirtualRegister, VirtualRegisterId,
    VirtualRegisterOrigin, alternative_family_tag, calls, constraints, control_flow, effects,
    encode_machine_alternative_identity, encode_machine_alternative_key_identity,
    encode_machine_encoded_effects_identity, identity, instructions, live_range_identity,
    live_ranges, liveness, liveness_identity, machine_effect_catalog_identity, plan_identity,
    pre_allocation_machine_effect_identity, provenance, saturating_family_tag,
    selected_instruction_plan_identity, structural_case, trapping_family_tag,
