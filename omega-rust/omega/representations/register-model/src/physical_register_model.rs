//! The physical register model: units, views, classes and the preservation
//! convention one architecture declares, and the validator that seals it.

use crate::identities;
use crate::identities::PhysicalRegisterModelIdentity;
use crate::{
