...
pub use legalized_operations::{
    ...
    LegalizedOperationPlanIdentity, LegalizedScalarArgument, LegalizedScalarBlock,
    LegalizedScalarCall, LegalizedScalarCallShapeError, LegalizedScalarComparison,
    ...
    LegalizedStructuralCaseSource, LegalizedStructuralCaseSuccessor, LegalizedStructuralContract,
    LegalizedValueDefinition, NativeCallOrigin, SaturatingCarrier, SaturatingOperation, calls,
    control_flow, encode_hosted_read_byte_identity, identity, legality,
