...
use checked_interpreter::{EvaluationUsage, MeasuredBuildMachineEvaluation};
...
pub(super) fn evaluate_admitted_machine(
    ...
    let product_entry_compatibility = crate::admission::selection::ProductEntryQueryCompatibility;
