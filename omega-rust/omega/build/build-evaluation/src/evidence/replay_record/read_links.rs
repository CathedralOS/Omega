...
pub(super) fn validate_source_read_link_shape(
    ...
    let [
        (
            count_ordinal,
            crate::evidence::replay_record::attempt_codec::ShapeScalar::U64(requested_count),
        ),
...
> {
    let [(_, crate::evidence::replay_record::attempt_codec::ShapeScalar::U64(requested_count))] =
        attempt.scalars.as_slice()
    else {
