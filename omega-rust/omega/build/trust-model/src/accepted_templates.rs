...
impl AcceptedTemplateIdentity {
    ...
    pub const fn commitment(self) -> typed_trees::typed_trees::MachineTemplateCommitment {
        self.commitment
    }
}
            ...
            rows: typed
                ...
                .map(|machine| {
                    let report_fingerprint =
                        typed_trees_to_checked_trees::generic_machine_template_report_fingerprint(
                            typed,
                            machine.symbol,
                        );
                    let commitment =
                        typed_trees_to_checked_trees::generic_machine_template_commitment(
                            typed,
                            machine.symbol,
                        );
...
mod tests {
    ...
    fn capture_retains_only_accepted_machine_templates() {
        ...
        let mut generic_accepted = typed_trees::machine::Machine {
            symbol: first,
        ...
        typed.push_machine_type_parameter(
            ...
            typed_trees::data::TypeParameter {
                symbol: binder,
                name: typed_trees::name::Identifier::generated("T"),
                ..Default::default()
            },
        );
        ...
        for (symbol, supply_mode) in [
            ...
            typed.push_machine(typed_trees::machine::Machine {
                symbol,
                supply_mode,
                ..Default::default()
            });
        ...
        let first_commitment =
            typed_trees_to_checked_trees::generic_machine_template_commitment(&typed, first)
