...
pub(super) fn rehydrate_exact_single_failure_shape(
    source_input: Option<psi_checked_interpreter::FilesystemSourceInputReplayRecord>,
    ...
    if shape.operation == 10 {
        ...
        let record = psi_checked_interpreter::FilesystemInputUnknownDescriptorSeekReplayRecord::new(
            source_input,
            *offset,
            *whence,
        );
    ...
    if shape.operation == 31 {
        ...
        let record = psi_checked_interpreter::FilesystemInputUnknownNativeHandleFinalPathNameByHandleReplayRecord::new(
            source_input,
            clone_bytes(buffer)?,
            *capacity,
            *flags,
    ...
    psi_checked_interpreter::FilesystemReplay::from_input_unknown_native_handle_mutation_record(
        record,
    )
    .map_err(|_| {
        BuildFilesystemReplayRecordError::new(
