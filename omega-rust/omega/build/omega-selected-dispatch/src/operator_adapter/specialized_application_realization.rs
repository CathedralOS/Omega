...
pub struct CheckedSpecializedOperatorApplicationRealization {
    ...
    pub specialization_commitment: psi_typed_trees::typed_trees::MachineSpecializationCommitment,
...
fn derive_one(
    ...
    let replayed = psi_validation::recompute_checked_machine_specialization_commitment(
        checked,
        realization_machine,
    )
    .map_err(|error| {
...
pub(super) fn applications_match(
    checked: &CheckedTrees,
    demand_row: &psi_checked_trees::CheckedBoundaryOperatorApplicationDemand,
