use super::*;
use psi_symbols::{Symbol, SymbolKind};
...
pub(super) struct Snapshot {
    ...
    declaration: Symbol,
    name: String,
    source_span: Option<psi_source::SourceSpan>,
...
pub(super) fn capture(
    ...
    symbol_identity.children = psi_arena::HandleSpan::empty();
    ...
    match declaration.kind {
        ...
        SymbolKind::Operator => {
            let operator = psi_typed_trees::operator::declaration_by_symbol(program, symbol)
