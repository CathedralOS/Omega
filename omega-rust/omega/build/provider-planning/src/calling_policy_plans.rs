...
pub struct BoundaryNativeParameter {
    ...
    layout_data_symbol: symbols::SymbolHandle,
}
...
fn find_policy_machine<'a>(
    typed: &'a TypedTrees,
    policy_type: &str,
) -> Option<&'a typed_trees::machine::Machine> {
...
fn collect_boundary_signatures<'a>(
    typed: &'a TypedTrees,
    definition: &'a typed_trees::trait_definition::TraitDefinition,
...
mod tests {
    ...
    fn test_opaque_representation_use(shape_root: u16) -> BoundaryOpaqueRepresentationUse {
        ...
        BoundaryOpaqueRepresentationUse {
            ...
            selected_application_commitment:
                representation_planning::selected_application_commitment(
                    conformance_application_commitment,
                    lifecycle,
                    copy_disposition,
                    origin,
    ...
    fn nominal_callback_placement_rejects_missing_or_drifting_plan() {
        ...
        let substituted_contract =
            checked_trees::MachineContractCommitment::from_digest([0x6a; 32]);
    ...
    fn callback_closure_reconciliation_requires_the_preclosure_strong_commitment() {
        ...
        let substituted_old =
            typed_trees::typed_trees::BoundaryCallingPlanCommitment::from_digest([0x5a; 32]);
        let closed =
            typed_trees::typed_trees::BoundaryCallingPlanCommitment::from_digest([0x6b; 32]);
