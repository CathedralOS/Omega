...
pub struct BoundaryOpaqueRepresentationUse {
    ...
    pub(super) origin: representation_planning::OpaqueRepresentationApplicationOrigin,
    pub(super) lifecycle: representation_planning::OpaqueRepresentationLifecycleDisposition,
    pub(super) copy_disposition: representation_planning::OpaqueRepresentationCopyDisposition,
...
impl BoundaryOpaqueRepresentationUse {
    ...
    pub const fn origin(&self) -> representation_planning::OpaqueRepresentationApplicationOrigin {
        self.origin
    }

    pub const fn lifecycle(
        &self,
    ) -> representation_planning::OpaqueRepresentationLifecycleDisposition {
        self.lifecycle
    }

    pub const fn copy_disposition(
        &self,
    ) -> representation_planning::OpaqueRepresentationCopyDisposition {
...
pub struct BoundaryOpaqueRepresentationMovement {
    ...
    pub(super) placement: calling_conventions::ValuePlacement,
}
...
impl BoundaryOpaqueRepresentationMovement {
    ...
    pub const fn placement(&self) -> &calling_conventions::ValuePlacement {
        &self.placement
    }
