...
use omega::compiler::{CheckedCompileRequest, compile_to_checked};
...
use tokens_to_syntax_trees::syntax_trees::expression::{ExpressionHandle, ExpressionNode};
...
pub fn repo_root() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR"))
        .ancestors()
        .nth(2)
        .expect("compiler crate should live under omega-rust/omega/src/compiler")
        .to_path_buf()
}
...
fn dangerous_service_bindings(
    preliminary: &omega::compiler::CheckedCompilation,
