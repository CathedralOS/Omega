    ...
    let mut permissions = plan
        ...
        .map(|method| {
            abstract_operations_to_target_operations::effects::ServiceTerminalAuthorityPermission::new(
                ...
                abstract_operations_to_target_operations::effects::TerminalAuthorityDisposition::from_classes(match method.name.as_str() {
                    "exit_process" => {
                        vec![abstract_operations_to_target_operations::effects::TerminalAuthorityClass::ProcessTermination]
                    }
                    "write" | "write_byte" | "write_line" => {
                        vec![abstract_operations_to_target_operations::effects::TerminalAuthorityClass::ProcessOutput]
                    }
                    "read_byte" | "read_line" => {
                        vec![abstract_operations_to_target_operations::effects::TerminalAuthorityClass::ProcessInput]
                    }
