...
"#,
    ...
    orphan_ref
        ...
        .semantic
        .refs
        .append(typed_trees_to_checked_trees::fact_plan::FactRef {
            fact: semantic_fact,
        });
    ...
    malformed_extra_context.facts.semantic.contexts.append(
        typed_trees_to_checked_trees::fact_plan::FactContext {
    ...
    let context = missing_context
        ...
        .find_map(|(handle, context)| {
            matches!(context.point, typed_trees_to_checked_trees::fact_plan::ProgramPoint::Definition { symbol } if symbol == data_symbol)
                .then_some(handle)
        })
        .or_else(|| {
            missing_context
