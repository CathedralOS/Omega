...
"#;
    ...
    let symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::ClosedConformanceConstArgument::Evaluated {
        declared_carrier,
        ..
    } = &mut carrier_drift
        .facts
...
"#,
    ...
    let retained = &mut checked
        ...
        .application
        .const_arguments[0];
    let symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::ClosedConformanceConstArgument::Evaluated { value, .. } =
        retained
    else {
