...
const SOURCE: &str =
    include_str!("../../../../../tests/omega/pass/effects/nominal_callback_dependency/main.omg");
...
"#,
    ...
    let original = typed_trees_to_checked_trees::validation::infer_service_reaches(
        &fixture.checked,
        &typed_trees_to_checked_trees::validation::infer_operational_may(&fixture.checked),
    );
    let replay = typed_trees_to_checked_trees::validation::infer_service_reaches(
        &changed,
        &typed_trees_to_checked_trees::validation::infer_operational_may(&changed),
    );
    assert_eq!(
        original
            .rows
