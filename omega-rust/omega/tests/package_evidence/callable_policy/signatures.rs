...
"#;
    ...
    let quiet_supply = omega::package_evidence::project_checked_external_supply_policy(
        &quiet.checked,
        quiet
            .checked
            .machines()
    ...
    .unwrap();
    let published_supply = omega::package_evidence::project_checked_external_supply_policy(
        &published.checked,
        published
            .checked
            .machines()
