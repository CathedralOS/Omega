...
"#,
    ...
    for source in toolchain_sources {
        ...
        assert_eq!(
            retained,
            omega::package_compilation::toolchain_source_identity_digest(source).unwrap()
        );
    }
...
"#,
    ...
    let accepted = omega::package_compilation::AcceptedSemanticBinding::new(
        omega::package_compilation::AcceptedSemanticBindingRole::ConsoleExitProcessI32,
        console_package,
        candidate
            .typed
            .symbols
