...
"#,
    ...
    assert_eq!(
        stand_down.reason,
        typed_trees_to_checked_trees::validation::ContractEntailmentStandDownReason::UnrecognizedInductiveBody
    );
...
"#,
    ...
    let fresh = omega::package_evidence::ledger::reconstruct_package_review(&checked)
    ...
    omega::package_evidence::ledger::validate_ordinary_package_obligation_results(
        &results, &checked,
    )
    ...
    omega::package_evidence::ledger::ordinary_package_obligation_results_from_projection(
        &ledger,
        &missing_projection,
    )
    ...
    let original = &tampered
        ...
        .proof
        .contract_entailment_assumption_discharges[0];
    let changed = typed_trees_to_checked_trees::checked_trees::CheckedContractEntailmentAssumptionDischarge::new(
    ...
    selected_tamper
        ...
        .proof
        .contract_entailment_assumption_discharges[0] =
        typed_trees_to_checked_trees::checked_trees::CheckedContractEntailmentAssumptionDischarge::new(
            original.machine_symbol(),
            original.contract_position(),
            original.fact_position(),
            original.machine_contract_commitment(),
...
"#,
    ...
    let complete = omega::package_evidence::ledger::reconstruct_package_review(&checked)
    ...
    checked
        ...
        .contract_entailment_assumption_discharges
        .reverse();
    let reordered = omega::package_evidence::ledger::reconstruct_package_review(&checked)
    ...
    let partial = omega::package_evidence::ledger::reconstruct_package_review(&checked)
