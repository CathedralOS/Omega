...
pub(crate) fn crafted_canonical_row(
    ...
    row.extend_from_slice(
        &omega::package_evidence::encoding::PACKAGE_REVIEW_ROW_ENCODING_VERSION.to_le_bytes(),
    );
    row.extend_from_slice(
        &omega::package_evidence::encoding::PACKAGE_REVIEW_ENCODING_VERSION.to_le_bytes(),
    );
...
fn crafted_row_envelope_with_locations(
    ...
    envelope.extend_from_slice(
        &omega::package_evidence::encoding::PACKAGE_REVIEW_CANONICAL_ROW_RECOVERY_VERSION
            .to_le_bytes(),
    );
