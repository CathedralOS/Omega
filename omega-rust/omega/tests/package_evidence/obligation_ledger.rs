...
"#,
    ...
    let console = omega::package_compilation::AcceptedSemanticBinding::new(
...
fn ordinary_package_obligation_ledger_rejects_every_one_field_substitution() {
    use omega::package_compilation::PackageDependencyClosure;
    use omega::package_evidence::ledger::OrdinaryPackageObligationLedger;
    ...
    let reject_recovery =
        |rows: &[omega::package_evidence::encoding::DecodedPackageReviewCanonicalRow],
         needle: &str| {
