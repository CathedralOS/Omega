...
use omega::package_evidence::record::PackagePolicyConformanceConstArgument;
use support::*;
use symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier;
use symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::ClosedConformanceConstArgument;
...
"#,
    ...
    for _ in 0..65 {
        nested = symbol_resolved_trees_to_typed_trees::typed_trees::expression::StaticMachineArgument {
