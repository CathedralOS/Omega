...
use omega::package_evidence::encoding::PackagePolicyRecoveryLimits;
use omega::package_evidence::project_checked_conformance_policy;
use omega::package_evidence::record::PackagePolicyClosedConformanceApplication;
use support::*;
...
"#,
    ...
    assert_policy_round_trip(&policy);
    omega::package_evidence::project_checked_package_review(&checked)
