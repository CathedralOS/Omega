use crate::support::*;
use omega::build_declarations::DependencyPurpose;
...
"#,
    ...
    assert_eq!(
        ...
        omega::representation_planning::OpaqueRepresentationCopyDisposition::CheckedSemanticCopy
    );
    assert!(
        checked
            .custody
...
"#,
    ...
    assert_eq!(
        ...
        &[
            omega::package_evidence::record::PackageReviewBoundaryValueLocation::Register {
