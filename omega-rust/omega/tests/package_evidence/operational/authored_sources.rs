...
"#,
    ...
    let invocation_text = |row: &omega::package_evidence::record::PackageReviewCanonicalRow| {
        let mut text = row
            .source()
            .authored_locations()
...
"#,
    ...
    let reach_text = |row: &omega::package_evidence::record::PackageReviewCanonicalRow| {
        let mut text = row
            .source()
            .authored_locations()
            .expect("authored review locations")
