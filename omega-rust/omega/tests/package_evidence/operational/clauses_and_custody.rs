...
"#,
    ...
    let role_text = |row: &omega::package_evidence::record::PackageReviewCanonicalRow,
...
"#,
    ...
    target_tamper
        ...
        .target = symbol_resolved_trees_to_typed_trees::typed_trees::signature::AuthoredInvocationTarget::Service(other);
