...
use omega::package_compilation::AcceptedSemanticBindingRole;
...
use omega::package_manager::resolution::package_compilation_inputs;
...
fn real_filesystem_host_policy_rejects_unknown_and_duplicate_requirements() {
    ...
    let diagnostics = match error {
        omega::package_manager::review::CompileResolvedPackageReviewsError::Compilation {
            diagnostics,
            ..
        } => diagnostics,
        other => {
