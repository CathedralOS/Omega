...
fn inspect(fixture: &Fixture) -> omega::package_manager::operations::PackageInspectionOutcome {
...
fn inspect_with_offline(
    fixture: &Fixture,
    offline: bool,
) -> omega::package_manager::operations::PackageInspectionOutcome {
