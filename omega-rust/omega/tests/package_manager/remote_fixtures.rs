use omega::package_manager::declarations::{PackageKey, PackageName};
...
use omega::package_manager::resolution::graph::{
    PackageSourceClosureLimits, resolve_git_package_closure,
};
use omega::package_manager::resolution::source::resolve_git_package_source;
...
fn remote_builds_pin_recorded_dependencies_without_sibling_paths() {
    use omega::package_manager::declarations::{DependencySourceRequest, PackageSelection};
...
fn remote_git_dependencies(package: &str) -> Vec<String> {
    use omega::package_manager::declarations::DependencySourceRequest;
