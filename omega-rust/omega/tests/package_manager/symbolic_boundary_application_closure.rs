...
use resolved_layout_to_resolved_layout::boundary_applications::{
    BoundaryApplication, BoundaryApplicationArgument,
};
...
) -> omega::package_evidence::record::PackageReviewTypeIdentity {
...
fn specialization(
    ...
    producer: &str,
    ordinals: &[u32],
    concrete: &omega::package_evidence::record::PackageReviewTypeIdentity,
