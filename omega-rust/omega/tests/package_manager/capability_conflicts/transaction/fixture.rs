...
pub(super) struct ExactCompilerRowScenario {
    ...
    pub(super) baseline_reviews: omega::package_manager::review::CompilerIssuedPackageReviewSet,
    pub(super) stale_baseline_reviews:
        omega::package_manager::review::CompilerIssuedPackageReviewSet,
    pub(super) candidate_reviews: omega::package_manager::review::CompilerIssuedPackageReviewSet,
}
