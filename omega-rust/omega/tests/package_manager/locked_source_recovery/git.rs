...
use omega::package_manager::declarations::{PackageName, PackageSelection};
use omega::package_manager::resolution::graph::resolve_selected_git_project_closure;
use omega::package_manager::resolution::source::GitPackageSourceRequest;
use omega::package_source::GitSourceRequest;
