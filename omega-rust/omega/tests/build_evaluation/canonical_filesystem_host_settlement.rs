...
use omega::build_evaluation::settle_checked_providers;
use omega::build_evaluation::target_machines::{
...
impl Fixture {
    ...
    fn package_inputs(&self, with_binding: bool) -> PackageCompilationInputs {
        ...
        let schema = omega::provider_planning::service_schema::from_typed(&self.typed, definition)
        ...
        let binding = AcceptedSemanticBinding::new_service(
            ...
            identity(HOST),
            "FilesystemHost",
            omega::package_compilation::accepted_service_schema_digest(
                AcceptedSemanticBindingRole::FilesystemHostService,
                &schema,
            ),
        )
    ...
    ) -> omega::build_evaluation::CheckedProviderSelection {
...
fn accepted_binding_mints_the_toolchain_filesystem_plan() {
    ...
    assert!(
        matches!(
            ...
            omega::provider_planning::ProviderSelectionProvenance::UniqueCoveringCandidate
        ),
