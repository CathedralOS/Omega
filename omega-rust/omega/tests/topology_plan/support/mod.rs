...
use omega::component_description::test_support::{bare_module, describe_module, module_subject};
use omega::component_description::{
...
pub fn assumption_api_module() -> (TerminalModule, Identity) {
    ...
    let assumption =
        omega::component_description::port_mechanism_assumption(service, PORT_NUMBER, PORT_VALUE);
    (module, assumption)
}
