...
fn typed_source(source: &str) -> symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees {
...
fn requirement<'program>(
    typed: &'program symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees,
    name: &str,
...
fn exact_top_level_requirement_schema_retains_its_typed_operational_shape() {
    ...
    let schema = omega::provider_planning::service_schema::from_typed_boundary_requirement(
        &typed,
        requirement,
    )
...
fn top_level_requirement_schema_fences_non_public_and_generic_declarations() {
    ...
    for name in ["Private::complete", "StaticGeneric::complete"] {
        assert!(
            omega::provider_planning::service_schema::from_typed_boundary_requirement(
                &typed,
