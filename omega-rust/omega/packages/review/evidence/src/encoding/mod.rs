...
pub const PACKAGE_CALLING_POLICY_VERSION: u16 = 3;
pub(crate) const CALLING_POLICY_MAGIC: &[u8] = b"OMEGA-CALLING-POLICY\0";

pub const PACKAGE_REPRESENTATION_POLICY_VERSION: u16 = 3;
pub(crate) const REPRESENTATION_POLICY_MAGIC: &[u8] = b"OMEGA-REPRESENTATION-POLICY\0";

pub const PACKAGE_SELECTED_PROVIDER_POLICY_VERSION: u16 = 3;
