...
[lib.rs](src/task_plans.rs) owns activation plans, selected-runtime facts, exact
preservation/invocation joins, and provider-instance lifecycle accounting.
[stack_composition.rs](src/task_plans/stack_composition/mod.rs) owns provider-independent same-stack composition.
...
[provider_admission.rs](src/task_plans/provider_admission.rs) is the provider-side
...
[Terminal producer](../../../psi/pipeline/07_lowered-psi-to-terminal-psi/terminal_production.md#structural-results-and-suspension).
