...
and validation. See [plans.rs](src/calling_conventions/plans/mod.rs) and the exported vocabulary in
[lib.rs](src/calling_conventions.rs). Callback parameter and destination identities live in
[callback_materializations.rs](src/calling_conventions/callback_materializations/mod.rs).
...
[production status](../../pipeline/09_resolved-layout-to-resolved-layout/image_footprint_replay.md) must not be
