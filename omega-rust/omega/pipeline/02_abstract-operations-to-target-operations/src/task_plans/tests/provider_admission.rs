...
fn persistent_binding(record: &crate::task_plans::TaskDependencyRecord) -> TaskStorageProvenance {
...
fn caller_storage_rejection_returns_the_supplied_lease() {
    ...
    assert_eq!(
        ...
        TaskStorageProvenance {
            ...
            lease: id(
                401,
                crate::task_plans::TaskStorageLeaseId::from_normalized_identity
            ),
        }
    );
}
...
fn an_unbound_unresolved_site_keeps_the_plan_rejecting() {
    ...
    let error = establish_stack_lease(
        &covered,
        crate::task_plans::StackLeaseBacking {
