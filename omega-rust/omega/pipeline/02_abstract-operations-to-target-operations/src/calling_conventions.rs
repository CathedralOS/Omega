...
pub use plans::{
    ...
    ValuePlacement, ValueShape, compose_state_footprints, encode_state_plan_identity,
    evaluate_call_plan, evaluate_darwin_aapcs64_variadic_boundary_entry_plan,
...
pub use stack_realizations::{
    ...
    ValidatedX86_64DeriverStub, ValidatedX86_64InstalledHardwareEntryFacts, X86_64ArrivalMechanism,
    X86_64DeriverStub, X86_64DeriverStubContext, X86_64ErrorCodeDisposition, X86_64GateKind,
    ...
    X86_64TargetDerivedHardwareArrival, X86_64TargetProfileIdentity, derive_x86_64_entry_exit_stub,
