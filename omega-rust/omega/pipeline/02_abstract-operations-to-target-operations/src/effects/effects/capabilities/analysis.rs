...
use crate::effects::effects::capabilities::provider_approval::{
...
fn boundary_trait_is_implemented(program: &TypedTrees, trait_symbol: SymbolHandle) -> bool {
    ...
    program.conformances().iter().any(|conformance| {
        matches!(
            &conformance.subject,
            symbol_resolved_trees_to_typed_trees::typed_trees::trait_definition::ConformanceSubject::Carrier(_)
