...
pub struct NormalizedForeignTerminalMechanismIdentity {
    ...
    implementation_contract: crate::effects::provider_plan::BoundaryCallingPlanCommitment,
...
impl NormalizedForeignTerminalMechanismIdentity {
    ...
    pub const fn implementation_contract(
        self,
    ) -> crate::effects::provider_plan::BoundaryCallingPlanCommitment {
...
pub struct TerminalAuthorityClosureLeaf {
    service_schema: crate::effects::provider_plan::ServiceSchemaDigest,
    requirement_identity: String,
    provider_plan: crate::effects::provider_plan::ProviderPlanDigest,
...
impl TerminalAuthorityClosureLeaf {
    ...
    pub const fn service_schema(&self) -> crate::effects::provider_plan::ServiceSchemaDigest {
        self.service_schema
    }
    ...
    pub const fn provider_plan(&self) -> crate::effects::provider_plan::ProviderPlanDigest {
        self.provider_plan
    }
...
pub struct TerminalAuthorityClosureReviewReceipt {
    ...
    selected_provider_closure: crate::effects::SelectedProviderClosureDigest,
...
impl TerminalAuthorityClosureReviewReceipt {
    ...
    pub const fn selected_provider_closure(&self) -> crate::effects::SelectedProviderClosureDigest {
...
mod tests {
    ...
    fn normalized_foreign_identity_binds_its_checked_argument_contract() {
        ...
        let plan =
            crate::effects::provider_plan::BoundaryCallingPlanCommitment::from_digest([7; 32]);
        let admitted =
    ...
    fn closure_leaf(
        ...
        super::TerminalAuthorityClosureLeaf::new(
            crate::effects::provider_plan::ServiceSchemaDigest::from_digest([41; 32]),
            "test::Console::exit()".to_owned(),
            crate::effects::provider_plan::ProviderPlanDigest::from_digest([43; 32]),
    ...
    > {
        super::TerminalAuthorityClosureReviewReceipt::from_reviewed_leaves(
            ...
            crate::effects::SelectedProviderPlanFacts::default().identity_digest(),
