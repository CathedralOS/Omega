...
use crate::effects::provider_plan::{ProviderBinding, ProviderPlan, ProviderPlanDigest};
...
pub enum OpaqueInProcessBinding {
    Import {
        evaluated: crate::effects::provider_plan::EvaluatedForeignImport,
    },
    VtableSlot {
        index: i64,
    },
...
fn incomplete_cause(
    plan: &ProviderPlan,
    row: &crate::effects::provider_plan::ProviderPlanRow,
    binding: OpaqueInProcessBinding,
) -> IncompleteCause {
    let requirement_identity = row.requirement_identity.clone();
