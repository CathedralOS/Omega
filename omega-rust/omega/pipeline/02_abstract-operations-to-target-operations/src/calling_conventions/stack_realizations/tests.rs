...
fn interrupt_boundary(class: u16) -> crate::calling_conventions::ValidatedBoundaryEntryPlan {
...
) -> crate::calling_conventions::ValidatedBoundaryEntryPlan {
    interrupt_boundary_with_shapes(
        class,
        vec![crate::calling_conventions::ValueShape::integer(8, 8); parameter_count],
    )
}

fn interrupt_boundary_with_shapes(
    class: u16,
    parameters: Vec<crate::calling_conventions::ValueShape>,
) -> crate::calling_conventions::ValidatedBoundaryEntryPlan {
    let signature = crate::calling_conventions::CallSignature {
        parameters,
        result: None,
    };
    let mut call = crate::calling_conventions::evaluate_call_plan(
        crate::calling_conventions::CallingPolicy::MicrosoftX64,
        &signature,
    )
    .expect("call plan");
    call.ordinary_clobbers = crate::calling_conventions::RegisterSet::new([
        crate::calling_conventions::MachineRegister::X86Rax,
        crate::calling_conventions::MachineRegister::X86Rcx,
        crate::calling_conventions::MachineRegister::X86Rdx,
        crate::calling_conventions::MachineRegister::X86Rsi,
        crate::calling_conventions::MachineRegister::X86Rdi,
        crate::calling_conventions::MachineRegister::X86R8,
        crate::calling_conventions::MachineRegister::X86R9,
        crate::calling_conventions::MachineRegister::X86R10,
        crate::calling_conventions::MachineRegister::X86R11,
    ]);
    call.entry_control = crate::calling_conventions::EntryControl::InterruptReturn;
    let interrupted = crate::calling_conventions::MachineStateSet::new([
        crate::calling_conventions::MachineState::GeneralRegisters,
        crate::calling_conventions::MachineState::Flags,
        crate::calling_conventions::MachineState::InstructionPointer,
        crate::calling_conventions::MachineState::StackPointer,
        crate::calling_conventions::MachineState::VectorRegisters,
    ]);
    let saved = crate::calling_conventions::MachineStateSet::new([
        crate::calling_conventions::MachineState::GeneralRegisters,
        crate::calling_conventions::MachineState::Flags,
        crate::calling_conventions::MachineState::InstructionPointer,
        crate::calling_conventions::MachineState::StackPointer,
    ]);
    crate::calling_conventions::validate_boundary_entry_plan(
        crate::calling_conventions::BoundaryEntryPlan {
            call,
            state: crate::calling_conventions::StatePlan {
                initial_regime: crate::calling_conventions::MachineRegime::X86Long64,
                interrupted_state: interrupted,
                saved_state: saved,
                restored_state: saved,
                permitted_transitive_use: crate::calling_conventions::MachineStateSet::new([
                    crate::calling_conventions::MachineState::GeneralRegisters,
                    crate::calling_conventions::MachineState::Flags,
                ]),
...
fn stub_installed_facts(
    boundary: &crate::calling_conventions::ValidatedBoundaryEntryPlan,
    vector: u8,
    gate: X86_64GateKind,
    contexts: Vec<X86_64InstalledArrivalContext>,
...
fn fatal_exception_stub_derives_hardware_error_word_and_saved_state() {
    ...
    assert_eq!(
        ...
        crate::calling_conventions::EntryControl::InterruptReturn
    );
    assert_eq!(
...
fn deriver_stub_carries_member_call_frame_and_peak_overhead() {
    ...
    let outgoing = boundary
        ...
        .filter_map(|location| match location {
            crate::calling_conventions::ValueLocation::Stack {
                stack_byte_offset,
                byte_size,
                ..
...
fn deriver_stub_member_call_frame_reserves_indirect_copies_and_pointer_slots() {
    ...
    let boundary = interrupt_boundary_with_shapes(
        11,
        vec![crate::calling_conventions::ValueShape::integer(16, 8)],
    );
    let installed = stub_installed_facts(
        &boundary,
        13,
    ...
    let boundary = interrupt_boundary_with_shapes(
        11,
        vec![crate::calling_conventions::ValueShape::integer(16, 8); 5],
    );
    let installed = stub_installed_facts(
        &boundary,
        13,
...
fn deriver_stub_fails_closed_on_unadmitted_boundary_or_drifted_facts() {
    ...
    let mut ordinary_call = crate::calling_conventions::evaluate_call_plan(
        crate::calling_conventions::CallingPolicy::MicrosoftX64,
        &crate::calling_conventions::CallSignature {
            parameters: vec![crate::calling_conventions::ValueShape::integer(8, 8)],
            result: None,
        },
    )
    .expect("call plan");
    ordinary_call.ordinary_clobbers = crate::calling_conventions::RegisterSet::new([
        crate::calling_conventions::MachineRegister::X86Rax,
        crate::calling_conventions::MachineRegister::X86Rcx,
        crate::calling_conventions::MachineRegister::X86Rdx,
    ]);
    ordinary_call.entry_control = crate::calling_conventions::EntryControl::CallReturn;
    let saved = crate::calling_conventions::MachineStateSet::new([
        crate::calling_conventions::MachineState::GeneralRegisters,
        crate::calling_conventions::MachineState::Flags,
    ]);
    let ordinary = crate::calling_conventions::validate_boundary_entry_plan(
        crate::calling_conventions::BoundaryEntryPlan {
            call: ordinary_call,
            state: crate::calling_conventions::StatePlan {
                initial_regime: crate::calling_conventions::MachineRegime::X86Long64,
