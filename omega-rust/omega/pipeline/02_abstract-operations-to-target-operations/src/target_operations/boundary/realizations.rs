...
use crate::calling_conventions::BoundaryEntryPlan;
use crate::target_operations::{TargetStructuralArgument, TargetUnitScalarCallArgument};
...
/// surrounding [`crate::target_operations::TargetUnitOperation::BoundarySettlement`] row.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
...
pub struct NormalizedForeignCallBinding {
    ...
    pub same_stack_contribution: crate::task_plans::AdmittedSameStackContribution,
}
