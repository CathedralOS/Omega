...
use crate::calling_conventions::{CallPlan, ValuePlacement, ValueShape};
...
pub enum TargetUnitOperation {
    ...
    ScalarDefinition {
        result_home: TargetUnitScalarHomeRequirement,
        expression: crate::target_operations::TargetScalarExpression,
    },
    ...
    ByteSequenceSubslice {
        result: StructuralOperationResult,
        view: crate::target_operations::TargetByteView,
    },
    ...
    EstablishElementView {
        result: StructuralOperationResult,
        view: crate::target_operations::TargetElementView,
    },
    ...
    EstablishRecord {
        psi_operation: OperationId,
        result_home: crate::target_operations::TargetStructuralHomeRequirement,
    ...
    Call {
        ...
        callee: MachineId,
        call_plan: CallPlan,
        result: crate::target_operations::TargetCallResult,
    ...
    Continue {
        ...
        bindings: Vec<terminal_psi_to_abstract_operations::abstract_operations::ValueBinding>,
