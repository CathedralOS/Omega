...
use crate::calling_conventions::CallPlan;
...
pub enum TargetStructuralReturnSource {
    Home(crate::target_operations::TargetStructuralHomeRequirement),
...
impl TargetStructuralCaseSource {
    ...
    pub const fn layout(&self) -> &crate::target_operations::TargetStructuralHomeLayout {
        match self {
...
pub struct TargetControlCasePayload {
    ...
    pub parameter: crate::target_operations::TargetScalarBlockValue,
}
