...
use crate::target_operations::{ScalarParameterLocation, TargetIntegerExpression};
...
pub enum TargetBooleanExpression {
    ...
    BlockParameter(crate::target_operations::TargetScalarBlockValue),
    /// Read an already executed scalar definition; physical residence is downstream.
    ScalarHome(crate::target_operations::TargetUnitScalarHomeRequirement),
    Immediate {
