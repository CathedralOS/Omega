use omega_machine_emission::StagedOptimizedFunctionFragmentEmissionSource;
...
impl From<omega_machine_emission::StagedOptimizedUnitFunctionRelativeRealization>
    for StagedOptimizedVerifiedPhysicalPipeline
{
    fn from(
        realization: omega_machine_emission::StagedOptimizedUnitFunctionRelativeRealization,
    ) -> Self {
        Self {
...
impl From<omega_machine_emission::StagedOptimizedStructuralUnitFunctionRelativeRealization>
    for StagedOptimizedVerifiedPhysicalPipeline
{
    fn from(
        realization: omega_machine_emission::StagedOptimizedStructuralUnitFunctionRelativeRealization,
    ) -> Self {
        Self {
            source: realization.into(),
        }
...
impl From<omega_machine_emission::StagedFixedFrameFunctionRelativeRealization>
    for StagedOptimizedVerifiedPhysicalPipeline
{
    fn from(
        realization: omega_machine_emission::StagedFixedFrameFunctionRelativeRealization,
    ) -> Self {
        Self {
            source: realization.into(),
        }
...
impl From<omega_machine_emission::StagedPostAllocationMachineFunctionRelativeRealization>
    for StagedOptimizedVerifiedPhysicalPipeline
{
    fn from(
        realization: omega_machine_emission::StagedPostAllocationMachineFunctionRelativeRealization,
    ) -> Self {
        Self {
            source: realization.into(),
        }
...
impl From<omega_machine_emission::StagedAllocationRecoveryFunctionRelativeRealization>
    for StagedOptimizedVerifiedPhysicalPipeline
{
    fn from(
        realization: omega_machine_emission::StagedAllocationRecoveryFunctionRelativeRealization,
    ) -> Self {
        Self {
            source: realization.into(),
        }
...
impl From<omega_machine_emission::StagedFunctionRelativeLayoutOptimizationRealization>
    for StagedOptimizedVerifiedPhysicalPipeline
{
    fn from(
        realization: omega_machine_emission::StagedFunctionRelativeLayoutOptimizationRealization,
    ) -> Self {
        Self {
            source: realization.into(),
        }
...
impl From<omega_machine_emission::StagedSelectedLoweringFunctionRelativeRealization>
    for StagedOptimizedVerifiedPhysicalPipeline
{
    fn from(
        realization: omega_machine_emission::StagedSelectedLoweringFunctionRelativeRealization,
    ) -> Self {
        Self {
            source: realization.into(),
        }
