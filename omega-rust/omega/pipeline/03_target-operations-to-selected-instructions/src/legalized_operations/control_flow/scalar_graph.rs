...
use terminal_psi_to_abstract_operations::abstract_operations::{
    AbstractParameterDynamicDispatch, ValueBinding,
};
...
pub struct LegalizedScalarBlock {
    pub id: BlockId,
    pub parameters: Vec<terminal_psi_to_abstract_operations::optimization_unit::ValueDefinition>,
...
pub enum LegalizedScalarInstructionKind {
    ...
    BoundarySettlement(crate::legalized_operations::LegalizedBoundarySettlement),
...
pub struct LegalizedRuntimeIndexOperand {
    pub operand: terminal_psi_to_abstract_operations::abstract_operations::AbstractResult,
    pub stride: u32,
    pub extent: u64,
...
pub struct LegalizedScalarCall {
    pub source: crate::legalized_operations::NativeCallOrigin,
...
pub struct LegalizedNormalizedForeignCall {
    ...
    pub provider_execution: abstract_operations_to_target_operations::target_operations::ProviderExecutionBinding,
    pub binding: abstract_operations_to_target_operations::target_operations::NormalizedForeignCallBinding,
    pub scalar_arguments: Vec<abstract_operations_to_target_operations::target_operations::NormalizedForeignScalarArgument>,
    pub structural_arguments: Vec<abstract_operations_to_target_operations::target_operations::NormalizedForeignStructuralArgument>,
    pub result_home: Option<abstract_operations_to_target_operations::target_operations::TargetUnitScalarHomeRequirement>,
    pub callback: Option<abstract_operations_to_target_operations::target_operations::TargetNativeCallbackArgument>,
}
