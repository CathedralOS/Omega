        ...
        match mutation {
            ...
            14 => {
                function.blocks[0].instructions[0]
                    ...
                    .as_mut()
                    .unwrap()
                    .definition_site = terminal_psi_to_abstract_operations::optimization_unit::ValueDefinitionSite::FunctionParameter(0)
            }
...
fn abi_layout_substitutions_drift_the_plan_identity() {
    ...
    for mutation in 0..10 {
        ...
        match mutation {
            ...
            7 => {
                call.call_plan.entry_control = abstract_operations_to_target_operations::calling_conventions::EntryControl::SupervisorCall {
                    number_register: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rax,
                    immediate: 0x80,
                };
            }
            8 => {
                call.call_plan.ordinary_clobbers = abstract_operations_to_target_operations::calling_conventions::RegisterSet::new([
...
fn ownership_frontier_fact_identities_bind_the_plan_identity() {
    ...
    let fact = |site| {
        terminal_psi_to_abstract_operations::optimization_unit::OwnershipFrontierFact::new(
            plan.psi,
            id(1),
            site,
            terminal_psi_to_abstract_operations::optimization_unit::OwnershipFrontierSnapshot {
                claims: Vec::new(),
    ...
    retained.scalar_functions[0].ownership_frontier_facts = vec![
        fact(terminal_psi_to_abstract_operations::optimization_unit::OwnershipFrontierSite::BlockEntry(id(1))),
        fact(terminal_psi_to_abstract_operations::optimization_unit::OwnershipFrontierSite::EdgeEntry(id(1))),
    ];
    ...
    substituted.scalar_functions[0].ownership_frontier_facts[1] = fact(
        terminal_psi_to_abstract_operations::optimization_unit::OwnershipFrontierSite::EdgeEntry(
            id(2),
        ),
    );
