use crate::legalized_operations::{LegalizedDynamicParameterCall, LegalizedScalarCall};
use abstract_operations_to_target_operations::calling_conventions::{
    EntryControl, ValueLocation, ValuePlacement, ValueShape,
};
    ...
    pub fn validate_shape(&self) -> Result<(), LegalizedScalarCallShapeError> {
            ...
            .enumerate()
        {
            if argument.placement() != placement
                || matches!(
                    argument,
                    crate::legalized_operations::LegalizedScalarArgument::Scalar { .. }
        ...
        for target in [
            ...
            for width in [4, 8] {
                let call_plan = abstract_operations_to_target_operations::calling_conventions::evaluate_call_plan(
                    abstract_operations_to_target_operations::calling_conventions::CallingPolicy::native_for_target(target),
