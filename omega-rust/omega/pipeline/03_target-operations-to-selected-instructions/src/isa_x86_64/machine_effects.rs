        ...
        declarations: selected_keys
            ...
            .map(|(semantic, constraint)| {
                if semantic == MachineSemanticKind::Crash {
                    return Ok(crate::isa_x86_64::selected_form_encoding::crash::declaration(
                        constraints
                            .catalog()
                            .constraints
                            .iter()
                ...
                if semantic == MachineSemanticKind::HostedExitProcessI32 {
                    return crate::isa_x86_64::selected_form_encoding::hosted_exit_process::declaration(
                        target, constraint,
                    )
                    .map_err(|_| {
                        X86_64MachineEffectCatalogValidationError::TargetSemanticMismatch
                ...
                if semantic == MachineSemanticKind::HostedReadByte {
                    return Ok(
                        crate::isa_x86_64::selected_form_encoding::hosted_read_byte::declaration(constraint),
                    );
                }
                if matches!(
                    semantic,
                    ...
                    return Ok(
                        crate::isa_x86_64::selected_form_encoding::floating_control::declaration(
                            semantic, constraint,
                        ),
                    );
                }
                if semantic == MachineSemanticKind::HostedWriteByteI32 {
                    return Ok(
                        crate::isa_x86_64::selected_form_encoding::hosted_write_byte::declaration(constraint),
                    );
                }
    ...
    Ok(SelectedConstraintKeys {
        ...
        call_aggregate: match abi {
            X86_64SelectedAbi::SystemV => {
                crate::isa_x86_64::register_model::x86_64_system_v_aggregate_call_keys()
                    .into_iter()
            ...
            X86_64SelectedAbi::Microsoft => {
                crate::isa_x86_64::register_model::x86_64_microsoft_aggregate_call_keys()
                    .into_iter()
        ...
        return_aggregate: match abi {
            X86_64SelectedAbi::SystemV => {
                crate::isa_x86_64::register_model::x86_64_system_v_aggregate_return_keys()
            }
            X86_64SelectedAbi::Microsoft => {
                crate::isa_x86_64::register_model::x86_64_microsoft_aggregate_return_keys()
            }
        },
        ...
        hosted_write_byte_i32: (target == NativeTarget::linux_x64())
            .then_some(crate::isa_x86_64::X86_64_HOSTED_WRITE_BYTE_I32),
        ...
        call_unit_mixed: match abi {
            X86_64SelectedAbi::SystemV => crate::isa_x86_64::x86_64_system_v_mixed_unit_call_keys(),
            X86_64SelectedAbi::Microsoft => {
        ...
        call_scalar: (match abi {
            ...
            X86_64SelectedAbi::Microsoft => {
                crate::isa_x86_64::x86_64_microsoft_register_call_keys()
            }
        })
        .into_iter()
        .chain(crate::isa_x86_64::x86_64_float_scalar_call_keys(microsoft))
        .collect(),
        ...
        saturating_add_u64: crate::isa_x86_64::register_model::X86_64_SATURATING_ADD_U64,
        divide_u64: crate::isa_x86_64::register_model::X86_64_DIVIDE_U64,
        remainder_u64: crate::isa_x86_64::register_model::X86_64_REMAINDER_U64,
        remainder_i64: crate::isa_x86_64::register_model::X86_64_REMAINDER_I64,
        divide_i64: crate::isa_x86_64::register_model::X86_64_DIVIDE_I64,
        shift_i64: crate::isa_x86_64::register_model::X86_64_SHIFT_I64,
        saturating_add_clamped: crate::isa_x86_64::register_model::X86_64_SATURATING_ADD_CLAMPED,
        ...
        saturating_multiply_u64: crate::isa_x86_64::register_model::X86_64_SATURATING_MULTIPLY_U64,
        ...
        return_float: crate::isa_x86_64::x86_64_float_scalar_return_keys(microsoft),
        return_i64,
        return_unit,
    })
}
...
fn encoded_effects(semantic: MachineSemanticKind, variant: u32) -> MachineEncodedEffects {
    ...
    if semantic == MachineSemanticKind::Crash {
        return crate::isa_x86_64::selected_form_encoding::crash::effects(&units("rip"));
    }
