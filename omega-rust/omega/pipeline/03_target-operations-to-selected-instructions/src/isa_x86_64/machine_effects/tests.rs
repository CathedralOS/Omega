...
use crate::register_model::validate_physical_register_model;
        ...
        for operation in [Add, Subtract, Divide, Remainder, Multiply] {
            for carrier in SaturatingCarrier::ALL {
                ...
                let (key, size) = match (operation, carrier.is_signed(), carrier) {
                    (Add, _, U64) => (
                        crate::isa_x86_64::register_model::X86_64_SATURATING_ADD_U64,
                        19,
                    ),
                    (Add, true, I64) => (
                        crate::isa_x86_64::register_model::X86_64_SATURATING_ADD_CLAMPED,
                        25,
                    ),
                    (Add, true, _) => (
                        crate::isa_x86_64::register_model::X86_64_SATURATING_ADD_CLAMPED,
                    ...
                    (Subtract, false, _) => (
                        crate::isa_x86_64::register_model::X86_64_SATURATING_SUBTRACT_UNSIGNED,
                        13,
                    ),
                    (Subtract, true, I64) => (
                        crate::isa_x86_64::register_model::X86_64_SATURATING_SUBTRACT_CLAMPED,
                        25,
                    ),
                    (Subtract, true, _) => (
                        crate::isa_x86_64::register_model::X86_64_SATURATING_SUBTRACT_CLAMPED,
                    ...
                    (Divide, false, _) => (crate::isa_x86_64::register_model::X86_64_DIVIDE_U64, 3),
                    (Divide, true, I64) => (
                        crate::isa_x86_64::register_model::X86_64_SATURATING_DIVIDE_SIGNED,
                        26,
                    ),
                    (Divide, true, _) => (
                        crate::isa_x86_64::register_model::X86_64_SATURATING_DIVIDE_SIGNED,
                    ...
                    (Remainder, false, _) => {
                        (crate::isa_x86_64::register_model::X86_64_REMAINDER_U64, 9)
                    }
                    (Remainder, true, _) => {
                        (crate::isa_x86_64::register_model::X86_64_REMAINDER_I64, 17)
                    }
                    (Multiply, _, U64) => (
                        crate::isa_x86_64::register_model::X86_64_SATURATING_MULTIPLY_U64,
                        9,
                    ),
                    (Multiply, true, I64) => (
                        crate::isa_x86_64::register_model::X86_64_SATURATING_MULTIPLY_CLAMPED,
                        29,
                    ),
                    (Multiply, true, _) => (
                        crate::isa_x86_64::register_model::X86_64_SATURATING_MULTIPLY_CLAMPED,
                ...
                assert_eq!(
                    ...
                    crate::selected_instructions::MachineAlternativeFamily::from(semantic)
                );
                assert_eq!(
                    alternative.size,
                    ...
                    match corruption {
                        ...
                        _ => {
                            ...
                            alternative.key.family = match operation {
                                Add => crate::selected_instructions::MachineAlternativeFamily::SaturatingAdd(sibling),
                                Subtract => crate::selected_instructions::MachineAlternativeFamily::SaturatingSubtract(sibling),
                                Divide => crate::selected_instructions::MachineAlternativeFamily::SaturatingDivide(sibling),
                                Remainder => crate::selected_instructions::MachineAlternativeFamily::SaturatingRemainder(sibling),
                                Multiply => crate::selected_instructions::MachineAlternativeFamily::SaturatingMultiply(sibling),
                            };
                        }
                    }
                    assert!(
        ...
        for form in TrappingForm::ALL {
            ...
            let (key, reads, writes): (_, Vec<u16>, Vec<u16>) = match (form.operation, form.carrier)
            {
                ...
                | (TrappingOperation::Multiply, SaturatingCarrier::U64) => (
                    crate::isa_x86_64::X86_64_TRAPPING_FIXED_PAIR,
                    vec![0, 1],
                    vec![2, 3],
                ),
                (TrappingOperation::ShiftLeft | TrappingOperation::ShiftRight, _) => (
                    crate::isa_x86_64::X86_64_TRAPPING_SHIFT,
                    vec![0, 1],
                    vec![2, 3],
                ),
                (TrappingOperation::Convert { .. }, _) => (
                    crate::isa_x86_64::X86_64_TRAPPING_CONVERT,
                    vec![0],
                    vec![1, 2],
                ),
                _ => (
                    crate::isa_x86_64::X86_64_TRAPPING_BINARY,
                    vec![0, 1],
                    vec![2, 3],
                ),
            };
...
fn wrapping_remainder_catalog_defines_scratch_and_clobbers_flags() {
    ...
    for target in [NativeTarget::linux_x64(), NativeTarget::windows_x64()] {
        ...
        assert_eq!(
            ...
            crate::isa_x86_64::register_model::X86_64_REMAINDER_I64
        );
        let alternative = &declaration.alternatives[0];
...
fn catalog_declares_alias_safe_subtraction_and_control_barriers() {
    for target in [NativeTarget::linux_x64(), NativeTarget::windows_x64()] {
        ...
        assert_eq!(
            ...
            crate::selected_instructions::MachineAlternativeFamily::ConditionalBranchI64LessThan
        );
        assert_eq!(
...
fn selected_keys_declare_the_supported_x86_64_pairs() {
    ...
    let microsoft_call = crate::isa_x86_64::x86_64_microsoft_register_call_keys()[0];
