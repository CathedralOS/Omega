...
use crate::isa_x86_64::register_model::packed_memory::{X86_64_LOAD_PACKED, X86_64_STORE_PACKED};
use crate::isa_x86_64::register_model::physical_model::{
    GPR64, VECTOR128, complement, sorted_units,
};
use crate::isa_x86_64::register_model::{
...
pub fn x86_64_register_constraint_catalog(
    ...
    let mut constraints = vec![
        RegisterInstructionConstraint {
            ...
            key: crate::isa_x86_64::X86_64_CRASH,
            operands: Vec::new(),
    ...
    for (key, restore) in [
        (crate::isa_x86_64::X86_64_SAVE_FLOATING_CONTROL, false),
        (crate::isa_x86_64::X86_64_RESTORE_FLOATING_CONTROL, true),
    ] {
