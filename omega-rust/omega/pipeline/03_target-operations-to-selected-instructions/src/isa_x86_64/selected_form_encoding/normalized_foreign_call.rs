...
use crate::isa_x86_64::machine_effects::{X86_64SelectedAbi, x86_64_selected_abi};
use crate::isa_x86_64::x86_64_register_constraint_catalog_for;
...
mod tests {
    ...
    fn inputs(
        ...
        let key = crate::isa_x86_64::x86_64_system_v_normalized_foreign_call_keys()
    ...
    fn microsoft_rows_select_their_exact_operands() {
        ...
        let key = crate::isa_x86_64::x86_64_microsoft_normalized_foreign_call_keys()[2 * 2 + 1];
        let row = catalog
            .constraints
            .iter()
            .find(|row| row.key == key)
