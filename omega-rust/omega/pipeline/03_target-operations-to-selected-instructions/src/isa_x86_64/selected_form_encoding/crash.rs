...
use crate::register_model::{RegisterInstructionConstraint, RegisterUnitId};
...
mod tests {
    ...
    fn crash_rejects_changed_bytes_operands_and_alternatives() {
        ...
        let encode = |physical, alternative, operands| {
            crate::isa_x86_64::encode_x86_64_selected_form(
                physical,
        ...
        let validate = |physical, alternative, operands, bytes| {
            crate::isa_x86_64::validate_x86_64_selected_form_encoding(
                physical,
                SelectedInstructionKind::Crash,
                alternative,
                operands,
        ...
        let encoded = crate::isa_x86_64::encode_x86_64_selected_form(
            &physical,
            SelectedInstructionKind::Crash,
            alternative,
            &[],
