...
use crate::isa_x86_64::{
    x86_64_register_constraint_catalog_for, x86_64_system_v_register_call_keys,
};
...
pub fn validate_x86_64_selected_scalar_call_template(
    ...
    let (expected_operand_views, expected) = if unit || aggregate || floating_scalar {
        let keys = if aggregate {
            ...
            crate::isa_x86_64::x86_64_float_scalar_call_keys(abi == X86_64SelectedAbi::Microsoft)
        } else {
            match abi {
                X86_64SelectedAbi::SystemV => {
                    crate::isa_x86_64::x86_64_system_v_register_unit_call_keys()
                        .into_iter()
                        .chain(crate::isa_x86_64::x86_64_system_v_mixed_unit_call_keys())
                        .collect::<Vec<_>>()
                }
                X86_64SelectedAbi::Microsoft => {
                    crate::isa_x86_64::x86_64_microsoft_register_unit_call_keys()
                        .into_iter()
                        .chain(crate::isa_x86_64::x86_64_microsoft_mixed_unit_call_keys())
                        .collect::<Vec<_>>()
                }
            }
        };
        ...
        .find(|row| {
            row.key
                == match abi {
                    ...
                    X86_64SelectedAbi::Microsoft => {
                        crate::isa_x86_64::x86_64_microsoft_register_call_keys()[arity]
                    }
                }
        })
    ...
    fn scalar_call_abi_matrix_resolves_declared_pairs_and_fails_closed() {
        ...
        for undeclared in [
            ...
            assert_eq!(
                ...
                Err(
                    crate::isa_x86_64::machine_effects::X86_64MachineEffectCatalogValidationError::UnsupportedTargetAbi,
                )
            );
        }
    }
