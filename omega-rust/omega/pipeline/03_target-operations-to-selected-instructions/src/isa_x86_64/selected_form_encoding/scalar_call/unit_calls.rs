...
use crate::isa_x86_64::{x86_64_physical_register_model, x86_64_register_constraint_catalog};
...
fn unit_call_templates_cover_native_register_arities_and_reject_forged_results() {
    ...
    for (target, keys) in [
        (
            ...
            crate::isa_x86_64::x86_64_system_v_register_unit_call_keys(),
        ),
        (
            NativeTarget::windows_x64(),
            crate::isa_x86_64::x86_64_microsoft_register_unit_call_keys(),
        ),
    ] {
        for (arity, key) in keys.iter().enumerate() {
            ...
            missing_clobber
                ...
                .clear();
            assert!(
                crate::isa_x86_64::validate_x86_64_register_constraint_catalog(
                    missing_clobber,
                    &physical
                )
                .is_err()
