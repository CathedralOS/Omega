...
fn mixed_aggregate_templates_replay_inputs_results_and_clobbers() {
    ...
    for (native, keys) in [
        (
            ...
            crate::isa_x86_64::x86_64_system_v_mixed_aggregate_call_keys(),
        ),
        (
            NativeTarget::windows_x64(),
            crate::isa_x86_64::x86_64_microsoft_mixed_aggregate_call_keys(),
        ),
    ] {
        let catalog =
            crate::isa_x86_64::x86_64_machine_effect_catalog(native, &constraints).unwrap();
        for key in keys {
                ...
                .find(|declaration| {
                    declaration.constraint == key
                        && declaration.semantic
                            == crate::selected_instructions::MachineSemanticKind::CallAggregate
                })
                .unwrap();
