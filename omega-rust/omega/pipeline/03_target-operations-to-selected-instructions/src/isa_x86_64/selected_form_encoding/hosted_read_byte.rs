...
pub fn encode_x86_64_selected_hosted_read_byte_form(
    ...
    let bytes = crate::isa_x86_64::encode_linux_read_byte_to_stack(displacement, displacement + 4)
        .map_err(|_| X86_64SelectedFormEncodingError::EncodedFormMismatch)?;
...
mod tests {
    ...
    fn read_catalog_retains_complete_zero_operand_constraint_and_effect_clobbers() {
        ...
        let catalog =
            crate::isa_x86_64::x86_64_machine_effect_catalog(target, &constraints).unwrap();
        let validated = crate::isa_x86_64::validate_x86_64_machine_effect_catalog(
            target,
            &constraints,
            catalog.clone(),
        )
        ...
        assert_eq!(
            ...
            crate::isa_x86_64::X86_64_HOSTED_READ_BYTE
        );
