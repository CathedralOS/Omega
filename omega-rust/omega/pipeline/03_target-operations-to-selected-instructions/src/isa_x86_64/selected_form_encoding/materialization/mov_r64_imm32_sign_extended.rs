...
fn require_canonical_model(
    ...
    if physical.identity() != crate::isa_x86_64::canonical_x86_64_physical_register_model_identity()
    {
        return Err(
...
mod tests {
    ...
    use crate::register_model::{RegisterViewId, validate_physical_register_model};
