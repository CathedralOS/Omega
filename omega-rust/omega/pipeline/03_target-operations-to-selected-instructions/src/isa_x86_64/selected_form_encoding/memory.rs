...
use crate::isa_x86_64::selected_form_encoding::instruction_bytes::{modrm, rex};
use crate::isa_x86_64::selected_form_encoding::request_validation::resolve_registers;
mod indexed;
#[cfg(test)]
mod load32_tests;
#[cfg(test)]
...
fn request(
    ...
    let catalog = crate::isa_x86_64::x86_64_register_constraint_catalog_for(physical);
...
mod tests {
    ...
    use crate::selected_instructions::OutgoingArgumentSlotId;
    ...
    fn local_frame_forms_reject_corrupt_stack_base_and_address_bytes() {
        let physical =
            validate_physical_register_model(crate::isa_x86_64::x86_64_physical_register_model())
                .unwrap();
        let slot = crate::selected_instructions::FrameStorageSlotId::Local(
    ...
    fn frame_forms_encode_signed_displacements_below_the_stack_pointer() {
        let physical =
            validate_physical_register_model(crate::isa_x86_64::x86_64_physical_register_model())
                .unwrap();
        let slot = crate::selected_instructions::FrameStorageSlotId::Local(
            crate::selected_instructions::LocalStorageSlotId::Spill {
                register: crate::selected_instructions::VirtualRegisterId(7),
            },
        );
    ...
    fn ordinary_memory_forms_replay_registers_displacements_and_every_encoded_byte() {
        let physical =
            validate_physical_register_model(crate::isa_x86_64::x86_64_physical_register_model())
                .unwrap();
        let slot =
            crate::selected_instructions::FrameStorageSlotId::Outgoing(OutgoingArgumentSlotId {
