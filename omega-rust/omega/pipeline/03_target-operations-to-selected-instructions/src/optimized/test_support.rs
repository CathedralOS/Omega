        ...
        match field {
            ...
            OptimizedSelectionCustodyFieldForTest::RegisterEnvironment => {
                self.custody.register_environment =
                    crate::register_model::TargetRegisterEnvironmentIdentity::from_bytes(
                        [0xa6; 32],
                    );
            }
            OptimizedSelectionCustodyFieldForTest::Legalized => {
                self.custody.legalized =
                    crate::legalized_operations::LegalizedOperationPlanIdentity::from_bytes(
                        [0xa7; 32],
                    );
            }
            ...
            OptimizedSelectionCustodyFieldForTest::Selected => {
                self.custody.selected =
                    crate::selected_instructions::SelectedInstructionPlanIdentity::from_bytes(
                        [0xa9; 32],
                    );
            }
