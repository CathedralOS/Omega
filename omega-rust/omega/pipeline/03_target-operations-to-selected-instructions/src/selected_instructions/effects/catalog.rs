...
use crate::selected_instructions::{SaturatingCarrier, SelectedConstraintKeys, TrappingForm};
pub use identity::{
...
pub struct MachineEncodedEffects {
    ...
    pub implicit_unit_uses: Vec<crate::register_model::RegisterUnitId>,
    /// Physical register units the encoding defines beyond its operand list.
    /// Admission requires this list to equal the constraint row's implicit
    /// definitions exactly.
    pub implicit_unit_defs: Vec<crate::register_model::RegisterUnitId>,
    ...
    pub implicit_unit_clobbers: Vec<crate::register_model::RegisterUnitId>,
