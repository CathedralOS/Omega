...
use crate::register_model::{RegisterConstraintCatalogIdentity, TargetRegisterEnvironmentIdentity};
use crate::selected_instructions::{MachineEffectCatalogIdentity, SelectedInstructionPlanIdentity};
...
impl PreAllocationMachineEffectPlan {
    ...
    pub fn decode(
        encoded: &[u8],
    ) -> Result<Self, crate::selected_instructions::PreAllocationMachineEffectDecodeError> {
