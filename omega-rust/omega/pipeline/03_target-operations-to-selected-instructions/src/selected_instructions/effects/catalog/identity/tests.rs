...
use crate::selected_instructions::{SaturatingCarrier, TrappingForm, TrappingOperation};
    ...
    MachineEffectDeclaration {
        ...
        alternatives: vec![MachineAlternative {
            ...
            encoded: if semantic == MachineSemanticKind::CopyBytes {
                ...
                encoded.implicit_unit_clobbers = vec![crate::register_model::RegisterUnitId(0)];
                encoded
            } else if semantic == MachineSemanticKind::HostedExitProcessI32 {
                ...
                encoded.memory = MachineEncodedMemoryEffect::HostedWriteByteV1 {
                    stack_pointer: crate::register_model::RegisterViewId(7),
                };
...
fn saturating_catalog_identity_binds_keys_and_gives_every_carrier_a_distinct_family() {
    use crate::selected_instructions::{
        SaturatingCarrier, SaturatingOperation, saturating_family_tag,
    };
...
/// that `machine_code::resolved_layout_to_resolved_layout::layout::identity` carried before the copies were
...
fn machine_alternative_identity_bytes_are_pinned_for_every_variant() {
    ...
    // `register_homes_to_post_allocation_machine::identity` carried before de-duplication: family
