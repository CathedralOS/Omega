...
use crate::selected_instructions::{
    MachineAlternative, MachineAlternativeKey, MachineLatencyKnowledge,
};
...
fn byte_copy_catalog_requires_dynamic_operands_and_early_clobbers() {
    let constraint = RegisterInstructionConstraint {
        ...
        implicit_uses: vec![],
        implicit_defs: vec![],
        clobbers: vec![crate::register_model::RegisterUnitId(0)],
    };
    ...
    let source = MachineEffectDeclaration {
        ...
        memory: crate::selected_instructions::MachineMemoryEffect::CopyBytesV1,
        trap: crate::selected_instructions::MachineTrapBehavior::MayArchitecturalFaultV1,
        barrier: MachineBarrier::None,
        call: crate::selected_instructions::MachineCallEffect::NoneV1,
        cleanup: crate::selected_instructions::MachineCleanupEffect::NoneV1,
    ...
    for mutation in 0..8 {
        ...
        match mutation {
            0 => {
                changed.memory = crate::selected_instructions::MachineMemoryEffect::NoneV1;
...
fn pointer_load_catalog_requires_the_semantic_exact_width() {
    ...
    for (semantic, byte_count) in [
        ...
        let mut declaration = MachineEffectDeclaration {
            semantic,
            constraint: constraint.key,
            memory: crate::selected_instructions::MachineMemoryEffect::ReadPointerV1,
            trap: crate::selected_instructions::MachineTrapBehavior::MayArchitecturalFaultV1,
            barrier: MachineBarrier::None,
            call: crate::selected_instructions::MachineCallEffect::NoneV1,
            cleanup: crate::selected_instructions::MachineCleanupEffect::NoneV1,
...
fn linux_write_catalog_rejects_stripped_memory_trap_and_operand_effects() {
    ...
    let source = MachineEffectDeclaration {
        ...
        constraint: constraint.key,
        memory: crate::selected_instructions::MachineMemoryEffect::HostedWriteByteV1,
        trap: crate::selected_instructions::MachineTrapBehavior::HostedWriteFailureV1,
    ...
    for mutation in 0..5 {
        ...
        match mutation {
            ...
            1 => {
                changed.trap = crate::selected_instructions::MachineTrapBehavior::NeverV1;
...
fn control_flow_rows_pin_their_encoded_control_shape() {
    ...
    let declaration = |semantic, control| {
        ...
        MachineEffectDeclaration {
            semantic,
            constraint: constraint.key,
            memory: crate::selected_instructions::MachineMemoryEffect::NoneV1,
            trap: crate::selected_instructions::MachineTrapBehavior::NeverV1,
    ...
    let declaration = |semantic, key, barrier, reads, writes, memory, stack, control| {
        ...
        MachineEffectDeclaration {
            ...
            call: if barrier == MachineBarrier::Call {
                crate::selected_instructions::MachineCallEffect::DirectInternalNormalReturnV1 {
                    pre_call_stack_alignment: 16,
                }
            } else {
                crate::selected_instructions::MachineCallEffect::NoneV1
            },
            cleanup: crate::selected_instructions::MachineCleanupEffect::NoneV1,
            alternatives: vec![MachineAlternative {
                key: MachineAlternativeKey {
...
fn explicit_crash_requires_operand_free_unconditional_no_cleanup_effects() {
    let constraint = RegisterInstructionConstraint {
        ...
        operands: Vec::new(),
        implicit_uses: vec![crate::register_model::RegisterUnitId(7)],
        implicit_defs: vec![crate::register_model::RegisterUnitId(7)],
        clobbers: Vec::new(),
    };
    let source = MachineEffectDeclaration {
        ...
        constraint: constraint.key,
        memory: crate::selected_instructions::MachineMemoryEffect::NoneV1,
        trap: crate::selected_instructions::MachineTrapBehavior::ExplicitCrashV1,
        barrier: MachineBarrier::ControlFlow,
        call: crate::selected_instructions::MachineCallEffect::NoneV1,
        cleanup: crate::selected_instructions::MachineCleanupEffect::NoneV1,
        alternatives: vec![MachineAlternative {
            key: MachineAlternativeKey {
                family: crate::selected_instructions::MachineAlternativeFamily::Crash,
                variant: 0,
            },
            applicability: MachineAlternativeApplicability::Always,
    ...
    for mutation in 0..13 {
        ...
        match mutation {
            0 => candidate.trap = crate::selected_instructions::MachineTrapBehavior::NeverV1,
...
fn indexed_and_frame_memory_rows_reject_foreign_semantics() {
    ...
    validate_declaration(
        ...
        &declaration(
            ...
            crate::selected_instructions::MachineMemoryEffect::ReadPointerV1,
            crate::selected_instructions::MachineTrapBehavior::MayArchitecturalFaultV1,
            &indexed,
        ),
    )
    .unwrap();
    ...
    assert!(
        validate_declaration(
            ...
            &declaration(
                MachineSemanticKind::Load64,
                crate::selected_instructions::MachineMemoryEffect::ReadPointerV1,
                crate::selected_instructions::MachineTrapBehavior::NeverV1,
                &pointer_read,
            ),
        )
        .is_err()
    ...
    assert!(
        validate_declaration(
            ...
            &declaration(
                MachineSemanticKind::ExactAddI64,
                crate::selected_instructions::MachineMemoryEffect::NoneV1,
                crate::selected_instructions::MachineTrapBehavior::HostedReadFailureV1,
    ...
    let store_constraint = RegisterInstructionConstraint {
        ...
        implicit_uses: vec![crate::register_model::RegisterUnitId(9)],
        implicit_defs: Vec::new(),
        clobbers: Vec::new(),
    };
    ...
    validate_declaration(
        ...
        &declaration(
            ...
            crate::selected_instructions::MachineMemoryEffect::WriteFrameStorageV1,
            crate::selected_instructions::MachineTrapBehavior::MayArchitecturalFaultV1,
            &frame_store,
        ),
    )
...
fn encoded_rows_restate_the_contracted_implicit_custody() {
    let unit = |id| crate::register_model::RegisterUnitId(id);
...
fn declared_memory_and_trap_surfaces_bind_the_selected_semantic() {
    ...
    for (memory, trap) in [
        ...
        (
            crate::selected_instructions::MachineMemoryEffect::ReadPointerV1,
            crate::selected_instructions::MachineTrapBehavior::HostedWriteFailureV1,
        ),
        (
            crate::selected_instructions::MachineMemoryEffect::WritePointerV1,
            crate::selected_instructions::MachineTrapBehavior::MayArchitecturalFaultV1,
        ),
        (
            crate::selected_instructions::MachineMemoryEffect::NoneV1,
...
fn hosted_exit_cannot_fall_through_to_the_plain_surface_row() {
    ...
    let declaration = MachineEffectDeclaration {
        ...
        constraint: constraint.key,
        memory: crate::selected_instructions::MachineMemoryEffect::NoneV1,
        trap: crate::selected_instructions::MachineTrapBehavior::HostedExitReturnedV1,
        barrier: MachineBarrier::ExternalEffect,
        call: crate::selected_instructions::MachineCallEffect::NoneV1,
        cleanup: crate::selected_instructions::MachineCleanupEffect::NoneV1,
        alternatives: vec![MachineAlternative {
...
fn normalized_foreign_call_declarations_bind_external_call_effects() {
    ...
    let declaration = |key, encoded: MachineEncodedEffects| MachineEffectDeclaration {
        ...
        call: crate::selected_instructions::MachineCallEffect::DirectExternalNormalReturnV1 {
            pre_call_stack_alignment: 16,
        },
        cleanup: crate::selected_instructions::MachineCleanupEffect::NoneV1,
        alternatives: vec![MachineAlternative {
