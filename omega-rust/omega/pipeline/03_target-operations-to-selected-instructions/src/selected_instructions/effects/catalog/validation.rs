use crate::register_model::{RegisterInstructionConstraint, RegisterOperandAccess};
...
pub(super) fn validate_declaration(
    ...
    let expected_memory = match semantic {
        MachineSemanticKind::CopyBytes => {
            crate::selected_instructions::MachineMemoryEffect::CopyBytesV1
        }
        MachineSemanticKind::HostedReadByte => {
            crate::selected_instructions::MachineMemoryEffect::HostedReadByteV1
        }
        MachineSemanticKind::HostedWriteByteI32 => {
            crate::selected_instructions::MachineMemoryEffect::HostedWriteByteV1
        }
        ...
        MachineSemanticKind::RestoreFloatingControl => {
            crate::selected_instructions::MachineMemoryEffect::ReadFrameStorageV1
        }
        MachineSemanticKind::Store | MachineSemanticKind::StorePacked => {
            crate::selected_instructions::MachineMemoryEffect::WritePointerV1
        }
        _ => crate::selected_instructions::MachineMemoryEffect::NoneV1,
    };
    ...
    let expected_trap = match semantic {
        MachineSemanticKind::Crash => {
            crate::selected_instructions::MachineTrapBehavior::ExplicitCrashV1
        }
        MachineSemanticKind::TrappingInteger(_) => {
            crate::selected_instructions::MachineTrapBehavior::TrappingIntegerV1
        }
        MachineSemanticKind::HostedExitProcessI32 => {
            crate::selected_instructions::MachineTrapBehavior::HostedExitReturnedV1
        }
        MachineSemanticKind::HostedReadByte => {
        ...
        _ => crate::selected_instructions::MachineTrapBehavior::NeverV1,
    };
    ...
    if declaration.cleanup != crate::selected_instructions::MachineCleanupEffect::NoneV1 {
        return Err(MachineEffectCatalogValidationError::InvalidEncodedEffects(
            semantic,
        ));
    }
    match (semantic, declaration.call) {
        ...
        (
            MachineSemanticKind::NormalizedForeignCall,
            crate::selected_instructions::MachineCallEffect::DirectExternalNormalReturnV1 {
                pre_call_stack_alignment,
            },
        ) if pre_call_stack_alignment.is_power_of_two() => {}
        ...
        (_, crate::selected_instructions::MachineCallEffect::NoneV1) => {}
        _ => {
            return Err(MachineEffectCatalogValidationError::InvalidEncodedEffects(
                semantic,
            ));
...
fn validate_encoded_effects(
    ...
    if declaration.semantic == MachineSemanticKind::CopyBytes
        && (declaration.memory != crate::selected_instructions::MachineMemoryEffect::CopyBytesV1
            || !matches!(
                encoded.memory,
                MachineEncodedMemoryEffect::CopyBytesV1 { .. }
            )
            || declaration.call != crate::selected_instructions::MachineCallEffect::NoneV1
            || !constraint.implicit_uses.is_empty()
    ...
    if declaration.semantic == MachineSemanticKind::HostedExitProcessI32
        && (declaration.memory != crate::selected_instructions::MachineMemoryEffect::NoneV1
            || declaration.trap
                != crate::selected_instructions::MachineTrapBehavior::HostedExitReturnedV1
            || encoded.memory != MachineEncodedMemoryEffect::NoneV1
    ...
    match (encoded.memory, encoded.stack, encoded.trap) {
        ...
        (
            ...
            declaration.semantic,
            crate::selected_instructions::MachineSemanticKind::Store
                | crate::selected_instructions::MachineSemanticKind::StorePacked
        ) && declaration.memory
            == crate::selected_instructions::MachineMemoryEffect::WritePointerV1
        ...
        (
            ...
            | MachineEncodedTrapBehavior::MayArchitecturalFaultV1,
        ) if declaration.memory == crate::selected_instructions::MachineMemoryEffect::NoneV1 => {}
        _ => return Err(()),
    }
    Ok(())
}
