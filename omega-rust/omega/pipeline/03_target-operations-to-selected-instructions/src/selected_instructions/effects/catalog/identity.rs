...
pub fn machine_effect_catalog_identity(
    ...
    for declaration in &catalog.declarations {
        ...
        bytes.push(match declaration.memory {
            crate::selected_instructions::MachineMemoryEffect::CopyBytesV1 => 6,
            crate::selected_instructions::MachineMemoryEffect::NoneV1 => 0,
            crate::selected_instructions::MachineMemoryEffect::ReadPointerV1 => 1,
            crate::selected_instructions::MachineMemoryEffect::HostedReadByteV1 => 5,
            crate::selected_instructions::MachineMemoryEffect::HostedWriteByteV1 => 3,
            crate::selected_instructions::MachineMemoryEffect::WriteFrameStorageV1 => 2,
            crate::selected_instructions::MachineMemoryEffect::ReadFrameStorageV1 => 7,
            crate::selected_instructions::MachineMemoryEffect::WritePointerV1 => 4,
        });
        bytes.push(match declaration.trap {
            crate::selected_instructions::MachineTrapBehavior::ExplicitCrashV1 => 5,
            crate::selected_instructions::MachineTrapBehavior::TrappingIntegerV1 => 6,
            crate::selected_instructions::MachineTrapBehavior::NeverV1 => 0,
            crate::selected_instructions::MachineTrapBehavior::HostedExitReturnedV1 => 3,
            crate::selected_instructions::MachineTrapBehavior::HostedReadFailureV1 => 4,
            crate::selected_instructions::MachineTrapBehavior::HostedWriteFailureV1 => 2,
            crate::selected_instructions::MachineTrapBehavior::MayArchitecturalFaultV1 => 1,
        });
        ...
        match declaration.call {
            crate::selected_instructions::MachineCallEffect::NoneV1 => bytes.push(0),
        ...
        bytes.push(match declaration.cleanup {
            crate::selected_instructions::MachineCleanupEffect::NoneV1 => 0,
        });
...
/// The canonical identity encoding of a [`crate::selected_instructions::MachineAlternative`]: its
...
pub fn encode_machine_alternative_identity<Sink: MachineIdentityBytes + ?Sized>(
    bytes: &mut Sink,
    alternative: &crate::selected_instructions::MachineAlternative,
) {
...
fn encode_units<Sink: MachineIdentityBytes + ?Sized>(
    bytes: &mut Sink,
    units: &[crate::register_model::RegisterUnitId],
) {
...
/// The canonical identity encoding of a [`crate::selected_instructions::MachineAlternativeKey`]: the
...
pub fn encode_machine_alternative_key_identity<Sink: MachineIdentityBytes + ?Sized>(
    bytes: &mut Sink,
    key: crate::selected_instructions::MachineAlternativeKey,
) {
...
pub const fn trapping_family_tag(form: crate::selected_instructions::TrappingForm) -> u8 {
    122 + form.ordinal()
}
