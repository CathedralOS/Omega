...
pub fn target_register_environment_identity(
    ...
    selected_keys: &crate::register_model::TargetRegisterEnvironmentConstraintKeys,
) -> TargetRegisterEnvironmentIdentity {
    let mut bytes = Vec::new();
    native_target(&mut bytes, target);
...
fn optional_constraint_key(
    bytes: &mut Vec<u8>,
    key: Option<crate::register_model::RegisterConstraintKey>,
) {
    match key {
        None => byte(bytes, 0),
        Some(key) => {
...
const fn reservation_reason(value: crate::register_model::ReservationReason) -> u8 {
    match value {
        crate::register_model::ReservationReason::Architectural => 0,
        crate::register_model::ReservationReason::StackPointer => 1,
        crate::register_model::ReservationReason::FramePointer => 2,
        crate::register_model::ReservationReason::Platform => 3,
        crate::register_model::ReservationReason::Dispatch => 4,
        crate::register_model::ReservationReason::Metering => 5,
        crate::register_model::ReservationReason::Syscall => 6,
        crate::register_model::ReservationReason::InlineAssembly => 7,
        crate::register_model::ReservationReason::Backend => 8,
    }
}
