...
fn validated_model() -> crate::register_model::ValidatedPhysicalRegisterModel {
...
fn catalog_rejects_model_convention_id_view_geometry_and_coverage_corruption() {
    ...
    wrong_model.physical_register_model =
        crate::register_model::PhysicalRegisterModelIdentity::from_bytes([7; 32]);
    assert_eq!(
