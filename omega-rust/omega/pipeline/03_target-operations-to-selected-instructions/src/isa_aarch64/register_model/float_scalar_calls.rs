...
mod tests {
    ...
    use super::{
        aarch64_aapcs64_register_unit_call_keys, aarch64_float_scalar_call_keys,
        aarch64_float_scalar_return_keys,
    };
    ...
    fn floating_return_uses_ordinary_return_bytes_and_exact_home() {
        ...
        let kind = crate::selected_instructions::SelectedInstructionKind::ReturnScalar;
        let alternative = crate::selected_instructions::MachineAlternativeKey {
            family: crate::selected_instructions::MachineAlternativeFamily::ReturnScalar,
            variant: 0,
        };
        let encoded =
            crate::isa_aarch64::encode_aarch64_selected_form(&physical, kind, alternative, &[home])
                .expect("floating return");
        crate::isa_aarch64::validate_aarch64_selected_form_encoding(
            &physical,
            kind,
            alternative,
            &[home],
