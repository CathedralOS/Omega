...
use crate::isa_aarch64::register_model::physical_model::{
    FLOAT64, GPR64, complement, sorted_units,
};
use crate::isa_aarch64::register_model::{
...
use crate::isa_aarch64::register_model::{float_scalar_calls, indirect_results, mixed_calls};
...
pub fn aarch64_register_constraint_catalog(
    ...
    let mut constraints = vec![
        RegisterInstructionConstraint {
            ...
            key: crate::isa_aarch64::AARCH64_CRASH,
            operands: Vec::new(),
    ...
    for (key, restore) in [
        (crate::isa_aarch64::AARCH64_SAVE_FLOATING_CONTROL, false),
        (crate::isa_aarch64::AARCH64_RESTORE_FLOATING_CONTROL, true),
    ] {
