...
use crate::isa_aarch64::saturating_forms::SaturatingRealization;
        ...
        declarations: selected_keys
            ...
            .map(|(semantic, constraint)| {
                if semantic == MachineSemanticKind::Crash {
                    return Ok(crate::isa_aarch64::selected_form_encoding::crash::declaration(
                        constraints
                            .catalog()
                            .constraints
                            .iter()
                ...
                if let MachineSemanticKind::TrappingInteger(form) = semantic {
                    return Ok(crate::isa_aarch64::selected_form_encoding::trapping_forms::declaration(
                        form, constraint,
                    ));
                }
                if semantic == MachineSemanticKind::HostedExitProcessI32 {
                    return crate::isa_aarch64::selected_form_encoding::hosted_exit_process::declaration(
                        target, constraint,
                    )
                    .map_err(|_| {
                        Aarch64MachineEffectCatalogValidationError::TargetSemanticMismatch
                ...
                if semantic == MachineSemanticKind::HostedReadByte {
                    return Ok(
                        crate::isa_aarch64::selected_form_encoding::hosted_read_byte::declaration(
                            target, constraint,
                        ),
                    );
                }
                if matches!(
                    ...
                    return Ok(
                        crate::isa_aarch64::selected_form_encoding::floating_control::declaration(
                            semantic, constraint,
                        ),
                    );
                }
                if semantic == MachineSemanticKind::HostedWriteByteI32 {
                    return Ok(
                        crate::isa_aarch64::selected_form_encoding::hosted_write_byte::declaration(
                            target, constraint,
                        ),
                    );
                }
...
fn selected_keys(
    ...
    Ok(SelectedConstraintKeys {
        ...
        hosted_read_byte: if target == NativeTarget::linux_arm64() {
            Some(crate::isa_aarch64::AARCH64_HOSTED_READ_BYTE)
        } else if target == NativeTarget::macos_arm64() {
            Some(crate::isa_aarch64::AARCH64_DARWIN_HOSTED_READ_BYTE)
        } else {
            None
        },
        hosted_exit_process_i32: if target == NativeTarget::linux_arm64() {
            Some(crate::isa_aarch64::AARCH64_HOSTED_EXIT_PROCESS_I32)
        } else if target == NativeTarget::macos_arm64() {
            Some(crate::isa_aarch64::AARCH64_DARWIN_HOSTED_EXIT_PROCESS_I32)
        } else {
            None
        },
        hosted_write_byte_i32: if target == NativeTarget::linux_arm64() {
            Some(crate::isa_aarch64::AARCH64_HOSTED_WRITE_BYTE_I32)
        } else if target == NativeTarget::macos_arm64() {
            Some(crate::isa_aarch64::AARCH64_DARWIN_HOSTED_WRITE_BYTE_I32)
        } else {
            None
        },
        ...
        call_unit_mixed: match abi {
            Aarch64SelectedAbi::Aapcs64 => {
                crate::isa_aarch64::aarch64_aapcs64_mixed_unit_call_keys()
            }
            Aarch64SelectedAbi::Darwin => crate::isa_aarch64::aarch64_darwin_mixed_unit_call_keys(),
        },
        call_unit: match abi {
            Aarch64SelectedAbi::Aapcs64 => {
                crate::isa_aarch64::aarch64_aapcs64_register_unit_call_keys()
            }
            Aarch64SelectedAbi::Darwin => {
                crate::isa_aarch64::aarch64_darwin_register_unit_call_keys()
            }
        },
        call_scalar: (match abi {
            Aarch64SelectedAbi::Aapcs64 => aarch64_aapcs64_register_call_keys(),
            Aarch64SelectedAbi::Darwin => crate::isa_aarch64::aarch64_darwin_register_call_keys(),
        })
        .into_iter()
        .chain(crate::isa_aarch64::aarch64_float_scalar_call_keys(darwin))
        .collect(),
        ...
        call_aggregate: crate::isa_aarch64::aarch64_register_aggregate_call_keys(darwin)
            .into_iter()
            .chain(crate::isa_aarch64::aarch64_mixed_aggregate_call_keys(
                darwin,
            ))
            ...
            .collect(),
        return_aggregate: crate::isa_aarch64::aarch64_register_aggregate_return_keys(darwin),
        ...
        saturating_subtract_unsigned:
            crate::isa_aarch64::register_model::AARCH64_SATURATING_SUBTRACT_UNSIGNED,
        saturating_add_u64: crate::isa_aarch64::register_model::AARCH64_SATURATING_ADD_U64,
        divide_u64: crate::isa_aarch64::register_model::AARCH64_DIVIDE_U64,
        remainder_u64: crate::isa_aarch64::register_model::AARCH64_REMAINDER_U64,
        remainder_i64: crate::isa_aarch64::register_model::AARCH64_REMAINDER_I64,
        divide_i64: crate::isa_aarch64::register_model::AARCH64_DIVIDE_I64,
        shift_i64: crate::isa_aarch64::register_model::AARCH64_SHIFT_I64,
        saturating_add_clamped: crate::isa_aarch64::register_model::AARCH64_SATURATING_ADD_CLAMPED,
        saturating_subtract_clamped:
            crate::isa_aarch64::register_model::AARCH64_SATURATING_SUBTRACT_CLAMPED,
        saturating_divide_signed:
            crate::isa_aarch64::register_model::AARCH64_SATURATING_DIVIDE_SIGNED,
        saturating_multiply_clamped:
            crate::isa_aarch64::register_model::AARCH64_SATURATING_MULTIPLY_CLAMPED,
        saturating_multiply_u64:
            crate::isa_aarch64::register_model::AARCH64_SATURATING_MULTIPLY_U64,
        trapping_binary: crate::isa_aarch64::register_model::AARCH64_TRAPPING_BINARY,
        trapping_fixed_pair: crate::isa_aarch64::register_model::AARCH64_TRAPPING_FIXED_PAIR,
        trapping_shift: crate::isa_aarch64::register_model::AARCH64_TRAPPING_SHIFT,
        trapping_convert: crate::isa_aarch64::register_model::AARCH64_TRAPPING_CONVERT,
        ...
        return_float: crate::isa_aarch64::aarch64_float_scalar_return_keys(darwin),
        return_i64,
        return_unit,
    })
}
...
fn encoded_effects(semantic: MachineSemanticKind) -> MachineEncodedEffects {
    let physical = crate::isa_aarch64::aarch64_physical_register_model();
    let units = |name: &str| {
        physical
            .view_named(name)
    ...
    if semantic == MachineSemanticKind::Crash {
        return crate::isa_aarch64::selected_form_encoding::crash::effects(&units("pc"));
    }
    let view = |name: &str| {
        physical
            .view_named(name)
