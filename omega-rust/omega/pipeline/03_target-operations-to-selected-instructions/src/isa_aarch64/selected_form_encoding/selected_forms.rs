...
use crate::isa_aarch64::selected_form_encoding::copy_bytes;
use crate::isa_aarch64::selected_form_encoding::decoding::{
    decode_words, footprint, validate_decoded,
};
use crate::isa_aarch64::selected_form_encoding::float_bits;
...
fn append_saturating(
    ...
    match realization {
        ...
        SaturatingRealization::ClampNarrow { operation, .. } => {
            ...
            words.push(three_address(
                match operation {
                    crate::selected_instructions::SaturatingOperation::Add => 0x8b00_0000,
                    crate::selected_instructions::SaturatingOperation::Subtract => 0xcb00_0000,
                    crate::selected_instructions::SaturatingOperation::Divide => 0x9ac0_0c00,
                    crate::selected_instructions::SaturatingOperation::Multiply => MULTIPLY,
