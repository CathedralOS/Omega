...
use crate::isa_aarch64::{aarch64_physical_register_model, aarch64_register_constraint_catalog};
...
fn target_register_arities_encode_and_reject_opposite_abi_effects() {
    ...
    .unwrap();
    assert!(
        crate::isa_aarch64::AARCH64_REQUIRED_REGISTER_CONSTRAINTS
            .windows(2)
    ...
    for (target, arguments) in cases {
        ...
        for arity in 0..=arguments.len() {
            ...
            let effects = &catalog
                ...
                .iter()
                .find(|row| {
                    row.semantic == crate::selected_instructions::MachineSemanticKind::CallScalar
