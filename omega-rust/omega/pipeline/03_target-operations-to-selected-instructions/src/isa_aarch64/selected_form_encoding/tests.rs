...
use crate::isa_aarch64::selected_form_encoding::decoding::DecodedWord;
use crate::isa_aarch64::selected_form_encoding::decoding::decode_words;
...
use crate::selected_instructions::{SaturatingCarrier, SaturatingOperation};
...
fn widened_branch_forms_encode_inverted_skip_plus_unconditional_imm26() {
    let physical = validate_physical_register_model(aarch64_physical_register_model()).unwrap();
    type Encode = fn(
        &crate::register_model::ValidatedPhysicalRegisterModel,
