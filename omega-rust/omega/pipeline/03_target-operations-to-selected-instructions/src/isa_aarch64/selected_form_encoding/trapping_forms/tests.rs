...
use crate::isa_aarch64::selected_form_encoding::decoding::{DecodedWord, decode_words};
use crate::isa_aarch64::selected_form_encoding::{
...
fn physical() -> ValidatedPhysicalRegisterModel {
    crate::register_model::validate_physical_register_model(aarch64_physical_register_model())
        .unwrap()
}
