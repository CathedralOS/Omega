...
use crate::register_model::{
    RegisterConstraintKey, RegisterViewId, ValidatedPhysicalRegisterModel,
};
...
pub fn encode_aarch64_selected_floating_control_form(
    ...
    let bytes = if restore {
        crate::isa_aarch64::encode_restore_fpcr_from_sp_displacement(offset)
    } else {
        crate::isa_aarch64::encode_save_fpcr_to_sp_displacement(offset)
    }
    .map_err(|_| Aarch64SelectedFormEncodingError::EncodedFormMismatch)?;
