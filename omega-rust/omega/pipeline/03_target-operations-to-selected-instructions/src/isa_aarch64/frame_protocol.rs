...
pub fn encode_aapcs64_frame_protocol(
    ...
    if model.identity() != crate::isa_aarch64::canonical_aarch64_physical_register_model_identity()
    {
...
mod tests {
    ...
    fn canonical_frame_encodes_sp_adjustment_and_link_custody() {
        let model =
            validate_physical_register_model(crate::isa_aarch64::aarch64_physical_register_model())
                .unwrap();
