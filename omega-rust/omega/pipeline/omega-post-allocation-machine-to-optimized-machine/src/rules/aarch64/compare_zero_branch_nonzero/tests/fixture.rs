...
use psi_core::{BlockId, EdgeId, FuelScheduleIdentity, MachineId, OperationId, ValueId};
...
fn physical_operand(view: &omega_register_model::RegisterView) -> PhysicalOperandFootprint {
...
fn units(
    values: impl IntoIterator<Item = omega_register_model::RegisterUnitId>,
