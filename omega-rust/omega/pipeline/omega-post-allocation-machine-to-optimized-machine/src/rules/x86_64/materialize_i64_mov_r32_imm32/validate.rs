...
use crate::{
    ValidatedX86MovR32Imm32Materialization, X86_MOV_R32_IMM32_BASELINE_BYTE_COUNT,
    ...
    x86_mov_r32_imm32_materialization_receipt,
};
...
pub(crate) fn validate_from_parts(
    ...
    source_identity: omega_physical_instructions::PostAllocationMachineIdentity,
    physical: &ValidatedPhysicalRegisterModel,
    plan: &X86MovR32Imm32MaterializationPlan,
