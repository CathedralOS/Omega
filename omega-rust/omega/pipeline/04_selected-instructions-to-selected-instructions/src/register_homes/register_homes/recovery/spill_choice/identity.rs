...
use crate::register_homes::{SpillChoiceIdentity, SpillChoicePlan, SpillChoicePolicy};
...
mod tests {
    ...
    use crate::register_homes::{AllocationLegalityIdentity, SpillChoicePlan, SpillChoicePolicy};
    ...
    fn identity_binds_roots_policy_work_and_functions() {
        ...
        changed.allocator_availability =
            crate::register_homes::AllocatorAvailabilityIdentity::from_bytes([6; 32]);
        assert_ne!(baseline, spill_choice_identity(&changed));
    }
    ...
    fn canonical_codec_round_trips_and_rejects_framing_and_identity_corruption() {
        ...
        use target_operations_to_selected_instructions::register_model::{
            RegisterClassId, RegisterViewId,
        };
