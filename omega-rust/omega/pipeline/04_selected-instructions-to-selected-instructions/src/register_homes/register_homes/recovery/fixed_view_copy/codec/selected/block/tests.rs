...
use crate::register_homes::register_homes::recovery::fixed_view_copy::codec::selected::block::decode_block;
use crate::register_homes::register_homes::recovery::fixed_view_copy::codec::selected::block::decode_successor;
use crate::register_homes::register_homes::recovery::fixed_view_copy::codec::selected::block::encode_block;
use crate::register_homes::register_homes::recovery::fixed_view_copy::codec::selected::block::encode_successor;
                ...
                instruction: SelectedInstruction {
                    ...
                    provenance: SelectedInstructionProvenance {
                        ...
                        fuel: vec![terminal_psi_to_abstract_operations::optimization_unit::FuelSettlement {
                            site: terminal_psi_to_abstract_operations::optimization_unit::PsiProvenance::Edge(edge),
                            units: 2,
                        }],
                        ..Default::default()
                    },
...
fn implementation_block_origin_round_trips_without_a_fabricated_source_block() {
    let mut block =
        crate::register_homes::register_homes::recovery::fixed_view_copy::codec::tests::function_with_operand(
...
fn case_payload_codec_retains_every_semantic_and_transport_field() {
    ...
    for mutation in 0..6 {
        ...
        match mutation {
            ...
            4 => {
                case.source = target_operations_to_selected_instructions::selected_instructions::SelectedCaseDispatchSource::Local {
