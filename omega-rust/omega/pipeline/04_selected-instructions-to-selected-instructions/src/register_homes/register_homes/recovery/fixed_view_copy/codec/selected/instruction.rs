...
use target_operations_to_selected_instructions::register_model::{
    RegisterClassId, RegisterUnitId, RegisterViewId,
};
...
pub(in crate::register_homes::register_homes::recovery::fixed_view_copy::codec) fn decode_kind(
    cursor: &mut Cursor<'_>,
    ...
    Ok(match cursor.byte()? {
        ...
        tag @ (46 | 47) => {
            ...
            let width =
                target_operations_to_selected_instructions::PackedByteWidth::from_byte_size(
                    raw_width,
                )
...
mod tests {
    ...
    use crate::register_homes::register_homes::recovery::fixed_view_copy::codec::selected::decode_kind;
    use crate::register_homes::register_homes::recovery::fixed_view_copy::codec::selected::instruction::encode_kind;
...
fn structural_primitives_round_trip_symbolic_slots_without_scalar_results() {
    ...
    for kind in [
        SelectedInstructionKind::HostedReadByte {
            slot: target_operations_to_selected_instructions::LocalStorageSlotId::Structural {
