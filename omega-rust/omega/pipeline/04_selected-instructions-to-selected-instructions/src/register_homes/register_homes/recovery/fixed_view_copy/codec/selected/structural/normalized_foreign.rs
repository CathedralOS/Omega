...
use target_operations_to_selected_instructions::legalized_operations::LegalizedNormalizedForeignCall;
use target_operations_to_selected_instructions::{
    SelectedInstructionId, SelectedNormalizedForeignCall,
};
...
mod tests {
    ...
    use abstract_operations_to_target_operations::calling_conventions::encode_state_plan_identity;
    use abstract_operations_to_target_operations::calling_conventions::{
    ...
    use crate::register_homes::FixedViewCopyDecodeError;
    use crate::register_homes::register_homes::recovery::fixed_view_copy::codec::primitives::Cursor;
    ...
    fn row() -> SelectedNormalizedForeignCall {
        ...
        SelectedNormalizedForeignCall {
            ...
            ownership: vec![terminal_psi_to_abstract_operations::optimization_unit::OwnershipEvent::ClaimTransfer(Vec::new())],
        }
    }
