use target_operations_to_selected_instructions::register_model::{
    RegisterConstraintFamily, RegisterOperandAccess,
};
...
use crate::register_homes::{FixedViewCopyPlan, FixedViewCopyPolicy, FixedViewCopySourceEvidence};
...
#[cfg(test)]
mod tests {
    use crate::register_homes::FixedViewCopySourceEvidence;
    use crate::register_homes::fixed_view_copy_identity;
    ...
    use target_operations_to_selected_instructions::{
        LiveRangeIdentity, LiveRangePoint, LivenessPosition, SelectedBlockId,
    ...
    fn plan() -> FixedViewCopyPlan {
        FixedViewCopyPlan {
            ...
            allocator_availability:
                crate::register_homes::AllocatorAvailabilityIdentity::from_bytes([5; 32]),
            source_evidence: FixedViewCopySourceEvidence::FixedPrecoloredSegmentHomesV1 {
                fixed_intervals:
                    crate::register_homes::FixedPrecoloredIntervalPlanIdentity::from_bytes([6; 32]),
                split_requirements:
        ...
        let mutations: Vec<Mutation> = vec![
            ...
            |plan| {
                plan.allocator_availability =
                    crate::register_homes::AllocatorAvailabilityIdentity::from_bytes([16; 32])
            },
