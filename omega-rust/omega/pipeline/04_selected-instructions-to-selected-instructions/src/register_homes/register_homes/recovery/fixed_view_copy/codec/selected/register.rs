...
pub(super) fn decode_register(
    ...
    let origin = match cursor.byte()? {
        ...
        3 => VirtualRegisterOrigin::BlockParameter {
            source_value: decode_id(cursor, ValueId::new)?,
            block: target_operations_to_selected_instructions::SelectedBlockId(cursor.u32()?),
            parameter_index: cursor.length()?,
        },
...
mod tests {
    ...
    use crate::register_homes::register_homes::recovery::fixed_view_copy::codec::selected::register::decode_register;
    use crate::register_homes::register_homes::recovery::fixed_view_copy::codec::selected::register::encode_register;
