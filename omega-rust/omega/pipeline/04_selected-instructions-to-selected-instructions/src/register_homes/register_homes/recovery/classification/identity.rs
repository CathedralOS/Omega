...
use terminal_psi_to_abstract_operations::optimization_unit::{
    FuelSettlement, PsiProvenance, encode_value_definition_site_identity,
};
...
mod tests {
    ...
    fn plan() -> RecoveryClassificationPlan {
        ...
        RecoveryClassificationPlan {
            ...
            allocator_availability:
                crate::register_homes::AllocatorAvailabilityIdentity::from_bytes([9; 32]),
    ...
    fn identity_is_deterministic_and_binds_roots_and_nested_classification() {
        ...
        changed.allocator_availability =
            crate::register_homes::AllocatorAvailabilityIdentity::from_bytes([21; 32]);
        assert_ne!(baseline, recovery_classification_identity(&changed));
    ...
    fn scalar_abi_address_recovery_codec_retains_its_distinct_origin() {
        ...
        row.classification = RecoveryClassification::NoAdmittedRecovery {
            reason: crate::register_homes::NoAdmittedRecoveryReason::UnsupportedRangeShape,
        };
        assert_eq!(
