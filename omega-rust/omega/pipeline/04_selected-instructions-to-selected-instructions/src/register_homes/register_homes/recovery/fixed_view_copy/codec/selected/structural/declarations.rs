use abstract_operations_to_target_operations::target_operations::{
    TargetStructuralArgument, TargetStructuralParameter,
};
...
use target_operations_to_selected_instructions::legalized_operations::LegalizedCallUnitParameter;
use terminal_psi::{
...
use crate::register_homes::FixedViewCopyDecodeError;
...
use crate::register_homes::register_homes::recovery::fixed_view_copy::codec::{
...
pub(in crate::register_homes::register_homes::recovery::fixed_view_copy::codec::selected) fn encode_semantic_argument(
    bytes: &mut Vec<u8>,
...
pub(in crate::register_homes::register_homes::recovery::fixed_view_copy::codec::selected) fn decode_semantic_argument(
    cursor: &mut Cursor<'_>,
...
pub(super) fn decode_place(
    ...
    let kind = match cursor.byte()? {
        ...
        5 => StructuralPlaceKind::ProviderAttachment {
            ...
            boundary: decode_id(cursor, semantic_vocabulary::BoundaryMachineId::new)?,
        },
...
pub(super) fn decode_entry_claim(
    ...
    Ok(EntryClaim {
        claim: decode_id(cursor, semantic_vocabulary::ClaimId::new)?,
