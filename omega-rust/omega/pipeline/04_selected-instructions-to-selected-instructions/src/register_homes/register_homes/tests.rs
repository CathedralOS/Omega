...
use crate::register_homes::CalleeSavedModificationWitness;
...
fn plan() -> RegisterHomePlan {
    RegisterHomePlan {
        ...
        allocator_availability: crate::register_homes::AllocatorAvailabilityIdentity::from_bytes(
            [4; 32],
        ),
        functions: vec![
    ...
    let mutations: Vec<Mutation> = vec![
        ...
        |plan| {
            plan.allocator_availability =
                crate::register_homes::AllocatorAvailabilityIdentity::from_bytes([7; 32])
        },
...
fn witness_digest(witness: CalleeSavedModificationWitness) -> [u8; 32] {
    ...
    crate::register_homes::encode_callee_saved_modification_witness_identity(&mut hasher, witness);
