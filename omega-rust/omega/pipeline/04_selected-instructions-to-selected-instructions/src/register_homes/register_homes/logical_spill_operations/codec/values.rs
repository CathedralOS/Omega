...
use target_operations_to_selected_instructions::{SelectedInstructionId, VirtualRegisterOrigin};
...
pub(super) fn decode_origin(
    ...
    match cursor.byte()? {
        ...
        3 => Ok(VirtualRegisterOrigin::BlockParameter {
            ...
            block: target_operations_to_selected_instructions::SelectedBlockId(u32::from_le_bytes(
                cursor.array()?,
            )),
            parameter_index: cursor.length()?,
        }),
        ...
        6 => Ok(VirtualRegisterOrigin::SpillAddress {
            ...
            register: target_operations_to_selected_instructions::VirtualRegisterId(
                u32::from_le_bytes(cursor.array()?),
            ),
        }),
