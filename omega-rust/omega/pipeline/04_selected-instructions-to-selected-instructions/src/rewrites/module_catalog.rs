...
pub(crate) const REWRITE_MODULE_CATALOG: &[RewriteModuleRow] = &[
    ...
    RewriteModuleRow {
        ...
        route: RewriteModuleRoute::Routed {
            caller: "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/selected_optimization.rs",
    ...
    RewriteModuleRow {
        ...
        // assignment recovery.
        route: RewriteModuleRoute::Routed {
            caller: "omega-rust/omega/pipeline/05_selected-instructions-to-register-homes/src/assignment/recovery.rs",
    ...
    RewriteModuleRow {
        ...
        route: RewriteModuleRoute::Routed {
            caller: "omega-rust/omega/pipeline/05_selected-instructions-to-register-homes/src/assignment/runtime_spill/replay.rs",
    ...
    RewriteModuleRow {
        ...
        route: RewriteModuleRoute::Routed {
            caller: "omega-rust/omega/pipeline/05_selected-instructions-to-register-homes/src/assignment/runtime_spill/recovery.rs",
    ...
    RewriteModuleRow {
        ...
        route: RewriteModuleRoute::Routed {
            caller: "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/literal_folds/mod.rs",
