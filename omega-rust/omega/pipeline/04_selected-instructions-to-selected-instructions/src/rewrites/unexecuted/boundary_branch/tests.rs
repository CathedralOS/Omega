...
use crate::rewrites::unexecuted::BoundaryBranchError;
use crate::rewrites::unexecuted::BoundaryBranchReceipt;
use crate::rewrites::unexecuted::ValidatedBoundaryBranch;
...
fn validated_results_compose_with_boundary_boolean() {
    ...
    // transformed plan.
    let boolean_fold = crate::rewrites::unexecuted::fold_selected_boundary_boolean(
        &source,
        0,
        EXTRA,
        &environment,
