...
pub(super) enum MaterializationPlan<'a> {
    Aarch64Movn(&'a post_allocation_machine_to_post_allocation_machine::Aarch64MovnMaterializationPlan),
    X86MovR32Imm32(&'a post_allocation_machine_to_post_allocation_machine::X86MovR32Imm32MaterializationPlan),
    X86MovR64Imm32SignExtended(
        &'a post_allocation_machine_to_post_allocation_machine::X86MovR64Imm32SignExtendedMaterializationPlan,
    ),
    X86XorZero(&'a post_allocation_machine_to_post_allocation_machine::X86XorZeroMaterializationPlan),
}
...
pub(super) enum MaterializationFunction<'a> {
    Aarch64Movn(&'a post_allocation_machine_to_post_allocation_machine::Aarch64MovnMaterializationFunction),
    X86MovR32Imm32(&'a post_allocation_machine_to_post_allocation_machine::X86MovR32Imm32MaterializationFunction),
    X86MovR64Imm32SignExtended(
        &'a post_allocation_machine_to_post_allocation_machine::X86MovR64Imm32SignExtendedMaterializationFunction,
    ),
    X86XorZero(&'a post_allocation_machine_to_post_allocation_machine::X86XorZeroMaterializationFunction),
}
...
pub(super) enum MaterializationBlock<'a> {
    Aarch64Movn(&'a post_allocation_machine_to_post_allocation_machine::Aarch64MovnMaterializationBlock),
    X86MovR32Imm32(&'a post_allocation_machine_to_post_allocation_machine::X86MovR32Imm32MaterializationBlock),
    X86MovR64Imm32SignExtended(
        &'a post_allocation_machine_to_post_allocation_machine::X86MovR64Imm32SignExtendedMaterializationBlock,
    ),
    X86XorZero(&'a post_allocation_machine_to_post_allocation_machine::X86XorZeroMaterializationBlock),
}
