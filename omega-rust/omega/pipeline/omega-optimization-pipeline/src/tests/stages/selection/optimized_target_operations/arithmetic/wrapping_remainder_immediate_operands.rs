//! Public optimized-target custody for proof-bearing wrapping remainder over constant operands.

use super::super::*;

#[test]
fn optimized_target_lowering_retains_wrapping_remainder_immediate_operand_custody() {
    for target_profile in [
        ...
        for scalar_type in native_fixed_types() {
            for (left, right) in boundary_pairs(scalar_type) {
                ...
                let (semantic, proof) =
                    wrapping_integer_remainder_immediate_operands_return_artifact(
                        scalar_type,
                        left,
                        right,
                    );
                ...
                let AbstractToTargetFunctionTranslationDisposition::Validated(
                    ...
                    panic!("optimized constant-operand wrapping remainder must retain its proof-bearing family")
                };
