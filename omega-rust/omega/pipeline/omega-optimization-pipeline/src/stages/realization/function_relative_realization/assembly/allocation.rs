...
pub(in crate::stages::realization::function_relative_realization) fn baseline_allocation_source(
...
pub(in crate::stages::realization::function_relative_realization) fn selected_lowering_source<
    'source,
>(
