        ...
        match field {
            PostAllocationMachinePlanReceiptFieldForTest::Identity => {
                self.receipt.identity =
                    crate::physical_instructions::PostAllocationMachineIdentity::from_bytes(
                        [0xc0; 32],
                    );
            }
            ...
            PostAllocationMachinePlanReceiptFieldForTest::Effects => {
                self.receipt.effects =
                    target_operations_to_selected_instructions::PreAllocationMachineEffectIdentity::from_bytes(
                        [0xc1; 32],
                    );
            }
