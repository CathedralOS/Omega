...
use selected_instructions_to_selected_instructions::register_homes::{
    AllocationLegalityIdentity, RegisterHomeIdentity,
};
...
pub(in crate::physical_instructions::codec) fn decode_content(
    ...
    for _ in 0..function_count {
        ...
        for _ in 0..slot_count {
            outgoing_arguments.push(target_operations_to_selected_instructions::SelectedOutgoingArgumentSlot {
                id: target_operations_to_selected_instructions::OutgoingArgumentSlotId {
                    ...
                    role: match byte(cursor)? {
                        0 => target_operations_to_selected_instructions::OutgoingArgumentSlotRole::Argument,
                        1 => target_operations_to_selected_instructions::OutgoingArgumentSlotRole::ValueCopy,
                        _ => return Err(PostAllocationMachineDecodeError::InvalidField),
                    },
                },
                byte_size: u32_field(cursor)?,
