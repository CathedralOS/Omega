...
pub(super) fn map_field_error(
    error: target_operations_to_selected_instructions::PreAllocationMachineEffectDecodeError,
) -> PostAllocationMachineDecodeError {
    match error {
        target_operations_to_selected_instructions::PreAllocationMachineEffectDecodeError::Truncated => {
