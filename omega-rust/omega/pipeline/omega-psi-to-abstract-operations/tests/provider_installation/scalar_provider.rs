...
use psi_core::{IntegerSign, IntegerType, IntegerValue, ScalarType, ValueId};
use psi_proof_admission::AdmissionProfile;
use psi_terminal::{Operation, OperationKind, OperationResult, TerminalModule, ValueDeclaration};
...
fn scalar_fixture() -> (
    ...
    Vec<u8>,
    AdmissionProfile,
    Vec<omega_psi_to_abstract_operations::SelectedProviderAdapter>,
) {
    let module = scalar_provider_module();
    let (semantic, proof) = artifact(&module);
    (
