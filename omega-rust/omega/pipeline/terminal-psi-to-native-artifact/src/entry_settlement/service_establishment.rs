...
mod tests {
    ...
    fn selected_plan_digest_rejoins_exact_fused_root() {
        ...
        let selected = effects::SelectedProviderPlanFacts::from_selected_plans(vec![plan.clone()])
        ...
        let substituted =
            effects::SelectedProviderPlanFacts::from_selected_plans(vec![substituted_plan])
