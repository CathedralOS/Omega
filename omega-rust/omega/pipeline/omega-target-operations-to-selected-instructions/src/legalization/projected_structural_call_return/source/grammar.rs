...
use psi_terminal::{StructuralAccess, StructuralMultiplicity, StructuralParameterDeclaration};
...
pub(super) fn validate_pair(
    ...
    source_caller: &omega_abstract_operations::AbstractFunction,
    source_callee: &omega_abstract_operations::AbstractFunction,
...
fn same_nonempty_roster(
    ...
    operation_result: &psi_terminal::StructuralOperationResult,
