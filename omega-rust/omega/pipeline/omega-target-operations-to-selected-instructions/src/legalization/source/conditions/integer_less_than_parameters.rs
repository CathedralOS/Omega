//! Exact ordered U64 entry-parameter strict-less-than condition selection.
...
pub(super) fn derive<'a>(
    ...
    integer_parameter_comparison::derive(Kind::LessThan, function, target, abstracted, optimized)
}
