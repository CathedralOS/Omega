...
struct Shape<'a> {
    ...
    inner: (OperationId, psi_core::ObligationId),
    middle: (OperationId, psi_core::ObligationId),
    bridge: (OperationId, psi_core::ObligationId),
    result: (OperationId, psi_core::ObligationId),
}
