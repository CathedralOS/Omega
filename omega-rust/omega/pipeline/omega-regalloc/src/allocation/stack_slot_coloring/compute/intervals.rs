...
pub(in crate::allocation::stack_slot_coloring) struct StackSlotInterval {
    pub(in crate::allocation::stack_slot_coloring) storage: LogicalSpillStorageId,
    pub(in crate::allocation::stack_slot_coloring) class: LogicalSpillStorageClass,
    pub(in crate::allocation::stack_slot_coloring) block: SelectedBlockId,
    pub(in crate::allocation::stack_slot_coloring) live_from: LiveRangePoint,
    pub(in crate::allocation::stack_slot_coloring) live_through: LiveRangePoint,
}
