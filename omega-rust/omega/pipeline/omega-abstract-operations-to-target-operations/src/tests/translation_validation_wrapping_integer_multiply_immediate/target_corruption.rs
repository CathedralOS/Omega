...
fn target_provenance_corruption_fails_closed() {
    assert_eq!(
        ...
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::TargetProvenance
    );
    assert_eq!(
...
fn target_immediate_corruption_fails_closed() {
    for mutate in [
        ...
        assert_eq!(
            ...
            StraightLineWrappingIntegerMultiplyImmediateTranslationError::TargetOperation
        );
    }
}
...
fn substitute_operation(operation: &mut TargetOperation) {
    *operation = TargetOperation::ReturnIntegerExpression {
        ...
        expression: TargetIntegerExpression::WrappingMultiply {
