//! Optimizer module role: stage group. Finite typed integer-literal Unit custody.
...
use crate::{
    ...
    StraightLineIntegerLiteralSequenceUnitReturnTranslationError, lower_to_target_operations,
