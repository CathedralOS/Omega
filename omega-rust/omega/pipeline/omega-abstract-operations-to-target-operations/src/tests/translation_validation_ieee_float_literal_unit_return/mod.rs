//! Optimizer module role: stage group. Exact raw-bit IEEE literal Unit-return custody.
...
use crate::{
    ...
    StraightLineIeeeFloatLiteralUnitReturnTranslationError, lower_to_target_operations,
