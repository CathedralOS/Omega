//! Exact source grammar for wrapping integer addition of two same-type integer constants.
...
pub(super) fn reconstruct(
...
) -> Result<ReconstructedWrappingIntegerAddImmediate, Error> {
    ...
    if *left != *left_constant_result || *right != *right_constant_result {
        return Err(Error::SourceWrappingAddOperands);
    }
