//! Catalog canaries for proof-bearing wrapping remainder over constant operands.
...
fn omission_and_duplicate_fail_closed() {
    ...
    let descriptor = super::super::dispatch::immediate::WRAPPING_INTEGER_REMAINDER_OPERANDS;
    assert!(matches!(
        selection::validate(
            &source,
...
fn pair() -> (AbstractFunction, TargetFunction) {
    ...
    let remainder_operation = OperationId::new(84_007).unwrap();
    let remainder_result = ValueId::new(84_008).unwrap();
    ...
    (
        ...
        TargetFunction {
            ...
            provenance: TerminalPsiProvenance {
                operations: vec![left_operation, right_operation, remainder_operation],
                edges: vec![edge],
            },
