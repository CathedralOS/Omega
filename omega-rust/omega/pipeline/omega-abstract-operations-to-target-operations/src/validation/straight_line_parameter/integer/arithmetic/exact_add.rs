//! Exact integer-add-of-parameters target replay with overflow-obligation custody.
...
pub(crate) fn is_candidate(function: &AbstractFunction) -> bool {
    super::super::super::source::integer::arithmetic::exact_add::is_candidate(function)
}
...
pub(crate) fn validate(
    ...
    StraightLineExactIntegerAddParametersTranslationError,
> {
    let reconstructed = super::reconstruct_exact_add(source, expected_target, target)?;
    ...
    let TargetOperation::ReturnIntegerExpression {
        ...
        return Err(StraightLineExactIntegerAddParametersTranslationError::TargetOperation);
    };
    ...
    Ok(
        StraightLineExactIntegerAddParametersTranslationReceipt::new(
            source.machine,
