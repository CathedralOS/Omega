...
pub(crate) fn is_candidate(function: &AbstractFunction) -> bool {
    super::super::super::source::integer::shift::exact_left::is_candidate(function)
}
...
pub(crate) fn validate(
    ...
    StraightLineExactIntegerShiftLeftParametersTranslationError,
> {
    let reconstructed = super::reconstruct_exact_left(source, expected_target, target)?;
    ...
    let TargetOperation::ReturnIntegerExpression {
        ...
        return Err(StraightLineExactIntegerShiftLeftParametersTranslationError::TargetOperation);
    };
    ...
    Ok(
        StraightLineExactIntegerShiftLeftParametersTranslationReceipt::new(
            source.machine,
            shift.operation,
