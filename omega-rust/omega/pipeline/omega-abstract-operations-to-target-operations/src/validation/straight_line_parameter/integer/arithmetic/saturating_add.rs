//! Exact saturating-integer-add-of-parameters target replay.
...
pub(crate) fn is_candidate(function: &AbstractFunction) -> bool {
    super::super::super::source::integer::arithmetic::saturating_add::is_candidate(function)
}
...
pub(crate) fn validate(
    ...
    StraightLineSaturatingIntegerAddParametersTranslationError,
> {
    let reconstructed = super::reconstruct_saturating_add(source, expected_target, target)?;
    let TargetOperation::ReturnIntegerExpression {
        ...
        return Err(StraightLineSaturatingIntegerAddParametersTranslationError::TargetOperation);
    };
    ...
    Ok(
        StraightLineSaturatingIntegerAddParametersTranslationReceipt::new(
            source.machine,
