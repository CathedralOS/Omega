//! Exact integer-subtract-of-parameters target replay with range-obligation custody.
...
pub(crate) fn is_candidate(function: &AbstractFunction) -> bool {
    super::super::super::source::integer::arithmetic::exact_subtract::is_candidate(function)
}
...
pub(crate) fn validate(
    ...
    StraightLineExactIntegerSubtractParametersTranslationError,
> {
    let reconstructed = super::reconstruct_exact_subtract(source, expected_target, target)?;
    ...
    let TargetOperation::ReturnIntegerExpression {
        ...
        return Err(StraightLineExactIntegerSubtractParametersTranslationError::TargetOperation);
    };
    ...
    Ok(
        StraightLineExactIntegerSubtractParametersTranslationReceipt::new(
            source.machine,
