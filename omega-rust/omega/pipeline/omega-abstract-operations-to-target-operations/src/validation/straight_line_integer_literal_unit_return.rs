//! Independent replay of one unused exact integer literal and its Unit return.
...
pub(crate) fn validate(
    ...
    StraightLineIntegerLiteralUnitReturnTranslationError,
> {
    use StraightLineIntegerLiteralUnitReturnTranslationError as Error;
    ...
    Ok(StraightLineIntegerLiteralUnitReturnTranslationReceipt::new(
        source.machine,
        *psi_operation,
        *result,
        *integer_type,
