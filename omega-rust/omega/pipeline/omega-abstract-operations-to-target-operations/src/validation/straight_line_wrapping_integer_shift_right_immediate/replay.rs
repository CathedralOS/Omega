//! Independent replay of constant wrapping integer shift-right as an immediate.

use omega_target_operations::{TargetFunction, TargetOperation};

use super::grammar::ReconstructedWrappingIntegerShiftRightImmediate;
use super::{
    StraightLineWrappingIntegerShiftRightImmediateTranslationError as Error,
    StraightLineWrappingIntegerShiftRightImmediateTranslationReceipt as Receipt,
};

pub(super) fn validate(
    source: ReconstructedWrappingIntegerShiftRightImmediate,
