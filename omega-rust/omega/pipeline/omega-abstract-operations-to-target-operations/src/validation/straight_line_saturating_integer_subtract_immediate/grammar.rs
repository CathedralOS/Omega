//! Exact source grammar for saturating subtraction of two same-type integer constants.
...
use super::StraightLineSaturatingIntegerSubtractImmediateTranslationError as Error;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) struct ReconstructedSaturatingIntegerSubtractImmediate {
    pub(super) machine: MachineId,
    pub(super) left_constant_operation: OperationId,
    pub(super) right_constant_operation: OperationId,
    pub(super) saturating_sub_operation: OperationId,
    pub(super) return_edge: EdgeId,
    pub(super) left_constant_result: ValueId,
    pub(super) right_constant_result: ValueId,
    pub(super) saturating_sub_result: ValueId,
...
pub(super) fn reconstruct(
...
) -> Result<ReconstructedSaturatingIntegerSubtractImmediate, Error> {
    ...
    let [
        ...
        AbstractOperation::SaturatingIntegerSubtract {
            psi_operation: saturating_sub_operation,
            result: saturating_sub_result,
            scalar_type,
            left,
            right,
        },
