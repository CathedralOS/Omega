//! Typed receipt for exact constant integer wrapping integer subtraction materialization.

use psi_core::{EdgeId, IntegerType, IntegerValue, MachineId, OperationId, ValueId};

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct StraightLineWrappingIntegerSubtractImmediateTranslationReceipt {
    machine: MachineId,
    left_constant_operation: OperationId,
    right_constant_operation: OperationId,
    wrapping_subtract_operation: OperationId,
    return_edge: EdgeId,
    left_constant_result: ValueId,
    right_constant_result: ValueId,
    wrapping_subtract_result: ValueId,
...
impl StraightLineWrappingIntegerSubtractImmediateTranslationReceipt {
    ...
    pub const fn wrapping_subtract_operation(self) -> OperationId {
        self.wrapping_subtract_operation
    }
    ...
    pub const fn wrapping_subtract_result(self) -> ValueId {
        self.wrapping_subtract_result
    }
