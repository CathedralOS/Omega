...
impl StraightLineSaturatingIntegerAddImmediateTranslationReceipt {
    ...
    pub const fn saturating_add_operation(self) -> OperationId {
        self.saturating_add_operation
    }
    ...
    pub const fn saturating_add_result(self) -> ValueId {
        self.saturating_add_result
    }
