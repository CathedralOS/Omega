...
pub use analyses::{
    ...
    materialize_allocator_availability, pre_allocation_machine_effect_identity,
...
pub use rewrites::{
    ...
    CopyRemovalReceipt, FixedPrecoloredSegmentHomeDecline, FixedViewCopy, FixedViewCopyDecodeError,
    ...
    ORDERED_ALLOCATION_RECOVERY_RULES, ORDERED_PRE_ALLOCATION_RULES,
    ORDERED_SELECTED_LOWERING_RULES, OptimizedFixedPrecoloredSegmentHomeCustodyError,
    ...
    PreAllocationTransformationIdentity, PressureRematerializationAction,
    ...
    RedundantExtensionError, RedundantExtensionReceipt, RegisterAllocationRuleTargetApplicability,
    RuntimeRematerializationError, RuntimeRematerializationReceipt, RuntimeSpillError,
    RuntimeSpillReceipt, RuntimeSpillSpanPolicy, SELECTED_LOWERING_RULE_CATALOG,
    SELECTED_STAGE_RULE_CATALOG, SelectedInstructionPairRule, SelectedLoweringRuleCatalogEntry,
    ...
    StagedOptimizedLiteralFolds, StagedOptimizedPreAllocationAttempt,
    ...
    StagedSelectedLoweringOptimizationRun, ValidatedCopyRemoval, ValidatedFixedViewCopies,
    ...
    fixed_view_copy_identity, probe_optimized_fixed_precolored_segment_homes,
    rematerialize_selected_active_resident, rematerialize_selected_runtime_value,
    resolve_pre_allocation_rules, resolve_selected_lowering_rules,
    run_pre_allocation_optimizations, run_selected_lowering_optimizations,
    selected_allocation_recovery_rule, spill_selected_runtime_value,
    ...
    stage_optimized_fixed_view_copies, validate_fixed_view_copies,
