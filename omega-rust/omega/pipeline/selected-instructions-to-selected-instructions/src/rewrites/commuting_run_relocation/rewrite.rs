...
use super::{CommutingRunRelocationError, ValidatedCommutingRunRelocation, admission};
...
pub fn relocate_selected_commuting_run(
    ...
    super::validate_commuting_run_relocation(
        source,
        function_index,
        first_member,
        last_member,
