...
use super::{EdgeRelocationError, EdgeRelocationReceipt, ValidatedEdgeRelocation, admission};
...
/// destination block, and moving it back must restore the complete source
/// by content — every crossed instruction, every other block and
