...
use super::{
    DiamondRelocationError, DiamondRelocationReceipt, ValidatedDiamondRelocation, admission,
};
use crate::ValidatedSelectedAnalysis;

/// Independently consume the proposed program: admission re-derives the
/// admitted member, diamond, and landing index from the source, the
...
/// instruction, register, roster row, call, settlement, and edge included.
