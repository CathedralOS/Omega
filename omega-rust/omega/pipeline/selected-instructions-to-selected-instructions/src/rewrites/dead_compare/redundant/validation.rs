...
use super::{RedundantCompareError, RedundantCompareReceipt, ValidatedRedundantCompare, admission};
use crate::ValidatedSelectedAnalysis;

/// Independently consume the proposed program: admission re-derives the
/// admitted compare, re-resolves every published unit's shadow, and
/// re-audits the operand interval from the source; the proposal's function
/// must equal the independently computed removal — compare dropped,
/// settlements shifted — and reinserting the compare with the source
