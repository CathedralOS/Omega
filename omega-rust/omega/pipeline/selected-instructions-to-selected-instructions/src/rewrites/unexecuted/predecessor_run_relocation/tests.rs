...
fn internally_coupled_run_moves_as_one_body() {
    ...
    assert_eq!(
        crate::rewrites::unexecuted::relocate_selected_instruction_into_predecessor(
            &source,
            0,
            RUN_B,
            MID,
        ...
        .unwrap_err(),
        crate::rewrites::unexecuted::PredecessorRelocationError::UnsupportedPair
    );
}
...
fn predecessor_run_relocation_is_deterministic_and_re_admitted() {
    ...
    let again = crate::rewrites::unexecuted::relocate_selected_instruction_into_predecessor(
        &first,
        0,
        TRAIL,
        MID,
