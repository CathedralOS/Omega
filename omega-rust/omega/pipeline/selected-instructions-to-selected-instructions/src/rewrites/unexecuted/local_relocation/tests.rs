...
fn row_less_member_crosses_an_accounted_run() {
    ...
    assert_eq!(
        crate::rewrites::unexecuted::schedule_selected_pair(
            &source,
            0,
            MAT_A,
            SUM,
        ...
        .unwrap_err(),
        crate::rewrites::unexecuted::LocalScheduleError::UnsupportedPair
    );
}
...
fn relocation_is_deterministic_and_re_admitted() {
    ...
    let swapped = crate::rewrites::unexecuted::schedule_selected_pair(
        &first,
        0,
        SUM,
        COMPARE,
