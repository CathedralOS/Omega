...
use super::{InflowRelocationError, InflowRelocationReceipt, ValidatedInflowRelocation, admission};
use crate::ValidatedSelectedAnalysis;

/// Independently consume the proposed program: admission re-derives the
/// admitted member, inflow block, and landing index from the source, the
/// proposal must place exactly the member's instruction on the landing
/// index in the inflow block, and moving it back must restore the
