...
//! diamond: a register or condition-state unit any member writes and a
...
//! block's executed prefix: past the run's first index in its own block,
//! or past the landing index in the join block.
//!
