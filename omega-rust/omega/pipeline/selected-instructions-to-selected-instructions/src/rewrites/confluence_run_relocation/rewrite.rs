...
use super::{ConfluenceRunRelocationError, ValidatedConfluenceRunRelocation, admission};
...
pub fn relocate_selected_run_into_confluence(
    ...
    super::validate_confluence_run_relocation(
        source,
        function_index,
        first_member,
        last_member,
