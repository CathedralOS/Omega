...
) -> Result<BTreeMap<BlockId, &optimization_unit::OptimizationBlock>, OptimizationUnitValidationError>
{
...
pub(super) fn validate_nodes_and_edges<'a>(
    ...
    blocks: BTreeMap<BlockId, &'a optimization_unit::OptimizationBlock>,
