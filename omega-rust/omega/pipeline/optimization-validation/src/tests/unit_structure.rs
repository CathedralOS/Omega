...
fn byte_literal_catalog_and_exact_establishment_correspondence_validate() {
    ...
    *psi_operation = id(4_619, OperationId::new);
    ...
    let second_declaration = terminal_psi::StructuralPlaceDeclaration {
        id: second_place,
...
fn retained_affine_authority_rejects_order_and_frontier_corruption() {
    ...
    let entry = OwnershipFrontierSnapshot {
        claims: Vec::new(),
        owned_places: vec![
            owned(363, terminal_psi::StructuralMultiplicity::Linear),
            owned(364, terminal_psi::StructuralMultiplicity::Affine),
            owned(365, terminal_psi::StructuralMultiplicity::Affine),
            owned(367, terminal_psi::StructuralMultiplicity::Affine),
            owned(368, terminal_psi::StructuralMultiplicity::Affine),
        ],
        partial_custody: Vec::new(),
    };
    let exit = OwnershipFrontierSnapshot {
        claims: Vec::new(),
        owned_places: vec![owned(363, terminal_psi::StructuralMultiplicity::Linear)],
        partial_custody: Vec::new(),
    };
    let exact_discards = [
        id(368, PlaceId::new),
