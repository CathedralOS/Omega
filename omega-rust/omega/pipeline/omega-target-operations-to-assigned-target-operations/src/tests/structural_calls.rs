...
use psi_core::{ObligationId, OperationId, PlaceId, StructuralPlaceKind, StructuralTypeId};
use psi_terminal::{
...
fn trivial_affine_local_call_plan(target: NativeTarget) -> TargetOperationPlan {
    ...
    let shape = omega_calling_conventions::ValueShape::integer(0, 1);
                ...
                operations: vec![
                    ...
                    TargetUnitOperation::Call {
                        ...
                        arguments: vec![omega_target_operations::TargetStructuralArgument {
                            ...
                            fixed_array_length: None,
                            element_stride: None,
                            source: omega_calling_conventions::ValuePlacement {
                                shape,
                                locations: Vec::new(),
                            },
