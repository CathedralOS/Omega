...
use target_operations_to_selected_instructions::PressureRematerializationIdentity;
        ...
        match field {
            ...
            OptimizedActiveResidentRematerializationCustodyFieldForTest::Liveness => {
                self.custody.liveness =
                    target_operations_to_selected_instructions::LivenessIdentity::from_bytes([0xaa; 32]);
            }
            OptimizedActiveResidentRematerializationCustodyFieldForTest::Ranges => {
                self.custody.ranges =
                    target_operations_to_selected_instructions::LiveRangeIdentity::from_bytes([0xab; 32]);
            }
