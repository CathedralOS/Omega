...
fn physical_contract(
...
) -> resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntryPhysicalContractPlan {
    let (slot, package, digest, requirement, plan, parameters, result) = match profile {
        TargetProfile::MacosArm64 => (
            ...
            resolved_layout_to_resolved_layout::program_entry_plan::MACOS_ARM64_PHYSICAL_REQUIREMENT_IDENTITY,
            resolved_layout_to_resolved_layout::program_entry_plan::exact_macos_arm64_physical_boundary_entry_plan(),
            vec![
                resolved_layout_to_resolved_layout::program_entry_plan::MACOS_ARM64_I32_TYPE_IDENTITY,
                resolved_layout_to_resolved_layout::program_entry_plan::MACOS_ARM64_ADDRESS_TYPE_IDENTITY,
                resolved_layout_to_resolved_layout::program_entry_plan::MACOS_ARM64_ADDRESS_TYPE_IDENTITY,
                resolved_layout_to_resolved_layout::program_entry_plan::MACOS_ARM64_ADDRESS_TYPE_IDENTITY,
            ],
            resolved_layout_to_resolved_layout::program_entry_plan::MACOS_ARM64_I32_TYPE_IDENTITY,
        ...
        TargetProfile::LinuxX64 => (
            ...
            resolved_layout_to_resolved_layout::program_entry_plan::LINUX_X86_64_PHYSICAL_REQUIREMENT_IDENTITY,
            resolved_layout_to_resolved_layout::program_entry_plan::exact_linux_x86_64_physical_boundary_entry_plan(),
            vec![resolved_layout_to_resolved_layout::program_entry_plan::LINUX_X86_64_ADDRESS_TYPE_IDENTITY],
            resolved_layout_to_resolved_layout::program_entry_plan::LINUX_X86_64_I32_TYPE_IDENTITY,
        ),
        TargetProfile::LinuxArm64 => (
            ...
            resolved_layout_to_resolved_layout::program_entry_plan::LINUX_ARM64_PHYSICAL_REQUIREMENT_IDENTITY,
            resolved_layout_to_resolved_layout::program_entry_plan::exact_linux_arm64_physical_boundary_entry_plan(),
            vec![resolved_layout_to_resolved_layout::program_entry_plan::LINUX_ARM64_U64_TYPE_IDENTITY],
            resolved_layout_to_resolved_layout::program_entry_plan::LINUX_ARM64_I32_TYPE_IDENTITY,
        ),
        _ => panic!("no hosted receiver bridge admits {profile:?}"),
    };
    resolved_layout_to_resolved_layout::program_entry_plan::ProgramEntryPhysicalContractPlan::new(
        slot,
        requirement.into(),
        package,
        digest,
...
fn bind_receiver(
    artifact: &mut resolved_layout_to_resolved_layout::image_emission::ObjectArtifact,
    signature: &resolved_layout_to_resolved_layout::program_entry_plan::SelectedProgramEntrySourceSignature,
    profile: TargetProfile,
