...
use abstract_operations_to_target_operations::target_operations::{
    CallSiteOwner, ScalarAbiValue, TerminalPsiProvenance,
};
...
fn register_placement() -> ValuePlacement {
    ValuePlacement {
        ...
        locations: vec![ValueLocation::Register {
            register: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rax,
            value_byte_offset: 0,
            byte_size: 4,
        }],
    }
...
fn canonical_scalar_abi()
-> abstract_operations_to_target_operations::target_operations::ScalarFunctionAbi {
...
fn canonical_parameter_abi()
-> post_allocation_machine_to_selected_form_encoding::machine_code::ParameterFunctionAbiRecord {
    let shape = ValueShape::integer(4, 4);
    let call_plan = evaluate_call_plan(
        CallingPolicy::native_for_target(NativeTarget::linux_x64()),
        &CallSignature {
...
fn matching_mixed_abi(
...
) -> abstract_operations_to_target_operations::target_operations::MixedStructuralScalarFunctionAbi {
    ...
    abstract_operations_to_target_operations::target_operations::MixedStructuralScalarFunctionAbi {
        ...
        structural_parameters: vec![abstract_operations_to_target_operations::target_operations::TargetStructuralParameter {
...
fn foreign_call(
    text_offset: usize,
) -> resolved_layout_to_resolved_layout::image_emission::InstalledForeignCallStack {
    resolved_layout_to_resolved_layout::image_emission::InstalledForeignCallStack {
        ...
        contribution_report_identity:
            abstract_operations_to_target_operations::task_plans::AdmittedStackContributionReportId::from_normalized_identity(7)
                .expect("contribution report"),
        contribution_commitment: abstract_operations_to_target_operations::task_plans::SameStackContributionCommitment::from_digest([3; 32]),
...
fn structural_field_store() -> post_allocation_machine_to_selected_form_encoding::machine_code::UnitStructuralScalarFieldStoreRecord{
    post_allocation_machine_to_selected_form_encoding::machine_code::UnitStructuralScalarFieldStoreRecord {
        psi_operation: operation_id(9),
        ...
        field_byte_offset: 0,
        source: post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarArgumentSourceRecord::IntegerImmediate {
...
fn write_only_store() -> post_allocation_machine_to_selected_form_encoding::machine_code::UnitWriteOnlyPrimitiveStoreRecord{
    post_allocation_machine_to_selected_form_encoding::machine_code::UnitWriteOnlyPrimitiveStoreRecord {
        psi_operation: operation_id(9),
        destination: terminal_psi::StructuralParameterDeclaration {
            place: place_id(1),
            position: 0,
        ...
        destination_placement: empty_placement(),
        source: post_allocation_machine_to_selected_form_encoding::machine_code::UnitWriteOnlyPrimitiveStoreSourceRecord::IntegerImmediate {
            defining_operation: operation_id(8),
            source_value: value_id(55),
            scalar_type: i32_integer(),
            value: IntegerValue::Signed(3),
...
fn scalar_field_store() -> post_allocation_machine_to_selected_form_encoding::machine_code::ScalarStructuralScalarFieldStoreRecord{
    post_allocation_machine_to_selected_form_encoding::machine_code::ScalarStructuralScalarFieldStoreRecord {
        psi_operation: operation_id(9),
        destination: terminal_psi::StructuralParameterDeclaration {
            place: place_id(1),
            position: 0,
        ...
        defining_operation: operation_id(8),
        source_value: value_id(55),
        immediate: abstract_operations_to_target_operations::target_operations::TargetScalarImmediate::Integer {
            scalar_type: i32_integer(),
            value: IntegerValue::Signed(3),
        },
...
fn affine_scalar_record_custody_plan() -> MachineCodePlan {
    ...
    let argument = |place: u64, kind: u64, stack_offset: u32, code_offset: usize, value: i64| {
        post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallArgumentRecord {
            place: place_id(place),
            access: StructuralAccess::Owned,
            path: Vec::new(),
            ...
            source_location: post_allocation_machine_to_selected_form_encoding::machine_code::StructuralSourceLocation::Stack {
                byte_offset: stack_offset,
            },
            call_stack_bytes: 8,
            fixed_array_length: None,
            element_stride: None,
            source: post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitStructuralArgumentSourceRecord::Placement(
                empty_source.clone(),
            ),
    ...
    let unit_call = |operation: u64,
        ...
        post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallRecord {
            source: post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallSource::Authored,
    ...
    let relocation = |operation: u64, allocation: usize, release: usize, offset: usize| {
        post_allocation_machine_to_selected_form_encoding::machine_code::InternalCallRelocation {
            owner: CallSiteOwner::Operation(operation_id(operation)),
            target: machine_id(2),
            unit_stack: Some(post_allocation_machine_to_selected_form_encoding::machine_code::UnitCallStackEvidence {
            ...
            MachineCodeFunction {
                ...
                unit_parameter_homes: vec![
                    UnitParameterHomeRecord {
                        ...
                        location: post_allocation_machine_to_selected_form_encoding::machine_code::StructuralSourceLocation::Stack { byte_offset: 0 },
                        indirect: false,
                    },
                    UnitParameterHomeRecord {
                        place: place_id(2),
    ...
    MachineCodePlan {
        ...
        functions: vec![MachineCodeFunction {
            ...
            unit_parameter_homes: vec![UnitParameterHomeRecord {
                ...
                shape: parameter_shape,
                source: home_source,
                location: post_allocation_machine_to_selected_form_encoding::machine_code::StructuralSourceLocation::Stack { byte_offset: 4 },
                indirect: false,
            }],
...
fn write_only_store_custody_plan() -> MachineCodePlan {
    ...
    let home_source = ValuePlacement {
        ...
        locations: vec![ValueLocation::Indirect {
            pointer: abstract_operations_to_target_operations::calling_conventions::IndirectPointerLocation::Stack {
                stack_byte_offset: 4,
                alignment: 8,
            },
...
fn nested_custody_check<'a>(
    image: &'a resolved_layout_to_resolved_layout::image_emission::ExecutableImage,
    authentic_fingerprint: &'a resolved_layout_to_resolved_layout::image_emission::InstallationFingerprint,
    ...
    let substitute = |record: &mut InstallationRecord,
        ...
        match field {
            ...
            Field::UnitCallStacksInsertDistinct => {
                let row = &mut record.functions_mut_for_test()[2];
                row.unit_call_stacks.push(
                    resolved_layout_to_resolved_layout::image_emission::ObjectUnitCallStack {
            ...
            Field::ScalarCallStacksInsertOnUnitRow => {
                let row = &mut record.functions_mut_for_test()[2];
                row.scalar_call_stacks.push(
                    resolved_layout_to_resolved_layout::image_emission::ObjectScalarCallStack {
                        owner: CallSiteOwner::Operation(operation_id(9)),
                        target: machine_id(1),
                        text_offset: 4,
                        caller_live_bytes: 8,
        ...
        match field {
            ...
            Field::ContributionReportIdentity => {
                ...
                row.foreign_call_stacks[0].contribution_report_identity =
                    abstract_operations_to_target_operations::task_plans::AdmittedStackContributionReportId::from_normalized_identity(
                        0xc011_e541,
                    )
                    .expect("contribution report");
            }
            Field::ContributionCommitment => {
                ...
                row.foreign_call_stacks[0].contribution_commitment =
                    abstract_operations_to_target_operations::task_plans::SameStackContributionCommitment::from_digest([0xaa; 32]);
            }
        ...
        match field {
            Field::ParameterHomesLocation => {
                ...
                row.unit_parameter_homes[0].location =
                    post_allocation_machine_to_selected_form_encoding::machine_code::StructuralSourceLocation::Stack { byte_offset: 8 };
            }
    ...
    let substitute = |record: &mut InstallationRecord,
        ...
        match field {
            ...
            Field::StructuralScalarFieldStoresSourceDefiningOperation => {
                let row = &mut record.functions_mut_for_test()[index];
                let post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarArgumentSourceRecord::IntegerImmediate {
                    defining_operation,
                    ..
            ...
            Field::StructuralScalarFieldStoresSourceBoolean => {
                ...
                row.unit_structural_scalar_field_stores[0].source =
                    post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarArgumentSourceRecord::BooleanImmediate {
            ...
            Field::StructuralScalarFieldStoresSourceParameter => {
                let row = &mut record.functions_mut_for_test()[index];
                row.unit_structural_scalar_field_stores[0].source =
                    post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarArgumentSourceRecord::Parameter {
                        parameter_index: 0,
                        source_value: value_id(51),
                        scalar_type: i32_scalar(),
            ...
            Field::StructuralScalarFieldStoresSourceHome => {
                let row = &mut record.functions_mut_for_test()[index];
                row.unit_structural_scalar_field_stores[0].source =
                    post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarArgumentSourceRecord::Home(
                        post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarHomeRecord {
                            defining_operation: operation_id(1),
                            source_value: value_id(51),
                            scalar_type: i32_scalar(),
                            shape: ValueShape::integer(4, 4),
    ...
    let substitute = |record: &mut InstallationRecord,
        ...
        match field {
            ...
            Field::WriteOnlyPrimitiveStoresSourceDefiningOperation => {
                let row = &mut record.functions_mut_for_test()[index];
                if let post_allocation_machine_to_selected_form_encoding::machine_code::UnitWriteOnlyPrimitiveStoreSourceRecord::IntegerImmediate {
                    defining_operation,
                    ..
            ...
            Field::WriteOnlyPrimitiveStoresSourceParameter => {
                ...
                row.unit_write_only_primitive_stores[0].source =
                    post_allocation_machine_to_selected_form_encoding::machine_code::UnitWriteOnlyPrimitiveStoreSourceRecord::Parameter {
                        parameter_index: 0,
                        source_value: value_id(51),
                        scalar_type: i32_scalar(),
                        location: post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarParameterLocationRecord::Register(
            ...
            Field::WriteOnlyPrimitiveStoresSourceBoolean => {
                let row = &mut record.functions_mut_for_test()[index];
                row.unit_write_only_primitive_stores[0].source =
                    post_allocation_machine_to_selected_form_encoding::machine_code::UnitWriteOnlyPrimitiveStoreSourceRecord::BooleanImmediate {
                        defining_operation: operation_id(9),
                        source_value: value_id(55),
                        value: true,
                        definition_ordinal: 0,
            ...
            Field::WriteOnlyPrimitiveStoresSourceIeeeFloat => {
                let row = &mut record.functions_mut_for_test()[index];
                row.unit_write_only_primitive_stores[0].source =
                    post_allocation_machine_to_selected_form_encoding::machine_code::UnitWriteOnlyPrimitiveStoreSourceRecord::IeeeFloatImmediate {
                        defining_operation: operation_id(9),
                        source_value: value_id(55),
            ...
            Field::WriteOnlyPrimitiveStoresSourceHome => {
                let row = &mut record.functions_mut_for_test()[index];
                row.unit_write_only_primitive_stores[0].source =
                    post_allocation_machine_to_selected_form_encoding::machine_code::UnitWriteOnlyPrimitiveStoreSourceRecord::Home(
                        post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarHomeRecord {
                            defining_operation: operation_id(1),
                            source_value: value_id(51),
                            scalar_type: i32_scalar(),
        ...
        match field {
            ...
            Field::ImmediateBoolean => {
                ...
                row.scalar_structural_scalar_field_stores[0].immediate =
                    abstract_operations_to_target_operations::target_operations::TargetScalarImmediate::Boolean(true);
            }
            Field::ImmediateScalarType => {
                let row = &mut record.functions_mut_for_test()[index];
                row.scalar_structural_scalar_field_stores[0].immediate =
                    abstract_operations_to_target_operations::target_operations::TargetScalarImmediate::Integer {
                        scalar_type: IntegerType::new(IntegerSign::Signed, 64).expect("i64"),
                        value: IntegerValue::Signed(3),
                    };
            }
...
fn installation_function_affine_scalar_records_reject_every_one_field_substitution() {
    ...
    let provider_source = post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallSource::InstalledProvider {
    ...
    let structural_result = post_allocation_machine_to_selected_form_encoding::machine_code::InternalStructuralCallResult {
    ...
    let substitute = |record: &mut InstallationRecord,
        ...
        match field {
            ...
            Field::UnitParameterHomesLocation => {
                let row = &mut record.functions_mut_for_test()[0];
                row.unit_parameter_homes[0].location =
                    post_allocation_machine_to_selected_form_encoding::machine_code::StructuralSourceLocation::Stack { byte_offset: 16 };
            }
            ...
            Field::InternalUnitCallsCustodyScalarArguments => {
                record.internal_unit_calls_mut_for_test()[0]
                    .custody
                    .scalar_arguments
                    .push(post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarCallArgumentRecord {
                        parameter_index: 0,
                        source:
                            post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarArgumentSourceRecord::IntegerImmediate {
                                defining_operation: operation_id(8),
                                source_value: value_id(55),
                                scalar_type: i32_integer(),
                                value: IntegerValue::Signed(3),
            ...
            Field::InternalUnitCallsCustodyArgumentsSourceEstablished => {
                record.internal_unit_calls_mut_for_test()[0]
                        ...
                        .arguments[0]
                        .source =
                        post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitStructuralArgumentSourceRecord::EstablishedPrimitiveLocal {
    ...
    let substitute = |record: &mut InstallationRecord,
        ...
        match field {
            ...
            Field::ParameterAbiInsertWithSpills => {
                ...
                abi.entry_register_spills = vec![post_allocation_machine_to_selected_form_encoding::machine_code::UnitEntryRegisterSpillRecord {
    ...
    let substitute = |record: &mut InstallationRecord,
        ...
        match field {
            ...
            Field::BindingsInsert => {
                let row = &mut record.functions_mut_for_test()[0];
                row.unit_continuations[0].bindings.push(
        ...
        match field {
            ...
            Field::CallPlanCallbackMaterializationsInsert => {
                ...
                row.parameter_abi
                    ...
                    .push(abstract_operations_to_target_operations::calling_conventions::CallbackMaterialization {
                        binder: abstract_operations_to_target_operations::calling_conventions::StaticMachineBinderId::new(1).expect("binder"),
                        destination: abstract_operations_to_target_operations::calling_conventions::NativePlace::Parameter(
                            abstract_operations_to_target_operations::calling_conventions::NativeParameterId::new(1).expect("parameter"),
                        ),
                    });
            }
            Field::CallPlanOrdinaryClobbers => {
                ...
                row.parameter_abi
                    ...
                    .expect("parameter ABI")
                    .call_plan
                    .ordinary_clobbers = abstract_operations_to_target_operations::calling_conventions::RegisterSet::new([
                    abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rbx,
                ]);
            }
            ...
            Field::CallPlanEntryControl => {
                ...
                row.parameter_abi
                    ...
                    .expect("parameter ABI")
                    .call_plan
                    .entry_control = abstract_operations_to_target_operations::calling_conventions::EntryControl::InterruptReturn;
            }
            ...
            Field::EntryRegisterSpillsRegister => {
                ...
                row.parameter_abi
                    ...
                    .expect("parameter ABI")
                    .entry_register_spills[0]
                    .register = abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rdx;
            }
            ...
            Field::EntryRegisterSpillsInsert => {
                ...
                row.parameter_abi
                    ...
                    .push(post_allocation_machine_to_selected_form_encoding::machine_code::UnitEntryRegisterSpillRecord {
                        source_value: value_id(47),
                        parameter_index: 2,
                        register: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rdx,
                        byte_offset: 16,
        ...
        match field {
            ...
            Field::StructuralParametersInsert => {
                ...
                row.mixed_structural_scalar_abi
                    ...
                    .push(abstract_operations_to_target_operations::target_operations::TargetStructuralParameter {
                        place: place_id(9),
                        structural_type: structural_type(9),
                        multiplicity: StructuralMultiplicity::Affine,
                        access: StructuralAccess::Owned,
            ...
            Field::ResultPlacement => {
                ...
                row.mixed_structural_scalar_abi
                    ...
                    shape: ValueShape::integer(4, 4),
                    locations: vec![ValueLocation::Register {
                        register: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rsi,
                        value_byte_offset: 0,
                        byte_size: 4,
                    }],
                };
