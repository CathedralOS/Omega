...
use resolved_layout_to_resolved_layout::object_file::{
    RelocationKind, RelocationOrigin, SectionKind,
};
...
fn legacy_internal_call_rejects_an_installed_provider_origin_with_unchanged_bytes() {
    ...
    call.source = post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallSource::InstalledProvider {
        boundary,
...
fn legacy_call_free_function_rejects_an_incoming_pointer_role() {
    ...
    plan.functions[0]
        ...
        .push(UnitParameterHomeRecord {
            ...
            location: post_allocation_machine_to_selected_form_encoding::machine_code::StructuralSourceLocation::IncomingIndirectPointer {
    ...
    for location in [
        abstract_operations_to_target_operations::calling_conventions::IndirectPointerLocation::Register(
        ...
        plan.functions[0].unit_parameter_homes[0].location =
            post_allocation_machine_to_selected_form_encoding::machine_code::StructuralSourceLocation::IncomingBorrowedPointer { location };
...
fn x86_internal_call_is_a_typed_relocation_and_the_only_final_text_mutation() {
    ...
    plan.functions[1].internal_calls[0].owner =
        abstract_operations_to_target_operations::target_operations::CallSiteOwner::Operation(
            full_width_operation,
        );
...
fn object_boundary_rejects_drifted_unit_stack_evidence() {
    ...
    assert_eq!(
        ...
        Err(ObjectError::InvalidUnitStackEncoding {
            ...
            owner: Some(abstract_operations_to_target_operations::target_operations::CallSiteOwner::Operation(operation_id(2))),
            offset: 0,
        })
    );
...
fn object_replays_linear_scalar_stack_peaks_and_rejects_mutations() {
    ...
    assert_eq!(
        resolved_layout_to_resolved_layout::image_emission::derive_stack_demand(
            &artifact,
            machine_id(1)
        )
