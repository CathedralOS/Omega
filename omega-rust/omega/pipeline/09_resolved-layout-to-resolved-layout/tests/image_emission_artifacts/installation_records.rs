...
use post_allocation_machine_to_selected_form_encoding::machine_code::{
    MachineCodeFunction, MachineCodePlan,
};
...
fn installation_record_is_canonical_and_binds_exact_image_and_target_facts() {
    ...
    assert!(matches!(
        ...
        Err(resolved_layout_to_resolved_layout::image_emission::InstallationStackError::Installation(
...
fn honest_installation_header_record(
    image: &resolved_layout_to_resolved_layout::image_emission::ExecutableImage,
) -> InstallationRecord {
    build_installation_record_with_evidence(
        image,
        ProfileDecisionId::new(11).expect("profile decision"),
...
fn substitute_installation_header(
    ...
    manifest_only: resolved_layout_to_resolved_layout::image_emission::InstalledComponentProgress,
    acceptance_only: resolved_layout_to_resolved_layout::image_emission::InstalledComponentProgress,
) {
    ...
    match field {
        ...
        Field::ExecutableInventoryDigestSubstituted => {
            record
                ...
                resolved_layout_to_resolved_layout::image::PlacedExecutableRegionInventoryDigest::from_digest([0x55; 32]);
        }
        Field::DataInventoryDigestSubstituted => {
            record.image_sections_mut_for_test().data_inventory_digest =
                resolved_layout_to_resolved_layout::image::PlacedDataRegionInventoryDigest::from_digest([0x55; 32]);
        }
        ...
        Field::FinalDataFingerprint => {
            record.image_sections_mut_for_test().final_data_fingerprint =
                resolved_layout_to_resolved_layout::image_emission::InitializedDataFingerprint::for_test([0x33; 32]);
        }
        ...
        Field::ExecutableInventoryDigestAbsent => {
            record
                .image_sections_mut_for_test()
                .executable_inventory_digest =
                resolved_layout_to_resolved_layout::image::PlacedExecutableRegionInventoryDigest::from_digest([0; 32]);
        }
        Field::DataInventoryDigestAbsent => {
            record.image_sections_mut_for_test().data_inventory_digest =
                resolved_layout_to_resolved_layout::image::PlacedDataRegionInventoryDigest::from_digest([0; 32]);
        }
...
optimization_core::custody_field_inventory! {
    ...
    /// [`resolved_layout_to_resolved_layout::image_emission::InstallationRecord`]. The machine, attachment and
...
fn substitute_installed_function_row(
    ...
    match field {
        ...
        Field::UnitStack => {
            record.functions_mut_for_test()[1].unit_stack = Some(
                resolved_layout_to_resolved_layout::image_emission::ObjectUnitStack {
                    frame_bytes: 16,
                    local_peak_bytes: 0,
                    stack_alignment: 16,
                },
        ...
        Field::ScalarStack => {
            record.functions_mut_for_test()[1].scalar_stack = Some(
                resolved_layout_to_resolved_layout::image_emission::ObjectScalarStack {
                    local_peak_bytes: 0,
                    stack_alignment: 16,
                },
            );
...
fn foreign_internal_unit_call_source()
-> post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallSource {
    post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallSource::InstalledProvider {
...
/// substitutions.
fn foreign_affine_structural_result()
-> post_allocation_machine_to_selected_form_encoding::machine_code::InternalStructuralCallResult {
...
fn foreign_scalar_call_argument() -> post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarCallArgumentRecord{
    post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarCallArgumentRecord {
        parameter_index: 0,
...
fn foreign_structural_call_argument()
-> post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallArgumentRecord {
    ...
    post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallArgumentRecord {
        ...
        source_location: post_allocation_machine_to_selected_form_encoding::machine_code::StructuralSourceLocation::Stack { byte_offset: 0 },
        call_stack_bytes: 0,
...
fn substitute_selected_provider_plan(
    ...
    let plan_id = |identity: u64| {
        resolved_layout_to_resolved_layout::image_emission::SelectedProviderPlanReportIdentity::new(
            identity,
        )
