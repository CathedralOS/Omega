...
pub(super) fn edge_owned_cleanup_plan() -> MachineCodePlan {
    ...
    let operation_custody = |operation, target| {
        InternalUnitCallRecord {
...
pub(super) fn continuation_unit_call_plan() -> MachineCodePlan {
    ...
    let parameter_abi = post_allocation_machine_to_selected_form_encoding::machine_code::ParameterFunctionAbiRecord {
        ...
        entry_register_spills: vec![
            post_allocation_machine_to_selected_form_encoding::machine_code::UnitEntryRegisterSpillRecord {
    ...
    MachineCodePlan {
        ...
        functions: vec![
            MachineCodeFunction {
                ...
                unit_continuations: vec![post_allocation_machine_to_selected_form_encoding::machine_code::UnitContinuationRecord {
                    operation_ordinal: 1,
                    ...
                    bindings: vec![
                        terminal_psi_to_abstract_operations::abstract_operations::ValueBinding {
                            parameter: semantic_vocabulary::ValueId::new(50)
                                .expect("bound parameter"),
                            argument: semantic_vocabulary::ValueId::new(45)
        ...
        functions: vec![
            MachineCodeFunction {
                ...
                structural_call_scalar_return: Some(
                    post_allocation_machine_to_selected_form_encoding::machine_code::StructuralCallScalarReturnEvidence {
                        psi_edge: edge_id(1),
                ...
                internal_unit_calls: vec![InternalUnitCallRecord {
                    ...
                    semantic_result: Some(terminal_psi_to_abstract_operations::abstract_operations::AbstractResult {
                        value: result_value,
                        scalar_type: i32_scalar,
                    }),
                    structural_result: None,
                    scalar_arguments: Vec::new(),
                    arguments: vec![post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallArgumentRecord {
                        place: caller_place,
                        access: StructuralAccess::Owned,
                        path: Vec::new(),
...
pub(super) fn dynamic_conformance_table_plan() -> MachineCodePlan {
    ...
    let descriptor_placement = abstract_operations_to_target_operations::calling_conventions::ValuePlacement {
        shape: abstract_operations_to_target_operations::calling_conventions::ValueShape::integer(16, 8),
        locations: vec![abstract_operations_to_target_operations::calling_conventions::ValueLocation::Indirect {
            pointer: abstract_operations_to_target_operations::calling_conventions::IndirectPointerLocation::Register(
    ...
    let instance_source = abstract_operations_to_target_operations::target_operations::TargetStructuralArgument {
        place,
        access: StructuralAccess::SharedBorrow,
        path: Vec::new(),
        root_structural_type: structural_type,
        ...
        fixed_array_length: None,
        element_stride: None,
        source: abstract_operations_to_target_operations::target_operations::TargetStructuralArgumentSource::Placement(
            empty_placement.clone(),
        ),
        destination: descriptor_placement.clone(),
    };
    let dynamic_call = post_allocation_machine_to_selected_form_encoding::machine_code::DynamicCallRecord {
        psi_operation: operation,
        dynamic_dispatch: terminal_psi_to_abstract_operations::abstract_operations::AbstractReboundDynamicDispatch {
            initial,
            rebound,
        ...
        result: None,
        descriptor_abi: post_allocation_machine_to_selected_form_encoding::machine_code::DynamicTraitDescriptorAbiRecord {
        ...
        initial_instance: post_allocation_machine_to_selected_form_encoding::machine_code::DynamicInstanceMaterializationRecord {
            selection_ordinal: 0,
        ...
        table_address: post_allocation_machine_to_selected_form_encoding::machine_code::DynamicTableAddressMaterialization {
            code_offset: 22,
            byte_count: 12,
        ...
        rebound_instance: post_allocation_machine_to_selected_form_encoding::machine_code::DynamicInstanceMaterializationRecord {
            selection_ordinal: 1,
...
pub(super) fn dynamic_parameter_call_plan() -> MachineCodePlan {
    ...
    let policy = abstract_operations_to_target_operations::calling_conventions::CallingPolicy::native_for_target(target);
    ...
    caller.dynamic_parameter_calls = vec![post_allocation_machine_to_selected_form_encoding::machine_code::DynamicParameterCallRecord {
        psi_edge: edge_id(2),
        ...
        function_call_plan,
        dispatch_call_plan,
        instance: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rdi,
        table: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rsi,
        table_slot_byte_offset: 0,
        mechanism: post_allocation_machine_to_selected_form_encoding::machine_code::DynamicParameterCallMechanismRecord::X86MemoryIndirect {
            table: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rsi,
        },
...
pub(super) fn stored_dynamic_call_plan() -> MachineCodePlan {
    ...
    application.commitment = terminal_psi::closed_conformance_application_commitment(&application);
    let stored =
        terminal_psi_to_abstract_operations::abstract_operations::AbstractStoredDynamicDescriptor {
    ...
    let stored_call = post_allocation_machine_to_selected_form_encoding::machine_code::StoredDynamicCallRecord {
        establishment: post_allocation_machine_to_selected_form_encoding::machine_code::StoredDynamicDescriptorMaterializationRecord {
            ...
            descriptor_home_byte_offset: 0,
            instance: post_allocation_machine_to_selected_form_encoding::machine_code::DynamicInstanceMaterializationRecord {
                selection_ordinal: 0,
                source: instance_source,
                source_home_byte_offset: 0,
                source_home_indirect: false,
        ...
        dynamic_dispatch: terminal_psi_to_abstract_operations::abstract_operations::AbstractStoredDynamicDispatch {
            stored,
...
pub(super) fn forwarded_dynamic_parameter_call_plan() -> MachineCodePlan {
    ...
    callee.dynamic_parameter_calls = vec![post_allocation_machine_to_selected_form_encoding::machine_code::DynamicParameterCallRecord {
        psi_edge: edge_id(1),
        psi_operation: operation_id(1),
    ...
    forwarder.forwarded_dynamic_parameter_calls =
        vec![post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicParameterCallRecord {
            psi_edge: edge_id(2),
            psi_operation: operation_id(2),
            source_value: Some(semantic_vocabulary::ValueId::new(91).expect("forwarded result")),
            scalar_type: Some(i32_type),
            callee: machine_id(1),
            argument: terminal_psi_to_abstract_operations::abstract_operations::AbstractDynamicDescriptorArgument {
                ...
                source: terminal_psi_to_abstract_operations::abstract_operations::AbstractDynamicDescriptorSource::Parameter(
            ...
            instance: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rdi,
            table: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rsi,
            instance_destination: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rdi,
            table_destination: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rsi,
            direct_call_offset: 1,
            direct_call_byte_count: 5,
            call_stack: post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicParameterCallStackEvidence::Scalar(
                call_stack,
            ),
            operation_ordinal: 0,
            code_offset: 0,
...
pub(super) fn forwarded_dynamic_descriptor_call_plan() -> MachineCodePlan {
    ...
    let structural_type = StructuralTypeId::new(1).expect("structural type");
    let pointer = ValueShape::integer(8, 8);
    let policy = abstract_operations_to_target_operations::calling_conventions::CallingPolicy::native_for_target(NativeTarget::linux_x64());
    let call_plan =
        abstract_operations_to_target_operations::calling_conventions::evaluate_call_plan(
            policy,
            &abstract_operations_to_target_operations::calling_conventions::CallSignature {
    ...
    application.report_fingerprint =
        terminal_psi::closed_conformance_application_report_fingerprint(&application);
    application.commitment = terminal_psi::closed_conformance_application_commitment(&application);
    let adapter = post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicDescriptorAdapterRecord {
        identity: post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicDescriptorAdapterIdentity {
    ...
    let argument = post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicDescriptorArgumentRecord {
        custody: terminal_psi_to_abstract_operations::abstract_operations::AbstractDynamicDescriptorArgument {
            argument: terminal_psi::TerminalDynamicDescriptorArgument {
                owner,
                operation,
                parameter_ordinal: 0,
            ...
            source: terminal_psi_to_abstract_operations::abstract_operations::AbstractDynamicDescriptorSource::Selection {
                selection: terminal_psi::TerminalDynamicConformanceSelection {
                    owner,
                    ordinal: 0,
                    source: StructuralArgument {
        ...
        instance: abstract_operations_to_target_operations::target_operations::TargetDynamicDescriptorInstanceArgument {
            place,
            access: StructuralAccess::SharedBorrow,
            path: Vec::new(),
            root_structural_type: structural_type,
    ...
    caller.forwarded_dynamic_descriptor_calls =
        vec![post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicDescriptorCallRecord {
            psi_operation: operation,
            semantic_result: None,
            result: None,
            callee: machine_id(1),
