...
use resolved_layout_to_resolved_layout::object_file::object_symbol_name;
...
pub(super) fn linux_write_line_exit_plan(provider: &WriteExitProvider) -> MachineCodePlan {
    ...
    let (write_bytes, data) =
        ...
        .unwrap();
    let exit_bytes =
        target_operations_to_selected_instructions::isa_x86_64::encode_hosted_exit_process_i32(37);
        ...
        functions: vec![MachineCodeFunction {
            ...
            boundary_settlements: vec![
                BoundarySettlementRecord {
                    ...
                    realization: abstract_operations_to_target_operations::target_operations::LinuxWriteLineRealization.into(),
                    scalar_arguments: Vec::new(),
                    runtime_scalar_arguments: Vec::new(),
                    arguments: vec![structural_argument.clone()],
                    byte_sequence_arguments: vec![
                        post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryByteSequenceArgumentRecord {
                ...
                BoundarySettlementRecord {
                    ...
                    execution: post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryExecutionRecord::CompilerBuiltin(
...
pub(super) fn windows_foreign_call_plan(provider: &WriteExitProvider) -> MachineCodePlan {
    ...
    .clone();
    let save_bytes =
        target_operations_to_selected_instructions::isa_x86_64::encode_stmxcsr_rsp_displacement(16)
            .expect("MXCSR save encoding");
    let restore_bytes =
        target_operations_to_selected_instructions::isa_x86_64::encode_ldmxcsr_rsp_displacement(16)
            .expect("MXCSR restore encoding");
    ...
    MachineCodePlan {
        ...
        functions: vec![MachineCodeFunction {
            ...
            x86_floating_control: None,
            unit_stack: Some(UnitStackEvidence {
                frame: Some(post_allocation_machine_to_selected_form_encoding::machine_code::StackAdjustmentPair {
                    byte_size: 32,
                    allocation_offset: 0,
            ...
            scalar_stack: None,
            internal_calls: Vec::new(),
            foreign_calls: vec![post_allocation_machine_to_selected_form_encoding::machine_code::ForeignCallRelocation {
                ...
                scalar_result: None,
                x86_floating_control: Some(post_allocation_machine_to_selected_form_encoding::machine_code::X86ForeignCallFloatingControlRecord {
                    target,
                ...
                unit_stack: post_allocation_machine_to_selected_form_encoding::machine_code::UnitCallStackEvidence {
                    outbound: Some(post_allocation_machine_to_selected_form_encoding::machine_code::StackAdjustmentPair {
                        byte_size: 40,
...
pub(super) fn linux_foreign_call_plan(provider: &WriteExitProvider) -> MachineCodePlan {
    ...
    bytes.push(0xc3);
    let provider_plan_commitment =
        abstract_operations_to_target_operations::task_plans::SameStackProviderPlanCommitment::from_digest([9; 32]);
    let same_stack_contribution = abstract_operations_to_target_operations::task_plans::admit_same_stack_contribution(
        abstract_operations_to_target_operations::task_plans::SameStackContributionAdmissionCandidate {
            provider_plan_report_identity: provider.provider_plan_report_identity(),
            provider_plan_commitment,
...
pub(super) fn port_effect_plan(provider: &WriteExitProvider) -> MachineCodePlan {
    ...
    bytes.extend_from_slice(&resolved_layout_to_resolved_layout::image_emission::x86_encoding::encode_immediate_port_write(0x40, 0x50));
...
pub(super) fn artifact_symbol(
    artifact: &resolved_layout_to_resolved_layout::image_emission::ObjectArtifact,
) -> &str {
...
pub(super) fn structural_return_plan() -> MachineCodePlan {
    ...
    let install = |function: &mut MachineCodeFunction,
        ...
        function.structural_return = Some(post_allocation_machine_to_selected_form_encoding::machine_code::StructuralReturnRecord {
            psi_edge: edge,
...
pub(super) fn callback_private_plan() -> post_allocation_machine_to_selected_form_encoding::machine_code::MachineCodePlanWithPrivateFunctions{
    let target = NativeTarget::linux_x64();
    ...
    function.bytes = vec![0x48, 0x89, 0xf8, 0xc3];
    post_allocation_machine_to_selected_form_encoding::machine_code::MachineCodePlanWithPrivateFunctions {
        plan: two_function_plan(),
        private_functions: vec![post_allocation_machine_to_selected_form_encoding::machine_code::CompilerPrivateMachineCodeFunction {
...
pub(super) fn x86_fma_plan(profile: TargetProfile, format: X86ScalarFmaFormat) -> MachineCodePlan {
    ...
    let emitted =
        resolved_layout_to_resolved_layout::machine_emission::emit_feature_required_x86_scalar_fma(
            requirement,
            profile.native_target(),
            format,
            abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Xmm(
                0,
            ),
            abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Xmm(
                1,
...
pub(super) fn refresh_x86_fma_identity(
    fragment: &mut post_allocation_machine_to_selected_form_encoding::machine_code::X86ScalarFmaFragment,
) {
        ...
        functions: vec![
            ...
            MachineCodeFunction {
                ...
                internal_calls: vec![InternalCallRelocation {
                    owner: abstract_operations_to_target_operations::target_operations::CallSiteOwner::Operation(operation_id(2)),
                    target: machine_id(1),
                    unit_stack: None,
                    scalar_stack: None,
                    offset: call_offset,
...
fn second_callback_private() -> post_allocation_machine_to_selected_form_encoding::machine_code::CompilerPrivateMachineCodeFunction{
...
fn fragment_route_materializes_private_functions_after_the_program_text() {
    ...
    let artifact = resolved_layout_to_resolved_layout::image_emission::build_function_fragment_object_artifact_with_private_functions(
    ...
    for (private, carrier) in roster.iter().zip(artifact.private_functions()) {
        ...
        assert_eq!(
            symbol.kind,
            resolved_layout_to_resolved_layout::object_file::SymbolKind::Function
        );
        assert_eq!(
            symbol.section,
            resolved_layout_to_resolved_layout::object_file::SymbolSection::Section(
                resolved_layout_to_resolved_layout::object_file::SectionKind::Text
            )
        );
    ...
    resolved_layout_to_resolved_layout::image_emission::validate_function_fragment_object_artifact_with_private_functions(
        &compiled.container,
        &artifact,
        &roster,
    )
...
fn fragment_route_rejects_foreign_duplicate_or_substituted_private_functions() {
    ...
    assert!(matches!(
        ...
        Err(
            resolved_layout_to_resolved_layout::image_emission::FunctionFragmentObjectArtifactError::PrivateFunctions(
                resolved_layout_to_resolved_layout::image_emission::ObjectError::InvalidPrivateFunctionIdentity
            )
        )
    ));
    ...
    assert!(matches!(
        ...
        Err(
            resolved_layout_to_resolved_layout::image_emission::FunctionFragmentObjectArtifactError::PrivateFunctions(
                resolved_layout_to_resolved_layout::image_emission::ObjectError::PrivateFunctionSymbolCollision
            )
        )
    ));
    let artifact = resolved_layout_to_resolved_layout::image_emission::build_function_fragment_object_artifact_with_private_functions(
