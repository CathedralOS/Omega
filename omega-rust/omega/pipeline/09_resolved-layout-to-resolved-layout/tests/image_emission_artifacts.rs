...
#[path = "image_emission_artifacts/acyclic_control_flow.rs"]
mod acyclic_control_flow;
#[path = "image_emission_artifacts/dynamic_and_cleanup_plans.rs"]
mod dynamic_and_cleanup_plans;
#[path = "image_emission_artifacts/fragment_container.rs"]
mod fragment_container;
#[path = "image_emission_artifacts/hosted_exit_runtime.rs"]
mod hosted_exit_runtime;
#[path = "image_emission_artifacts/hosted_receiver.rs"]
mod hosted_receiver;
#[path = "image_emission_artifacts/installation_field_substitution_fields.rs"]
mod installation_field_substitution_fields;
#[path = "image_emission_artifacts/installation_field_substitutions.rs"]
mod installation_field_substitutions;
#[path = "image_emission_artifacts/installation_function_nested_custody.rs"]
mod installation_function_nested_custody;
#[path = "image_emission_artifacts/installation_function_nested_custody_fields.rs"]
mod installation_function_nested_custody_fields;
#[path = "image_emission_artifacts/installation_records.rs"]
mod installation_records;
#[path = "image_emission_artifacts/installed_artifact.rs"]
mod installed_artifact;
#[path = "image_emission_artifacts/macho_fixups.rs"]
mod macho_fixups;
#[path = "image_emission_artifacts/macho_storage.rs"]
mod macho_storage;
#[path = "image_emission_artifacts/object_custody.rs"]
mod object_custody;
#[path = "image_emission_artifacts/object_replays.rs"]
mod object_replays;
#[path = "image_emission_artifacts/provider_and_call_plans.rs"]
mod provider_and_call_plans;
#[path = "image_emission_artifacts/provider_execution.rs"]
mod provider_execution;
#[path = "image_emission_artifacts/requested_executable_route.rs"]
mod requested_executable_route;
#[path = "image_emission_artifacts/scalar_plans.rs"]
mod scalar_plans;
