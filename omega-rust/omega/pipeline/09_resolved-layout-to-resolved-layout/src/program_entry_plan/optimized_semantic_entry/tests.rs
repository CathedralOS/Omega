...
fn semantic_application(
    ...
    OptimizedProgramStorageSemanticCallingApplication::new(
        ...
        abstract_operations_to_target_operations::effects::provider_plan::BoundaryCallingPlanCommitment::from_digest(
...
fn physical_contract(
    ...
    ProgramEntryPhysicalContractPlan::new(
        ...
        crate::program_entry_plan::ProgramEntryPhysicalContractPackageSourceDigest::from_package_source(
            target::ProgramEntryPhysicalContractPackage::UefiX64,
...
fn extent_layout(base: u32) -> crate::program_entry_plan::ProgramEntrySourceExtentValueLayout {
    crate::program_entry_plan::ProgramEntrySourceExtentValueLayout::from_checked_record(
...
fn exact_granted_claims_and_semantic_fingerprint_are_required() {
    ...
    stale_commitment.calling_plan_commitment =
        Some(abstract_operations_to_target_operations::effects::provider_plan::BoundaryCallingPlanCommitment::from_digest([0x42; 32]));
