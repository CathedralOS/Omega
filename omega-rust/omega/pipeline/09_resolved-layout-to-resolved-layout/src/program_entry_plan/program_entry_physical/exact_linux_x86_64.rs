...
/// Canonical checked-tree overload identity for `LinuxX86_64PhysicalEntry::enter`.
pub const LINUX_X86_64_PHYSICAL_REQUIREMENT_IDENTITY: &str = concat!(
    "named-callable(path(LinuxX86_64PhysicalEntry::enter),parameters(",
...
pub fn exact_linux_x86_64_physical_boundary_entry_plan() -> ValidatedBoundaryEntryPlan {
    ...
    let plan = BoundaryEntryPlan {
        call: CallPlan {
            policy: abstract_operations_to_target_operations::calling_conventions::CallingPolicy::SystemVAMD64,
...
mod tests {
    ...
    use crate::program_entry_plan::ProgramEntryPhysicalContractPackageSourceDigest;
    ...
    fn physical_plan_is_exact_kernel_arrival_shape() {
        ...
        assert_eq!(
            ...
            &[abstract_operations_to_target_operations::calling_conventions::ValueLocation::Register {
                register: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rsp,
                value_byte_offset: 0,
                byte_size: 8,
            }]
        );
        ...
        assert_eq!(
            ...
            &[abstract_operations_to_target_operations::calling_conventions::ValueLocation::Register {
                register: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rdi,
                value_byte_offset: 0,
                byte_size: 4,
            }]
        );
        assert_eq!(
            call.entry_control,
            abstract_operations_to_target_operations::calling_conventions::EntryControl::SupervisorCall {
                number_register: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rax,
                immediate: 231,
            }
        );
        ...
        assert_eq!(
            ...
            abstract_operations_to_target_operations::calling_conventions::EntryStack::ProviderSelected
        );
        assert_eq!(
            plan.plan().state.initial_regime,
            abstract_operations_to_target_operations::calling_conventions::MachineRegime::X86Long64
        );
    }
}
