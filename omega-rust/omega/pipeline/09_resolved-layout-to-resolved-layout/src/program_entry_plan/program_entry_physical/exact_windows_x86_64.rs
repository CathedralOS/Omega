...
mod tests {
    ...
    fn exact_runtime_contract_replays_all_owned_fields() {
        ...
        placement_drift
            ...
            .locations[0] = abstract_operations_to_target_operations::calling_conventions::ValueLocation::Register {
            register: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rcx,
            value_byte_offset: 0,
            byte_size: 4,
        };
    ...
    fn physical_plan_is_exact_loader_arrival_shape() {
        ...
        assert_eq!(
            call.entry_control,
            abstract_operations_to_target_operations::calling_conventions::EntryControl::CallReturn
        );
