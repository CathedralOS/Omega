...
mod tests {
    ...
    fn physical_plan_is_exact_dyld_arrival_shape() {
        ...
        let expected_registers = [
            abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rdi,
            abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rsi,
