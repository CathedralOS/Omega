...
impl ProgramEntryPhysicalContractPlan {
    pub fn new(
        ...
        let (expected_policy, parameter_count, guaranteed_entry_stack) = match (
            ...
            ) => (abstract_operations_to_target_operations::calling_conventions::CallingPolicy::Aapcs64, 4, None),
            ...
            ) => (abstract_operations_to_target_operations::calling_conventions::CallingPolicy::SystemVAMD64, 4, None),
            ...
            (
                ...
                Some(target::ProgramEntryCallingConvention::SystemVAMD64),
            ) => (abstract_operations_to_target_operations::calling_conventions::CallingPolicy::SystemVAMD64, 1, None),
            ...
            (
                ...
                Some(target::ProgramEntryCallingConvention::Aapcs64),
            ) => (abstract_operations_to_target_operations::calling_conventions::CallingPolicy::Aapcs64, 1, None),
            ...
            (
                ...
                Some(target::ProgramEntryCallingConvention::MicrosoftX64),
            ) => (abstract_operations_to_target_operations::calling_conventions::CallingPolicy::MicrosoftX64, 0, None),
            _ => {
                return Err(
