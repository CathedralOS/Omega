...
pub fn exact_linux_arm64_physical_boundary_entry_plan() -> ValidatedBoundaryEntryPlan {
    ...
    let plan = BoundaryEntryPlan {
        call: CallPlan {
            policy: abstract_operations_to_target_operations::calling_conventions::CallingPolicy::Aapcs64,
    ...
    fn physical_plan_is_exact_kernel_arrival_shape() {
        ...
        assert_eq!(
            ...
            abstract_operations_to_target_operations::calling_conventions::EntryControl::SupervisorCall {
                number_register: abstract_operations_to_target_operations::calling_conventions::MachineRegister::Aarch64X(8),
                immediate: 94,
            }
        );
        ...
        assert_eq!(
            ...
            abstract_operations_to_target_operations::calling_conventions::MachineRegime::Aarch64A64 { exception_level: 0 }
        );
    }
}
