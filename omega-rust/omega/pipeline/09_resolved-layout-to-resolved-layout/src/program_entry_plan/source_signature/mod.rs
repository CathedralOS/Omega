...
use crate::program_entry_plan::ProgramStorageEntryRootRole;
...
impl ProgramEntrySourceExtentValueLayout {
    ...
    pub fn from_checked_record(
        ...
        base_offset: u16,
        base_shape: abstract_operations_to_target_operations::calling_conventions::ValueShape,
        length_symbol: symbols::SymbolHandle,
        length_offset: u16,
        length_shape: abstract_operations_to_target_operations::calling_conventions::ValueShape,
        shape: abstract_operations_to_target_operations::calling_conventions::ValueShape,
    ) -> Result<Self, String> {
        let layout = Self {
            data_symbol,
    ...
    fn validate_capture(&self) -> Result<(), String> {
        ...
        if !self.data_symbol.is_valid()
            || self.shape != abstract_operations_to_target_operations::calling_conventions::ValueShape::integer(16, 8)
    ...
    pub fn validate_backend_layout(
        ...
        let crate::layout::DataShape::Record { fields } = layout.shape else {
...
pub struct ProgramEntrySourceVisibleParameterSignature {
    ...
    value_shape: abstract_operations_to_target_operations::calling_conventions::ValueShape,
...
impl SelectedProgramEntrySourceSignature {
    ...
    pub fn validate_program_storage_binding(
        ...
        continuation_key: abstract_operations_to_target_operations::function_identity::StateKey,
