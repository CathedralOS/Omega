...
use crate::image_elf::dynamic_executable::load_placement::placed_section_headers::ValidatedElfPlacedSectionHeaderTable;
...
) -> Result<&crate::image_elf::dynamic_executable::section_headers::section_payload_roster::ElfIndexedSectionPayloadRow, Diagnostic>{
    indexed
        .contents()
        .rows
