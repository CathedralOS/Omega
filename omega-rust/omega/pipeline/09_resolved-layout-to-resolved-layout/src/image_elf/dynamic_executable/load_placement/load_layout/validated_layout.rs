...
use crate::image_elf::dynamic_executable::load_placement::load_layout::abi_validation::retained_image;
...
impl ValidatedElfDynamicLoadLayout {
    ...
    pub const fn final_image_layout(&self) -> crate::image::FinalImageLayout {
    ...
    pub(crate) fn retained_image(&self) -> &crate::image::FinalImage {
