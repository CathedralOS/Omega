...
use crate::image_elf::dynamic_executable::import_sections::dynamic_section_descriptors::ElfDynamicSectionKind;
use crate::image_elf::dynamic_executable::procedure_linkage::dynamic_linkage_descriptors::{
    ElfProcedureLinkageSectionInfo, ElfProcedureLinkageSectionKind, ElfProcedureLinkageSectionLink,
};
use crate::image_elf::dynamic_executable::section_headers::section_name_table::{
...
fn base_descriptor_contents(
    section_names: &ValidatedElfSectionNameTablePlan,
) -> &crate::image_elf::dynamic_executable::import_sections::dynamic_section_descriptors::ElfDynamicSectionDescriptorContents{
    section_names
        .dynamic_table()
        .payload()
        .plan()
...
fn linkage_descriptor_contents(
    section_names: &ValidatedElfSectionNameTablePlan,
) -> &crate::image_elf::dynamic_executable::procedure_linkage::dynamic_linkage_descriptors::ElfProcedureLinkageSectionDescriptorContents{
    section_names
        .dynamic_table()
        .payload()
        .plan()
