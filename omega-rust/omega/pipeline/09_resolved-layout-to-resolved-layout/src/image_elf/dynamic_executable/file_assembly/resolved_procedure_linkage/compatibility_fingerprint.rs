...
const fn image_section_tag(section: crate::image::FinalImageSection) -> u8 {
    match section {
        crate::image::FinalImageSection::Text => 1,
        crate::image::FinalImageSection::Data => 2,
        crate::image::FinalImageSection::Bss => 3,
        crate::image::FinalImageSection::None => 4,
    }
}
