...
use crate::image_elf::dynamic_executable::checked::require;
use crate::image_elf::dynamic_executable::file_assembly::dynamic_file_envelope::ValidatedElfDynamicFileEnvelope;
use crate::image_elf::dynamic_executable::file_assembly::resolved_procedure_linkage::candidates::ElfResolvedProcedureLinkageContents;
use crate::image_elf::dynamic_executable::file_assembly::resolved_procedure_linkage::{
...
use crate::image_elf::dynamic_executable::load_placement::load_layout::{
    ElfPlacedDynamicSection, ElfPlacedDynamicSectionKind, ValidatedElfDynamicLoadLayout,
};
use crate::image_elf::dynamic_executable::procedure_linkage::dynamic_linkage_templates::{
    ElfProcedureLinkageFixupKind, ElfProcedureLinkageSemanticTarget,
};
use crate::image_elf::dynamic_executable::section_headers::section_payload_roster::{
    ElfIndexedProcedureFixup, ElfIndexedProcedureFixupStorage, ElfIndexedSectionPayloadContents,
};
use crate::image_elf::dynamic_executable::section_headers::section_roster::ElfDynamicRosterSectionKind;
...
pub(crate) fn semantic_target_address(
    ...
    } = fixup.target
    {
        let base = match section {
            crate::image::FinalImageSection::Text => layout.image_memory().text_virtual_address(),
            crate::image::FinalImageSection::Data => layout.image_memory().data_virtual_address(),
            crate::image::FinalImageSection::Bss => layout.image_memory().bss_virtual_address(),
            crate::image::FinalImageSection::None => {
