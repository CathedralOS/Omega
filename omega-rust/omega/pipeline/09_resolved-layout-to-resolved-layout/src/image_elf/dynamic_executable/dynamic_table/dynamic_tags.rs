...
use crate::image_elf::dynamic_executable::checked::{
    checked_product, checked_sum, checked_u32, require,
};
...
fn dynamic_payloads(
    descriptors: &ValidatedElfProcedureLinkageSectionDescriptorPlan,
) -> &crate::image_elf::dynamic_executable::import_sections::dynamic_section_bytes::ValidatedElfDynamicSectionPayloads{
    descriptors.templates().linkage().descriptors().payloads()
}

fn structural_contents(
    descriptors: &ValidatedElfProcedureLinkageSectionDescriptorPlan,
) -> &crate::image_elf::dynamic_executable::import_sections::dynamic_sections::ElfDynamicSectionContents{
