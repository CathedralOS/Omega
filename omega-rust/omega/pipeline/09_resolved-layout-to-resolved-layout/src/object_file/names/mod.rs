...
//! [`object_target_policy`](crate::object_file::object_target_policy) matrix rather than
...
pub fn object_symbol_handle_by_foreign_locator(
    ...
    if symbol.kind == crate::object_file::SymbolKind::Import
...
pub fn object_function_symbol(
    ...
    (symbol.kind == crate::object_file::SymbolKind::Function
