...
use post_allocation_machine_to_selected_form_encoding::machine_code::TextSectionRelocationRequirements;
pub fn construct_relocation_free_object_from_text(
    text: &post_allocation_machine_to_selected_form_encoding::machine_code::RelocationFreeTextSectionPlacement,
...
mod tests {
    ...
    fn text_with_target(target: NativeTarget) -> RelocationFreeTextSectionPlacement {
        ...
        RelocationFreeTextSectionPlacement {
            ...
            section_alignment: crate::object_file::object_target_policy(target)
    ...
    fn construction_declares_sorted_imports_and_binds_unresolved_fields() {
        ...
        text.unresolved_normalized_foreign_calls = vec![
            post_allocation_machine_to_selected_form_encoding::machine_code::PlacedNormalizedForeignCallResolution {
                kind: post_allocation_machine_to_selected_form_encoding::machine_code::NormalizedForeignCallResolutionKind::X86Relative32FromNextInstructionToNormalizedForeignImportV1,
                state: post_allocation_machine_to_selected_form_encoding::machine_code::NormalizedForeignCallResolutionState::UnresolvedImportFieldV1,
                caller: machine,
                block: target_operations_to_selected_instructions::SelectedBlockId(0),
        ...
        assert_eq!(
            ...
            crate::object_file::RelocationFreeObjectRelocationRequirements::UnresolvedNormalizedForeignImportFieldsV1
        );
        ...
        assert_eq!(
            crate::object_file::validate_relocation_free_object_from_text(
                &text,
                OptimizationSelectionIdentity::from_bytes([6; 32]),
                &object,
            ),
        ...
        let container = crate::object_file::encode_relocation_free_object(&object).unwrap();
        assert_eq!(
            crate::object_file::decode_relocation_free_object(&container.bytes),
            Ok(object)
        );
    }
