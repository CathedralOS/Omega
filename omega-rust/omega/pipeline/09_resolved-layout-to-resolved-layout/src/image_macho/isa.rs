...
use abstract_operations_to_target_operations::calling_conventions::StateFootprintEvidence;
...
impl MachoIsa {
    ...
    pub(crate) fn import_thunk_size(self) -> usize {
        match self {
            Self::Aarch64 => 12,
            Self::X86_64 => target_operations_to_selected_instructions::isa_x86_64::X86_64_IMPORT_THUNK_BYTE_COUNT,
        }
    }
    ...
    pub(crate) fn apply_relocations(
        ...
        match self {
            Self::Aarch64 => crate::image::apply_aarch64_relocations(image, layout, output_name),
            Self::X86_64 => crate::image::apply_x86_64_relocations(image, layout, output_name),
        }
    }
    ...
    pub(crate) fn thunk_footprint(self) -> StateFootprintEvidence {
        match self {
            Self::Aarch64 => StateFootprintEvidence::new(
                abstract_operations_to_target_operations::calling_conventions::RegisterSet::new([
                    abstract_operations_to_target_operations::calling_conventions::MachineRegister::Aarch64X(16),
                ]),
                abstract_operations_to_target_operations::calling_conventions::MachineStateSet::new([
                    abstract_operations_to_target_operations::calling_conventions::MachineState::InstructionPointer,
                ]),
            ),
            Self::X86_64 => target_operations_to_selected_instructions::isa_x86_64::x86_64_import_thunk_footprint(),
        }
    }
}
