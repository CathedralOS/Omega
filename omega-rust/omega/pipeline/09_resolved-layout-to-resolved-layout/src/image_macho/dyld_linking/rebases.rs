...
impl MachoRebaseInfo {
    pub(crate) fn validate_patched_preferred_pointers(
    ...
    ) -> Result<Vec<crate::image_macho::MachoRebasePointer>, Diagnostic> {
        ...
        for site in &self.sites {
            ...
            pointers.push(crate::image_macho::MachoRebasePointer {
...
mod tests {
    ...
    fn preferred_pointer_replay_rejects_mutated_patched_bytes() {
        ...
        crate::image::apply_aarch64_relocations(&mut image, &layout, "test Mach-O")
