use crate::image_macho::file_layout::bytes::{write_fixed_string_16, write_u32, write_u64};
use crate::image_macho::file_layout::constants::{
    MACHO_EXECUTABLE_BASE, MACHO_SECTION_SIZE, MACHO_SEGMENT_COMMAND_SIZE,
};
use crate::image_macho::file_layout::layout::{align_to_u64, alignment_power};
