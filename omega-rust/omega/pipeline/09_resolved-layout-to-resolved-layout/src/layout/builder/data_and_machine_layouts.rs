...
use crate::layout::builder::private_callback_closure::close_private_callback_demands;
use crate::layout::builder::semantic_ranges::canonical_plan_laid_data_identity;
...
use abstract_operations_to_target_operations::calling_conventions::{
    callback_layout_plan_id, callback_plan_laid_layout_id,
};
...
impl<'program> LayoutBuilder<'program> {
    pub(crate) fn compute_data_layout(
            ...
            .find(|plan| definition.symbol == plan.data_symbol)
        {
            ...
            let native_layout_report_fingerprint =
                terminal_psi::layout_plans::normalized_native_layout_plan_report_fingerprint(
    ...
    fn compute_case_bearing_layout(
        ...
        const TAG_LAYOUT: TypeLayout = TypeLayout {
            size: crate::layout::ENUM_TAG_BYTES,
            alignment: crate::layout::ENUM_TAG_BYTES,
        };
