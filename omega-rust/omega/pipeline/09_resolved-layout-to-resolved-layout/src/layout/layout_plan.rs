...
pub struct TargetClosedPrivateCallbackDemand {
    ...
    pub slot_application: symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::ClosedConformanceApplication,
    pub slot_identity: Arc<str>,
    pub layout_subject_identity: Arc<str>,
    pub callback_requirement_identity: Arc<str>,
    pub layout: abstract_operations_to_target_operations::calling_conventions::LayoutPlanId,
    pub slot: abstract_operations_to_target_operations::calling_conventions::LayoutSlotId,
    pub requirement: abstract_operations_to_target_operations::calling_conventions::CallbackRequirementId,
    pub offset: usize,
    pub byte_size: usize,
    pub alignment: usize,
}
...
pub struct TargetClosedTwoHopPrivateCallbackPath {
    ...
    pub field_slot: abstract_operations_to_target_operations::calling_conventions::LayoutSlotId,
...
impl TargetClosedTwoHopPrivateCallbackPath {
    pub fn native_demand(
        &self,
        parameter: abstract_operations_to_target_operations::calling_conventions::NativeParameterId,
    ) -> abstract_operations_to_target_operations::calling_conventions::NativeCallbackDemand {
        abstract_operations_to_target_operations::calling_conventions::NativeCallbackDemand {
            destination:
                abstract_operations_to_target_operations::calling_conventions::NativePlace::Field {
                    parameter,
