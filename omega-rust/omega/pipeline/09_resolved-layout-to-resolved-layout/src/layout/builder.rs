...
use crate::layout::builder::generic_bindings::GenericLayoutBinding;
use crate::layout::builder::generic_bindings::binding_for_type;
use crate::layout::builder::generic_bindings::fixed_array_length;
use crate::layout::builder::private_callback_closure::close_two_hop_private_callback_paths;
use crate::layout::sizing::fat_descriptor_layout;
use crate::layout::{
...
use crate::representation_selections::OpaqueRepresentationSelection;
use arena::Arena;
...
use typed_trees_to_checked_trees::checked_trees::trait_definition::TraitDefinition;
...
pub fn build_layout_plan(
    ...
    let proof_only =
        typed_trees_to_checked_trees::checked_trees::proof_only::classify(&program.typed);
            ...
            TypeReferenceNode::Constrained {
                ...
                let has_named_domain = constraint_list.iter().any(|constraint| match constraint {
                    TypeConstraintNode::Domain(name) => {
                        !typed_trees_to_checked_trees::checked_trees::wire::is_layout_domain_constraint(name)
