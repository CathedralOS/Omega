...
use crate::image::symbols::{final_image_section, final_image_symbol_handle};
use crate::object_file::{ObjectPlan, RelocationPlan, SectionKind, SymbolKind, SymbolSection};
use arena::Handle;
    ...
    image
        ...
        .insert_many(relocations.records().map(|(_, relocation)| {
            ...
            FinalImageRelocation {
                section: final_image_section(crate::object_file::SymbolSection::Section(
                    relocation.section,
                )),
