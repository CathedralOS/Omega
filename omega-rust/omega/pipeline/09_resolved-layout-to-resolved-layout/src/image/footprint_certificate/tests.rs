...
fn placed_inventory() -> (crate::image::FinalImage, PlacedExecutableRegionInventory) {
    let mut image = crate::image::FinalImage::with_capacity(
        NativeTarget::host(),
        crate::image::FinalImageMemory {
            text: (0usize..8).map(|index| (index * 7 + 3) as u8).collect(),
            ..crate::image::FinalImageMemory::default()
        },
        Default::default(),
        0,
        0,
    ...
    image.executable_regions.extend([
        crate::image::FinalExecutableRegion {
            origin: crate::image::FinalExecutableRegionOrigin::CompilerFunction,
            section_offset: 0,
            byte_count: 4,
            symbol: "entry".into(),
        ...
        crate::image::FinalExecutableRegion {
            origin: crate::image::FinalExecutableRegionOrigin::ImportThunk,
            section_offset: 4,
            byte_count: 4,
    ...
    let inventory = crate::image::place_executable_regions(
        &image,
        crate::image::FinalImageLayout {
            text_address: 0x1000,
            ..crate::image::FinalImageLayout::default()
        },
    )
...
fn entry_footprint_binding(
    ...
    let mut binding = CompilerEntryFootprintBindingEvidence {
        entry_region_evidence_digest: crate::image::CompilerEntryRegionBindingDigest::from_digest(
            [20; 32],
        ),
        entry_region_evidence_report_fingerprint: 20,
        final_region_binding_report_fingerprint: 19,
        prior_inventory_digest: crate::image::PlacedExecutableRegionInventoryDigest::from_digest(
            [12; 32],
        ),
        prior_inventory_report_fingerprint: 12,
        footprint_digest: crate::image::StateFootprintEvidenceDigest::from_digest([2; 32]),
        ...
        evidence_digest: crate::image::CompilerEntryFootprintBindingDigest::from_digest([0; 32]),
...
fn reseal_nested(certificate: &mut FinalFootprintCertificate) {
    ...
    certificate.inventory.inventory_report_fingerprint =
        crate::image::final_image::executable_inventory_report_fingerprint(
    ...
    certificate.inventory.inventory_digest = crate::image::final_image::executable_inventory_digest(
        certificate.inventory.text_address,
        certificate.inventory.text_byte_count,
...
fn final_footprint_certificate_rejects_every_one_field_substitution() {
    ...
    mutated
        ...
        .evidence_digest =
        crate::image::CompilerEntryFootprintBindingDigest::from_digest([0xee; 32]);
    reseal_certificate(&mut mutated);
    ...
    mutated.inventory.inventory_digest =
        crate::image::PlacedExecutableRegionInventoryDigest::from_digest([0xee; 32]);
    reseal_certificate(&mut mutated);
    ...
    let mut mutated = authentic.clone();
    mutated.inventory.text_digest =
        crate::image::FinalExecutableTextDigest::from_digest([0xee; 32]);
    reseal(&mut mutated);
    ...
    mutated.inventory.regions[0].byte_digest =
        crate::image::PlacedExecutableRegionBytesDigest::from_digest([0xee; 32]);
    reseal(&mut mutated);
    ...
    let mut mutated = authentic.clone();
    mutated.inventory.regions[0].origin = crate::image::FinalExecutableRegionOrigin::ImportThunk;
    reseal(&mut mutated);
    ...
    mutated.inventory.regions.insert(
        1,
        crate::image::PlacedExecutableRegion {
            origin: crate::image::FinalExecutableRegionOrigin::ImportThunk,
            section_offset: 4,
            address: 0x1004,
            byte_count: 4,
            byte_digest: crate::image::PlacedExecutableRegionBytesDigest::from_digest([0xee; 32]),
    ...
    mutated
        .inventory
        .unclassified_gaps
        .push(crate::image::PlacedExecutableGap {
            section_offset: 8,
            address: 0x1008,
            byte_count: 1,
            byte_digest: crate::image::PlacedExecutableGapBytesDigest::from_digest([1; 32]),
    ...
    let mut mutated = authentic.clone();
    mutated.inventory = {
        let mut foreign_image = crate::image::FinalImage::with_capacity(
            NativeTarget::host(),
            crate::image::FinalImageMemory {
                text: vec![0x5a; 4],
                ..crate::image::FinalImageMemory::default()
        ...
        foreign_image
            .executable_regions
            .push(crate::image::FinalExecutableRegion {
                origin: crate::image::FinalExecutableRegionOrigin::CompilerFunction,
                section_offset: 0,
                byte_count: 4,
                symbol: "entry".into(),
        ...
        crate::image::place_executable_regions(
            &foreign_image,
            crate::image::FinalImageLayout::default(),
        )
...
fn final_footprint_certificate_compact_fields_stay_identity_bound() {
    ...
    mutated
        ...
        crate::image::CompilerEntryRegionBindingDigest::from_digest([0xee; 32]);
    reseal(&mut mutated);
    stays_identity_bound(
    ...
    mutated
        ...
        crate::image::PlacedExecutableRegionInventoryDigest::from_digest([13; 32]);
    reseal(&mut mutated);
    stays_identity_bound(
    ...
    mutated
        ...
        .as_mut()
        .expect("entry binding")
        .footprint_digest = crate::image::StateFootprintEvidenceDigest::from_digest([0xee; 32]);
    reseal(&mut mutated);
    stays_identity_bound(
...
fn compact_certificate_identity_cannot_substitute_strong_native_evidence() {
    ...
    substituted.inventory.inventory_digest =
        crate::image::PlacedExecutableRegionInventoryDigest::from_digest([99; 32]);
    ...
    let binding = substituted
        ...
        .as_mut()
        .expect("entry binding");
    binding.footprint_digest = crate::image::StateFootprintEvidenceDigest::from_digest([99; 32]);
    binding.evidence_digest = binding.recomputed_evidence_digest();
    assert_eq!(
        substituted.certificate_report_fingerprint,
        certificate.certificate_report_fingerprint
    ...
    binding.entry_region_evidence_digest =
        crate::image::CompilerEntryRegionBindingDigest::from_digest([98; 32]);
    assert_eq!(
