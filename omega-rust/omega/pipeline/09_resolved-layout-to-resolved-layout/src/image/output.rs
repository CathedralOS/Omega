...
pub struct ExecutableImageOutput {
    ...
    pub final_image_layout: crate::image::FinalImageLayout,
    ...
    pub executable_regions: crate::image::PlacedExecutableRegionInventory,
    ...
    pub data_regions: crate::image::PlacedDataRegionInventory,
    ...
    pub import_data_regions: crate::image::PlacedDataRegionInventory,
}
...
impl EmittedImageOutput {
    ...
    pub fn validate_final_initialized_data_relocation_envelope(
        ...
        crate::image::relocation_envelope::validate_final_initialized_data_relocation_envelope(
            encoded_data_bytes,
...
pub struct CompilerEntryRegionBindingEvidence {
    ...
    pub object_symbol_handle: crate::object_file::ObjectSymbolHandle,
    pub region_index: usize,
    pub symbol: String,
    pub section_offset: usize,
    pub address: u64,
    pub byte_count: usize,
    pub byte_digest: crate::image::PlacedExecutableRegionBytesDigest,
    /// Compact report compatibility only.
    pub byte_report_fingerprint: u64,
    pub inventory_digest: crate::image::PlacedExecutableRegionInventoryDigest,
    /// Compact report compatibility only.
...
pub struct CompilerEntryFootprintBindingEvidence {
    ...
    pub final_region_binding_report_fingerprint: u64,
    pub prior_inventory_digest: crate::image::PlacedExecutableRegionInventoryDigest,
    /// Compact report compatibility only.
    pub prior_inventory_report_fingerprint: u64,
    pub footprint_digest: crate::image::StateFootprintEvidenceDigest,
    /// Compact report compatibility only.
    pub footprint_report_fingerprint: u64,
    pub resulting_inventory_digest: crate::image::PlacedExecutableRegionInventoryDigest,
    /// Compact report compatibility only.
