...
pub struct FinalExecutableRegion {
    ...
    pub footprint: Option<
        abstract_operations_to_target_operations::calling_conventions::StateFootprintEvidence,
    >,
}
...
pub fn bind_compiler_entry_footprint(
    ...
    binding: &crate::image::CompilerEntryRegionBindingEvidence,
    final_region_binding_report_fingerprint: u64,
    footprint: abstract_operations_to_target_operations::calling_conventions::StateFootprintEvidence,
) -> Result<crate::image::CompilerEntryFootprintBindingEvidence, Diagnostic> {
    ...
    let mut evidence = crate::image::CompilerEntryFootprintBindingEvidence {
