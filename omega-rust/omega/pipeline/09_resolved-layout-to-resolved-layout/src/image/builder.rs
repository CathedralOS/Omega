...
use crate::image::final_image::{FinalImage, FinalImageMemory};
use crate::image::symbols::final_image_symbol_handle;
use crate::object_file::{ObjectPlan, RelocationPlan, SectionKind, SymbolKind};
...
pub fn build_final_image(input: FinalImageInput<'_>) -> FinalImage {
    ...
    copies::copy_object_data_regions(&mut image);
