...
struct Inputs<'a> {
    selected: &'a target_operations_to_selected_instructions::SelectedInstructionPlan,
    machine: &'a register_homes_to_post_allocation_machine::PostAllocationMachinePlan,
