...
pub(super) use post_allocation_machine_to_selected_form_encoding::machine_code::whole_function_exit_contract_identity as contract_identity;

#[cfg(test)]
mod tests {
    use optimization_core::Optimization;
    use register_homes_to_post_allocation_machine::Aarch64MovnMaterializationIdentity;
    ...
    fn contract_with_custody(
        ...
        let mut contract = WholeFunctionExitContract {
            ...
            post_allocation_machine:
                register_homes_to_post_allocation_machine::PostAllocationMachineIdentity::from_bytes([3; 32]),
            register_environment: target_operations_to_selected_instructions::register_model::TargetRegisterEnvironmentIdentity::from_bytes(
                [4; 32],
            ),
            physical_register_model: target_operations_to_selected_instructions::register_model::PhysicalRegisterModelIdentity::from_bytes(
                [5; 32],
            ),
    ...
    fn layout_custody_and_optimization_receipts_are_identity_bound() {
        ...
        framed.frame = WholeFunctionFrameDisposition::CanonicalFixedFrameV1 {
            layout: post_allocation_machine_to_selected_form_encoding::machine_code::TargetFrameLayoutIdentity::from_bytes([10; 32]),
            protocol: post_allocation_machine_to_selected_form_encoding::machine_code::TargetFrameProtocolEncodingIdentity::from_bytes([11; 32]),
        };
