...
use target_operations_to_selected_instructions::isa_aarch64::Aarch64FrameSlot;
use target_operations_to_selected_instructions::isa_x86_64::X86_64FrameSlot;

use crate::machine_emission::frame_layout::frame_unwind_policy;
        ...
        let (prologue, epilogue) = match codec {
            FrameProtocolCodec::X86_64 => {
                let slots = function
                    ...
                    .collect::<Vec<_>>();
                target_operations_to_selected_instructions::isa_x86_64::encode_system_v_amd64_frame_protocol(
                    environment.physical(),
                    committed_bytes,
                    target_operations_to_selected_instructions::isa_x86_64::X86_64StackProbe {
            ...
            FrameProtocolCodec::Aarch64 => {
                let slots = function
                    ...
                    .collect::<Vec<_>>();
                target_operations_to_selected_instructions::isa_aarch64::encode_aapcs64_frame_protocol(
                    environment.physical(),
                    committed_bytes,
                    target_operations_to_selected_instructions::isa_aarch64::Aarch64StackProbe {
                        interval_bytes: function.stack_probe.interval_bytes,
                        touches: function.stack_probe.touches,
                    },
                    &slots,
