...
pub use post_allocation_machine_to_selected_form_encoding::machine_code::target_frame_protocol_encoding_identity;
pub use validation::validate_target_frame_protocol_encoding;

use crate::machine_emission::frame_layout::{
    TargetFrameLayoutIdentity, ValidatedTargetFrameLayout,
};
...
pub struct ValidatedTargetFrameProtocolEncoding {
    pub(in crate::machine_emission::frame_protocol) plan:
        std::sync::Arc<TargetFrameProtocolEncodingPlan>,
    pub(in crate::machine_emission::frame_protocol) receipt: TargetFrameProtocolEncodingReceipt,
}
