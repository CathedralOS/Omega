...
pub enum TargetFrameProtocolEncodingError {
    ...
    X86(target_operations_to_selected_instructions::isa_x86_64::X86_64FrameProtocolError),
    Aarch64(target_operations_to_selected_instructions::isa_aarch64::Aarch64FrameProtocolError),
