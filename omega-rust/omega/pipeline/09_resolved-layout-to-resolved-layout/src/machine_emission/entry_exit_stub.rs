...
mod tests {
    ...
    fn emission_rejects_a_foreign_boundary_plan() {
        ...
        let other = evaluate_ordinary_boundary_entry_plan(
            ...
            &CallSignature {
                parameters: vec![abstract_operations_to_target_operations::calling_conventions::ValueShape::integer(8, 8)],
                result: None,
            },
        )
        .expect("ordinary boundary");
    ...
    fn indirect_boundary(
        shapes: &[abstract_operations_to_target_operations::calling_conventions::ValueShape],
    ...
    fn indirect_parameter_stages_copy_bytes_and_register_pointer() {
        let boundary = indirect_boundary(&[
            abstract_operations_to_target_operations::calling_conventions::ValueShape::integer(
                24, 8,
            ),
        ]);
        ...
        let abstract_operations_to_target_operations::calling_conventions::ValueLocation::Indirect {
            pointer: abstract_operations_to_target_operations::calling_conventions::IndirectPointerLocation::Register(pointer),
    ...
    fn borrowed_reference_pointer_still_rejects() {
        ...
        let boundary =
            indirect_boundary(&[abstract_operations_to_target_operations::calling_conventions::ValueShape::borrowed_reference(24, 8)]);
        let stub = stub(
            0,
            X86_64GateKind::Trap,
            X86_64ArrivalMechanism::Exception,
