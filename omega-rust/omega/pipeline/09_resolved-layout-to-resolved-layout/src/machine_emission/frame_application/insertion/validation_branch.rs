...
pub(super) fn validate(
    ...
    if let (Branch::Jump(source_branch), Branch::Jump(branch)) = (source_branch, branch) {
        ...
        let effects = match architecture {
            Architecture::X86_64 => target_operations_to_selected_instructions::isa_x86_64::validate_x86_64_selected_jump_form(
                physical,
            ...
            .encoded
            .clone(),
            Architecture::Aarch64 => target_operations_to_selected_instructions::isa_aarch64::validate_aarch64_selected_jump_form(
                physical,
                candidate.alternative,
                displacement,
                &candidate.bytes,
...
fn decode(
    ...
    (
        ...
        target_operations_to_selected_instructions::MachineEncodedEffects,
    ),
