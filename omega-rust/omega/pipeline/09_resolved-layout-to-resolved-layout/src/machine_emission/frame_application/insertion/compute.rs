...
fn shift_foreign_fixup(
    fixup: &mut post_allocation_machine_to_selected_form_encoding::machine_code::FunctionFragmentNormalizedForeignCallFixup,
    shift: u64,
) -> Result<(), FrameApplicationError> {
    fixup.opcode_function_offset = fixup
        .opcode_function_offset
...
mod tests {
    ...
    use post_allocation_machine_to_selected_form_encoding::machine_code::TargetFrameLayoutIdentity;
