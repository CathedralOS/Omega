...
pub(super) fn reencode_branches(
    ...
    epilogues: &mut [post_allocation_machine_to_selected_form_encoding::machine_code::FunctionAppliedFrameEpilogue],
                ...
                FunctionFragmentBranchEvidence::Jump(branch) => {
                    ...
                    let (bytes, effects) = match architecture {
                        ...
                        Architecture::Aarch64 => {
                            let encoded = target_operations_to_selected_instructions::isa_aarch64::encode_aarch64_selected_jump_form(
                                physical,
                                alternative,
                                branch.byte_displacement,
                            )
