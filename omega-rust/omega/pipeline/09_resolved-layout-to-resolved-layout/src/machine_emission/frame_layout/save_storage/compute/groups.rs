use target_operations_to_selected_instructions::register_model::ValidatedPreservationStorageCatalog;

use crate::machine_emission::frame_layout::save_storage::FunctionAllocatedCalleeSavedRequirements;
