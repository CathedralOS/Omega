...
//! Durable plans live in `post_allocation_machine_to_selected_form_encoding::machine_code::storage::frame_layout`; only the
...
pub use post_allocation_machine_to_selected_form_encoding::machine_code::target_frame_layout_identity;
...
pub struct ValidatedTargetFrameLayout {
    pub(in crate::machine_emission::frame_layout) plan: std::sync::Arc<TargetFrameLayoutPlan>,
    pub(in crate::machine_emission::frame_layout) receipt: TargetFrameLayoutReceipt,
}
