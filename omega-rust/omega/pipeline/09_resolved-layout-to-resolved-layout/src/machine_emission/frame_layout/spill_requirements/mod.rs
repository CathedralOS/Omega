...
#[cfg(test)]
pub(in crate::machine_emission::frame_layout::spill_requirements) use compute::derive_zero_access_requirement_for_test;
#[cfg(test)]
pub(in crate::machine_emission::frame_layout::spill_requirements) use replay::replay_zero_access_requirement_for_test;

use optimization_core::OptimizationWorkBudget;
use selected_instructions_to_register_homes::unsequenced_spill_stages::ValidatedAbstractSpillAccessConstraints;

use crate::machine_emission::frame_layout::ValidatedTargetRegisterEnvironment;
...
pub use target_operations_to_selected_instructions::register_environment::FrameAbiPreservationConvention;
...
mod tests {
    ...
    use target_operations_to_selected_instructions::register_environment::FrameAbiPreservationConvention;
...
pub struct NonAuthoritativeSpillFrameRequirementReceipt {
    pub(in crate::machine_emission::frame_layout::spill_requirements) identity:
        NonAuthoritativeSpillFrameRequirementIdentity,
    pub(in crate::machine_emission::frame_layout::spill_requirements) abstract_spill_access_constraints:
        AbstractSpillAccessConstraintPlanIdentity,
    pub(in crate::machine_emission::frame_layout::spill_requirements) register_environment:
        TargetRegisterEnvironmentIdentity,
    pub(in crate::machine_emission::frame_layout::spill_requirements) target: NativeTarget,
    pub(in crate::machine_emission::frame_layout::spill_requirements) policy:
        NonAuthoritativeSpillFrameRequirementPolicy,
    pub(in crate::machine_emission::frame_layout::spill_requirements) usage: OptimizationWorkUsage,
    pub(in crate::machine_emission::frame_layout::spill_requirements) function_count: usize,
    pub(in crate::machine_emission::frame_layout::spill_requirements) spill_bearing_function_count:
        usize,
    pub(in crate::machine_emission::frame_layout::spill_requirements) max_abstract_spill_area_bytes:
        u64,
    pub(in crate::machine_emission::frame_layout::spill_requirements) max_abstract_spill_area_alignment:
        u64,
}
...
pub struct ValidatedNonAuthoritativeSpillFrameRequirements {
    pub(in crate::machine_emission::frame_layout::spill_requirements) plan:
        NonAuthoritativeSpillFrameRequirementPlan,
    pub(in crate::machine_emission::frame_layout::spill_requirements) receipt:
