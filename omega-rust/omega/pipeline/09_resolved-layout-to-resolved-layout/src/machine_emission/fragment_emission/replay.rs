...
use crate::machine_emission::function_realization::StagedFixedFrameFunctionRelativeRealization;
...
impl FunctionFragmentReplayInputs {
    ...
    pub fn layout_optimization(&self) -> &crate::ResolvedLayoutOptimization {
    ...
    pub fn frame_protocol(
        &self,
    ) -> Option<&crate::machine_emission::frame_protocol::ValidatedTargetFrameProtocolEncoding>
    {
    ...
    pub fn frame_layout(
        &self,
    ) -> Option<&crate::machine_emission::frame_layout::ValidatedTargetFrameLayout> {
...
impl FunctionFragmentReplayInputs {
    pub fn shared_selected_plan(
        &self,
    ) -> std::sync::Arc<target_operations_to_selected_instructions::SelectedInstructionPlan> {
        self.allocation()
            .current()
            .selected()
