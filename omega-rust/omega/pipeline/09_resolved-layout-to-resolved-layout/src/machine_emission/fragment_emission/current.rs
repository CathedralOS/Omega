...
use crate::machine_emission::function_realization::ValidatedFunctionRelativeOptimizationRealizationManifest;
...
pub(super) struct CurrentFunctionFragmentInput {
    ...
    pub(super) environment: target_operations_to_selected_instructions::register_environment::ValidatedTargetRegisterEnvironment,
