        ...
        branch: row.branch.as_deref().map(|branch| {
            let branch = match branch {
                ...
                post_allocation_machine_to_selected_form_encoding::machine_code::ResolvedBranchEvidence::Jump(jump) => {
                    return Box::new(post_allocation_machine_to_selected_form_encoding::machine_code::FunctionFragmentBranchEvidence::Jump(
                        post_allocation_machine_to_selected_form_encoding::machine_code::FunctionFragmentJumpEvidence {
            ...
            Box::new(post_allocation_machine_to_selected_form_encoding::machine_code::FunctionFragmentBranchEvidence::Conditional(
                FunctionFragmentConditionalBranchEvidence {
                    predicate: match branch.predicate {
                        post_allocation_machine_to_selected_form_encoding::machine_code::ResolvedConditionalBranchPredicate::NonZeroV1 => {
                            FunctionFragmentConditionalBranchPredicate::NonZeroV1
                        }
                        post_allocation_machine_to_selected_form_encoding::machine_code::ResolvedConditionalBranchPredicate::U64LessThanV1 => {
                            FunctionFragmentConditionalBranchPredicate::U64LessThanV1
                        }
                        post_allocation_machine_to_selected_form_encoding::machine_code::ResolvedConditionalBranchPredicate::I64LessThanV1 => {
