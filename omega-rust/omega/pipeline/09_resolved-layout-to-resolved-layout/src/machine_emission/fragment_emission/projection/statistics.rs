...
use post_allocation_machine_to_selected_form_encoding::machine_code::FunctionFragmentEmissionStatistics;
        ...
        for block in &function.blocks {
            ...
            for row in &block.instructions {
                ...
                result.resolved_conditional_branches += u64::from(
                    row.branch
                        .as_deref()
                        .and_then(post_allocation_machine_to_selected_form_encoding::machine_code::FunctionFragmentBranchEvidence::as_conditional)
                        .is_some(),
                );
