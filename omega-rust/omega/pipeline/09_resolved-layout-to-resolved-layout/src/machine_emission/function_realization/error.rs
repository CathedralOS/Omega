use crate::ResolvedLayoutOptimizationError;
use crate::machine_emission::exit_contract::WholeFunctionExitContractError;
...
pub enum FunctionRelativeOptimizationRealizationError {
    ...
    CalleeSaveStorage(
        crate::machine_emission::frame_layout::NonAuthoritativeCalleeSaveStorageError,
    ),
    FrameLayout(crate::machine_emission::frame_layout::TargetFrameLayoutError),
    FrameProtocol(crate::machine_emission::frame_protocol::TargetFrameProtocolEncodingError),
    StatisticsOverflow,
    RootMismatch,
    ReceiptMismatch,
}
