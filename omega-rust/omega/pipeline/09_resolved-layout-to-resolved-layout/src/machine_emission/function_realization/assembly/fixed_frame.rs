...
use crate::ResolvedLayoutOptimization;
...
pub(in crate::machine_emission::function_realization) fn expected_fixed_frame_manifest(
...
> {
    ...
    let layout_custody = match relaxation {
        Some(relaxation) => {
            post_allocation_machine_to_selected_form_encoding::machine_code::WholeFunctionExitLayoutCustody::X86RelaxConditionalBranchesToRel8V1 {
                relaxation,
            }
        }
        None => post_allocation_machine_to_selected_form_encoding::machine_code::WholeFunctionExitLayoutCustody::BaselineNearLayoutV1,
    };
    ...
    if selected_lowering.identity() != expected_lowering_selections
        ...
        || exit_contract.contract().frame
            != (post_allocation_machine_to_selected_form_encoding::machine_code::WholeFunctionFrameDisposition::CanonicalFixedFrameV1 {
...
#[allow(clippy::too_many_arguments)]
pub(in crate::machine_emission::function_realization) fn fixed_frame_custody(
