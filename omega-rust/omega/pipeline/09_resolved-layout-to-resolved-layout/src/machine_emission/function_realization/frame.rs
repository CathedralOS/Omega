...
pub struct FunctionRelativeFrame {
    pub(in crate::machine_emission::function_realization) requirements:
        ValidatedAllocatedCalleeSavedRequirements,
    pub(in crate::machine_emission::function_realization) storage:
        ValidatedNonAuthoritativeCalleeSaveStorage,
    pub(in crate::machine_emission::function_realization) layout: ValidatedTargetFrameLayout,
    pub(in crate::machine_emission::function_realization) protocol:
