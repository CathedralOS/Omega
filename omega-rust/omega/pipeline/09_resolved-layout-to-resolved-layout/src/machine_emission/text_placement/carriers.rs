...
use post_allocation_machine_to_selected_form_encoding::machine_code::FunctionFragmentFrameApplicationIdentity;

use post_allocation_machine_to_selected_form_encoding::machine_code::FunctionFragmentTextSectionManifest;
