...
use target_operations_to_selected_instructions::{
    MachineAlternativeFamily, MachineEncodedControlEffect,
};

use super::super::TextPlacementError;

pub(in crate::machine_emission::text_placement::placement) fn prove_none(
...
fn target_block_offset(
    function: &FunctionFragment,
    target: target_operations_to_selected_instructions::SelectedBlockId,
) -> Option<u64> {
    function
        .blocks
        .iter()
