use crate::boundary_applications::BoundaryApplicationRealization;
use crate::object_file::{RelocationKind, RelocationOrigin, RelocationRecord, SectionKind};
...
fn validate_checked_call_relocation(
    ...
    caller_symbol: crate::object_file::ObjectSymbolHandle,
    callee_symbol: crate::object_file::ObjectSymbolHandle,
...
enum DynamicCallEmission<'artifact> {
    Rebound(&'artifact post_allocation_machine_to_selected_form_encoding::machine_code::DynamicCallRecord),
    Stored(&'artifact post_allocation_machine_to_selected_form_encoding::machine_code::StoredDynamicCallRecord),
    Parameter(&'artifact post_allocation_machine_to_selected_form_encoding::machine_code::DynamicParameterCallRecord),
    ForwardedParameter(&'artifact post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicParameterCallRecord),
    ForwardedDescriptor(&'artifact post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicDescriptorCallRecord),
}
...
struct ExpectedRelocationWindow {
    offset: usize,
    kind: RelocationKind,
    symbol: crate::object_file::ObjectSymbolHandle,
}
...
fn table_address_relocation_windows(
    text_offset: usize,
    materialization: &post_allocation_machine_to_selected_form_encoding::machine_code::DynamicTableAddressMaterialization,
    table_symbol: crate::object_file::ObjectSymbolHandle,
) -> Vec<ExpectedRelocationWindow> {
    match materialization.encoding {
        post_allocation_machine_to_selected_form_encoding::machine_code::DynamicTableAddressEncoding::X86_64Relative32 { relocation_offset } => {
            vec![ExpectedRelocationWindow {
...
fn match_expected_relocation_windows(
    ...
    function_symbol: crate::object_file::ObjectSymbolHandle,
    operation: semantic_vocabulary::OperationId,
) -> Result<
    Vec<(
        usize,
        usize,
        RelocationKind,
        crate::object_file::ObjectSymbolHandle,
    )>,
    &'static str,
> {
...
fn derive_integer_comparison_span(
    occurrence: &OptimizedOperatorOccurrence,
    execution: &abstract_operations_to_target_operations::effects::CompilerIntrinsicExecutionIdentity,
    object: &crate::image_emission::ObjectArtifact,
    image: &crate::image::EmittedImageOutput,
) -> Result<Option<OperatorPhysicalSpan>, &'static str> {
    if !matches!(
...
mod tests {
    ...
    fn checked_call_relocation() -> RelocationRecord {
        RelocationRecord {
            origin: RelocationOrigin::SemanticOperation {
                function_symbol_handle: crate::object_file::ObjectSymbolHandle::from_arena_index(1),
                operation_identity: 3,
            },
            section: SectionKind::Text,
            offset: 12,
            byte_width: 4,
            symbol_handle: crate::object_file::ObjectSymbolHandle::from_arena_index(2),
            addend: 0,
            kind: RelocationKind::X86_64Relative32,
        }
    }

    fn caller_symbol() -> crate::object_file::ObjectSymbolHandle {
        crate::object_file::ObjectSymbolHandle::from_arena_index(1)
    }
    ...
    fn table_window(offset: usize, kind: RelocationKind) -> ExpectedRelocationWindow {
        ExpectedRelocationWindow {
            offset,
            kind,
            symbol: crate::object_file::ObjectSymbolHandle::from_arena_index(9),
        }
    }
    ...
    fn table_relocation(offset: usize, kind: RelocationKind) -> RelocationRecord {
        RelocationRecord {
            ...
            offset,
            byte_width: 4,
            symbol_handle: crate::object_file::ObjectSymbolHandle::from_arena_index(9),
            addend: 0,
            kind,
        }
    }
    ...
    fn table_address_windows_follow_the_encoding() {
        let x86 = post_allocation_machine_to_selected_form_encoding::machine_code::DynamicTableAddressMaterialization {
            code_offset: 8,
            byte_count: 4,
            encoding: post_allocation_machine_to_selected_form_encoding::machine_code::DynamicTableAddressEncoding::X86_64Relative32 {
        ...
        let aarch64 = post_allocation_machine_to_selected_form_encoding::machine_code::DynamicTableAddressMaterialization {
            code_offset: 8,
            byte_count: 8,
            encoding: post_allocation_machine_to_selected_form_encoding::machine_code::DynamicTableAddressEncoding::Aarch64PageAddress {
    ...
    fn expected_windows_reject_missing_or_substituted_relocations() {
        ...
        wrong_symbol.symbol_handle = crate::object_file::ObjectSymbolHandle::from_arena_index(10);
    ...
    fn windows_digest_commits_the_ordered_windows() {
        let windows = [
            (
                ...
                crate::object_file::ObjectSymbolHandle::from_arena_index(9),
            ),
            (
                116usize,
                4usize,
        ...
        let other_symbol = [
            (
                ...
                4,
                RelocationKind::Aarch64Page21,
                crate::object_file::ObjectSymbolHandle::from_arena_index(10),
            ),
            windows[1],
        ];
        assert_ne!(
    ...
    fn validate(relocation: &RelocationRecord) -> Result<(), &'static str> {
        validate_checked_call_relocation(
            ...
            Architecture::X86_64,
            crate::object_file::ObjectSymbolHandle::from_arena_index(1),
            crate::object_file::ObjectSymbolHandle::from_arena_index(2),
            semantic_vocabulary::OperationId::new(3).expect("operation"),
            10,
            16,
            relocation,
