...
fn reference_projection_identity_is_distinct_from_owned_paths() {
    ...
    let identity = |path: &[StructuralPathSegment]| {
        ...
        crate::native_artifact::physical::derivation::hashing::hash_structural_path(
            &mut digest,
            path,
        );
...
use crate::native_artifact::physical::NativeOptimizationProjection;
use crate::native_artifact::physical::NativePhysicalOccurrence;
use crate::native_artifact::physical::derivation::evidence::PhysicalChildCoordinate;
use crate::native_artifact::physical::derivation::evidence::boundary_occurrence_identity;
use crate::native_artifact::physical::derivation::evidence::operator_occurrence_identity;
use crate::native_artifact::physical::derivation::evidence::validate_exact_physical_child_coordinates;
use crate::native_artifact::physical::derivation::settlement_identity::admitted_provider_settlement_identity;
use crate::native_artifact::physical::derivation::settlement_identity::hosted_builtin_settlement_identity;
use crate::native_artifact::physical::native_optimization_projection;
use crate::native_artifact::physical::optimized_boundary_occurrence;
use crate::native_artifact::physical::optimized_operator_occurrence;
...
fn structural_boundary_settlement_identity_binds_the_complete_result_declaration() {
    ...
    let original = post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryStructuralResultRecord {
        ...
        layout: abstract_operations_to_target_operations::calling_conventions::evaluate_conventional_sum_layout(
            ...
            &[
                Vec::new(),
                vec![abstract_operations_to_target_operations::calling_conventions::ValueShape::integer(4, 4)],
            ],
        )
        .unwrap(),
        home_byte_offset: 16,
    ...
    let projection = physical_projection();
    let identity = |result: &post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryStructuralResultRecord| {
        hosted_builtin_settlement_identity(
            ...
            [3, 3],
            None,
            &crate::native_artifact::CompilerBuiltinResult::Structural(result.clone()),
        )
        .unwrap()
    };
...
fn admitted_provider_settlement_identity_binds_the_complete_retained_row() {
    ...
    let record = post_allocation_machine_to_selected_form_encoding::machine_code::ProviderExecutionRecord::new(7, 11, 13, 17, 19).unwrap();
    let execution = abstract_operations_to_target_operations::target_operations::ProviderExecutionBinding::from_execution_record(
        abstract_operations_to_target_operations::target_operations::ProviderPlanReportIdentity::new(7).unwrap(),
        11,
        13,
        17,
        19,
    ...
    let source =
        abstract_operations_to_target_operations::target_operations::CompletionClaimSource {
            claim,
    ...
    let byte_sequence = post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryByteSequenceArgumentRecord {
    ...
    let completion = post_allocation_machine_to_selected_form_encoding::machine_code::BoundarySettlementRecord {
        psi_operation: OperationId::new(41).unwrap(),
        boundary: BoundaryMachineId::new(43).unwrap(),
        execution: post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryExecutionRecord::AdmittedProvider(record),
        ...
        completion_provider_custody: vec![post_allocation_machine_to_selected_form_encoding::machine_code::CompletionProviderCustodyBinding {
            source: source.clone(),
            receipt,
    ...
    let identity = |settlement: &post_allocation_machine_to_selected_form_encoding::machine_code::BoundarySettlementRecord,
    ...
    for mutation in 0..22 {
        ...
        match mutation {
            ...
            2 => {
                changed.execution = post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryExecutionRecord::AdmittedProvider(
                    post_allocation_machine_to_selected_form_encoding::machine_code::ProviderExecutionRecord::new(7, 11, 13, 17, 23).unwrap(),
                )
            }
            3 => {
                changed.execution = post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryExecutionRecord::CompilerBuiltin(
                    abstract_operations_to_target_operations::target_operations::CompilerBuiltinExecution::HostedWriteByteI32,
                )
            }
            4 => {
                changed.realization = abstract_operations_to_target_operations::target_operations::BoundaryRealization::MetadataOnlyPort(
            ...
            5 => changed.scalar_arguments.push(BoundaryScalarArgument {
                ...
                destination: abstract_operations_to_target_operations::calling_conventions::MachineRegister::X86Rdi,
            }),
            6 => {
                changed
                    .runtime_scalar_arguments
                    .push(post_allocation_machine_to_selected_form_encoding::machine_code::ForeignCallScalarArgumentRecord {
                    parameter_index: 0,
                    source:
                        post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarArgumentSourceRecord::SelectedProcessExit {
                            ...
                            instruction: target_operations_to_selected_instructions::SelectedInstructionId(41),
                        },
                    placement: abstract_operations_to_target_operations::calling_conventions::ValuePlacement {
    ...
    let port_effect =
        post_allocation_machine_to_selected_form_encoding::machine_code::PortEffectRecord {
    ...
    let port = post_allocation_machine_to_selected_form_encoding::machine_code::BoundarySettlementRecord {
        realization: abstract_operations_to_target_operations::target_operations::BoundaryRealization::MetadataOnlyPort(
            MetadataOnlyPortRealization {
                effect_operation: OperationId::new(40).unwrap(),
                service: ServiceId::new(3).unwrap(),
                port: 0x3f8,
    ...
    for mutation in 0..4 {
        ...
        let abstract_operations_to_target_operations::target_operations::BoundaryRealization::MetadataOnlyPort(realization) =
...
fn normalized_foreign_structural_signature_requires_the_exact_admitted_lane() {
    use abstract_operations_to_target_operations::calling_conventions::{
        MachineRegister, ValueLocation, ValuePlacement, ValueShape,
    };
    ...
    use crate::native_artifact::physical::derivation::children::normalized_foreign_structural_parameter_shapes;
    ...
    indirect[0].locations = vec![ValueLocation::Indirect {
        pointer: abstract_operations_to_target_operations::calling_conventions::IndirectPointerLocation::Register(MachineRegister::X86Rdi),
...
fn normalized_foreign_parent_identity_binds_the_structural_call_custody() {
    ...
    use crate::native_artifact::physical::derivation::settlement_identity::admitted_provider_boundary_trait_settlement_identity;
...
fn physical_child_identity_binds_every_retained_field() {
    ...
    use crate::native_artifact::physical::derivation::evidence::physical_child_identity;
    ...
    let identity = |parent: &PhysicalChildParent,
                    ...
                    machine_span: crate::native_artifact::NativeByteSpan,
                    object_span: crate::native_artifact::NativeByteSpan,
                    final_image_span: crate::native_artifact::NativeByteSpan,
...
fn physical_child_identity_binds_the_normalized_foreign_relocation() {
    use crate::object_file::{ObjectSymbolHandle, RelocationKind, RelocationOrigin};
...
fn dynamic_call_occurrence_binds_its_dispatch_role_and_parent_identity() {
    use crate::native_artifact::physical::derivation::evidence::physical_child_identity;
    use crate::native_artifact::physical::{dynamic_call_dispatch, native_byte_span};
    use crate::native_artifact::{PhysicalChildParent, PhysicalRelocationDisposition};
...
fn physical_evidence_gap_identity_binds_the_exact_subject() {
    use crate::native_artifact::physical::NativePhysicalEvidenceGapSubject;
    use crate::native_artifact::physical::derivation::hashing::physical_evidence_gap_identity;
...
fn physical_evidence_gap_names_the_blocking_occurrence() {
    use crate::native_artifact::physical::NativePhysicalEvidenceGapSubject;
    use crate::native_artifact::physical::derivation::hashing::physical_evidence_gap_identity;
    use crate::native_artifact::physical::native_physical_evidence_gap;
    use abstract_operations_to_target_operations::target_operations::CallSiteOwner;
