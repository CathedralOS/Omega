...
use crate::native_artifact::NativeByteSpan;
use crate::native_artifact::NativeOptimizationProjection;
use crate::native_artifact::NativePhysicalChild;
use crate::native_artifact::NativePhysicalChildParts;
use crate::native_artifact::NativePhysicalEvidence;
use crate::native_artifact::NativePhysicalOccurrence;
pub(crate) use crate::native_artifact::NormalizedForeignCallbackRelocations;
use crate::native_artifact::PhysicalChildParent;
use crate::native_artifact::PhysicalRelocationDisposition;
use crate::native_artifact::native_artifact::boundary_application_coverage_identity;
use crate::native_artifact::physical::derivation::children::{
...
use crate::native_artifact::physical::derivation::hashing::{
...
use crate::native_artifact::physical::dynamic_call_dispatch;
use crate::native_artifact::physical::native_optimization_projection;
use crate::native_artifact::physical::native_physical_evidence;
use crate::native_artifact::physical::native_physical_evidence_gap;
use crate::native_artifact::physical::operator_applications::{
...
use crate::native_artifact::physical::{
    NativePhysicalEvidenceGap, NativePhysicalEvidenceGapSubject,
};
...
fn dynamic_call_dispatch_identity(
    ...
    occurrence: &crate::native_artifact::OptimizedOperatorOccurrence,
