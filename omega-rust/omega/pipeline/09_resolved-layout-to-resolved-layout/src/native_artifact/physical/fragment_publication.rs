...
pub(super) struct FragmentPublicationBinding {
    ...
    foreign_call_custody: Vec<crate::image_emission::ObjectForeignCall>,
    ...
    relocation_free_object: Arc<crate::object_file::RelocationFreeObjectPlan>,
    ...
    text_section: Arc<post_allocation_machine_to_selected_form_encoding::machine_code::RelocationFreeTextSectionPlacement>,
    ...
    selected: Arc<target_operations_to_selected_instructions::SelectedInstructionPlan>,
    identity: [u8; 32],
}
...
impl FragmentPublicationBinding {
    ...
    pub(super) fn foreign_call_custody(&self) -> &[crate::image_emission::ObjectForeignCall] {
        &self.foreign_call_custody
    }

    pub(super) fn relocation_free_object(&self) -> &crate::object_file::RelocationFreeObjectPlan {
        &self.relocation_free_object
    }

    pub(super) fn text_section(&self) -> &post_allocation_machine_to_selected_form_encoding::machine_code::RelocationFreeTextSectionPlacement{
        &self.text_section
    }
...
pub(crate) fn derive_scope(
    final_plan: &terminal_psi_to_abstract_operations::abstract_operations::AbstractOperationPlan,
    ...
    coverage: &crate::boundary_applications::TerminalBoundaryApplicationCoverage,
    ...
    crate::image_emission::validate_function_fragment_object_artifact(source, object)
        .map_err(|_| "fragment publication object failed independent source replay")?;
    let foreign_call_custody =
        crate::image_emission::derive_normalized_foreign_call_custody(source)
...
fn validate_final_plan(
    proposed: &terminal_psi_to_abstract_operations::abstract_operations::AbstractOperationPlan,
    retained: &terminal_psi_to_abstract_operations::abstract_operations::AbstractOperationPlan,
    terminal: terminal_psi::TerminalPsiIdentity,
