...
use crate::boundary_applications::OperatorApplicationCoverageRef;
use crate::native_artifact::NativeSelectedProviderPlanDigest;
...
///
/// Construction is owned by [`crate::native_artifact::NativePhysicalEvidenceScope`]. Keeping
...
impl ValidatedOptimizedNativePhysicalEvidenceScope {
    ...
    pub(crate) fn foreign_call_custody(&self) -> &[crate::image_emission::ObjectForeignCall] {
        self.publication
            .as_ref()
...
pub enum CompilerBuiltinScalarArgument {
    ...
    RuntimeScalar(post_allocation_machine_to_selected_form_encoding::machine_code::ForeignCallScalarArgumentRecord),
}
...
pub enum CompilerBuiltinResult {
    ...
    Structural(post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryStructuralResultRecord),
}
...
pub enum BoundaryTraitSettlementRole {
    ...
    AdmittedProviderSettlement {
        ...
        port_effect: Option<post_allocation_machine_to_selected_form_encoding::machine_code::PortEffectRecord>,
    },
}
...
pub struct NormalizedForeignCallRelocation {
    ...
    object_symbol: crate::object_file::ObjectSymbolHandle,
    origin: crate::object_file::RelocationOrigin,
    offset: usize,
    byte_width: usize,
    addend: i64,
    kind: crate::object_file::RelocationKind,
...
impl NormalizedForeignCallbackRelocation {
    pub const fn object_symbol(&self) -> crate::object_file::ObjectSymbolHandle {
        self.object_symbol
    }

    pub const fn origin(&self) -> crate::object_file::RelocationOrigin {
        self.origin
    }
    ...
    pub const fn kind(&self) -> crate::object_file::RelocationKind {
        self.kind
    }
}

impl NormalizedForeignCallbackRelocations {
    pub const fn callback_function(
        &self,
    ) -> abstract_operations_to_target_operations::function_identity::MachineFunctionIdentity {
        match self {
...
pub struct NormalizedForeignCallImportField {
    ...
    boundary: BoundaryMachineId,
    ordinal: u32,
    object_symbol: crate::object_file::ObjectLocalSymbolId,
    offset: usize,
    byte_width: usize,
    addend: i64,
    kind: crate::object_file::RelocationKind,
...
impl NormalizedForeignCallImportField {
    ...
    pub const fn object_symbol(&self) -> crate::object_file::ObjectLocalSymbolId {
        self.object_symbol
    }
