...
use crate::boundary_applications::TerminalBoundaryApplicationCoverage;
...
use crate::native_artifact::physical::{
...
pub struct NativeArtifact {
    ...
    image: crate::image_emission::ExecutableImage,
...
pub struct NativeArtifactParts {
    ...
    pub object: crate::image_emission::ObjectArtifact,
    pub image: crate::image_emission::ExecutableImage,
...
impl NativeArtifact {
    ...
    pub fn validate(&self) -> Result<(), &'static str> {
        ...
        crate::image_emission::validate_direct_executable_image(&self.object, &self.image)
        ...
        for installed in self.image.boundary_settlements() {
            ...
            let crate::image_emission::BoundaryExecutionRecord::AdmittedProvider(execution) =
        ...
        for foreign in self.image.foreign_calls() {
            let abstract_operations_to_target_operations::target_operations::CallSiteOwner::Operation(owner) = foreign.owner else {
                return Err(
    ...
    pub const fn object(&self) -> &crate::image_emission::ObjectArtifact {
        &self.object
    }

    pub const fn image(&self) -> &crate::image_emission::ExecutableImage {
        &self.image
    }
...
impl NativePhysicalEvidenceScope {
    ...
    fn normalized_foreign_call_custody(&self) -> &[crate::image_emission::ObjectForeignCall] {
        match self {
    ...
    pub fn from_validated_fragment_publication(
        ...
        source: &crate::object_file::StagedOptimizedRelocationFreeObjectContainer,
        object: &crate::image_emission::ObjectArtifact,
...
fn validate_foreign_stack_contribution(
    ...
    execution: post_allocation_machine_to_selected_form_encoding::machine_code::ProviderExecutionRecord,
...
fn validate_ieee_float_fma_occurrences(
    ...
    for (function, occurrence) in object_occurrences {
        ...
        let expected_format = match occurrence.format {
            post_allocation_machine_to_selected_form_encoding::machine_code::X86ScalarFmaFormat::Binary32 => {
                semantic_vocabulary::IeeeFloatFormat::Binary32
            }
            post_allocation_machine_to_selected_form_encoding::machine_code::X86ScalarFmaFormat::Binary64 => {
