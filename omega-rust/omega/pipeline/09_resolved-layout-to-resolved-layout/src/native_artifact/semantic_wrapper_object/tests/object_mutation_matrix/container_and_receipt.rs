...
use crate::native_artifact::semantic_wrapper_object::manifest::validate_manifest;
...
fn wrapper_object_container_rejects_every_one_field_substitution() {
    ...
    assert_eq!(
        ...
        Err(crate::native_artifact::semantic_wrapper_object::OptimizedProgramStorageSemanticWrapperObjectDecodeError::IdentityMismatch),
    ...
    assert_eq!(
        ...
        Err(crate::native_artifact::semantic_wrapper_object::OptimizedProgramStorageSemanticWrapperObjectDecodeError::Truncated),
    );
    ...
    assert_eq!(
        ...
        Err(crate::native_artifact::semantic_wrapper_object::OptimizedProgramStorageSemanticWrapperObjectDecodeError::TrailingBytes),
    );
