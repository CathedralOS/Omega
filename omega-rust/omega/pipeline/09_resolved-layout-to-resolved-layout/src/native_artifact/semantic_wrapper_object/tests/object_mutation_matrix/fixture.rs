...
use crate::native_artifact::semantic_wrapper_object::compose_optimized_program_storage_semantic_wrapper_object;
use crate::native_artifact::semantic_wrapper_object::encode_optimized_program_storage_semantic_wrapper_object;
use crate::native_artifact::semantic_wrapper_object::manifest::construct_manifest;
