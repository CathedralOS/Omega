...
pub(super) fn reconstruct(
    ...
    for block in &machine.blocks {
        ...
        let evidence = exit_function
            ...
            .ok_or(OptimizedOrdinaryCallableEntryError::MissingReturn(edge))?;
        let post_allocation_machine_to_selected_form_encoding::machine_code::WholeFunctionReturnValueEvidence::ScalarV1 {
            virtual_register,
            view,
            units,
        } = &evidence.value
...
fn place_backed_origins_cannot_supply_scalar_callable_results() {
    ...
    for origin in [
        ...
        VirtualRegisterOrigin::SpillAddress {
            instruction: target_operations_to_selected_instructions::SelectedInstructionId(0),
            register: target_operations_to_selected_instructions::VirtualRegisterId(0),
        },
        VirtualRegisterOrigin::StructuralParameter {
            place,
            parameter_index: 0,
