...
/// candidate.  This identity is domain-separated from [`crate::native_artifact::NativeArtifactIdentity`]
...
///
/// This is intentionally not [`crate::native_artifact::NativeArtifact`].  Existing component,
...
pub struct DynamicElfNativeArtifact {
    ...
    image: crate::image_emission::RequestedDynamicElfImage,
...
pub struct DynamicElfNativeArtifactParts {
    ...
    pub image: crate::image_emission::RequestedDynamicElfImage,
...
impl DynamicElfNativeArtifact {
    ...
    pub fn from_emitted_parts(
        ...
        let final_image_symbol_digest =
            *crate::image::final_image_symbol_digest(parts.image.emission().admitted().image())
                .as_bytes();
    ...
    pub fn validate(&self) -> Result<(), &'static str> {
        ...
        crate::image_emission::validate_requested_dynamic_elf_image(&self.object, &self.image)
        ...
        let final_image_symbol_digest =
            *crate::image::final_image_symbol_digest(self.image.emission().admitted().image())
                .as_bytes();
    ...
    pub const fn image(&self) -> &crate::image_emission::RequestedDynamicElfImage {
        &self.image
    }
