...
use crate::image_pe::layout::{align_to, align_to_u32};
...
pub(crate) fn plan_pe_sections(image: &FinalImage, rdata_virtual_size: usize) -> PeSections {
    ...
    let reloc_virtual_size =
        crate::image_pe::relocations::build_base_relocations(image, TEXT_RVA, data_rva)
            .bytes
            .len();
...
mod tests {
    ...
    use crate::image_pe::constants::{FILE_ALIGNMENT, SECTION_ALIGNMENT, TEXT_RVA};
    use arena::Handle;
