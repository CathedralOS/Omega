...
use crate::image_emission::ObjectArtifact;
use crate::image_emission::final_image_validation::validate_terminal_dynamic_elf_image;
...
pub fn emit_dynamic_elf_image(
    ...
    let prepared_entry =
        crate::image_emission::hosted_unit_entry::prepare(artifact).map_err(|diagnostic| {
...
fn derive_output(
    ...
    let prepared_entry = crate::image_emission::hosted_unit_entry::prepare(artifact)?;
    ...
    let mut replayed_image = crate::image::build_final_image(FinalImageInput {
        target,
        object,
        relocations,
        text_bytes,
