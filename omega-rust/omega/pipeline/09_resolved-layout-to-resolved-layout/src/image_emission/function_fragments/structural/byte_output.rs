...
use crate::image_emission::ObjectBoundarySettlement;
...
pub(super) fn settlement(
    ...
    let (register, offset) =
        crate::image_emission::object_artifact::replay::boundary::runtime_scalar_custody::decode_selected_byte_output(native, &span.bytes)
...
pub(super) fn validate(
    ...
    if settlement.execution != BoundaryExecutionRecord::from(execution)
        ...
        || !crate::image_emission::object_artifact::replay::boundary::runtime_scalar_custody::selected_byte_output_bytes_are_exact(
...
fn target_settlement(
    ...
    (
        abstract_operations_to_target_operations::target_operations::BoundaryExecutionBinding,
        abstract_operations_to_target_operations::target_operations::BoundaryRealization,
    ),
    Error,
> {
