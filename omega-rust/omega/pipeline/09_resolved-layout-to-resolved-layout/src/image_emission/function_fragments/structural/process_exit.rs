...
pub(super) fn settlement(
    ...
    if span.control
        != (post_allocation_machine_to_selected_form_encoding::machine_code::FunctionFragmentControlProvenance::HostedExitProcess {
    ...
    let register =
        crate::image_emission::object_artifact::replay::boundary::runtime_scalar_custody::process_exit::decode(
    ...
    let settlement = BoundarySettlementRecord {
        ...
        execution: BoundaryExecutionRecord::CompilerBuiltin(
            abstract_operations_to_target_operations::target_operations::CompilerBuiltinExecution::HostedExitProcessI32,
        ),
        realization: abstract_operations_to_target_operations::target_operations::BoundaryRealization::HostedExitProcessI32(
            Default::default(),
        ),
...
pub(super) fn validate(
    ...
    if located.instruction_index as usize != block.instructions.len()
        ...
        || !crate::image_emission::object_artifact::replay::boundary::runtime_scalar_custody::process_exit::bytes_are_exact(
            container.source().text_section().target,
            &proposed.settlement,
            &fragment.bytes,
        )
