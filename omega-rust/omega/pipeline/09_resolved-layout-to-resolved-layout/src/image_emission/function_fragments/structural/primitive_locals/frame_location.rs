...
use target_operations_to_selected_instructions::{LocalStorageSlotId, SelectedFunction};
use terminal_psi::StructuralAccess;

pub(in crate::image_emission::function_fragments::structural) fn location(
    source: &StagedOptimizedRelocationFreeObjectContainer,
    selected: &SelectedFunction,
    argument: &abstract_operations_to_target_operations::target_operations::TargetStructuralArgument,
    ...
    if producer_operation != operation
        ...
        || argument.shape
            != abstract_operations_to_target_operations::calling_conventions::ValueShape::borrowed_reference(u16::from(size), u16::from(size))
...
pub(super) fn frame_location(
    homes: &[post_allocation_machine_to_selected_form_encoding::machine_code::LocalStorageFrameSlot],
