...
use target_operations_to_selected_instructions::SelectedSuccessorRole;
...
fn supports(
    instruction: &post_allocation_machine_to_selected_form_encoding::machine_code::FunctionFragmentInstructionSpan,
