...
//!   and retirement ladder that `executable-installation` drives over the
//!   emitted record.
...
pub use post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryExecutionRecord;
