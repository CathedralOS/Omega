...
use crate::image_emission::{ObjectArtifact, ObjectError, ObjectFunction};
...
pub struct StackDemand {
    ...
    pub(crate) admitted_contribution_report_identities: std::collections::BTreeSet<
        abstract_operations_to_target_operations::task_plans::AdmittedStackContributionReportId,
    >,
    pub(crate) admitted_contribution_commitments: std::collections::BTreeSet<
        abstract_operations_to_target_operations::task_plans::SameStackContributionCommitment,
    >,
}
