...
pub(crate) fn storage_end(
    ...
    let mut cursor =
        crate::image_emission::object_artifact::replay::unit::call_custody::result_home::parameter_storage_end(
...
pub(crate) fn exact_prologue(
    ...
    let Some(staging) =
        crate::image_emission::object_artifact::replay::unit::call_custody::parameter_staging::expected_bytes(
            target,
            parameters,
            frame_bytes,
        )
