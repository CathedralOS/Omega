...
pub(crate) fn exact_owned_result_projection(
    ...
    exact_owned_projection_from_root(
        ...
        post_allocation_machine_to_selected_form_encoding::machine_code::StructuralSourceLocation::Stack {
...
fn exact_owned_projection_from_root(
    ...
    source: &abstract_operations_to_target_operations::calling_conventions::ValuePlacement,
    location: post_allocation_machine_to_selected_form_encoding::machine_code::StructuralSourceLocation,
    declarations: &[StructuralTypeDeclaration],
) -> bool {
    ...
    let metadata_matches = match root.shape {
        StructuralTypeShape::FixedArray { element, length } => {
            crate::image_emission::object_artifact::replay::structural::condition_layout::replay_structural_value_shape(element, declarations)
                .and_then(|shape| {
...
pub(crate) fn exact_projected_affine_result<'a>(
    ...
    cleanup: Option<&UnitAffineCleanupRecord>,
) -> Option<&'a post_allocation_machine_to_selected_form_encoding::machine_code::InternalStructuralCallResult>{
