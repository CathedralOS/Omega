...
use post_allocation_machine_to_selected_form_encoding::machine_code::{
    BoundarySettlementRecord, derive_completion_provider_custody,
};
...
pub(crate) fn validate_completion_custody(
    ...
    let execution_realization_pair_is_exact = match (settlement.execution, settlement.realization) {
        ...
        (
            post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryExecutionRecord::AdmittedProvider(_),
            abstract_operations_to_target_operations::target_operations::BoundaryRealization::HostedWriteByteI32(_),
        ) => true,
        (
            post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryExecutionRecord::CompilerBuiltin(
        ...
        (post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryExecutionRecord::CompilerBuiltin(_), _)
        | (
            _,
            abstract_operations_to_target_operations::target_operations::BoundaryRealization::HostedExitProcessI32(_)
            | abstract_operations_to_target_operations::target_operations::BoundaryRealization::HostedReadByte(_),
...
mod tests {
    ...
    fn settlement(
        ...
        let provider_execution =
            post_allocation_machine_to_selected_form_encoding::machine_code::ProviderExecutionRecord::new(1, 2, 3, 4, 5).expect("provider execution");
        let completion_provider_custody = derive_completion_provider_custody(
            post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryExecutionRecord::AdmittedProvider(provider_execution),
        ...
        BoundarySettlementRecord {
            ...
            execution: post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryExecutionRecord::AdmittedProvider(provider_execution),
    ...
    fn complete_custody_replay_preserves_validation_precedence() {
        ...
        role_substitution.execution = post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryExecutionRecord::CompilerBuiltin(
            abstract_operations_to_target_operations::target_operations::CompilerBuiltinExecution::HostedExitProcessI32,
        );
        assert_eq!(
        ...
        reverse_role_substitution.realization =
            abstract_operations_to_target_operations::target_operations::BoundaryRealization::HostedExitProcessI32(Default::default());
        assert_eq!(
