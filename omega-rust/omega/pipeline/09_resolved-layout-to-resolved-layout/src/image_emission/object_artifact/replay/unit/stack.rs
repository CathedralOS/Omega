...
use crate::image_emission::object_artifact::call_sites::{
    validate_foreign_call_site, validate_internal_call_site,
};
use crate::image_emission::{ObjectError, ObjectUnitCallStack, ObjectUnitStack};

pub(crate) fn validate_unit_function_stack(
...
pub(crate) fn validate_unit_call_stack(
    architecture: Architecture,
    caller: MachineId,
    bytes: &[u8],
    relocation: post_allocation_machine_to_selected_form_encoding::machine_code::InternalCallRelocation,
...
pub(crate) fn validate_foreign_unit_call_stack(
    architecture: Architecture,
    caller: MachineId,
    bytes: &[u8],
...
pub(crate) fn validate_stack_adjustment_pair(
    architecture: Architecture,
    machine: MachineId,
...
pub(crate) fn validate_complete_unit_stack_evidence(
    target: target::NativeTarget,
    machine: MachineId,
    bytes: &[u8],
    function: UnitStackEvidence,
    calls: &[post_allocation_machine_to_selected_form_encoding::machine_code::InternalCallRelocation],
    foreign_calls: &[ForeignCallRelocation],
    dynamic_calls: &[post_allocation_machine_to_selected_form_encoding::machine_code::DynamicCallRecord],
    stored_dynamic_calls: &[post_allocation_machine_to_selected_form_encoding::machine_code::StoredDynamicCallRecord],
    boundary_settlements: &[post_allocation_machine_to_selected_form_encoding::machine_code::BoundarySettlementRecord],
    integer_constants: &[post_allocation_machine_to_selected_form_encoding::machine_code::UnitIntegerConstantRecord],
    scalar_homes: &[post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarHomeRecord],
    internal_unit_scalar_calls: &[post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarCallRecord],
    ...
    for settlement in boundary_settlements {
        if crate::image_emission::object_artifact::replay::boundary::runtime_scalar_custody::hosted_write_byte_custody_is_exact(
            target,
            settlement,
            ...
            |home, consumer_ordinal, consumer_offset| {
                crate::image_emission::object_artifact::replay::unit::scalar_call_custody::exact_preceding_internal_unit_scalar_home_producer_count(
...
pub(crate) fn aarch64_stack_adjustment_at(bytes: &[u8], offset: usize) -> bool {
...
pub(crate) fn x86_64_stack_adjustment(byte_size: u32, add: bool) -> Vec<u8> {
...
pub(crate) fn x86_64_stack_release_preserving_flags(byte_size: u32) -> Vec<u8> {
    if byte_size <= i8::MAX as u32 {
...
pub(crate) fn aarch64_unit_link_instruction(load: bool, byte_offset: u32) -> u32 {
