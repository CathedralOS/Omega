...
use super::conditional_stack::validate_conditional_tree_scalar_stack;
use super::division_stack::validate_linear_scalar_division_stack;
use super::shared_convergence::validate_boolean_shared_convergence_stack;
...
pub(crate) fn validate_scalar_stack(
    architecture: Architecture,
    machine: MachineId,
    bytes: &[u8],
    calls: &[post_allocation_machine_to_selected_form_encoding::machine_code::InternalCallRelocation],
    dynamic_parameter_calls: &[post_allocation_machine_to_selected_form_encoding::machine_code::DynamicParameterCallRecord],
    ...
    scalar_structural_parameter_homes: &[post_allocation_machine_to_selected_form_encoding::machine_code::UnitParameterHomeRecord],
    ...
    if let ScalarControlFlowEvidence::Acyclic { blocks } = &evidence.control_flow {
        ...
        let reconstructed =
            crate::image_emission::object_artifact::replay::scalar::control_flow::reconstruct_scalar_control_flow(
                architecture,
                machine,
                bytes,
                attribution.iter(),
        ...
        return crate::image_emission::object_artifact::replay::scalar::control_flow::validate_stack(
            architecture,
            machine,
            bytes,
            evidence,
