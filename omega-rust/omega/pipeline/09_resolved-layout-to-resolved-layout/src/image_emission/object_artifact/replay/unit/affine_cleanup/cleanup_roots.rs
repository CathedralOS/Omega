...
use post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryResultRecord;
...
pub(super) fn cleanup_roots(inputs: &CleanupInputs<'_>) -> CleanupRoots {
    ...
    let inspected_roots =
        crate::image_emission::object_artifact::replay::boundary::runtime_scalar_custody::inspected_hosted_read_byte_roots(boundary_settlements);
