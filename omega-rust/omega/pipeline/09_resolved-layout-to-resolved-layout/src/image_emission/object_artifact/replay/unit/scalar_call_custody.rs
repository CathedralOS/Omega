...
use abstract_operations_to_target_operations::target_operations::{
    CallSiteOwner, ScalarFunctionAbi,
};
...
use crate::image_emission::{ObjectError, ObjectUnitCallStack, ObjectUnitStack};

pub(crate) fn validate_internal_unit_scalar_calls(
    target: NativeTarget,
...
fn validate_home_roster(
    ...
    enum Allocation<'a> {
        Dynamic(&'a post_allocation_machine_to_selected_form_encoding::machine_code::DynamicCallRecord),
        StoredDynamic(&'a post_allocation_machine_to_selected_form_encoding::machine_code::StoredDynamicCallRecord),
        Scalar(
            CallSiteOwner,
            &'a post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarCallResultRecord,
        ),
    }
...
pub(crate) fn validate_source(
    ...
    match source {
        ...
        | InternalUnitScalarArgumentSourceRecord::SelectedCall { .. } => return Err(invalid()),
...
pub(crate) fn exact_preceding_unit_scalar_home_producer_count(
    function: &MachineCodeFunction,
    home: post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarHomeRecord,
    consumer_operation_ordinal: usize,
    consumer_code_offset: usize,
) -> usize {
...
pub(crate) fn exact_preceding_internal_unit_scalar_home_producer_count(
    calls: &[post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarCallRecord],
    home: post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarHomeRecord,
    consumer_operation_ordinal: usize,
    consumer_code_offset: usize,
) -> usize {
...
fn replay_scalar_transport_plan(
    ...
    arguments: &[post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarCallArgumentRecord],
) -> Option<ReplayScalarTransportPlan> {
    let source_registers = arguments
        .iter()
        .filter_map(|argument| match argument.source {
            InternalUnitScalarArgumentSourceRecord::Parameter {
                location: post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarParameterLocationRecord::Register(register),
                ..
            } => Some(register),
            _ => None,
        })
    ...
    let needs_snapshot = arguments.iter().any(|argument| {
        ...
        destination_is_source
            && !matches!(
                ...
                InternalUnitScalarArgumentSourceRecord::Parameter {
                    location:
                        post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarParameterLocationRecord::Register(source),
                    ..
...
pub(crate) fn expected_argument_bytes(
    target: NativeTarget,
    call_plan: &abstract_operations_to_target_operations::calling_conventions::CallPlan,
    arguments: &[post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarCallArgumentRecord],
            ...
            match argument.source {
                ...
                InternalUnitScalarArgumentSourceRecord::Parameter { location, .. } => {
                    match location {
                        ...
                        post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarParameterLocationRecord::IncomingStack {
                            byte_offset,
                        ...
                        post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarParameterLocationRecord::FrameSpill {
                            byte_offset,
                        } => expected_x86_stack_load(
                            &mut bytes,
                            register,
...
pub(crate) fn expected_unit_scalar_result_bytes(
    target: NativeTarget,
    result: &post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarCallResultRecord,
) -> Option<Vec<u8>> {
...
pub(crate) fn integer_shape(integer: IntegerType) -> Option<ValueShape> {
...
pub(crate) fn scalar_home_shape(scalar: ScalarType) -> Option<ValueShape> {
    match scalar {
...
pub(crate) fn expected_x86_stack_store(bytes: &mut Vec<u8>, register: u8, offset: u32) {
...
pub(crate) fn expected_aarch64_stack_store(register: u8, offset: u32) -> Option<u32> {
