...
use post_allocation_machine_to_selected_form_encoding::machine_code::ScalarStackMutation;
        ...
        Architecture::X86_64 => {
            ...
            while decoder.can_decode() {
                ...
                if mutation {
                    ...
                    if matches!(row.kind,
                        post_allocation_machine_to_selected_form_encoding::machine_code::ScalarStackMutationKind::Allocate { byte_size }
                        | post_allocation_machine_to_selected_form_encoding::machine_code::ScalarStackMutationKind::Release { byte_size }
                        | post_allocation_machine_to_selected_form_encoding::machine_code::ScalarStackMutationKind::X86ReleasePreservingFlags { byte_size }
...
mod tests {
    ...
    use crate::image_emission::ObjectScalarStack;
    use post_allocation_machine_to_selected_form_encoding::machine_code::{
    ...
    fn validate_stack(
        ...
        crate::image_emission::object_artifact::replay::scalar::control_flow::validate_stack(
            architecture,
            machine,
            bytes,
            evidence,
