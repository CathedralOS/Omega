...
use abstract_operations_to_target_operations::target_operations::{
    MixedStructuralScalarFunctionAbi, TerminalPsiProvenance,
};
...
pub(crate) fn validate_mixed_structural_scalar_abi(
    ...
    let result_shape =
        crate::image_emission::object_artifact::replay::unit::scalar_call_custody::scalar_home_shape(
...
pub(crate) fn structural_result_matches_return(
    result: &post_allocation_machine_to_selected_form_encoding::machine_code::InternalStructuralCallResult,
...
pub(crate) fn exact_borrowed_projection(
    ...
    source: &post_allocation_machine_to_selected_form_encoding::machine_code::UnitParameterHomeRecord,
    destination: &post_allocation_machine_to_selected_form_encoding::machine_code::UnitParameterRecord,
        ...
        .any(|segment| matches!(segment, terminal_psi::StructuralPathSegment::FixedIndex(_)))
    {
        let Some((leaf_type, leaf_shape, byte_offset)) =
            crate::image_emission::object_artifact::replay::structural::condition_layout::replay_structural_projection(
        ...
        let Some((byte_offset, _capacity)) =
            crate::image_emission::object_artifact::replay::structural::condition_layout::replay_bounded_byte_field(
                source.structural_type,
                &argument.path,
                structural_types,
            )
    ...
    let Some(root_shape) =
        crate::image_emission::object_artifact::replay::structural::condition_layout::replay_structural_value_shape(
            source.structural_type,
            structural_types,
        )
    else {
...
struct InternalUnitCallCustody<'a> {
    ...
    span: CallSpan<'a>,
    stacks: StackFacts<'a>,
    expected_plan: abstract_operations_to_target_operations::calling_conventions::CallPlan,
...
pub(crate) fn validate_internal_unit_call_custody(
    ...
    relocations: &[post_allocation_machine_to_selected_form_encoding::machine_code::InternalCallRelocation],
    internal_unit_calls: &[post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallRecord],
    ...
    callee_parameter_abi: Option<&post_allocation_machine_to_selected_form_encoding::machine_code::ParameterFunctionAbiRecord>,
    callee_unit_parameters: &[post_allocation_machine_to_selected_form_encoding::machine_code::UnitParameterRecord],
...
pub(crate) fn expected_projected_copy_bytes(
    ...
    if argument.shape.class == abstract_operations_to_target_operations::calling_conventions::ValueClass::BorrowedReference
        && source_placement.shape.class == abstract_operations_to_target_operations::calling_conventions::ValueClass::BorrowedReference
    {
        let [
            abstract_operations_to_target_operations::calling_conventions::ValueLocation::Indirect {
                pointer,
        ...
        return match target.architecture {
            Architecture::X86_64 => {
                let destination = match *pointer {
                    ...
                    abstract_operations_to_target_operations::calling_conventions::IndirectPointerLocation::Stack { .. } => 11,
                };
                let mut bytes = Vec::new();
                ...
                if let abstract_operations_to_target_operations::calling_conventions::IndirectPointerLocation::Stack {
                    stack_byte_offset,
                    ..
                } = *pointer
                {
            ...
            Architecture::Aarch64 => {
                let destination = match *pointer {
                    ...
                    abstract_operations_to_target_operations::calling_conventions::IndirectPointerLocation::Stack { .. } => 9,
                };
