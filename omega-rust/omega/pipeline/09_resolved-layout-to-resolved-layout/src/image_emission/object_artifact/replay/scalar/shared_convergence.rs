...
use super::super::structural::condition_layout::replay_boolean_field_offset;
use super::super::structural::condition_read::{
    condition_stack_depth_before, replay_aarch64_boolean_structural_read,
    replay_x86_boolean_structural_read,
};
use super::conditional_regions::collect_conditional_tree_regions;
use super::conditional_stack::replay_scalar_conditional_region;
use super::division_stack::decode_exact_x86_instruction;
...
pub(crate) fn validate_boolean_shared_convergence_stack(
    ...
    return_edges: &[semantic_vocabulary::EdgeId],
    fallthrough_return_edge: semantic_vocabulary::EdgeId,
    structural_conditions: &[post_allocation_machine_to_selected_form_encoding::machine_code::BooleanStructuralConditionEvidence],
    merge_offset: usize,
    cleanup: Option<
        &post_allocation_machine_to_selected_form_encoding::machine_code::UnitAffineCleanupRecord,
    >,
    parameter_homes: &[post_allocation_machine_to_selected_form_encoding::machine_code::UnitParameterHomeRecord],
