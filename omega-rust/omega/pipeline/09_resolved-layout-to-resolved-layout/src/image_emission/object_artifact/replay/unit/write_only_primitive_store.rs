...
use super::structural_scalar_field_store::{
...
pub(crate) fn validate_unit_write_only_primitive_stores(
    target: NativeTarget,
...
fn validate_store(
            ...
            let (expected_location, placed_byte_size) =
                match scalar_parameter.placement.locations.as_slice() {
                    [
                        ...
                        post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarParameterLocationRecord::Register(*register),
                        *byte_size,
                    ),
                    [
                        ValueLocation::Stack {
    ...
    let expected = match store.source {
        ...
        UnitWriteOnlyPrimitiveStoreSourceRecord::Parameter {
            location: post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarParameterLocationRecord::IncomingStack { byte_offset },
            ..
