...
pub(crate) fn boundary_result_is_exact(
    target: NativeTarget,
    ...
    match realization {
        ...
        BoundaryRealization::HostedReadByte(_) => {
            ...
            abstract_operations_to_target_operations::target_operations::HostedReadByteRealization::supports_target(target)
...
mod tests {
    ...
    use post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryScalarResultRecord;
    ...
    fn hosted_read_byte_requires_the_exact_target_and_structural_sum_home() {
        ...
        .unwrap();
        let result =
            BoundaryResultRecord::Structural(post_allocation_machine_to_selected_form_encoding::machine_code::BoundaryStructuralResultRecord {
