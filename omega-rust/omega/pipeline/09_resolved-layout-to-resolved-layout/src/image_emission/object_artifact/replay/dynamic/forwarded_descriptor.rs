...
fn validate_call_result(
    ...
    call: &post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicDescriptorCallRecord,
    operation_end: usize,
) -> Option<()> {
    ...
    let expected_bytes =
        crate::image_emission::object_artifact::replay::unit::scalar_call_custody::expected_unit_scalar_result_bytes(target, result)?;
...
fn validate_table_address(
    target: NativeTarget,
    function: &MachineCodeFunction,
    argument: &post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicDescriptorArgumentRecord,
) -> Option<()> {
...
fn expected_adapter_bytes(
    target: NativeTarget,
    erased: &abstract_operations_to_target_operations::calling_conventions::CallPlan,
    realization: &abstract_operations_to_target_operations::calling_conventions::CallPlan,
