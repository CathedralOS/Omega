...
use super::super::unit::stack::{aarch64_unit_link_instruction, validate_stack_adjustment_pair};
use crate::image_emission::{ObjectError, ObjectScalarCallStack};

pub(crate) fn validate_scalar_call_stack(
