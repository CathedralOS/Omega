...
use crate::image_emission::{ObjectError, ObjectUnitCallStack};

pub(crate) fn validate_installed_provider_unit_scalar_calls(
    target: NativeTarget,
    ...
    for call in &function.installed_provider_unit_scalar_calls {
        ...
        let exact_attribution_count = function
            ...
            .iter()
            .filter(|row| row.site == post_allocation_machine_to_selected_form_encoding::machine_code::SemanticCodeSite::Operation(operation))
