...
use crate::image_emission::HostedReceiverBinding;
use crate::object_file::{ObjectPlan, ObjectSymbolHandle, RelocationPlan};
use abstract_operations_to_target_operations::target_operations::{
    CallSiteOwner, TerminalPsiProvenance,
};
...
pub struct ObjectArtifact {
    ...
    pub(crate) fragment_replay:
        Option<crate::image_emission::function_fragments::replay::FragmentReplay>,
...
pub struct ObjectFunction {
    ...
    pub structural_call_scalar_return: Option<post_allocation_machine_to_selected_form_encoding::machine_code::StructuralCallScalarReturnEvidence>,
    pub parameter_abi: Option<post_allocation_machine_to_selected_form_encoding::machine_code::ParameterFunctionAbiRecord>,
    ...
    pub x86_scalar_fma: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::X86ScalarFmaFragment>,
    pub x86_scalar_fma_occurrences: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::X86ScalarFmaOccurrenceRecord>,
    pub x86_floating_control: Option<post_allocation_machine_to_selected_form_encoding::machine_code::X86FloatingControlRecord>,
    ...
    pub internal_unit_calls: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallRecord>,
    pub internal_unit_scalar_calls: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarCallRecord>,
    pub installed_provider_unit_scalar_calls:
        Vec<post_allocation_machine_to_selected_form_encoding::machine_code::InstalledProviderUnitScalarCallRecord>,
    pub dynamic_calls: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::DynamicCallRecord>,
    pub stored_dynamic_calls: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::StoredDynamicCallRecord>,
    pub dynamic_parameter_calls: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::DynamicParameterCallRecord>,
    pub forwarded_dynamic_parameter_calls: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicParameterCallRecord>,
    pub forwarded_dynamic_descriptor_calls: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicDescriptorCallRecord>,
    pub unit_scalar_homes: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarHomeRecord>,
    pub unit_integer_constants: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::UnitIntegerConstantRecord>,
    pub unit_affine_scalar_records: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::UnitAffineScalarRecordEstablishmentRecord>,
    pub unit_structural_scalar_field_stores:
        Vec<post_allocation_machine_to_selected_form_encoding::machine_code::UnitStructuralScalarFieldStoreRecord>,
    pub unit_write_only_primitive_stores: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::UnitWriteOnlyPrimitiveStoreRecord>,
    pub scalar_structural_scalar_field_stores:
        Vec<post_allocation_machine_to_selected_form_encoding::machine_code::ScalarStructuralScalarFieldStoreRecord>,
    pub unit_parameters: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::UnitParameterRecord>,
    pub unit_parameter_homes: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::UnitParameterHomeRecord>,
    pub unit_continuations: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::UnitContinuationRecord>,
    pub unit_affine_cleanup: Option<post_allocation_machine_to_selected_form_encoding::machine_code::UnitAffineCleanupRecord>,
    pub scalar_affine_cleanup: Option<post_allocation_machine_to_selected_form_encoding::machine_code::UnitAffineCleanupRecord>,
    ...
    pub scalar_structural_parameters: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::UnitParameterRecord>,
    pub scalar_structural_parameter_homes: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::UnitParameterHomeRecord>,
...
pub struct ObjectForwardedDynamicDescriptorAdapter {
    pub record: post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicDescriptorAdapterRecord,
    pub symbol: ObjectSymbolHandle,
...
pub struct ObjectForwardedDynamicDescriptorSlot {
    pub row_index: u32,
    pub adapter: post_allocation_machine_to_selected_form_encoding::machine_code::ForwardedDynamicDescriptorAdapterIdentity,
...
pub struct ObjectForeignCall {
    ...
    pub provider_execution: post_allocation_machine_to_selected_form_encoding::machine_code::ProviderExecutionRecord,
    pub boundary_entry_plan:
        abstract_operations_to_target_operations::calling_conventions::BoundaryEntryPlan,
    ...
    pub same_stack_contribution:
        abstract_operations_to_target_operations::task_plans::AdmittedSameStackContribution,
    ...
    pub scalar_arguments: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::ForeignCallScalarArgumentRecord>,
    ...
    pub callback_address: Option<post_allocation_machine_to_selected_form_encoding::machine_code::CallbackAddressMaterialization>,
    /// Result custody retained from machine emission. Its code offset is
    /// rebased to absolute object `.text`, like `text_offset` below.
    pub scalar_result: Option<post_allocation_machine_to_selected_form_encoding::machine_code::ForeignCallScalarResultRecord>,
    /// Absolute object-text intervals proving complete MXCSR preservation for
    /// this returning x86 foreign call.
    pub x86_floating_control: Option<post_allocation_machine_to_selected_form_encoding::machine_code::X86ForeignCallFloatingControlRecord>,
    /// Absolute object-text intervals proving complete FPCR preservation for
    /// this returning AArch64 foreign call.
    pub aarch64_floating_control: Option<post_allocation_machine_to_selected_form_encoding::machine_code::Aarch64ForeignCallFloatingControlRecord>,
