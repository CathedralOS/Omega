...
use crate::image_emission::installation_record::codec::fingerprint::{
...
pub(crate) fn installed_forwarded_dynamic_parameter_calls(
    ...
    image
        ...
        .map(|(function, call)| {
            let terminal_psi_to_abstract_operations::abstract_operations::AbstractDynamicDescriptorSource::Parameter(source) =
...
pub(crate) fn installed_compiler_private_function(
    emitted: &crate::image_emission::ObjectCompilerPrivateFunction,
...
pub(crate) fn installed_scalar_control_cleanups_match_object(
    installed: &[post_allocation_machine_to_selected_form_encoding::machine_code::UnitAffineCleanupRecord],
    emitted: &[post_allocation_machine_to_selected_form_encoding::machine_code::ScalarControlAffineCleanupRecord],
) -> bool {
...
pub(crate) fn installed_scalar_source_is_exact(
    ...
    machine: MachineId,
    consumer: &post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallRecord,
        ...
        post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarArgumentSourceRecord::Parameter {
            ...
            .is_some_and(|parameter| {
                let expected_location = function.parameter_abi.as_ref().and_then(|abi| {
                    crate::image_emission::object_artifact::replay::unit::scalar_call_custody::entry_spills::parameter_location(
                        abi,
                    ...
                    .filter(|attribution| {
                        attribution.machine == machine
                            && attribution.attribution.site
                                == post_allocation_machine_to_selected_form_encoding::machine_code::SemanticCodeSite::Operation(defining_operation)
