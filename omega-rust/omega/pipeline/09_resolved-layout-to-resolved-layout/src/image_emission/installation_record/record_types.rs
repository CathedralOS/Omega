...
use crate::image::{CompilerTextValidationEvidence, FinalImageLayout};
use crate::image_emission::installation_record::codec::fingerprint::write_hex;
use crate::image_emission::{ObjectBoundarySettlement, ObjectCodeAttribution, ObjectPortEffect};
use abstract_operations_to_target_operations::target_operations::CallSiteOwner;
use post_allocation_machine_to_selected_form_encoding::machine_code::StructuralReturnRecord;
...
pub struct InstallationRecord {
    ...
    pub(crate) boundary_opaque_applications:
        crate::boundary_applications::BoundaryOpaqueRepresentationApplications,
...
impl InstallationRecord {
    ...
    pub fn boundary_opaque_applications_mut_for_test(
        &mut self,
    ) -> &mut crate::boundary_applications::BoundaryOpaqueRepresentationApplications {
...
pub struct InstalledImageSections {
    ...
    pub executable_inventory_digest: crate::image::PlacedExecutableRegionInventoryDigest,
    ...
    pub data_inventory_digest: crate::image::PlacedDataRegionInventoryDigest,
}
...
pub struct InstalledForwardedDynamicDescriptorCall {
    ...
    pub semantic_result:
        Option<terminal_psi_to_abstract_operations::abstract_operations::AbstractResult>,
    pub result: Option<post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarCallResultRecord>,
    pub text_offset: usize,
    pub byte_count: usize,
}
...
pub struct InstalledFunction {
    ...
    pub unit_stack: Option<crate::image_emission::ObjectUnitStack>,
    pub scalar_stack: Option<crate::image_emission::ObjectScalarStack>,
    pub unit_call_stacks: Vec<crate::image_emission::ObjectUnitCallStack>,
    pub scalar_call_stacks: Vec<crate::image_emission::ObjectScalarCallStack>,
    ...
    pub scalar_control_affine_cleanups: Vec<post_allocation_machine_to_selected_form_encoding::machine_code::UnitAffineCleanupRecord>,
...
pub struct InstalledCompilerPrivateFunction {
    ...
    pub machine: MachineId,
    pub scalar_abi: abstract_operations_to_target_operations::target_operations::ScalarFunctionAbi,
    pub text_offset: usize,
    pub byte_count: usize,
}
...
pub struct InstalledInternalUnitScalarCall {
    pub machine: MachineId,
    pub text_offset: usize,
    pub custody: post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitScalarCallRecord,
}
