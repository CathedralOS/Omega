...
fn encode_boundary_result(
    ...
    match result {
        ...
        BoundaryResultRecord::Structural(result) => {
            ...
            crate::image_emission::installation_record::encode_structural_types(
                bytes,
            ...
            BoundaryStructuralResultRecord {
                ...
                declaration: {
                    let mut declarations =
                        crate::image_emission::installation_record::decode_structural_types(
                            reader,
                        )?;
...
mod tests {
    ...
    fn structural_boundary_result_round_trips_with_exact_sum_layout() {
        ...
        let result = BoundaryResultRecord::Structural(BoundaryStructuralResultRecord {
            ...
            declaration: crate::image_emission::object_artifact::replay::boundary::result_placement::test_byte_read_declaration(
