    ...
    match source {
        ...
        InternalUnitScalarArgumentSourceRecord::Parameter {
            ...
            match location {
                ...
                post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarParameterLocationRecord::IncomingStack { byte_offset } => {
                    bytes.extend_from_slice(&[1, 0, 0, 0]);
                    push_u32(bytes, byte_offset);
                }
                post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarParameterLocationRecord::FrameSpill { byte_offset } => {
    ...
    match tag {
        ...
        3 => {
            ...
            let location = match location_tag {
                0 if byte_offset == 0 => post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarParameterLocationRecord::Register(
...
mod tests {
    ...
    use post_allocation_machine_to_selected_form_encoding::machine_code::UnitScalarParameterLocationRecord;
    ...
    fn selected_call_source_round_trips_exact_identity_type_and_instruction() {
        for scalar_type in [
            ...
            let source = InternalUnitScalarArgumentSourceRecord::SelectedCall {
                ...
                scalar_type,
                instruction: target_operations_to_selected_instructions::SelectedInstructionId(9),
            };
