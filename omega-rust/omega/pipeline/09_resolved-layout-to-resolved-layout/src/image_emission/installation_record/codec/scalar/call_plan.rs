...
use crate::image_emission::installation_record::codec::value_placement::{
    decode_direct_placement, encode_direct_placement,
};
use crate::image_emission::installation_record::{InstallationError, Reader, push_u16, push_u32};
...
pub(crate) fn decode_scalar_call_plan(
    reader: &mut Reader<'_>,
