...
pub(crate) struct DecodedInstallationHeader {
    ...
    pub(crate) component_progress:
        Option<crate::image_emission::installation_record::InstalledComponentProgress>,
    pub(crate) image: ImageFingerprint,
    pub(crate) image_sections: crate::image_emission::installation_record::InstalledImageSections,
    pub(crate) compiler_text_validation: CompilerTextValidationEvidence,
}

pub(crate) fn encode_installation_header(
    bytes: &mut Vec<u8>,
...
pub(crate) fn decode_installation_header(
    reader: &mut Reader<'_>,
    ...
    let component_progress = component_progress_present
        .then(|| {
            ...
            Ok(
                crate::image_emission::installation_record::InstalledComponentProgress {
                    manifest,
                    acceptance,
                },
            )
    ...
    let image_sections = crate::image_emission::installation_record::InstalledImageSections {
        layout: crate::image::FinalImageLayout {
        ...
        data_byte_count: usize::try_from(reader.u64()?)
            .map_err(|_| InstallationError::InvalidImageSectionLayout)?,
        final_data_fingerprint:
            crate::image_emission::installation_record::InitializedDataFingerprint(reader.array()?),
        ...
        executable_inventory_digest:
            crate::image::PlacedExecutableRegionInventoryDigest::from_digest(reader.array()?),
        data_inventory_digest: crate::image::PlacedDataRegionInventoryDigest::from_digest(
            reader.array()?,
        ),
    };
