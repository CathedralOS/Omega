...
// affine cleanups.
pub(in crate::image_emission::installation_record) mod affine_cleanup;
pub(in crate::image_emission::installation_record) mod parameter;
pub(in crate::image_emission::installation_record) mod stack;
