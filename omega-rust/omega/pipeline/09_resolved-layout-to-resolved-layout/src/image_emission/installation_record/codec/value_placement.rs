...
use crate::image_emission::installation_record::{
    InstallationError, Reader, decode_boolean, push_u16, push_u32,
};
...
mod tests {
    ...
    fn indirect_result_pointer_retains_aarch64_dedicated_register() {
        let placement = abstract_operations_to_target_operations::calling_conventions::evaluate_call_plan(
            abstract_operations_to_target_operations::calling_conventions::CallingPolicy::Aapcs64,
