...
use crate::image_emission::installation_record::codec::structural::scalar::{
    decode_identity, encode_identity,
};
...
pub(crate) fn encode_structural_field(
    ...
    match &field.field_type {
        StructuralFieldType::BoundedInteger(bounds) => {
            bytes.push(8);
            crate::image_emission::installation_record::codec::unit::scalar::encode_integer_type(
                bytes,
                bounds.integer_type(),
            )?;
            crate::image_emission::installation_record::codec::unit::scalar::encode_integer_value(
                bytes,
                bounds.minimum(),
            );
            crate::image_emission::installation_record::codec::unit::scalar::encode_integer_value(
...
pub(crate) fn decode_structural_field(
    ...
    let field_type = match reader.u8()? {
        8 => {
            ...
            let minimum =
                crate::image_emission::installation_record::codec::unit::scalar::decode_integer_value(reader)?;
            let maximum =
                crate::image_emission::installation_record::codec::unit::scalar::decode_integer_value(reader)?;
