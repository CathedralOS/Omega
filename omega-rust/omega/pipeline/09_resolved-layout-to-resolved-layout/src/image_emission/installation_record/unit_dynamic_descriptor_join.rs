...
pub(super) fn validate_installed_unit_dynamic_descriptor_joins(
    ...
    for function in &record.functions {
        ...
        let edge_identity =
            |attribution: &crate::image_emission::ObjectCodeAttribution| match attribution
                .attribution
                .site
            {
...
fn contiguous(
    left: &crate::image_emission::ObjectCodeAttribution,
    right: &crate::image_emission::ObjectCodeAttribution,
) -> bool {
