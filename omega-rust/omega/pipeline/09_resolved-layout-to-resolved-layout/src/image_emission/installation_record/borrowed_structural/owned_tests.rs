...
use crate::image_emission::installation_record::record_validation::internal_unit_calls_match_object;
use crate::image_emission::installation_record::resource_tests::installed_function_with_unit_call;
...
fn fixture(
    ...
    function.mixed_structural_scalar_abi =
        Some(abstract_operations_to_target_operations::target_operations::MixedStructuralScalarFunctionAbi {
            ...
            structural_parameters: structural
                ...
                .zip(&homes)
                .map(
                    |(parameter, home)| abstract_operations_to_target_operations::target_operations::TargetStructuralParameter {
                        place: parameter.place,
                        structural_type: parameter.structural_type,
                        multiplicity: parameter.multiplicity,
                        access: parameter.access,
