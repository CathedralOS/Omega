...
use crate::image_emission::installation_record::{InstallationRecord, InstalledFunction};
use abstract_operations_to_target_operations::calling_conventions::{
    CallSignature, CallingPolicy, evaluate_call_plan,
};

pub(super) fn parameter_homes(
    function: &InstalledFunction,
) -> &[post_allocation_machine_to_selected_form_encoding::machine_code::UnitParameterHomeRecord] {
...
pub(super) fn scalar_result_is_exact(
    call: &post_allocation_machine_to_selected_form_encoding::machine_code::InternalUnitCallRecord,
