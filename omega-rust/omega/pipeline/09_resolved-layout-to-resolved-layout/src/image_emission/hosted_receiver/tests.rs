...
fn physical_contract(
    requirement: &str,
    source: crate::program_entry_plan::ProgramEntryPhysicalContractPackageSourceDigest,
) -> ProgramEntryPhysicalContractPlan {
    let plan = crate::program_entry_plan::exact_macos_arm64_physical_boundary_entry_plan();
    ProgramEntryPhysicalContractPlan::new(
        ...
        0,
        [
            crate::program_entry_plan::MACOS_ARM64_I32_TYPE_IDENTITY,
            crate::program_entry_plan::MACOS_ARM64_ADDRESS_TYPE_IDENTITY,
            crate::program_entry_plan::MACOS_ARM64_ADDRESS_TYPE_IDENTITY,
            crate::program_entry_plan::MACOS_ARM64_ADDRESS_TYPE_IDENTITY,
        ]
        .into_iter()
        .map(str::to_owned)
        .collect(),
        crate::program_entry_plan::MACOS_ARM64_I32_TYPE_IDENTITY.into(),
...
fn hosted_physical_replay_keeps_source_bytes_for_package_qualified_requirements() {
    let source =
        crate::program_entry_plan::exact_macos_arm64_physical_contract_package_source_digest();
    for requirement in [
        crate::program_entry_plan::MACOS_ARM64_PHYSICAL_REQUIREMENT_IDENTITY,
...
fn linux_physical_contract(
    ...
    let plan = crate::program_entry_plan::exact_linux_x86_64_physical_boundary_entry_plan();
    ProgramEntryPhysicalContractPlan::new(
        ...
        source,
        0,
        [crate::program_entry_plan::LINUX_X86_64_ADDRESS_TYPE_IDENTITY]
            .into_iter()
            .map(str::to_owned)
            .collect(),
        crate::program_entry_plan::LINUX_X86_64_I32_TYPE_IDENTITY.into(),
        plan.contract_report_fingerprint(),
        plan.plan().clone(),
    )
...
fn linux_hosted_physical_replay_keeps_source_bytes_for_package_qualified_requirements() {
    let source =
        crate::program_entry_plan::exact_linux_x86_64_physical_contract_package_source_digest();
    for requirement in [
        crate::program_entry_plan::LINUX_X86_64_PHYSICAL_REQUIREMENT_IDENTITY,
...
fn linux_arm64_physical_contract(
    ...
    let plan = crate::program_entry_plan::exact_linux_arm64_physical_boundary_entry_plan();
    ProgramEntryPhysicalContractPlan::new(
        ...
        source,
        0,
        [crate::program_entry_plan::LINUX_ARM64_U64_TYPE_IDENTITY]
            .into_iter()
            .map(str::to_owned)
            .collect(),
        crate::program_entry_plan::LINUX_ARM64_I32_TYPE_IDENTITY.into(),
        plan.contract_report_fingerprint(),
        plan.plan().clone(),
    )
...
fn linux_arm64_hosted_physical_replay_keeps_source_bytes_for_package_qualified_requirements() {
    let source =
        crate::program_entry_plan::exact_linux_arm64_physical_contract_package_source_digest();
    for requirement in [
        crate::program_entry_plan::LINUX_ARM64_PHYSICAL_REQUIREMENT_IDENTITY,
...
fn windows_physical_contract(
    ...
    let plan = crate::program_entry_plan::exact_windows_x86_64_physical_boundary_entry_plan();
    ProgramEntryPhysicalContractPlan::new(
        ...
        0,
        Vec::new(),
        crate::program_entry_plan::WINDOWS_X86_64_U32_TYPE_IDENTITY.into(),
        plan.contract_report_fingerprint(),
        plan.plan().clone(),
    )
...
fn windows_hosted_physical_replay_keeps_source_bytes_for_package_qualified_requirements() {
    let source =
        crate::program_entry_plan::exact_windows_x86_64_physical_contract_package_source_digest();
    for requirement in [
        crate::program_entry_plan::WINDOWS_X86_64_PHYSICAL_REQUIREMENT_IDENTITY,
...
fn hosted_receiver_binding(
    ...
    super::HostedReceiverBinding {
        source: crate::program_entry_plan::SelectedProgramEntrySourceSignature::from_checked_typed_entry(
            ...
            "main".into(),
            "Main::main".into(),
            crate::program_entry_plan::ProgramEntrySourceReceiverSignature::ProvisionedMutable {
        ...
        physical,
        services: Vec::new(),
        demand: crate::image_emission::StackDemand {
