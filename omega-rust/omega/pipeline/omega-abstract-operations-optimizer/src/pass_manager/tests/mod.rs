...
use crate::{
    ...
    rules::tests::{
        ...
        constant_conditional_same_target_unit, dead_exact_add_unit, dead_scalar_literals_unit,
        ...
        live_signed_remainder_by_negative_one_unit, live_zero_dividend_unit, local_cse_unit,
