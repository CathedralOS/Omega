...
use crate::machine_code::{Aarch64ReturnLinkEvidence, StackAdjustmentPair};
...
pub struct UnitContinuationRecord {
    ...
    pub bindings: Vec<terminal_psi_to_abstract_operations::abstract_operations::ValueBinding>,
