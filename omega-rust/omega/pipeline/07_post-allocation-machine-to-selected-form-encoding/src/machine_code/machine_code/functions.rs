...
pub struct MachineCodeFunction {
    ...
    pub scalar_abi: Option<abstract_operations_to_target_operations::target_operations::ScalarFunctionAbi>,
    ...
    /// manufacture it.
    pub mixed_structural_scalar_abi: Option<abstract_operations_to_target_operations::target_operations::MixedStructuralScalarFunctionAbi>,
    ...
    /// Ordered adjacent fallthrough cleanup boundaries, separate from return.
    pub unit_continuations: Vec<UnitContinuationRecord>,
