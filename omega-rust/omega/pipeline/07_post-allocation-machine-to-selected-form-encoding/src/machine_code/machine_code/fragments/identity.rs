...
use target_operations_to_selected_instructions::SelectedInstructionProvenance;
...
fn encode_successor(hasher: &mut Sha256, successor: &FunctionFragmentSuccessorProvenance) {
    hasher.update([match successor.role {
        target_operations_to_selected_instructions::SelectedSuccessorRole::Semantic => 0,
        target_operations_to_selected_instructions::SelectedSuccessorRole::EdgeTransferContinuation => 1,
        target_operations_to_selected_instructions::SelectedSuccessorRole::CaseDispatchContinuation => 2,
    }]);
