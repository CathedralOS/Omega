...
use abstract_operations_to_target_operations::calling_conventions::{
    CallPlan, ValuePlacement, ValueShape,
};
...
pub struct ParameterFunctionAbiRecord {
    ...
    pub parameters:
        Vec<abstract_operations_to_target_operations::target_operations::ScalarAbiValue>,
    ...
    fn only_local_stack_residence_supplies_a_stack_home_offset() {
        ...
        for source in [
            ...
            StructuralSourceLocation::IncomingBorrowedPointer {
                location: abstract_operations_to_target_operations::calling_conventions::IndirectPointerLocation::Register(
                    MachineRegister::Aarch64X(0),
                ),
            },
            StructuralSourceLocation::IncomingBorrowedPointer {
                location: abstract_operations_to_target_operations::calling_conventions::IndirectPointerLocation::Stack {
                    stack_byte_offset: 32,
                    alignment: 8,
                },
            },
