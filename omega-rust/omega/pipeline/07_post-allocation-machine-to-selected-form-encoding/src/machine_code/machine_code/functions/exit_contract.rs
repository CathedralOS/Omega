...
pub struct WholeFunctionExitContract {
    ...
    pub post_allocation_machine: register_homes_to_post_allocation_machine::PostAllocationMachineIdentity,
    pub register_environment: target_operations_to_selected_instructions::register_model::TargetRegisterEnvironmentIdentity,
    pub physical_register_model: target_operations_to_selected_instructions::register_model::PhysicalRegisterModelIdentity,
