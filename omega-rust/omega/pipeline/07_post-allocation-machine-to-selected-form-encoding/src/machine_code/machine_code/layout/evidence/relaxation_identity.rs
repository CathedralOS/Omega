...
pub struct RevisionRoots {
    ...
    pub selected: target_operations_to_selected_instructions::SelectedInstructionPlanIdentity,
    pub machine: register_homes_to_post_allocation_machine::PostAllocationMachineIdentity,
    pub pre_layout: crate::machine_code::SelectedFormEncodingIdentity,
        ...
        for block in &function.blocks {
            ...
            for row in &block.instructions {
                ...
                match row.branch.as_deref() {
                    ...
                    Some(crate::machine_code::ResolvedBranchEvidence::Conditional(branch)) => {
                        hasher.update([1]);
                    ...
                    Some(crate::machine_code::ResolvedBranchEvidence::Jump(jump)) => {
                        hasher.update([2]);
