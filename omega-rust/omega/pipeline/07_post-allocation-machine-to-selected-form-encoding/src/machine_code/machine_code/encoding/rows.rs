...
use crate::machine_code::SelectedFormInternalMachineFixup;
...
pub enum SelectedFormMachineDisposition {
    ...
    Aarch64FusedBranchNonZeroToCbnzV1 {
        ...
        source_read: register_homes_to_post_allocation_machine::QualifiedPhysicalRead,
    },
...
pub struct ResolvedPhysicalAddress {
    pub symbolic: register_homes_to_post_allocation_machine::PhysicalAddressOperation,
