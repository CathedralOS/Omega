...
use abstract_operations_to_target_operations::calling_conventions::{CallPlan, ValuePlacement};
...
pub struct InternalStructuralResultHomeRecord {
    pub requirement: abstract_operations_to_target_operations::target_operations::TargetStructuralHomeRequirement,
...
pub struct InstalledProviderUnitScalarCallRecord {
    ...
    pub claim_transfers: Vec<ClaimTransfer>,
    pub completion_claim_sources:
        Vec<abstract_operations_to_target_operations::target_operations::CompletionClaimSource>,
...
pub enum InternalUnitCallSource {
    ...
    InstalledProvider {
        ...
        completion_claim_sources:
            Vec<terminal_psi_to_abstract_operations::abstract_operations::CompletionClaimSource>,
