...
use crate::machine_code::{UnitScalarHomeRecord, UnitScalarParameterLocationRecord};
...
/// [`crate::machine_code::ForeignCallRelocation::offset`]. A selected boundary source instead
...
pub struct InternalUnitCallArgumentRecord {
    ...
    pub source_location: crate::machine_code::StructuralSourceLocation,
