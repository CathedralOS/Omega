...
use semantic_vocabulary::{EdgeId, MachineId, OperationId, ValueId};
...
pub enum DynamicParameterCallMechanismRecord {
    X86MemoryIndirect {
        table: abstract_operations_to_target_operations::target_operations::MachineRegister,
    },
    Aarch64LoadedIndirect {
        table: abstract_operations_to_target_operations::target_operations::MachineRegister,
        target: abstract_operations_to_target_operations::target_operations::MachineRegister,
    },
}
...
pub struct DynamicParameterCallRecord {
    ...
    pub parameter: terminal_psi::TerminalDynamicDescriptorParameter,
    pub requirement: terminal_psi::TerminalDynamicRequirement,
    pub function_call_plan: CallPlan,
    pub dispatch_call_plan: CallPlan,
    pub instance: abstract_operations_to_target_operations::target_operations::MachineRegister,
    pub table: abstract_operations_to_target_operations::target_operations::MachineRegister,
...
pub struct ForwardedDynamicParameterCallRecord {
    ...
    pub instance: abstract_operations_to_target_operations::target_operations::MachineRegister,
    pub table: abstract_operations_to_target_operations::target_operations::MachineRegister,
    pub instance_destination:
        abstract_operations_to_target_operations::target_operations::MachineRegister,
    pub table_destination:
        abstract_operations_to_target_operations::target_operations::MachineRegister,
...
pub struct ForwardedDynamicDescriptorArgumentRecord {
    ...
    pub instance: abstract_operations_to_target_operations::target_operations::TargetDynamicDescriptorInstanceArgument,
    pub instance_destination: abstract_operations_to_target_operations::target_operations::MachineRegister,
    pub table_destination: abstract_operations_to_target_operations::target_operations::MachineRegister,
    pub source_home_byte_offset: u32,
    pub source_home_indirect: bool,
...
pub struct ForwardedDynamicDescriptorAdapterIdentity {
    pub application: terminal_psi::ClosedConformanceApplicationCommitment,
    pub row_index: u32,
...
pub struct ForwardedDynamicDescriptorAdapterRecord {
    ...
    pub result: terminal_psi::ClosedConformanceCallableResult,
