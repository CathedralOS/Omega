...
pub struct IntegerEqualConstantRangeRule;

impl IntegerEqualConstantRangeRule {
    pub fn contract() -> OptimizationRuleContract {
        super::contract(b"omega.psi-rule.integer-equal-constant-range.v1")
    }
}

impl PsiOptimizationRule for IntegerEqualConstantRangeRule {
