...
pub enum CountdownInvariantConstantRelocationError {
    ...
    TransformedValidation(omega_optimization_validation::OptimizationUnitValidationError),
    ...
    InvalidLedger(omega_optimization_unit::InvalidPsiTransformationLedger),
}
