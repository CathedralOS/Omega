...
use omega_selected_instructions::{
    MachineAlternative, MachineEffectCatalogIdentity, SelectedBlockId, SelectedInstructionId,
    SelectedInstructionPlanIdentity, VirtualRegisterId,
};
use omega_target::NativeTarget;
use psi_core::MachineId;

use crate::{PreAllocationMachineEffectIdentity, StructuralUnitCallMachineEffects};
