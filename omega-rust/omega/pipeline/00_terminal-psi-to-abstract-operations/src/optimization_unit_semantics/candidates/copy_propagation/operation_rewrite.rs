...
use crate::optimization_unit::RedundantBlockParameterRewrite;
use semantic_vocabulary::ValueId;

pub(crate) fn rewrite_block_parameter_operation(
    operation: &mut crate::abstract_operations::AbstractOperation,
    ...
    let rewrite_bindings = |bindings: &mut Vec<crate::abstract_operations::ValueBinding>| {
