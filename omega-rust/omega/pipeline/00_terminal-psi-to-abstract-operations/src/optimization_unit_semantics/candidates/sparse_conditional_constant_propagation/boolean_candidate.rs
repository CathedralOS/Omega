...
use crate::optimization_unit_semantics::candidates::sparse_conditional_constant_propagation::{
...
pub fn validate_boolean_evaluation_candidate(
    ...
    let accepted_provenance = vec![crate::optimization_unit::ProvenanceRewrite {
        input: site,
    ...
    node.operation = crate::abstract_operations::AbstractOperation::BooleanConstant {
