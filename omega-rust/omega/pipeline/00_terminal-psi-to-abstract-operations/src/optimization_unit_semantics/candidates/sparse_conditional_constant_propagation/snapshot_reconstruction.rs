    ...
    loop {
        ...
        for block in &function.blocks {
            ...
            let successors = match &node.operation {
                crate::abstract_operations::AbstractOperation::Jump { .. }
                | crate::abstract_operations::AbstractOperation::StructuralCase { .. } => {
                    operation_successors.iter().collect::<Vec<_>>()
                }
                crate::abstract_operations::AbstractOperation::Conditional {
                    condition,
                    when_true,
                    when_false,
            ...
            for successor in successors {
                ...
                if let crate::abstract_operations::AbstractOperation::StructuralCase {
                    cases, ..
                } = &node.operation
                {
...
pub(crate) fn validator_scalar_operation_successors(
    ...
    match operation {
        O::Jump {
            ...
            fuel: vec![crate::optimization_unit::FuelSettlement {
...
mod structural_case_tests {
    ...
    use crate::optimization_unit_semantics::candidates::sparse_conditional_constant_propagation::snapshot_reconstruction::validator_scalar_operation_successors;
    ...
    use crate::optimization_unit::{
        ValueDefinition, ValueDefinitionSite,
    };
    ...
    fn independent_sccp_case_payload_overdefines_an_ordinary_constant_arrival() {
        ...
        let mut input = crate::optimization_unit_semantics::tests::fixtures::scalar_units::unit();
        ...
        dispatch.nodes[0].operation = O::StructuralCase {
            ...
            cases: vec![
                crate::abstract_operations::AbstractStructuralCaseSuccessor {
                    psi_edge: case_edge,
                    target: join_block,
...
mod residual_edge_tests {
    ...
    fn successor_projection_retains_exact_ordered_residuals() {
        ...
        let residuals = [2, 0]
            ...
            .to_vec();
        let operation = crate::abstract_operations::AbstractOperation::Jump {
            structural_bindings: Vec::new(),
