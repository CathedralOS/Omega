...
use crate::optimization_unit::{
    PsiOptimizationUnit, PsiRewriteCandidate, PsiRewritePatch, ScalarSubstitution,
    recompute_psi_optimization_unit_identity,
};
use crate::optimization_unit_semantics::candidates::global_value_numbering::{
    independent_reachable_dominators, independently_replacement_dominates_uses,
};
use crate::optimization_unit_semantics::candidates::rewrite_accounting::adjacent_merge::reconstruct_adjacent_merge_ownership_is_identity;
use crate::optimization_unit_semantics::candidates::rewrite_accounting::non_adjacent_merge::reconstruct_non_adjacent_merge_accounting;
use crate::optimization_unit_semantics::candidates::rewrite_accounting::preserve_edge_custody;
use crate::optimization_unit_semantics::candidates::rewrite_accounting::substitutions::rewrite_scalar_value_uses;
...
use crate::optimization_unit_semantics::{
    OptimizationUnitValidationError, ValidatedPsiRewrite, validate_psi_optimization_unit,
};
...
pub(super) fn validate(
    ...
    for block in &mut output_function.blocks {
        for node in &mut block.nodes {
            node.effect = crate::optimization_unit::EffectLink {
                input: effect,
                output: effect
                    .checked_add(1)
                    .ok_or(OptimizationUnitValidationError::CandidateLocationMissing)?,
