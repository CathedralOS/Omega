...
use crate::optimization_unit_semantics::candidates::state_specialization::cyclic_machines;
use crate::optimization_unit_semantics::candidates::structural_bindings::bound_place;
...
fn admit_membership_node(
    ...
    Some(FoldedCaseMembershipRow {
        site: crate::optimization_unit::NodeLocation {
            machine,
            block,
