...
use crate::optimization_unit_semantics::candidates::global_value_numbering::ScalarCseProofClass;
use crate::optimization_unit_semantics::candidates::rewrite_accounting::common_subexpression::reconstruct_phi_translated_cse_accounting;
use crate::optimization_unit_semantics::candidates::rewrite_accounting::preserve_edge_custody;
use crate::optimization_unit_semantics::candidates::rewrite_accounting::substitutions::{
...
pub(super) fn validate_phi_translated_scalar_common_subexpression_candidate(
    ...
    for incoming in &patch.incoming {
        ...
        bindings.push(crate::abstract_operations::ValueBinding {
