...
use crate::optimization_unit::{
    OptimizationEdge, RedundantBlockParameterRewrite, ScalarSubstitution,
};
use crate::optimization_unit_semantics::candidates::copy_propagation::rewrite_block_parameter_operation;
use crate::optimization_unit_semantics::unit_validation::derived_metadata::expected_edges;
...
pub(crate) fn preserve_edge_custody(
    node: &crate::optimization_unit::OptimizationNode,
