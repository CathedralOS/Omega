...
use crate::optimization_unit_semantics::candidates::sparse_conditional_constant_propagation::validator_scalar_constant_facts;
...
fn integer_comparison_condition(
    block: &crate::optimization_unit::OptimizationBlock,
    ...
    match &predecessor.operation {
        ...
        O::Conditional {
            ...
            for row in site_rows {
                ...
                *arm = crate::abstract_operations::AbstractSuccessor {
...
fn fused_edge(
    ...
    let bindings = resolved
        ...
        .map(|binding| {
            ...
            crate::abstract_operations::ValueBinding {
...
fn node_uses(
    operation: &crate::abstract_operations::AbstractOperation,
