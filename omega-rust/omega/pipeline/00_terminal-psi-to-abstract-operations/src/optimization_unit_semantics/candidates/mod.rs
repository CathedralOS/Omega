...
pub struct ValidatedPsiRewrite {
    pub(in crate::optimization_unit_semantics::candidates) unit: PsiOptimizationUnit,
    pub(in crate::optimization_unit_semantics::candidates) candidate: OptimizationCandidateIdentity,
    pub(in crate::optimization_unit_semantics::candidates) validator: OptimizationValidatorIdentity,
    pub(in crate::optimization_unit_semantics::candidates) provenance: Vec<ProvenanceRewrite>,
}
