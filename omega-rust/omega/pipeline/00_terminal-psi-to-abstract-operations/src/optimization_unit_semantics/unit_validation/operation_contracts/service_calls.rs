...
use crate::optimization_unit_semantics::unit_validation::operation_contracts::affine_calls::exact_plain_affine_structural_call;
use crate::optimization_unit_semantics::unit_validation::operation_contracts::boundaries::{
    boundary_completion_matches, boundary_requirements_match,
};
use crate::optimization_unit_semantics::unit_validation::operation_contracts::claim_transfers::validate_internal_claim_transfers;
use crate::optimization_unit_semantics::unit_validation::operation_contracts::payloadless_cases::{
...
use crate::optimization_unit_semantics::unit_validation::operation_contracts::records::{
    plain_record_call, record_establishment_matches,
};
use crate::optimization_unit_semantics::unit_validation::operation_contracts::scalar_arrays::{
...
fn reference_call_matches(
    ...
    result.structural_type == signature.structural_type
        ...
        && crate::optimization_unit_semantics::unit_validation::references::contains_reference(types, result.structural_type)
        && (crate::optimization_unit_semantics::unit_validation::references::referent(types, result.structural_type).is_some()
            || crate::optimization_unit_semantics::unit_validation::operation_contracts::constructible(
                types,
