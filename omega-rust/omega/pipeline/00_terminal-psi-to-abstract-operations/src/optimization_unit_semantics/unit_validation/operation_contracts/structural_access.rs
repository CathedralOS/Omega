...
use crate::optimization_unit_semantics::unit_validation::operation_contracts::records::record_loan;
...
pub(crate) fn structural_arguments_match(
    ...
    for (argument, parameter) in arguments.iter().zip(parameters) {
            ...
            .contains(&terminal_psi::StructuralPathSegment::Referent)
        {
            ...
            ) && crate::optimization_unit_semantics::unit_validation::references::reference_source_type(
