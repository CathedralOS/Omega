...
use crate::optimization_unit_semantics::unit_validation::operation_contracts::structural_access::structural_source_contract;
...
pub(super) fn validate(
    ...
    source: PlaceId,
    successors: &[crate::abstract_operations::AbstractStructuralCaseSuccessor],
