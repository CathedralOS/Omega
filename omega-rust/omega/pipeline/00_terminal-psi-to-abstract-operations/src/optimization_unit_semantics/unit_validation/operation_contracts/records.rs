        ...
        for field in fields {
            ...
            match field.field_type {
                ...
                StructuralFieldType::Structural(child)
                    if references
                        && crate::optimization_unit_semantics::unit_validation::references::referent(types, child).is_some() => {
                }
    ...
    while let Some(current) = pending.pop() {
        ...
        for field in matching {
            ...
            match field.field_type {
                ...
                | StructuralFieldType::BoundedInteger(_) => {}
                StructuralFieldType::Structural(child)
                    if crate::optimization_unit_semantics::unit_validation::references::referent(types, child).is_some() => {}
