...
use crate::optimization_unit_semantics::unit_validation::operation_contracts::structural_access::{
...
fn static_primitive_subloans_reconstruct_interleaved_paths_and_access() {
    ...
    let mut unit =
        crate::optimization_unit_semantics::tests::fixtures::scalar_units::projected_shared_structural_scalar_call_unit();
