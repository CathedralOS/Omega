...
use crate::optimization_unit_semantics::unit_validation::structural_catalog::structural_root_key;
        ...
        for (node_index, node) in block.nodes.iter().enumerate() {
            ...
            match &node.operation {
                ...
                O::EstablishReference {
                    ...
                    let expected =
                        crate::optimization_unit_semantics::unit_validation::references::referent(
                            structural_types,
...
fn readable_field_type(
    ...
    let signature = crate::optimization_unit_semantics::unit_validation::operation_contracts::structural_source_contract(
