...
use crate::optimization_unit_semantics::unit_validation::derived_metadata::validate_places_and_claims;
use crate::optimization_unit_semantics::unit_validation::operation_contracts::validate_values_and_bindings;
use crate::optimization_unit_semantics::unit_validation::services::valid_service_ceiling;
use crate::optimization_unit_semantics::unit_validation::structural_catalog::{
...
use crate::optimization_unit_semantics::{OptimizationUnitValidationError, current_ownership};
...
pub(crate) fn validate_function(
    ...
    crate::optimization_unit_semantics::unit_validation::references::validate_function_references(
        function,
        structural_types,
    )?;
