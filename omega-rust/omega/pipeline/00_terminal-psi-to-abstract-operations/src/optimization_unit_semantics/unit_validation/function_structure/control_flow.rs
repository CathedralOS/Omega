...
pub(super) struct FunctionControlFlow<'a> {
    pub(super) blocks: BTreeMap<BlockId, &'a crate::optimization_unit::OptimizationBlock>,
...
pub(super) fn index_blocks(
    ...
    BTreeMap<BlockId, &crate::optimization_unit::OptimizationBlock>,
...
pub(super) fn validate_nodes_and_edges<'a>(
    ...
    blocks: BTreeMap<BlockId, &'a crate::optimization_unit::OptimizationBlock>,
