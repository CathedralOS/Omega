...
//! contract. An address join (`crate::abstract_operations::control_flow::address_joins`)
                ...
                let exact_source = if address_join(parameter, types) {
                    ...
                    crate::abstract_operations::control_flow::address_joins::is_static_projection(
                        ...
                        access != StructuralAccess::WriteOnlyBorrow
                            ...
                            && crate::abstract_operations::control_flow::address_joins::referent_type(
                                types.values().copied(),
                                root_type,
                                &binding.argument.path,
...
fn address_join(
    ...
    crate::abstract_operations::control_flow::address_joins::is_address_join(
        parameter,
        |identity| types.get(&identity).copied(),
    )
}
