...
fn valid_edge_partial_affine_transition(
    ...
    if !discards.is_empty()
        ...
        || !crate::optimization_unit_semantics::current_ownership::valid_partial_continuation_complement(
            function,
            structural_types,
            root,
            &moved,
...
pub(crate) fn valid_edge_affine_transition(
    ...
    let mut eligible = results
        ...
        .collect::<Vec<_>>();
    eligible.extend(
        crate::optimization_unit_semantics::current_ownership::parameter_establishment_order(
            function,
        )
        .into_iter()
        .rev()
