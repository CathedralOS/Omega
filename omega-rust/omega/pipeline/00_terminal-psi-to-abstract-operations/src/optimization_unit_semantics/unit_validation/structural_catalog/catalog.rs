...
use crate::optimization_unit_semantics::unit_validation::structural_catalog::content_projection::validate_structural_content_projection;
use crate::optimization_unit_semantics::unit_validation::structural_catalog::type_declarations::{
...
> {
    ...
    for declaration in &unit.structural_types {
        ...
        if children.iter().any(|child| {
            crate::optimization_unit_semantics::unit_validation::references::contains_reference(
                &types, *child,
            )
        }) {
            return Err(
