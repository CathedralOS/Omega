use crate::abstract_operations::AbstractFunctionResult;
use crate::optimization_unit::PsiOptimizationFunction;
use crate::optimization_unit_semantics::OptimizationUnitValidationError;
use crate::optimization_unit_semantics::current_ownership::mutations::expected_trivial_affine_discards;
use crate::optimization_unit_semantics::current_ownership::residuals::partial_affine_residuals;
use crate::optimization_unit_semantics::current_ownership::structural::{
