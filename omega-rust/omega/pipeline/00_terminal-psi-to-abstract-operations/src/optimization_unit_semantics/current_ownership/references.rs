...
use crate::optimization_unit_semantics::unit_validation::operation_contracts::structural_source_contract;
use crate::optimization_unit_semantics::unit_validation::references::{
...
fn window_hole(
    ...
    let parent =
        crate::optimization_unit_semantics::unit_validation::structural_catalog::resolve_structural_path(types, root, path)?;
