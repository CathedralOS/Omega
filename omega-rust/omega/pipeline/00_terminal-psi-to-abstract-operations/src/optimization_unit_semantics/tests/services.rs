...
use crate::optimization_unit_semantics::tests::fixtures::scalar_units::{
    scalar_boundary_call_unit, scalar_call_unit, structural_call_unit,
};
use crate::optimization_unit_semantics::tests::fixtures::structural_catalog::{
...
use crate::optimization_unit_semantics::tests::support::{
    id, refresh_identity, refresh_node_derivatives,
};
...
use crate::optimization_unit_semantics::unit_validation::operation_contracts::operation_service_contract_matches;
use crate::optimization_unit_semantics::unit_validation::services::refresh_root_service_reach;
...
fn replays_exact_root_service_reach_shape_and_installation_dependencies() {
    ...
    for (index, node) in overlap.functions[0].blocks[0].nodes.iter_mut().enumerate() {
        ...
        node.fuel = node
            ...
            .iter()
            .copied()
            .map(|site| crate::optimization_unit::FuelSettlement { site, units: 1 })
            .collect();
...
) -> crate::abstract_operations::AbstractReboundDynamicDispatch {
    crate::abstract_operations::AbstractReboundDynamicDispatch {
...
fn stored_dispatch(
    ...
    operation: OperationId,
    realization: MachineId,
) -> crate::abstract_operations::AbstractStoredDynamicDispatch {
    crate::abstract_operations::AbstractStoredDynamicDispatch {
        stored: crate::abstract_operations::AbstractStoredDynamicDescriptor {
...
fn descriptor_argument(
    ...
    target: MachineId,
    realization: MachineId,
) -> crate::abstract_operations::AbstractDynamicDescriptorArgument {
    crate::abstract_operations::AbstractDynamicDescriptorArgument {
        ...
        source: crate::abstract_operations::AbstractDynamicDescriptorSource::Selection {
            selection: conformance_selection(owner, 0),
            application: conformance_application(owner, &[realization]),
        },
    }
