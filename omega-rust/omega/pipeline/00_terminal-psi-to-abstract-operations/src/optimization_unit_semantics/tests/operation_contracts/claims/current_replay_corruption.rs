...
use crate::abstract_operations::{AbstractFunctionResult, AbstractOperation};
use crate::optimization_unit_semantics::tests::fixtures::dominance::refresh_function_derivatives;
use crate::optimization_unit_semantics::tests::fixtures::ownership::{
    affine_claim_join_unit, affine_claim_transfer_unit,
};
use crate::optimization_unit_semantics::tests::fixtures::structural_catalog::structural_result_call_unit;
use crate::optimization_unit_semantics::tests::support::{id, refresh_node_derivatives};
