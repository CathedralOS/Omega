...
fn build_unit(
    ...
    if matches!(producer, RootProducer::Boundary) {
        ...
        functions[0].operations.insert(
            ...
            AbstractOperation::BoundaryCall {
                ...
                result: crate::abstract_operations::AbstractBoundaryResult::Structural(
    ...
    if matches!(producer, RootProducer::Boundary) {
        ...
        crate::optimization_unit_semantics::unit_validation::services::refresh_root_service_reach(
            &mut unit,
        )
