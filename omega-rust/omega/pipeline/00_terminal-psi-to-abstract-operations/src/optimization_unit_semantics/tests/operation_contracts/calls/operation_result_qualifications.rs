...
fn structural_call_and_return_retain_the_exact_projected_result_roster() {
    ...
    for function in &mut unit.functions {
        ...
        let crate::abstract_operations::AbstractFunctionResult::Structural(result) =
            &mut function.result
        else {
    ...
    let crate::abstract_operations::AbstractFunctionResult::Structural(caller_result) =
...
fn boundary_requirement_consumes_a_dominating_operation_result_qualification() {
    ...
    boundary_node.operation = AbstractOperation::BoundaryCall {
        ...
        completion_claim_sources: vec![crate::abstract_operations::CompletionClaimSource {
