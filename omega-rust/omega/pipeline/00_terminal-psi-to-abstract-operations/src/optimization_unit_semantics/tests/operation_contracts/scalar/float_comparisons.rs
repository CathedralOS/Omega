use crate::abstract_operations::{AbstractFunctionResult, AbstractOperation as Operation};
use crate::optimization_unit_semantics::tests::fixtures::scalar_units::exact_add_unit;
...
fn comparison_unit() -> crate::optimization_unit::PsiOptimizationUnit {
