...
use crate::optimization_unit::PsiOptimizationUnit;
use crate::optimization_unit_semantics::tests::fixtures::dominance::refresh_function_derivatives;
use crate::optimization_unit_semantics::tests::fixtures::structural_catalog::structural_result_call_unit;
use crate::optimization_unit_semantics::tests::support::{id, refresh_identity};
use crate::optimization_unit_semantics::validate_psi_optimization_unit;
...
fn array_unit(length: u64) -> PsiOptimizationUnit {
    ...
    for function in &mut candidate.functions {
        ...
        if let crate::abstract_operations::AbstractFunctionResult::Structural(result) =
            &mut function.result
        {
...
fn scalar_array_rewrites_preserve_every_leaf_occurrence_and_result_identity() {
    ...
    *elements = vec![to, to];
    ...
    crate::optimization_unit_semantics::candidates::rewrite_accounting::substitutions::rewrite_scalar_value_uses(
        &mut substitution,
        from,
        to,
    );
    ...
    crate::optimization_unit_semantics::candidates::copy_propagation::rewrite_block_parameter_operation(
        &mut parameter_rewrite,
        crate::optimization_unit::RedundantBlockParameterRewrite {
