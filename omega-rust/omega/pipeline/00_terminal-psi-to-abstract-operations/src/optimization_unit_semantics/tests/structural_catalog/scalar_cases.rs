...
use semantic_vocabulary::{OperationId, PlaceId, StructuralPlaceKind, StructuralTypeId, ValueId};
...
fn scalar_case_initializer_is_a_live_typed_scalar_use() {
    ...
    let types = candidate
        ...
        .collect();
    assert!(
        crate::optimization_unit_semantics::unit_validation::operation_contracts::scalar_case_establishment_matches(
            function,
            &node.operation,
            &types
        )
