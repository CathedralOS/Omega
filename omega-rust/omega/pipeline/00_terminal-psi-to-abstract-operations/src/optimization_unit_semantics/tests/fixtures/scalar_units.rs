...
pub(crate) fn exact_add_unit() -> PsiOptimizationUnit {
    ...
    let unit = reconstruct_psi_optimization_unit_seed(&plan, FuelScheduleIdentity::new(1).unwrap())
        .unwrap();
    crate::optimization_unit::attach_accepted_obligation_facts(
        unit.clone(),
        vec![crate::optimization_unit::AcceptedObligationFact::new(
            unit.psi,
            [23; 32],
            machine,
        ...
        functions: vec![AbstractFunction {
            ...
            operations: vec![
                ...
                AbstractOperation::BoundaryCall {
                    ...
                    result: crate::abstract_operations::AbstractBoundaryResult::Scalar(
                        AbstractResult {
                            value: result,
                            scalar_type,
                        },
