...
pub(crate) fn compressed_trivial_affine_return_unit_with_prefix(
    ...
    let local_type = terminal_psi::StructuralTypeDeclaration {
        id: structural_type,
        identity: "validation::trivial-affine-empty-record".into(),
        shape: terminal_psi::StructuralTypeShape::Record { fields: Vec::new() },
    };
    let parameter = |place, position, multiplicity| terminal_psi::StructuralParameterDeclaration {
        place,
        position,
        is_self: false,
        structural_type,
    ...
    let local = |place, declaration_ordinal| terminal_psi::StructuralPlaceDeclaration {
        id: place,
    ...
    let plan = AbstractOperationPlan {
        ...
        functions: vec![AbstractFunction {
            ...
            structural_parameters: vec![
                parameter(source, 0, terminal_psi::StructuralMultiplicity::Linear),
                parameter(first_tail, 1, terminal_psi::StructuralMultiplicity::Affine),
...
pub(crate) fn explicit_trivial_affine_return_unit() -> PsiOptimizationUnit {
    ...
    let structural_type_declaration = terminal_psi::StructuralTypeDeclaration {
        id: structural_type,
        identity: "validation::explicit-trivial-affine-empty-record".into(),
        shape: terminal_psi::StructuralTypeShape::Record { fields: Vec::new() },
    };
    let place_declaration = terminal_psi::StructuralPlaceDeclaration {
        id: place,
        kind: StructuralPlaceKind::TrivialAffineLocal {
