...
use crate::optimization_unit::{PsiOptimizationUnit, reconstruct_psi_optimization_unit_seed};
...
pub(crate) fn provider_attachment_specialization_unit() -> PsiOptimizationUnit {
    ...
    let provider_field = id(1, semantic_vocabulary::StructuralFieldId::new);
    ...
    let call = |psi_operation, boundary| AbstractOperation::BoundaryCall {
        psi_operation,
        result: crate::abstract_operations::AbstractBoundaryResult::Unit,
        boundary,
        arguments: Vec::new(),
