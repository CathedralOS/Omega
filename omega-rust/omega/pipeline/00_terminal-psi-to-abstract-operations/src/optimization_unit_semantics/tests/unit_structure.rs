...
use crate::abstract_operations::{AbstractOperation as O, AbstractOperation};
...
use crate::optimization_unit_semantics::tests::fixtures::scalar_units::{
    scalar_boundary_call_unit, scalar_call_unit, unit,
};
...
use crate::optimization_unit_semantics::unit_validation::affine_authority::{
...
fn structural_block_root_keys_retain_block_and_position() {
    ...
    .map(crate::optimization_unit_semantics::unit_validation::structural_catalog::structural_root_key);
...
fn structural_block_parameters_cannot_enter_scalar_only_optimizer_blocks() {
    ...
    let types = candidate
        ...
        .collect();
    assert_eq!(
        crate::optimization_unit_semantics::unit_validation::structural_catalog::validate_function_structural_catalog(
            function,
            &types,
            &BTreeMap::new()
        ),
