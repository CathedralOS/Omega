...
use crate::abstract_operations::AtomicCoherenceViolation;

use crate::optimization_unit::PsiProvenance;
...
pub enum OptimizationUnitValidationError {
    ...
    ContentProjectionOwnerMismatch(semantic_vocabulary::ContentProjectionIdentity),
    ...
    AtomicEventCoherenceMismatch {
        ...
        block: BlockId,
        node: u32,
        violation: AtomicCoherenceViolation,
    },
    ...
    ContextIdentity(terminal_codec::CodecError),
    ContextProofFingerprint(terminal_codec::ProofCodecError),
