...
use crate::optimization_unit::{ProvenanceRewrite, PsiRewriteCandidate, PsiTransformationLedger};
...
pub struct PsiOptimizationCommit {
    ...
    pub pruned_machines: Vec<crate::optimization_unit::PrunedMachineCustody>,
