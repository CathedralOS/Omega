...
//!
//! Owns the saturating integer-subtract constant fold contract and proposal join.
...
pub struct SaturatingIntegerSubtractConstantsRule;

impl SaturatingIntegerSubtractConstantsRule {
...
impl PsiOptimizationRule for SaturatingIntegerSubtractConstantsRule {
