...
//!
//! Owns the saturating integer-multiply constant fold contract and proposal join.
...
pub struct SaturatingIntegerMultiplyConstantsRule;

impl SaturatingIntegerMultiplyConstantsRule {
...
impl PsiOptimizationRule for SaturatingIntegerMultiplyConstantsRule {
