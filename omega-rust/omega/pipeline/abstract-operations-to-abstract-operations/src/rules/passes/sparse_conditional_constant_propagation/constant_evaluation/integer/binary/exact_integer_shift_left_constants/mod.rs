...
//!
//! Owns the proof-certified exact integer left-shift constant fold contract and proposal join.
...
pub struct ExactIntegerShiftLeftConstantsRule;

impl ExactIntegerShiftLeftConstantsRule {
...
impl PsiOptimizationRule for ExactIntegerShiftLeftConstantsRule {
