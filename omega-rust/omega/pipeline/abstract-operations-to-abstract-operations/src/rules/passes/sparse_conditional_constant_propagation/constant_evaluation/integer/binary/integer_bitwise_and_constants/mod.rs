...
//!
//! Owns the integer bitwise-AND constant fold contract and proposal join.
...
pub struct IntegerBitwiseAndConstantsRule;

impl IntegerBitwiseAndConstantsRule {
...
impl PsiOptimizationRule for IntegerBitwiseAndConstantsRule {
