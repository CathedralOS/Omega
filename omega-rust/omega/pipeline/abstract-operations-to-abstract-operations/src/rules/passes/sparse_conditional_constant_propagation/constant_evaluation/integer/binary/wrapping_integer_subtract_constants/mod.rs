...
//!
//! Owns the wrapping integer-subtract constant fold contract and proposal join.
...
pub struct WrappingIntegerSubtractConstantsRule;

impl WrappingIntegerSubtractConstantsRule {
...
impl PsiOptimizationRule for WrappingIntegerSubtractConstantsRule {
