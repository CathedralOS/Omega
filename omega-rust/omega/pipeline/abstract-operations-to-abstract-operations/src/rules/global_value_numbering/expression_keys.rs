...
//!
//! This file owns the closed key vocabularies and operand translation,
...
pub(in crate::rules) use compatible_policy::{
    compatible_policy_scalar_leader, compatible_policy_scalar_redundant,
};
pub(in crate::rules) use proof_certified::proof_certified_scalar_expression;
...
pub(in crate::rules::global_value_numbering) enum TotalScalarExpressionKey {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord)]
pub(in crate::rules) enum CompatiblePolicyScalarExpressionKey {
...
impl CompatiblePolicyScalarExpressionKey {
    pub(in crate::rules::global_value_numbering) fn references_any(
        self,
    ...
    pub(in crate::rules::global_value_numbering) fn translate(
        self,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord)]
pub(in crate::rules) enum ProofCertifiedScalarExpressionKey {
