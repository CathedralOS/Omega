...
fn envelope_and_operation_roster_corruption_fail_closed() {
    assert_eq!(
        ...
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceParameters
    );
    assert_eq!(
        leaf_error(|function| {
            function
        ...
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceStructuralParameters
    );
    assert_eq!(
        leaf_error(|function| function.result = AbstractFunctionResult::Unit),
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceResult
    );
    assert_eq!(
        leaf_error(|function| {
        ...
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceEntryClaims
    );
    assert_eq!(
        leaf_error(|function| {
            function
        ...
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourcePublishedServices
    );
    assert_eq!(
        leaf_error(|function| function.block_entries[0].operation_offset = 1),
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceBlockRoster
    );
    assert_eq!(
        leaf_error(|function| function.operations.swap(1, 2)),
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceOperationRoster
    );
}
...
fn definition_type_value_and_operand_corruption_fail_closed() {
    assert_eq!(
        ...
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceDefinitionRoster
    );
    assert_eq!(
        leaf_error(|function| {
    ...
    assert_eq!(
        ...
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceConstantType
    );
    for invalid in [
        ...
        assert_eq!(
            ...
            StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceIntegerType
        );
    }
    assert_eq!(
        leaf_error(|function| {
        ...
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceConstantOutsideType
    );
    assert_eq!(
        leaf_error(|function| {
            let AbstractOperation::WrappingIntegerMultiply { left, right, .. } =
                &mut function.operations[2]
            else {
                unreachable!()
            };
        ...
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceWrappingMultiplyOperands
    );
}
...
fn return_and_cleanup_corruption_fail_closed() {
    assert_eq!(
        ...
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceResultLink
    );
    assert_eq!(
        leaf_error(|function| {
    ...
    assert_eq!(
        ...
        StraightLineWrappingIntegerMultiplyImmediateTranslationError::SourceCleanup
    );
}
