            ...
            for count_type in native_types() {
                for (value, count) in boundary_pairs(value_type, count_type) {
                    ...
                    let AbstractToTargetFunctionTranslationDisposition::Validated(
                        ...
                        panic!("constant wrapping shift-right must publish only its exact immediate family")
                    };
...
fn classifier_is_disjoint_from_plain_parameter_and_other_shift_policies() {
    ...
    *value = ValueId::new(83_004).unwrap();
    ...
    for replacement in [
        ...
        assert!(
            !crate::validation::straight_line_wrapping_integer_shift_right_immediate::is_candidate(
    ...
    let parameter =
        super::super::parameter_translation_fixture::wrapping_integer_shift_right_parameters_plan(
            &[
