...
#[test]
fn validates_native_saturating_add_boundaries_on_every_native_target() {
        ...
        for scalar_type in native_types() {
            for (left_value, right_value) in boundary_pairs(scalar_type) {
                ...
                let AbstractToTargetFunctionTranslationDisposition::Validated(
                    ...
                    panic!("constant saturating integer-add must publish only its exact immediate family")
                };
                ...
                assert_eq!(row.return_edge(), EdgeId::new(80_009).unwrap());
    ...
    *value = ValueId::new(80_004).unwrap();
    ...
    for replacement in [
        AbstractOperation::ExactIntegerAdd {
            ...
            obligation: ObligationId::new(80_011).unwrap(),
        },
        ...
        assert!(
            !crate::validation::straight_line_saturating_integer_add_immediate::is_candidate(
    ...
    assert!(
        !crate::validation::straight_line_saturating_integer_add_immediate::is_candidate(
            &super::super::parameter_translation_fixture::uniform_saturating_integer_add_plan(
                scalar_type(),
                2,
            )
            .functions[0]
