...
fn target_provenance_corruption_fails_closed() {
    assert_eq!(
        ...
        StraightLineWrappingIntegerSubtractImmediateTranslationError::TargetProvenance
    );
    assert_eq!(
...
fn target_immediate_corruption_fails_closed() {
    for mutate in [
        ...
        assert_eq!(
            ...
            StraightLineWrappingIntegerSubtractImmediateTranslationError::TargetOperation
        );
    }
}
...
fn substitute_operation(operation: &mut TargetOperation) {
    *operation = TargetOperation::ReturnIntegerExpression {
        ...
        expression: TargetIntegerExpression::WrappingSubtract {
