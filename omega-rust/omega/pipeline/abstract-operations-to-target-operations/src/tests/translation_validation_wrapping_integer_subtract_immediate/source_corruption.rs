...
fn envelope_and_operation_roster_corruption_fail_closed() {
    assert_eq!(
        ...
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceParameters
    );
    assert_eq!(
        leaf_error(|function| {
            function
        ...
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceStructuralParameters
    );
    assert_eq!(
        leaf_error(|function| function.result = AbstractFunctionResult::Unit),
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceResult
    );
    assert_eq!(
        leaf_error(|function| {
        ...
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceEntryClaims
    );
    assert_eq!(
        leaf_error(|function| {
            function
        ...
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourcePublishedServices
    );
    assert_eq!(
        leaf_error(|function| function.block_entries[0].operation_offset = 1),
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceBlockRoster
    );
    assert_eq!(
        leaf_error(|function| function.operations.swap(1, 2)),
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceOperationRoster
    );
}
...
fn definition_type_value_and_operand_corruption_fail_closed() {
    assert_eq!(
        ...
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceDefinitionRoster
    );
    assert_eq!(
        leaf_error(|function| {
    ...
    assert_eq!(
        ...
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceConstantType
    );
    for invalid in [
        ...
        assert_eq!(
            ...
            StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceIntegerType
        );
    }
    assert_eq!(
        leaf_error(|function| {
        ...
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceConstantOutsideType
    );
    assert_eq!(
        leaf_error(|function| {
            let AbstractOperation::WrappingIntegerSubtract { left, right, .. } =
                &mut function.operations[2]
            else {
                unreachable!()
            };
        ...
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceWrappingSubtractOperands
    );
}
...
fn return_and_cleanup_corruption_fail_closed() {
    assert_eq!(
        ...
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceResultLink
    );
    assert_eq!(
        leaf_error(|function| {
    ...
    assert_eq!(
        ...
        StraightLineWrappingIntegerSubtractImmediateTranslationError::SourceCleanup
    );
}
