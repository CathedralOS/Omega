...
fn target_provenance_corruption_fails_closed() {
    assert_eq!(
        ...
        StraightLineIntegerBitwiseXorImmediateTranslationError::TargetProvenance
    );
    assert_eq!(
...
fn target_immediate_corruption_fails_closed() {
    for mutate in [
        ...
        assert_eq!(
            ...
            StraightLineIntegerBitwiseXorImmediateTranslationError::TargetOperation
        );
    }
}
...
fn mutate_edge(operation: &mut TargetOperation) {
    ...
    *psi_edge = EdgeId::new(79_200).unwrap();
}
...
fn mutate_source_value(operation: &mut TargetOperation) {
    ...
    *source_value = ValueId::new(79_201).unwrap();
}
