//! Optimizer module role: stage group. Ordered mixed integer/IEEE Unit custody.
...
use semantic_vocabulary::{
    BlockId, ClaimId, EdgeId, IeeeFloatValue, IntegerSign, IntegerType, IntegerValue, MachineId,
...
use crate::{
    ...
    AbstractToTargetTranslationValidationError, IntegerIeeeFloatLiteralSequenceMember,
