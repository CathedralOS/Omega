...
fn operations(
    candidate: &mut target_operations::TargetOperationPlan,
        ...
        assert_eq!(
            candidate_error(|candidate| {
                ...
                match field {
                    ...
                    _ => settlement.provider = target::AdmittedX86ScalarFmaProvider::from_deployment_claim(TargetProfile::WindowsX64, &X86_SCALAR_FMA_REQUIRED_FEATURES).unwrap(),
                }
            }),
