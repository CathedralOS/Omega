//! Independent replay of constant integer bitwise-XOR as an integer immediate.

use target_operations::{TargetFunction, TargetOperation};

use super::grammar::ReconstructedIntegerBitwiseXorImmediate;
use super::{
    StraightLineIntegerBitwiseXorImmediateTranslationError as Error,
    StraightLineIntegerBitwiseXorImmediateTranslationReceipt as Receipt,
};

pub(super) fn validate(
    source: ReconstructedIntegerBitwiseXorImmediate,
    ...
    if !matches!(
        ...
        TargetOperation::ReturnIntegerImmediate {
            ...
            && source_value == source.bitwise_xor_result
