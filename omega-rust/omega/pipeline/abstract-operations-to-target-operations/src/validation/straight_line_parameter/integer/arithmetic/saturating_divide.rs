//! Saturating integer-divide replay with nonzero-divisor obligation custody.
...
pub(crate) fn is_candidate(function: &AbstractFunction) -> bool {
    super::super::super::source::integer::arithmetic::saturating_divide::is_candidate(function)
}
...
pub(crate) fn validate(
    ...
    StraightLineSaturatingIntegerDivideParametersTranslationError,
> {
    let reconstructed = super::reconstruct_saturating_divide(source, expected_target, target)?;
    ...
    let TargetOperation::ReturnIntegerExpression {
        ...
        return Err(StraightLineSaturatingIntegerDivideParametersTranslationError::TargetOperation);
    };
    ...
    Ok(
        StraightLineSaturatingIntegerDivideParametersTranslationReceipt::new(
            source.machine,
