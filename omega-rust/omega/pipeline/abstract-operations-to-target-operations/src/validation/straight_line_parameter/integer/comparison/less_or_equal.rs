...
pub(crate) fn is_candidate(function: &AbstractFunction) -> bool {
    super::super::super::source::integer::comparison::less_or_equal::is_candidate(function)
}
...
pub(crate) fn validate(
    ...
    StraightLineIntegerLessOrEqualParametersTranslationError,
> {
    let reconstructed = super::reconstruct_less_or_equal(source, expected_target, target)?;
