//! Exact integer bitwise-OR-of-parameters target replay.
...
pub(crate) fn is_candidate(function: &AbstractFunction) -> bool {
    super::super::super::source::integer::bitwise::bitwise_or::is_candidate(function)
}
...
pub(crate) fn validate(
    ...
    StraightLineIntegerBitwiseOrParametersTranslationError,
> {
    let reconstructed = super::reconstruct_bitwise_or(source, expected_target, target)?;
    let TargetOperation::ReturnIntegerExpression {
        ...
        return Err(StraightLineIntegerBitwiseOrParametersTranslationError::TargetOperation);
    };
    ...
    Ok(
        StraightLineIntegerBitwiseOrParametersTranslationReceipt::new(
            source.machine,
