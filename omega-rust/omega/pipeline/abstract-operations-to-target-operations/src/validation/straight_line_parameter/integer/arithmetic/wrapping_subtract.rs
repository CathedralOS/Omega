//! Exact wrapping-integer-subtract-of-parameters target replay.
...
pub(crate) fn is_candidate(function: &AbstractFunction) -> bool {
    super::super::super::source::integer::arithmetic::wrapping_subtract::is_candidate(function)
}
...
pub(crate) fn validate(
    ...
    StraightLineWrappingIntegerSubtractParametersTranslationError,
> {
    let reconstructed = super::reconstruct_wrapping_subtract(source, expected_target, target)?;
    let TargetOperation::ReturnIntegerExpression {
        ...
        return Err(StraightLineWrappingIntegerSubtractParametersTranslationError::TargetOperation);
    };
    ...
    Ok(
        StraightLineWrappingIntegerSubtractParametersTranslationReceipt::new(
            source.machine,
