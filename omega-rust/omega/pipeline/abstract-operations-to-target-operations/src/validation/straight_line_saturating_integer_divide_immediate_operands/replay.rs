//! Independent replay of proof-bearing saturating divide over constant operands.

use target_operations::{TargetFunction, TargetIntegerExpression, TargetOperation};

use super::grammar::ReconstructedSaturatingIntegerDivideImmediateOperands;
use super::{
    StraightLineSaturatingIntegerDivideImmediateOperandsTranslationError as Error,
    StraightLineSaturatingIntegerDivideImmediateOperandsTranslationReceipt as Receipt,
};

pub(super) fn validate(
    source: ReconstructedSaturatingIntegerDivideImmediateOperands,
