//! Exact source grammar for proof-bearing saturating divide of two integer constants.
...
use super::StraightLineSaturatingIntegerDivideImmediateOperandsTranslationError as Error;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) struct ReconstructedSaturatingIntegerDivideImmediateOperands {
...
pub(super) fn reconstruct(
    ...
    Ok(ReconstructedSaturatingIntegerDivideImmediateOperands {
