//! Typed receipt for exact constant integer wrapping integer multiplication materialization.

use semantic_vocabulary::{EdgeId, IntegerType, IntegerValue, MachineId, OperationId, ValueId};

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct StraightLineWrappingIntegerMultiplyImmediateTranslationReceipt {
    machine: MachineId,
    left_constant_operation: OperationId,
    right_constant_operation: OperationId,
    wrapping_multiply_operation: OperationId,
    return_edge: EdgeId,
    left_constant_result: ValueId,
    right_constant_result: ValueId,
    wrapping_multiply_result: ValueId,
...
impl StraightLineWrappingIntegerMultiplyImmediateTranslationReceipt {
    ...
    pub const fn wrapping_multiply_operation(self) -> OperationId {
        self.wrapping_multiply_operation
    }
    ...
    pub const fn wrapping_multiply_result(self) -> ValueId {
        self.wrapping_multiply_result
    }
