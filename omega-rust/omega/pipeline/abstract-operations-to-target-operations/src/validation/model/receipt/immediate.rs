...
mod wrapping_integer_remainder_operands;
...
pub use wrapping_integer_divide_operands::StraightLineWrappingIntegerDivideImmediateOperandsTranslationReceipt;
pub use wrapping_integer_multiply::StraightLineWrappingIntegerMultiplyImmediateTranslationReceipt;
pub use wrapping_integer_remainder_operands::StraightLineWrappingIntegerRemainderImmediateOperandsTranslationReceipt;
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct StraightLineIntegerEqualImmediateTranslationReceipt {
    machine: MachineId,
    left_constant_operation: OperationId,
    right_constant_operation: OperationId,
    equal_operation: OperationId,
...
impl StraightLineIntegerEqualImmediateTranslationReceipt {
    #[allow(clippy::too_many_arguments)]
    pub(in crate::validation) const fn new(
        machine: MachineId,
        left_constant_operation: OperationId,
