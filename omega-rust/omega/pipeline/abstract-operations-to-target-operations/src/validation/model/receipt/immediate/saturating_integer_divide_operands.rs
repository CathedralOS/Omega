//! Typed receipt for proof-bearing saturating divide over constant operands.
...
pub struct StraightLineSaturatingIntegerDivideImmediateOperandsTranslationReceipt {
    machine: MachineId,
...
impl StraightLineSaturatingIntegerDivideImmediateOperandsTranslationReceipt {
