...
pub struct StraightLineSaturatingIntegerMultiplyParametersTranslationReceipt {
    machine: MachineId,
    multiply_operation: OperationId,
    return_edge: EdgeId,
...
impl StraightLineSaturatingIntegerMultiplyParametersTranslationReceipt {
    ...
    pub const fn multiply_operation(self) -> OperationId {
