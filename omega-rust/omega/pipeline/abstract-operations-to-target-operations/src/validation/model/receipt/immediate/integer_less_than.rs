//! Typed receipt for exact constant integer ordering materialization.

use semantic_vocabulary::{EdgeId, IntegerType, IntegerValue, MachineId, OperationId, ValueId};

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct StraightLineIntegerLessThanImmediateTranslationReceipt {
    machine: MachineId,
...
impl StraightLineIntegerLessThanImmediateTranslationReceipt {
    ...
    pub const fn less_than_result(self) -> ValueId {
        self.less_than_result
    }
