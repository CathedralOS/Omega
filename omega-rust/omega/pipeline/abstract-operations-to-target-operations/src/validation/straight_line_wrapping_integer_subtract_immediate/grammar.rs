//! Exact source grammar for wrapping integer subtraction of two same-type integer constants.
...
use super::StraightLineWrappingIntegerSubtractImmediateTranslationError as Error;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) struct ReconstructedWrappingIntegerSubtractImmediate {
    pub(super) machine: MachineId,
    pub(super) left_constant_operation: OperationId,
    pub(super) right_constant_operation: OperationId,
    pub(super) wrapping_subtract_operation: OperationId,
    pub(super) return_edge: EdgeId,
    pub(super) left_constant_result: ValueId,
    pub(super) right_constant_result: ValueId,
    pub(super) wrapping_subtract_result: ValueId,
...
pub(super) fn reconstruct(
...
) -> Result<ReconstructedWrappingIntegerSubtractImmediate, Error> {
    ...
    if *left != *left_constant_result || *right != *right_constant_result {
        return Err(Error::SourceWrappingSubtractOperands);
    }
