//! Exact source grammar for bitwise-OR of two same-type integer constants.
...
pub(super) fn reconstruct(
...
) -> Result<ReconstructedIntegerBitwiseOrImmediate, Error> {
    ...
    if *left != *left_constant_result || *right != *right_constant_result {
        return Err(Error::SourceBitwiseOrOperands);
    }
