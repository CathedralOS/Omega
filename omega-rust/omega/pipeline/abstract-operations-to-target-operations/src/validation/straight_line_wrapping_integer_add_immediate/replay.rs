//! Independent replay of constant integer wrapping integer addition as an integer immediate.

use target_operations::{TargetFunction, TargetOperation};

use super::grammar::ReconstructedWrappingIntegerAddImmediate;
use super::{
    StraightLineWrappingIntegerAddImmediateTranslationError as Error,
    StraightLineWrappingIntegerAddImmediateTranslationReceipt as Receipt,
};

pub(super) fn validate(
    source: ReconstructedWrappingIntegerAddImmediate,
    ...
    if !matches!(
        ...
        TargetOperation::ReturnIntegerImmediate {
            ...
            && source_value == source.wrapping_add_result
