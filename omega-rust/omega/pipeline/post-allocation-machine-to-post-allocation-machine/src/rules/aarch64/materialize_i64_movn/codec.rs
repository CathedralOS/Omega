...
use crate::{
    ...
    Aarch64MovnMaterializationPolicy, Aarch64MovnMaterializationRevisionIdentity, Aarch64MovnPatch,
    Aarch64MovnRecipe, QualifiedPhysicalWrite, aarch64_movn_materialization_identity,
};
use physical_instructions::{Aarch64MovnMaterializationIdentity, PostAllocationMachineIdentity};
...
mod tests {
    ...
    use crate::{
        ...
        Aarch64MovnMaterializationFunction, Aarch64MovnMaterializationInstruction,
        ...
        QualifiedPhysicalWrite, aarch64_movn_materialization_identity,
    };
