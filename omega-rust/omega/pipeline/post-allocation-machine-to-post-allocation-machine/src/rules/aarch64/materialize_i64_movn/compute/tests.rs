use optimization_core::{OptimizationWorkBudget, PostAllocationOptimizationManifestIdentity};
use register_model::{
...
use crate::{
    ...
    Aarch64MovnMaterializationWorkAxis, Aarch64MovnPatch,
};
...
fn fixture() -> (
    ...
    let source = PostAllocationMachinePlan {
        ...
        ranges: selected_instructions_to_register_homes::LiveRangeIdentity::from_bytes([5; 32]),
