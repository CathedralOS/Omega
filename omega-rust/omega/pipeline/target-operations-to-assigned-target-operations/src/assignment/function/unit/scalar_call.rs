...
pub(super) fn assign(
    ...
    result: target_operations::TargetUnitScalarHomeRequirement,
    ...
    match source {
        ...
        TargetUnitScalarArgumentSource::IntegerImmediate {
            ...
            let matches = preceding_operations
                ...
                .count();
            (matches == 1 && semantic_vocabulary::ScalarTerm::integer(scalar_type, value).is_ok())
                .then_some(AssignedUnitScalarArgumentSource::IntegerImmediate {
                    defining_operation,
                    source_value,
                    scalar_type,
                    value,
