...
use terminal_psi::{ClaimTransfer, CrashRouteBucket, StructuralPathSegment};
...
pub(super) fn assign(
    ...
    result: Option<target_operations::AbstractResult>,
    callee: MachineId,
    call_plan: &calling_conventions::CallPlan,
    result_home: Option<target_operations::TargetUnitScalarHomeRequirement>,
    structural_arguments: &[target_operations::TargetStructuralArgument],
