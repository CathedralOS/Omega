...
use semantic_vocabulary::{IeeeFloatFormat, ScalarType, StructuralFieldId, StructuralTypeId};
use terminal_psi::{
...
fn physically_retained_field(field: &terminal_psi::StructuralFieldDeclaration) -> bool {
