...
use assigned_target_operations::AssignedUnitWriteOnlyPrimitiveStoreSource;
use calling_conventions::ValuePlacement;
use semantic_vocabulary::ScalarType;
use target_operations::{TargetUnitBody, TargetUnitWriteOnlyPrimitiveStoreSource};
...
pub(super) fn assign(
    ...
    if destination.is_self
        ...
        || destination_type.shape
            != terminal_psi::StructuralTypeShape::PrimitiveScalar(expected_scalar_type)
        || !body
            .structural_types
            .iter()
