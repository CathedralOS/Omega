...
fn validate_structural_register(
    ...
    let matches_architecture = matches!(
        ...
        (
            Architecture::X86_64,
            target_operations::MachineRegister::X86Rax
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86Rcx
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86Rdx
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86Rbx
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86Rsp
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86Rbp
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86Rsi
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86Rdi
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86R8
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86R9
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86R10
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86R11
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86R12
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86R13
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86R14
        ) | (
            Architecture::X86_64,
            target_operations::MachineRegister::X86R15
        ) | (
            Architecture::Aarch64,
            target_operations::MachineRegister::Aarch64X(0..=30)
        )
    );
