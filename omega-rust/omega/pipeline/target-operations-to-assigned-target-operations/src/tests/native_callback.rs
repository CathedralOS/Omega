...
fn admitted_foreign_stack() -> task_plans::AdmittedSameStackContribution {
    let commitment = task_plans::SameStackProviderPlanCommitment::from_digest([0x73; 32]);
...
fn direct_callback_assignment_preserves_native_slot_without_inventing_a_scalar() {
    ...
    assert_eq!(
        ...
        AssignedCallDestination::Register(target_operations::MachineRegister::X86Rsi)
    );
