use selected_instructions::{SelectedBlockId, SelectedStructuralUnitFunction};
use semantic_vocabulary::{BlockId, EdgeId, MachineId, OperationId, ServiceId, StructuralTypeId};
...
pub(super) struct DecodedSignature {
    ...
    pub(super) structural_types: Vec<terminal_psi::StructuralTypeDeclaration>,
    pub(super) abi: selected_instructions::SelectedStructuralUnitAbi,
    pub(super) structural_places: Vec<terminal_psi::StructuralPlaceDeclaration>,
    pub(super) entry_claims: Vec<terminal_psi::EntryClaim>,
