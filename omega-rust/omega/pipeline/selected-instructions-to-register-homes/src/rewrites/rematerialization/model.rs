...
pub struct StagedOptimizedActiveResidentRematerializationCustodyReceipt {
    ...
    pub(super) choice_usage: optimization_core::OptimizationWorkUsage,
    ...
    pub(super) classification_usage: optimization_core::OptimizationWorkUsage,
    ...
    pub(super) rematerialization_usage: optimization_core::OptimizationWorkUsage,
    pub(super) budget: OptimizationWorkBudget,
    pub(super) transformed_selected: selected_instructions::SelectedInstructionPlanIdentity,
    ...
    pub(super) manifest: optimization_core::PostAllocationOptimizationManifestIdentity,
...
pub struct StagedOptimizedActiveResidentRematerializationPressure {
    ...
    pub(super) ranges: ValidatedLiveRanges,
    pub(super) legality: ValidatedAllocationLegality,
    pub(super) custody: StagedOptimizedActiveResidentRematerializationPressureCustodyReceipt,
}
