...
pub use register_homes::FixedPrecoloredSplitRequirementPlanIdentity;

pub use register_homes::FixedPrecoloredSplitRequirementPolicy;
...
pub use register_homes::FixedPrecoloredSplitRequirementValidationReceipt;
