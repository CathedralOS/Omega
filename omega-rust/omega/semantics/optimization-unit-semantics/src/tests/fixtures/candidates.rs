...
use crate::candidates::copy_propagation::normalize_redundant_parameter_observation_input;
...
use optimization_unit::{
    ...
    RedundantBlockParameterRewrite, ScalarConstantValue, literal_scalar_constant_fact_identity,
...
pub(crate) fn redundant_parameter_region_fixture() -> (
    ...
    use abstract_operations::{AbstractSuccessor, ValueBinding};
            ...
            functions: vec![AbstractFunction {
                ...
                operations: vec![
                    ...
                    AbstractOperation::ExactIntegerAdd {
                        ...
                        obligation: id(713, semantic_vocabulary::ObligationId::new),
                        result,
                        scalar_type: integer,
                        left: parameter,
                        right: alternate,
...
pub(crate) fn integer_candidate_with_facts(
    unit: &PsiOptimizationUnit,
    constant: IntegerValue,
    supplied_left_fact: Option<optimization_core::ScalarConstantFactIdentity>,
    supplied_obligation_fact: Option<optimization_core::AcceptedObligationFactIdentity>,
) -> PsiRewriteCandidate {
