...
use semantic_vocabulary::{
    ...
    IntegerValue, MachineId, OperationId, PlaceId, ScalarType, StructuralTypeId, ValueId,
};
...
pub(super) fn write_only_store_plan(store_before_value: bool) -> AbstractOperationPlan {
    ...
    let destination = terminal_psi::StructuralParameterDeclaration {
        ...
        access: terminal_psi::StructuralAccess::WriteOnlyBorrow,
...
pub(crate) fn exact_add_unit() -> PsiOptimizationUnit {
        ...
        functions: vec![AbstractFunction {
            ...
            operations: vec![
                ...
                AbstractOperation::ExactIntegerAdd {
                    ...
                    obligation: id(209, semantic_vocabulary::ObligationId::new),
                    result,
                    scalar_type: integer,
                    left,
                    right,
    ...
    let unit = reconstruct_psi_optimization_unit_seed(&plan, FuelScheduleIdentity::new(1).unwrap())
        .unwrap();
    optimization_unit::attach_accepted_obligation_facts(
        unit.clone(),
        vec![optimization_unit::AcceptedObligationFact::new(
            unit.psi,
            [23; 32],
            machine,
            id(208, OperationId::new),
            id(209, semantic_vocabulary::ObligationId::new),
        ...
        functions: vec![AbstractFunction {
            ...
            operations: vec![
                ...
                AbstractOperation::BoundaryCall {
                    ...
                    result: abstract_operations::AbstractBoundaryResult::Scalar(AbstractResult {
                        value: result,
                        scalar_type,
                    }),
                    boundary,
...
pub(crate) fn structural_call_unit() -> PsiOptimizationUnit {
    ...
    let structural_type = id(337, semantic_vocabulary::StructuralTypeId::new);
    let parameter = |place, position| terminal_psi::StructuralParameterDeclaration {
        place,
        position,
        is_self: false,
        structural_type,
...
pub(crate) fn projected_shared_structural_scalar_call_unit() -> PsiOptimizationUnit {
    ...
    let field = id(359, semantic_vocabulary::StructuralFieldId::new);
            ...
            terminal_psi::StructuralTypeDeclaration {
                ...
                shape: terminal_psi::StructuralTypeShape::Record {
                    fields: vec![terminal_psi::StructuralFieldDeclaration {
                        ...
                        field_type: terminal_psi::StructuralFieldType::Structural(carrier),
                    }],
                },
            },
            terminal_psi::StructuralTypeDeclaration {
