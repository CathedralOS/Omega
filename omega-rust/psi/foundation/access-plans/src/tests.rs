use super::{
    ...
    AdmittedResourceProfile, AtomicAccessOperation, AtomicCapability, AtomicOrderingPlan,
    ...
    DeviceRevisionPredicateId, DormantOwnedAtomicResident, EffectFootprint, EffectiveFieldSupply,
    EffectiveSupplyKind, EstablishedOwnedPlacement, Extent, ExtentLoan, ExternalCapability,
    ExternalPrimitiveOperation, ExternalRead, ExternalReadBehavior, FieldAccess,
    FieldAccessDescriptor, LoanPolarity, LogicalFieldExtent, LogicalFieldFragment, MemoryOrdering,
    ObservationModel, OwnedPlacementAdmission, PlacedOccurrenceId, PlacementAdmission,
    PlacementAdmissionId, PlacementAuthorityRef, PlacementPlan, PlacementPlanId,
    PlacementRejection, PrimitiveAccessRequest, ProviderAssertedDeviceOperationClaim,
    ProviderExistingContentGrant, RelativeEffectFootprint, ResidentClaimId, ResourceProfile,
    ResourceProfileGrant, ResourceProfileReceiptId, ResourceRegion, RuntimeDeviceRevisionEvidence,
    ...
    StablePrimitiveOperation, TransferRule, ValidatedAccessPlan, ValidatedPlacementPlan,
    admit_owned_placement, admit_placement, adopt_owned_atomic, adopt_owned_stable,
    bind_schema_correspondence_to_placement, effect_footprints_conflict, place,
    structurally_close_device_operation_requirements, validate_access_plan,
    validate_entry_geometry, validate_placement_plan, validate_placement_resources,
...
fn provider_existing_content_must_name_the_actual_placement() {
    ...
    let (extent, content) = uart_root_grant(1, 100)
        .mint_provider_existing_content(
            0xa200,
            4,
            extents::ExtentContentInterpretation::from_sha256_commitment(
                extent_id(
