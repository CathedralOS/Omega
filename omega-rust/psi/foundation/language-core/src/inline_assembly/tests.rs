...
fn catalog_names_semantic_refusal_classes() {
    for mnemonic in [
        "ret", "retq", "call", "br", "blr",
        // Mode transitions and software interrupts.
        "iret", "iretd", "int", "int1", "int3", "into", "syscall", "sysenter", "sysexit",
        "lmsw", // Counted/conditional branch spellings.
        "loop", "loope", "loopne", "loopnz", "loopz", "jcxz", "jecxz", "jrcxz", "ja", "jae", "jb",
        "jbe", "jc", "je", "jg", "jge", "jl", "jle", "jna", "jnae", "jnb", "jnbe", "jnc", "jne",
        "jng", "jnge", "jnl", "jnle", "jno", "jnp", "jns", "jnz", "jo", "jp", "jpe", "jpo", "js",
        "jz", // AArch64 branch and exception-generating spellings.
        "b", "bl", "cbz", "cbnz", "tbz", "tbnz", "svc", "hvc", "smc", "brk", "drps",
    ] {
        assert_eq!(
    ...
    for mnemonic in [
        ...
        "push",
        "pop",
        // Atomic and read-modify-write families.
        "xchg",
        "xadd",
        "cmpxchg",
        "cmpxchg8b",
        "cmpxchg16b",
        "lock",
        // String, stack-frame and far/descriptor-table operations.
        "movsb",
        "movsw",
        "movsd",
        "movsq",
        ...
        "lar",
        "lsl",
        // Cache, TLB and address-monitoring maintenance.
        "invlpg",
        "invlpga",
        "invpcid",
        "invd",
        ...
        "umwait",
        "tpause",
        // AArch64 plain, exclusive, acquire-release and LSE atomic families.
        "ldrb",
        "ldrh",
        "ldrsb",
        "ldrsh",
