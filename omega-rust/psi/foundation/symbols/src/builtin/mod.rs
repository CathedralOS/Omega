...
pub enum BuiltinFunction {
    ...
    /// (`serialize`/`isb`, `pause`/`yield`). Zero-operand asm intrinsics with
    /// no service-reach effect and no modeled machine-state write; legal
...
impl BuiltinFunction {
    ...
    pub fn name(self) -> &'static str {
        match self {
            ...
            Self::AsmSerialize => "asm#serialize",
    ...
    pub fn ordinal(self) -> usize {
        match self {
            ...
            Self::AsmSerialize => 72,
            Self::AsmInstructionSyncBarrier => 73,
            Self::AsmSpinPause => 74,
            Self::AsmYieldHint => 75,
            Self::AsmReadSctlrEl1 => 76,
            Self::AsmReadTcrEl1 => 77,
            Self::AsmReadTtbr0El1 => 78,
            Self::AsmReadTtbr1El1 => 79,
            Self::AsmReadMairEl1 => 80,
            Self::AsmReadVbarEl1 => 81,
            Self::AsmReadTpidrEl1 => 82,
            Self::AsmReadEsrEl1 => 83,
            Self::AsmReadFarEl1 => 84,
            Self::AsmWriteSctlrEl1 => 85,
            Self::AsmWriteTcrEl1 => 86,
            Self::AsmWriteTtbr0El1 => 87,
            Self::AsmWriteTtbr1El1 => 88,
            Self::AsmWriteMairEl1 => 89,
            Self::AsmWriteVbarEl1 => 90,
            Self::AsmWriteTpidrEl1 => 91,
        }
    }
...
pub fn builtin_function_symbols() -> [(SymbolKind, SymbolNameRef<'static>); BuiltinFunction::COUNT]
{
    [
        ...
        (
            SymbolKind::BuiltinFunction,
            SymbolNameRef::Static(BuiltinFunction::AsmSerialize.name()),
        ),
        (
            SymbolKind::BuiltinFunction,
            SymbolNameRef::Static(BuiltinFunction::AsmInstructionSyncBarrier.name()),
        ),
        (
            SymbolKind::BuiltinFunction,
            SymbolNameRef::Static(BuiltinFunction::AsmSpinPause.name()),
        ),
        (
            SymbolKind::BuiltinFunction,
