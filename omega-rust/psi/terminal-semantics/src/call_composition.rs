...
mod fixed_byte_view;
pub use fixed_byte_view::{
    FixedByteArrayWindow, fixed_byte_array_extent, fixed_byte_array_window,
    fixed_element_array_extent,
};
...
impl CallCompositionSemanticRow {
    pub const ALL: [Self; 10] = [
        ...
        Self {
            tag: OperationSemanticTag::CallDynamicParameterScalar,
            schema: CallCompositionSchema {
                target: CallTargetRule::DynamicDescriptorTable,
                result: CallResultRule::ScalarCalleeResult,
                arguments: CallArgumentRule::DynamicDescriptorSource,
        ...
        Self {
            tag: OperationSemanticTag::CallDynamicUnit,
            schema: CallCompositionSchema {
                target: CallTargetRule::DynamicDescriptorTable,
                result: CallResultRule::UnitCalleeResult,
                arguments: CallArgumentRule::DynamicDescriptorSource,
        ...
        Self {
            tag: OperationSemanticTag::CallDynamicParameterUnit,
            schema: CallCompositionSchema {
                target: CallTargetRule::DynamicDescriptorTable,
                result: CallResultRule::UnitCalleeResult,
                arguments: CallArgumentRule::DynamicDescriptorSource,
...
const fn is_call_composition_tag(tag: OperationSemanticTag) -> bool {
    matches!(
        ...
        OperationSemanticTag::Call
            ...
            | OperationSemanticTag::CallDynamicUnit
            | OperationSemanticTag::CallDynamicParameterUnit
...
mod tests {
    ...
    fn inventory_is_exact_unique_and_exposes_every_independent_axis() {
        assert_eq!(CallCompositionSemanticRow::ALL.len(), 10);
        assert_eq!(
            CallCompositionSemanticRow::ALL
                .iter()
                .map(|row| row.tag())
    ...
    fn lookup_rejects_missing_duplicate_cross_kind_and_axis_drift() {
        ...
        weakened[9].schema.frontier = CallFrontierRule::KeepsScalarFrontier;
        assert_eq!(
