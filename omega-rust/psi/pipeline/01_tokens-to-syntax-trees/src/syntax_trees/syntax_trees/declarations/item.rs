...
pub struct ConstDefinition {
    ...
    pub name: Identifier,
    pub is_public: bool,
    pub type_reference: crate::syntax_trees::types::TypeReferenceHandle,
    pub value: crate::syntax_trees::expression::ExpressionHandle,
...
pub struct ConstInitializerNormalization {
    pub authored_expression: crate::syntax_trees::expression::ExpressionHandle,
    pub canonical_result_encoding: String,
    pub selections: Vec<crate::syntax_trees::types::ConstArgumentOrigin>,
...
pub enum PropositionBody {
    ...
    Witness {
        evidence: crate::syntax_trees::types::TypeReferenceHandle,
    },
    /// Source/debug alias expanded before normalized semantic identity.
    Transparent {
        proposition: crate::syntax_trees::expression::ExpressionHandle,
    },
}
...
pub enum MathematicalDefinitionBody {
    ...
    Definition(crate::syntax_trees::expression::ExpressionHandle),
...
impl Default for MathematicalDefinitionBody {
    fn default() -> Self {
        ...
        Self::Definition(crate::syntax_trees::expression::ExpressionHandle::invalid())
    }
}
...
/// [`crate::syntax_trees::types::TypeReferenceNode`] so that admitting `->` into the shared
...
pub enum MathematicalTypeNode {
    ...
    /// `core::Squash<A>`.
    Ordinary(crate::syntax_trees::types::TypeReferenceHandle),
    ...
    Application {
        ...
        arguments: HandleSpan<crate::syntax_trees::expression::ExpressionHandle>,
    },
}

impl Default for MathematicalTypeNode {
    fn default() -> Self {
        Self::Ordinary(crate::syntax_trees::types::TypeReferenceHandle::invalid())
    }
}
...
pub struct MeasureDefinition {
    ...
    pub return_type: crate::syntax_trees::types::TypeReferenceHandle,
    ...
    pub body: HandleSpan<crate::syntax_trees::expression::ExpressionHandle>,
...
pub struct DataDefinition {
    pub name: Identifier,
    pub is_public: bool,
    pub supply_mode: language_core::DataSupplyMode,
    /// Erased borrow-region parameters declared in the shared `<>` list.
    pub lifetime_parameters: Vec<Identifier>,
    pub type_parameters: HandleSpan<TypeParameter>,
    ...
    pub generic_instance: Option<crate::syntax_trees::types::TypeReferenceHandle>,
...
pub struct QuotientDefinition {
    pub carrier: crate::syntax_trees::types::TypeReferenceHandle,
...
pub struct QuotientEquivalenceSelection {
    ...
    pub trait_arguments: HandleSpan<crate::syntax_trees::types::TypeReferenceHandle>,
...
pub struct DataProperties {
    ...
    pub multiplicity: language_core::Multiplicity,
    ...
    pub carry: Option<language_core::CarryPolicy>,
}
...
pub enum TypeParameterKind {
    ...
    Type,
    Const {
        type_reference: crate::syntax_trees::types::TypeReferenceHandle,
    },
...
pub struct DomainDefinition {
    ...
    pub type_parameters: HandleSpan<TypeParameter>,
    pub target_type: crate::syntax_trees::types::TypeReferenceHandle,
    /// Const binders selected into family identity (`Quantity<U>`).
    pub index_arguments: HandleSpan<crate::syntax_trees::types::TypeReferenceHandle>,
    ...
    pub classification: Option<language_core::DomainClassification>,
    pub predicate_body: language_core::DomainPredicateBody,
    pub facts: HandleSpan<ProofFact>,
...
impl Default for DomainDefinition {
    fn default() -> Self {
        Self {
            ...
            target_type: crate::syntax_trees::types::TypeReferenceHandle::invalid(),
            index_arguments: HandleSpan::empty(),
            is_public: false,
            alias: None,
            authored_routes: Vec::new(),
            classification: None,
            predicate_body: language_core::DomainPredicateBody::Bodyless,
            facts: HandleSpan::empty(),
...
impl Default for ProofFact {
    fn default() -> Self {
        Self::Expression(crate::syntax_trees::expression::ExpressionHandle::invalid())
    }
}
...
pub struct ProofMembershipFact {
    ...
    pub domain_arguments: HandleSpan<crate::syntax_trees::types::TypeReferenceHandle>,
}

impl Default for ProofMembershipFact {
    fn default() -> Self {
        Self {
            value: crate::syntax_trees::expression::ExpressionHandle::invalid(),
...
pub struct SatisfiesClause {
    ...
    pub arguments: HandleSpan<crate::syntax_trees::types::TypeReferenceHandle>,
    ...
    pub via_expression: crate::syntax_trees::expression::ExpressionHandle,
    ...
    pub via_keyword_source_span: Option<source::SourceSpan>,
}
...
pub struct GenericConformanceBound {
    ...
    pub selected_conformance: Option<crate::syntax_trees::expression::StaticMachineArgument>,
}
...
pub struct Machine {
    ...
    /// Structural static equations retained until every application is discharged.
    pub where_facts: HandleSpan<ProofFact>,
    ...
    pub ranking_subjects: HandleSpan<crate::syntax_trees::expression::ExpressionHandle>,
    ...
    pub ranking_view_arguments: HandleSpan<crate::syntax_trees::expression::ExpressionHandle>,
    ...
    pub ranking_range: crate::syntax_trees::expression::ExpressionHandle,
...
pub struct State {
    ...
    pub contracts: HandleSpan<CapabilityContract>,
    pub statements: HandleSpan<crate::syntax_trees::statement::StatementHandle>,
}
...
pub struct TraitDefinition {
    ...
    pub parents: HandleSpan<crate::syntax_trees::types::TypeReferenceHandle>,
    ...
    pub refines: Option<crate::syntax_trees::types::TypeReferenceHandle>,
...
pub struct StateSignature {
    ...
    pub spelling: Option<crate::syntax_trees::operator_spelling::OperatorSpelling>,
    ...
    pub default_body: HandleSpan<crate::syntax_trees::statement::StatementHandle>,
...
struct StateStorage {
    ...
    statement_handles: Arena<crate::syntax_trees::statement::StatementHandle>,
...
impl ItemTable {
    ...
    pub fn proof_fact_source_span(&self, handle: Handle<ProofFact>) -> Option<source::SourceSpan> {
        self.declaration_storage
    ...
    pub fn statements(
        &self,
        span: HandleSpan<crate::syntax_trees::statement::StatementHandle>,
    ...
    pub fn append_statement_handle(
        &mut self,
        handle: crate::syntax_trees::statement::StatementHandle,
    ) -> Handle<crate::syntax_trees::statement::StatementHandle> {
