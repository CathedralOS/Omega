...
impl SyntaxTrees {
    pub fn copy_static_machine_argument(
        &mut self,
        other: &SyntaxTrees,
        argument: &crate::syntax_trees::expression::StaticMachineArgument,
    ) -> crate::syntax_trees::expression::StaticMachineArgument {
    ...
    pub(crate) fn copy_state_signature_node(
        &mut self,
        other: &SyntaxTrees,
        signature: &crate::syntax_trees::item::StateSignatureNode,
    ) -> StateSignature {
        StateSignature {
            name: signature.name.clone(),
            spelling: signature.spelling,
    ...
    fn copy_statement_node(
        ...
        match statement {
            StatementNode::RootBinding(binding) => {
                StatementNode::RootBinding(crate::syntax_trees::statement::RootBinding {
            ...
            StatementNode::ProofOutputBindingStatement(binding) => {
                StatementNode::ProofOutputBindingStatement(
                    crate::syntax_trees::statement::TableProofOutputBindingStatement {
        ...
        self.copy_mapped_span(
            ...
            |this, constraint| match constraint {
                ...
                TypeConstraintNode::Domain(domain) => {
                    TypeConstraintNode::Domain(crate::syntax_trees::types::DomainConstraint {
    ...
    pub(crate) fn copy_expression_handle(
        ...
        let expression = match other.expressions.expression(handle) {
            ExpressionNode::Match(dispatch) => {
                ...
                for arm in other.expressions.match_arms(dispatch.arms) {
                    let pattern = match arm.pattern {
                        crate::syntax_trees::expression::MatchPattern::Value(value) => {
                            crate::syntax_trees::expression::MatchPattern::Value(
            ...
            ExpressionNode::Atomic(atomic) => {
                ExpressionNode::Atomic(crate::syntax_trees::expression::TableAtomicExpression {
            ...
            ExpressionNode::Membership(membership) => ExpressionNode::Membership(
                crate::syntax_trees::expression::TableMembershipExpression {
            ...
            ExpressionNode::Range(range) => {
                ExpressionNode::Range(crate::syntax_trees::expression::TableRangeExpression {
            ...
            ExpressionNode::Unary(unary) => {
                ...
                ExpressionNode::Unary(crate::syntax_trees::expression::TableUnaryExpression {
