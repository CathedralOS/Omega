...
use crate::syntax_trees::item::{StateParameterNode, StateSignature};
...
pub(crate) fn snapshot_state_node(
    ...
    state: &crate::syntax_trees::item::StateNode,
) -> StateSnapshot {
    StateSnapshot {
    ...
    match statement {
        ...
        StatementNode::Transition(value) => StatementSnapshot::Transition {
            ...
            crash_cause: match value.exit {
                crate::syntax_trees::statement::TransitionExit::Ordinary => None,
                crate::syntax_trees::statement::TransitionExit::Crash(
                    crate::syntax_trees::item::CrashCause::Trap,
                ) => Some("Trap"),
                crate::syntax_trees::statement::TransitionExit::Crash(
