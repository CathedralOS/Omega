    ...
    pub fn retain_const_argument_normalization(
        ...
        self.const_argument_normalizations
            .insert(RetainedConstArgumentNormalization {
                argument,
                normalization: ConstArgumentNormalization {
                    authored_expression: crate::syntax_trees::expression::ExpressionHandle::invalid(
                    ),
                    reference,
...
pub enum TypeReferenceNode {
    ...
    ConstExpression(crate::syntax_trees::expression::ExpressionHandle),
    DynamicTrait {
...
pub enum TypeConstraintNode {
    Named(Identifier),
    Range {
        minimum: crate::syntax_trees::expression::ExpressionHandle,
        maximum: crate::syntax_trees::expression::ExpressionHandle,
