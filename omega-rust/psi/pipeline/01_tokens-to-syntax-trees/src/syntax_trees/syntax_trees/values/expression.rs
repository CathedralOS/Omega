...
pub enum ExpressionNode {
    ...
    TypeExpression(crate::syntax_trees::types::TypeReferenceHandle),
    /// Proof-only observation of a type's normalized all-zero home value.
    ZeroValue(crate::syntax_trees::types::TypeReferenceHandle),
}
...
pub struct TableCastExpression {
    ...
    pub semantic_domain_arguments: HandleSpan<crate::syntax_trees::types::TypeReferenceHandle>,
