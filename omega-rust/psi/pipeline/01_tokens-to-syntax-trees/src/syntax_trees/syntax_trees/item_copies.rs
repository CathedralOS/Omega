...
impl SyntaxTrees {
    ...
    ) -> crate::syntax_trees::item::StateSignatureNode {
        ...
        match item {
            ...
            Item::Conformance(conformance) => {
                let body = match &conformance.body {
                    crate::syntax_trees::item::ConformanceBody::AttachedRequirementMachines => {
                        crate::syntax_trees::item::ConformanceBody::AttachedRequirementMachines
                    }
                    crate::syntax_trees::item::ConformanceBody::Closed { members } => {
                        let copied = other
                            .items
                            ...
                            .map(|member| match member {
                                crate::syntax_trees::item::ConformanceMember::Machine(machine) => {
                                    crate::syntax_trees::item::ConformanceMember::Machine(
                                        self.copy_machine(other, machine),
                                    )
                                }
                                crate::syntax_trees::item::ConformanceMember::TraitDefault {
                                    declaring_trait,
                                    requirement_ordinal,
                                    machine,
                                } => crate::syntax_trees::item::ConformanceMember::TraitDefault {
                                ...
                                crate::syntax_trees::item::ConformanceMember::Reference {
                                    declaring_trait,
                                    requirement,
                                    target,
                                } => crate::syntax_trees::item::ConformanceMember::Reference {
            ...
            Item::Const(constant) => Item::Const(crate::syntax_trees::item::ConstDefinition {
                ...
                normalization: constant.normalization.as_ref().map(|normalization| {
                    crate::syntax_trees::item::ConstInitializerNormalization {
            ...
            Item::Domain(domain) => Item::Domain(DomainDefinition {
                ...
                alias: domain.alias.as_ref().map(|alias| {
                    crate::syntax_trees::item::DomainAliasDefinition {
                        constituents: alias
                            .constituents
                            .iter()
            ...
            Item::Module(module) => Item::Module(crate::syntax_trees::item::ModuleDeclaration {
            ...
            Item::Package(package) => {
                Item::Package(crate::syntax_trees::item::PackageDeclaration {
                    path: self.copy_item_identifier_span(other, package.path),
                })
            }
            Item::Proposition(proposition) => {
                Item::Proposition(crate::syntax_trees::item::PropositionDefinition {
                    ...
                    body: match proposition.body {
                        ...
                        crate::syntax_trees::item::PropositionBody::Witness { evidence } => {
                        ...
                        crate::syntax_trees::item::PropositionBody::Transparent { proposition } => {
                            crate::syntax_trees::item::PropositionBody::Transparent {
    ...
    fn copy_data_definition(
        ...
        DataDefinition {
            ...
            quotient: data.quotient.as_ref().map(|quotient| {
                crate::syntax_trees::item::QuotientDefinition {
                    ...
                    equivalence: quotient.equivalence.as_ref().map(|selection| {
                        crate::syntax_trees::item::QuotientEquivalenceSelection {
    ...
    fn copy_machine(&mut self, other: &SyntaxTrees, machine: &Machine) -> Machine {
        Machine {
            ...
            satisfies: self.copy_mapped_span(
                ...
                |this, clause| crate::syntax_trees::item::SatisfiesClause {
                    ...
                    via_expression: if clause.via_expression.is_valid() {
                        ...
                        crate::syntax_trees::expression::ExpressionHandle::invalid()
                    },
            ...
            conformance_bounds: machine
                .conformance_bounds
                .iter()
                .map(|bound| crate::syntax_trees::item::GenericConformanceBound {
    ...
    fn copy_trait_definition(
        ...
        TraitDefinition {
            ...
            refinement_clauses: trait_definition
                .refinement_clauses
                .iter()
                .map(|clause| crate::syntax_trees::item::TraitRefinementClause {
        ...
        self.copy_mapped_span(
            ...
            |this, parameter| {
                let kind = match &parameter.kind {
                    crate::syntax_trees::item::TypeParameterKind::Type => crate::syntax_trees::item::TypeParameterKind::Type,
                    crate::syntax_trees::item::TypeParameterKind::Const { type_reference } => {
                        crate::syntax_trees::item::TypeParameterKind::Const {
                            type_reference: this.copy_type_reference_handle(other, *type_reference),
                        }
                    }
                    crate::syntax_trees::item::TypeParameterKind::Value { type_reference } => {
                        crate::syntax_trees::item::TypeParameterKind::Value {
                            type_reference: this.copy_type_reference_handle(other, *type_reference),
                        }
                    }
                    crate::syntax_trees::item::TypeParameterKind::Machine { contract } => {
                        crate::syntax_trees::item::TypeParameterKind::Machine {
                            contract: contract.as_ref().map(|contract| match contract {
                                ...
                                crate::syntax_trees::item::MachineParameterContract::Structural(signature) => {
                                    crate::syntax_trees::item::MachineParameterContract::Structural(
                                        this.copy_state_signature_value(other, signature),
                                    )
                                }
                                crate::syntax_trees::item::MachineParameterContract::Nominal { requirement } => {
                                    crate::syntax_trees::item::MachineParameterContract::Nominal {
                                        requirement: this
                    ...
                    crate::syntax_trees::item::TypeParameterKind::Proposition { contract } => {
                        crate::syntax_trees::item::TypeParameterKind::Proposition {
                            contract: contract.as_ref().map(|contract| {
                                crate::syntax_trees::item::PropositionParameterSignature {
