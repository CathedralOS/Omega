...
pub struct RootBinding {
    pub receiver: crate::syntax_trees::expression::ExpressionHandle,
    ...
    pub implementation_operand: crate::syntax_trees::expression::ExpressionHandle,
...
pub struct StatementTable {
    ...
    expression_handles: Arena<crate::syntax_trees::expression::ExpressionHandle>,
...
impl StatementTable {
    ...
    pub fn insert_expression_handles(
        &mut self,
        expressions: impl IntoIterator<Item = crate::syntax_trees::expression::ExpressionHandle>,
    ...
    pub fn expression_handles(
        &self,
        span: HandleSpan<crate::syntax_trees::expression::ExpressionHandle>,
...
pub struct TableProofOutputBindingStatement {
    ...
    pub call: crate::syntax_trees::expression::ExpressionHandle,
}
...
pub struct TableAssemblyFact {
    ...
    pub expression: crate::syntax_trees::expression::ExpressionHandle,
}
...
pub struct TableAssignment {
    pub target: crate::syntax_trees::expression::ExpressionHandle,
...
pub struct TableCall {
    ...
    pub machine_arguments: Box<[crate::syntax_trees::expression::StaticMachineArgument]>,
    pub arguments: HandleSpan<crate::syntax_trees::expression::ExpressionHandle>,
    /// Explicit erased evidence-term arguments after the `;` call lane.
    pub evidence_arguments: Box<[Identifier]>,
    pub operational_acknowledgement: language_core::CallOperationalAcknowledgement,
...
pub struct TableLocalData {
    ...
    pub initial_value: crate::syntax_trees::expression::ExpressionHandle,
...
impl Default for TableLocalData {
    fn default() -> Self {
        Self {
            ...
            initial_value: crate::syntax_trees::expression::ExpressionHandle::invalid(),
            is_mutable: false,
...
pub enum TransitionExit {
    #[default]
    Ordinary,
    Crash(crate::syntax_trees::item::CrashCause),
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum TransitionGuardNode {
    Always,
    When(crate::syntax_trees::expression::ExpressionHandle),
}
...
pub enum TransitionTargetNode {
    ...
    Value(crate::syntax_trees::expression::ExpressionHandle),
    SelfTarget,
    #[default]
    Terminal,
}
...
mod tests {
    ...
    use crate::syntax_trees::expression::{ExpressionNode, ExpressionTable};
    use crate::syntax_trees::identifier::Identifier;
