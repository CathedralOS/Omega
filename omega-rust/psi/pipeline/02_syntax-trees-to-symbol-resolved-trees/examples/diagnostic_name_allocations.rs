//! Run with `mbx run -p syntax-trees-to-symbol-resolved-trees --example diagnostic_name_allocations`.
...
use syntax_trees_to_symbol_resolved_trees::symbol_resolved_trees::name::DiagnosticName;
