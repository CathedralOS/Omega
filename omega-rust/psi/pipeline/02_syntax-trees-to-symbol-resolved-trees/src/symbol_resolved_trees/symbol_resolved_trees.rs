...
pub struct SymbolResolvedRoots {
    pub const_declarations:
        OrderedRootArena<crate::symbol_resolved_trees::constant::ConstDeclaration>,
    pub data_definitions: OrderedRootArena<crate::symbol_resolved_trees::data::DataDefinition>,
    pub domain_definitions:
        OrderedRootArena<crate::symbol_resolved_trees::domain::DomainDefinition>,
    pub machines: OrderedRootArena<crate::symbol_resolved_trees::machine::Machine>,
    ...
    pub traits: OrderedRootArena<crate::symbol_resolved_trees::trait_definition::TraitDefinition>,
    pub conformances: OrderedRootArena<crate::symbol_resolved_trees::trait_definition::Conformance>,
    pub wire_schemas: OrderedRootArena<wire::WireSchema>,
}

impl SymbolResolvedRoots {
    pub fn with_roots(
        data_definitions: OrderedRootArena<crate::symbol_resolved_trees::data::DataDefinition>,
        domain_definitions: OrderedRootArena<
            crate::symbol_resolved_trees::domain::DomainDefinition,
        >,
        machines: OrderedRootArena<crate::symbol_resolved_trees::machine::Machine>,
        operators: OrderedRootArena<operator::OperatorDefinition>,
        traits: OrderedRootArena<crate::symbol_resolved_trees::trait_definition::TraitDefinition>,
    ) -> Self {
        Self {
...
pub struct SymbolResolvedDeclarationStorage {
    ...
    pub domain_path_members: Arena<crate::symbol_resolved_trees::name::DiagnosticName>,
    pub operator_path_members: Arena<crate::symbol_resolved_trees::name::DiagnosticName>,
    ...
    pub machine_owned_data: Arena<crate::symbol_resolved_trees::machine::OwnedData>,
    pub machine_trait_conformances: Arena<crate::symbol_resolved_trees::machine::TraitConformance>,
    pub machine_state_handles: Arena<Handle<state::State>>,
    pub machine_states: Arena<state::State>,
    pub trait_requirements: Arena<crate::symbol_resolved_trees::trait_definition::TraitRequirement>,
    pub trait_machine_signatures: Arena<signature::StateSignature>,
    pub ranking_views: Arena<crate::symbol_resolved_trees::name::DiagnosticName>,
    pub signature_invokes: Arena<crate::symbol_resolved_trees::name::DiagnosticName>,
    pub signature_contracts: Arena<signature::SignatureContract>,
    pub state_parameters: Arena<signature::StateParameter>,
    pub statement_path_members: Arena<crate::symbol_resolved_trees::name::DiagnosticName>,
...
impl SymbolResolvedTrees {
    ...
    pub fn domain_path_members(
        &self,
        span: HandleSpan<crate::symbol_resolved_trees::name::DiagnosticName>,
    ) -> &[crate::symbol_resolved_trees::name::DiagnosticName] {
        self.tables
            .declarations
            .domain_path_members
            .span_or_empty(span)
    ...
    pub fn trait_requirements(
        &self,
        span: HandleSpan<crate::symbol_resolved_trees::trait_definition::TraitRequirement>,
    ) -> &[crate::symbol_resolved_trees::trait_definition::TraitRequirement] {
        self.tables
            .declarations
            .trait_requirements
            .span_or_empty(span)
    ...
    pub fn machine_owned_data(
        &self,
        span: HandleSpan<crate::symbol_resolved_trees::machine::OwnedData>,
    ) -> &[crate::symbol_resolved_trees::machine::OwnedData] {
        self.tables
            .declarations
            .machine_owned_data
            .span_or_empty(span)
    ...
    pub fn machine_trait_conformances(
        &self,
        span: HandleSpan<crate::symbol_resolved_trees::machine::TraitConformance>,
    ) -> &[crate::symbol_resolved_trees::machine::TraitConformance] {
        self.tables
            .declarations
...
mod tests {
    ...
    fn record_selection(
        ...
        start: usize,
        symbol: u32,
    ) -> crate::symbol_resolved_trees::AuthoredDeclarationSelectionOccurrenceId {
        trees
            .record_resolved_authored_declaration_selection(
    ...
    fn tree_call(
        occurrence: crate::symbol_resolved_trees::AuthoredDeclarationSelectionOccurrenceId,
    ) -> statement::Statement {
    ...
    fn extension_rebase_shifts_every_extension_owned_occurrence_store() {
        ...
        let mut destination =
            crate::symbol_resolved_trees::AuthoredDeclarationSelections::default();
        destination
            .record_resolved(
