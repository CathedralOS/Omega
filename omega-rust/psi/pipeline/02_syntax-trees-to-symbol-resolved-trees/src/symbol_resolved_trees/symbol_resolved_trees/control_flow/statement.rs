...
pub struct RootBinding {
    pub receiver: crate::symbol_resolved_trees::expression::ExpressionHandle,
    ...
    pub implementation_operand: crate::symbol_resolved_trees::expression::ExpressionHandle,
...
pub struct ProofOutputBindingStatement {
    ...
    pub call: crate::symbol_resolved_trees::expression::ExpressionHandle,
}
...
pub struct AssemblyFact {
    ...
    pub expression: crate::symbol_resolved_trees::expression::ExpressionHandle,
}
...
pub struct Assignment {
    pub target: crate::symbol_resolved_trees::expression::ExpressionHandle,
...
pub struct LocalDataStorage {
    pub type_reference: crate::symbol_resolved_trees::types::TypeReference,
    pub initial_value: crate::symbol_resolved_trees::expression::ExpressionHandle,
...
impl Default for LocalDataStorage {
    fn default() -> Self {
        Self {
            type_reference: crate::symbol_resolved_trees::types::TypeReference::Unit,
            initial_value: crate::symbol_resolved_trees::expression::ExpressionHandle::invalid(),
            is_mutable: false,
...
pub struct CallStorage {
    ...
    pub machine_arguments: Box<[crate::symbol_resolved_trees::expression::StaticMachineArgument]>,
    pub arguments: HandleSpan<crate::symbol_resolved_trees::expression::ExpressionHandle>,
...
pub enum TransitionExit {
    #[default]
    Ordinary,
    Crash(crate::symbol_resolved_trees::signature::CrashCause),
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub enum TransitionGuard {
    Always,
    When(crate::symbol_resolved_trees::expression::ExpressionHandle),
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub enum TransitionTarget {
    Named(NamedTransitionTarget),
    Value(crate::symbol_resolved_trees::expression::ExpressionHandle),
    SelfTarget,
    Terminal,
}
...
struct StatementPathStorage {
    expression_handles: Arena<crate::symbol_resolved_trees::expression::ExpressionHandle>,
...
impl StatementTable {
    ...
    pub fn expression_handles(
        &self,
        span: HandleSpan<crate::symbol_resolved_trees::expression::ExpressionHandle>,
    ...
    pub fn reserve_expression_handles(
        &mut self,
        count: u32,
    ) -> HandleSpan<crate::symbol_resolved_trees::expression::ExpressionHandle> {
    ...
    pub fn insert_tree(
        &mut self,
        statement: &Statement,
        source_expressions: &crate::symbol_resolved_trees::expression::ExpressionTable,
        expressions: &mut crate::symbol_resolved_trees::expression::ExpressionTable,
        type_references: &mut crate::symbol_resolved_trees::types::TypeReferenceTable,
        source_child_type_references: &Arena<crate::symbol_resolved_trees::types::TypeReference>,
        source_constraints: &Arena<crate::symbol_resolved_trees::types::TypeConstraint>,
        source_expression_table: &crate::symbol_resolved_trees::expression::ExpressionTable,
    ...
    fn insert_expression_handle_span_from_trees(
        &mut self,
        source_expressions: &crate::symbol_resolved_trees::expression::ExpressionTable,
        arguments: HandleSpan<crate::symbol_resolved_trees::expression::ExpressionHandle>,
        expressions: &mut crate::symbol_resolved_trees::expression::ExpressionTable,
        copy_expression_handles: bool,
    ) -> HandleSpan<crate::symbol_resolved_trees::expression::ExpressionHandle> {
...
pub struct TableLocalData {
    pub symbol: SymbolHandle,
    pub name: DiagnosticName,
    pub type_reference: crate::symbol_resolved_trees::types::TypeReferenceHandle,
    pub initial_value: crate::symbol_resolved_trees::expression::ExpressionHandle,
    /// `let mut` -- see the syntax-tree twin.
    pub is_mutable: bool,
...
impl Default for TableLocalData {
    fn default() -> Self {
        Self {
            ...
            type_reference: crate::symbol_resolved_trees::types::TypeReferenceHandle::invalid(),
            initial_value: crate::symbol_resolved_trees::expression::ExpressionHandle::invalid(),
            is_mutable: false,
            type_is_inferred: false,
            relevance: language_core::BindingRelevance::Relevant,
...
mod tests {
    ...
    use crate::symbol_resolved_trees::expression::{ExpressionNode, ExpressionTable};
    use crate::symbol_resolved_trees::name::DiagnosticName;
    use crate::symbol_resolved_trees::types::TypeReferenceTable;
