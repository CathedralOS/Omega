...
pub struct DataDefinitionStorage {
    ...
    pub where_facts: HandleSpan<crate::symbol_resolved_trees::domain::ProofFact>,
...
pub enum MachineParameterContract {
    RequirementIdentity,
    Structural(crate::symbol_resolved_trees::signature::StateSignature),
...
impl Default for MachineParameterContract {
    fn default() -> Self {
        Self::Structural(crate::symbol_resolved_trees::signature::StateSignature::default())
    }
}

impl MachineParameterContract {
    pub fn structural(&self) -> Option<&crate::symbol_resolved_trees::signature::StateSignature> {
        match self {
    ...
    pub fn structural_mut(
        &mut self,
    ) -> Option<&mut crate::symbol_resolved_trees::signature::StateSignature> {
        match self {
            Self::Structural(signature) => Some(signature),
            Self::RequirementIdentity | Self::AuthoredNominal { .. } | Self::Nominal { .. } => None,
        }
...
pub enum MachineParameterContractView<'program> {
    Structural(&'program crate::symbol_resolved_trees::signature::StateSignature),
    Nominal {
        trait_definition: &'program crate::symbol_resolved_trees::trait_definition::TraitDefinition,
        requirement: &'program crate::symbol_resolved_trees::signature::StateSignature,
    },
}

impl<'program> MachineParameterContractView<'program> {
    pub fn signature(self) -> &'program crate::symbol_resolved_trees::signature::StateSignature {
        match self {
