...
pub struct DomainDefinition {
    ...
    pub operators: HandleSpan<crate::symbol_resolved_trees::operator::OperatorDefinition>,
...
impl Default for ProofFact {
    fn default() -> Self {
        Self::Expression(crate::symbol_resolved_trees::expression::ExpressionHandle::invalid())
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct ProofMembershipFact {
    pub value: crate::symbol_resolved_trees::expression::ExpressionHandle,
    pub domain: HandleSpan<DiagnosticName>,
    pub domain_symbol: SymbolHandle,
...
impl Default for ProofMembershipFact {
    fn default() -> Self {
        Self {
            value: crate::symbol_resolved_trees::expression::ExpressionHandle::invalid(),
            domain: HandleSpan::empty(),
            domain_symbol: SymbolHandle::invalid(),
