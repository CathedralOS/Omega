...
pub struct ConstDeclaration {
    ...
    pub is_public: bool,
    pub declared_type: crate::symbol_resolved_trees::types::TypeReference,
    /// Already-resolved declaration-owned root, deep-copied at each later use.
    pub initializer: crate::symbol_resolved_trees::expression::ExpressionHandle,
    ...
    pub authored_initializer: crate::symbol_resolved_trees::expression::ExpressionHandle,
