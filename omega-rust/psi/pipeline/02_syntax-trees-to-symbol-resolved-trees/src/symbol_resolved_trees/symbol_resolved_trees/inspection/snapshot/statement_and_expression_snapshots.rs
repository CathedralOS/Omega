...
use crate::symbol_resolved_trees::expression::{BinaryOperator, ExpressionHandle, ExpressionNode};
use crate::symbol_resolved_trees::statement::{
    Statement, Transition, TransitionGuard, TransitionTarget,
};
use crate::symbol_resolved_trees::symbol_resolved_trees::inspection::snapshot::TypeReferenceSnapshot;
use crate::symbol_resolved_trees::symbol_resolved_trees::inspection::snapshot::type_snapshots::{
    ...
    match statement {
        ...
        Statement::AssemblyFact(fact) => StatementSnapshot::AssemblyFact {
            contract_kind: match fact.kind {
                crate::symbol_resolved_trees::statement::AssemblyFactKind::Requires => "requires",
                crate::symbol_resolved_trees::statement::AssemblyFactKind::Ensures => "ensures",
            },
...
fn transition_snapshot(
    ...
    StatementSnapshot::Transition {
        ...
        crash_cause: match transition.exit {
            crate::symbol_resolved_trees::statement::TransitionExit::Ordinary => None,
            crate::symbol_resolved_trees::statement::TransitionExit::Crash(
            ...
            arms: table
                ...
                .map(|arm| MatchArmSnapshot {
                    ...
                    pattern: match arm.pattern {
                        crate::symbol_resolved_trees::expression::MatchPattern::Value(value) => {
...
fn diagnostic_name_span_snapshot(
