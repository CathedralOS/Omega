...
use crate::symbol_resolved_trees::statement::{Statement, StatementTable};
use crate::symbol_resolved_trees::types::{TypeConstraint, TypeReference, TypeReferenceTable};
use crate::symbol_resolved_trees::{SymbolResolvedDeclarationStorage, SymbolResolvedTrees};
...
impl SymbolResolvedTreeTables {
    pub fn from_symbol_resolved_trees_with_state_spans(
        ...
        for proposition in &roots.propositions {
            for binder in proposition_binders.span_or_empty(proposition.binders) {
                if let crate::symbol_resolved_trees::proposition::PropositionBinderKind::Const {
                    type_reference,
                } = &binder.kind
                {
                    tables.insert_type_reference(
            ...
            if let crate::symbol_resolved_trees::proposition::PropositionBody::Witness {
                evidence,
            } = &proposition.body
            {
                tables.insert_type_reference(
    ...
    fn insert_data_definition(
        &mut self,
        members: &[DataMember],
        data_payload_fields: &Arena<crate::symbol_resolved_trees::data::DataField>,
        child_type_references: &Arena<TypeReference>,
        type_constraints: &Arena<TypeConstraint>,
        source_expressions: &ExpressionTable,
    ) {
    ...
    fn insert_machine_with_state_spans(
        ...
        state_parameters: &Arena<StateParameter>,
        statement_path_members: &Arena<crate::symbol_resolved_trees::name::DiagnosticName>,
