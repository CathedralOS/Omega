...
pub enum TypeReference {
    ...
    ConstExpression(crate::symbol_resolved_trees::expression::ExpressionHandle),
    DynamicTrait {
        symbol: SymbolHandle,
        name: DiagnosticName,
...
pub enum TypeConstraint {
    ...
    Range {
        minimum: crate::symbol_resolved_trees::expression::ExpressionHandle,
        maximum: crate::symbol_resolved_trees::expression::ExpressionHandle,
        end_inclusive: bool,
    },
