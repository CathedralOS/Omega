...
fn display_dynamic_trait(
    trait_name: &crate::symbol_resolved_trees::name::DiagnosticName,
    conformance_carrier: Option<&crate::symbol_resolved_trees::name::DiagnosticName>,
    conformance_name: Option<&crate::symbol_resolved_trees::name::DiagnosticName>,
) -> String {
