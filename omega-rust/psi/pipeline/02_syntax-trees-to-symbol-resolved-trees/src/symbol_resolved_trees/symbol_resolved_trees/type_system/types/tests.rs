...
use crate::symbol_resolved_trees::expression::ExpressionTable;
...
fn check_range_tree_to_table(end_inclusive: bool) {
    ...
    let minimum = source_expressions.insert(
        crate::symbol_resolved_trees::expression::ExpressionNode::Integer(
            numerics::literals::IntegerLiteral::from_value(0),
        ),
    );
    let maximum = source_expressions.insert(
        crate::symbol_resolved_trees::expression::ExpressionNode::Integer(
