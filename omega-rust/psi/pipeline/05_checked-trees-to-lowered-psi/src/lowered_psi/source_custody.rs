...
impl LoweredSelectedIntegerComparisonOperation {
    ...
    pub const fn admitted_emission(
        operator: typed_trees_to_checked_trees::checked_trees::expression::BinaryOperator,
...
pub struct LoweredSourceCallOccurrence {
    pub source_site: Option<typed_trees_to_checked_trees::checked_trees::NominalMachineUseSite>,
