...
pub(super) fn validate_selected_operator_structural_call(
    ...
    if source != 0
        ...
        || realization.structural_parameter.access != checked_trees::CheckedStructuralAccess::Owned
        ...
        || machine.structural_parameters[0].access != checked_trees::CheckedStructuralAccess::Owned
        ...
        checked_trees::CheckedUnitStructuralTypeShape::Record { fields }
            if matches!(
                ...
                [field]
                    if matches!(
                        &field.field_type,
                        checked_trees::CheckedUnitStructuralFieldType::Scalar(
