...
pub(in crate::proofs::nonzero_divisor_certificate::affine_custody::frontier) struct Entry {
    word: Vec<usize>,
    start: usize,
    current: ScalarTerm,
}
...
impl Entry {
    pub(in crate::proofs::nonzero_divisor_certificate::affine_custody::frontier) fn root(
        root: &ScalarTerm,
    ) -> Self {
        Self {
            word: Vec::new(),
