...
use crate::execution::terminal_unit::return_unit_affine_discards;
...
pub(super) fn build(
        ...
        .enumerate()
    {
        ...
        let subject_place = crate::flow::contextual_canonical_place_from_expression(
            program,
            entry.symbol,
            2 + ordinal,
            subject,
        ...
        let payloads = if variant.symbol == payload_variant_definition.symbol {
            ...
            let argument_place = crate::flow::contextual_canonical_place_from_expression(
                program,
                entry.symbol,
                2 + ordinal,
                *argument,
