...
fn complementary_guards_preserve_exact_operands_and_boolean_polarity() {
    ...
    let storage = CheckedBooleanExpression::StorageRead {
        symbol: symbols::SymbolHandle::from_parts(2, 1),
    };
    ...
    for (left, right, accepted) in [
        ...
        (
            ...
            negate(CheckedBooleanExpression::StorageRead {
                symbol: symbols::SymbolHandle::from_parts(2, 2),
            }),
            false,
        ),
        ...
        assert_eq!(
            complementary(&plans, symbols::SymbolHandle::from_arena_index(1), 0),
            accepted,
            "{plans:?}"
        );
    }
...
fn complementary_guards_require_one_selected_row_per_exact_coordinate() {
    ...
    for mutation in 0..5 {
        ...
        match mutation {
            ...
            _ => changed.expressions[1].state = symbols::SymbolHandle::from_parts(1, 2),
        }
