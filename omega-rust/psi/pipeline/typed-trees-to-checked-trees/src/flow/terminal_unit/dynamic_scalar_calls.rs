...
struct ForwardedDynamicCall<'program, 'facts> {
    ...
    flow_call: &'facts checked_trees::FlowCallFact,
    call_site: crate::CallSite<'program>,
    transfer: checked_trees::CheckedDynamicDescriptorTransferPlan,
    prior_transfers: Vec<checked_trees::CheckedDynamicDescriptorTransferPlan>,
}
...
struct CheckedRealizationScalarBody {
    structural_scalar_field_stores: Vec<checked_trees::CheckedStructuralScalarFieldStorePlan>,
