...
use crate::flow::terminal_unit::control::call_results::{
...
pub(crate) fn build_checked_machine_with(
    ...
    let retain_reference_self = retain_reference_self
        ...
        || crate::flow::terminal_unit::receiver_calls::reads_receiver(program, facts, state)
        || facts
            .contract_plans
    ...
    let scalar_expression_locals = if statement_sequence.is_some() {
        ...
        crate::flow::terminal_unit::scalar_locals::scalar_expression_local_prefix(
