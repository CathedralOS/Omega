...
use crate::flow::terminal_unit::dynamic_scalar_calls::forwarded_calls::{
    ForwardedDynamicCall, forwarded_transfer_path_is_exact,
};
use crate::flow::terminal_unit::dynamic_scalar_calls::realization_bodies::{
...
use crate::flow::terminal_unit::{
    ...
    ServiceReachSummary, ShapeCollector, StatementNode, SymbolHandle, TypeReferenceNode,
...
pub(crate) fn build_checked_dynamic_scalar_call(
    ...
    plan.unit_continuation =
        crate::flow::terminal_unit::composed_control::build_direct_dynamic_unit_continuation(
...
fn checked_dynamic_realization_callables(
    ...
    closed_rows
        ...
        .map(|(closed, retained)| {
            ...
            Some(checked_trees::CheckedDynamicRealizationCallablePlan {
