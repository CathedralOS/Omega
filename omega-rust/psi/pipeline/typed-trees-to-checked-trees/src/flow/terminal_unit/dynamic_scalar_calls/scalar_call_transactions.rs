//! Dynamic scalar call transactions and descriptor transfers.

use crate::flow::terminal_unit::dynamic_scalar_calls::forwarded_calls::build_checked_forwarded_dynamic_scalar_calls;
use crate::flow::terminal_unit::dynamic_scalar_calls::receivers::{
    CheckedDynamicScalarCall, local_receiver_symbol, stored_dynamic_receiver,
};
use crate::flow::terminal_unit::dynamic_scalar_calls::scalar_call_plans::build_checked_dynamic_scalar_call;
use crate::flow::terminal_unit::dynamic_scalar_calls::{join, unit};
use crate::flow::terminal_unit::{
    BTreeMap, CheckFacts, CheckedBoundaryMachinePlan, CheckedUnitCallCoordinate, ExpressionNode,
    ShapeCollector, SymbolHandle, TypeReferenceNode, TypedTrees, state_flow,
};

pub(crate) fn build_checked_dynamic_scalar_call_transaction(
    program: &TypedTrees,
    facts: &CheckFacts,
    shapes: &mut ShapeCollector<'_>,
    boundaries: &[CheckedBoundaryMachinePlan],
) -> Option<checked_trees::CheckedDynamicDispatchPlans> {
