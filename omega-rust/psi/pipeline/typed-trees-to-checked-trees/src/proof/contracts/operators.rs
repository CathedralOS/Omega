...
) -> arena::Arena<ContractOperatorUseFact> {
...
mod tests {
    ...
    fn builds_contract_operator_use_facts_from_resolved_operator_contracts() {
        ...
        let mut candidates = arena::Arena::default();
        let candidate_span =
        ...
        let mut uses = arena::Arena::default();
        ...
        let mut contract_facts = arena::Arena::default();
        let mut fact_refs = arena::Arena::default();
