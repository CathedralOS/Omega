...
pub(super) fn expression_uses_symbol(
    ...
    match program.expression_table.expression(expression) {
        ...
        typed_trees::expression::ExpressionNode::Borrow(inner_expression) => {
        ...
        typed_trees::expression::ExpressionNode::StructLiteral(struct_literal) => program
            .expression_table
        ...
        | typed_trees::expression::ExpressionNode::String(_)
...
pub(super) fn expression_uses_local_name(
    ...
    match program.expression_table.expression(expression) {
        ...
        typed_trees::expression::ExpressionNode::Name(path) => program
            .expression_table
...
pub(super) fn expression_uses_place_symbol(
    ...
    .is_some_and(|place| {
        matches!(place.root, facts::PlaceRoot::Symbol(root) if root == symbol)
            || place.segments.iter().any(|segment| {
                matches!(segment, facts::PlaceSegment::Field { symbol: field } if *field == symbol)
            })
    });
    ...
    match program.expression_table.expression(expression) {
        ...
        typed_trees::expression::ExpressionNode::Member(member) => expression_uses_place_symbol(
            program,
            state_symbol,
            statement_index,
            member.receiver,
        ...
        typed_trees::expression::ExpressionNode::Unary(unary) => expression_uses_place_symbol(
            program,
            state_symbol,
            statement_index,
            unary.operand,
