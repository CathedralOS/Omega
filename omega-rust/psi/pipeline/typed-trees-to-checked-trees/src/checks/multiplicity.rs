...
struct WrittenLinearTarget {
    ...
    destination_path: Vec<facts::PlaceSegment>,
    place_index: usize,
...
pub(super) struct LinearClaimTemplate {
    pub(super) path: Vec<facts::PlaceSegment>,
...
struct CheckedClaimOutcomeEntry {
    output_path: Vec<facts::PlaceSegment>,
...
fn data_field_name(program: &typed_trees::TypedTrees, field_symbol: SymbolHandle) -> Option<&str> {
