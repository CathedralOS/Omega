...
struct CheckedReborrowLoanResourceDraft {
    ...
    owner_path: Vec<checked_trees::BorrowLoanOwnerSegment>,
    captured_place: checked_trees::CapturedPlace,
    access: checked_trees::BorrowAccessKind,
    parent_access: checked_trees::BorrowAccessKind,
    access_effect: CheckedReborrowAccessEffect,
    activation_source: checked_trees::FlowInvalidationSource,
    weakening_source: checked_trees::FlowInvalidationSource,
    weakening_reason: checked_trees::FlowBorrowWeakeningReason,
    parent_loan: arena::Handle<BorrowLoanFact>,
    child_activation: arena::Handle<checked_trees::FlowBorrowActivationFact>,
    parent_entry_constraint: arena::Handle<checked_trees::FlowConstraintRef>,
    child_weakening: arena::Handle<checked_trees::FlowBorrowWeakeningFact>,
    parent_weakening: arena::Handle<checked_trees::FlowBorrowWeakeningFact>,
...
struct CheckedReborrowDispositionEventDraft {
    machine_symbol: symbols::SymbolHandle,
    state_symbol: symbols::SymbolHandle,
    child_loan: arena::Handle<BorrowLoanFact>,
...
struct ResourceHandles {
    direct: Vec<arena::Handle<CheckedDirectBorrowLoanResource>>,
    reborrows: Vec<arena::Handle<CheckedReborrowLoanResource>>,
}
...
struct CheckedReborrowContainmentCertificateDraft {
    ...
    parent_resource: ParentResourceIndex,
    parent_access: checked_trees::BorrowAccessKind,
    child_access: checked_trees::BorrowAccessKind,
    access_effect: CheckedReborrowAccessEffect,
    child_activation: arena::Handle<checked_trees::FlowBorrowActivationFact>,
    parent_entry_constraint: arena::Handle<checked_trees::FlowConstraintRef>,
    ...
    child_weakening_reason: checked_trees::FlowBorrowWeakeningReason,
    parent_place: checked_trees::CapturedPlace,
    child_place: checked_trees::CapturedPlace,
    projection_remainder: Vec<facts::PlaceSegment>,
...
struct CheckedReborrowRestoredCallUseCertificateDraft {
    ...
    containment: usize,
    child_weakening: arena::Handle<checked_trees::FlowBorrowWeakeningFact>,
    call: arena::Handle<checked_trees::FlowCallFact>,
    borrow_call: arena::Handle<checked_trees::BorrowCallFact>,
    call_access: arena::Handle<checked_trees::BorrowArgumentAccessFact>,
    parent_entry_constraint: arena::Handle<checked_trees::FlowConstraintRef>,
    carrier_place: checked_trees::CapturedPlace,
    restored_place: checked_trees::CapturedPlace,
    access: checked_trees::BorrowAccessKind,
...
fn span_handle<T>(span: arena::HandleSpan<T>, offset: usize) -> Option<arena::Handle<T>> {
