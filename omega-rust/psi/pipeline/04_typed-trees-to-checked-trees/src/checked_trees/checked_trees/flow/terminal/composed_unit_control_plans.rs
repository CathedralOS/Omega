...
use crate::checked_trees::{CheckedScalarExpression, ClosedScalarContractValue};
...
pub enum CheckedComposedUnitControlTerminatorPlan {
    ...
    ReturnStructural {
        result: crate::checked_trees::CheckedUnitStructuralReturnPlan,
    },
    ReturnCase {
...
pub enum CheckedScalarReturnPlan {
    ...
    Binding(crate::checked_trees::CheckedUnitScalarResultBindingPlan),
    ...
    Exits(crate::checked_trees::CheckedUnitScalarControlPlan),
}
