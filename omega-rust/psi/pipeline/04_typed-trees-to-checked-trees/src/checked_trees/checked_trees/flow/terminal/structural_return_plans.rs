...
pub struct CheckedPayloadlessGuardedCallEvidencePlan {
    ...
    pub guarantee: arena::Handle<crate::checked_trees::OutcomeSpecificGuaranteeFact>,
    pub selected_term: arena::Handle<crate::checked_trees::CheckedEvidenceTerm>,
...
pub struct CheckedPayloadlessGuardedCallEvidenceUsePlan {
    ...
    pub parameter: arena::Handle<crate::checked_trees::CheckedEvidenceTerm>,
}
