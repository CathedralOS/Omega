...
pub struct FlowPermissionEventFact {
    ...
    pub root: crate::fact_plan::PlaceRoot,
    pub segments: HandleSpan<crate::fact_plan::PlaceSegment>,
...
pub struct FlowOwnedSelectionTransfer {
    ...
    pub path: HandleSpan<crate::fact_plan::PlaceSegment>,
...
pub enum FlowClaimOutcomeSource {
    ...
    Input {
        ...
        segments: HandleSpan<crate::fact_plan::PlaceSegment>,
    },
    Established {
...
pub struct FlowClaimOutcomeEntryFact {
    pub output_segments: HandleSpan<crate::fact_plan::PlaceSegment>,
...
pub struct FlowClaimJoinReceipt {
    ...
    pub expression: symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionHandle,
    pub result_root: crate::fact_plan::PlaceRoot,
    pub result_segments: HandleSpan<crate::fact_plan::PlaceSegment>,
    pub claim_identity: language_semantics::PermissionClaimIdentity,
