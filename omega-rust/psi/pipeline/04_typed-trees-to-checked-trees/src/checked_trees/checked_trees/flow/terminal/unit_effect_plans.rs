...
use crate::checked_trees::checked_trees::flow::terminal::structural_return::CheckedUnitStructuralReturnPlan;
...
pub struct CheckedUnitEffectPlans {
    ...
    pub dynamic_dispatch: crate::checked_trees::CheckedDynamicDispatchPlans,
...
pub enum CheckedUnitEffectOperationPlan {
    ...
    EstablishStructuralValue {
        ...
        operand_source: Option<crate::checked_trees::CheckedArrayConstructionSource>,
    ...
    ScalarCall {
        ...
        target_state: SymbolHandle,
        target_contract_report_fingerprint: u64,
        target_contract_commitment: crate::checked_trees::MachineContractCommitment,
        service_reach: ServiceReachSummary,
        scalar_arguments: Vec<CheckedCallScalarArgument>,
        /// Proof-only erased actuals in the target's erased-formal order.
        erased_scalar_arguments: Vec<CheckedCallScalarArgument>,
    ...
    WriteOnlyPrimitiveStore {
        ...
        value: crate::checked_trees::CheckedCallScalarArgument,
    },
    ...
    AtomicAccess(crate::checked_trees::CheckedAtomicAccessPlan),
...
pub struct CheckedStructuralValueCall {
    pub value: crate::checked_trees::CheckedStructuralValueHandle,
