...
pub struct CheckedDynamicStoredDescriptorPlan {
    pub storage: crate::checked_trees::DynamicDescriptorStorageFact,
...
pub struct CheckedDynamicJoinControlPlan {
    ...
    pub scalar_parameters: Vec<crate::checked_trees::CheckedStructuralScalarParameterPlan>,
...
pub struct CheckedDynamicScalarHelperPlan {
    ...
    pub scalar_locals: Vec<(CheckedUnitScalarResultBindingPlan, CheckedScalarExpression)>,
    pub scalar_control: crate::checked_trees::CheckedUnitScalarControlPlan,
}
...
pub enum CheckedDynamicRealizationBodyPlan {
    ...
    Unit,
    Scalar {
        result_type: symbol_resolved_trees_to_typed_trees::typed_trees::types::PrimitiveType,
...
pub enum CheckedStructuralScalarFieldStoreValue {
    ...
    Computation(crate::checked_trees::CheckedScalarComputationHandle),
