...
impl<'facts> StatementAcceptance<'facts> {
    ...
    pub fn borrow_compatibility_certificates(
        &self,
    ) -> impl Iterator<Item = &'facts crate::checked_trees::CheckedBorrowCompatibilityCertificate> + '_
    {
        self.facts
            .borrow
    ...
    /// Already-validated borrow-mutation certificates formed by this exact
    /// state-owned statement.
    pub fn borrow_mutation_certificates(
        &self,
    ) -> impl Iterator<Item = &'facts crate::checked_trees::CheckedBorrowMutationCertificate> + '_
    {
        self.facts
            .borrow
    ...
    /// Already-validated invocation comparisons at this exact statement.
    pub fn borrow_call_compatibility_certificates(
        &self,
    ) -> impl Iterator<Item = &'facts crate::checked_trees::CheckedBorrowCallCompatibilityCertificate> + '_
    {
        self.facts
            .borrow
    ...
    pub fn qualification_correspondences(
        &self,
    ) -> impl Iterator<Item = &'facts crate::fact_plan::QualificationCorrespondence> + '_ {
        self.facts
            .semantic
