...
use crate::checked_trees::{CheckedTrees, types};
...
impl CheckedTrees {
    ...
    pub fn bound_service_parameter_carrier(
        ...
        let Some(carrier) =
            symbol_resolved_trees_to_typed_trees::typed_trees::service::classify_exact_bound_service_carrier(&self.typed, type_reference)
