...
use crate::checked_trees::{
    CheckedFactCallProjection, CheckedIntrinsicCallFact, CheckedPlacedViewInput,
};

#[derive(Debug, Clone, Default, PartialEq, Eq)]
pub struct CheckFacts {
    pub semantic: crate::fact_plan::FactPlan,
    ...
    pub capabilities: crate::flow_effects::CapabilityFlowPlan,
    pub flow: FlowFacts,
    ...
    pub boundary_adapter_dispatch: Vec<crate::checked_trees::CheckedBoundaryAdapterDispatch>,
