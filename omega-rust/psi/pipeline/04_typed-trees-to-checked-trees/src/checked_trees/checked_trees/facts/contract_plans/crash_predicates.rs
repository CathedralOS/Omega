...
pub struct CrashPredicateIdentity {
    ...
    scalar_expression: Option<crate::checked_trees::CheckedBooleanExpression>,
}
...
impl CrashPredicateIdentity {
    ...
    pub fn from_expression_and_scalar(
        ...
        scalar_expression: crate::checked_trees::CheckedBooleanExpression,
    ) -> Self {
    ...
    pub const fn scalar_expression(
        &self,
