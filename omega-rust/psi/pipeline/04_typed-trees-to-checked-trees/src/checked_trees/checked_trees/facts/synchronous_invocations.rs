...
pub struct MachineSynchronousInvocationFact {
    ...
    pub published_targets: Vec<crate::flow_effects::InvocationTarget>,
    pub checked_inferred_targets: Vec<crate::flow_effects::InvocationTarget>,
        ...
        let facts = SynchronousInvocationFacts {
            machines: vec![
                ...
                MachineSynchronousInvocationFact {
                    machine: internal,
                    published_targets: Vec::new(),
                    checked_inferred_targets: vec![crate::flow_effects::InvocationTarget::Service(
