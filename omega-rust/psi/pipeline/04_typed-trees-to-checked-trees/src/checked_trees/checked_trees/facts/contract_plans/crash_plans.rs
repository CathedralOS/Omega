...
pub struct CrashPlan {
    ...
    structural_runtime_requirements: Option<Vec<crate::checked_trees::CheckedBooleanExpression>>,
    checked_sites: Vec<CheckedCrashSite>,
    checked_calls: Vec<CheckedCrashCallSite>,
    checked_operators:
        Vec<crate::checked_trees::checked_trees::facts::checked_crash_operator_site::CheckedCrashOperatorSite>,
...
impl CrashPlan {
    ...
    pub fn with_structural_runtime_requirements(
        mut self,
        requirements: Option<Vec<crate::checked_trees::CheckedBooleanExpression>>,
    ) -> Self {
    ...
    pub fn uses_structural_proof_gated_arithmetic(&self) -> bool {
        fn scalar_uses_proof_gated_arithmetic(
            ...
            match expression {
                ...
                crate::checked_trees::CheckedScalarExpression::IntegerBinary {
                    ...
                    let exact = matches!(
                        kind,
                        crate::checked_trees::CheckedIntegerBinaryKind::ExactDivide
                            | crate::checked_trees::CheckedIntegerBinaryKind::ExactRemainder
                    );
                    let policy = matches!(
                        kind,
                        crate::checked_trees::CheckedIntegerBinaryKind::WrappingDivide
                            | crate::checked_trees::CheckedIntegerBinaryKind::WrappingRemainder
                            | crate::checked_trees::CheckedIntegerBinaryKind::SaturatingDivide
                            | crate::checked_trees::CheckedIntegerBinaryKind::SaturatingRemainder
                    );
                    ...
                    let exact_shift = matches!(
                        kind,
                        crate::checked_trees::CheckedIntegerBinaryKind::ExactShiftLeft
                            | crate::checked_trees::CheckedIntegerBinaryKind::ExactShiftRight
                    );
                    runtime_divisor
                        || exact_shift
                ...
                crate::checked_trees::CheckedScalarExpression::IntegerBitwiseNot {
                    operand,
                    ..
                }
                | crate::checked_trees::CheckedScalarExpression::IntegerWiden { operand, .. }
                | crate::checked_trees::CheckedScalarExpression::IntegerExactCast {
                    operand, ..
                }
                | crate::checked_trees::CheckedScalarExpression::IntegerWrappingCast {
                    operand,
                    ..
                }
                | crate::checked_trees::CheckedScalarExpression::IntegerSaturatingCast {
                    operand,
                    ..
    ...
    pub fn with_checked_operators(
        mut self,
        mut operators: Vec<
            crate::checked_trees::checked_trees::facts::checked_crash_operator_site::CheckedCrashOperatorSite,
        >,
    ) -> Option<Self> {
        ...
        let identity = |site: &crate::checked_trees::checked_trees::facts::checked_crash_operator_site::CheckedCrashOperatorSite| {
