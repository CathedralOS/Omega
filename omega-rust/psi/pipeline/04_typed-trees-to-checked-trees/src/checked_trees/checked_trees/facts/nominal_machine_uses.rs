...
pub struct CheckedMachineContractRefinement {
    ...
    pub published_requirement_commitment: crate::checked_trees::MachineContractCommitment,
    pub selected_actual_report_fingerprint: u64,
    pub selected_actual_commitment: crate::checked_trees::MachineContractCommitment,
}
...
pub struct CheckedCallbackPlacementIdentity {
    ...
    pub boundary_calling_plan_commitment: symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment,
...
pub struct CheckedCallbackResourceReceipt {
    ...
    contract_commitment: crate::checked_trees::MachineContractCommitment,
...
impl CheckedCallbackResourceReceipt {
    ...
    pub const fn contract_commitment(self) -> crate::checked_trees::MachineContractCommitment {
...
mod tests {
    ...
    use crate::checked_trees::MachineContractCommitment;
    ...
    fn callback_placement_identity_must_be_nonzero() {
        ...
        row.callback_placement = Some(CheckedCallbackPlacementIdentity {
            ...
            boundary_calling_plan_commitment:
                symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment::from_digest([0; 32]),
    ...
    fn callback_resource_receipt_must_bind_the_selected_actual_entry() {
        ...
        row.callback_placement = Some(CheckedCallbackPlacementIdentity {
            ...
            boundary_calling_plan_commitment:
                symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::BoundaryCallingPlanCommitment::from_digest([10; 32]),
    ...
    fn callback_resource_receipt_rejects_compact_equal_contract_substitution() {
        ...
        let substituted = crate::checked_trees::MachineContractCommitment::from_digest([0x77; 32]);
