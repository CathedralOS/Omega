...
pub struct ClosedFloatRangeRequirement {
    pub position: usize,
    pub primitive_type: symbol_resolved_trees_to_typed_trees::typed_trees::types::PrimitiveType,
...
pub enum ClosedScalarContractValue {
    ...
    FloatMeaningEquality {
        ...
        equality: Option<crate::checked_trees::CheckedProofPropositionId>,
    },
}
...
impl ClosedScalarValueContractPlan {
    ...
    pub fn requires_bound_interval(
        &self,
        position: usize,
        primitive_type: symbol_resolved_trees_to_typed_trees::typed_trees::types::PrimitiveType,
    ) -> Option<(i128, i128)> {
    ...
    pub fn resolve_float_meaning_equalities(
        ...
        ) -> Option<crate::checked_trees::CheckedProofPropositionId>,
    ...
    match predicate {
        ...
        crate::checked_trees::CheckedBooleanExpression::IntegerComparison { kind, left, right } => {
            ...
            let (lower, upper) = match (kind, subject_is_left) {
                (crate::checked_trees::CheckedIntegerComparisonKind::Equal, _) => {
                    (Some(endpoint), Some(endpoint))
                }
                (crate::checked_trees::CheckedIntegerComparisonKind::LessOrEqual, true) => {
                    (None, Some(endpoint))
                }
                (crate::checked_trees::CheckedIntegerComparisonKind::LessThan, true) => {
                    (None, endpoint.checked_sub(1))
                }
                (crate::checked_trees::CheckedIntegerComparisonKind::LessOrEqual, false) => {
                    (Some(endpoint), None)
                }
                (crate::checked_trees::CheckedIntegerComparisonKind::LessThan, false) => {
...
fn conjunct_literal(expression: &crate::checked_trees::CheckedScalarExpression) -> Option<i128> {
    let crate::checked_trees::CheckedScalarExpression::IntegerLiteral { literal } = expression
    else {
        return None;
    };
