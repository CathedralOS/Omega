...
pub enum BorrowCompatibilityPremiseSource {
    ...
    Requires(Handle<crate::checked_trees::ContractProofFact>),
    RequiresDomain {
        membership: Handle<crate::checked_trees::ContractProofFact>,
        domain: SymbolHandle,
        predicate: Handle<symbol_resolved_trees_to_typed_trees::typed_trees::domain::ProofFact>,
    },
    IncomingGuard {
...
pub struct CheckedDirectBorrowRestorationObligation {
    ...
    pub weakening_source: crate::checked_trees::FlowInvalidationSource,
    pub weakening_reason: crate::checked_trees::FlowBorrowWeakeningReason,
}
...
pub struct CheckedDirectBorrowLoanResource {
    ...
    pub access: BorrowAccessKind,
    pub activation_source: crate::checked_trees::FlowInvalidationSource,
    pub weakening_source: crate::checked_trees::FlowInvalidationSource,
    pub weakening_reason: crate::checked_trees::FlowBorrowWeakeningReason,
...
pub struct CheckedReborrowRestorationObligation {
    ...
    pub child_weakening_source: crate::checked_trees::FlowInvalidationSource,
    pub child_weakening_reason: crate::checked_trees::FlowBorrowWeakeningReason,
}
...
pub struct CheckedReborrowParentSuspensionBoundary {
    ...
    pub parent_loan: Handle<BorrowLoanFact>,
    pub parent_resource: CheckedParentBorrowResource,
    pub child_activation: Handle<crate::checked_trees::FlowBorrowActivationFact>,
    pub parent_entry_constraint: Handle<crate::checked_trees::FlowConstraintRef>,
    pub source: crate::checked_trees::FlowInvalidationSource,
}
...
pub struct CheckedReborrowParentEndStatus {
    ...
    pub parent_loan: Handle<BorrowLoanFact>,
    pub parent_resource: CheckedParentBorrowResource,
    pub child_weakening: Handle<crate::checked_trees::FlowBorrowWeakeningFact>,
    pub parent_weakening: Handle<crate::checked_trees::FlowBorrowWeakeningFact>,
...
pub struct CheckedRetiredParentResourceDispositionStep {
    ...
    pub weakening: Handle<crate::checked_trees::FlowBorrowWeakeningFact>,
}
...
pub struct CheckedReborrowResourceDispositionEvent {
    ...
    pub parent_loan: Handle<BorrowLoanFact>,
    pub parent_resource: CheckedParentBorrowResource,
    pub boundary_source: crate::checked_trees::FlowInvalidationSource,
...
pub struct CheckedReborrowContainmentCertificate {
    ...
    pub child_activation: Handle<crate::checked_trees::FlowBorrowActivationFact>,
    pub parent_entry_constraint: Handle<crate::checked_trees::FlowConstraintRef>,
    pub formation_source: crate::checked_trees::FlowInvalidationSource,
    pub child_weakening: Handle<crate::checked_trees::FlowBorrowWeakeningFact>,
    pub parent_weakening: Handle<crate::checked_trees::FlowBorrowWeakeningFact>,
    pub child_weakening_source: crate::checked_trees::FlowInvalidationSource,
    pub child_weakening_reason: crate::checked_trees::FlowBorrowWeakeningReason,
    ...
    pub projection_remainder: Vec<crate::fact_plan::PlaceSegment>,
...
pub struct CheckedReborrowRestoredCallUseCertificate {
    ...
    pub child_weakening: Handle<crate::checked_trees::FlowBorrowWeakeningFact>,
    pub call: Handle<crate::checked_trees::FlowCallFact>,
...
pub struct BorrowFacts {
    ...
    pub access_segments: Arena<crate::fact_plan::PlaceSegment>,
...
impl BorrowFacts {
    pub fn with_roots(
        ...
        access_segments: Arena<crate::fact_plan::PlaceSegment>,
    ...
    pub fn loan_segments(&self, loan: &BorrowLoanFact) -> &[crate::fact_plan::PlaceSegment] {
...
mod tests {
    ...
    fn borrow_facts_constructor_keeps_borrow_roots_explicit() {
        ...
        let access_segments = Arena::<crate::fact_plan::PlaceSegment>::with_capacity(2);
    ...
    fn captured_place_identity_is_structural_and_order_sensitive() {
        ...
        let first = symbols::SymbolHandle::from_arena_index(2);
        let second = symbols::SymbolHandle::from_arena_index(3);
        let first_expression =
            crate::checked_trees::expression::ExpressionHandle::from_arena_index(4);
        let place = CapturedPlace {
            root_symbol: root,
            segments: vec![
                crate::fact_plan::PlaceSegment::Field { symbol: first },
                crate::fact_plan::PlaceSegment::Case { variant: second },
                crate::fact_plan::PlaceSegment::FixedIndex { index: 5 },
                crate::fact_plan::PlaceSegment::FixedRange { start: 6, end: 8 },
        ...
        let Some(crate::fact_plan::PlaceSegment::Index { expression }) =
            changed_selector.segments.last_mut()
        else {
            unreachable!()
        };
        *expression = crate::checked_trees::expression::ExpressionHandle::from_arena_index(5);
