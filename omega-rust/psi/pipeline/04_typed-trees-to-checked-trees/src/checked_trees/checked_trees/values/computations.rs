...
use crate::checked_trees::CheckedUnitStructuralArgumentPlan;
...
pub enum CheckedScalarComputationKind {
    ...
    SelectedComparison {
        operator_use: Handle<crate::checked_trees::CheckedOperatorUseFact>,
    ...
    Call {
        source_call: Handle<crate::checked_trees::FlowCallFact>,
...
pub struct CheckedScalarDispatchArm {
    ...
    pub equality_use: Handle<crate::checked_trees::CheckedOperatorUseFact>,
    pub source_arm:
