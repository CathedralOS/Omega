...
use crate::checked_trees::{
    CheckedOperatorUseFact, CheckedScalarComputationHandle, CheckedScalarDispatchPattern,
};
use arena::Arena;
use arena::{Handle, HandleSpan};
use symbol_resolved_trees_to_typed_trees::typed_trees::expression::{
    ExpressionHandle, TableMatchArm,
};
...
pub enum CheckedStructuralValueKind {
    ...
    Case(crate::checked_trees::CheckedScalarCaseConstruction),
    ...
    Place(crate::checked_trees::CheckedUnitStructuralArgumentPlan),
    ...
    /// read does not carry.
    ViewElementCopy {
        reads: Vec<crate::checked_trees::CheckedScalarExpression>,
    },
    ...
    Projection {
        ...
        path: Vec<crate::checked_trees::CheckedUnitStructuralPathSegment>,
...
impl Default for CheckedStructuralValueKind {
    fn default() -> Self {
        Self::Case(crate::checked_trees::CheckedScalarCaseConstruction::default())
    }
}
