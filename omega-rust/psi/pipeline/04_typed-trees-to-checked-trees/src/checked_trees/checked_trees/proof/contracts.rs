...
pub struct ContractProofFact {
    ...
    pub fact: Handle<symbol_resolved_trees_to_typed_trees::typed_trees::domain::ProofFact>,
...
pub struct OutcomeSpecificArmRowFact {
    ...
    pub instantiated_proposition: Option<crate::checked_trees::CheckedPropositionApplication>,
...
pub struct OutcomeSpecificEvidenceInterfaceScopeFact {
    pub interface: crate::checked_trees::CheckedEvidenceInterfaceIdentity,
    pub evidence_type:
        symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle,
    pub reference_regions:
        Vec<symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle>,
...
pub struct CheckedEvidenceTerm {
    ...
    pub proposition: crate::checked_trees::CheckedPropositionApplication,
    ...
    pub evidence_interface: Option<crate::checked_trees::CheckedEvidenceInterfaceIdentity>,
}
...
pub struct ContractExpressionEvidenceArgumentFact {
    ...
    pub parameter: Handle<CheckedEvidenceTerm>,
    pub lane_position: usize,
    pub instantiated_proposition: crate::checked_trees::CheckedPropositionApplication,
}
...
pub struct ContractExpressionStaticConformanceApplicationFact {
    ...
    pub application: symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::ClosedConformanceApplication,
}
...
pub enum EvidenceAssignmentSource {
    ...
    ProducerConformance {
        ...
        rows: Vec<crate::checked_trees::DynamicConformanceRowFact>,
    },
}
...
pub struct StaticRequirementDispatchFact {
    ...
    pub application_commitment: symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::ClosedConformanceApplicationCommitment,
    pub declaring_trait: SymbolHandle,
    pub requirement: SymbolHandle,
