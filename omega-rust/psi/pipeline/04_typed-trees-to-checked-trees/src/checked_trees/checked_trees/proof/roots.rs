...
pub struct ProofFacts {
    ...
    pub contract_entailment_assumption_discharges:
        Vec<crate::checked_trees::CheckedContractEntailmentAssumptionDischarge>,
    ...
    pub float_meaning_projections: Vec<crate::checked_trees::CheckedFloatMeaningProjection>,
    ...
    pub float_meaning_projection_occurrences:
        Vec<crate::checked_trees::CheckedFloatMeaningProjectionOccurrence>,
    /// Proof-position equalities over exact float-meaning projection results.
    pub float_meaning_equalities: Vec<crate::checked_trees::CheckedFloatMeaningEqualityProposition>,
    ...
    pub float_semantic_applications: Vec<crate::checked_trees::CheckedFloatSemanticApplication>,
    ...
    pub proposition_vocabulary: crate::checked_trees::CheckedPropositionVocabulary,
    ...
    pub mathematical_declarations: Vec<crate::checked_trees::CheckedMathematicalDeclaration>,
}
...
impl ProofFacts {
    ...
    pub fn direct_result_float_meaning_reflexivity(
        ...
        source_expression: symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionHandle,
    ) -> Option<&crate::checked_trees::CheckedFloatMeaningProjection> {
        ...
        if projections.next().is_some()
            || !matches!(
                projection.source,
                crate::checked_trees::CheckedFloatProjectionSource::DirectMachineResult(result)
...
mod tests {
    ...
    fn proof_facts_constructor_keeps_proof_roots_explicit() {
        ...
        let proposition_vocabulary = crate::checked_trees::CheckedPropositionVocabulary::default();
