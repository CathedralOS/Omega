...
fn proves_domain_membership_for_structurally_equal_places() {
    ...
    let mut program = TypedTrees::default();
    program.push_domain_definition(
        symbol_resolved_trees_to_typed_trees::typed_trees::domain::DomainDefinition {
...
fn expression_places_resolve_attached_data_members() {
    ...
    let mut main_data = symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition {
    ...
    program.push_data_member(
        ...
        symbol_resolved_trees_to_typed_trees::typed_trees::data::DataMember::Field(
            symbol_resolved_trees_to_typed_trees::typed_trees::data::DataField {
                identity: None,
    ...
    let mut machine = symbol_resolved_trees_to_typed_trees::typed_trees::machine::Machine {
    ...
    let mut state = symbol_resolved_trees_to_typed_trees::typed_trees::state::State {
        symbol: state_symbol,
        name: Identifier::generated("main"),
