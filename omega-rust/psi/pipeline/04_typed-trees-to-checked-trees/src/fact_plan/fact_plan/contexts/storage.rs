...
use crate::fact_plan::FactContextHandle;
...
impl FactContexts {
    ...
    pub(in crate::fact_plan::fact_plan) fn handles_at_point(
        &self,
        point: ProgramPoint,
    ...
    pub(in crate::fact_plan::fact_plan) fn group_at_point(
        &self,
        point: ProgramPoint,
    ) -> FactContextGroup {
        FactContextGroup {
    ...
    pub(in crate::fact_plan::fact_plan) fn handles_in_group(
        &self,
