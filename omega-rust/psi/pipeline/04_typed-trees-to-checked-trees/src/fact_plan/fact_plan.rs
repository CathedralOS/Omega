...
pub struct FactPlan {
    ...
    pub scalar_values: Arena<crate::fact_plan::ScalarValue>,
    pub integer_ranges: Arena<crate::fact_plan::IntegerRange>,
...
impl FactPlan {
    pub fn with_capacity(fact_capacity: usize, context_capacity: usize) -> Self {
        Self {
            ...
            scalar_values: Arena::with_capacity(fact_capacity),
            integer_ranges: Arena::with_capacity(fact_capacity),
    ...
    /// [`canonical_place_label_from_parts`](crate::fact_plan::canonical_place_label_from_parts).
