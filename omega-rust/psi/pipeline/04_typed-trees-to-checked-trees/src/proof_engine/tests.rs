...
use crate::proof_engine::build_proof_surface_report;
...
fn collects_bounded_type_sites() {
    ...
    let state = syntax_trees.items.insert_state(&State {
        ...
        return_type: tokens_to_syntax_trees::syntax_trees::types::TypeReferenceHandle::invalid(),
    ...
    syntax_trees.push_root_item(Item::Machine(Machine {
        ...
        ranking_range: tokens_to_syntax_trees::syntax_trees::expression::ExpressionHandle::invalid(
        ),
