...
use crate::proof_engine::checker::assignment_stability::collect_stable_assignment_conditions;
use crate::proof_engine::checker::guards::{
...
use crate::proof_engine::checker::requires_conditions;
...
fn anonymous_integer_argument_range(
    ...
    let literal = crate::validation::land_anonymous_integer_expression(
        program,
        argument,
        primitive,
        |expression| crate::validation::has_anonymous_operator_meaning(program, expression),
    )?;
...
pub struct AssignmentRangeContext<'program> {
    pub(crate) program: &'program symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees,
    call_frames: std::sync::OnceLock<Option<crate::validation::CallFrameResolver<'program>>>,
}
...
impl<'program> AssignmentRangeContext<'program> {
    ...
    pub(crate) fn call_frames(&self) -> Option<&crate::validation::CallFrameResolver<'program>> {
        self.call_frames
            .get_or_init(|| crate::validation::CallFrameResolver::new(self.program))
            .as_ref()
    }
}
...
pub fn proved_assignment_integer_range_with_context(
    ...
    context: &AssignmentRangeContext<'_>,
) -> Option<crate::proof_engine::obligations::IntegerRange> {
...
fn operand_is_unsigned(
    ...
    matches!(
        ...
        symbol_resolved_trees_to_typed_trees::typed_trees::types::PrimitiveType::U8
            ...
            | symbol_resolved_trees_to_typed_trees::typed_trees::types::PrimitiveType::Addr
    )
}
...
fn operand_declared_primitive(
    ...
    for machine in program.machines() {
        ...
        if let Some(field_type) = crate::proof_engine::obligations::data_field_type_by_name(
            program,
            data,
