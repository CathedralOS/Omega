...
use crate::proof_engine::checker::arrival_stability;
use crate::proof_engine::checker::guards::unwrap_true_guard_condition;
use crate::proof_engine::obligations::{BoundedAssignmentObligation, ProofPlan};
...
pub(crate) fn resolved_writes_overlap_reads(written: &[String], reads: &[Vec<String>]) -> bool {
    reads.iter().any(|read| {
        ...
        written
            .iter()
            .any(|write| crate::validation::frame_paths_overlap(&read, write))
    })
}
