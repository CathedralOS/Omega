...
use crate::proof_engine::obligations::plan::{
...
fn unary_operator_tag(
    operator: symbol_resolved_trees_to_typed_trees::typed_trees::expression::UnaryOperator,
) -> &'static str {
    match operator {
        symbol_resolved_trees_to_typed_trees::typed_trees::expression::UnaryOperator::BitwiseNot => "bit-not",
        symbol_resolved_trees_to_typed_trees::typed_trees::expression::UnaryOperator::LogicalNot => "logical-not",
    }
}
