...
fn bounded_value(
    ...
    data_name: &str,
    base: symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle,
...
fn float_ranges_key_by_exact_value() {
    ...
    let float_range = |minimum: f64, maximum: f64, inclusive| ProofConstraint::FloatRange {
        minimum:
            symbol_resolved_trees_to_typed_trees::typed_trees::expression::FloatLiteral::from_f64(
                minimum,
            ),
        maximum:
            symbol_resolved_trees_to_typed_trees::typed_trees::expression::FloatLiteral::from_f64(
