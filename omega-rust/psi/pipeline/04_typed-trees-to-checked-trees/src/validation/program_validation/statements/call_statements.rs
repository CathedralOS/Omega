...
use crate::validation::machine_calls::calls::validate_call_node;
...
pub(super) fn validate(
    ...
    statement_handle: symbol_resolved_trees_to_typed_trees::typed_trees::statement::StatementHandle,
    ...
    if let Some(state) = current_state {
        crate::validation::declarations::operators::validate_named_statement_operator_application(
            program,
            symbols,
            machine,
            state,
    ...
    if let Some(signature) =
        crate::validation::machine_calls::calls::boundary_trait_signature(program, machine, call)
    {
