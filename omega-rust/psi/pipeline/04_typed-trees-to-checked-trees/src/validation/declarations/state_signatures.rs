...
fn validate_machine_parameter_signatures<'program>(
    ...
    inherited_type_parameters: &[symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameter],
...
fn validate_crash_route_shapes(
    ...
    let symbol_resolved_trees_to_typed_trees::typed_trees::signature::SignatureContractKind::Crashes { cause } = &contract.kind else {
        return;
    };
...
fn contract_kind_label(
    ...
    match kind {
        symbol_resolved_trees_to_typed_trees::typed_trees::signature::SignatureContractKind::Requires => "requires",
        symbol_resolved_trees_to_typed_trees::typed_trees::signature::SignatureContractKind::Ensures => "ensures",
        ...
        symbol_resolved_trees_to_typed_trees::typed_trees::signature::SignatureContractKind::Crashes { .. } => "crashes",
    }
}
