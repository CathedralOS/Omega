...
fn is_sealed_toolchain_float_projection(
    ...
    crate::validation::proof_contracts::float_projection_bindings::exact_toolchain_float_projection_primitive(
...
pub(crate) fn collect_declaration_visibility_diagnostics(
    ...
    for selection in program.authored_declaration_selections() {
        ...
        if !symbol_resolved_trees_to_typed_trees::typed_trees::visibility::requires_declaration_visibility(symbol_kind) {
            continue;
        }
        let Some(visibility) =
