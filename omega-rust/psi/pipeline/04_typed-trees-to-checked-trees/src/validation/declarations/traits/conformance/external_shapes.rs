...
use crate::validation::declarations::standard_declarations::is_core_vector;
...
fn boundary_has_explicit_calling_policy(
    ...
    crate::validation::declarations::standard_declarations::standard_calling_traits(program)
        .is_some_and(|(calling, _)| {
            program
