...
use crate::validation::declarations::traits::conformance::bounds::{
...
use crate::validation::declarations::traits::trait_definition_by_symbol;
use crate::validation::value_custody::type_references::type_references_match;
...
pub(crate) fn validate_trait_application_obligations(
    ...
    available_bounds: &[symbol_resolved_trees_to_typed_trees::typed_trees::machine::GenericConformanceBound],
...
fn indexed_carrier_parameter_matches(
    ...
    applied_arguments: &[TypeReferenceHandle],
    proposition_binders: &[symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionBinder],
