...
use crate::validation::declarations::traits::conformance::trait_applications::validate_trait_application_obligations;
...
pub(crate) struct GenericBoundRequirement<'program> {
    ...
    pub(crate) bound: &'program symbol_resolved_trees_to_typed_trees::typed_trees::machine::GenericConformanceBound,
}
