...
use symbol_resolved_trees_to_typed_trees::typed_trees::operator::operator_operand_signature;
...
///
/// Delegates to the shared `operator_operand_signature` in `typed-trees`
