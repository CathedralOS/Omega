...
use symbol_resolved_trees_to_typed_trees::typed_trees::machine::{Machine, TraitConformance};
...
fn retained_row(fixture: &ClosedApplicationFixture) -> ClosedOperatorRealizationApplication {
    ...
    symbol_resolved_trees_to_typed_trees::typed_trees::operator::closed_operator_realization_application(program, machine, operator)
