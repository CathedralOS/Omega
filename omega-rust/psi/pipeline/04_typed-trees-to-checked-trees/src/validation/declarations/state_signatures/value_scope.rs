...
use symbol_resolved_trees_to_typed_trees::typed_trees::{
    TypedTrees, domain::ProofFact, machine::Machine,
};
...
pub(super) fn validate(
    ...
    for state in program.machine_states(machine) {
        let scope = crate::validation::value_custody::locals::StateValueScope {
            program,
            machine,
            state,
        ...
        let type_scope = crate::validation::value_custody::locals::StateValueScope {
            context: "type bound",
            ..scope
        };
