...
use crate::validation::proof_contracts::arithmetic_domains::float_arithmetic::resolve_named_float_arithmetic;
use crate::validation::proof_contracts::arithmetic_domains::integer_ranges::{
    primitive_name, primitive_range,
};
...
pub(crate) fn validate_machine_total_specification_arithmetic(
    ...
    for contract in program.machine_contracts(machine) {
        ...
        for fact in program.proof_facts.span_or_empty(contract.facts) {
            ...
            crate::validation::proof_contracts::contract_entailment::validate_specification_call_requirements(
                program,
                machine,
                entry_state,
                fact,
            ...
            crate::validation::proof_contracts::contract_entailment::validate_proof_fact_integer_casts(
                program,
                fact,
                &machine_prior_facts,
                diagnostics,
...
pub(super) struct AbstractSpecificationBindings<'program> {
    ...
    data: Option<&'program symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition>,
}
...
pub(super) fn abstract_specification_place_type(
    ...
    fn named_data(
        ...
        if symbol.is_valid() {
            return crate::validation::machine_calls::effect_inference::plan_scope::data_definition_by_symbol(
                program, symbol,
            );
        }
        ...
        if let PropositionBody::Transparent { proposition } = &proposition.body {
            match proposition {
                PropositionFormula::BooleanExpression(expression) => {
                    crate::validation::proof_contracts::contract_entailment::validate_proof_integer_casts(
                        program,
                        *expression,
                        &[],
                        diagnostics,
