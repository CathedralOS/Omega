...
use crate::validation::proof_contracts::arithmetic_domains::assignments::check_narrowing_assignment;
...
use crate::validation::proof_contracts::arithmetic_domains::interval::Interval;
use crate::validation::proof_contracts::arithmetic_domains::range_constraints::range_constraint_interval;
use crate::validation::proof_contracts::arithmetic_domains::value_environment::ValueEnvironment;
...
pub(crate) fn call_return_type(
    ...
    if crate::validation::proof_contracts::proof_embeddings::is_exact_embed_call(program, call) {
        return crate::validation::proof_contracts::proof_embeddings::proof_int_type_reference(
            program,
        );
    }
...
pub(crate) fn ensured_call_result_interval(
    ...
    let (machine, state) = crate::validation::machine_calls::calls::machine_state_by_symbol(
        program,
        call.target_symbol,
    )?;
    ...
    for fact in ensures {
        ...
        while let Some(conjunct) = conjuncts.pop() {
            ...
            for (subject, operand, subject_on_left) in [
                ...
                let names_result =
                    crate::validation::proof_contracts::contract_results::reserved_result_owner(
                        program, subject,
                    )
...
pub(crate) fn enforce_symbolic_range(
    ...
    if crate::validation::proof_contracts::contract_entailment::symbolic_range_contains(
        program,
        machine,
        state,
        return_type,
...
mod bracketed_ownership_probes {
    ...
    use crate::validation::proof_contracts::arithmetic_domains::range_constraints::declares_bracketed_range;
