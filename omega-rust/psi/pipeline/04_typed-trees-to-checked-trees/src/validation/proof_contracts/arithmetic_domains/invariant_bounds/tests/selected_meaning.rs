...
fn nested_arithmetic_retains_selected_operator_and_comparison_meaning() {
    ...
    for selected in [false, true] {
        ...
        for (name, spelling) in [
            ...
            let symbol_resolved_trees_to_typed_trees::typed_trees::statement::StatementNode::Expression(expression) =
...
fn closed_primitive_range_bounds_do_not_erase_selected_trait_meaning() {
    ...
    assert!(crate::validation::closed_integer_range_bound(&program, expression).is_none());
}
