...
use crate::validation::proof_contracts::arithmetic_domains::integer_ranges::known_u64_value;
...
pub(super) fn bitwise_known_unsigned(
    ...
    match program.expression_table.expression(expression) {
        ExpressionNode::Unary(unary)
            if unary.operator == symbol_resolved_trees_to_typed_trees::typed_trees::expression::UnaryOperator::BitwiseNot =>
        {
