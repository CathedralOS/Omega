...
use crate::validation::proof_contracts::arithmetic_domains::return_ranges::{
...
fn selected_const_call_result(
    ...
    let (return_type, minimum, maximum) =
        crate::validation::proof_contracts::contract_entailment::selected_const_call_result_bounds(
            program,
            walk.machine,
            walk.state,
            expression,
