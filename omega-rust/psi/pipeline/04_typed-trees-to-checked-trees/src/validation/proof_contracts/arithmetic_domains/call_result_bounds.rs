...
fn project(
    ...
    formal: Option<&symbol_resolved_trees_to_typed_trees::typed_trees::signature::StateParameter>,
) -> Interval {
    ...
    let result = |expression| {
        if let Some(parameter) = formal {
            ...
            crate::validation::reserved_result_owner(program, expression).is_some_and(
