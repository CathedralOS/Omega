...
pub(crate) fn check_range_under_non_exact_domain(
    ...
    owner: crate::validation::value_custody::type_references::TypeReferenceOwner<'_>,
...
fn closed_range_interval(
    ...
    let minimum = crate::validation::closed_integer_range_bound(program, minimum)?;
    let maximum = crate::validation::closed_integer_range_maximum(program, maximum, end_inclusive)?;
...
fn dependent_maximum_substituted(
    program: &TypedTrees,
    maximum: symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionHandle,
    end_inclusive: bool,
) -> Option<i64> {
