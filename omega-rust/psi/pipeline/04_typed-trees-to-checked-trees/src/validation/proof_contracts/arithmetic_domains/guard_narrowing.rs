...
mod arrivals;
use crate::validation::proof_contracts::arithmetic_domains::float_arithmetic::{
...
use crate::validation::proof_contracts::bound_expression_meaning as meaning;
mod case_facts;
...
pub(crate) fn incoming_guard_environments(
    program: &TypedTrees,
    machine: &Machine,
    frames: Option<&crate::validation::CallFrameResolver>,
