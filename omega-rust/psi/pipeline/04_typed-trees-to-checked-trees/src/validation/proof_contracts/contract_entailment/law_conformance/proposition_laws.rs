...
pub(crate) fn check_proposition_law_conformance(
    ...
    proposition_laws: &[&symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionApplication],
    proven_propositions: &[&symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionApplication],
    ...
    for law in proposition_laws {
        ...
        if program.symbols.get(law.proposition).kind == symbols::SymbolKind::PropositionParameter {
            ...
            let symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceNode::Named { symbol, name } =
        ...
        } else if let symbol_resolved_trees_to_typed_trees::typed_trees::proposition::NormalizedPropositionFormula::Boolean {
        ...
        } = &expected_formula
        {
            proven_propositions.iter().any(|proven| {
                matches!(
                    ...
                    Some(symbol_resolved_trees_to_typed_trees::typed_trees::proposition::NormalizedPropositionFormula::Boolean {
                        label,
...
pub(crate) fn synthesize_indexed_law_binder_labels(
    program: &TypedTrees,
    authored_law: &symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionApplication,
    instantiated_law: &symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionApplication,
    requirement: &StateSignature,
    entry_state: &symbol_resolved_trees_to_typed_trees::typed_trees::state::State,
) -> Option<Vec<String>> {
...
fn generic_type_argument_handles(
    ...
    match program.type_reference_table.type_reference(type_reference) {
        ...
        symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceNode::Generic { arguments, .. } => Some(
            program
