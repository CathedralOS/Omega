        ...
        match role {
            ...
            3 => {
                ...
                fixture.program.expression_table.push_name_path_member(
                    &mut path.members,
                    symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier::generated_static("other"),
                );
            }
            _ => {
                path.members = arena::HandleSpan::empty();
                for spelling in ["self", "field"] {
                    fixture.program.expression_table.push_name_path_member(
                        &mut path.members,
                        symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier::generated_static(spelling),
                    );
                }
            }
        }
