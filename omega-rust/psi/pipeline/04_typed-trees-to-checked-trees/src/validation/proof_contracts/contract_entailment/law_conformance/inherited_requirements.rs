...
use crate::validation::proof_contracts::contract_entailment::law_conformance::proposition_laws::synthesize_indexed_law_binder_labels;
use crate::validation::proof_contracts::contract_entailment::{
    StateSignature, TraitDefinition, TypedTrees,
};
...
pub fn inherited_requirement_proposition_application(
    ...
    satisfier_state: &symbol_resolved_trees_to_typed_trees::typed_trees::state::State,
...
pub fn inherited_satisfier_parameters<'a>(
    ...
    trait_definition: &TraitDefinition,
    requirement: &StateSignature,
    satisfier_state: &'a symbol_resolved_trees_to_typed_trees::typed_trees::state::State,
    ...
    if trait_definition.is_boundary
        ...
        && actual.first().is_some_and(|parameter| {
            let label = crate::validation::value_custody::type_references::type_reference_label(
                program,
