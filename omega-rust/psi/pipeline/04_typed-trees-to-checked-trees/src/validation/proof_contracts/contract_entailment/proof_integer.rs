        ...
        match program.type_reference_table.type_reference(reference) {
            ...
            TypeReferenceNode::Named { symbol, name } => {
                ...
                return name.as_str() == "Nat"
                    ...
                    && crate::validation::machine_calls::effect_inference::plan_scope::data_definition_by_symbol(program, *symbol)
                        .is_some_and(|data| {
...
pub(crate) fn proof_integer_expression(program: &TypedTrees, expression: ExpressionHandle) -> bool {
    match program.expression_table.expression(expression) {
        ...
        .is_some_and(|reference| proof_builtin_type(program, reference, symbols::BuiltinType::Int)),
    }
}
