...
use crate::validation::proof_contracts::contract_entailment::structural_terms::{
...
pub fn transparent_proposition_application_entailed(
    ...
    goal: &symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionApplication,
) -> bool {
    fn equation(
        program: &TypedTrees,
        ...
        fn argument_term(
                ...
                .type_reference(state.return_type)
            {
                ...
                symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceNode::Generic { base_symbol, .. } => *base_symbol,
