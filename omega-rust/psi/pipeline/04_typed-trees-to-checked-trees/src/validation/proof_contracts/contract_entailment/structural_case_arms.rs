...
use crate::validation::proof_contracts::contract_entailment::is_arm_pattern_marker;
use crate::validation::proof_contracts::contract_entailment::self_induction::intake_available_self_induction_hypotheses;
...
use crate::validation::proof_contracts::contract_entailment::structural_terms::structural_term;
...
pub(crate) fn recognize_guarded_structural_value_arms(
    ...
    let branch = |transition: &symbol_resolved_trees_to_typed_trees::typed_trees::statement::TableTransition| {
