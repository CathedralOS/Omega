...
use crate::validation::proof_contracts::contract_entailment::law_conformance::proposition_laws::{
    bindings_are_forall_general, check_proposition_law_conformance,
};
use crate::validation::proof_contracts::contract_entailment::law_conformance::slot_bindings::{
...
pub(crate) fn check_law_conformance(
    ...
    explicit_trait_arguments: &[symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceHandle],
