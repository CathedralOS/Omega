...
pub(crate) fn check_operator_contract_conformance(
    ...
    let operator_identity =
        symbol_resolved_trees_to_typed_trees::typed_trees::operator::boundary_operator_requirement_identity(program, operator);
    ...
    let collect = |contracts: &[symbol_resolved_trees_to_typed_trees::typed_trees::signature::SignatureContract],
...
fn operator_crash_bucket(
    program: &TypedTrees,
    contracts: &[symbol_resolved_trees_to_typed_trees::typed_trees::signature::SignatureContract],
    cause: symbol_resolved_trees_to_typed_trees::typed_trees::signature::CrashCause,
