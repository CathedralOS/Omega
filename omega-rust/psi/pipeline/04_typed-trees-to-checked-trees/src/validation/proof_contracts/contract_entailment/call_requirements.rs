...
pub fn structural_call_requirement_entailed(
    ...
    if !crate::validation::machine_calls::calls::named_state_transition_subgraph_is_acyclic(
...
fn intake_state_induction(
    ...
    if !crate::validation::machine_calls::calls::proof_call_has_structural_descent(
