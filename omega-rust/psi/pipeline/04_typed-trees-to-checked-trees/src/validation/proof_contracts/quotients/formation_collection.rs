...
use crate::validation::proof_contracts::quotients::ValidatedQuotientFormation;
use crate::validation::proof_contracts::quotients::carrier_fence::{
    CarrierFenceViolation, first_forbidden_carrier_content,
};
use crate::validation::proof_contracts::quotients::equivalence_selection::{
        ...
        for state in program.machine_states(machine) {
            ...
            match relation_plan::derive_direct_terminal_plan(
                ...
                Ok(plan) => {
                    ...
                    if request.kind == symbol_resolved_trees_to_typed_trees::typed_trees::expression::QuotientOperationKind::Lift
...
fn operation_name(
    kind: symbol_resolved_trees_to_typed_trees::typed_trees::expression::QuotientOperationKind,
) -> &'static str {
    match kind {
        symbol_resolved_trees_to_typed_trees::typed_trees::expression::QuotientOperationKind::Lift => "lift",
        symbol_resolved_trees_to_typed_trees::typed_trees::expression::QuotientOperationKind::Define => "define",
    }
}
