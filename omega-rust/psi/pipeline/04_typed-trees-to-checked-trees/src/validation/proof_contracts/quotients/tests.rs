...
use crate::validation::proof_contracts::quotients::carrier_fence::CarrierFenceViolation;
use symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees;
use symbol_resolved_trees_to_typed_trees::typed_trees::data::{
    DataDefinition, DataField, DataMember,
};
use symbol_resolved_trees_to_typed_trees::typed_trees::domain::{
    ...
    program
        ...
        .insert(ExpressionNode::Call(TableCallExpression {
            ...
            quotient_operation: Some(QuotientOperationRequest {
                ...
                theorem_evidence: vec![symbol_resolved_trees_to_typed_trees::typed_trees::expression::QuotientTheoremSelection {
                    role: symbol_resolved_trees_to_typed_trees::typed_trees::expression::QuotientTheoremRole::Congruence,
