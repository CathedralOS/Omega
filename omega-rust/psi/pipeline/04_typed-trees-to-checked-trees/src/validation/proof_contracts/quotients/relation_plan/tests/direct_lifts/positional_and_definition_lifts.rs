use crate::validation::proof_contracts::quotients::relation_plan::tests::{
...
use crate::validation::proof_contracts::quotients::relation_plan::theorem_schema::derive_expected_theorem_schema;
...
fn direct_lift_runtime_accepts_exact_nested_integer_array_literals() {
    use crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedIntegerArrayElement;
    ...
    assert_eq!(
        runtime.positions,
        [crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
            source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::NestedIntegerArray {
                    rows: Arc::from(vec![
                        Arc::from(vec![
    ...
    evidence_drift.positions[0].source = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::NestedIntegerArray {
            rows: Arc::from(vec![
...
fn direct_lift_runtime_accepts_exact_float_array_literals() {
    use crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedFloatArrayElement;
    ...
    assert_eq!(
        ...
        [
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
                source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                    crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::FloatArray {
    ...
    format_drift.positions[0].source = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::FloatArray {
            elements: Arc::from(vec![
                ClosedFloatArrayElement {
                    spelling: "1.25".to_owned(),
...
fn direct_lift_runtime_accepts_exact_nested_float_array_literals() {
    ...
    assert_eq!(
        ...
        [crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
            source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::NestedFloatArray {
                    rows: Arc::from(vec![
                        Arc::from(vec![
...
fn direct_lift_literal_fences_mismatched_and_unadmitted_values() {
    ...
    for (position, (expression, target, expected)) in cases.iter().copied().enumerate() {
        assert_eq!(
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::closed_lift_literal_for_representative(&program, expression, target, position,),
            Err(expected),
        );
    }
    ...
    {
        assert_eq!(
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::closed_lift_literal_for_representative(
                &program,
                expression,
                target,
                position + 6,
    ...
    for (position, target) in [
        ...
        assert_eq!(
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::closed_lift_literal_for_representative(&program, string, target, position),
    ...
    assert_eq!(
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::closed_lift_literal_for_representative(&program, array, bool_type, 12),
    ...
    for (position, target) in [(16, constrained), (17, generic)] {
        assert_eq!(
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::closed_lift_literal_for_representative(&program, cases[4].0, target, position,),
            Err(RelationPlanError::DirectLiftLiteralTargetMismatch(position)),
        );
    }
...
fn direct_lift_runtime_duplication_can_exceed_public_arity_without_granting_mutable_execution() {
    ...
    assert!(runtime.positions.iter().all(|position| position.source
        == crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::PublicParameter(public_symbol)));
    assert_eq!(
