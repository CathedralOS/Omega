...
use symbol_resolved_trees_to_typed_trees::typed_trees::domain::{
    DomainAliasDefinition, DomainDefinition,
};
...
pub(super) fn first_forbidden_carrier_content(
    ...
    match program.type_reference_table.type_reference(type_reference) {
        TypeReferenceNode::Named { symbol, name } => {
            ...
            ) && (parameter.bounds.multiplicity != language_semantics::Multiplicity::Unrestricted
        ...
        TypeReferenceNode::Generic {
            ...
            for (parameter, argument) in program.data_type_parameters(definition).iter().zip(
                ...
                if matches!(parameter.kind, symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameterKind::Type)
