...
use crate::validation::proof_contracts::quotients::relation_plan::theorem_schema::{
...
use symbol_resolved_trees_to_typed_trees::typed_trees::expression::{
    QuotientTheoremRole, StaticSymbolApplication,
};
...
fn direct_plan_retains_exact_input_and_result_quotient_identities() {
    ...
    assert_eq!(
        ...
        Some(
            crate::validation::proof_contracts::quotients::relation_plan::theorem::SelectedTheoremTermination {
    ...
    assert_eq!(
        congruence.purity,
        Some(
            crate::validation::proof_contracts::quotients::relation_plan::theorem::SelectedTheoremPurity {
                machine_symbol: symbol(700),
                state_symbol: symbol(701),
            }
        )
