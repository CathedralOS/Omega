...
pub(in crate::validation::proof_contracts::quotients) struct VerifiedForwardPreconditionTransportSchema
{
    pub(super) role:
        symbol_resolved_trees_to_typed_trees::typed_trees::expression::QuotientTheoremRole,
...
pub(super) fn verify_forward_precondition_transport_schema(
    ...
    Ok(VerifiedForwardPreconditionTransportSchema {
        role: symbol_resolved_trees_to_typed_trees::typed_trees::expression::QuotientTheoremRole::ForwardPreconditionTransport,
