...
fn direct_lift_duplication_shares_each_side_value_without_collapsing_legality_coordinates() {
    ...
    let runtime = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimeCorrespondence {
        positions: vec![
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
                source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::PublicParameter(public_symbol),
    ...
    let verified_theorem = crate::validation::proof_contracts::quotients::relation_plan::theorem_schema_verification::VerifiedTheoremSchema {
        ...
        parameters: expected_theorem
            ...
            .map(|(expected_position, _)| {
                crate::validation::proof_contracts::quotients::relation_plan::theorem_schema_verification::VerifiedTheoremParameter {
                    expected_position,
        ...
        relation_premises: expected_theorem
            ...
            .enumerate()
            .map(
                |(expected_position, _)| crate::validation::proof_contracts::quotients::relation_plan::theorem_schema_verification::VerifiedTheoremFact {
                    expected_position,
    ...
    tampered_runtime.positions[1].source =
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::PublicParameter(unused_public_symbol);
    assert_eq!(
...
fn direct_lift_runtime_rung_accepts_subsets_permutations_and_duplicates_but_rejects_adaptation() {
    ...
    assert_eq!(
        ...
        [
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
                source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::PublicParameter(right_symbol),
                representative_parameter: representative.parameters[0].symbol,
            },
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
                source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::PublicParameter(left_symbol),
...
fn direct_lift_runtime_accepts_only_closed_exact_scalar_literals() {
        ...
        [
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
                source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                    crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::Boolean(true),
                ),
                representative_parameter: symbol(100),
            },
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
                source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                    crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::Integer {
                        spelling: "7".to_owned(),
    ...
    spelling_drift.positions[1].source = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::Integer {
    ...
    landing_drift.positions[1].source = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::Integer {
            spelling: "7".to_owned(),
            landing: IntegerLanding {
                landed_type: LandedIntegerType::I8,
...
fn direct_lift_runtime_accepts_explicit_and_target_landed_float_literals() {
    ...
    assert_eq!(
        ...
        [
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
                source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                    crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::Float {
    ...
    let mut spelling_drift = runtime.clone();
    spelling_drift.positions[0].source = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::Float {
...
fn direct_lift_runtime_accepts_exact_shared_and_bounded_byte_string_literals() {
    ...
    assert_eq!(
        ...
        [
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
                source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                    crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::ByteString {
    ...
    bytes_drift.positions[0].source = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::ByteString {
...
fn direct_lift_runtime_accepts_exact_fixed_byte_array_literals() {
    ...
    assert_eq!(
        ...
        [crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
            source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::FixedByteArray {
...
fn direct_lift_runtime_accepts_exact_nested_fixed_byte_array_literals() {
    ...
    assert_eq!(
        ...
        [crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
            source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::NestedFixedByteArray {
                    rows: Arc::from(vec![
                        Arc::from(&[0, 127, 255][..]),
                        Arc::from(&[3, 2, 1][..]),
                    ]),
    ...
    row_boundary_drift.positions[0].source = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::NestedFixedByteArray {
            rows: Arc::from(vec![
                Arc::from(&[0, 127][..]),
                Arc::from(&[255, 3, 2, 1][..]),
...
fn direct_lift_runtime_accepts_exact_boolean_array_literals() {
    ...
    assert_eq!(
        ...
        [crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
            source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::BooleanArray {
    ...
    order_drift.positions[0].source = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::BooleanArray {
...
fn direct_lift_runtime_accepts_exact_nested_boolean_array_literals() {
    ...
    assert_eq!(
        ...
        [crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
            source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::NestedBooleanArray {
                    rows: Arc::from(vec![
...
fn direct_lift_runtime_accepts_exact_boolean_tensor3_literals() {
    ...
    assert_eq!(
        ...
        [crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
            source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::BooleanTensor3 {
                    planes: Arc::from(vec![
                        Arc::from(vec![
                            Arc::from(&[true, false][..]),
                            Arc::from(&[false, true][..]),
    ...
    grouping_drift.positions[0].source = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::BooleanTensor3 {
            planes: Arc::from(vec![
...
fn direct_lift_runtime_accepts_remaining_recursive_primitive_arrays() {
    use crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::{
        ...
        expected.into_iter().zip(&runtime.positions).enumerate()
    {
        let crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::RecursivePrimitiveArray {
                elements,
                target_type,
            },
        ) = &actual.source
    ...
    assert!(matches!(
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::closed_lift_literal_for_representative(&program, float_matrix, float_matrix_type, 5,),
        Ok(Some(
...
fn direct_lift_runtime_accepts_exact_integer_array_literals() {
    ...
    assert_eq!(
        ...
        [
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftRuntimePosition {
                source: crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
                    crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::IntegerArray {
