...
fn representative_termination_retains_only_unconditional_checked_summary() {
    ...
    assert_eq!(
        ...
        Some(crate::validation::proof_contracts::quotients::relation_plan::representative::RepresentativeTermination {
...
fn representative_purity_consumes_shared_recursive_effect_summaries() {
    ...
    assert_eq!(
        ...
        Some(crate::validation::proof_contracts::quotients::relation_plan::representative::RepresentativePurity {
    ...
    let unresolved_operational = crate::validation::infer_operational_may(&unresolved_program);
    let unresolved_reaches =
        crate::validation::infer_service_reaches(&unresolved_program, &unresolved_operational);
    assert_eq!(
...
fn define_preconditions_require_one_exact_alpha_renamed_bijection() {
    ...
    let partition = crate::validation::proof_contracts::quotients::relation_plan::precondition::RepresentativePreconditionPartition {
    ...
    let correspondence = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DefineRuntimeCorrespondence {
        positions: vec![
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DefineRuntimePosition {
    ...
    let redirected = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DefineRuntimeCorrespondence {
        positions: vec![
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DefineRuntimePosition {
                public_parameter: public_left,
                representative_parameter: representative_right,
