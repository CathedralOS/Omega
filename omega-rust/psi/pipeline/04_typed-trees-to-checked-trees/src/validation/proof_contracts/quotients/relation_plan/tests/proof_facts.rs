...
fn direct_lift_q_implies_p_rejects_missing_identity_and_theorem_coordinate_tamper() {
    ...
    assert!(
        compose_lift_correspondence_certificate(
            ...
            &exact.runtime,
            &crate::validation::proof_contracts::quotients::relation_plan::correspondence_certificate::DirectLiftPreconditionImplication { rows: Vec::new() },
            &FixedRepresentativeCallPreconditions { rows: Vec::new() },
            &exact.representative_partition,
        )
        .is_none()
...
fn direct_lift_literal_stays_fixed_and_dependent_use_requires_an_exact_public_fact() {
    let fixture = direct_lift_implication_fixture(true);
    let literal = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::Boolean(true);

    let mut fixed_literal = fixture.runtime.clone();
    fixed_literal.positions[1].source = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(literal.clone());
    assert!(
        derive_direct_lift_precondition_implication(
            &fixture.program,
            &fixture.public_machine,
    ...
    dependent_literal.positions[0].source = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(literal);
    assert_eq!(
        derive_direct_lift_precondition_implication(
            &fixture.program,
            &fixture.public_machine,
...
fn direct_lift_literal_substitutes_exactly_inside_dependent_representative_p() {
    ...
    let verified = crate::validation::proof_contracts::quotients::relation_plan::theorem_schema_verification::VerifiedTheoremSchema {
    ...
    drifted.positions[1].source = crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::Literal(
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedLiftLiteral::Integer {
            spelling: "8".to_owned(),
            landing: IntegerLanding {
                landed_type: LandedIntegerType::I32,
...
fn proof_fact_literal_substitution_retains_value_landing_and_recursive_fact_shape() {
    use crate::validation::proof_contracts::quotients::relation_plan::proof_fact_identity::{
    ...
    let nested_integer_array_value = vec![ProofValueSubstitution::nested_integer_array(
        ...
        &[
            Arc::from(vec![
                crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedIntegerArrayElement {
                    spelling: "-1".to_owned(),
                    landing: i16_landing,
                },
                crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedIntegerArrayElement {
    ...
    let float_element = |spelling: &str| {
        crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::ClosedFloatArrayElement {
