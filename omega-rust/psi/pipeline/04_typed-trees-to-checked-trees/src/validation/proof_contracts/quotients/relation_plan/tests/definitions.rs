...
use symbol_resolved_trees_to_typed_trees::typed_trees::data::{
    DataDefinition, QuotientDefinition, TypeParameter, TypeParameterKind,
};
...
use symbol_resolved_trees_to_typed_trees::typed_trees::statement::{
    StatementNode, TableLocalData, TableTransition,
};
...
fn define_fixed_preconditions_reject_arithmetic_weakening() {
    ...
    let positions = fixture
        ...
        .iter()
        .map(|position| {
            let crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DirectLiftArgumentSource::PublicParameter(public_parameter) =
                position.source
            else {
                panic!("define fixture must use only direct public parameters")
            };
            crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DefineRuntimePosition {
                public_parameter,
    ...
    assert_eq!(
        derive_define_precondition_correspondence(
            ...
            &crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DefineRuntimeCorrespondence { positions },
        ),
...
fn define_correspondence_applies_closed_representative_type_substitution() {
    ...
    assert_eq!(
        ...
        Some(crate::validation::proof_contracts::quotients::relation_plan::precondition::RepresentativePreconditionPartition {
            dependent: Vec::new(),
            fixed: Vec::new(),
        })
    );
    ...
    assert_eq!(
        ...
        Some(crate::validation::proof_contracts::quotients::relation_plan::precondition::DefinePreconditionCorrespondence {
            dependent: Vec::new(),
            fixed: Vec::new(),
        })
    );
    assert_eq!(
        plan.define_correspondence
            ...
            .positions,
        vec![crate::validation::proof_contracts::quotients::relation_plan::runtime_correspondence::DefineRuntimePosition {
...
fn derived_direct_terminal_plan_remains_non_executable() {
    ...
    crate::validation::proof_contracts::quotients::formation_collection::reject_quotient_operation_requests(
        &program,
        &program,
        &mut diagnostics,
    );
...
fn immutable_alias_fallthrough_requires_an_exact_immutable_chain() {
    ...
    assert_eq!(
        ...
        Some(crate::validation::proof_contracts::quotients::relation_plan::result_flow::ImmutableAliasFallthroughRoot {
...
fn complete_result_flow_requires_one_exact_machine_state() {
    ...
    let root = {
        ...
        assert_eq!(
            ...
            Some(crate::validation::proof_contracts::quotients::relation_plan::result_flow::CompleteSingleStateResultFlow {
...
fn complete_result_flow_accepts_exact_finite_state_forwarding() {
    ...
    let target = program.statement_table.insert_transition_target(
        symbol_resolved_trees_to_typed_trees::typed_trees::statement::TransitionTargetNode::Named {
            ...
            path: symbol_resolved_trees_to_typed_trees::typed_trees::statement::TableNamePath {
    ...
    assert_eq!(
        ...
        Some(crate::validation::proof_contracts::quotients::relation_plan::result_flow::CompleteStateForwardingResultFlow {
            machine_symbol: symbol(50),
            forwarding_edges: vec![crate::validation::proof_contracts::quotients::relation_plan::result_flow::StateForwardingEdge {
    ...
    assert_eq!(
        ...
        Some(crate::validation::proof_contracts::quotients::relation_plan::result_flow::CompleteStateForwardingResultFlow {
            ...
            forwarding_edges: vec![
                crate::validation::proof_contracts::quotients::relation_plan::result_flow::StateForwardingEdge {
                    source_state_symbol: symbol(51),
    ...
    transition.continuation = symbol_resolved_trees_to_typed_trees::typed_trees::statement::TransitionTargetHandle::invalid();
