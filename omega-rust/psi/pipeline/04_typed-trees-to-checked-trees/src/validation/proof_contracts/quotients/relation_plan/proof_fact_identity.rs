...
fn membership_arguments_match(
    program: &TypedTrees,
    left: &symbol_resolved_trees_to_typed_trees::typed_trees::domain::ProofMembershipFact,
    right: &symbol_resolved_trees_to_typed_trees::typed_trees::domain::ProofMembershipFact,
            ...
            let arms = program
                ...
                .map(|arm| {
                    let pattern = match arm.pattern {
                        ...
                        symbol_resolved_trees_to_typed_trees::typed_trees::expression::MatchPattern::Wildcard => "wildcard".to_owned(),
                    };
