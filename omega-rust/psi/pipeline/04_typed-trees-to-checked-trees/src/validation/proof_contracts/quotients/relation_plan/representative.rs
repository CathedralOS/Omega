...
use symbol_resolved_trees_to_typed_trees::typed_trees::expression::QuotientOperationRequest;
...
pub(in crate::validation::proof_contracts::quotients) struct RepresentativeTermination {
    pub(super) machine_symbol: SymbolHandle,
    pub(super) state_symbol: SymbolHandle,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::validation::proof_contracts::quotients) struct RepresentativePurity {
    pub(super) machine_symbol: SymbolHandle,
    pub(super) state_symbol: SymbolHandle,
}
...
pub(in crate::validation::proof_contracts::quotients) struct RepresentativeTelescope {
    pub(super) machine_symbol: SymbolHandle,
    pub(super) state_symbol: SymbolHandle,
...
pub(super) fn unconditional_representative_termination(
    termination: &dyn crate::validation::proof_contracts::quotients::CheckedTerminationOracle,
...
pub(in crate::validation::proof_contracts::quotients) fn pure_representative_effect(
    representative: &RepresentativeTelescope,
    ...
    crate::validation::machine_calls::denotational_calls::has_pure_effect_closure(
