...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::validation::proof_contracts::quotients) struct DirectLiftPreconditionImplication {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::validation::proof_contracts::quotients) struct FixedRepresentativeCallPreconditions {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::validation::proof_contracts::quotients) struct QuotientCorrespondenceCertificate {
...
fn integer_spelling_value(spelling: &str) -> Option<numerics::bignum::BigInt> {
...
fn theorem_evidence_is_eligible(
    ...
    role: symbol_resolved_trees_to_typed_trees::typed_trees::expression::QuotientTheoremRole,
