...
use crate::validation::proof_contracts::quotients::CORE_EQUIVALENCE_SOURCE;
...
pub(crate) fn validate_equivalence_selection(
    ...
    quotient: &symbol_resolved_trees_to_typed_trees::typed_trees::data::QuotientDefinition,
    relation: &symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionDefinition,
    ...
    if !matches!(
        conformance.subject,
        symbol_resolved_trees_to_typed_trees::typed_trees::trait_definition::ConformanceSubject::Subjectless
    ) {
        diagnostics.push(Diagnostic::error(format!(
    ...
    for row in rows {
        ...
        crate::validation::proof_contracts::contract_entailment::check_law_conformance(
            program,
            machine,
...
pub(crate) fn fact_is_exact_relation_pair(
    ...
    relation: &symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionDefinition,
    left: &symbol_resolved_trees_to_typed_trees::typed_trees::signature::StateParameter,
    right: &symbol_resolved_trees_to_typed_trees::typed_trees::signature::StateParameter,
    ...
    match fact {
        ...
        symbol_resolved_trees_to_typed_trees::typed_trees::domain::ProofFact::Expression(
            ...
            let symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionBody::Transparent {
                proposition:
                    symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionFormula::BooleanExpression(expected),
            } = relation.body
            else {
                return false;
            };
...
fn is_sealed_core_equivalence(
    ...
    let parameter_shape = matches!(
        parameters,
        [carrier, relation]
            if matches!(carrier.kind, symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameterKind::Type)
                && matches!(relation.kind, symbol_resolved_trees_to_typed_trees::typed_trees::data::TypeParameterKind::Proposition { .. })
    );
...
pub(super) fn checked_proof_dependency<'program>(
    ...
    for dependency in crate::validation::machine_calls::call_cycles::machine_call_dependency_symbols(
        program, machine,
    ) {
