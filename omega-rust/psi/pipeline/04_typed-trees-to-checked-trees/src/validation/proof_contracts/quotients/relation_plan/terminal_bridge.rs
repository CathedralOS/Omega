...
pub(in crate::validation::proof_contracts::quotients) fn canonical_direct_correspondence(
    program: &TypedTrees,
...
fn canonical_correspondence(
    ...
    if planned_theorem.role != symbol_resolved_trees_to_typed_trees::typed_trees::expression::QuotientTheoremRole::Congruence {
...
fn canonical_define_runtime_positions(
    public: &[&symbol_resolved_trees_to_typed_trees::typed_trees::signature::StateParameter],
