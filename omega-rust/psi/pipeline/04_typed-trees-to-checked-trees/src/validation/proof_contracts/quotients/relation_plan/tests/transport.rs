...
use crate::validation::proof_contracts::quotients::relation_plan::theorem_schema_verification::verify_selected_theorem_schema;
...
use symbol_resolved_trees_to_typed_trees::typed_trees::proposition::PropositionApplication;
...
fn transport_certificate_requires_exact_role_identity_and_each_eligibility_fence() {
    let fixture = transport_schema_fixture(TransportSchemaMutation::Exact);
    let verified = verify_transport_fixture(&fixture).expect("exact transport schema");
    let congruence = crate::validation::proof_contracts::quotients::relation_plan::theorem_schema_verification::VerifiedTheoremSchema {
    ...
    let exact_evidence = crate::validation::proof_contracts::quotients::relation_plan::PlannedQuotientTheoremEvidence {
        role: QuotientTheoremRole::ForwardPreconditionTransport,
        selected_application: fixture.theorem.clone(),
        termination: Some(crate::validation::proof_contracts::quotients::relation_plan::theorem::SelectedTheoremTermination {
            machine_symbol: fixture.theorem.machine_symbol,
            state_symbol: fixture.theorem.state_symbol,
        }),
        purity: Some(crate::validation::proof_contracts::quotients::relation_plan::theorem::SelectedTheoremPurity {
            machine_symbol: fixture.theorem.machine_symbol,
            state_symbol: fixture.theorem.state_symbol,
        }),
        crash_free: true,
    ...
    let certificate = compose_lift_transport_correspondence_certificate(
        ...
        &{
            ...
            evidence.termination = Some(crate::validation::proof_contracts::quotients::relation_plan::theorem::SelectedTheoremTermination {
                machine_symbol: congruence.theorem_machine_symbol,
                state_symbol: congruence.theorem_state_symbol,
            });
            evidence.purity = Some(crate::validation::proof_contracts::quotients::relation_plan::theorem::SelectedTheoremPurity {
                machine_symbol: congruence.theorem_machine_symbol,
                state_symbol: congruence.theorem_state_symbol,
            });
            evidence
    ...
    let plan =
        crate::validation::proof_contracts::quotients::relation_plan::DirectTerminalRelationPlan {
            input_relations: vec![
