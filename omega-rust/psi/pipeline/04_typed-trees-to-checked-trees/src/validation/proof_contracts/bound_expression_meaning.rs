...
pub(super) fn sealed_float_comparison(
    ...
    if !operator.is_boundary
        || !matches!(
            symbol_resolved_trees_to_typed_trees::typed_trees::operator::primitive_float_binary_semantics(program, operator),
    ...
    program
        ...
        && crate::validation::proof_contracts::float_projection_bindings::semantic_operations::
        ...
        membership_subject_matches_owner(
            ...
            |subject| {
                operand_type(program, machine, state, subject).or_else(|| {
                    ...
                    crate::validation::reserved_result_place(program, subject)
...
fn membership_subject_matches_owner(
    ...
    let Some(subject_type) = subject_type(subject).and_then(|reference| {
...
fn operand_type_at_depth(
    ...
    let reference = match program.expression_table.expression(expression) {
        ...
        ExpressionNode::Member(_)
            if crate::validation::value_custody::places::collection_length_receiver(
        ...
        ExpressionNode::Binary(binary) => {
            ...
            let unwrapped = crate::validation::value_custody::places::unwrapped_type_reference(
                program, carrier,
            )?;
