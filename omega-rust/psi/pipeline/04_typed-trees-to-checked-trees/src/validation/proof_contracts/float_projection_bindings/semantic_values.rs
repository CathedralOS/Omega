...
use symbol_resolved_trees_to_typed_trees::typed_trees::operator::resolve_named_expression_call;
...
fn closed_meaning(
    ...
    *remaining_work = remaining_work.checked_sub(1)?;
    ...
    if let Some((selected_operator, _, operation, _)) =
        crate::validation::proof_contracts::float_projection_invocations::exact_projection_operation(
            program, call,
        )
    {
