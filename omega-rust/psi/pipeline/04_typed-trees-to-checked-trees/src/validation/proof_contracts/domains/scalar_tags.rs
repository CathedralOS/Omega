...
use symbol_resolved_trees_to_typed_trees::typed_trees::domain::{DomainDefinition, ProofFact};
...
fn vacuous_scalar_tag(
    ...
    if !declaration.symbol.is_valid()
        ...
        || (!symbol_resolved_trees_to_typed_trees::typed_trees::domain::has_generic_carrier(
            program,
            declaration,
