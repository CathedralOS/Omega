...
pub(super) fn validate_expression(
    ...
    match program.expression_table.expression(expression) {
        ...
        ExpressionNode::Member(member) => {
            ...
            {
                if crate::validation::value_custody::places::direct_self_field_member(
                    program, expression,
...
pub(super) fn validate_statement_call_receiver(
    ...
    for member in projected {
        ...
        let Some(field) = crate::validation::value_custody::places::exact_data_member_field(
            program,
            definition,
        ...
        owner = crate::validation::value_custody::places::data_definition_for_type(
            program,
...
fn report_runtime_erased_member_by_receiver(
    ...
    let Some(definition) = receiver_type.and_then(|type_reference| {
        crate::validation::value_custody::places::data_definition_for_type(program, type_reference)
    }) else {
        return;
    };
...
fn literal_fields<'program>(
    ...
    case_name: Option<&symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier>,
