...
use symbol_resolved_trees_to_typed_trees::typed_trees::operator::{
    resolve_named_call, resolve_named_expression_call,
};
...
pub(crate) fn exact_projection_operation(
    ...
    let (primitive, contract) =
        crate::validation::proof_contracts::float_projection_bindings::exact_toolchain_float_projection_contract(
    ...
    match program.expression_table.expression(expression) {
        ...
        ExpressionNode::Call(call) => {
            ...
            if let Some(requested_operation) = requested_projection_operation(program, call) {
                ...
                if !crate::validation::value_custody::expression_types::argument_matches_type_reference_handle(
                    program,
                    *source,
