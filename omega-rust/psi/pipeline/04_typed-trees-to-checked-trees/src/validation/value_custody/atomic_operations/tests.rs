...
use terminal_psi::access_plans::{AtomicAccessOperation, BorrowPolarity};
...
fn validation_messages(source: &str) -> Vec<String> {
    match crate::validation::validate_program(&crate::validation::front_end::typed_program(source))
    {
        Ok(()) => Vec::new(),
