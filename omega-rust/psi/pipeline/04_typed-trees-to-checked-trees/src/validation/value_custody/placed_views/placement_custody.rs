...
use terminal_psi::layout_plans::{LayoutFieldEntryReport, LayoutPlacementReport};
...
fn validate_nested_record(
    ...
    schema: &symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition,
    custody: &symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition,
    outer_field: &DataField,
    nested_schema: &symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition,
...
fn validate_nested_record_at_path(
    program: &TypedTrees,
    conformance: &symbol_resolved_trees_to_typed_trees::typed_trees::trait_definition::Conformance,
    root_schema: &symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition,
    custody: &symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition,
    outer_field: &DataField,
    nested_schema: &symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition,
    custody_field: Option<&DataField>,
...
fn exact_layout_entry<'plan>(
    plan: &'plan symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::PlacedViewPlan,
    field: &DataField,
...
fn canonical_path(
    owner: &symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition,
    field: &DataField,
) -> String {
...
fn fixed_type_layout(
    ...
    match program.type_reference_table.type_reference(type_reference) {
        TypeReferenceNode::Named { symbol, .. } => {
            if let Some(primitive) = crate::validation::value_custody::recasts::exact_primitive_type(
                program,
                type_reference,
            ) {
...
mod tests {
    ...
    use symbol_resolved_trees_to_typed_trees::typed_trees::data::{DataDefinition, DataField};
