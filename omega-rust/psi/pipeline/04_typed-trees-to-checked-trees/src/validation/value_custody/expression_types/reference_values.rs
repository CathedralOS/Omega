...
use symbol_resolved_trees_to_typed_trees::typed_trees::types::{
    FixedArrayLength, TypeConstraintNode,
};
...
fn selected_value_type(
    ...
    match program.expression_table.expression(expression) {
        ...
        ExpressionNode::Member(member) => {
            ...
            {
                return crate::validation::value_custody::places::exact_self_field(
        ...
        ExpressionNode::Indexed(indexed) => {
            ...
            let meaning_is_builtin = if let Some(machine) =
                place_machine_symbol(program, indexed.collection)
            {
                ...
                crate::validation::value_custody::places::has_retained_builtin_index_meaning(
                    program, expression,
                ) || {
