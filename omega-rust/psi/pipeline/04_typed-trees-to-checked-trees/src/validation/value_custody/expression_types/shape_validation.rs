...
pub(crate) fn report_array_scalar_shape_mismatch(
    ...
    if crate::validation::value_custody::literals::validate_constant_projection_destination(
        program,
        machine.symbol,
        value,
        target_type,
...
fn argument_collection_element(
    ...
    {
        return crate::validation::value_custody::places::declared_place_type(
            program,
            machine,
            state,
            indexed.collection,
    ...
    crate::validation::value_custody::places::declared_place_type(program, machine, state, handle)
        .and_then(|type_reference| collection_element(program, type_reference))
}
