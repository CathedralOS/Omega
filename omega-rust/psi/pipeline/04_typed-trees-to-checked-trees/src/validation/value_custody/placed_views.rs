...
use terminal_psi::access_plans::{AccessExposure, AtomicPermissions, FieldAccess};
...
) -> Option<&'program symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::PlacedFieldPlan>
{
...
fn placed_view_field_for_place<'program>(
    ...
    &'program symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::PlacedViewPlan,
    &'program symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::PlacedFieldPlan,
)> {
    let type_reference = crate::validation::value_custody::places::declared_place_type(
        program,
        machine,
        Some(state),
        place,
...
fn placed_view_field_for_statement_call<'program>(
    ...
    placed_view_field_for_call_target(program, call.target_symbol).or_else(|| {
        let receiver = program
            ...
            .collect::<Vec<_>>();
        let type_reference = crate::validation::value_custody::places::declared_member_path_type(
            program,
            machine,
            Some(state),
            &receiver,
...
fn validate_binding_private_use(
    program: &TypedTrees,
    machine: &Machine,
    view: &symbol_resolved_trees_to_typed_trees::typed_trees::typed_trees::PlacedViewPlan,
...
mod tests {
    ...
    use terminal_psi::access_plans::AtomicPermissions;
