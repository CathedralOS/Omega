...
fn type_representation(
    ...
    let phantom_lifetime_shell =
        crate::validation::value_custody::recasts::record_eligibility::direct_phantom_lifetime_record_symbol(
            program,
            type_reference,
        );
    ...
    match program.type_reference_table.type_reference(type_reference) {
        ...
        TypeReferenceNode::Generic { .. }
            if allow_lifetime_shell
                ...
                && budget.lifetime_shell_depth < crate::validation::value_custody::recasts::record_eligibility::MAX_RECAST_PHANTOM_LIFETIME_SHELL_DEPTH =>
        {
            let symbol = crate::validation::value_custody::recasts::record_eligibility::phantom_lifetime_record_symbol_shape(program, type_reference)?;
            budget.lifetime_shell_depth += 1;
