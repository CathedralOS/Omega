...
pub(in crate::validation::value_custody::literals) fn validate_numeric_tree_destination(
    program: &TypedTrees,
    ...
    while let Some(expression) = pending.pop() {
        ...
        match program.expression_table.expression(expression) {
            ...
            ExpressionNode::Binary(binary)
                if crate::validation::value_custody::literals::has_anonymous_operator_meaning(
                    program, expression,
                ) =>
            {
