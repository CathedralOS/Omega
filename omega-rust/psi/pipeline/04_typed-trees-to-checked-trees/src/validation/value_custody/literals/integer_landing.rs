...
pub fn select_anonymous_numeric_match_arm(
    ...
    for arm in arms {
        match arm.pattern {
            symbol_resolved_trees_to_typed_trees::typed_trees::expression::MatchPattern::Wildcard => return Some(arm.value),
...
pub(crate) use symbol_resolved_trees_to_typed_trees::typed_trees::closed_numeric::AnonymousNumericValue;
...
fn evaluate_anonymous_value<const ALLOW_DECIMAL_LITERALS: bool>(
    ...
    symbol_resolved_trees_to_typed_trees::typed_trees::closed_numeric::evaluate_anonymous_value::<
        ALLOW_DECIMAL_LITERALS,
    >(program, expression, selected_arms, builtin)
}

pub use symbol_resolved_trees_to_typed_trees::typed_trees::closed_numeric::has_anonymous_operator_meaning;
pub(super) use symbol_resolved_trees_to_typed_trees::typed_trees::closed_numeric::has_builtin_anonymous_operands;
