...
pub(crate) fn closed_record_integer_projection(
    program: &TypedTrees,
    expression: ExpressionHandle,
) -> Option<symbol_resolved_trees_to_typed_trees::typed_trees::closed_numeric::ClosedIntegerValue> {
    ...
    Some(
        symbol_resolved_trees_to_typed_trees::typed_trees::closed_numeric::ClosedIntegerValue {
            value: value.value,
