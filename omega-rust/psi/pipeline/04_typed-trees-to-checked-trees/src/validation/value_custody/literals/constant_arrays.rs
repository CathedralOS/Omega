...
> {
    ...
    while let Some((expression, reference, exiting)) = pending.pop() {
        ...
        match (
            ...
            {
                leaves.push((expression, symbol_resolved_trees_to_typed_trees::typed_trees::types::PrimitiveType::Bool))
            }
            (
...
pub fn builtin_constant_array_projection_type(
    ...
    for projection in projections.into_iter().rev() {
        ...
        if !symbol_resolved_trees_to_typed_trees::typed_trees::operator::resolve_indexed_spelling_for_operands(
            program,
...
pub(super) fn validate_declared_array_destination(
    ...
    let Some(destination) =
        crate::validation::value_custody::places::unwrapped_type_reference(program, destination)
    else {
        return;
    };
    for occurrence in program
...
pub(crate) fn validate_constant_projection_destination(
    ...
    while let Some((value, mut destination)) = pending.pop() {
        ...
        let Some(destination) = crate::validation::value_custody::places::unwrapped_type_reference(
            program,
            destination,
        ) else {
            continue;
    ...
    fn empty_array_comparison_peels_qualifications_but_not_reference_elements() {
        ...
        let element = program
            ...
            .insert(TypeReferenceNode::Named {
                ...
                name: symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier::generated_static("u8"),
            });
        let source = program
            .type_reference_table
        ...
        for argument in [element, element, reference] {
            ...
            let generic = program
                ...
                .insert(TypeReferenceNode::Generic {
                    ...
                    base_name: symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier::generated_static("Holder"),
