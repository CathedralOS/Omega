...
pub(crate) struct StateValueScope<'program, 'symbols> {
    ...
    pub(crate) prior_statements:
        &'symbols [symbol_resolved_trees_to_typed_trees::typed_trees::statement::StatementNode],
    ...
    pub(crate) fn expression(
        ...
        match table.expression(expression) {
            ...
            ExpressionNode::Call(call) => {
                if !crate::validation::value_custody::locals::expression_call_has_operator_namespace(
                    self.program,
                    call,
                ) {
