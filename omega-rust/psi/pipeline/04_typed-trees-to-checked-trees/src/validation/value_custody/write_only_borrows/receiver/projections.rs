...
pub(in crate::validation::value_custody::write_only_borrows) enum ProjectionAdmission {
    MembersOnly,
    LiteralIndexes,
    RuntimeIndexes,
}
...
pub(in crate::validation::value_custody::write_only_borrows) fn captured_type(
    program: &TypedTrees,
    expression: ExpressionHandle,
    roots: &[WriteOnlyRoot],
...
pub(in crate::validation::value_custody::write_only_borrows) fn projected<'roots>(
    program: &TypedTrees,
    expression: ExpressionHandle,
...
pub(in crate::validation::value_custody::write_only_borrows) fn validate_operands(
    program: &TypedTrees,
    machine: &Machine,
    state: &State,
    expression: ExpressionHandle,
