...
pub(crate) fn validate_wire_schema_call(
    ...
    match call.target.as_str() {
        symbol_resolved_trees_to_typed_trees::typed_trees::wire::WIRE_ENCODE_MACHINE_NAME => {
        ...
        symbol_resolved_trees_to_typed_trees::typed_trees::wire::WIRE_DECODE_MACHINE_NAME => {
