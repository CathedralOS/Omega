...
use symbol_resolved_trees_to_typed_trees::typed_trees::domain::DomainDefinition;
...
fn data_field<'program>(
    ...
    name: &str,
) -> Option<&'program symbol_resolved_trees_to_typed_trees::typed_trees::data::DataField> {
    loop {
...
fn is_content_scalar_embedding(program: &TypedTrees, call: &TableCallExpression) -> bool {
    crate::validation::proof_contracts::proof_embeddings::is_exact_embed_call(program, call)
}
...
fn domain_accepts_projection_carrier(
    ...
    symbol_resolved_trees_to_typed_trees::typed_trees::domain::has_generic_carrier(program, domain)
        && carrier.is_valid()
            ...
            domains.extend(
                program
                    ...
                    .filter_map(|constraint| match constraint {
                        symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeConstraintNode::Domain(domain) => Some(domain),
                        _ => None,
                    }),
            );
            domains
