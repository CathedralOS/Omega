    ...
    match program.type_reference_table.type_reference(reference) {
        ...
        TypeReferenceNode::Constrained {
            ...
            let understood = rows.iter().all(|constraint| match constraint {
                ...
                symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeConstraintNode::Named(_) => false,
            });
...
pub(crate) fn is_plain_value_domain(
    ...
    if domain.subject != symbol_resolved_trees_to_typed_trees::typed_trees::types::DomainConstraintSubject::Declared
...
fn owns_drop_hook(program: &TypedTrees, symbol: SymbolHandle) -> bool {
    crate::validation::machine_calls::effect_inference::plan_scope::memoized_owns_drop_hook(
        program, symbol,
    )
}
