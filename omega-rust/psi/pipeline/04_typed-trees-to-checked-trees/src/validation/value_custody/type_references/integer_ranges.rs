...
pub fn closed_scalar_result_range(
    ...
    Some((
        primitive,
        crate::validation::land_integer_value(&minimum, primitive)?,
        crate::validation::land_integer_value(&maximum, primitive)?,
    ))
}
...
mod policy_tests {
    ...
    fn field(spelling: &str) -> (TypedTrees, TypeReferenceHandle) {
        ...
        let typed = crate::validation::front_end::typed_program(&source);
