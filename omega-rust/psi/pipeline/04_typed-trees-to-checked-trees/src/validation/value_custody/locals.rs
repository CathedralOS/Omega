...
pub(crate) fn expression_call_has_operator_namespace(
    ...
    let symbol_resolved_trees_to_typed_trees::typed_trees::expression::ExpressionNode::Name(path) =
        table.expression(call.receiver)
    else {
        return false;
    };
...
pub(crate) fn state_value_root_is_known(
    ...
    {
        return crate::validation::value_custody::locals::state_binding_type(
            program,
            machine,
            state,
            prior_statements,
    ...
    crate::validation::value_custody::locals::state_binding_type(
        program,
        machine,
        state,
        prior_statements,
...
pub(crate) fn local_is_mutable_reference(
    program: &symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees,
    local_data: &symbol_resolved_trees_to_typed_trees::typed_trees::statement::TableLocalData,
) -> bool {
