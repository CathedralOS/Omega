...
use crate::validation::proof_contracts::proof_facts::{ProofFactOwner, validate_proof_facts};
...
use symbol_resolved_trees_to_typed_trees::typed_trees::data::{DataMember, DataShapeKind};
...
pub(crate) fn validate_data_field_types(
    ...
    for data_definition in program.data_definitions() {
        ...
        if symbols::builtin_type_symbols()
            .iter()
...
fn validate_data_default_domain(
    ...
    for fact in facts {
        ...
        let field_carrier =
            crate::validation::value_custody::places::unwrapped_type_reference(program, field_type)
                .unwrap_or(field_type);
        let domain_carrier = crate::validation::value_custody::places::unwrapped_type_reference(
            program,
            domain.target_type,
        )
...
pub fn data_requires_establishment(
    ...
    crate::validation::machine_calls::effect_inference::plan_scope::memoized_data_requires_establishment(
        program,
        definition,
...
fn validate_payload_field_names(
    data_definition: &symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition,
    variant: &symbol_resolved_trees_to_typed_trees::typed_trees::data::DataVariant,
    program: &TypedTrees,
    diagnostics: &mut Vec<Diagnostic>,
) {
    let data_members = program.data_members(data_definition);
...
fn validate_data_shape(
    ...
    match symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition::shape_kind_from_members(data_members) {
