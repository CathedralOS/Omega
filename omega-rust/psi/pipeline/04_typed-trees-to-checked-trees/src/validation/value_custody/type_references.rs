...
use crate::validation::StateSignatureOwner;
...
pub enum StaticTypeArgumentOwner<'program> {
    ...
    Data(&'program symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition),
}
...
pub(crate) fn validate_type_reference_handle_with_type_parameters(
    ...
    lifetime_parameters: &[symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier],
) {
    ...
    crate::validation::proof_contracts::arithmetic_domains::check_range_under_non_exact_domain(
        program,
        type_reference,
        owner,
        diagnostics,
...
fn validate_routed_service_carrier_placement(
    ...
    match symbol_resolved_trees_to_typed_trees::typed_trees::service::classify_exact_bound_service_carrier(program, type_reference) {
        Err(error) => {
...
fn validate_type_reference_handle_with_context(
    ...
    match program.type_reference_table.type_reference(type_reference) {
        TypeReferenceNode::Reference {
            ...
            if *access == language_semantics::ReferenceAccess::WriteOnly
...
struct TypeParameterScope<'program> {
    ...
    lifetime_parameters:
        &'program [symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier],
}
