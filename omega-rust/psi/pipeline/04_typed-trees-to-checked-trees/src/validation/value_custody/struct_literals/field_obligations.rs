...
fn validate_anonymous_element_landing(
    ...
    if crate::validation::value_custody::literals::anonymous_numeric_value(
        program,
        value,
        &mut |expression| {
...
pub(super) fn enforce_construction_field_obligations(
    ...
    for field in program.expression_table.struct_fields(literal.fields) {
        ...
        crate::validation::value_custody::expression_types::report_array_scalar_shape_mismatch(
            program,
            machine,
            Some(state),
            field.value,
        ...
        if let Some(field_primitive) = program.primitive_type_reference(field_type) {
            if crate::validation::value_custody::expression_types::report_cross_class_store(
                program,
                Some(machine),
                Some(state),
                field.value,
        ...
        } else if crate::validation::value_custody::expression_types::report_data_type_conflict(
        ...
        match construction_field_literal(program, field.value) {
            ...
            None => {
                ...
                let interval = match crate::validation::proof_contracts::arithmetic_domains::immutable_integer_expression_interval(
...
pub(crate) fn validate_array_literal_elements_for_shape(
    ...
    match program.primitive_type_reference(element_type) {
        ...
        Some(element_primitive) => {
            ...
            for element in element_handles {
                ...
                let (_, source_primitive, _) =
                    crate::validation::proof_contracts::arithmetic_domains::validate_value_range(
                        program,
                        machine,
                        Some(state),
                        *element,
        ...
        None => {
            for element in element_handles {
                crate::validation::value_custody::expression_types::report_data_type_conflict(
                    program,
                    machine,
                    Some(state),
                    *element,
...
/// literal-width gate in crate::validation::value_custody::literals.)
