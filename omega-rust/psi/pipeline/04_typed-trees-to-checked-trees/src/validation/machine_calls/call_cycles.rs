...
use crate::validation::value_custody::places::exact_data_member_field;
...
fn resolve_machine_index(
    ...
    let callee = machine
        ...
        .or_else(|| {
            crate::validation::machine_calls::calls::free_machine_entry_state(
                program,
                symbols,
                name.as_str(),
            )
...
fn proof_edge_decrease_witness(
    ...
    machine: &Machine,
    symbols: &TopLevelSymbols<'_>,
    target: &symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier,
...
fn exact_member_field<'program>(
    ...
    let data =
        crate::validation::value_custody::places::data_definition_for_type(program, receiver_type)?;
