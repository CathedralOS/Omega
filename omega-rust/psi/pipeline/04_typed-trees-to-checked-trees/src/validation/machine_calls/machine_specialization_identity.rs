...
pub fn recompute_checked_machine_specialization_commitment(
    ...
    crate::validation::validate_static_machine_call_contracts(&checked.typed, &operational)
...
fn recompute_specialization_commitment(
    ...
    let static_call_bindings = crate::validation::static_machine_call_binding_bytes(
        &checked.typed,
        operational,
        specialization,
    )
...
fn normalized_machine_identity(
    checked: &CheckedTrees,
    machine: &crate::checked_trees::machine::Machine,
) -> Option<String> {
