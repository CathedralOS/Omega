...
use crate::validation::declarations::symbols::PrefixSiteEntry;
...
pub struct LocalWriteOrigin {
    ...
    pub local_segments: Vec<crate::fact_plan::PlaceSegment>,
    ...
    pub source_segments: Vec<crate::fact_plan::PlaceSegment>,
}
...
struct CallerPrefixEvidence<'program> {
    state: Option<&'program symbol_resolved_trees_to_typed_trees::typed_trees::state::State>,
    aliases: Vec<(String, FramePlaceOrigin)>,
    divergent: Vec<(String, Vec<FramePlaceOrigin>)>,
    stored: Vec<StoredLocalOrigins>,
}
