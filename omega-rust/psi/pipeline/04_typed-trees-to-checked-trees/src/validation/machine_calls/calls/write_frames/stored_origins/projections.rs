...
pub(in crate::validation::machine_calls::calls::write_frames) fn symbolic_reference_leaves(
    program: &TypedTrees,
    machine: &Machine,
    expression: ExpressionHandle,
    expected: TypeReferenceHandle,
...
pub(in crate::validation::machine_calls::calls::write_frames) fn reference_leaves_before_statement(
    program: &TypedTrees,
    state: &State,
...
pub(in crate::validation::machine_calls::calls::write_frames) fn reference_leaves_before_statement_for_query(
    program: &TypedTrees,
    state: &State,
    before: &StatementNode,
    expression: ExpressionHandle,
...
pub(in crate::validation::machine_calls::calls::write_frames) fn project_stored_origins(
    program: &TypedTrees,
...
pub(in crate::validation::machine_calls::calls::write_frames) fn projected_type(
    program: &TypedTrees,
...
pub(in crate::validation::machine_calls::calls::write_frames) fn projected_storage_type(
    program: &TypedTrees,
...
mod tests {
    ...
    use crate::validation::machine_calls::calls::write_frames::stored_origins::StoredWriteOrigin;
    use crate::validation::machine_calls::calls::write_frames::{
        FramePathPrecision, FramePlaceOrigin, FrameSourcePlace,
    };
