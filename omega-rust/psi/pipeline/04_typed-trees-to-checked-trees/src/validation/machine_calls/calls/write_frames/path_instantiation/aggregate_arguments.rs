...
use crate::validation::machine_calls::calls::write_frames::isolation::{
    concrete_nominal_type, struct_literal_matches_expected_type,
};
use crate::validation::machine_calls::calls::write_frames::reference_origins::{
...
#[derive(Clone)]
pub(in crate::validation::machine_calls::calls::write_frames) struct ReferenceLeaf {
...
pub(in crate::validation::machine_calls::calls::write_frames) struct AggregateOrigins {
...
#[derive(Debug, Clone)]
pub(in crate::validation::machine_calls::calls::write_frames) struct AggregateMove {
    pub local_segments: Vec<PlaceSegment>,
...
pub(in crate::validation::machine_calls::calls::write_frames) type ReferenceResolver<'resolver> =
    dyn Fn(
            ExpressionHandle,
            TypeReferenceHandle,
            bool,
...
pub(in crate::validation::machine_calls::calls::write_frames) type AggregateResolver<'resolver> =
    dyn Fn(ExpressionHandle, TypeReferenceHandle, &FrameInference) -> Option<AggregateOrigins>
        + 'resolver;

pub(in crate::validation::machine_calls::calls::write_frames) fn reference_leaves(
    program: &TypedTrees,
    caller_machine: &Machine,
    argument: ExpressionHandle,
    expected_type: TypeReferenceHandle,
...
pub(in crate::validation::machine_calls::calls::write_frames) fn reference_leaves_with_origins(
    program: &TypedTrees,
    caller_machine: &Machine,
    argument: ExpressionHandle,
    expected_type: TypeReferenceHandle,
