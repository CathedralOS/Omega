...
fn assignment_copies_primitive_referent(
    ...
    let Some(source) = crate::validation::value_custody::places::declared_place_type_raw(
        program,
        machine,
        Some(state),
        assignment.value,
...
pub fn state_reference_parameter_binding_is_stable(
    ...
    program
        ...
        .all(|statement| {
            ...
            if let symbol_resolved_trees_to_typed_trees::typed_trees::statement::StatementNode::Assignment(assignment) = statement
...
pub(super) fn assignment_replaces_untracked_reference(
    ...
    let Some(reference) = crate::validation::value_custody::places::declared_place_type_raw(
        program,
        machine,
        Some(state),
        assignment.target,
