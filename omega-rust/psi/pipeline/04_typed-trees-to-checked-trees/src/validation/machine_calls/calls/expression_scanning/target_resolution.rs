...
use symbol_resolved_trees_to_typed_trees::typed_trees::expression::TableCallExpression;
...
pub(super) fn report_unresolved_value_call(
    ...
    if symbol_resolved_trees_to_typed_trees::typed_trees::operator::resolve_named_expression_call(
        program, call,
    )
    .is_some()
    {
