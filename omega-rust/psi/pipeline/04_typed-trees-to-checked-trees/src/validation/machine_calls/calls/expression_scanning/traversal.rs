...
pub(crate) fn validate_value_position_calls(
    ...
    transition_values: &crate::validation::declarations::transitions::TransitionValueEnvironments,
...
fn unknown_field_read_reports(
    ...
    if let Some(field_name) =
        crate::validation::value_custody::places::direct_self_field_member(program, expression)
        && let Some(data) =
    ...
    if let Some((container, member)) =
        crate::validation::value_custody::places::first_unknown_nested_field(
            program,
            machine,
            Some(state),
            expression,
...
fn scan_expression_calls_at_position(
    ...
    if let Some((receiver, access)) = primitive_access
        && let Some(receiver_type) = crate::validation::value_custody::places::declared_place_type(
            program,
            machine,
            Some(state),
            receiver,
    ...
    match program.expression_table.expression(expression) {
        ExpressionNode::Match(dispatch) => {
            crate::validation::value_custody::expression_types::validate_match_dispatch(
                program,
                machine,
                state,
                expression,
            ...
            for arm in program.expression_table.match_arms(dispatch.arms) {
                let selected = match arm.pattern {
                    symbol_resolved_trees_to_typed_trees::typed_trees::expression::MatchPattern::Wildcard => Some(true),
                    symbol_resolved_trees_to_typed_trees::typed_trees::expression::MatchPattern::Value(pattern) => {
                        ...
                        match (
                            ...
                            _ => {
                                crate::validation::value_custody::literals::evaluate_anonymous_numeric_equality(
                                    program,
                                    dispatch.subject,
                                    pattern,
                                    |expression| {
        ...
        ExpressionNode::Call(call) => {
            ...
            if crate::validation::proof_contracts::proof_embeddings::is_exact_embed_call(
                ...
                crate::validation::proof_contracts::arithmetic_domains::validate_total_specification_arithmetic(
                    program,
                    machine,
                    Some(state),
                    expression,
            ...
            if call.receiver.is_valid()
                && !crate::validation::value_custody::locals::expression_call_has_operator_namespace(program, &call)
                && !crate::validation::machine_calls::calls::generic_requirement::expression_conformance_receiver(
                    program,
                    machine,
                    call.receiver,
                )
        ...
        ExpressionNode::Binary(binary) => {
            ...
            crate::validation::value_custody::expression_types::validate_binary_operand_types(
                program,
                machine,
                Some(state),
                binary.operator,
        ...
        ExpressionNode::Cast(cast) => {
            ...
            crate::validation::value_custody::expression_types::validate_cast_types(
                program,
                machine,
                Some(state),
                cast,
            ...
            if executes {
                crate::validation::proof_contracts::arithmetic_domains::validate_range_cast_at_use(
                    program,
                    machine,
                    state,
                    expression,
        ...
        ExpressionNode::Unary(unary) => {
            match unary.operator {
                symbol_resolved_trees_to_typed_trees::typed_trees::expression::UnaryOperator::BitwiseNot => {
                    crate::validation::value_custody::expression_types::report_non_integer_bitwise_not(
                        program,
                        machine,
                        Some(state),
                        unary.operand,
                ...
                symbol_resolved_trees_to_typed_trees::typed_trees::expression::UnaryOperator::LogicalNot => {
                    crate::validation::value_custody::expression_types::report_non_bool_logical_not(
                        program,
                        machine,
                        Some(state),
                        unary.operand,
