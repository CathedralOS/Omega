...
use crate::validation::machine_calls::calls::write_frames::alias_origins::stable_alias_initializer_origins;
use crate::validation::machine_calls::calls::write_frames::assignment_targets::{
...
use crate::validation::machine_calls::calls::write_frames::call_targets;
use crate::validation::machine_calls::calls::write_frames::call_targets::{
    discarded_primitive_internal_call_is_relationally_neutral, machine_state_by_symbol,
};
use crate::validation::machine_calls::calls::write_frames::call_trees::parameter_relative_expression_preserves_transparent_result;
...
use crate::validation::machine_calls::calls::write_frames::isolated_initializers::isolated_local_initializer_preserves_transparent_result;
...
use crate::validation::machine_calls::calls::write_frames::parameter_aliases::{
    ParameterRelativeFrameOrigin, parameter_relative_alias_position,
};
use crate::validation::machine_calls::calls::write_frames::parameter_relative_origins::parameter_relative_place_or_carrier_origins;
use crate::validation::machine_calls::calls::write_frames::parameter_relative_origins::parameter_relative_place_origin;
use crate::validation::machine_calls::calls::write_frames::parameter_relative_origins::parameter_relative_place_origins;
use crate::validation::machine_calls::calls::write_frames::parameter_relative_origins::single_parameter_relative_origin;
...
use crate::validation::machine_calls::calls::write_frames::type_capabilities::type_reference_is_reference;
use crate::validation::machine_calls::calls::write_frames::value_expressions::{
        ...
        let result = match tail {
            ...
            StatementNode::Transition(transition)
                if transition.exit == symbol_resolved_trees_to_typed_trees::typed_trees::statement::TransitionExit::Ordinary
                    ...
                    && matches!(
                        transition.guard,
                        symbol_resolved_trees_to_typed_trees::typed_trees::statement::TransitionGuardNode::Always
                    ) =>
            {
                let symbol_resolved_trees_to_typed_trees::typed_trees::statement::TransitionTargetNode::Value(result) =
