...
pub(super) fn validate_requirement_call_arguments(
    ...
    requirement: &crate::validation::declarations::traits::GenericBoundRequirement<'_>,
    ...
    validate_call_arguments_with_type_correspondence(
        ...
        false,
        |argument, required| {
            let raw_actual = crate::validation::value_custody::places::declared_place_type_raw(
                ...
                && declared_reference_access(program, actual).is_some()
            {
                ...
                return match receiver {
                    Some(receiver) => {
                        crate::validation::declarations::traits::generic_bound_argument_matches(
                            program,
                            actual,
                            required,
                    ...
                    None => {
                        crate::validation::declarations::traits::named_conformance_argument_matches(
                            program,
                            actual,
                            required,
                            requirement,
...
pub(super) fn named_conformance_requirement<'program>(
    ...
    Option<crate::validation::declarations::traits::GenericBoundRequirement<'program>>,
    String,
> {
    ...
    for trait_definition in program.traits() {
        if crate::validation::declarations::traits::arguments_for_declaring_trait(
            program,
            carrier,
            &bound.arguments,
        ...
        for signature in program.trait_machine_signatures(trait_definition) {
            ...
            selected = Some(
                crate::validation::declarations::traits::GenericBoundRequirement {
                    signature,
                    trait_definition,
                    bound,
                },
...
pub(super) fn validate_named_conformance_arguments(
    ...
    let Some(inherited_arguments) =
        crate::validation::declarations::traits::arguments_for_declaring_trait(
            program,
            carrier,
    ...
    let requirement = crate::validation::declarations::traits::GenericBoundRequirement {
    ...
    for (argument, parameter) in arguments.iter().zip(&parameters) {
        ...
        let required = crate::validation::value_custody::places::unwrapped_type_reference(
            program,
            parameter.type_reference,
        )
        .unwrap_or(parameter.type_reference);
        if !crate::validation::declarations::traits::named_conformance_argument_matches(
            program,
            actual,
            required,
            &requirement,
...
pub fn generic_bound_call_requirement<'program>(
    ...
    Option<&'program symbol_resolved_trees_to_typed_trees::typed_trees::signature::StateSignature>,
    String,
> {
    ...
    crate::validation::declarations::traits::generic_bound_requirement_call(
        program,
        machine,
        receiver_type,
        target,
