...
use crate::validation::value_custody::struct_literals::construction_field_type;
use std::cell::RefCell;
use std::collections::HashMap;
use symbol_resolved_trees_to_typed_trees::typed_trees::TypedTrees;
use symbol_resolved_trees_to_typed_trees::typed_trees::data::DataMember;
use symbol_resolved_trees_to_typed_trees::typed_trees::expression::TableStructLiteral;
use symbol_resolved_trees_to_typed_trees::typed_trees::name::Identifier;
use symbol_resolved_trees_to_typed_trees::typed_trees::type_identity::NormalizedTypeIdentity;
...
type DefinitionVerdicts =
    HashMap<*const symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition, bool>;
...
thread_local! {
    static ISOLATION_CACHE: RefCell<
        Option<(symbol_resolved_trees_to_typed_trees::typed_trees::ProgramIdentity, usize, IsolationCache)>,
...
pub(super) fn definitions_for_symbol(
    program: &TypedTrees,
    symbol: SymbolHandle,
) -> Vec<&symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition> {
...
pub(super) fn definitions_for_name<'p>(
    ...
    name: &str,
) -> Vec<&'p symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition> {
...
pub(super) fn struct_literal_matches_expected_type(
    ...
    let Some(expected_type) =
        crate::validation::value_custody::places::unwrapped_type_reference(program, expected_type)
    else {
        return false;
    };
...
pub(super) fn data_definition_has_only_owned_storage(
    ...
    let key = definition
        as *const symbol_resolved_trees_to_typed_trees::typed_trees::data::DataDefinition;
    if let Some(verdict) =
