...
use crate::validation::machine_calls::calls::write_frames::alias_bindings::{
    rebind_stable_local_mutable_alias_origin, stable_local_mutable_alias_rebinding_is_representable,
};
use crate::validation::machine_calls::calls::write_frames::alias_origins::{
...
use crate::validation::machine_calls::calls::write_frames::assignment_targets::expression_is_effectful_indexed_place;
use crate::validation::machine_calls::calls::write_frames::boundary_calls::{
    known_boundary_call_written_paths_for_parts, known_requirement_call_written_paths_for_parts,
};
use crate::validation::machine_calls::calls::write_frames::caller_aliases::AssignmentWriteTarget;
use crate::validation::machine_calls::calls::write_frames::caller_aliases::CallOriginContext;
use crate::validation::machine_calls::calls::write_frames::caller_aliases::CallerWriteSite;
use crate::validation::machine_calls::calls::write_frames::demand::{
    collect_expression_call_written_paths, statement_value_expression_roots,
    syntactic_call_written_paths,
};
use crate::validation::machine_calls::calls::write_frames::inference::FrameInference;
use crate::validation::machine_calls::calls::write_frames::isolation::type_is_caller_isolated_local;
use crate::validation::machine_calls::calls::write_frames::known_call_written_paths_for_parts_with_origins;
use crate::validation::machine_calls::calls::write_frames::local_aliases::expression_reborrows_unresolved_reference_binding;
use crate::validation::machine_calls::calls::write_frames::permuted_cycle_frames::{
    summarize_state_written_paths_with_permuted_cycles, summarize_transition_target_written_paths,
};
use crate::validation::machine_calls::calls::write_frames::place_paths::{
    FramePathPrecision, FramePlaceOrigin, append_place_suffix, coarse_place_path, split_place_root,
};
use crate::validation::machine_calls::calls::write_frames::state_paths::{
    push_visible_frame_path, relative_state_path_is_visible,
};
use crate::validation::machine_calls::calls::write_frames::stored_origins::{
    StoredLocalOrigins, expand_write_path,
};
use crate::validation::machine_calls::calls::write_frames::transition_topology::{
    named_state_transition_subgraph_is_acyclic, named_transition_subgraph_is_acyclic,
};
use crate::validation::machine_calls::calls::write_frames::type_capabilities::{
    type_may_carry_write, type_reference_is_reference,
};
use crate::validation::machine_calls::calls::write_frames::{
...
fn walk_state_write_prefix_inner(
    ...
    if crate::validation::declarations::standard_declarations::is_core_vector_surface_state(
                        ...
                        .position(|(name, _)| name.as_str() == split_place_root(&relative).0)
                {
                        ...
                        )
                    {
                        ...
                        if !bare_name_target
                            ...
                            && crate::validation::value_custody::places::declared_place_type_raw(
                                program,
                                machine,
                                Some(state),
                                assignment.target,
