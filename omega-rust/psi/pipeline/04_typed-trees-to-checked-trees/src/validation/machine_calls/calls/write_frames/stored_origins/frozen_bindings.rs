...
use crate::validation::machine_calls::calls::write_frames::{
    FrameSourcePlace, coarse_place_path, split_place_root,
};
...
pub(in crate::validation::machine_calls::calls::write_frames) fn statement_exposes_frozen_binding(
    program: &TypedTrees,
    ...
    use crate::validation::machine_calls::calls::write_frames::statement_value_expression_roots;
...
pub(in crate::validation::machine_calls::calls::write_frames) fn call_exposes_frozen_binding(
    program: &TypedTrees,
    machine: &symbol_resolved_trees_to_typed_trees::typed_trees::machine::Machine,
    state: &symbol_resolved_trees_to_typed_trees::typed_trees::state::State,
...
pub(in crate::validation::machine_calls::calls::write_frames) fn expression_exposes_frozen_binding(
    program: &TypedTrees,
    machine: &symbol_resolved_trees_to_typed_trees::typed_trees::machine::Machine,
    state: &symbol_resolved_trees_to_typed_trees::typed_trees::state::State,
    ...
    use crate::validation::machine_calls::calls::write_frames::caller_aliases::expression_any;
...
fn receiver_allows_replacement(program: &TypedTrees, target: symbols::SymbolHandle) -> bool {
    let Some((_, state)) =
        crate::validation::machine_calls::calls::write_frames::machine_state_by_symbol(
            program, target,
        )
    else {
        return true;
...
pub(in crate::validation::machine_calls::calls::write_frames) fn assignment_replaces_case_binding(
    program: &TypedTrees,
...
pub(in crate::validation::machine_calls::calls::write_frames) fn assignment_replaces_reference_ancestor(
    program: &TypedTrees,
    assignment: &TableAssignment,
    stored: &[StoredLocalOrigins],
    aliases: &[(String, FramePlaceOrigin)],
...
pub(in crate::validation::machine_calls::calls::write_frames) fn binding_source(
    program: &TypedTrees,
    expression: ExpressionHandle,
    aliases: &[(String, FramePlaceOrigin)],
