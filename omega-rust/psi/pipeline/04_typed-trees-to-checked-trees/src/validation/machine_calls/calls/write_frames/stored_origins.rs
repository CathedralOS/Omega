...
use symbol_resolved_trees_to_typed_trees::typed_trees::statement::TableLocalData;
...
pub(super) fn declaration_origins_for_query(
    ...
    if declaration.kind != symbols::SymbolKind::Local
        ...
        || !program
            ...
            .iter()
            .any(|statement| {
                matches!(statement, symbol_resolved_trees_to_typed_trees::typed_trees::statement::StatementNode::LocalData(candidate)
