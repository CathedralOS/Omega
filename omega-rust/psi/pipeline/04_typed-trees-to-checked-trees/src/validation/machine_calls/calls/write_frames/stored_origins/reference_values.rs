...
pub(in crate::validation::machine_calls::calls::write_frames) fn canonical_reference_origins(
    program: &TypedTrees,
...
pub(in crate::validation::machine_calls::calls::write_frames) fn source_reaches_leaf(
    source: &[PlaceSegment],
    leaf: &[PlaceSegment],
) -> bool {
    source.len() >= leaf.len()
