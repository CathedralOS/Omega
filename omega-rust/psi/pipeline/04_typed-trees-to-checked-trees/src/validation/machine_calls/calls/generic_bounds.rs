...
use crate::validation::proof_contracts::properties::{
...
use crate::validation::value_custody::type_references::type_reference_label;
    ...
    callee_machine.supply_mode == language_semantics::MachineSupplyMode::TopLevelRequirement
        ...
        && program
            ...
            .all(|parameter| {
                ...
                {
                    symbol_resolved_trees_to_typed_trees::typed_trees::types::TypeReferenceNode::Named { .. } => true,
