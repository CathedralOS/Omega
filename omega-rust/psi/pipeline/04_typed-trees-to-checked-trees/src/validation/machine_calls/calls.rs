...
pub(crate) fn validate_call_node(
    ...
    // gate cannot see.
    if crate::validation::value_custody::wire::validate_wire_schema_call(
        program,
        call,
        current_machine,
        current_state,
...
fn argument_forwards_mutable_reference(
    ...
    if !crate::validation::value_custody::places::place_has_builtin_coordinates(
        program,
        current_machine,
        current_state,
        argument,
    ...
    let Some(binding_type) = crate::validation::value_custody::locals::state_binding_type(
        program,
        current_machine,
        state,
    ...
    crate::validation::value_custody::expression_types::place_forwards_mutable_reference(
        program,
        argument,
        path.symbol,
        binding_type,
...
fn validate_generic_bound_argument_types(
    ...
    for (argument, parameter) in arguments.iter().zip(parameters) {
        ...
        if !crate::validation::declarations::traits::generic_bound_argument_matches(
            program,
            actual,
            required,
            receiver,
...
fn validate_call_arguments_with_type_correspondence(
    ...
    let quotient_lift = callee_state.and_then(|state| {
        let argument_types = arguments
            ...
            .collect::<Vec<_>>();
        crate::validation::proof_contracts::quotients::legacy_quotient_call_candidate(
            program,
            None,
            &argument_types,
            state,
        ...
        .enumerate()
    {
        ...
        crate::validation::value_custody::literals::validate_constant_projection_destination(
            program,
        ...
        } else if !crate::validation::value_custody::expression_types::report_view_element_argument_mismatch(
            program,
            current_machine,
            current_state,
            *argument,
        ...
        if let Some(state) = current_state {
            crate::validation::value_custody::struct_literals::validate_array_literal_elements(
                program,
                current_machine,
                state,
                *argument,
        ...
        crate::validation::value_custody::expression_types::report_scalar_data_shape_mismatch(
            program,
            current_machine,
            current_state,
            *argument,
        ...
        if retain_arithmetic_policy {
            crate::validation::proof_contracts::domain_weakening::validate_implicit_domain_weakening_retaining_arithmetic_policy(
                program,
                current_machine,
                current_state,
                *argument,
            ...
            crate::validation::proof_contracts::domain_weakening::validate_implicit_domain_weakening(
                program,
                current_machine,
                current_state,
                *argument,
...
fn validate_value_call_argument_classes(
    ...
    if executes {
        crate::validation::proof_contracts::contract_entailment::reject_refuted_value_call_requires(
            program,
            current_machine,
            current_state,
            callee_machine,
    ...
    for (argument, parameter) in arguments.iter().zip(
        ...
        if !crate::validation::value_custody::expression_types::report_view_element_argument_mismatch(
            program,
            current_machine,
            Some(current_state),
            *argument,
