...
use crate::flow_effects::{CallOperational, MachineOperational, OperationalPlan, StateOperational};
...
fn push_call(
    ...
    target_state_symbol: SymbolHandle,
    static_machine_parameter: SymbolHandle,
    static_machine_arguments: &[symbol_resolved_trees_to_typed_trees::typed_trees::expression::StaticMachineArgument],
    target_operator_symbol: SymbolHandle,
    acknowledgement: language_semantics::CallOperationalAcknowledgement,
    statement_index: usize,
    call_ordinal: &mut usize,
...
fn signature_operational(
    ...
    for target in super::declared_signature_invocations(program, signature) {
        let service = match target {
            ...
            crate::flow_effects::InvocationTarget::Service(symbol) => Some(symbol),
        };
...
fn retain_static_machine_bindings(
    ...
    bindings: &mut arena::Arena<crate::flow_effects::StaticMachineCallBinding>,
    ...
    for (parameter, selected) in parameters.zip(selected) {
        ...
        bindings.append_to_span(
            &mut result,
            crate::flow_effects::StaticMachineCallBinding {
