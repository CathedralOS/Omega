...
use crate::validation::declarations::state_signatures::validate_callable_state_signatures;
use crate::validation::declarations::state_signatures::validate_machine_contracts;
use crate::validation::declarations::symbols::MachineSymbols;
use crate::validation::declarations::traits::validate_conformances;
use crate::validation::declarations::traits::validate_external_leaf_native_shapes;
use crate::validation::declarations::traits::validate_external_via_expression;
use crate::validation::declarations::traits::validate_generic_conformance_bounds;
use crate::validation::declarations::traits::validate_machine_trait_conformances;
use crate::validation::declarations::traits::validate_trait_conformance_bounds;
use crate::validation::declarations::traits::validate_trait_requirements;
use crate::validation::machine_calls::calls::validate_proof_machine_recursion;
...
use crate::validation::value_custody::data::validate_data_field_types;
use crate::validation::value_custody::locals::WritableRoots;
use crate::validation::value_custody::locals::validate_local_data_names;
...
pub struct ExactIntegerCastFact {
    ...
    pub source_type: symbol_resolved_trees_to_typed_trees::typed_trees::types::PrimitiveType,
    pub target_type: symbol_resolved_trees_to_typed_trees::typed_trees::types::PrimitiveType,
...
pub struct ProgramValidation {
    ...
    pub operational: crate::flow_effects::OperationalPlan,
    pub service_reaches: crate::flow_effects::ServiceReachInferencePlan,
}
...
/// [`crate::validation::admit_checked_quotient_requests`] once its termination facts
