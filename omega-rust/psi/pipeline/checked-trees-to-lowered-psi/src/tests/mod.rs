...
use checked_trees::{
    ...
    CheckedScalarExpressionRole, CheckedStructuralScalarReturnCleanupAction,
    ...
    CheckedUnitStructuralPathSegment, CheckedUnitStructuralTypeShape, ContentIdentityReshuffleFact,
...
use language_semantics::{
    Multiplicity, PermissionClaimIdentity, SemanticDomainId, ServiceReachId, ServiceReachInterface,
...
use semantic_vocabulary::{
    ...
    ContentTerm, IeeeFloatFormat, IntegerSign, IntegerType, IntegerValue, ObligationId,
    OperationId, PlaceId, Proposition, PropositionContext, ScalarTerm, ScalarType, ServiceId,
    StructuralPlaceKind, ValueId,
};
use terminal_codec::{DebugSite, DebugSubject, terminal_psi_identity};
use terminal_psi::{
    Block, BoundaryMachineResult, ByteSequenceCarrier, ContractClause, Operation, OperationKind,
    OperationResult, StructuralAccess, StructuralFieldType, StructuralMultiplicity,
    StructuralPathSegment, StructuralPlaceDeclaration, StructuralTypeShape, SuccessorEdge,
...
use crate::scalar_graph::scalar_graph_lowering::{
    prepare_scalar_graph_machine, terminal_scalar_type,
};
...
#[cfg(test)]
use crate::proofs::crash_routes::{checked_boolean_proposition, lower_checked_crash_frontier};
#[cfg(test)]
use crate::unit::attached_unit::{collect_contract_services, lower_contract_service_ceiling};
#[cfg(test)]
use crate::unit::structural_unit_control::lower_structural_unit_control_machine;
#[cfg(test)]
use crate::unit::unit_cleanup::lower_partial_affine_unit_cleanup_machine;
use language_semantics::PermissionEventSource;
use language_semantics::content::{ContentCaseSegment, ContentFieldSegment};
