...
pub(in crate::unit::attached_unit) struct LoweredSelectedStructuralScalarRealizations {
    ...
    pub(in crate::unit::attached_unit) source_calls: Vec<LoweredSourceCallOccurrence>,
}

pub(in crate::unit::attached_unit) fn lower_selected_structural_scalar_realizations(
