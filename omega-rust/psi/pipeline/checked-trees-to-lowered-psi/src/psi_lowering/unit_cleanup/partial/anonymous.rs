...
pub(crate) fn validate_permissions(
    ...
    let authored_producer = crate::psi_lowering::call_source_custody::authored::locate_source(
        checked,
        plan.state,
        *coordinate,
    )?;
    ...
    let authored_consumer = crate::psi_lowering::call_source_custody::authored::locate_source(
        checked,
        plan.state,
        *consumer_coordinate,
    )?;
