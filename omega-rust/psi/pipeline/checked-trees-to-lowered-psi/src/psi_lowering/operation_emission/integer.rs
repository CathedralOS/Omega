...
use crate::psi_lowering::obligation_id;
use numerics::{
...
pub(in crate::psi_lowering) enum LoweredIntegerComparisonKind {
    Equal,
    LessThan,
    LessOrEqual,
}
...
impl LoweredIntegerComparisonKind {
    pub(in crate::psi_lowering) const fn operation(
        self,
        left: ValueId,
        right: ValueId,
    ) -> OperationKind {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::psi_lowering) enum LoweredIntegerBinaryKind {
    BitwiseAnd,
    BitwiseOr,
    BitwiseXor,
    WrappingShiftLeft,
...
impl LoweredIntegerBinaryKind {
    pub(in crate::psi_lowering) const fn integer_policy_binding(
        self,
    ...
    pub(in crate::psi_lowering) fn formation_obligation(
        self,
    ...
    pub(in crate::psi_lowering) fn operation(
        self,
        operation: OperationId,
        left: ValueId,
        right: ValueId,
