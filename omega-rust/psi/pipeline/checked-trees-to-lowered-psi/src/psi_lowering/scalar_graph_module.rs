...
mod qualifications;
mod ranking;
use crate::psi_lowering::scalar_contracts;
...
pub(super) fn build_scalar_graph_module(
    ...
    loop_plan: Option<&crate::psi_lowering::scalar_graph_lowering::cycles::ScalarLoopPlan>,
...
pub(crate) fn build_scalar_graph_module_in_namespace(
    ...
    for index in emission_order(states) {
        ...
        crate::psi_lowering::scalar_graph_effects::emit(
    ...
    for place in crate::psi_lowering::scalar_computations::arrays::declarations(&all_operations)
        .chain(crate::psi_lowering::scalar_computations::cases::declarations(&all_operations))
        .chain(
            crate::psi_lowering::scalar_graph_lowering::structural_values::declarations(
                &all_operations,
            ),
        )
    {
