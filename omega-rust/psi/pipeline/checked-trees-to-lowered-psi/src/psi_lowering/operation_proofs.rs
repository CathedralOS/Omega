...
#[cfg(test)]
use super::{lower_machine, obligation_id};
...
fn finalize_operation_proofs_inner(
    ...
    crate::psi_lowering::scalar_block_invariants::retain_provable(lowered)?;
    ...
    crate::psi_lowering::control_cycle_proofs::finalize(lowered)?;
    Ok(())
}
