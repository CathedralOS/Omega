    ...
    let selected = match (authored, role) {
        (
            ...
            let (expression, primitive) =
                crate::psi_lowering::attached_unit::structural_values::source_custody::operand_source(
                    checked,
                    state.symbol,
                    statement,
                    role,
        ...
        ) => crate::psi_lowering::attached_unit::scalar_arrays::construction_expression(
            checked,
            machine.symbol,
            state.symbol,
            statement,
        ...
        (
            ...
            let call = crate::psi_lowering::call_source_custody::authored::locate_source(
                checked,
                state.symbol,
