...
impl ScalarBindings {
    ...
    pub(super) fn shared_structural_argument(
        ...
        Ok(StructuralArgument {
            place,
            path: crate::psi_lowering::attached_unit::lower_structural_path(&argument.path),
    ...
    pub(super) fn expression(
        ...
        crate::psi_lowering::scalar_graph_lowering::lower_checked_scalar_expression_with_parameters(
            &expression,
