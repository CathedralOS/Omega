...
pub(super) fn prepare(
    ...
    if body.result()? != checked_trees::CheckedControlResultPlan::Unit
        ...
        || !crate::psi_lowering::attached_unit::catalog::checked_unit_target_reach_matches(
            *service_reach,
    ...
    let flow_call = crate::psi_lowering::attached_unit::retain_exact_flow_call(
        checked,
        machine,
        state.state,
        *coordinate,
    ...
    let borrow = crate::psi_lowering::attached_unit::primitive_locals::borrows::call(
        checked,
        machine,
        state.state,
        *coordinate,
    ...
    let access_positions =
        crate::psi_lowering::scalar_source_custody::computation_calls::rejoin_call_accesses(
            checked,
            machine,
            state.state,
        ...
        .zip(target.structural_parameters)
    {
        ...
        let actual_position =
            crate::psi_lowering::scalar_source_custody::computation_calls::primitive_arguments::validate(
                checked,
                caller_state,
                coordinate.statement_index,
