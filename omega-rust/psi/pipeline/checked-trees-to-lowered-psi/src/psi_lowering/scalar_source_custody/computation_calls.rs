...
use crate::psi_lowering::attached_unit::primitive_locals::borrows as borrow_rows;
mod dispatch;
mod mixed_arguments;
mod operand_scopes;
mod owned_arguments;
    ...
    while let Some((handle, exiting, authored_scope)) = pending.pop() {
        ...
        match &node.kind {
            ...
            CheckedScalarComputationKind::CaseMembership {
                ...
                let fields = crate::psi_lowering::scalar_computations::cases::source::membership(
                    checked,
                    machine,
                    state,
                    *source_expression,
            ...
            CheckedScalarComputationKind::SelectedComparison {
                ...
                crate::psi_lowering::scalar_computations::comparisons::occurrence(
                    checked,
                    *operator_use,
                    machine,
                    state,
