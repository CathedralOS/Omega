...
use super::*;
use crate::psi_lowering::scalar_qualifications::declared_atoms;
...
pub(super) fn operand(
    ...
    if cast.semantic_domain.is_empty() {
        ...
        let (source_primitive, source_atoms) =
            crate::psi_lowering::scalar_qualifications::type_atoms(checked, source_type)?;
        let (result_primitive, result_atoms) =
            crate::psi_lowering::scalar_qualifications::type_atoms(checked, result_type)?;
