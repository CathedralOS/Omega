...
impl DefinitionIndex {
    ...
    pub(in crate::psi_lowering::nonzero_divisor_certificate::affine_custody) fn candidates_from(
        &self,
        input: &ScalarTerm,
        start: usize,
    ...
    pub(in crate::psi_lowering::nonzero_divisor_certificate) fn output_definitions_before(
        &self,
        output: &ScalarTerm,
        before: usize,
    ) -> &[usize] {
    ...
    pub(in crate::psi_lowering::nonzero_divisor_certificate) fn cast_roots(
        &self,
    ) -> impl Iterator<Item = &ScalarTerm> {
        self.cast_roots.iter()
    }

    pub(in crate::psi_lowering::nonzero_divisor_certificate) fn cast_spine(
        &self,
        target: &ScalarTerm,
    ...
    pub(in crate::psi_lowering::nonzero_divisor_certificate::affine_custody) fn cached_words(
        &self,
        root: &ScalarTerm,
    ) -> Option<Rc<[Vec<usize>]>> {
    ...
    pub(in crate::psi_lowering::nonzero_divisor_certificate::affine_custody) fn cache_words(
        &mut self,
        root: &ScalarTerm,
        words: Rc<[Vec<usize>]>,
    ) {
    ...
    pub(in crate::psi_lowering::nonzero_divisor_certificate::affine_custody) fn cached_words_to_target(
        &self,
        root: &ScalarTerm,
        target: &ScalarTerm,
    ) -> Option<Rc<[Vec<usize>]>> {
    ...
    pub(in crate::psi_lowering::nonzero_divisor_certificate::affine_custody) fn cache_words_to_target(
        &mut self,
        root: &ScalarTerm,
        target: &ScalarTerm,
        words: Rc<[Vec<usize>]>,
    ...
    pub(in crate::psi_lowering::nonzero_divisor_certificate::affine_custody) fn cached_literal_axioms(
        &self,
        root: &ScalarTerm,
    ...
    pub(in crate::psi_lowering::nonzero_divisor_certificate::affine_custody) fn cache_literal_axioms(
        &mut self,
        root: &ScalarTerm,
        definition_axioms: &[usize],
        target: &ScalarTerm,
    ...
    pub(in crate::psi_lowering::nonzero_divisor_certificate) fn cached_affine_proof(
        &self,
        goal: &Proposition,
    ...
    pub(in crate::psi_lowering::nonzero_divisor_certificate) fn begin_affine_proof(
        &mut self,
        goal: &Proposition,
    ) {
    ...
    pub(in crate::psi_lowering::nonzero_divisor_certificate) fn cache_affine_proof(
        &mut self,
        goal: &Proposition,
