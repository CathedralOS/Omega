...
use crate::psi_lowering::scalar_graph_lowering::direct_expression_contains_short_circuit;
use crate::psi_lowering::{LoweringError, unsupported, value_id};
use crate::psi_lowering::{scalar_computations, scalar_graph_lowering};
pub(super) use boolean::emit_boolean_expression;
use buffer::OperationBuffer;
pub(super) use calls::emit_staged_scalar_call_binding;
use calls::{CallEmissionContext, LoweredDirectCallBinding};
use expressions::LoweredDirectExpression;
pub(super) use expressions::{emit_byte_length, emit_direct_expression};
...
pub(in crate::psi_lowering) enum LoweredScalarBinding {
    SelectedComparison {
...
pub(super) fn emit_scalar_binding(
    ...
    match binding {
        ...
        LoweredScalarBinding::StoredValue { value, destination } => {
            use crate::psi_lowering::scalar_graph_lowering::primitive_locals::StoreDestination;
