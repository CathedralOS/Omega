...
pub(super) fn lower_structural_crash_route_buckets(
        ...
        match expression {
            ...
            CheckedBooleanExpression::Equal { left, right } => {
                match (left.as_ref(), right.as_ref()) {
                    ...
                    {
                        crate::psi_lowering::contract_predicates::equality_from_polarities(
            ...
            CheckedBooleanExpression::And { left, right }
            | CheckedBooleanExpression::Or { left, right } => {
                crate::psi_lowering::contract_predicates::connective(
    ...
    fn lower_atom_polarity(
        ...
        crate::psi_lowering::contract_predicates::canonical_equality(
