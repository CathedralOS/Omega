...
pub(crate) fn validate_assignment(
    ...
    let source = crate::psi_lowering::call_source_custody::projected_receivers::store_destination(
        checked,
        machine,
        state_symbol,
        None,
...
pub(crate) fn emit(
    ...
    let (path, field) = crate::psi_lowering::structural_scalar_store::lower_structural_field_place(
        ...
        parameter,
        structural_types,
        crate::psi_lowering::structural_scalar_store::StoreAccessPolicy::Exclusive,
    )?;
