...
pub(super) struct Destination {
    ...
    pub(super) path: Vec<semantic_vocabulary::CanonicalStructuralPathSegment>,
    pub(super) scalar_type: ScalarType,
}

pub(super) fn parameter_destination(
...
pub(super) fn emit_assignment(
    ...
    evaluation: &mut crate::psi_lowering::attached_unit::argument_evaluation::Evaluation,
...
pub(super) fn validate_assignment(
    ...
    let (_, state) =
        crate::psi_lowering::scalar_source_custody::authored_state(checked, state_symbol)?;
...
pub(super) fn validate_symbol_assignment(
    ...
    let target = crate::psi_lowering::call_source_custody::projected_receivers::store_destination(
        checked,
        machine.symbol,
        state_symbol,
    ...
    let value = match value {
        checked_trees::CheckedCallScalarArgument::Computation(handle) => {
            ...
            let source = crate::psi_lowering::scalar_source_custody::locate(
                checked,
                state_symbol,
                statement_index,
                role,
            ...
            crate::psi_lowering::scalar_source_custody::validate_computation_calls(
                checked,
                machine.symbol,
                state_symbol,
                statement_index,
            ...
            return crate::psi_lowering::scalar_source_custody::value_correspondence::validate(
                checked,
                state_symbol,
                statement_index,
                assignment.value,
    ...
    crate::psi_lowering::scalar_source_custody::validate_namespace(checked, binding)
}
