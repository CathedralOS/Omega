...
use crate::psi_lowering::attached_unit::{
    lower_composed_unit_control_machine, lower_unit_effect_closure,
};
use crate::psi_lowering::boundary_scalar_return::lower_boundary_scalar_return_machine;
use crate::psi_lowering::dynamic_composed_unit::{
...
use crate::psi_lowering::payloadless_case_return::lower_payloadless_case_return_machine;
use crate::psi_lowering::payloadless_guarded_call_return::lower_payloadless_guarded_call_return_machine;
use crate::psi_lowering::scalar_call_closure::{
    checked_scalar_call_closure, lower_scalar_call_closure,
};
use crate::psi_lowering::scalar_graph_lowering::lower_scalar_graph_machine;
use crate::psi_lowering::structural_return::lower_structural_return_machine;
use crate::psi_lowering::structural_scalar_return::{
...
use crate::psi_lowering::structural_unit_control::lower_structural_unit_control_machine;
use crate::psi_lowering::unit_cleanup::{
...
pub(super) fn lower_selected_machine(
        ...
        .claim_free_affine_for_machine(selection.machine)
    {
        ...
        return selected_machine(
            crate::psi_lowering::affine_return::lower_affine_return_machine(
                checked,
                selection.machine,
            ),
            LoweringCompletion {
    ...
    if crate::psi_lowering::scalar_call_closure::requires_shared_catalog(
        checked,
        selection.machine,
    )? {
        return source_mapped_machine(
            crate::psi_lowering::attached_unit::lower_scalar_effect_closure(
                checked,
                selection.machine,
            ),
            LoweringCompletion {
