...
impl Expansion<'_> {
    ...
    pub(super) fn call(
        ...
        let callee = crate::psi_lowering::scalar_call_closure::callee::CheckedScalarCallee::find_for_unit_call(
            self.checked,
            target_machine,
        )?;
        let (_, source_state) =
            crate::psi_lowering::scalar_source_custody::authored_state(self.checked, target_state)?;
