...
) -> Result<crate::psi_lowering::scalar_qualifications::PreparedScalarQualifications, LoweringError>
{
    let qualifications =
...
pub(crate) struct Evaluation {
    ...
    pub(crate) local_cases:
        Vec<crate::psi_lowering::scalar_bindings::structural_cases::LocalCaseBinding>,
    pub(crate) arrays: Vec<crate::psi_lowering::scalar_computations::arrays::Slot>,
    pub(crate) cases: Vec<crate::psi_lowering::scalar_computations::cases::Slot>,
    pub(crate) record_fields: Vec<crate::psi_lowering::scalar_computations::fields::Binding>,
    ...
    pub scalar_bindings: Option<crate::psi_lowering::scalar_bindings::ScalarBindings>,
    pub structural_parameters: Vec<(u32, StructuralParameterDeclaration)>,
    pub structural_fields: Vec<crate::psi_lowering::scalar_bindings::StructuralScalarFieldBinding>,
    pub structural_cases:
        Vec<crate::psi_lowering::scalar_bindings::structural_cases::StructuralCaseBinding>,
    pub entry: BlockId,
    pub current: BlockId,
        ...
        let argument_types = arguments
            ...
            .map(|argument| match argument {
                ...
                CheckedCallScalarArgument::Computation(root) => {
                    ...
                    crate::psi_lowering::scalar_computations::computation_value_type(
                        checked,
                        &qualifications,
                        *root,
                        &source_bindings,
