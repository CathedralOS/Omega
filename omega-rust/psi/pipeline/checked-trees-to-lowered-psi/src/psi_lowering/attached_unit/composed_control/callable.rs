...
impl<'a> CallableBody<'a> {
    pub(in crate::psi_lowering::attached_unit) fn boundaries(
        &self,
...
pub(in crate::psi_lowering::attached_unit) fn admit<'a>(
...
pub(in crate::psi_lowering::attached_unit) struct SharedCatalog<'a> {
...
pub(in crate::psi_lowering::attached_unit) struct EmissionCounters<'a> {
    pub place: &'a mut u64,
    pub value: &'a mut u64,
    pub block: &'a mut u64,
...
pub(in crate::psi_lowering::attached_unit) fn emit(
