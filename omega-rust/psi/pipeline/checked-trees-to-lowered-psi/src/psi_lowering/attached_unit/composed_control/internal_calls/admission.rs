...
pub(in crate::psi_lowering::attached_unit::composed_control) fn retain_call_target<'a>(
        ...
        .enumerate()
    {
            ...
            .is_some()
        {
            ...
            crate::psi_lowering::attached_unit::structural_calls::validate_linear_result_consumer(
                checked,
                root,
                state.state,
                &state.operations,
