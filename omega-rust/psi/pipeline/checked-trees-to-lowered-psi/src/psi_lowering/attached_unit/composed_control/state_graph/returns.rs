...
pub(super) fn signature_matches(
    ...
    match result {
        ...
        CheckedControlResultPlan::Structural(result) => {
            let Ok(carrier) =
                crate::psi_lowering::attached_unit::parameters::structural_carrier_type(
                    checked,
                    source.return_type,
                )
            else {
...
pub(super) fn validate_case(
    ...
    let expression =
        crate::psi_lowering::scalar_source_custody::guarded_exits::completion_expression(
        ...
        CheckedUnitStructuralArgumentSourcePlan::StructuralResult { binding_ordinal } => {
            ...
            if binding.statement_index as usize == ordinal {
                if matches!(
                    ...
                    crate::psi_lowering::attached_unit::structural_calls::validate_custody(
                        checked,
                        plan.machine,
                        state.state,
                        operation,
                    ...
                    crate::psi_lowering::attached_unit::structural_values::source_custody::validate(
                        checked,
                        plan.machine,
                        state.state,
                        operation,
    ...
    Ok(TerminalMachineResult::Structural(
        StructuralResultDeclaration {
            ...
            projected_qualifications:
                crate::psi_lowering::attached_unit::parameters::lower_projected_qualifications(
...
pub(super) fn emit(
    ...
    bindings: &crate::psi_lowering::scalar_bindings::ScalarBindings,
    catalogs: &mut catalogs::ComposedCatalogs,
