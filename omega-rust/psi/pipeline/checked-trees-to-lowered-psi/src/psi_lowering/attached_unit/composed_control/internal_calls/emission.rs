...
pub(in crate::psi_lowering::attached_unit::composed_control) fn emit_call_operation(
    ...
    let arguments = crate::psi_lowering::attached_unit::argument_evaluation::validated_values(
        scalar_values,
    ...
    let target_entry = crate::psi_lowering::attached_unit::bodies::UnitBody::find(
    ...
    validate_transfer_shape(
        ...
        &[],
        Some(
            crate::psi_lowering::attached_unit::parameters::StructuralResultCustody {
    ...
    if result_binding.is_some() {
        let declaration = crate::psi_lowering::attached_unit::ordinary_calls::emit_structural(
            checked,
            state.state,
            operation,
            crate::psi_lowering::attached_unit::ordinary_calls::PreparedCall {
