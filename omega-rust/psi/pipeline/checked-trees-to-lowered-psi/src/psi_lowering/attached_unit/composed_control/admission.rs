...
pub(in crate::psi_lowering::attached_unit) struct AdmittedComposedUnit<'a> {
    ...
    pub(in crate::psi_lowering::attached_unit) leaves:
        Vec<&'a checked_trees::CheckedComposedUnitControlStatePlan>,
    pub(in crate::psi_lowering::attached_unit) boundaries:
        Vec<(&'a CheckedBoundaryMachinePlan, String)>,
    pub(in crate::psi_lowering::attached_unit) internal_targets: Vec<(UnitBody<'a>, String)>,
    pub(super) custody: custody::ComposedCustody,
}

pub(in crate::psi_lowering::attached_unit) fn admit_composed_unit_control<'a>(
