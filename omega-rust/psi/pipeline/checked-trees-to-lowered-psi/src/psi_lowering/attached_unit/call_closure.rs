...
pub(super) use crate::psi_lowering::scalar_call_closure::embedded::checked_scalar_call_closure_with_structural_roots;
        ...
        .enumerate()
    {
        let coordinate = match operation {
            ...
            | CheckedUnitEffectOperationPlan::SelectedIeeeFloatFusedMultiplyAdd {
                ...
                if !crate::psi_lowering::call_source_custody::initializers::discards_result(
                    checked,
                    machine.state,
                    *coordinate,
                )? {
