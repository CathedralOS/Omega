...
pub(super) fn validate(
    ...
    crate::psi_lowering::runtime_requirements::validate_scalar_source(checked, source, state)?;
    crate::psi_lowering::scalar_contracts::validate_guarantees(checked, source, state)?;
