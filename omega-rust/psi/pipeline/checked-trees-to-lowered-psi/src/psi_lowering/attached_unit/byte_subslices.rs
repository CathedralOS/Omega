...
pub(super) fn emit(
    ...
    let bindings = crate::psi_lowering::scalar_bindings::ScalarBindings::new(values.len())
    ...
    let mut endpoint =
        |retained: &CheckedScalarExpression, role| -> Result<ValueId, LoweringError> {
            ...
            crate::psi_lowering::scalar_graph_lowering::validate_direct_parameter_types(
                &lowered,
                &values
                    .iter()
            ...
            Ok(
                crate::psi_lowering::operation_emission::emit_direct_expression(
