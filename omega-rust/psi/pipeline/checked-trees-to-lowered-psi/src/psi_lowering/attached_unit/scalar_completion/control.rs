...
pub(super) fn validate(
    ...
    crate::psi_lowering::scalar_contracts::with_result_range(
        checked,
        machine.state,
        0,
...
fn conditional(
    ...
    crate::psi_lowering::scalar_graph_lowering::branch_destinations::validate_coordinates(
        *guard_statement_ordinal,
        when_true,
        when_false,
    )?;
        ...
        match tail {
            ...
            [
                ...
                && (fallback.guard == TransitionGuardNode::Always
                    || crate::psi_lowering::scalar_source_custody::guarded_exits::complementary(
                        checked,
                        machine.state,
                        *guard_statement_ordinal,
                    )?),
