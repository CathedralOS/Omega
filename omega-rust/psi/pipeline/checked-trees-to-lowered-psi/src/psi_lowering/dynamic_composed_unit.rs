...
fn retain_dynamic_source_owners(
    ...
    crate::psi_lowering::machine_dispatch::SourceMappedLowered::new(terminal, sources)
}
...
fn validate_exact_dynamic_plan(
    ...
    if let Some(store) = store
        && (store.statement_index != 0
            ...
            || !crate::psi_lowering::structural_scalar_store::checked_store_literal_matches(
...
fn lower_realization_store_operation(
    ...
    let lowered =
        crate::psi_lowering::structural_scalar_store::lower_structural_scalar_store_destination(
            store,
