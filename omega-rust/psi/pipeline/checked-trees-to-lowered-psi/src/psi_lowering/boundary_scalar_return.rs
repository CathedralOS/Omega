...
use super::*;
use crate::psi_lowering::attached_unit::argument_evaluation;
use crate::psi_lowering::machine_dispatch::SourceMappedLowered;
use crate::psi_lowering::scalar_call_closure::embedded::EmbeddedScalarCalls;
...
pub(super) fn lower_boundary_scalar_return_machine(
    ...
    let boundary_declaration = BoundaryMachineDeclaration {
        ...
        fixed_service_reach:
            crate::psi_lowering::attached_unit::lower_fixed_boundary_service_reach(
                checked,
                boundary,
                &service_ids,
            )?,
