...
impl ScalarBindings {
    ...
    pub(crate) fn shared_structural_argument(
        ...
        Ok(StructuralArgument {
            place,
            path: crate::unit::attached_unit::lower_structural_path(&argument.path),
    ...
    pub(crate) fn expression(
        ...
        crate::scalar_graph::scalar_graph_lowering::lower_checked_scalar_expression_with_parameters(
            &expression,
