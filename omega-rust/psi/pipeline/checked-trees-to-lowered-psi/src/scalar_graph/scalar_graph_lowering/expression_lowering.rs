...
pub(crate) fn lower_checked_scalar_expression_with_parameters(
    ...
    structural_fields: &[crate::scalar_graph::scalar_bindings::StructuralScalarFieldBinding],
    structural_cases: &[crate::scalar_graph::scalar_bindings::structural_cases::StructuralCaseBinding],
    ...
    match expression {
        CheckedScalarExpression::StructuralParameterByteLength {
            ...
            if !path.is_empty() {
                let (source, path, field) =
                    crate::scalar_graph::scalar_bindings::structural_fields::resolve_byte_length(
                        structural_fields,
                        *parameter_position,
                        path,
                    )?;
        ...
        CheckedScalarExpression::StorageRead {
            ...
            let source = crate::scalar_graph::scalar_bindings::primitive_storage_place(
                primitive_storage,
                *symbol,
                scalar_type,
            )?;
        ...
        CheckedScalarExpression::StructuralParameterField {
            ...
            if path.iter().any(|segment| {
                ...
                let (source, path) =
                    crate::scalar_graph::scalar_bindings::structural_fields::resolve_primitive(
                        structural_fields,
                        *parameter_position,
                        path,
                        scalar_type,
            ...
            let (source, path, field) =
                crate::scalar_graph::scalar_bindings::structural_fields::resolve(
                    structural_fields,
                    *parameter_position,
                    path,
                    scalar_type,
    ...
    Ok(match expression {
        ...
        CheckedBooleanExpression::StructuralCaseMembership { subject, case } => {
            let (source, path, case) =
                crate::scalar_graph::scalar_bindings::structural_cases::resolve(
                    structural_cases,
                    subject,
                    case,
                )?;
