...
use crate::typed_trees::typed_trees::ClosedConformanceApplication;
...
pub struct PlacedViewPlan {
    ...
    pub placement: terminal_psi::access_plans::ValidatedPlacementPlan,
...
pub struct PlacedFieldPlan {
    ...
    pub accessor_type: crate::typed_trees::types::TypeReferenceHandle,
    ...
    pub value_type: crate::typed_trees::types::TypeReferenceHandle,
    pub access: terminal_psi::access_plans::FieldAccess,
...
pub struct PlacedAtomicResidentContract {
    ...
    pub resident_type: crate::typed_trees::types::TypeReferenceHandle,
...
pub(crate) fn named_type_reference_through_shells(
    table: &crate::typed_trees::types::TypeReferenceTable,
    handle: crate::typed_trees::types::TypeReferenceHandle,
) -> Option<crate::typed_trees::types::TypeReferenceHandle> {
    match table.type_reference(handle) {
        crate::typed_trees::types::TypeReferenceNode::Named { .. } => Some(handle),
        crate::typed_trees::types::TypeReferenceNode::Reference { referee, .. } => {
            named_type_reference_through_shells(table, *referee)
        }
        crate::typed_trees::types::TypeReferenceNode::Constrained { base_type, .. } => {
...
pub struct PlanLaidLayout {
    ...
    pub validated_layout: terminal_psi::layout_plans::LayoutPlanReport,
    ...
    pub private_callback_demands: Vec<
        terminal_psi::layout_plans::PrivateCallbackLayoutDemandReport<ClosedConformanceApplication>,
    >,
...
pub struct PlanLaidIntegerField {
    ...
    pub interpretation: terminal_psi::layout_plans::IntegerInterpretation,
