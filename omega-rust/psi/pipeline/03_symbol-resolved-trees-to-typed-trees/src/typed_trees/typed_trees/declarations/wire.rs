...
use crate::typed_trees::types::{DomainConstraint, TypeReferenceHandle};
        ...
        crate::typed_trees::types::TypeReferenceNode::Constrained {
            ...
            program
                ...
                .any(|constraint| {
                    matches!(
                        constraint,
                        crate::typed_trees::types::TypeConstraintNode::Range { .. }
                    )
                })
...
pub fn data_field_type(
    ...
    loop {
        receiver = match program.type_reference_table.type_reference(receiver) {
            crate::typed_trees::types::TypeReferenceNode::Reference { referee, .. } => *referee,
...
pub fn fixed_array_element_type(
    ...
    loop {
        handle = match program.type_reference_table.type_reference(handle) {
            ...
            crate::typed_trees::types::TypeReferenceNode::FixedArray { element_type, .. } => {
...
impl WireScalarEncoding {
    ...
    pub fn for_primitive(primitive: crate::typed_trees::types::PrimitiveType) -> Option<Self> {
