...
use crate::typed_trees::typed_trees::declarations::operator::operand_signatures::{
...
pub fn trait_operator_matches_application(
    ...
    application: &crate::typed_trees::typed_trees::ClosedConformanceApplication,
...
pub struct SelectedTraitOperatorMeaning<'program> {
    pub trait_definition: &'program crate::typed_trees::trait_definition::TraitDefinition,
    pub requirement: &'program crate::typed_trees::signature::StateSignature,
    pub application: &'program crate::typed_trees::typed_trees::ClosedConformanceApplication,
    pub row: &'program crate::typed_trees::typed_trees::ClosedConformanceRowIdentity,
}
