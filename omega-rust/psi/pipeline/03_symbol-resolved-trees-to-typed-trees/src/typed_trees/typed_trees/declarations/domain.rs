...
pub struct DomainDefinition {
    ...
    pub operators: HandleSpan<crate::typed_trees::operator::OperatorDefinition>,
...
pub fn indexed_domain_instance_name(
    ...
    parameters: &[crate::typed_trees::data::TypeParameter],
    ...
    for (parameter, argument) in parameters.iter().zip(arguments) {
        match parameter.kind {
            crate::typed_trees::data::TypeParameterKind::Type => identities.push(format!(
                "type:{}",
...
pub fn index_parameters<'program>(
    ...
    domain: &DomainDefinition,
) -> &'program [crate::typed_trees::data::TypeParameter] {
...
fn const_index_type_name(
    ...
    use crate::typed_trees::types::{FixedArrayLength, TypeReferenceNode};
...
fn closed_domain_argument_identity(
    ...
    let crate::typed_trees::types::TypeReferenceNode::Named { symbol, name } =
        ...
        if matches!(
            program.type_reference_table.type_reference(argument),
            crate::typed_trees::types::TypeReferenceNode::ConstExpression(_)
        ) {
...
pub enum ProofFact {
    ...
    Proposition(crate::typed_trees::proposition::PropositionApplication),
}

impl Default for ProofFact {
    fn default() -> Self {
        Self::Expression(crate::typed_trees::expression::ExpressionHandle::invalid())
    }
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct ProofMembershipFact {
    pub value: crate::typed_trees::expression::ExpressionHandle,
    pub domain: HandleSpan<Identifier>,
    pub domain_symbol: SymbolHandle,
...
impl Default for ProofMembershipFact {
    fn default() -> Self {
        Self {
            value: crate::typed_trees::expression::ExpressionHandle::invalid(),
            domain: HandleSpan::empty(),
            domain_symbol: SymbolHandle::invalid(),
...
mod symbol_only_proof_tests {
    ...
    fn indexed_membership_cannot_enter_a_symbol_only_implication_chain() {
        ...
        program.push_domain_type_parameter(
            &mut indexed,
            crate::typed_trees::data::TypeParameter {
                kind: crate::typed_trees::data::TypeParameterKind::Const {
