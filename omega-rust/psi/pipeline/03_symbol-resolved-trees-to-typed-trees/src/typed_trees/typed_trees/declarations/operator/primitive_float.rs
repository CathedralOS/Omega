...
use crate::typed_trees::{TypedTrees, expression::BinaryOperator};
...
pub fn primitive_float_binary_semantics(
    ...
    let format = match primitive {
        crate::typed_trees::types::PrimitiveType::F32 => numerics::literals::FloatFormat::F32,
        crate::typed_trees::types::PrimitiveType::F64 => numerics::literals::FloatFormat::F64,
        _ => return None,
    };
    let expected_result = if operation_returns_boolean(operation) {
        crate::typed_trees::types::PrimitiveType::Bool
    } else {
        primitive
    };
