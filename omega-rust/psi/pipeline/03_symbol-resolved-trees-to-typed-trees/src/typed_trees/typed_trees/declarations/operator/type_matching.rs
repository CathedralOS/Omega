...
use crate::typed_trees::data::TypeParameter;
use crate::typed_trees::typed_trees::declarations::operator::OperatorConstBinding;
use crate::typed_trees::types::{FixedArrayLength, TypeReferenceHandle, TypeReferenceNode};
...
fn fixed_array_lengths_match(
    ...
    let crate::typed_trees::data::TypeParameterKind::Const { type_reference } = parameter.kind
    else {
        return false;
    };
...
fn nominal_type_identity_matches(
    ...
    matches!(
        (
            crate::typed_trees::types::PrimitiveType::from_name(actual_name),
            crate::typed_trees::types::PrimitiveType::from_name(expected_name),
        ),
