...
pub enum MachineParameterContract {
    RequirementIdentity,
    Structural(crate::typed_trees::signature::StateSignature),
    Nominal {
...
impl Default for MachineParameterContract {
    fn default() -> Self {
        Self::Structural(crate::typed_trees::signature::StateSignature::default())
    }
}

impl MachineParameterContract {
    pub fn structural(&self) -> Option<&crate::typed_trees::signature::StateSignature> {
        match self {
    ...
    pub fn structural_mut(&mut self) -> Option<&mut crate::typed_trees::signature::StateSignature> {
        match self {
            Self::Structural(signature) => Some(signature),
            Self::RequirementIdentity | Self::Nominal { .. } => None,
        }
...
pub enum MachineParameterContractView<'program> {
    Structural(&'program crate::typed_trees::signature::StateSignature),
    Nominal {
        trait_definition: &'program crate::typed_trees::trait_definition::TraitDefinition,
        requirement: &'program crate::typed_trees::signature::StateSignature,
    },
}

impl<'program> MachineParameterContractView<'program> {
    pub fn signature(self) -> &'program crate::typed_trees::signature::StateSignature {
        match self {
