...
use crate::typed_trees::operator::indexing;
use crate::typed_trees::typed_trees::declarations::operator::operand_signatures::normalized_operand_parameters;
    ...
    let root_candidates = program
        ...
        .map(|operator| SpelledOperator {
            ...
            domain: operator
                ...
                .is_valid()
                .then(|| {
                    crate::typed_trees::domain::domain_by_symbol(program, operator.home_domain)
                })
                .flatten(),
        });
...
fn indexed_receiver_self_match(
    ...
    type_parameters: &[crate::typed_trees::data::TypeParameter],
...
) -> Vec<&crate::typed_trees::types::DomainConstraint> {
...
fn declared_domain_constraint_matches(
    program: &TypedTrees,
    actual: &crate::typed_trees::types::DomainConstraint,
    expected: &crate::typed_trees::types::DomainConstraint,
) -> bool {
