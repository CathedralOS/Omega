...
use crate::typed_trees::typed_trees::declarations::operator::applications::{
    ClosedOperatorRealizationApplication, closed_operator_realization_application,
};
use crate::typed_trees::typed_trees::declarations::operator::{
    OperatorDefinition, declaration_by_symbol,
};
...
pub fn resolve_satisfied_checked_operator<'program>(
    ...
    machine: &'program crate::typed_trees::machine::Machine,
    namespace: &str,
    requirement: &str,
...
pub fn resolve_satisfied_boundary_operator_for_conformance<'program>(
    program: &'program TypedTrees,
    machine: &'program crate::typed_trees::machine::Machine,
    conformance: &'program crate::typed_trees::machine::TraitConformance,
) -> Option<&'program OperatorDefinition> {
        ...
        machine_parameters.iter().zip(operator_parameters)
    {
        match (&machine_parameter.kind, &operator_parameter.kind) {
            (
                ...
                crate::typed_trees::data::TypeParameterKind::Type,
            ) if !crate::typed_trees::data::type_parameter_demands_stronger_properties(
                operator_parameter,
                machine_parameter,
            ) => {}
            (
