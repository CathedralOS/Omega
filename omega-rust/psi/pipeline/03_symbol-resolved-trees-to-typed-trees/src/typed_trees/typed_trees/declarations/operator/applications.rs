...
use crate::typed_trees::typed_trees::declarations::operator::spellings::declared_domain_constraints_match;
use crate::typed_trees::typed_trees::declarations::operator::type_matching::type_reference_matches_with_policy;
...
fn closed_application_for_operands(
    ...
    let application = type_parameters
        ...
        .map(|parameter| match parameter.kind {
            crate::typed_trees::data::TypeParameterKind::Type => bindings
                .iter()
...
pub fn symbolic_operator_type_application_for_operands(
    ...
    if operator_parameters.is_empty()
        || operator_parameters.iter().any(|parameter| {
            !matches!(
                parameter.kind,
                crate::typed_trees::data::TypeParameterKind::Type
            )
