...
use crate::typed_trees::data::{DataDefinition, DataMember};
...
impl ProofOnlyClassification {
    ...
    fn closed_contract_carrier(
        ...
        if definition.supply_mode != language_core::DataSupplyMode::CheckedShape
            ...
            || !matches!(
                shape,
                crate::typed_trees::data::DataShapeKind::Empty
                    | crate::typed_trees::data::DataShapeKind::Record
                    | crate::typed_trees::data::DataShapeKind::Enum
                    | crate::typed_trees::data::DataShapeKind::Mixed
            )
            || program
                .plan_laid_layouts
                .iter()
        ...
        let admitted = program.data_members(definition).iter().all(|member| {
            let fields: &[crate::typed_trees::data::DataField] = match member {
                crate::typed_trees::data::DataMember::Field(field) => std::slice::from_ref(field),
            ...
            program.state_parameters(state).iter().any(|parameter| {
                ...
                || program
                    ...
                    .any(|statement| match statement {
                        crate::typed_trees::statement::StatementNode::LocalData(local_data) => {
