...
pub fn domain_byte_predicate(
    ...
    if domain.alias.is_some()
        ...
        || !crate::typed_trees::domain::index_parameters(program, domain).is_empty()
    {
        return None;
    }
...
mod tests {
    ...
    use crate::typed_trees::TypedTrees;
    use crate::typed_trees::domain::{DomainAliasDefinition, DomainDefinition, ProofFact};
    use crate::typed_trees::expression::{ExpressionHandle, ExpressionNode};
    use crate::typed_trees::expression::{TableCallExpression, TableNamePath};
    use crate::typed_trees::name::Identifier;
    use crate::typed_trees::types::TypeReferenceHandle;
    use crate::typed_trees::types::{DomainConstraint, TypeConstraintNode, TypeReferenceNode};
