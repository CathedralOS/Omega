use crate::typed_trees::data::DataProperties;
use crate::typed_trees::expression::ExpressionHandle;
...
pub struct PropositionDefinition {
    ...
    pub parameters: HandleSpan<crate::typed_trees::signature::StateParameter>,
...
pub struct PropositionBinderArgument {
    ...
    pub evidence_projection: Option<crate::typed_trees::expression::EvidenceProjection>,
    pub symbol: SymbolHandle,
}
...
fn normalize_evidence_interface(
    ...
    let (trait_symbol, arguments) = match program.type_reference_table.type_reference(evidence) {
        crate::typed_trees::types::TypeReferenceNode::Named { symbol, .. } => (*symbol, &[][..]),
        crate::typed_trees::types::TypeReferenceNode::Generic {
            base_symbol,
            arguments,
            ..
        } => (
    ...
    if !trait_symbol.is_valid()
        || program.symbols.get(trait_symbol).kind != symbols::SymbolKind::Trait
    {
...
fn type_reference_mentions_any(
    ...
    use crate::typed_trees::types::{FixedArrayLength, TypeConstraintNode, TypeReferenceNode};
...
pub struct NormalizedEvidenceInterfaceIdentity {
    ...
    pub arguments: Vec<crate::typed_trees::type_identity::NormalizedTypeIdentity>,
...
impl crate::typed_trees::TypedTrees {
    ...
    pub fn render_proof_constructor_value(
        &self,
        literal: &crate::typed_trees::expression::TableStructLiteral,
                ...
                == symbols::SymbolKind::PropositionParameter
        {
            let parameter_count = self
                ...
                .find_map(|parameter| match &parameter.kind {
                    crate::typed_trees::data::TypeParameterKind::Proposition { contract }
...
fn render_expression(
    ...
    match program.expression_table.expression(expression) {
            ...
            let arms = program
                ...
                .map(|arm| {
                    let pattern = match arm.pattern {
                        crate::typed_trees::expression::MatchPattern::Value(value) => render(value),
                        crate::typed_trees::expression::MatchPattern::Wildcard => "_".to_owned(),
                    };
        ...
        ExpressionNode::Cast(cast) => format!(
            "({} as {})",
            render(cast.value),
            crate::typed_trees::expression::display_name_path(
                program
                    .expression_table
        ...
        ExpressionNode::Name(path) => {
            ...
            crate::typed_trees::expression::display_name_path(members, "::")
        }
