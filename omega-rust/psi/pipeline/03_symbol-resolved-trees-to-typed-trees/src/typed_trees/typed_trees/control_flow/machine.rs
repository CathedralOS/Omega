...
use crate::typed_trees::signature::{AuthoredInvocation, SignatureContract};
use crate::typed_trees::state::State;
...
pub struct GenericConformanceBound {
    ...
    pub selected_conformance: Option<crate::typed_trees::expression::StaticMachineArgument>,
}
...
pub struct TraitConformance {
    ...
    pub requirement_source_span: Option<source::SourceSpan>,
    ...
    pub via_expression: crate::typed_trees::expression::ExpressionHandle,
...
impl Default for TraitConformance {
    fn default() -> Self {
        Self {
            ...
            via_expression: crate::typed_trees::expression::ExpressionHandle::invalid(),
...
pub enum SatisfiedDeclaration<'program> {
    Trait {
        definition: &'program crate::typed_trees::trait_definition::TraitDefinition,
        requirement: &'program crate::typed_trees::signature::StateSignature,
    },
    TopLevelRequirement(&'program Machine),
    Operator(&'program crate::typed_trees::operator::OperatorDefinition),
}
...
pub fn resolve_satisfied_declaration<'program>(
    program: &'program crate::typed_trees::TypedTrees,
