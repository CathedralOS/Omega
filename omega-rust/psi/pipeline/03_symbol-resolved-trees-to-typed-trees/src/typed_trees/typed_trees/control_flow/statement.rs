...
pub struct RootBinding {
    pub receiver: crate::typed_trees::expression::ExpressionHandle,
    ...
    pub implementation_operand: crate::typed_trees::expression::ExpressionHandle,
...
pub struct StatementTable {
    ...
    expression_handles: Arena<crate::typed_trees::expression::ExpressionHandle>,
...
impl StatementTable {
    ...
    pub fn push_expression_handle(
        &mut self,
        span: &mut HandleSpan<crate::typed_trees::expression::ExpressionHandle>,
    ...
    pub fn insert_expression_handles(
        &mut self,
        expressions: impl IntoIterator<Item = crate::typed_trees::expression::ExpressionHandle>,
    ) -> HandleSpan<crate::typed_trees::expression::ExpressionHandle> {
    ...
    pub fn reserve_expression_handles(
        ...
        self.expression_handles.insert_many(
            std::iter::repeat_with(crate::typed_trees::expression::ExpressionHandle::invalid)
    ...
    pub fn set_expression_handle_at_offset(
        &mut self,
        expressions: HandleSpan<crate::typed_trees::expression::ExpressionHandle>,
        offset: u32,
        expression: crate::typed_trees::expression::ExpressionHandle,
    ) {
    ...
    pub fn copy_statement_nodes_deep_from(
        ...
        source_types: &crate::typed_trees::types::TypeReferenceTable,
        target_types: &mut crate::typed_trees::types::TypeReferenceTable,
            ...
            let statement = match statement {
                StatementNode::RootBinding(binding) => StatementNode::RootBinding(RootBinding {
                    ...
                    implementation_operand: if binding.implementation_operand.is_valid() {
                        ...
                        crate::typed_trees::expression::ExpressionHandle::invalid()
                    },
                    ..binding.clone()
                }),
                ...
                StatementNode::LocalData(local) => {
                    ...
                    StatementNode::LocalData(TableLocalData {
                        ...
                        type_reference: type_reference.unwrap_or_else(
                            crate::typed_trees::types::TypeReferenceHandle::invalid,
                        ),
                        initial_value: initial_value.unwrap_or_else(
                            crate::typed_trees::expression::ExpressionHandle::invalid,
                        ),
    ...
    pub fn remap_symbols_in(
        ...
        types: &mut crate::typed_trees::types::TypeReferenceTable,
    ...
    pub fn expression_handles(
        &self,
        span: HandleSpan<crate::typed_trees::expression::ExpressionHandle>,
...
pub struct TableAssemblyFact {
    ...
    pub expression: crate::typed_trees::expression::ExpressionHandle,
}
...
pub struct TableAssignment {
    pub target: crate::typed_trees::expression::ExpressionHandle,
...
pub struct TableCall {
    ...
    pub static_requirement_dispatch:
        Option<crate::typed_trees::typed_trees::StaticRequirementDispatch>,
    pub machine_arguments: Box<[crate::typed_trees::expression::StaticMachineArgument]>,
    pub arguments: HandleSpan<crate::typed_trees::expression::ExpressionHandle>,
...
pub struct TableLocalData {
    ...
    pub name: Identifier,
    pub type_reference: crate::typed_trees::types::TypeReferenceHandle,
    pub initial_value: crate::typed_trees::expression::ExpressionHandle,
...
impl Default for TableLocalData {
    fn default() -> Self {
        Self {
            ...
            type_reference: crate::typed_trees::types::TypeReferenceHandle::invalid(),
            initial_value: crate::typed_trees::expression::ExpressionHandle::invalid(),
            is_mutable: false,
...
pub enum TransitionExit {
    #[default]
    Ordinary,
    Crash(crate::typed_trees::signature::CrashCause),
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum TransitionGuardNode {
    Always,
    When(crate::typed_trees::expression::ExpressionHandle),
}
...
pub enum TransitionTargetNode {
    Named {
        ...
        arguments: HandleSpan<crate::typed_trees::expression::ExpressionHandle>,
    ...
    Value(crate::typed_trees::expression::ExpressionHandle),
    SelfTarget,
    #[default]
    Terminal,
}
