...
use crate::typed_trees::types::{TypeReferenceNode, TypeReferenceTable};
...
fn statement_table_appends_handle_native_payloads_directly() {
    ...
    let argument = expressions.insert(crate::typed_trees::expression::ExpressionNode::Integer(
...
fn deep_copy_owns_nested_statement_payloads() {
    ...
    let local_reference = source_expressions.insert(ExpressionNode::Name(
    ...
    source_statements.push_statement(
        ...
        StatementNode::RootBinding(super::RootBinding {
            ...
            implementation_operand: crate::typed_trees::expression::ExpressionHandle::invalid(),
            source_span: Default::default(),
        }),
    );
