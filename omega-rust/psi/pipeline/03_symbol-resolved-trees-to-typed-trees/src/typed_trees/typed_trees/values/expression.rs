use crate::typed_trees::AuthoredDeclarationSelectionOccurrenceId;
...
pub enum Expression {
    ...
    ZeroValue(crate::typed_trees::types::TypeReferenceHandle),
}
        ...
        match expression {
            ...
            Expression::Cast(cast) => {
                ...
                self.insert(ExpressionNode::Cast(TableCastExpression {
                    ...
                    result_type: crate::typed_trees::types::TypeReferenceHandle::invalid(),
                    target_label,
                    domain: cast.domain,
...
pub struct TableCastExpression {
    pub value: ExpressionHandle,
    pub target_type: crate::typed_trees::types::TypeReferenceHandle,
    ...
    pub result_type: crate::typed_trees::types::TypeReferenceHandle,
    ...
    pub semantic_domain_arguments: HandleSpan<crate::typed_trees::types::TypeReferenceHandle>,
