...
use crate::typed_trees::{data, types};
...
pub struct BoundaryCallingPlanIdentity {
    ...
    pub boundary_arguments: Vec<crate::typed_trees::types::TypeReferenceHandle>,
...
pub struct MachineSpecialization {
    ...
    pub operator_realizations:
        Vec<crate::typed_trees::operator::ClosedOperatorRealizationApplication>,
...
pub struct ClosedConformanceApplication {
    ...
    pub arguments: Box<[crate::typed_trees::expression::StaticMachineArgument]>,
