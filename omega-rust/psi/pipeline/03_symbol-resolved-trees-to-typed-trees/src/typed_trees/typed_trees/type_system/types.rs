...
impl TypeReferenceTable {
    pub(crate) fn retains_exact_prefix(&self, base: &Self) -> bool {
        ...
        crate::typed_trees::typed_trees::retained_prefix::arena_is_exact_prefix(
            type_references,
    ...
    pub fn const_expression_sites(
        ...
        TypeReferenceHandle,
        crate::typed_trees::expression::ExpressionHandle,
    )> {
        self.type_references
            .iter()
            .filter_map(|(handle, node)| match node {
    ...
    pub fn display_name_with_constraints(
        &self,
        handle: TypeReferenceHandle,
        expressions: &crate::typed_trees::expression::ExpressionTable,
    ) -> String {
    ...
    pub fn copy_from(
        ...
        source_expressions: &crate::typed_trees::expression::ExpressionTable,
        target_expressions: &mut crate::typed_trees::expression::ExpressionTable,
        type_reference: TypeReferenceHandle,
    ) -> TypeReferenceHandle {
    ...
    pub fn remap_symbols_in(
        &mut self,
        type_reference: TypeReferenceHandle,
        expressions: &mut crate::typed_trees::expression::ExpressionTable,
...
pub enum TypeReferenceNode {
    ...
    ConstExpression(crate::typed_trees::expression::ExpressionHandle),
    DynamicTrait {
        symbol: SymbolHandle,
        name: Identifier,
...
pub enum TypeConstraintNode {
    Named(Identifier),
    Range {
        minimum: crate::typed_trees::expression::ExpressionHandle,
        maximum: crate::typed_trees::expression::ExpressionHandle,
...
pub enum DomainConstraintSubject {
    ...
    Value(language_semantics::value_domain::ValueDomain),
    OmegaLayout {
...
pub struct AuthoredDomainConstraintSelection {
    ...
    pub exposure: language_semantics::declaration_selection::AuthoredDeclarationSelectionExposure,
}
