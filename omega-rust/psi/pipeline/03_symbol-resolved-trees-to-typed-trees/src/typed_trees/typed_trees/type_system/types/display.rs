use crate::typed_trees::expression::ExpressionTable;
use crate::typed_trees::types::{TypeConstraintNode, TypeReferenceNode, TypeReferenceTable};
...
fn dynamic_trait_label(
    trait_name: &crate::typed_trees::name::Identifier,
    conformance_carrier: Option<&crate::typed_trees::name::Identifier>,
    conformance_name: Option<&crate::typed_trees::name::Identifier>,
) -> String {
