...
use crate::typed_trees::type_identity::{ExactOwnerTypeIdentityRequest, TypeIdentityRequest};
...
use crate::typed_trees::typed_trees::type_system::type_identity::identity_context::PackageQualifiedNominalOwner;
use crate::typed_trees::typed_trees::type_system::type_identity::identity_context::package_qualified_nominal_name;
use crate::typed_trees::typed_trees::{OpenIndexNormalization, OpenIndexOperationSelection};
...
fn symbolic_range_endpoints_preserve_owner_slots_and_substitution() {
    ...
    for qualification in [
        crate::typed_trees::typed_trees::type_system::type_identity::identity_context::TypeIdentityQualification::Ordinary,
        crate::typed_trees::typed_trees::type_system::type_identity::identity_context::TypeIdentityQualification::PackageQualified,
    ] {
        let context = crate::typed_trees::typed_trees::type_system::type_identity::identity_context::TypeIdentityContext {
            binders: &[],
            substitutions: &[],
        ...
        let identity = |expression, context: &crate::typed_trees::typed_trees::type_system::type_identity::identity_context::TypeIdentityContext<'_>| {
            crate::typed_trees::typed_trees::type_system::type_identity::constraint_identity::normalized_range_endpoint(&program, expression, false, context)
        };
        assert_ne!(
        ...
        assert_eq!(
            identity(
                first_expression,
                &crate::typed_trees::typed_trees::type_system::type_identity::identity_context::TypeIdentityContext {
                    binders: &first_slot,
                    ..context
                }
            ),
        ...
        let substituted = crate::typed_trees::typed_trees::type_system::type_identity::identity_context::TypeIdentityContext {
        ...
        assert_ne!(
            identity(first_expression, &context),
            crate::typed_trees::typed_trees::type_system::type_identity::constraint_identity::normalized_range_endpoint(&program, first_expression, true, &context),
...
fn range_endpoint_substitution_normalizes_values_without_erasing_typed_failure() {
    ...
    let overflow = program.expression_table.insert(ExpressionNode::Binary(
        crate::typed_trees::expression::TableBinaryExpression {
            left: typed,
    ...
    for qualification in [
        ...
        for replacement in [eight_expression, eight_atom] {
            ...
            assert_eq!(
                crate::typed_trees::typed_trees::type_system::type_identity::constraint_identity::normalized_range_endpoint(&program, endpoint, false, &substituted),
                crate::typed_trees::typed_trees::type_system::type_identity::constraint_identity::normalized_range_endpoint(&program, seven, true, &context),
            ...
            .zip(invalid_references)
        {
            ...
            let actual = crate::typed_trees::typed_trees::type_system::type_identity::constraint_identity::normalized_range_endpoint(&program, endpoint, false, &substituted);
            assert_eq!(
                actual,
                crate::typed_trees::typed_trees::type_system::type_identity::constraint_identity::normalized_range_endpoint(&program, expression, false, &context)
            );
            assert_ne!(
                actual,
                crate::typed_trees::typed_trees::type_system::type_identity::constraint_identity::normalized_range_endpoint(
                    &program,
...
fn closed_range_endpoints_keep_canonical_numeric_formatting() {
    ...
    for qualification in [
        ...
        assert_eq!(
            crate::typed_trees::typed_trees::type_system::type_identity::constraint_identity::normalized_range_endpoint(&program, eight, false, &context),
            crate::typed_trees::typed_trees::type_system::type_identity::constraint_identity::normalized_range_endpoint(&program, seven, true, &context)
        );
    }
}
...
fn declared(name: &str, semantic_id: SemanticDomainId) -> TypeConstraintNode {
    TypeConstraintNode::Domain(DomainConstraint {
        ...
        arguments: Vec::new(),
        subject: crate::typed_trees::types::DomainConstraintSubject::Declared,
        symbol: SymbolHandle::invalid(),
        semantic_id,
        classification: None,
...
fn generic_machine(
...
) -> crate::typed_trees::machine::Machine {
    let mut machine = crate::typed_trees::machine::Machine {
        symbol: owner_symbol,
        name: Identifier::generated("I32::from_value"),
        ..crate::typed_trees::machine::Machine::default()
    };
    program.push_machine_type_parameter(
        ...
        crate::typed_trees::data::TypeParameter {
            ...
            ..crate::typed_trees::data::TypeParameter::default()
        },
    );
    ...
    program.push_state_parameter(
        ...
        crate::typed_trees::signature::StateParameter {
            ...
            ..crate::typed_trees::signature::StateParameter::default()
        },
    );
