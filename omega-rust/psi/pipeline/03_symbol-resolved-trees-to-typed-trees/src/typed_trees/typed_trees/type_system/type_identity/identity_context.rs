...
use crate::typed_trees::typed_trees::type_system::type_identity::open_index_identity::{
    ...
    match program.expression_table.expression(expression) {
        ...
        ExpressionNode::Unary(unary) => compound(
            match unary.operator {
                crate::typed_trees::expression::UnaryOperator::BitwiseNot => "bitwise-not",
                crate::typed_trees::expression::UnaryOperator::LogicalNot => "logical-not",
            },
                ...
                program
                    ...
                    .map(|arm| {
                        compound(
                            ...
                            [
                                match arm.pattern {
                                    crate::typed_trees::expression::MatchPattern::Value(
                                        pattern,
