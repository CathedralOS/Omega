...
use crate::typed_trees::typed_trees::type_system::type_identity::identity_context::normalize_const_or_nominal_name;
use crate::typed_trees::typed_trees::type_system::type_identity::identity_context::normalize_index_expression;
...
pub(super) fn range_endpoint(
    ...
    Some(
        match program.type_reference_table.type_reference(reference) {
            TypeReferenceNode::ConstExpression(expression) => {
                crate::typed_trees::typed_trees::type_system::type_identity::constraint_identity::normalized_range_endpoint(program, *expression, end_inclusive, &nested)
            }
            TypeReferenceNode::Named { symbol, name } => {
                ...
                if let Some(value) = integer(program, *symbol, name.as_str()) {
                    let value = crate::typed_trees::closed_numeric::canonical_integer_range_endpoint(
                        numerics::bignum::BigInt::from_i128(value),
                        end_inclusive,
                    );
                    crate::typed_trees::typed_trees::type_system::type_identity::constraint_identity::normalized_range_integer(&value, &nested)
                } else {
