...
fn apply_numeric(
    ...
    if !machine.is_valid()
        && program
            ...
            .iter()
            .any(|specialization| {
                !crate::typed_trees::operator::selected_trait_operator_meanings(
                    program,
    ...
    if !crate::typed_trees::operator::has_builtin_spelled_expression_meaning(
        program,
        machine,
        expression,
        spelling,
...
pub fn has_builtin_anonymous_operands(
    ...
    crate::typed_trees::operator::resolve_spelling_for_operands(
        program,
        spelling,
        &[None, None],
...
mod tests {
    ...
    use crate::typed_trees::expression::TableBinaryExpression;
