...
use crate::typed_trees::typed_trees::type_system::type_identity::constraint_identity::{
    atom, compound,
};
...
) -> Option<&crate::typed_trees::typed_trees::OpenIndexOperationSelection> {
    program
...
pub(crate) fn open_index_algebra_identity(
    program: &TypedTrees,
    selection: &crate::typed_trees::typed_trees::OpenIndexOperationSelection,
...
fn same_open_index_ac_authority(
    left: &crate::typed_trees::typed_trees::OpenIndexOperationSelection,
    right: &crate::typed_trees::typed_trees::OpenIndexOperationSelection,
) -> bool {
...
fn collect_licensed_ac_operands(
    ...
    expression: ExpressionHandle,
    operator: BinaryOperator,
    authority: &crate::typed_trees::typed_trees::OpenIndexOperationSelection,
    context: &TypeIdentityContext<'_>,
