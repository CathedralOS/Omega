...
use crate::typed_trees::typed_trees::type_system::type_identity::identity_context::TypeIdentityContext;
pub use crate::typed_trees::typed_trees::type_system::type_identity::identity_context::TypeIdentityQualification;
use crate::typed_trees::typed_trees::type_system::type_identity::identity_context::normalize_type_reference;
use crate::typed_trees::typed_trees::type_system::type_identity::result_dispatch_terms::collect_result_dispatch_terms;
use crate::typed_trees::types::{TypeConstraintNode, TypeReferenceHandle};
...
impl TypedTrees {
    ...
    pub fn machine_by_normalized_overload_identity(
        &self,
        identity: &str,
    ) -> Option<&crate::typed_trees::machine::Machine> {
    ...
    pub fn trait_declaration_path(
        &self,
        trait_definition: &crate::typed_trees::trait_definition::TraitDefinition,
    ) -> String {
        if self
            .symbols
    ...
    pub fn normalized_trait_requirement_overload_identity(
        &self,
        trait_definition: &crate::typed_trees::trait_definition::TraitDefinition,
        requirement: &crate::typed_trees::signature::StateSignature,
    ...
    pub fn normalized_operator_overload_identity(
        ...
        NormalizedNamedCallableIdentity {
            ...
            parameters: format!(
                ...
                crate::typed_trees::operator::operator_operand_signature(self, operator)
            ),
