...
use crate::typed_trees::type_identity::substitution;
use crate::typed_trees::typed_trees::type_system::type_identity::NormalizedDomainTerm;
use crate::typed_trees::typed_trees::type_system::type_identity::identity_context::{
        ...
        DomainConstraintSubject::OmegaLayout { grammar } => compound(
            ...
            [
                ...
                atom(
                    "grammar",
                    match grammar {
                        crate::typed_trees::types::OmegaLayoutGrammar::Derived => "derived",
                    },
                ),
            ]
            .into_iter()
