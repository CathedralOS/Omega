...
use crate::typed_trees::typed_trees::inspection::snapshot::declaration_snapshots::{
    establishment_route_snapshot, semantic_roles_snapshot, snapshot_binding_relevance,
};
use crate::typed_trees::typed_trees::inspection::snapshot::statement_and_expression_snapshots::expression_snapshot;
use crate::typed_trees::typed_trees::inspection::snapshot::{
...
pub(crate) fn wire_schema_snapshot(
    program: &TypedTrees,
    wire_schema: &crate::typed_trees::wire::WireSchema,
) -> WireSchemaSnapshot {
    WireSchemaSnapshot {
...
fn wire_member_snapshots(
    program: &TypedTrees,
    members: arena::HandleSpan<crate::typed_trees::wire::WireMember>,
) -> Vec<WireMemberSnapshot> {
    program
        .wire_members(members)
        .iter()
        .map(|member| match member {
            crate::typed_trees::wire::WireMember::Field(field) => WireMemberSnapshot::Field {
                number: field.number,
            ...
            crate::typed_trees::wire::WireMember::Reserved(reserved) => {
                WireMemberSnapshot::Reserved {
                    number: reserved.number,
                }
            }
            crate::typed_trees::wire::WireMember::Version(version) => WireMemberSnapshot::Version {
...
mod termination_vocabulary_tests {
    use crate::typed_trees::snapshot::ProgressPremiseSnapshot;
    use crate::typed_trees::snapshot::TerminationGuaranteeSnapshot;
