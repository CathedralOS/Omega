...
use crate::typed_trees::domain::{DomainDefinition, ProofFact};
use crate::typed_trees::mathematical::{MathematicalBody, MathematicalType};
use crate::typed_trees::measure::MeasureDefinition;
use crate::typed_trees::operator::OperatorDefinition;
use crate::typed_trees::proposition::{
    PropositionBinderKind, PropositionBody, PropositionDefinition, PropositionFormula,
};
use crate::typed_trees::typed_trees::inspection::snapshot::machine_snapshots::state_parameter_snapshot;
use crate::typed_trees::typed_trees::inspection::snapshot::statement_and_expression_snapshots::{
    expression_snapshot, expression_span_snapshot,
};
use crate::typed_trees::typed_trees::inspection::snapshot::type_snapshots::type_reference_snapshot;
...
fn proposition_formula_application_snapshot(
    program: &TypedTrees,
    application: &crate::typed_trees::proposition::PropositionApplication,
        ...
        type_parameters: program
            ...
            .map(|parameter| DomainTypeParameterSnapshot {
                ...
                kind: match parameter.kind {
                    crate::typed_trees::data::TypeParameterKind::Type => "type",
                    crate::typed_trees::data::TypeParameterKind::Const { .. } => "const",
                    crate::typed_trees::data::TypeParameterKind::Value { .. } => "value",
                    crate::typed_trees::data::TypeParameterKind::Machine { .. } => "machine",
                ...
                const_type: match parameter.kind {
                    ...
                    | crate::typed_trees::data::TypeParameterKind::Proposition { .. } => None,
                },
            })
            .collect(),
...
fn mathematical_binder_snapshot(
    program: &TypedTrees,
    parameter: &crate::typed_trees::data::TypeParameter,
) -> MathematicalBinderSnapshot {
    let (kind, carrier) = match &parameter.kind {
        crate::typed_trees::data::TypeParameterKind::Type => ("type", None),
        crate::typed_trees::data::TypeParameterKind::Const { type_reference }
        | crate::typed_trees::data::TypeParameterKind::Value { type_reference } => {
        ...
        crate::typed_trees::data::TypeParameterKind::Machine { .. } => ("machine", None),
        crate::typed_trees::data::TypeParameterKind::Proposition { .. } => ("proposition", None),
    };
    MathematicalBinderSnapshot {
