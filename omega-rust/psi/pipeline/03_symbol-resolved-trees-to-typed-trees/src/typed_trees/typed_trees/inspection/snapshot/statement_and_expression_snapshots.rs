...
use crate::typed_trees::statement::{StatementNode, TransitionGuardNode, TransitionTargetNode};
use crate::typed_trees::typed_trees::inspection::snapshot::TypeReferenceSnapshot;
use crate::typed_trees::typed_trees::inspection::snapshot::type_snapshots::{
    ...
    match statement {
        ...
        StatementNode::AssemblyFact(fact) => StatementSnapshot::AssemblyFact {
            contract_kind: match fact.kind {
                crate::typed_trees::statement::AssemblyFactKind::Requires => "requires",
                crate::typed_trees::statement::AssemblyFactKind::Ensures => "ensures",
            },
        ...
        StatementNode::Transition(transition) => StatementSnapshot::Transition {
            ...
            crash_cause: match transition.exit {
                crate::typed_trees::statement::TransitionExit::Ordinary => None,
                crate::typed_trees::statement::TransitionExit::Crash(
...
fn transition_target_snapshot(
    program: &TypedTrees,
    target: crate::typed_trees::statement::TransitionTargetHandle,
            ...
            arms: program
                ...
                .map(|arm| MatchArmSnapshot {
                    ...
                    pattern: match arm.pattern {
                        crate::typed_trees::expression::MatchPattern::Value(value) => {
                            MatchPatternSnapshot::Value {
                                value: Box::new(expression_snapshot(program, value)),
                            }
                        }
                        crate::typed_trees::expression::MatchPattern::Wildcard => {
                            MatchPatternSnapshot::Wildcard
                        }
                    },
...
pub(crate) fn snapshot_static_argument(
    program: &TypedTrees,
    argument: &crate::typed_trees::expression::StaticMachineArgument,
