...
use crate::typed_trees::data::DataDefinition;
use crate::typed_trees::domain::{DomainAliasConstituent, DomainAliasDefinition, DomainDefinition};
use crate::typed_trees::machine::Machine;
use crate::typed_trees::name::Identifier;
use crate::typed_trees::typed_trees::inspection::snapshot::type_snapshots::type_constraint_snapshot;
...
fn snapshots_measure_root_and_full_table_census() {
    let mut program = TypedTrees::default();
    program.push_const_declaration(crate::typed_trees::constant::ConstDeclaration {
        is_public: true,
        ..crate::typed_trees::constant::ConstDeclaration::default()
    });
    let mut measure = crate::typed_trees::measure::MeasureDefinition {
        symbol: symbols::SymbolHandle::from_arena_index(51),
        lexicographic: true,
        ..crate::typed_trees::measure::MeasureDefinition::default()
    };
    ...
    let mut definition = crate::typed_trees::mathematical::MathematicalDefinition {
        name: Identifier::generated("theorem"),
        is_public: true,
        ..crate::typed_trees::mathematical::MathematicalDefinition::default()
    };
    let result = program
        .insert_mathematical_type(crate::typed_trees::mathematical::MathematicalType::default());
    ...
    program.push_mathematical_parameter(
        ...
        crate::typed_trees::mathematical::MathematicalParameter {
            ...
            ty: result,
            ..crate::typed_trees::mathematical::MathematicalParameter::default()
        },
    );
...
fn snapshots_program_level_custody_and_full_state_census() {
    ...
    program.authored_service_reach_rows.push(
        crate::typed_trees::signature::AuthoredServiceReachRow {
            ...
            targets: vec![crate::typed_trees::signature::AuthoredServiceReachTarget {
                service: boundary,
    ...
    program
        ...
        .push(crate::typed_trees::typed_trees::FusedServiceErasureAuthorization { requirement });
    program.boundary_calling_plans.push(
        crate::typed_trees::typed_trees::BoundaryCallingPlanIdentity {
            boundary_trait: boundary,
            boundary_arguments: Vec::new(),
            requirement_machine: requirement,
            report_fingerprint: 0xdead_beef,
            commitment: crate::typed_trees::typed_trees::BoundaryCallingPlanCommitment::from_digest(
                [7u8; 32],
            ),
        },
    );
    program
        ...
        .push(crate::typed_trees::typed_trees::MachineSpecialization {
            template: boundary,
            ...
            template_contract_commitment:
                crate::typed_trees::typed_trees::MachineTemplateCommitment::from_digest([6u8; 32]),
            report_fingerprint: 42,
            commitment:
                crate::typed_trees::typed_trees::MachineSpecializationCommitment::from_digest(
                    [5u8; 32],
                ),
            ..Default::default()
        });
    let subject =
        program
            .expression_table
            .insert(crate::typed_trees::expression::ExpressionNode::Boolean(
                true,
            ));
    program.ranking_expression_custody.push(
        crate::typed_trees::ranking::RankingExpressionCustody {
            machine: boundary,
    ...
    let fact = program.proof_facts.append_to_span(
        &mut domain.facts,
        crate::typed_trees::domain::ProofFact::Expression(subject),
    );
