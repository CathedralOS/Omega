...
pub struct TypedTrees {
    ...
    pub ranking_expression_custody: Vec<crate::typed_trees::ranking::RankingExpressionCustody>,
    ...
    pub pending_const_range_endpoints:
        std::collections::HashSet<crate::typed_trees::expression::ExpressionHandle>,
}
...
pub struct EvidenceForwarding {
    ...
    pub target: crate::typed_trees::name::Identifier,
    pub source: crate::typed_trees::name::Identifier,
...
pub struct ProofOutputCall {
    ...
    pub call: crate::typed_trees::expression::ExpressionHandle,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct ProofOutputSelector {
    pub output_field: crate::typed_trees::name::Identifier,
    pub binding: crate::typed_trees::name::Identifier,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct OpenIndexNormalization {
    pub expression: crate::typed_trees::expression::ExpressionHandle,
    pub index_type: crate::typed_trees::types::TypeReferenceHandle,
...
pub struct TypedTreeTables {
    ...
    pub const_declarations: Arena<crate::typed_trees::constant::ConstDeclaration>,
    ...
    pub domain_path_members: Arena<crate::typed_trees::name::Identifier>,
    pub operator_path_members: Arena<crate::typed_trees::name::Identifier>,
    pub machines: Arena<machine::Machine>,
    pub measures: Arena<measure::MeasureDefinition>,
    pub measure_path_members: Arena<crate::typed_trees::name::Identifier>,
    pub operators: Arena<crate::typed_trees::operator::OperatorDefinition>,
    pub machine_owned_data: Arena<machine::OwnedData>,
    pub machine_trait_conformances: Arena<machine::TraitConformance>,
    pub machine_states: Arena<crate::typed_trees::state::State>,
    ...
    pub statement_table: crate::typed_trees::statement::StatementTable,
...
pub struct TypedTreeRoots {
    pub const_declarations: HandleSpan<crate::typed_trees::constant::ConstDeclaration>,
    ...
    /// [`crate::typed_trees::operator::resolve_spelling`] for why the view exists.
    pub machine_token_bindings: HandleSpan<crate::typed_trees::operator::OperatorDefinition>,
...
impl TypedTreeRoots {
    pub fn with_roots(
        ...
        operators: HandleSpan<crate::typed_trees::operator::OperatorDefinition>,
...
impl TypedTrees {
    ...
    ) -> Option<&crate::typed_trees::ranking::RankingExpressionCustody> {
