...
Enter [terminal_production.rs](src/terminal_production/terminal_production.rs). The sequence is
...
[Optimization ownership](../06_lowered-psi-to-lowered-psi/README.md)
keeps shared retention policy separate from pass execution.
[Publication ownership](README.md)
...
An erased `Binding<R>` parameter is not an ordinary empty record.
...
[composed Unit producer](../04_typed-trees-to-checked-trees/src/execution/terminal_unit/composed_control/mod.rs)
...
[`computation argument tests`](../05_checked-trees-to-lowered-psi/tests/scalar_array_source/computation_arguments.rs)
...
[`operation-body callee tests`](../05_checked-trees-to-lowered-psi/tests/scalar_array_source/operation_body_callees.rs)
...
[ranking.rs](../05_checked-trees-to-lowered-psi/src/unit/attached_unit/composed_control/state_graph/ranking.rs).
[control_cycle_proofs.rs](../05_checked-trees-to-lowered-psi/src/proofs/control_cycle_proofs.rs)
...
[call planning](../04_typed-trees-to-checked-trees/src/execution/terminal_unit/calls/mod.rs)
...
[nonzero_divisor_certificate.rs](../05_checked-trees-to-lowered-psi/src/proofs/nonzero_divisor_certificate.rs),
...
[composed-provider regressions](../05_checked-trees-to-lowered-psi/src/tests/composed_provider_candidates.rs).
