...
fn snapshots_materialize_resolved_roots_and_table_counts() {
    ...
    program.domain_definitions.push(DomainDefinition {
        ...
        semantic_id: language_semantics::SemanticDomainId(17),
        semantic_roles: language_semantics::DomainSemanticRoles {
            denotation_dimension: Some(language_semantics::SemanticDomainId(17)),
            arithmetic_policy: None,
        },
        establishment_routes: vec![
            language_semantics::DomainEstablishmentRoute::CheckedRequirement {
                trait_definition: symbols::SymbolHandle::from_arena_index(19),
                requirement: symbols::SymbolHandle::from_arena_index(20),
            },
        ],
        ..Default::default()
    });
