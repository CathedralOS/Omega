...
use language_semantics::SynchronousInvocationPlan;
...
pub struct MachineSynchronousInvocationFact {
    ...
    pub published_targets: Vec<flow_effects::InvocationTarget>,
    pub checked_inferred_targets: Vec<flow_effects::InvocationTarget>,
        ...
        let facts = SynchronousInvocationFacts {
            machines: vec![
                MachineSynchronousInvocationFact {
                    ...
                    checked_inferred_targets: vec![flow_effects::InvocationTarget::Parameter(0)],
                ...
                MachineSynchronousInvocationFact {
                    machine: internal,
                    published_targets: Vec::new(),
                    checked_inferred_targets: vec![flow_effects::InvocationTarget::Service(
