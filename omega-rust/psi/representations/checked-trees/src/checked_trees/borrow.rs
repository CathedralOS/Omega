...
pub struct CheckedReborrowContainmentCertificate {
    ...
    pub projection_remainder: Vec<facts::PlaceSegment>,
...
pub struct BorrowFacts {
    ...
    pub access_segments: Arena<facts::PlaceSegment>,
...
impl BorrowFacts {
    pub fn with_roots(
        ...
        access_segments: Arena<facts::PlaceSegment>,
    ...
    pub fn access_segments(&self, access: &BorrowArgumentAccessFact) -> &[facts::PlaceSegment] {
        self.access_segments.span_or_empty(access.segments)
    }

    pub fn loan_segments(&self, loan: &BorrowLoanFact) -> &[facts::PlaceSegment] {
...
mod tests {
    ...
    fn borrow_facts_constructor_keeps_borrow_roots_explicit() {
        ...
        let access_segments = Arena::<facts::PlaceSegment>::with_capacity(2);
    ...
    fn captured_place_identity_is_structural_and_order_sensitive() {
        ...
        let place = CapturedPlace {
            root_symbol: root,
            segments: vec![
                facts::PlaceSegment::Field { symbol: first },
                facts::PlaceSegment::Case { variant: second },
                facts::PlaceSegment::FixedIndex { index: 5 },
                facts::PlaceSegment::FixedRange { start: 6, end: 8 },
        ...
        let Some(facts::PlaceSegment::Index { expression }) = changed_selector.segments.last_mut()
        else {
            unreachable!()
        };
