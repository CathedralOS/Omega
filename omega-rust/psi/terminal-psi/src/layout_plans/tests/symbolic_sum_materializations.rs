        ...
        match mutation {
            ...
            2 => {
                malformed.entries[1].placement = LayoutPlacementReport::IntegerAt {
                    offset: 8,
                    stored_width: 8,
                    interpretation: crate::layout_plans::IntegerInterpretation::Unsigned,
                }
            }
...
fn symbolic_recursive_record_array_materialization_composes_element_boundaries() {
    ...
    assert!(
        matches!(
            ...
            crate::layout_plans::ConventionalRecordSumChildHop::Index {
                element_count: 2,
                element_stride: 32,
            }
        ) && matches!(
            inner_carriers[2].inner_layout.interior,
            crate::layout_plans::SymbolicFieldInterior::Record(_)
        ),
...
fn symbolic_recursive_record_array_paths_stay_symbolic_until_assignment() {
    ...
    let crate::layout_plans::ConventionalRecordSumChildHop::Index { element_stride, .. } =
