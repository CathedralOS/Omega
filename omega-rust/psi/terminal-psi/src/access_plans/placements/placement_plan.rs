...
use crate::access_plans::plan_policy::normalized_identities::{
    authoritative_placement_interpretation, non_authoritative_placement_compatibility_fingerprint,
};
use crate::access_plans::validate_access_plan;
use crate::access_plans::{AccessPlan, AccessPlanDiagnostic, BoundaryReach, ValidatedAccessPlan};
...
pub struct ValidatedPlacementPlan {
    ...
    pub(crate) content_interpretation: crate::extents::ExtentContentInterpretation,
...
impl ValidatedPlacementPlan {
    ...
    pub const fn content_interpretation(&self) -> crate::extents::ExtentContentInterpretation {
...
pub fn validate_placement_plan(
    ...
    let mut validated = ValidatedPlacementPlan {
        identity,
        content_interpretation: crate::extents::ExtentContentInterpretation::from_sha256_commitment(
