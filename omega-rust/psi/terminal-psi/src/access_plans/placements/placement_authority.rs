...
use crate::extents::{LoanPolarity, ResidentClaimId};

use crate::access_plans::placements::owned_atomic_resident_custody::validate_owned_atomic_resident_authority;
use crate::access_plans::placements::owned_resident_custody::replay_owned_admission_resources;
use crate::access_plans::placements::owned_resident_custody::validate_owned_content_binding;
use crate::access_plans::placements::owned_resident_custody::validate_provider_content_binding;
use crate::access_plans::placements::owned_resident_custody::validate_resident_observation;
use crate::access_plans::placements::placement_admission::validate_placement_admission;
...
pub(crate) enum PlacementAuthorityRef<'view, 'extent> {
    ...
    CorrespondedBorrowed(
        &'view crate::access_plans::placements::schema_correspondence::SchemaCorrespondedPlacedView<'extent>,
    ),
        ...
        let replay = match self {
            ...
            .and_then(|()| {
                validate_resident_observation(
                    established.placement_plan(),
                    crate::access_plans::access_plan::ObservationModel::Stable,
                    transition,
                )
            }),
            ...
            .and_then(|()| {
                validate_resident_observation(
                    established.placement_plan(),
                    crate::access_plans::access_plan::ObservationModel::Atomic,
                    transition,
                )
            }),
            Self::EstablishedOwned(established) => {
