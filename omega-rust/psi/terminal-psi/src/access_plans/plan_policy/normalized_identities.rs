use crate::access_plans::access_plan::AccessLayoutCommitment;
...
use crate::extents::{ExtentContentInterpretation, ExtentContentInterpretationId};
...
pub(crate) fn authoritative_placement_interpretation(
    plan: &crate::access_plans::placements::placement_plan::ValidatedPlacementPlan,
...
fn hash_canonical_layout(digest: &mut Sha256, layout: &crate::layout_plans::LayoutPlanReport) {
