...
pub use call_composition::{
    ...
    fixed_element_array_extent, shared_boundary_buffer_capacity,
...
pub use static_path::{
    canonical_structural_path_tip, runtime_index_bound, runtime_index_selects,
    runtime_structural_path_tip, structural_paths_may_overlap,
};
