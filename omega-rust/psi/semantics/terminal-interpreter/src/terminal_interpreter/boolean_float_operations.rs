...
use crate::terminal_interpreter::scalar_operations::{
    ieee_float_compare, nearest_ieee_float_fused_multiply_add,
};
...
impl TerminalExecution {
    pub(super) fn execute_ieee_float_constant(
        &mut self,
    ...
    pub(super) fn execute_ieee_float_compare(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_nearest_ieee_float_fused_multiply_add(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_boolean_constant(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_boolean_not(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_boolean_equal(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
