...
use crate::terminal_interpreter::{TerminalInterpretError, TerminalScalarValue};
use semantic_vocabulary::ScalarType;
use terminal_psi::OperationKind;

impl TerminalExecution {
    pub(super) fn execute_integer_constant(
        &mut self,
    ...
    pub(super) fn execute_integer_equal(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_integer_less_than(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_integer_bitwise_not(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_integer_widen(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_integer_exact_cast(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_integer_bitwise_and(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_wrapping_integer_shift_left(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_exact_integer_add(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_saturating_integer_add(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_saturating_integer_subtract(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(super) fn execute_saturating_integer_multiply(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
