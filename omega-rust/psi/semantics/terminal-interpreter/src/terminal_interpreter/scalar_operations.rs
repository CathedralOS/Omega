...
pub(super) fn terminal_scalar_belongs_to_type(value: TerminalScalarValue) -> bool {
    match value {
...
pub(super) fn ieee_float_compare(
...
pub(super) fn nearest_ieee_float_fused_multiply_add(
