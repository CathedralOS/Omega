...
impl TerminalExecution {
    ...
    pub(crate) fn execute_byte_sequence_subslice(
        &mut self,
        operation: &Operation,
        ...
        match (
            ...
            (
                Some(previous),
                Some(crate::byte_sequences::binding::ByteSequenceBinding::Immutable(_)),
        ...
        self.byte_sequence_values.insert(
            result.place,
            crate::byte_sequences::binding::ByteSequenceBinding::Immutable(view),
        );
