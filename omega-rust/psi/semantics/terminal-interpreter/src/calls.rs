...
//!
//! `frames.rs` binds each call's arguments and pushes its frame,
//! `scalar_case_arguments.rs` prepares an established scalar case as a call
//! argument.

pub(crate) mod frames;
pub(crate) mod scalar_case_arguments;
#[cfg(test)]
...
impl TerminalExecution {
    pub(crate) fn execute_call_unit(
        &mut self,
    ...
    pub(crate) fn execute_call_structural_scalar(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(crate) fn execute_call_dynamic_scalar(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(crate) fn execute_call_dynamic_parameter_scalar(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(crate) fn execute_call_dynamic_unit(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(crate) fn execute_call_dynamic_parameter_unit(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(crate) fn execute_call_structural(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(crate) fn execute_call_structural_with_scalar_arguments(
        &mut self,
        operation: &terminal_psi::Operation,
    ) -> Result<OperationFlow, TerminalInterpretError> {
    ...
    pub(crate) fn execute_boundary_call(
        &mut self,
        operation: &terminal_psi::Operation,
        ...
        results::commit_boundary_result(
            &mut self.values,
