...
pub(crate) fn proposition_mentions_substituted_value(
    ...
    proposition.any_value_id(|value| substitutions.contains_key(&value))
}
...
pub(crate) fn substitute_proposition_structural_places(
    ...
    match proposition {
        ...
        Proposition::IeeeFloatComparison {
            ...
            let rebase = |field: &semantic_vocabulary::IeeeFloatStructuralField| {
                substitutions
                    .get(&field.root())
    ...
    match term {
        IntegerMathTerm::MathValue { source_type, value } => substitutions
            ...
            .and_then(|replacement| match replacement {
                ScalarTerm::Value {
                    id,
                    scalar_type: semantic_vocabulary::ScalarType::Integer(actual),
