...
pub(crate) fn exact_payloadless_case_return_exits(
    ...
    if !crate::validation::structural_result_contracts::has_empty_qualification_rosters(
    ...
    for block in &machine.blocks {
        ...
        if operation_result.place != *source
            ...
            || !crate::validation::structural_result_contracts::has_empty_qualification_rosters(
