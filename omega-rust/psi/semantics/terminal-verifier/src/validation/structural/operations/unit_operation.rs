...
use crate::validation::structural::operations::claim_transfers::validate_service_reach;
use crate::validation::structural::operations::contract_places::validate_unit_call_contract_places;
use crate::validation::structural::operations::primitive_calls::validate_primitive_structural_call;
...
pub(crate) fn validate_unit_operation_static(
    ...
    match &operation.kind {
        ...
        OperationKind::StructuralScalarFieldStore {
            ...
            crate::validation::structural::scalar_fields::structural_scalar_field_store_type(
                module,
                machine,
                operation.id,
                *destination,
        ...
        OperationKind::ByteSequenceWrite { .. } => {
            crate::validation::byte_sequence::write::validate(module, machine, operation)?;
        }
        OperationKind::StructuralByteSequenceFieldByteStore { .. } => {
            crate::validation::structural::byte_sequence_fields::validate(
                module, machine, operation,
            )?;
        }
        OperationKind::StructuralByteSequenceFieldStore { .. } => {
            crate::validation::structural::byte_sequence_store::capacity(
                module, machine, operation,
            )?;
        }
        OperationKind::EstablishScalarCase { .. } => {
            crate::validation::scalar::case::fields(module, machine, operation)?;
        }
        OperationKind::EstablishRecord { .. } => {
            crate::validation::record::fields(module, machine, operation)?;
        }
        OperationKind::EstablishStructuralCase { .. } => {
            crate::validation::structural::case::fields(module, machine, operation)?;
        }
