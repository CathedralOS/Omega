...
use crate::validation::structural::operations::boundary_requirements::{
...
pub(in crate::validation) fn validate_boundary_call(
...
pub(in crate::validation) fn validate_port_write(
    module: &TerminalModule,
    machine: &TerminalMachine,
    operation: &terminal_psi::Operation,
) -> Result<(), ModuleError> {
