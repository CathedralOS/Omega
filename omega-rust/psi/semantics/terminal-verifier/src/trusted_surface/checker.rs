...
pub static ENTRIES: &[TrustedSurfaceEntry] = &[
    ...
    TrustedSurfaceEntry {
        ...
        family: LedgerFamily::EvidenceRoute,
        binding: dispatch(CoveredSurface::EvidenceRoutes),
        premises: "a certificate envelope whose proof is checked against the exact obligation, assumptions, and reconstructed axioms under the current proof-system marker",
        conclusion: "the fact is certificate-derived and its rule/premise acceptance is recorded",
        dependencies: &["rule:traversal"],
        implementation: &[EVIDENCE, ADMISSION],
        soundness: TRUSTED,
    },
