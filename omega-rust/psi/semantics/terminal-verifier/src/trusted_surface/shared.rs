...
rows! {
    ...
    FORM_MATHEMATICAL_CORE => (
        ...
        &["formation:proposition-context"],
        &[pa!( "mathematical_core.rs"), pa!( "mathematical_core/term.rs"), pa!( "mathematical_core/typing.rs"), pa!( "mathematical_core/substitution.rs"), pa!( "mathematical_core/conversion.rs"), pa!( "mathematical_core/certificate.rs"), pa!( "mathematical_core/bounded_denotation.rs"), pa!( "mathematical_core/bounded_denotation/addition.rs"), pa!( "mathematical_core/bounded_denotation/binary_numerals.rs"), pa!( "mathematical_core/bounded_denotation/subtraction.rs"), pa!( "mathematical_core/bounded_denotation/booleans.rs"), pa!( "mathematical_core/bounded_denotation/equality_transport.rs"), pa!( "mathematical_core/bounded_denotation/integer_operations.rs"), pa!( "mathematical_core/indexed.rs"), pa!( "mathematical_core/quotient.rs"), pa!( "mathematical_core/scheme_dsl.rs"), pa!( "mathematical_core/theorems.rs")]
    );
    FORM_REWRITE => (
