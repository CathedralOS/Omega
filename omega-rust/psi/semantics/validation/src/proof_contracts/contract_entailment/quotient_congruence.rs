...
pub(super) fn quotient_equality_from_requires(
    ...
    proposition_requires: &[&typed_trees::proposition::PropositionApplication],
    ...
    let proposition_match = proposition_requires.iter().any(|application| {
        ...
        let forward = crate::proof_contracts::quotients::exact_relation_application_matches(
            program,
            application,
            relation.relation_symbol,
            left_symbol,
        ...
        let reverse = crate::proof_contracts::quotients::exact_relation_application_matches(
            program,
            application,
            relation.relation_symbol,
            right_symbol,
...
) -> Option<(SymbolHandle, typed_trees::types::TypeReferenceHandle)> {
