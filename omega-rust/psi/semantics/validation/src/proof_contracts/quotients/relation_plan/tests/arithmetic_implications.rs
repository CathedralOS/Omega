...
use crate::proof_contracts::quotients::relation_plan::theorem_schema::TheoremApplicationSide;
...
use typed_trees::expression::{BinaryOperator, ExpressionNode, TableNamePath};
...
fn fixed_representative_call_exact_match_is_one_runtime_proof_with_both_theorem_sides() {
    ...
    let dependent = crate::proof_contracts::quotients::relation_plan::correspondence_certificate::DirectLiftPreconditionImplication { rows: Vec::new() };
