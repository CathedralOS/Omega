...
pub(in crate::proof_contracts::quotients) struct RepresentativePreconditionPartition {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::proof_contracts::quotients) struct DefinePreconditionCorrespondence {
...
fn expression_depends_on_any(
    ...
    match program.expression_table.expression(expression) {
        ExpressionNode::Match(dispatch) => crate::value_custody::expression_types::match_children(
            program, *dispatch,
        )
