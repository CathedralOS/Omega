...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::proof_contracts::quotients) struct DirectLiftPreconditionImplication {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::proof_contracts::quotients) struct FixedRepresentativeCallPreconditions {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::proof_contracts::quotients) struct QuotientCorrespondenceCertificate {
