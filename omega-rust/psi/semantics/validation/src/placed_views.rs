...
use access_plans::{AccessExposure, AtomicPermissions, FieldAccess};
...
) -> Option<&'program typed_trees::typed_trees::PlacedFieldPlan> {
...
fn placed_view_field_for_place<'program>(
    ...
    &'program typed_trees::typed_trees::PlacedViewPlan,
    &'program typed_trees::typed_trees::PlacedFieldPlan,
)> {
...
fn placed_view_field_for_call_target(
    ...
    &typed_trees::typed_trees::PlacedViewPlan,
    &typed_trees::typed_trees::PlacedFieldPlan,
)> {
    if !target.is_valid() {
        return None;
    }
...
fn validate_binding_private_use(
    program: &TypedTrees,
    machine: &Machine,
    view: &typed_trees::typed_trees::PlacedViewPlan,
    field: &typed_trees::typed_trees::PlacedFieldPlan,
    diagnostics: &mut Vec<Diagnostic>,
) {
...
fn permissions(field: &typed_trees::typed_trees::PlacedFieldPlan) -> AtomicPermissions {
    match &field.access {
...
mod tests {
    ...
    use access_plans::AtomicPermissions;
