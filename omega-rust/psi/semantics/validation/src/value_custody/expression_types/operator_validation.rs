...
pub(crate) fn validate_binary_operand_types(
    ...
    crate::proof_contracts::arithmetic_domains::report_out_of_range_comparison_literal(
        program,
        machine,
        state,
        operator,
    ...
    crate::proof_contracts::arithmetic_domains::report_mismatched_width_operands(
        program,
        machine,
        state,
        operator,
