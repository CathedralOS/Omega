...
use crate::machine_calls::calls::write_frames::isolation::{
...
#[derive(Debug, Clone)]
pub(in crate::machine_calls::calls::write_frames) struct AggregateMove {
    pub local_segments: Vec<PlaceSegment>,
...
pub(in crate::machine_calls::calls::write_frames) fn reference_leaves(
    program: &TypedTrees,
    caller_machine: &Machine,
    argument: ExpressionHandle,
    expected_type: TypeReferenceHandle,
...
pub(in crate::machine_calls::calls::write_frames) fn reference_leaves_with_origins(
    program: &TypedTrees,
    caller_machine: &Machine,
    argument: ExpressionHandle,
    expected_type: TypeReferenceHandle,
