...
use super::{
    ...
    TypeReferenceHandle, TypeReferenceNode, TypedTrees, ValueEnvironment, WritableRoots,
        ...
        |argument, required| {
                ...
                && declared_reference_access(program, actual).is_some()
            {
                ...
                return match receiver {
                    Some(receiver) => crate::declarations::traits::generic_bound_argument_matches(
                        program,
                        actual,
                        required,
                        crate::value_custody::places::unwrapped_type_reference(program, receiver)
                            .unwrap_or(receiver),
                        requirement,
                    ),
                    None => crate::declarations::traits::named_conformance_argument_matches(
                        program,
                        actual,
                        required,
                        requirement,
...
pub(super) fn named_conformance_requirement<'program>(
    ...
    receiver: symbols::SymbolHandle,
    target: symbols::SymbolHandle,
) -> Result<Option<crate::declarations::traits::GenericBoundRequirement<'program>>, String> {
    ...
    for trait_definition in program.traits() {
        ...
        for signature in program.trait_machine_signatures(trait_definition) {
            ...
            selected = Some(crate::declarations::traits::GenericBoundRequirement {
                signature,
                trait_definition,
                bound,
            });
...
pub(super) fn validate_named_conformance_arguments(
    ...
    let requirement = crate::declarations::traits::GenericBoundRequirement {
    ...
    for (argument, parameter) in arguments.iter().zip(&parameters) {
        ...
        if !crate::declarations::traits::named_conformance_argument_matches(
            program,
            actual,
            required,
            &requirement,
...
pub fn generic_bound_call_requirement<'program>(
    ...
    crate::declarations::traits::generic_bound_requirement_call(
        program,
        machine,
        receiver_type,
        target,
