...
use psi_typed_trees::data::{DataDefinition, DataField, DataMember, TypeParameter};
...
pub(super) struct CarryDerivation<'program> {
    ...
    visiting: Vec<psi_symbols::SymbolHandle>,
}
...
impl<'program> CarryDerivation<'program> {
            ...
            .map(|parameter| {
                (
                    ...
                    parameter
                        .bounds
                        .carry
                        .unwrap_or(psi_language_semantics::CarryPolicy::STRICT),
                )
            })
            .collect();
        Self {
    ...
    pub(super) fn derive_named_data(
        ...
        name: &str,
        arguments: Option<&[psi_typed_trees::types::TypeReferenceHandle]>,
    ) -> psi_language_semantics::CarryPolicy {
        use psi_language_semantics::CarryPolicy;
