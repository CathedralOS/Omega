...
pub fn normalize_open_index_expressions(program: &mut TypedTrees) -> Result<(), Vec<Diagnostic>> {
    ...
    for (expression, index_type) in sites {
        ...
        normalizations.push(psi_typed_trees::typed_trees::OpenIndexNormalization {
            expression,
            index_type,
            operations,
...
fn normalize_open_index_expression_operations(
    ...
    operations: &mut Vec<psi_typed_trees::typed_trees::OpenIndexOperationSelection>,
    diagnostics: &mut Vec<Diagnostic>,
) {
    ...
    operations.push(psi_typed_trees::typed_trees::OpenIndexOperationSelection {
        expression,
        spelling,
