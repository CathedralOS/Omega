...
impl<'program> Evaluator<'program> {
    pub(in crate::interpreter) fn new(
        ...
        Self {
            ...
            output_obligations: Vec::new(),
            output_receipts: Vec::new(),
            output_obligation_paths: BTreeMap::new(),
            output_seal_states: BTreeMap::new(),
            output_open_writers: BTreeMap::new(),
    ...
    pub(in crate::interpreter) fn new_checked(
    ...
    pub(in crate::interpreter) fn configure_build_evaluation(
        &mut self,
        fuel_ceiling: u64,
    ...
    pub(in crate::interpreter) fn finish_cell_usage(&mut self) {
    ...
    pub(in crate::interpreter) fn run_entry(&mut self, entry_machine_name: &str) -> EvalResult<()> {
    ...
    pub(in crate::interpreter) fn run_const_machine(
        &mut self,
        machine_name: &str,
    ) -> EvalResult<i64> {
        let machine = self
    ...
    pub(in crate::interpreter) fn run_build_time_machine(
        &mut self,
        machine_name: &str,
    ...
    /// as a fallback.
    pub(in crate::interpreter) fn run_build_time_machine_symbol(
        &mut self,
    ...
    /// arguments.
    pub(in crate::interpreter) fn run_build_time_machine_arguments(
        &mut self,
        machine_name: &str,
        arguments: Vec<crate::build_time::BuildTimeValue>,
    ...
    pub(in crate::interpreter) fn run_build_time_machine_symbol_arguments(
        &mut self,
        machine_symbol: SymbolHandle,
        arguments: Vec<crate::build_time::BuildTimeValue>,
    ) -> EvalResult<Vec<crate::build_time::BuildTimeValue>> {
    ...
    pub(in crate::interpreter) fn run_build_machine_arguments_with_policy(
        &mut self,
        machine_name: &str,
        arguments: Vec<crate::build_time::BuildTimeValue>,
    ...
    pub(in crate::interpreter) fn run_build_machine_symbol_arguments_with_policy(
        &mut self,
        machine_symbol: SymbolHandle,
        arguments: Vec<crate::build_time::BuildTimeValue>,
        allow_filesystem: bool,
    ...
    fn default_value_for_type_with_bindings(
        ...
        if type_reference.is_valid() {
            if let typed_trees::types::TypeReferenceNode::Named { symbol, name } = self
                .program
                .type_reference_table
            ...
            if let typed_trees::types::TypeReferenceNode::Constrained { base_type, .. } = self
                .program
                .type_reference_table
                .type_reference(type_reference)
            {
            ...
            if let typed_trees::types::TypeReferenceNode::FixedArray {
                element_type,
                length,
            } = self
                .program
                ...
                .type_reference(type_reference)
            {
                ...
                let count = match length {
                    typed_trees::types::FixedArrayLength::Literal(count) => Some(*count),
                    typed_trees::types::FixedArrayLength::ConstParameter { symbol, name } => self
                        .generic_binding_argument(*symbol, name.as_str(), bindings)
                        .and_then(|argument| {
            ...
            if let typed_trees::types::TypeReferenceNode::Generic {
                base_symbol,
                base_name,
                arguments,
                ..
    ...
    fn const_argument_value_with_bindings(
        &self,
        argument: typed_trees::types::TypeReferenceHandle,
        bindings: &[(
            SymbolHandle,
            String,
            typed_trees::types::TypeReferenceHandle,
    ...
    fn enum_zero_case(
        &self,
        type_reference: typed_trees::types::TypeReferenceHandle,
    ) -> Option<(SymbolHandle, String, Vec<typed_trees::data::DataField>)> {
        if self
            .program
        ...
        let mut fields: Vec<typed_trees::data::DataField> = members
            .iter()
