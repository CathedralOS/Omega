...
impl<'program> Evaluator<'program> {
    ...
    pub(super) fn mutable_scalar_recast_initializer(
        ...
        let cast_handle = match self.program.expression_table.expression(initializer) {
            ...
            ExpressionNode::Cast(cast) if cast.form == language_core::CastForm::RecastMutable => {
                initializer
            }
            _ => return Ok(None),
        };
        ...
        if cast.form != language_core::CastForm::RecastMutable {
            return Ok(None);
        }
    ...
    pub(super) fn declared_type_is_fixed_array(
        ...
        {
            typed_trees::types::TypeReferenceNode::FixedArray { .. } => true,
    ...
    pub(super) fn declared_type_is_bounded_byte_buffer(
        ...
        let has_value_domain = self
            ...
            .any(|constraint| match constraint {
                typed_trees::types::TypeConstraintNode::Domain(name) => {
