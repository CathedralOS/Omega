...
use terminal_psi::{ProgramLocalRootIntroductionSchema, TerminalPsiIdentity};
...
pub struct VerifiedProgramLocalRootProducerCatalog {
    ...
    terminal_entry: semantic_vocabulary::MachineId,
...
impl VerifiedProgramLocalRootProducerCatalog {
    ...
    pub const fn terminal_entry(&self) -> semantic_vocabulary::MachineId {
        self.terminal_entry
    }
