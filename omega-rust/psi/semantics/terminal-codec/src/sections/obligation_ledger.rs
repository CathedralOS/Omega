...
use crate::sections::semantic_module::proposition_wire::{decode_proposition, encode_proposition};
use crate::sections::semantic_module::wire::decode_counted;
use crate::sections::semantic_module::wire::{Reader, Writer};
use crate::sections::trust_graph::{TerminalTrustGraphIdentity, ValidatedTerminalTrustGraph};
...
fn encode_propositions(
    writer: &mut Writer,
    label: &'static str,
    propositions: &[semantic_vocabulary::Proposition],
) -> Result<(), CodecError> {
