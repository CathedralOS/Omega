...
//!
//! `validate_operation_foundation` dispatches each operation kind to its
//! `validate_*` function in `value_foundations`, `storage_foundations` or
//! `call_foundations`.
...
use terminal_psi::{
    ...
    StructuralPlaceDeclaration, StructuralTypeShape, TerminalMachine, TerminalMachineResult,
    TerminalModule, Terminator, is_bounded_structural_scalar_store_path,
};
