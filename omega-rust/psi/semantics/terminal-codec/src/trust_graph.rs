...
const BLOCK_WIRE_SOURCE: &[u8] = include_bytes!("block_wire.rs");
const REACH_APPLICATION_WIRE_SOURCE: &[u8] = include_bytes!("reach_application_wire.rs");
...
const PROOF_ADMISSION_INTEGER_AFFINE_SOURCE: &[u8] =
    include_bytes!("../../proof-admission/src/integer_affine.rs");
const PROOF_ADMISSION_INTEGER_CAST_SOURCE: &[u8] =
    include_bytes!("../../proof-admission/src/integer_cast.rs");
const PROOF_ADMISSION_INTEGER_FORBIDDEN_ROOT_SOURCE: &[u8] =
    include_bytes!("../../proof-admission/src/integer_forbidden_root.rs");
