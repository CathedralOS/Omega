...
fn suspension_call_plan_round_trips_canonically_and_rejects_prior_format() {
    ...
    assert_eq!(&bytes[8..10], 81_u16.to_le_bytes());
...
fn current_vocabulary_has_one_stable_canonical_encoding_and_identity() {
    ...
    assert_eq!(
        ...
        "d23166a4cb01b088995428c279ecf60a335b1bf067780237cac9f5e9b9af4fb4"
    );
    assert_eq!(
...
fn decoder_rejects_noncanonical_or_ambiguous_bytes() {
    ...
    future_format[8..10].copy_from_slice(&82_u16.to_le_bytes());
    assert_eq!(
        decode_module(&future_format),
        Err(CodecError::UnsupportedFormatMarker(82))
    );
