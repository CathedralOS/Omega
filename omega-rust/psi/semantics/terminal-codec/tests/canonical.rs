...
fn suspension_call_plan_round_trips_canonically_and_rejects_prior_format() {
    ...
    assert_eq!(&bytes[8..10], 87_u16.to_le_bytes());
...
fn current_vocabulary_has_one_stable_canonical_encoding_and_identity() {
    ...
    assert_eq!(
        ...
        "8b9259c722f25daa02dfb7bf81f452b512749224b135e358add627b8313f422e"
    );
    assert_eq!(
...
fn natural_ranking_round_trips_exact_semantic_rows_and_rejects_malformed_coverage() {
    ...
    assert_eq!(&bytes[8..12], &[87, 0, 97, 0]);
    assert_eq!(decode_module(&bytes), Ok(module.clone()));
...
fn decoder_rejects_noncanonical_or_ambiguous_bytes() {
    ...
    future_format[8..10].copy_from_slice(&88_u16.to_le_bytes());
    assert_eq!(
        decode_module(&future_format),
        Err(CodecError::UnsupportedFormatMarker(88))
    );
