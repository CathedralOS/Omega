...
fn suspension_call_plan_round_trips_canonically_and_rejects_prior_format() {
    ...
    assert_eq!(&bytes[8..10], 80_u16.to_le_bytes());
...
fn current_vocabulary_has_one_stable_canonical_encoding_and_identity() {
    ...
    assert_eq!(
        ...
        "1fab1b262a9fd8bb11972252e7f4d1571ec9a33fabf6b65872f61fce68b402c6"
    );
    assert_eq!(
...
fn decoder_rejects_noncanonical_or_ambiguous_bytes() {
    ...
    future_format[8..10].copy_from_slice(&81_u16.to_le_bytes());
    assert_eq!(
        decode_module(&future_format),
        Err(CodecError::UnsupportedFormatMarker(81))
    );
