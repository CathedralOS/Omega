...
pub(in crate::layouts::layout_plans) struct SumReachability<'a> {
    typed: &'a TypedTrees,
...
impl<'a> SumReachability<'a> {
    ...
    pub(in crate::layouts::layout_plans) fn new(typed: &'a TypedTrees) -> Self {
        Self {
            typed,
    ...
    pub(in crate::layouts::layout_plans) fn type_contains_sum(
        &mut self,
