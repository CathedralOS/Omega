...
the complete abstract plan, not just a matching entry signature.
`WRITE-ONLY-BORROW` in [TASKS.md](../TASKS.md) retains the acceptance command and
remaining stack-pointer transport and platform coverage.
