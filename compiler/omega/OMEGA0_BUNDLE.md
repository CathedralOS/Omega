...
```sh
python3 compiler/omega/omega0_bundle.py pack \
  src/main.omg=src/main.omg lib/math.omg=lib/math.omg > sources.omg0b
python3 compiler/omega/omega0_bundle.py verify sources.omg0b
python3 compiler/omega/omega0_bundle.py manifest sources.omg0b
python3 compiler/omega/omega0_bundle.py get sources.omg0b src/main.omg
```
