...
The trust gates (`omega/omega-meaning.sh`, `delta/forall-sample.sh`, `omega/input-tv.sh`,
`delta/math-contracts.sh`, `omega/e2g-termination.sh`, …) verify meaning/proof-carrying
