pub(in crate::semantic_calls) struct CallSiteTraversal<'program, 'ordinal> {
    pub(super) program: &'program omega_typed_trees::TypedTrees,
    pub(super) machine: &'program omega_typed_trees::machine::Machine,
    pub(super) state: &'program omega_typed_trees::state::State,
