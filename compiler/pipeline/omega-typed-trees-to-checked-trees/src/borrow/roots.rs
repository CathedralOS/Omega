...
pub(super) fn append_state_writable_roots(
    ...
    writable_roots: &mut omega_core::arena::Arena<BorrowWritableRootFact>,
    writable_roots_span: &mut omega_core::arena::HandleSpan<BorrowWritableRootFact>,
) {
...
pub(super) fn estimated_borrow_root_capacity(program: &omega_typed_trees::TypedTrees) -> usize {
    program
        .machines()
        .iter()
        .map(|machine| {
