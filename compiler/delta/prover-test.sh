...
# THE BRIDGE -- WIRED: the lattice's real contract compiler (epsilon-rs/src/discharge.rs) cites a 7-lemma library
...
# hand-written. "automation discharges with zero hand-proving, the kernel checks" (rungs/omega.md) is LIVE on the
