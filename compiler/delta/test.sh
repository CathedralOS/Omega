...
# ∃-distribution laws — unlocked by the relaxed unpack (C re-binds the var, no leak)
chk "exists over +"   "(-> (Exists (+ (Pred 0 (v 0)) (Pred 1 (v 0)))) (+ (Exists (Pred 0 (v 0))) (Exists (Pred 1 (v 0))))) (lam (Exists (+ (Pred 0 (v 0)) (Pred 1 (v 0)))) (unpack (hyp 0) (gen (lam (+ (Pred 0 (v 0)) (Pred 1 (v 0))) (case (hyp 0) (lam (Pred 0 (v 0)) (inl (Exists (Pred 1 (v 0))) (wit (Pred 0 (v 0)) (v 0) (hyp 0)))) (lam (Pred 1 (v 0)) (inr (Exists (Pred 0 (v 0))) (wit (Pred 1 (v 0)) (v 0) (hyp 0)))))))))" accept
chk "exists over &"   "(-> (Exists (& (Pred 0 (v 0)) Q)) (& (Exists (Pred 0 (v 0))) Q)) (lam (Exists (& (Pred 0 (v 0)) Q)) (unpack (hyp 0) (gen (lam (& (Pred 0 (v 0)) Q) (pair (wit (Pred 0 (v 0)) (v 0) (fst (hyp 0))) (snd (hyp 0)))))))" accept
...
# richer binary-function laws: add(1,x)=S x reduces (recursion on the CLOSED 1st arg, x open),
# and the right-successor lemma add(x, S y)=S(add(x,y)) by induction on x (toward commutativity).
chk "fun add(1,x)=Sx" "$ADD (All (= (f 10 (k 3 (k 2)) (v 0)) (k 3 (v 0)))) (gen (refl (f 10 (k 3 (k 2)) (v 0))))" accept
chk "fun add(x,Sy)law" "$ADD (All (All (= (f 10 (v 0) (k 3 (v 1))) (k 3 (f 10 (v 0) (v 1)))))) (gen (rec 2 3 (= (f 10 (v 0) (k 3 (v 1))) (k 3 (f 10 (v 0) (v 1)))) (refl (k 3 (v 0))) (gen (lam (= (f 10 (v 0) (k 3 (v 1))) (k 3 (f 10 (v 0) (v 1)))) (eqelim (= (k 3 (f 10 (v 1) (k 3 (v 2)))) (k 3 (v 0))) (hyp 0) (refl (k 3 (f 10 (v 0) (k 3 (v 1))))))))))" accept
# THE CAPSTONE: a USER-DEFINED binary function is COMMUTATIVE. ∀x∀y. add(x,y)=add(y,x), by
# structural induction over the user type + the lemma layer (right-identity n+0, right-
# successor n+sm, symmetry, transitivity) — the user-function analogue of built-in +-comm.
chk "fun add assoc"  "$ADD (All (All (All (= (f 10 (f 10 (v 0) (v 2)) (v 1)) (f 10 (v 0) (f 10 (v 2) (v 1))))))) (gen (gen (rec 2 3 (= (f 10 (f 10 (v 0) (v 2)) (v 1)) (f 10 (v 0) (f 10 (v 2) (v 1)))) (refl (f 10 (v 1) (v 0))) (gen (lam (= (f 10 (f 10 (v 0) (v 2)) (v 1)) (f 10 (v 0) (f 10 (v 2) (v 1)))) (eqelim (= (k 3 (f 10 (f 10 (v 1) (v 3)) (v 2))) (k 3 (v 0))) (hyp 0) (refl (k 3 (f 10 (f 10 (v 0) (v 2)) (v 1))))))))))" accept
chk "fun add commutes" "$ADD (def 0 (All (= (f 10 (v 0) (k 2)) (v 0))) (rec 2 3 (= (f 10 (v 0) (k 2)) (v 0)) (refl (k 2)) (gen (lam (= (f 10 (v 0) (k 2)) (v 0)) (eqelim (= (k 3 (f 10 (v 1) (k 2))) (k 3 (v 0))) (hyp 0) (refl (k 3 (f 10 (v 0) (k 2))))))))) (def 1 (All (All (= (f 10 (v 0) (k 3 (v 1))) (k 3 (f 10 (v 0) (v 1)))))) (gen (rec 2 3 (= (f 10 (v 0) (k 3 (v 1))) (k 3 (f 10 (v 0) (v 1)))) (refl (k 3 (v 0))) (gen (lam (= (f 10 (v 0) (k 3 (v 1))) (k 3 (f 10 (v 0) (v 1)))) (eqelim (= (k 3 (f 10 (v 1) (k 3 (v 2)))) (k 3 (v 0))) (hyp 0) (refl (k 3 (f 10 (v 0) (k 3 (v 1))))))))))) (def 2 (All (All (-> (= (v 1) (v 0)) (= (v 0) (v 1))))) (gen (gen (lam (= (v 1) (v 0)) (eqelim (= (v 0) (v 2)) (hyp 0) (refl (v 1))))))) (def 3 (All (All (All (-> (= (v 2) (v 1)) (-> (= (v 1) (v 0)) (= (v 2) (v 0))))))) (gen (gen (gen (lam (= (v 2) (v 1)) (lam (= (v 1) (v 0)) (eqelim (= (v 3) (v 0)) (hyp 0) (hyp 1)))))))) (All (All (= (f 10 (v 0) (v 1)) (f 10 (v 1) (v 0))))) (gen (rec 2 3 (= (f 10 (v 0) (v 1)) (f 10 (v 1) (v 0))) (eqelim (= (v 0) (f 10 (v 1) (k 2))) (inst (use 0) (v 0)) (refl (f 10 (v 0) (k 2)))) (gen (lam (= (f 10 (v 0) (v 1)) (f 10 (v 1) (v 0))) (app (app (inst (inst (inst (use 3) (k 3 (f 10 (v 0) (v 1)))) (k 3 (f 10 (v 1) (v 0)))) (f 10 (v 1) (k 3 (v 0)))) (eqelim (= (k 3 (f 10 (v 1) (v 2))) (k 3 (v 0))) (hyp 0) (refl (k 3 (f 10 (v 0) (v 1)))))) (app (inst (inst (use 2) (f 10 (v 1) (k 3 (v 0)))) (k 3 (f 10 (v 1) (v 0)))) (inst (inst (use 1) (v 0)) (v 1))))))))" accept
# FUNCTION COMPOSITION: user-mult (fid 11) is DEFINED IN TERMS of user-add —
# mult(Z,y)=Z, mult(S x,y)=add(y, mult(x,y)) (its rule body calls (f 10 …)). It computes,
# and ∀y. mult(1,y)=y proves by composing mult + add + the add(y,Z)=y lemma.
MUL="$ADD (fun 11 2 (k 2)) (fun 11 3 (f 10 (y 0) (rec 0)))"
...
# THE SEMIRING CAPSTONE: user-defined add + mult satisfy RIGHT DISTRIBUTIVITY,
# ∀a∀b∀c. mult(add(a,b),c) = add(mult(a,c),mult(b,c)), by induction on a using user-add
# associativity (def 0) + symmetry/transitivity. With the commutative-monoid laws for add
# and mult(x,Z)=Z, user-Nat with USER-DEFINED arithmetic is a semiring — inside the checker.
chk "fun distributes" "$MUL (def 0 (All (All (All (= (f 10 (f 10 (v 0) (v 2)) (v 1)) (f 10 (v 0) (f 10 (v 2) (v 1))))))) (gen (gen (rec 2 3 (= (f 10 (f 10 (v 0) (v 2)) (v 1)) (f 10 (v 0) (f 10 (v 2) (v 1)))) (refl (f 10 (v 1) (v 0))) (gen (lam (= (f 10 (f 10 (v 0) (v 2)) (v 1)) (f 10 (v 0) (f 10 (v 2) (v 1)))) (eqelim (= (k 3 (f 10 (f 10 (v 1) (v 3)) (v 2))) (k 3 (v 0))) (hyp 0) (refl (k 3 (f 10 (f 10 (v 0) (v 2)) (v 1))))))))))) (def 1 (All (All (-> (= (v 1) (v 0)) (= (v 0) (v 1))))) (gen (gen (lam (= (v 1) (v 0)) (eqelim (= (v 0) (v 2)) (hyp 0) (refl (v 1))))))) (def 2 (All (All (All (-> (= (v 2) (v 1)) (-> (= (v 1) (v 0)) (= (v 2) (v 0))))))) (gen (gen (gen (lam (= (v 2) (v 1)) (lam (= (v 1) (v 0)) (eqelim (= (v 3) (v 0)) (hyp 0) (hyp 1)))))))) (All (All (All (= (f 11 (f 10 (v 0) (v 2)) (v 1)) (f 10 (f 11 (v 0) (v 1)) (f 11 (v 2) (v 1))))))) (gen (gen (rec 2 3 (= (f 11 (f 10 (v 0) (v 2)) (v 1)) (f 10 (f 11 (v 0) (v 1)) (f 11 (v 2) (v 1)))) (refl (f 11 (v 1) (v 0))) (gen (lam (= (f 11 (f 10 (v 0) (v 2)) (v 1)) (f 10 (f 11 (v 0) (v 1)) (f 11 (v 2) (v 1)))) (app (app (inst (inst (inst (use 2) (f 10 (v 1) (f 11 (f 10 (v 0) (v 2)) (v 1)))) (f 10 (v 1) (f 10 (f 11 (v 0) (v 1)) (f 11 (v 2) (v 1))))) (f 10 (f 10 (v 1) (f 11 (v 0) (v 1))) (f 11 (v 2) (v 1)))) (eqelim (= (f 10 (v 2) (f 11 (f 10 (v 1) (v 3)) (v 2))) (f 10 (v 2) (v 0))) (hyp 0) (refl (f 10 (v 1) (f 11 (f 10 (v 0) (v 2)) (v 1)))))) (app (inst (inst (use 1) (f 10 (f 10 (v 1) (f 11 (v 0) (v 1))) (f 11 (v 2) (v 1)))) (f 10 (v 1) (f 10 (f 11 (v 0) (v 1)) (f 11 (v 2) (v 1))))) (inst (inst (inst (use 0) (f 11 (v 0) (v 1))) (f 11 (v 2) (v 1))) (v 1)))))))))" accept
# building blocks toward user-mult commutativity: the function reduction laws as proved
# equalities, and congruence for the USER constructor S (=k 3).
chk "mult S-rule"    "$MUL (All (All (= (f 11 (k 3 (v 0)) (v 1)) (f 10 (v 1) (f 11 (v 0) (v 1)))))) (gen (gen (refl (f 11 (k 3 (v 0)) (v 1)))))" accept
chk "user S cong"    "$MUL (All (All (-> (= (v 1) (v 0)) (= (k 3 (v 1)) (k 3 (v 0)))))) (gen (gen (lam (= (v 1) (v 0)) (eqelim (= (k 3 (v 2)) (k 3 (v 0))) (hyp 0) (refl (k 3 (v 1)))))))" accept
# LEFT-EXPANSION lemma: forall y x. mult(x,Sy) = add(mult(x,y), x). The induction step on x
# chains the IH, add associativity (S-congruence of), and add right-successor by transitivity.
# This is the gating lemma for user-mult commutativity.
chk "fun mult left-exp" "$MUL (def 0 (All (All (= (f 10 (v 0) (k 3 (v 1))) (k 3 (f 10 (v 0) (v 1)))))) (gen (rec 2 3 (= (f 10 (v 0) (k 3 (v 1))) (k 3 (f 10 (v 0) (v 1)))) (refl (k 3 (v 0))) (gen (lam (= (f 10 (v 0) (k 3 (v 1))) (k 3 (f 10 (v 0) (v 1)))) (eqelim (= (k 3 (f 10 (v 1) (k 3 (v 2)))) (k 3 (v 0))) (hyp 0) (refl (k 3 (f 10 (v 0) (k 3 (v 1))))))))))) (def 1 (All (All (All (= (f 10 (f 10 (v 0) (v 2)) (v 1)) (f 10 (v 0) (f 10 (v 2) (v 1))))))) (gen (gen (rec 2 3 (= (f 10 (f 10 (v 0) (v 2)) (v 1)) (f 10 (v 0) (f 10 (v 2) (v 1)))) (refl (f 10 (v 1) (v 0))) (gen (lam (= (f 10 (f 10 (v 0) (v 2)) (v 1)) (f 10 (v 0) (f 10 (v 2) (v 1)))) (eqelim (= (k 3 (f 10 (f 10 (v 1) (v 3)) (v 2))) (k 3 (v 0))) (hyp 0) (refl (k 3 (f 10 (f 10 (v 0) (v 2)) (v 1))))))))))) (def 2 (All (All (-> (= (v 1) (v 0)) (= (v 0) (v 1))))) (gen (gen (lam (= (v 1) (v 0)) (eqelim (= (v 0) (v 2)) (hyp 0) (refl (v 1))))))) (def 3 (All (All (All (-> (= (v 2) (v 1)) (-> (= (v 1) (v 0)) (= (v 2) (v 0))))))) (gen (gen (gen (lam (= (v 2) (v 1)) (lam (= (v 1) (v 0)) (eqelim (= (v 3) (v 0)) (hyp 0) (hyp 1)))))))) (def 4 (All (All (-> (= (v 1) (v 0)) (= (k 3 (v 1)) (k 3 (v 0)))))) (gen (gen (lam (= (v 1) (v 0)) (eqelim (= (k 3 (v 2)) (k 3 (v 0))) (hyp 0) (refl (k 3 (v 1)))))))) (All (All (= (f 11 (v 0) (k 3 (v 1))) (f 10 (f 11 (v 0) (v 1)) (v 0))))) (gen (rec 2 3 (= (f 11 (v 0) (k 3 (v 1))) (f 10 (f 11 (v 0) (v 1)) (v 0))) (refl (k 2)) (gen (lam (= (f 11 (v 0) (k 3 (v 1))) (f 10 (f 11 (v 0) (v 1)) (v 0))) (app (app (inst (inst (inst (use 3) (f 11 (k 3 (v 0)) (k 3 (v 1)))) (k 3 (f 10 (v 1) (f 10 (f 11 (v 0) (v 1)) (v 0))))) (f 10 (f 11 (k 3 (v 0)) (v 1)) (k 3 (v 0)))) (eqelim (= (f 11 (k 3 (v 1)) (k 3 (v 2))) (k 3 (f 10 (v 2) (v 0)))) (hyp 0) (refl (f 11 (k 3 (v 0)) (k 3 (v 1)))))) (app (app (inst (inst (inst (use 3) (k 3 (f 10 (v 1) (f 10 (f 11 (v 0) (v 1)) (v 0))))) (k 3 (f 10 (f 10 (v 1) (f 11 (v 0) (v 1))) (v 0)))) (f 10 (f 11 (k 3 (v 0)) (v 1)) (k 3 (v 0)))) (app (inst (inst (use 4) (f 10 (v 1) (f 10 (f 11 (v 0) (v 1)) (v 0)))) (f 10 (f 10 (v 1) (f 11 (v 0) (v 1))) (v 0))) (app (inst (inst (use 2) (f 10 (f 10 (v 1) (f 11 (v 0) (v 1))) (v 0))) (f 10 (v 1) (f 10 (f 11 (v 0) (v 1)) (v 0)))) (inst (inst (inst (use 1) (f 11 (v 0) (v 1))) (v 0)) (v 1))))) (app (inst (inst (use 2) (f 10 (f 11 (k 3 (v 0)) (v 1)) (k 3 (v 0)))) (k 3 (f 10 (f 10 (v 1) (f 11 (v 0) (v 1))) (v 0)))) (inst (inst (use 0) (v 0)) (f 10 (v 1) (f 11 (v 0) (v 1)))))))))))" accept
# THE COMMUTATIVE-SEMIRING CAPSTONE: user-mult COMMUTES, forall m n. mult(n,m)=mult(m,n).
# Induct on n (m free, generalized by a single outer gen so the eigenvariable condition holds);
# the step rewrites by the IH, then user-add commutativity, then the left-expansion lemma
# (mult(m,Sn)=add(mult(m,n),m)) reversed. With add a commutative monoid and mult distributing,
# user-Nat with USER-DEFINED arithmetic is a COMMUTATIVE semiring -- entirely inside the checker.
chk "fun mult commutes" "$MUL (def 0 (All (All (-> (= (v 1) (v 0)) (= (v 0) (v 1))))) (gen (gen (lam (= (v 1) (v 0)) (eqelim (= (v 0) (v 2)) (hyp 0) (refl (v 1))))))) (def 1 (All (All (All (-> (= (v 2) (v 1)) (-> (= (v 1) (v 0)) (= (v 2) (v 0))))))) (gen (gen (gen (lam (= (v 2) (v 1)) (lam (= (v 1) (v 0)) (eqelim (= (v 3) (v 0)) (hyp 0) (hyp 1)))))))) (def 2 (All (All (-> (= (v 1) (v 0)) (= (k 3 (v 1)) (k 3 (v 0)))))) (gen (gen (lam (= (v 1) (v 0)) (eqelim (= (k 3 (v 2)) (k 3 (v 0))) (hyp 0) (refl (k 3 (v 1)))))))) (def 3 (All (= (f 10 (v 0) (k 2)) (v 0))) (rec 2 3 (= (f 10 (v 0) (k 2)) (v 0)) (refl (k 2)) (gen (lam (= (f 10 (v 0) (k 2)) (v 0)) (eqelim (= (k 3 (f 10 (v 1) (k 2))) (k 3 (v 0))) (hyp 0) (refl (k 3 (f 10 (v 0) (k 2))))))))) (def 4 (All (All (= (f 10 (v 0) (k 3 (v 1))) (k 3 (f 10 (v 0) (v 1)))))) (gen (rec 2 3 (= (f 10 (v 0) (k 3 (v 1))) (k 3 (f 10 (v 0) (v 1)))) (refl (k 3 (v 0))) (gen (lam (= (f 10 (v 0) (k 3 (v 1))) (k 3 (f 10 (v 0) (v 1)))) (eqelim (= (k 3 (f 10 (v 1) (k 3 (v 2)))) (k 3 (v 0))) (hyp 0) (refl (k 3 (f 10 (v 0) (k 3 (v 1))))))))))) (def 5 (All (All (All (= (f 10 (f 10 (v 0) (v 2)) (v 1)) (f 10 (v 0) (f 10 (v 2) (v 1))))))) (gen (gen (rec 2 3 (= (f 10 (f 10 (v 0) (v 2)) (v 1)) (f 10 (v 0) (f 10 (v 2) (v 1)))) (refl (f 10 (v 1) (v 0))) (gen (lam (= (f 10 (f 10 (v 0) (v 2)) (v 1)) (f 10 (v 0) (f 10 (v 2) (v 1)))) (eqelim (= (k 3 (f 10 (f 10 (v 1) (v 3)) (v 2))) (k 3 (v 0))) (hyp 0) (refl (k 3 (f 10 (f 10 (v 0) (v 2)) (v 1))))))))))) (def 6 (All (All (= (f 10 (v 0) (v 1)) (f 10 (v 1) (v 0))))) (gen (rec 2 3 (= (f 10 (v 0) (v 1)) (f 10 (v 1) (v 0))) (eqelim (= (v 0) (f 10 (v 1) (k 2))) (inst (use 3) (v 0)) (refl (f 10 (v 0) (k 2)))) (gen (lam (= (f 10 (v 0) (v 1)) (f 10 (v 1) (v 0))) (app (app (inst (inst (inst (use 1) (k 3 (f 10 (v 0) (v 1)))) (k 3 (f 10 (v 1) (v 0)))) (f 10 (v 1) (k 3 (v 0)))) (eqelim (= (k 3 (f 10 (v 1) (v 2))) (k 3 (v 0))) (hyp 0) (refl (k 3 (f 10 (v 0) (v 1)))))) (app (inst (inst (use 0) (f 10 (v 1) (k 3 (v 0)))) (k 3 (f 10 (v 1) (v 0)))) (inst (inst (use 4) (v 0)) (v 1))))))))) (def 7 (All (= (f 11 (v 0) (k 2)) (k 2))) (rec 2 3 (= (f 11 (v 0) (k 2)) (k 2)) (refl (k 2)) (gen (lam (= (f 11 (v 0) (k 2)) (k 2)) (hyp 0))))) (def 8 (All (All (= (f 11 (v 0) (k 3 (v 1))) (f 10 (f 11 (v 0) (v 1)) (v 0))))) (gen (rec 2 3 (= (f 11 (v 0) (k 3 (v 1))) (f 10 (f 11 (v 0) (v 1)) (v 0))) (refl (k 2)) (gen (lam (= (f 11 (v 0) (k 3 (v 1))) (f 10 (f 11 (v 0) (v 1)) (v 0))) (app (app (inst (inst (inst (use 1) (f 11 (k 3 (v 0)) (k 3 (v 1)))) (k 3 (f 10 (v 1) (f 10 (f 11 (v 0) (v 1)) (v 0))))) (f 10 (f 11 (k 3 (v 0)) (v 1)) (k 3 (v 0)))) (eqelim (= (f 11 (k 3 (v 1)) (k 3 (v 2))) (k 3 (f 10 (v 2) (v 0)))) (hyp 0) (refl (f 11 (k 3 (v 0)) (k 3 (v 1)))))) (app (app (inst (inst (inst (use 1) (k 3 (f 10 (v 1) (f 10 (f 11 (v 0) (v 1)) (v 0))))) (k 3 (f 10 (f 10 (v 1) (f 11 (v 0) (v 1))) (v 0)))) (f 10 (f 11 (k 3 (v 0)) (v 1)) (k 3 (v 0)))) (app (inst (inst (use 2) (f 10 (v 1) (f 10 (f 11 (v 0) (v 1)) (v 0)))) (f 10 (f 10 (v 1) (f 11 (v 0) (v 1))) (v 0))) (app (inst (inst (use 0) (f 10 (f 10 (v 1) (f 11 (v 0) (v 1))) (v 0))) (f 10 (v 1) (f 10 (f 11 (v 0) (v 1)) (v 0)))) (inst (inst (inst (use 5) (f 11 (v 0) (v 1))) (v 0)) (v 1))))) (app (inst (inst (use 0) (f 10 (f 11 (k 3 (v 0)) (v 1)) (k 3 (v 0)))) (k 3 (f 10 (f 10 (v 1) (f 11 (v 0) (v 1))) (v 0)))) (inst (inst (use 4) (v 0)) (f 10 (v 1) (f 11 (v 0) (v 1)))))))))))) (All (All (= (f 11 (v 0) (v 1)) (f 11 (v 1) (v 0))))) (gen (rec 2 3 (= (f 11 (v 0) (v 1)) (f 11 (v 1) (v 0))) (app (inst (inst (use 0) (f 11 (v 0) (k 2))) (k 2)) (inst (use 7) (v 0))) (gen (lam (= (f 11 (v 0) (v 1)) (f 11 (v 1) (v 0))) (app (app (inst (inst (inst (use 1) (f 11 (k 3 (v 0)) (v 1))) (f 10 (v 1) (f 11 (v 1) (v 0)))) (f 11 (v 1) (k 3 (v 0)))) (eqelim (= (f 11 (k 3 (v 1)) (v 2)) (f 10 (v 2) (v 0))) (hyp 0) (refl (f 11 (k 3 (v 0)) (v 1))))) (app (app (inst (inst (inst (use 1) (f 10 (v 1) (f 11 (v 1) (v 0)))) (f 10 (f 11 (v 1) (v 0)) (v 1))) (f 11 (v 1) (k 3 (v 0)))) (inst (inst (use 6) (f 11 (v 1) (v 0))) (v 1))) (app (inst (inst (use 0) (f 11 (v 1) (k 3 (v 0)))) (f 10 (f 11 (v 1) (v 0)) (v 1))) (inst (inst (use 8) (v 0)) (v 1)))))))))" accept
# ORDER THEORY: define a<=b := exists c. a+c=b, directly in the existing logic (no new
...
# a known first-order incompleteness, documented in delta/ORDER.md.)
...
# ANTISYMMETRY forall a b. a<=b -> b<=a -> a=b -- with reflexivity and transitivity this
# makes <= a PARTIAL ORDER. Unpacks both witnesses c,d; then a+(c+d)=(a+c)+d=b+d=a=a+0,
# so cancellation gives c+d=0, sum-zero gives c=0, and a+c=b collapses to a=b.
chk "le antisym" "(def 0 (All (All (-> (= (v 1) (v 0)) (= (v 0) (v 1))))) (gen (gen (lam (= (v 1) (v 0)) (eqelim (= (v 0) (v 2)) (hyp 0) (refl (v 1))))))) (def 1 (All (All (All (-> (= (v 2) (v 1)) (-> (= (v 1) (v 0)) (= (v 2) (v 0))))))) (gen (gen (gen (lam (= (v 2) (v 1)) (lam (= (v 1) (v 0)) (eqelim (= (v 3) (v 0)) (hyp 0) (hyp 1)))))))) (def 2 (All (All (All (= (p (p (v 0) (v 2)) (v 1)) (p (v 0) (p (v 2) (v 1))))))) (gen (gen (natind (= (p (p (v 0) (v 2)) (v 1)) (p (v 0) (p (v 2) (v 1)))) (refl (p (v 1) (v 0))) (gen (lam (= (p (p (v 0) (v 2)) (v 1)) (p (v 0) (p (v 2) (v 1)))) (eqelim (= (s (p (p (v 1) (v 3)) (v 2))) (s (v 0))) (hyp 0) (refl (s (p (p (v 0) (v 2)) (v 1))))))))))) (def 3 (All (= (p (v 0) z) (v 0))) (natind (= (p (v 0) z) (v 0)) (refl z) (gen (lam (= (p (v 0) z) (v 0)) (eqelim (= (s (p (v 1) z)) (s (v 0))) (hyp 0) (refl (s (p (v 0) z)))))))) (def 4 (All (All (All (-> (= (p (v 2) (v 1)) (p (v 2) (v 0))) (= (v 1) (v 0)))))) (natind (All (All (-> (= (p (v 2) (v 1)) (p (v 2) (v 0))) (= (v 1) (v 0))))) (gen (gen (lam (= (p z (v 1)) (p z (v 0))) (hyp 0)))) (gen (lam (All (All (-> (= (p (v 2) (v 1)) (p (v 2) (v 0))) (= (v 1) (v 0))))) (gen (gen (lam (= (p (s (v 2)) (v 1)) (p (s (v 2)) (v 0))) (app (inst (inst (hyp 1) (v 1)) (v 0)) (sinj (hyp 0)))))))))) (def 5 (All (All (-> (= (p (v 1) (v 0)) z) (= (v 1) z)))) (natind (All (-> (= (p (v 1) (v 0)) z) (= (v 1) z))) (gen (lam (= (p z (v 0)) z) (refl z))) (gen (lam (All (-> (= (p (v 1) (v 0)) z) (= (v 1) z))) (gen (lam (= (p (s (v 1)) (v 0)) z) (absurd (= (s (v 1)) z) (disj (app (app (inst (inst (inst (use 1) z) (p (s (v 1)) (v 0))) (s (p (v 1) (v 0)))) (app (inst (inst (use 0) (p (s (v 1)) (v 0))) z) (hyp 0))) (refl (p (s (v 1)) (v 0)))))))))))) (All (All (-> (Exists (= (p (v 2) (v 0)) (v 1))) (-> (Exists (= (p (v 1) (v 0)) (v 2))) (= (v 1) (v 0)))))) (gen (gen (lam (Exists (= (p (v 2) (v 0)) (v 1))) (lam (Exists (= (p (v 1) (v 0)) (v 2))) (unpack (hyp 1) (gen (lam (= (p (v 2) (v 0)) (v 1)) (unpack (hyp 1) (gen (lam (= (p (v 2) (v 0)) (v 3)) (app (app (inst (inst (inst (use 1) (v 3)) (p (v 3) z)) (v 2)) (app (inst (inst (use 0) (p (v 3) z)) (v 3)) (inst (use 3) (v 3)))) (eqelim (= (p (v 4) (v 0)) (v 3)) (app (inst (inst (use 5) (v 1)) (v 0)) (app (inst (inst (inst (use 4) (v 3)) (p (v 1) (v 0))) z) (app (app (inst (inst (inst (use 1) (p (v 3) (p (v 1) (v 0)))) (v 3)) (p (v 3) z)) (app (app (inst (inst (inst (use 1) (p (v 3) (p (v 1) (v 0)))) (p (p (v 3) (v 1)) (v 0))) (v 3)) (app (inst (inst (use 0) (p (p (v 3) (v 1)) (v 0))) (p (v 3) (p (v 1) (v 0)))) (inst (inst (inst (use 2) (v 1)) (v 0)) (v 3)))) (app (app (inst (inst (inst (use 1) (p (p (v 3) (v 1)) (v 0))) (p (v 2) (v 0))) (v 3)) (eqelim (= (p (p (v 4) (v 2)) (v 1)) (p (v 0) (v 1))) (hyp 1) (refl (p (p (v 3) (v 1)) (v 0))))) (hyp 0)))) (app (inst (inst (use 0) (p (v 3) z)) (v 3)) (inst (use 3) (v 3)))))) (hyp 1)))))))))))))" accept
# TOTALITY forall a b. a<=b \/ b<=a -- with the partial-order laws this makes <= a TOTAL
# (linear) order. Induction on a; the step cases on b (0 or successor) and, in the
# successor case, applies the induction hypothesis at the predecessor + le-succ-mono.
chk "le total" "(def 0 (All (All (-> (Exists (= (p (v 2) (v 0)) (v 1))) (Exists (= (p (s (v 2)) (v 0)) (s (v 1))))))) (gen (gen (lam (Exists (= (p (v 2) (v 0)) (v 1))) (unpack (hyp 0) (gen (lam (= (p (v 2) (v 0)) (v 1)) (wit (= (p (s (v 3)) (v 0)) (s (v 2))) (v 0) (eqelim (= (p (s (v 3)) (v 1)) (s (v 0))) (hyp 0) (refl (p (s (v 2)) (v 0)))))))))))) (def 1 (All (+ (= (v 0) z) (Exists (= (v 1) (s (v 0)))))) (natind (+ (= (v 0) z) (Exists (= (v 1) (s (v 0))))) (inl (Exists (= z (s (v 0)))) (refl z)) (gen (lam (+ (= (v 0) z) (Exists (= (v 1) (s (v 0))))) (inr (= (s (v 0)) z) (wit (= (s (v 1)) (s (v 0))) (v 0) (refl (s (v 0))))))))) (def 2 (All (All (-> (= (v 1) (v 0)) (= (v 0) (v 1))))) (gen (gen (lam (= (v 1) (v 0)) (eqelim (= (v 0) (v 2)) (hyp 0) (refl (v 1))))))) (def 3 (All (All (All (-> (= (v 2) (v 1)) (-> (= (v 1) (v 0)) (= (v 2) (v 0))))))) (gen (gen (gen (lam (= (v 2) (v 1)) (lam (= (v 1) (v 0)) (eqelim (= (v 3) (v 0)) (hyp 0) (hyp 1)))))))) (All (All (+ (Exists (= (p (v 2) (v 0)) (v 1))) (Exists (= (p (v 1) (v 0)) (v 2)))))) (natind (All (+ (Exists (= (p (v 2) (v 0)) (v 1))) (Exists (= (p (v 1) (v 0)) (v 2))))) (gen (inl (Exists (= (p (v 1) (v 0)) z)) (wit (= (p z (v 0)) (v 1)) (v 0) (refl (v 0))))) (gen (lam (All (+ (Exists (= (p (v 2) (v 0)) (v 1))) (Exists (= (p (v 1) (v 0)) (v 2))))) (gen (case (inst (use 1) (v 0)) (lam (= (v 0) z) (inr (Exists (= (p (s (v 2)) (v 0)) (v 1))) (wit (= (p (v 1) (v 0)) (s (v 2))) (s (v 1)) (eqelim (= (p (v 0) (s (v 2))) (s (v 2))) (app (inst (inst (use 2) (v 0)) z) (hyp 0)) (refl (s (v 1))))))) (lam (Exists (= (v 1) (s (v 0)))) (unpack (hyp 0) (gen (lam (= (v 1) (s (v 0))) (case (inst (hyp 2) (v 0)) (lam (Exists (= (p (v 3) (v 0)) (v 1))) (inl (Exists (= (p (v 2) (v 0)) (s (v 3)))) (unpack (app (inst (inst (use 0) (v 2)) (v 0)) (hyp 0)) (gen (lam (= (p (s (v 3)) (v 0)) (s (v 1))) (wit (= (p (s (v 4)) (v 0)) (v 3)) (v 0) (app (app (inst (inst (inst (use 3) (p (s (v 3)) (v 0))) (s (v 1))) (v 2)) (hyp 0)) (app (inst (inst (use 2) (v 2)) (s (v 1))) (hyp 2))))))))) (lam (Exists (= (p (v 1) (v 0)) (v 3))) (inr (Exists (= (p (s (v 3)) (v 0)) (v 2))) (unpack (app (inst (inst (use 0) (v 0)) (v 2)) (hyp 0)) (gen (lam (= (p (s (v 1)) (v 0)) (s (v 3))) (wit (= (p (v 3) (v 0)) (s (v 4))) (v 0) (app (app (inst (inst (inst (use 3) (p (v 2) (v 0))) (p (s (v 1)) (v 0))) (s (v 3))) (eqelim (= (p (v 3) (v 1)) (p (v 0) (v 1))) (hyp 2) (refl (p (v 2) (v 0))))) (hyp 0))))))))))))))))))" accept
# multiplication MONOTONICITY forall a b c. a<=b -> a*c<=b*c: the order is compatible with
# *, so the naturals are an ORDERED commutative semiring. Witness k*c, via right-distributivity.
chk "mult mono" "(def 0 (All (All (All (= (p (p (v 0) (v 2)) (v 1)) (p (v 0) (p (v 2) (v 1))))))) (gen (gen (natind (= (p (p (v 0) (v 2)) (v 1)) (p (v 0) (p (v 2) (v 1)))) (refl (p (v 1) (v 0))) (gen (lam (= (p (p (v 0) (v 2)) (v 1)) (p (v 0) (p (v 2) (v 1)))) (eqelim (= (s (p (p (v 1) (v 3)) (v 2))) (s (v 0))) (hyp 0) (refl (s (p (p (v 0) (v 2)) (v 1))))))))))) (def 1 (All (All (-> (= (v 1) (v 0)) (= (v 0) (v 1))))) (gen (gen (lam (= (v 1) (v 0)) (eqelim (= (v 0) (v 2)) (hyp 0) (refl (v 1))))))) (def 2 (All (All (All (-> (= (v 2) (v 1)) (-> (= (v 1) (v 0)) (= (v 2) (v 0))))))) (gen (gen (gen (lam (= (v 2) (v 1)) (lam (= (v 1) (v 0)) (eqelim (= (v 3) (v 0)) (hyp 0) (hyp 1)))))))) (def 3 (All (All (All (= (m (p (v 0) (v 2)) (v 1)) (p (m (v 0) (v 1)) (m (v 2) (v 1))))))) (gen (gen (natind (= (m (p (v 0) (v 2)) (v 1)) (p (m (v 0) (v 1)) (m (v 2) (v 1)))) (refl (m (v 1) (v 0))) (gen (lam (= (m (p (v 0) (v 2)) (v 1)) (p (m (v 0) (v 1)) (m (v 2) (v 1)))) (app (app (inst (inst (inst (use 2) (p (v 1) (m (p (v 0) (v 2)) (v 1)))) (p (v 1) (p (m (v 0) (v 1)) (m (v 2) (v 1))))) (p (p (v 1) (m (v 0) (v 1))) (m (v 2) (v 1)))) (eqelim (= (p (v 2) (m (p (v 1) (v 3)) (v 2))) (p (v 2) (v 0))) (hyp 0) (refl (p (v 1) (m (p (v 0) (v 2)) (v 1)))))) (app (inst (inst (use 1) (p (p (v 1) (m (v 0) (v 1))) (m (v 2) (v 1)))) (p (v 1) (p (m (v 0) (v 1)) (m (v 2) (v 1))))) (inst (inst (inst (use 0) (m (v 0) (v 1))) (m (v 2) (v 1))) (v 1)))))))))) (All (All (All (-> (Exists (= (p (v 3) (v 0)) (v 2))) (Exists (= (p (m (v 3) (v 1)) (v 0)) (m (v 2) (v 1)))))))) (gen (gen (gen (lam (Exists (= (p (v 3) (v 0)) (v 2))) (unpack (hyp 0) (gen (lam (= (p (v 3) (v 0)) (v 2)) (wit (= (p (m (v 4) (v 2)) (v 0)) (m (v 3) (v 2))) (m (v 0) (v 1)) (app (app (inst (inst (inst (use 2) (p (m (v 3) (v 1)) (m (v 0) (v 1)))) (m (p (v 3) (v 0)) (v 1))) (m (v 2) (v 1))) (app (inst (inst (use 1) (m (p (v 3) (v 0)) (v 1))) (p (m (v 3) (v 1)) (m (v 0) (v 1)))) (inst (inst (inst (use 3) (v 0)) (v 1)) (v 3)))) (eqelim (= (m (v 0) (v 2)) (m (v 3) (v 2))) (app (inst (inst (use 1) (p (v 3) (v 0))) (v 2)) (hyp 0)) (refl (m (v 2) (v 1)))))))))))))" accept
# order monotonicity / inversion (all via exists-elim, enabled by the eigenvariable fix):
chk "le succ mono" "(All (All (-> (Exists (= (p (v 2) (v 0)) (v 1))) (Exists (= (p (s (v 2)) (v 0)) (s (v 1))))))) (gen (gen (lam (Exists (= (p (v 2) (v 0)) (v 1))) (unpack (hyp 0) (gen (lam (= (p (v 2) (v 0)) (v 1)) (wit (= (p (s (v 3)) (v 0)) (s (v 2))) (v 0) (eqelim (= (p (s (v 3)) (v 1)) (s (v 0))) (hyp 0) (refl (p (s (v 2)) (v 0))))))))))" accept
chk "le succ refl" "(All (All (-> (Exists (= (p (s (v 2)) (v 0)) (s (v 1)))) (Exists (= (p (v 2) (v 0)) (v 1)))))) (gen (gen (lam (Exists (= (p (s (v 2)) (v 0)) (s (v 1)))) (unpack (hyp 0) (gen (lam (= (p (s (v 2)) (v 0)) (s (v 1))) (wit (= (p (v 3) (v 0)) (v 2)) (v 0) (sinj (hyp 0)))))))))" accept
chk "le zero"      "(def 0 (All (All (-> (= (v 1) (v 0)) (= (v 0) (v 1))))) (gen (gen (lam (= (v 1) (v 0)) (eqelim (= (v 0) (v 2)) (hyp 0) (refl (v 1))))))) (def 1 (All (All (All (-> (= (v 2) (v 1)) (-> (= (v 1) (v 0)) (= (v 2) (v 0))))))) (gen (gen (gen (lam (= (v 2) (v 1)) (lam (= (v 1) (v 0)) (eqelim (= (v 3) (v 0)) (hyp 0) (hyp 1)))))))) (def 2 (All (All (-> (= (p (v 1) (v 0)) z) (= (v 1) z)))) (natind (All (-> (= (p (v 1) (v 0)) z) (= (v 1) z))) (gen (lam (= (p z (v 0)) z) (refl z))) (gen (lam (All (-> (= (p (v 1) (v 0)) z) (= (v 1) z))) (gen (lam (= (p (s (v 1)) (v 0)) z) (absurd (= (s (v 1)) z) (disj (app (app (inst (inst (inst (use 1) z) (p (s (v 1)) (v 0))) (s (p (v 1) (v 0)))) (app (inst (inst (use 0) (p (s (v 1)) (v 0))) z) (hyp 0))) (refl (p (s (v 1)) (v 0)))))))))))) (All (-> (Exists (= (p (v 1) (v 0)) z)) (= (v 0) z))) (gen (lam (Exists (= (p (v 1) (v 0)) z)) (unpack (hyp 0) (gen (lam (= (p (v 1) (v 0)) z) (app (inst (inst (use 2) (v 1)) (v 0)) (hyp 0)))))))" accept
# built-in right-successor a+Sm=S(a+m) and a<=Sa (witness 1) -- toward order totality.
chk "right succ" "(All (All (= (p (v 1) (s (v 0))) (s (p (v 1) (v 0)))))) (natind (All (= (p (v 1) (s (v 0))) (s (p (v 1) (v 0))))) (gen (refl (s (v 0)))) (gen (lam (All (= (p (v 1) (s (v 0))) (s (p (v 1) (v 0))))) (gen (eqelim (= (p (s (v 2)) (s (v 1))) (s (v 0))) (inst (hyp 0) (v 0)) (refl (p (s (v 1)) (s (v 0)))))))))" accept
chk "le succ self" "(def 0 (All (All (= (p (v 1) (s (v 0))) (s (p (v 1) (v 0)))))) (natind (All (= (p (v 1) (s (v 0))) (s (p (v 1) (v 0))))) (gen (refl (s (v 0)))) (gen (lam (All (= (p (v 1) (s (v 0))) (s (p (v 1) (v 0))))) (gen (eqelim (= (p (s (v 2)) (s (v 1))) (s (v 0))) (inst (hyp 0) (v 0)) (refl (p (s (v 1)) (s (v 0)))))))))) (def 1 (All (= (p (v 0) z) (v 0))) (natind (= (p (v 0) z) (v 0)) (refl z) (gen (lam (= (p (v 0) z) (v 0)) (eqelim (= (s (p (v 1) z)) (s (v 0))) (hyp 0) (refl (s (p (v 0) z)))))))) (def 2 (All (All (-> (= (v 1) (v 0)) (= (s (v 1)) (s (v 0)))))) (gen (gen (lam (= (v 1) (v 0)) (eqelim (= (s (v 2)) (s (v 0))) (hyp 0) (refl (s (v 1)))))))) (def 3 (All (All (All (-> (= (v 2) (v 1)) (-> (= (v 1) (v 0)) (= (v 2) (v 0))))))) (gen (gen (gen (lam (= (v 2) (v 1)) (lam (= (v 1) (v 0)) (eqelim (= (v 3) (v 0)) (hyp 0) (hyp 1)))))))) (All (Exists (= (p (v 1) (v 0)) (s (v 1))))) (gen (wit (= (p (v 1) (v 0)) (s (v 1))) (s z) (app (app (inst (inst (inst (use 3) (p (v 0) (s z))) (s (p (v 0) z))) (s (v 0))) (inst (inst (use 0) (v 0)) z)) (app (inst (inst (use 2) (p (v 0) z)) (v 0)) (inst (use 1) (v 0))))))" accept
# additive LEFT-CANCELLATION forall a x y. a+x=a+y -> x=y, by induction on a with
