...
pub struct SymbolResolvedDeclarationStorage {
    ...
    pub machine_owned_data_expressions: Arena<expression::Expression>,
...
impl SymbolResolvedTrees {
    ...
    pub fn machine_owned_data_expression(
        &self,
    ...
    pub fn state_statement_expressions(
        &self,
        span: HandleSpan<expression::Expression>,
    ) -> &[expression::Expression] {
        self.tables
            .declarations
