    ...
    match expression {
        ...
        LoweredDirectExpression::IntegerBinary {
            ...
            collect_direct(left, right)
                ...
                .or_else(|| {
                    shared_exact_signed_affine_cast_affine_runtime_parameters(expression)
                })
                .or_else(|| {
                ...
                .or_else(|| shared_exact_affine_fork_join_runtime_parameters(expression))
                .or_else(|| {
                    shared_exact_distinct_root_affine_fork_join_runtime_parameters(expression)
                })
        }
        LoweredDirectExpression::IntegerBinary {
        ...
        LoweredDirectExpression::IntegerBinary {
            ...
            collect_direct()
                ...
                .or_else(|| shared_exact_signed_affine_chain_runtime_parameters(expression))
                .or_else(|| {
                    shared_exact_same_root_affine_product_join_runtime_parameters(expression)
                })
                .or_else(|| {
        ...
        LoweredDirectExpression::IntegerExactCast {
            ...
            shared_roundtrip_exact_cast_runtime_parameters(*scalar_type, operand)
                ...
                .or_else(|| {
                    shared_exact_mixed_shift_chain_cast_runtime_parameters(*scalar_type, operand)
                })
                .or_else(|| {
...
fn shared_exact_computed_prefix_cast_chain_then_computed_suffix_runtime_parameters(
    expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    shared_exact_computed_suffix_runtime_parameters(
        expression,
...
fn shared_exact_computed_prefix_mixed_conversion_chain_then_computed_suffix_runtime_parameters(
    expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    shared_exact_computed_suffix_runtime_parameters(
        expression,
...
fn shared_exact_computed_suffix_runtime_parameters(
    expression: &LoweredDirectExpression,
...
fn shared_exact_computed_prefix_cast_chain_suffix_root_runtime_parameters(
    target_type: IntegerType,
    expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let LoweredDirectExpression::IntegerExactCast {
...
fn shared_exact_computed_prefix_mixed_conversion_chain_suffix_root_runtime_parameters(
    target_type: IntegerType,
    mut expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let mut expected_target = target_type;
...
fn shared_exact_multiply_chain_cast_runtime_parameters(
    target_type: ScalarType,
    mut operand: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let ScalarType::Integer(target_type) = target_type else {
...
fn shared_exact_mixed_shift_chain_cast_runtime_parameters(
    target_type: ScalarType,
    operand: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let ScalarType::Integer(target_type) = target_type else {
...
fn shared_exact_shift_right_chain_cast_runtime_parameters(
    target_type: ScalarType,
    mut operand: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let ScalarType::Integer(target_type) = target_type else {
...
fn shared_exact_mixed_add_subtract_chain_runtime_parameters(
    mut expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let mut chain_type = None;
...
fn shared_exact_affine_chain_runtime_parameters(
    mut expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let mut chain_type = None;
...
fn shared_exact_shift_then_arithmetic_runtime_parameters(
    mut expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
...
fn shared_exact_affine_cast_affine_runtime_parameters(
    mut expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
...
fn shared_exact_signed_affine_cast_affine_runtime_parameters(
    mut expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let mut target_type = None;
...
fn negated_lowered_signed_pair((negative, magnitude): (bool, u128)) -> (bool, u128) {
    (magnitude != 0 && !negative, magnitude)
}

fn checked_lowered_affine_pair_step(
...
fn lowered_affine_landed_literal_pair(
    integer_type: IntegerType,
    expression: &LoweredDirectExpression,
) -> Option<(bool, u128)> {
    let LoweredDirectExpression::IntegerLiteral { value, scalar_type } = expression else {
...
fn shared_exact_affine_fork_branch_parameters(
    mut expression: &LoweredDirectExpression,
...
fn shared_exact_affine_fork_join_runtime_parameters(
    expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let LoweredDirectExpression::IntegerBinary {
        kind:
...
fn shared_exact_distinct_root_affine_fork_join_runtime_parameters(
    expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let LoweredDirectExpression::IntegerBinary {
        kind: LoweredIntegerBinaryKind::ExactAdd | LoweredIntegerBinaryKind::ExactSubtract,
...
fn shared_exact_same_root_affine_product_join_runtime_parameters(
    expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let LoweredDirectExpression::IntegerBinary {
        kind: LoweredIntegerBinaryKind::ExactMultiply,
...
fn shared_exact_same_root_affine_divide_remainder_join_runtime_parameters(
    expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let LoweredDirectExpression::IntegerBinary {
        kind: LoweredIntegerBinaryKind::ExactDivide | LoweredIntegerBinaryKind::ExactRemainder,
...
fn shared_exact_runtime_divisor_chain_runtime_parameters(
    mut expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let mut chain_type = None;
...
fn shared_exact_cast_then_mixed_shift_runtime_parameters(
    mut expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let mut value_type = None;
    let mut saw_left = false;
...
fn shared_exact_shift_cast_shift_runtime_parameters(
    mut expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let mut target_type = None;
    loop {
...
fn lowered_exact_cross_cast_chain_family(
    expression: &LoweredDirectExpression,
...
fn lowered_exact_cross_cast_chain_link<'a>(
...
fn lowered_exact_cross_cast_parameter_root(
    mut expression: &LoweredDirectExpression,
    family: ExactCrossCastChainFamily,
...
fn shared_exact_divide_remainder_cross_cast_runtime_parameters(
    mut expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
...
fn shared_exact_cast_then_shift_left_runtime_parameters(
    mut expression: &LoweredDirectExpression,
) -> Option<BTreeSet<SharedBooleanRuntimeInput>> {
    let mut chain_type = None;
    loop {
