...
/// Reconstruct the exact logical facts generated by the initial executable
/// vocabulary. The validator has already established one reachable,
/// unconditional path, so each listed operation and edge executes.
