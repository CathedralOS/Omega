...
use integer_affine::{
    ...
    exact_integer_signed_affine_replay, integer_offset_ceil_div, integer_offset_floor_div,
};
#[cfg(test)]
...
use integer_shift::{
    ...
    exact_integer_mixed_shift_chain_obligation, exact_integer_mixed_shift_preimage,
    exact_integer_shift_cast_shift_obligation, exact_integer_shift_left_chain_obligation,
    exact_integer_shift_right_chain_cast_interval_obligation,
};
use integer_shift::{
    exact_integer_mixed_shift_chain_cast_obligation, exact_integer_shift_cast_affine_obligation,
    exact_integer_shift_left_chain_cast_obligation, exact_integer_shift_left_obligation,
    exact_integer_shift_obligation, exact_integer_shift_prefix_interval_obligation,
    exact_integer_shift_right_chain_cast_obligation,
    exact_integer_shift_then_arithmetic_chain_obligation,
    exact_integer_shifted_interval_obligation,
};
