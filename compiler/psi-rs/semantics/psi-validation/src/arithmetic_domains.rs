...
use dependent_relations::{
    dependent_maximum_of_type_reference, refine_dependent_subtract,
    validation_state_preserves_field,
};
...
impl ValueEnv {
    ...
    fn proves_signed_joint_subtract_lower_bound(
        &self,
        program: &TypedTrees,
        left: ExpressionHandle,
        right: ExpressionHandle,
    ...
    fn proves_joint_multiply_bound(
        &self,
        program: &TypedTrees,
        left: ExpressionHandle,
        right: ExpressionHandle,
...
struct AbstractSpecificationBindings<'program> {
...
fn abstract_specification_place_type(
    program: &TypedTrees,
