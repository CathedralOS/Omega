            ...
            for statement in program.statement_table.statements(state.statement_nodes) {
                ...
                for member in program.data_members(data) {
                    match member {
                        ...
                        psi_typed_trees::data::DataMember::Variant(_) => {
                            has_variants = true;
                        }
                    }
                }
...
fn validate_arm_pattern_marker(
    ...
    if is_captured_transition_subject(program, local.initial_value)
        ...
        && data.properties.multiplicity != psi_language_semantics::Multiplicity::Unrestricted
    {
        diagnostics.push(Diagnostic::error(format!(
    ...
    let declared_fields: Vec<&str> = if variant.is_empty() {
        ...
        let Some(case) = program
            ...
            .find_map(|member| match member {
                psi_typed_trees::data::DataMember::Variant(case)
