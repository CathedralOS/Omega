//! Runtime and proof-machine recursion validation.
//!
//! This module owns recursive-call position checks and the structural or
//! cited decrease proofs for measured recursion. The parent call validator
//! controls traversal and diagnostic ordering.
