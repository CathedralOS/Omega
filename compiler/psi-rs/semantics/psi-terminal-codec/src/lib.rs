...
use psi_core::{
    ClaimId, ContentTerm, ObligationId, Proposition, PropositionError, PropositionId,
    PsiSemanticId, ScalarTerm, ServiceId, StructuralPlaceKind, StructuralTypeId,
};
use psi_terminal::{
    CrashRouteBucket, CrashRouteGuard, FloatProjectionInputId, NominalAffineCleanup, Operation,
    OperationKind, OperationResult, ProofPropositionId, ProofValueId, StructuralAffineDiscard,
