...
pub(super) fn return_width(architecture: crate::target::Architecture) -> usize {
    crate::architecture::return_width(architecture)
}

pub(super) fn dispatch_loop_enter_width(architecture: crate::target::Architecture) -> usize {
    crate::architecture::dispatch_loop_enter_width(architecture)
}

pub(super) fn dispatch_case_enter_width(architecture: crate::target::Architecture) -> usize {
    crate::architecture::dispatch_case_enter_width(architecture)
}

pub(super) fn dispatch_state_write_width(architecture: crate::target::Architecture) -> usize {
    crate::architecture::dispatch_state_write_width(architecture)
}

pub(super) fn dispatch_case_leave_width(architecture: crate::target::Architecture) -> usize {
...
pub(super) fn runtime_storage_compare_width(architecture: crate::target::Architecture) -> usize {
