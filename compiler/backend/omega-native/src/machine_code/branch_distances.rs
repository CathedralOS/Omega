...
use super::model::{MachineInstruction, MachineInstructionKind};

pub(super) fn byte_distance_to_case_end(
...
pub(super) fn byte_distance_to_next_state_write_end(
    machine_instructions: &[MachineInstruction],
    machine_instruction_index: usize,
) -> Result<isize, Diagnostic> {
    let Some(current) = machine_instructions.get(machine_instruction_index) else {
...
pub(super) fn byte_distance_to_case_leave(
    machine_instructions: &[MachineInstruction],
    machine_instruction_index: usize,
) -> Result<isize, Diagnostic> {
    let Some(current) = machine_instructions.get(machine_instruction_index) else {
...
pub(super) fn byte_distances_to_next_runtime_machine_write_end(
...
pub(super) fn byte_distance_to_next_runtime_write_end(
    native_plan: &NativePlan,
    machine_instructions: &[MachineInstruction],
    machine_instruction_index: usize,
) -> Result<isize, Diagnostic> {
...
pub(super) fn byte_distance_to_next_runtime_write_end_from_branch_offset(
    native_plan: &NativePlan,
    machine_instructions: &[MachineInstruction],
    machine_instruction_index: usize,
    branch_offset: usize,
...
pub(super) fn byte_distance_to_dispatch_loop_start(
    machine_instructions: &[MachineInstruction],
    machine_instruction_index: usize,
) -> Result<isize, Diagnostic> {
    let Some(current) = machine_instructions.get(machine_instruction_index) else {
