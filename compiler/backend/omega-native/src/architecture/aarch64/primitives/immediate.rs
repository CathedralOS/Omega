...
pub(in crate::architecture::aarch64) fn encode_movz(register: u8, immediate: u16) -> Vec<u8> {
    encode_instruction(0xD2800000 | (u32::from(immediate) << 5) | u32::from(register))
}

pub(in crate::architecture::aarch64) fn encode_movz_w(register: u8, immediate: u16) -> Vec<u8> {
    encode_instruction(0x52800000 | (u32::from(immediate) << 5) | u32::from(register))
}

pub(in crate::architecture::aarch64) fn encode_movk(
    register: u8,
    immediate: u16,
    halfword_shift: u8,
) -> Vec<u8> {
...
pub(in crate::architecture::aarch64) fn encode_adrp_placeholder(register: u8) -> Vec<u8> {
    encode_instruction(0x90000000 | u32::from(register))
}

pub(in crate::architecture::aarch64) fn encode_add_page_offset_placeholder(
    register: u8,
) -> Vec<u8> {
    encode_instruction(0x91000000 | (u32::from(register) << 5) | u32::from(register))
}

pub(in crate::architecture::aarch64) fn encode_immediate(
    register: u8,
    value: i64,
...
pub(in crate::architecture::aarch64) fn encode_unsigned_immediate(
    register: u8,
    value: u64,
) -> Vec<u8> {
...
pub(in crate::architecture::aarch64) fn halfword(value: u64, halfword_shift: u8) -> u16 {
