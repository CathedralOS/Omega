...
step "forall-input theorem — count(xs,n)=len(xs)+n proven for ALL inputs by induction (check.beta + check_ref; perturbation rejected)" delta forall-input.sh beta beta-lang beta-lang-rs
