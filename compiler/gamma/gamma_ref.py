...
# MEAN, and delta proves theorems ABOUT that meaning, so interp.beta's correctness underpins the proof edifice.
# interp.beta is cross-checked on fixed corpora and (for arithmetic) against delta's normalizer, but its
