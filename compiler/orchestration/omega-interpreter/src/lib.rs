...
//! passing; `dyn Trait` dispatch by the receiver's RUNTIME type (works for any number of
...
//!
//! Still deferred: string concatenation host paths and the deepest recursion-heavy
//! dungeon `&mut` chains.
