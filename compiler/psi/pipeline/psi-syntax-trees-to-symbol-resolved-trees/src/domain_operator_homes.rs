use psi_arena::{Arena, HandleSpan, OrderedRootArena};
...
fn domain_accepts_carrier(
    ...
    carrier: &psi_symbol_resolved_trees::types::TypeReference,
    ...
    matches!(
        &domain.target_type,
        psi_symbol_resolved_trees::types::TypeReference::Named { name, .. }
...
fn type_references_match(
    program: &SymbolResolvedTrees,
    left: &psi_symbol_resolved_trees::types::TypeReference,
    right: &psi_symbol_resolved_trees::types::TypeReference,
) -> bool {
