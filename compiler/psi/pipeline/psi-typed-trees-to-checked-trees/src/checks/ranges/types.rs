...
fn dependent_range_of_type_reference(
    program: &psi_typed_trees::TypedTrees,
    handle: TypeReferenceHandle,
) -> Option<(i64, psi_typed_trees::dependent_ranges::SymbolicMaxBound)> {
    match program.type_reference_table.type_reference(handle) {
        ...
        TypeReferenceNode::Constrained {
            ...
            if constraints.iter().any(|constraint| {
                matches!(
                    constraint,
                    psi_typed_trees::types::TypeConstraintNode::ArithmeticDomain(domain)
...
fn data_field_type_reference(
    ...
    member_name: &psi_typed_trees::name::Identifier,
) -> Option<TypeReferenceHandle> {
    match program.type_reference_table.type_reference(type_reference) {
        TypeReferenceNode::Reference { referee, .. }
        | TypeReferenceNode::Constrained {
