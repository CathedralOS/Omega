    ...
    match program.type_reference_table.type_reference(type_reference) {
        ...
        TypeReferenceNode::Constrained {
            ...
            program
                ...
                .iter()
                .any(|constraint| matches!(constraint, omega_typed_trees::types::TypeConstraintNode::Domain(candidate) if candidate.symbol == domain))
    ...
    !call.receiver.is_valid()
        ...
        && (!call.target_symbol.is_valid()
            || (program.symbols.get(call.target_symbol).kind
                == omega_core::symbols::SymbolKind::BuiltinFunction
