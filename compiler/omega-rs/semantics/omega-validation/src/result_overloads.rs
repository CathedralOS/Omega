...
fn select_overload_symbol(
    program: &TypedTrees,
    provisional_identity: &omega_typed_trees::type_identity::NormalizedNamedCallableIdentity,
    overloads: &[(
        SymbolHandle,
        omega_typed_trees::type_identity::NormalizedNamedCallableIdentity,
    )],
    expected_result: Option<TypeReferenceHandle>,
    diagnostics: &mut Vec<Diagnostic>,
    kind: &str,
...
mod tests {
    ...
    use omega_typed_trees::statement::{StatementNode, TableCall, TableLocalData};
