...
fn float_to_integer_cast_is_proven(
    program: &TypedTrees,
    machine: &omega_typed_trees::machine::Machine,
    state: Option<&omega_typed_trees::state::State>,
    value: ExpressionHandle,
...
fn transition_target_names_state(
    ...
    let omega_typed_trees::statement::TransitionTargetNode::Named { path, .. } =
...
fn flip_comparison(
    operator: omega_typed_trees::expression::BinaryOperator,
) -> omega_typed_trees::expression::BinaryOperator {
    use omega_typed_trees::expression::BinaryOperator;
    match operator {
...
fn negate_float_comparison(
    operator: omega_typed_trees::expression::BinaryOperator,
) -> Option<omega_typed_trees::expression::BinaryOperator> {
    use omega_typed_trees::expression::BinaryOperator;
    Some(match operator {
