...
use omega_typed_trees::type_identity::NormalizedNamedCallableIdentity;
...
mod tests {
    ...
    use omega_core::semantics::{DomainPredicateBody, DomainSemanticRoles};
    use omega_core::symbols::SymbolHandle;
    use omega_typed_trees::TypedTrees;
    use omega_typed_trees::machine::Machine;
    use omega_typed_trees::name::Identifier;
    use omega_typed_trees::state::State;
    use omega_typed_trees::types::{DomainConstraint, TypeConstraintNode, TypeReferenceNode};

    fn machine(
        program: &mut TypedTrees,
        machine_symbol: u32,
        state_symbol: u32,
        result: omega_typed_trees::types::TypeReferenceHandle,
    ) -> Machine {
        let state = State {
