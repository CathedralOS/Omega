...
pub use host::{
    ...
    encode_function_enter_bytes, encode_host_call_sequence, encode_host_call_sequence_with_plan,
    encode_interrupt_control_bytes, encode_linux_timespec_argument_syscall_with_plan,
    ...
    encode_value_syscall_sequence_with_plan, encode_vtable_call_sequence_at_offset_with_plan,
    encode_vtable_call_sequence_with_plan, foreign_float_control_prefix_width,
    foreign_float_control_trampoline_width, linux_timespec_argument_relocation_byte_offset,
...
pub use runtime_text::{
    ...
    encode_runtime_text_line_read_with_plan, encode_runtime_text_line_read_with_plans,
