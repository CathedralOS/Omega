...
pub use host::{
    ...
    encode_host_call_sequence, encode_return_bytes, encode_return_register_integer_write_bytes,
    encode_runtime_storage_copy_to_return_register_bytes, encode_syscall_sequence,
    encode_vtable_call_sequence,
};
pub use runtime_storage::{
    ...
    encode_runtime_machine_bounded_buffer_write,
    ...
    encode_runtime_pointee_binary_write, encode_runtime_pointee_bounded_buffer_write,
    encode_runtime_pointee_integer_write, encode_runtime_pointee_string_write,
