...
pub use runtime_storage::{
    ...
    WritePlaceShape, classify_write_place_shape, encode_write_place_integer,
    write_place_integer_width,
    encode_runtime_storage_compare_bytes, encode_runtime_storage_convert,
    x86_64_encode_copy_places_with_sites, x86_64_encode_write_place_integer_with_sites,
