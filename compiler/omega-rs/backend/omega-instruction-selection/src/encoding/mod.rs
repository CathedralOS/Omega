...
pub use runtime_storage::{
    ...
    classify_frame_base_double_indexed_integer_shape, classify_frame_base_indexed_binary_shape,
    classify_frame_base_indexed_bounded_buffer_shape, classify_frame_base_indexed_convert_shape,
    classify_frame_base_indexed_integer_shape, classify_frame_base_indexed_string_shape,
    classify_write_place_shape, encode_append_place_bounded_buffer_literal,
    encode_append_place_bounded_buffer_source, encode_atomic_compare_exchange,
    encode_atomic_fetch_add, encode_atomic_fetch_and, encode_atomic_fetch_or,
