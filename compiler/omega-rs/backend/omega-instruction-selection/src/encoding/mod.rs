...
pub use runtime_storage::{
    ...
    encode_atomic_compare_exchange, encode_atomic_fetch_add, encode_atomic_load_to_storage,
    encode_atomic_store_from_operand, encode_copy_places, encode_place_compare_bytes,
