...
pub use host::{
    ...
    encode_function_enter_bytes, encode_generated_idt_load_bytes,
    encode_generated_idt_writer_bytes, encode_host_call_sequence, encode_interrupt_control_bytes,
    encode_linux_timespec_argument_syscall_with_plan, encode_linux_timespec_syscall_with_plan,
    ...
    encode_syscall_sequence_with_plan, encode_table_function_call_sequence,
    encode_table_function_call_sequence_with_plan, encode_vtable_call_sequence,
    encode_vtable_call_sequence_at_offset, encode_vtable_call_sequence_at_offset_with_plan,
    encode_vtable_call_sequence_with_plan, linux_timespec_argument_relocation_byte_offset,
    linux_timespec_result_relocation_byte_offset, normalized_aarch64_host_argument_placements,
...
pub use runtime_storage::{
    ...
    classify_copy_places_shape, classify_write_place_shape,
    ...
    encode_write_place_binary, encode_write_place_bounded_buffer, encode_write_place_convert,
    encode_write_place_integer, encode_write_place_string, place_binary_index_base_positions,
    place_binary_operand_start_width, place_compare_width, place_frame_deref_indexed_path,
    place_value_compare_width, write_place_address_width, write_place_binary_width,
    ...
    x86_64_encode_place_value_compare_with_sites, x86_64_encode_write_place_address_with_sites,
    x86_64_encode_write_place_binary_with_sites,
