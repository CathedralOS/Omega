...
pub use host::{
    ...
    encode_linux_timespec_argument_syscall, encode_linux_timespec_argument_syscall_with_plan,
    encode_linux_timespec_syscall, encode_linux_timespec_syscall_with_plan,
