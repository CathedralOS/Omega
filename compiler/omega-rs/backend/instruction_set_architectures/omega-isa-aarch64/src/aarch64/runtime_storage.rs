...
use super::primitives::{
    ...
    encode_add_x_register, encode_adrp_placeholder, encode_and_w_low_ones, encode_and_w_top_bit,
    encode_and_x_low_ones, encode_and_x_register, encode_and_x_top_bit, encode_asrv_w_register,
    encode_asrv_x_register, encode_brk, encode_cbz_x, encode_compare_w_immediate,
    ...
    encode_float_add, encode_float_compare, encode_float_conditional_select, encode_float_divide,
    encode_float_fused_multiply_add, encode_float_move_from_gpr, encode_float_move_to_gpr,
    encode_float_multiply, encode_float_sqrt, encode_float_subtract, encode_load_byte_w_from_x,
    encode_load_byte_w_post_increment, encode_load_w_from_x, encode_load_x_from_x,
    encode_lsl_x_immediate, encode_lslv_w_register, encode_lslv_x_register, encode_lsr_x_immediate,
    encode_lsrv_w_register, encode_lsrv_x_register, encode_move_w_register, encode_move_x_register,
    encode_movz, encode_movz_w, encode_msub_w_register, encode_msub_x_register,
    encode_mul_x_register, encode_orr_x_register, encode_read_fpcr, encode_sdiv_w_register,
    encode_sdiv_x_register, encode_sign_extend_byte_to_w, encode_sign_extend_byte_to_x,
    encode_sign_extend_halfword_to_w, encode_sign_extend_halfword_to_x,
    encode_sign_extend_word_to_x, encode_store_byte_w_post_increment, encode_store_byte_w_to_x,
    encode_store_w_to_x, encode_store_w17_to_x16, encode_store_x_to_x, encode_store_x17_to_x16,
    encode_sub_x_register, encode_subs_x_immediate, encode_udiv_w_register, encode_udiv_x_register,
...
#[cfg(test)]
use super::primitives::{encode_atomic_load, encode_atomic_store, encode_ldadd, encode_swp};
...
pub fn encode_runtime_frame_base_double_indexed_bounded_buffer_write(
    ...
    let expected_width =
        super::widths::runtime_frame_base_double_indexed_bounded_buffer_write_width(literal);
...
pub fn encode_runtime_frame_base_double_indexed_string_write(
    ...
    let expected_width =
        super::widths::runtime_frame_base_double_indexed_string_write_width(byte_length);
    let mut bytes = Vec::with_capacity(expected_width);
    bytes.extend(encode_adrp_placeholder(16));
    bytes.extend(encode_add_page_offset_placeholder(16));
    append_double_index_address_math(
...
pub fn encode_runtime_storage_copy_frame_base_indexed_to_frame_base_indexed(
    ...
    let expected_width =
        super::widths::runtime_storage_copy_frame_base_indexed_to_frame_base_indexed_width(
            source_index_region,
            target_index_region,
            byte_count,
        );
...
pub fn encode_runtime_storage_copy_cross_region_indexed_pair(
    ...
    let expected_width =
        super::widths::runtime_storage_copy_cross_region_indexed_pair_width(byte_count);
    let mut bytes = Vec::with_capacity(expected_width);
    bytes.extend(encode_adrp_placeholder(16));
    bytes.extend(encode_add_page_offset_placeholder(16));
    bytes.extend(encode_adrp_placeholder(15));
...
pub fn encode_runtime_storage_copy_frame_base_double_indexed_to_frame_base_double_indexed(
    ...
    let expected_width = super::widths::runtime_storage_copy_frame_base_double_indexed_to_frame_base_double_indexed_width(
