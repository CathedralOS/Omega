...
pub use place_copy::{
    ...
    copy_places_to_machine_indexed_clobbers, copy_places_to_pointee_clobbers,
    direct_place_integer_write_clobbers, encode_copy_places, encode_place_address_write,
