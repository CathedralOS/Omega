...
pub use place_copy::{
    ...
    copy_places_pointee_pair_clobbers, copy_places_to_indexed_clobbers,
    copy_places_to_machine_double_indexed_clobbers, copy_places_to_machine_indexed_clobbers,
