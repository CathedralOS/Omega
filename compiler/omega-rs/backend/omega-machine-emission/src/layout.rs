...
use omega_instruction_selection::{
    ...
    runtime_atomic_fetch_add_width, runtime_atomic_fetch_or_width, runtime_atomic_fetch_sub_width,
    ...
    runtime_byte_write_width, runtime_frame_base_indexed_binary_write_width,
    runtime_frame_base_indexed_integer_write_width, runtime_frame_indexed_binary_write_width,
    runtime_frame_indexed_integer_write_width, runtime_machine_bounded_buffer_literal_append_width,
