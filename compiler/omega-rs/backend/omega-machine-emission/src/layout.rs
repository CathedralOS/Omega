...
use omega_instruction_selection::{
    ...
    entry_arguments_slice_descriptor_write_width, entry_stack_argument_write_width,
    flags_restore_width, flags_snapshot_width, function_enter_width, host_call_sequence_width,
