...
pub(super) fn encode_runtime_frame_fixed_indexed_address_to_runtime_frame_write(
    input: MachineEmissionContext<'_>,
    descriptor_offset: usize,
    element_index: usize,
    element_byte_size: usize,
    ...
    architecture::encode_runtime_frame_fixed_indexed_address_to_runtime_frame_write(
        input.target.architecture,
        descriptor_offset,
        element_index,
        element_byte_size,
