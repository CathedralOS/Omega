...
pub(super) fn outbound_syscall_argument_storage_sites(
    architecture: Architecture,
...
pub(super) fn outbound_syscall_argument_data_sites(
    architecture: Architecture,
    arguments: &[omega_target_operations::InstructionOperand],
    data_symbols: &[std::sync::Arc<str>],
...
pub(super) fn outbound_syscall_data_relocation_targets(
...
pub(super) struct RuntimeTextReplay {
    pub(super) bytes: Vec<u8>,
    pub(super) call_sites: Vec<(usize, std::sync::Arc<str>, std::sync::Arc<str>)>,
    pub(super) address_sites: Vec<(usize, OutboundCallRelocationTarget)>,
}

#[allow(clippy::too_many_arguments)]
pub(super) fn encode_runtime_byte_replay(
    architecture: Architecture,
    read: bool,
...
#[allow(clippy::too_many_arguments)]
pub(super) fn encode_runtime_line_read_replay(
    architecture: Architecture,
...
pub(super) fn encode_linux_timespec_result_outbound_syscall(
    architecture: Architecture,
    operands: &[omega_target_operations::InstructionOperand],
    number: u32,
    plan: &omega_calling_conventions::CallPlan,
...
pub(super) fn encode_linux_timespec_argument_outbound_syscall(
    architecture: Architecture,
    operands: &[omega_target_operations::InstructionOperand],
    number: u32,
    plan: &omega_calling_conventions::CallPlan,
...
pub(super) fn encode_simple_outbound_syscall(
    architecture: Architecture,
    operands: &[omega_target_operations::InstructionOperand],
    number: u32,
    plan: &omega_calling_conventions::CallPlan,
