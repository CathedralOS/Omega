...
use omega_terminal_assigned_target_operations::{
    ...
    TerminalAssignedScalarExpression,
};
use omega_terminal_machine_code::{
    TerminalBooleanStructuralConditionEvidence, TerminalInternalCallRelocation,
...
pub(crate) struct EmissionFragment {
    ...
    pub(crate) internal_calls: Vec<TerminalInternalCallRelocation>,
    pub(crate) conditional: Option<Vec<TerminalScalarConditionalBranchEvidence>>,
}
...
pub(crate) fn linear_boolean_expression(expression: &TerminalAssignedBooleanExpression) -> bool {
    match expression {
...
pub(crate) fn expression_source(expression: &TerminalAssignedIntegerExpression) -> ValueId {
    match expression {
...
pub(crate) fn boolean_expression_source(expression: &TerminalAssignedBooleanExpression) -> ValueId {
    match expression {
