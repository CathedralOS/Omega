...
use omega_terminal_machine_code::{
    ...
    TerminalScalarStackMutationKind,
};
...
use super::{
    ...
    aarch64_unit_stack_access, stack_adjustment_pair, x86_unit_register,
};

pub(super) fn emit_native_crash(architecture: Architecture) -> Vec<u8> {
    match architecture {
...
pub(super) struct EmissionFragment {
    pub(super) bytes: Vec<u8>,
    pub(super) internal_calls: Vec<TerminalInternalCallRelocation>,
    pub(super) conditional: Option<Vec<TerminalScalarConditionalBranchEvidence>>,
}
...
fn top_level_integer_conditional_evidence(
...
pub(super) fn emit_x86_64_conditional_integer_control(
...
pub(super) fn emit_x86_64_conditional_integer_expression_control(
...
pub(super) fn emit_x86_64_conditional_boolean_control(
    condition_source: ValueId,
    condition_location: TerminalAssignedScalarLocation,
...
pub(super) fn emit_x86_64_conditional_boolean_expression_control(
    condition_frame: &TerminalExpressionFrame,
    condition: &TerminalAssignedBooleanExpression,
    when_true: &TerminalAssignedConditionalBooleanArm,
    when_false: &TerminalAssignedConditionalBooleanArm,
...
pub(super) fn emit_x86_64_boolean_control(
...
pub(super) fn emit_aarch64_conditional_integer_control(
    condition_source: ValueId,
    condition_location: TerminalAssignedScalarLocation,
    scalar_type: IntegerType,
    when_true: &TerminalAssignedConditionalIntegerArm,
...
pub(super) fn emit_aarch64_conditional_integer_expression_control(
    condition_frame: &TerminalExpressionFrame,
    condition: &TerminalAssignedBooleanExpression,
    scalar_type: IntegerType,
    when_true: &TerminalAssignedConditionalIntegerArm,
...
pub(super) fn emit_aarch64_conditional_boolean_control(
    condition_source: ValueId,
    condition_location: TerminalAssignedScalarLocation,
    when_true: &TerminalAssignedConditionalBooleanArm,
    when_false: &TerminalAssignedConditionalBooleanArm,
...
pub(super) fn emit_aarch64_conditional_boolean_expression_control(
    condition_frame: &TerminalExpressionFrame,
    condition: &TerminalAssignedBooleanExpression,
    when_true: &TerminalAssignedConditionalBooleanArm,
    when_false: &TerminalAssignedConditionalBooleanArm,
...
pub(super) fn emit_aarch64_boolean_control(
    control: &TerminalAssignedBooleanControl,
    target: NativeTarget,
) -> Result<EmissionFragment, EmissionError> {
    match control {
...
pub(super) fn emit_x86_64_boolean_not_parameter_return(
    source: ValueId,
...
pub(super) fn emit_aarch64_boolean_not_parameter_return(
    source: ValueId,
    location: TerminalAssignedScalarLocation,
) -> Result<Vec<u8>, EmissionError> {
...
pub(super) fn emit_aarch64_condition_load(
    source: ValueId,
    location: TerminalAssignedScalarLocation,
...
pub(super) fn emit_x86_64_boolean_return(value: bool) -> Vec<u8> {
    vec![0xb8, u8::from(value), 0, 0, 0, 0xc3] // mov eax, 0/1; ret
}

pub(super) fn emit_aarch64_boolean_return(value: bool) -> Vec<u8> {
...
pub(super) fn emit_boolean_shared_convergence(
...
pub(super) fn require_native_integer_width(
    source: ValueId,
    scalar_type: IntegerType,
...
pub(super) fn emit_x86_64_parameter_return(
    source: ValueId,
    is_64: bool,
    location: TerminalAssignedScalarLocation,
) -> Result<Vec<u8>, EmissionError> {
...
pub(super) fn emit_aarch64_parameter_return(
    source: ValueId,
    is_64: bool,
    location: TerminalAssignedScalarLocation,
) -> Result<Vec<u8>, EmissionError> {
...
pub(super) fn emit_x86_64_return(scalar_type: IntegerType, bits: u64) -> Vec<u8> {
    let mut bytes = Vec::new();
...
pub(super) fn emit_aarch64_return(scalar_type: IntegerType, bits: u64) -> Vec<u8> {
...
pub(super) fn emit_x86_64_boolean_expression(
...
pub(super) fn emit_x86_64_boolean_condition_value(
    frame: &TerminalExpressionFrame,
    expression: &TerminalAssignedBooleanExpression,
    mut internal_calls: Option<(&mut Vec<TerminalInternalCallRelocation>, NativeTarget)>,
...
pub(super) fn emit_x86_64_integer_expression(
    scalar_type: IntegerType,
    frame: &TerminalExpressionFrame,
...
pub(super) fn emit_x86_64_adjust_sp(bytes: &mut Vec<u8>, byte_size: u32, add: bool) {
    if byte_size <= i8::MAX as u32 {
...
pub(super) fn emit_x86_64_stack_store(bytes: &mut Vec<u8>, register: u8, byte_offset: u32) {
...
pub(super) fn emit_x86_64_stack_load(bytes: &mut Vec<u8>, register: u8, byte_offset: u32) {
    bytes.push(0x48 | (((register >> 3) & 1) << 2));
...
pub(super) fn emit_x86_64_stack_store_width(
    bytes: &mut Vec<u8>,
    register: u8,
    byte_offset: u32,
    byte_size: u16,
...
pub(super) fn emit_x86_64_stack_load_width(
    bytes: &mut Vec<u8>,
    register: u8,
    byte_offset: u32,
    byte_size: u16,
...
pub(super) fn emit_x86_64_memory_load_width(
    bytes: &mut Vec<u8>,
    destination: u8,
    base: u8,
    byte_offset: u32,
...
pub(super) fn emit_aarch64_boolean_expression(
    frame: &TerminalExpressionFrame,
    expression: &TerminalAssignedBooleanExpression,
    internal_calls: Option<(&mut Vec<TerminalInternalCallRelocation>, NativeTarget)>,
) -> Result<Vec<u8>, EmissionError> {
...
pub(super) fn emit_aarch64_boolean_condition_value(
    frame: &TerminalExpressionFrame,
    expression: &TerminalAssignedBooleanExpression,
    mut internal_calls: Option<(&mut Vec<TerminalInternalCallRelocation>, NativeTarget)>,
    structural_reads: Option<&mut Vec<TerminalBooleanStructuralFieldRead>>,
...
pub(super) fn emit_aarch64_integer_expression(
    scalar_type: IntegerType,
    frame: &TerminalExpressionFrame,
    expression: &TerminalAssignedIntegerExpression,
    mut internal_calls: Option<(&mut Vec<TerminalInternalCallRelocation>, NativeTarget)>,
...
pub(super) fn emit_aarch64_adjust_sp(
    instructions: &mut Vec<u32>,
    byte_size: u32,
    add: bool,
) -> Result<(), EmissionError> {
...
pub(super) fn linear_boolean_expression(expression: &TerminalAssignedBooleanExpression) -> bool {
    match expression {
...
pub(super) fn accountable_direct_integer_expression(
    expression: &TerminalAssignedIntegerExpression,
) -> bool {
    match expression {
        TerminalAssignedIntegerExpression::Call { arguments, .. } => arguments
...
pub(super) fn collect_x86_division_branch_evidence(
    bytes: &[u8],
...
pub(super) fn conditional_with_terminal_shape(
    decisions: Vec<TerminalScalarConditionalBranchEvidence>,
...
pub(super) fn direct_conditional_boolean_shape(
    when_true: &TerminalAssignedConditionalBooleanArm,
    when_false: &TerminalAssignedConditionalBooleanArm,
) -> Option<Vec<bool>> {
    fn collect(
...
pub(super) fn direct_conditional_integer_shape(
    when_true: &TerminalAssignedConditionalIntegerArm,
    when_false: &TerminalAssignedConditionalIntegerArm,
) -> Option<Vec<bool>> {
    fn collect(
...
pub(super) fn accountable_conditional_boolean_expression(
    expression: &TerminalAssignedBooleanExpression,
) -> bool {
    match expression {
        TerminalAssignedBooleanExpression::Call { arguments, .. } => arguments
...
fn accountable_conditional_call_argument_expression(
    expression: &TerminalAssignedScalarExpression,
) -> bool {
    match expression {
        TerminalAssignedScalarExpression::Boolean(expression) => {
...
pub(super) fn collect_scalar_stack_evidence(
    architecture: Architecture,
    bytes: &[u8],
...
pub(super) const fn aarch64_csel(destination: u8, left: u8, right: u8, condition: u8) -> u32 {
    0x9a80_0000
        | ((right as u32) << 16)
        | ((condition as u32) << 12)
        | ((left as u32) << 5)
