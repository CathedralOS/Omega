...
pub fn map_owned(
    ...
    identity: MappingId,
    grant: &MappingGrant,
) -> Result<MappedExtent<'static>, Box<OwnedMappingError>> {
...
pub fn map_borrowed<'source>(
    ...
    identity: MappingId,
    grant: &MappingGrant,
) -> Result<MappedExtent<'source>, Box<BorrowedMappingError<'source>>> {
...
fn map_with_source<'source>(
    ...
    identity: MappingId,
    grant: &MappingGrant,
) -> Result<MappedExtent<'source>, Box<MappingStartError<'source>>> {
