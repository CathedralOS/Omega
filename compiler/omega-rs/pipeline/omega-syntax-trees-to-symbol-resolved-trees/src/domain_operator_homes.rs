use omega_core::arena::{Arena, HandleSpan, OrderedRootArena};
...
fn type_references_match(
    program: &SymbolResolvedTrees,
    left: &omega_symbol_resolved_trees::types::TypeReference,
    right: &omega_symbol_resolved_trees::types::TypeReference,
) -> bool {
