...
fn check(source: &str) -> omega_checked_trees::CheckedTrees {
...
fn specializations_for<'program>(
    checked: &'program omega_checked_trees::CheckedTrees,
    machine_name: &str,
) -> Vec<&'program omega_typed_trees::typed_trees::MachineSpecialization> {
    checked
