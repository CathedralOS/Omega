use omega_checked_trees::FlowStateFact;
use omega_core::diagnostics::Diagnostic;
use omega_facts::{FactOrigin, ProgramPoint};
...
fn target_is_self(program: &omega_typed_trees::TypedTrees, target: TransitionTargetHandle) -> bool {
    matches!(
