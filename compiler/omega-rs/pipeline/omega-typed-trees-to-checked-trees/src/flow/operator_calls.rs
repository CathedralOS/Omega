...
pub(super) struct ResolvedOperatorStatementCall<'program> {
    pub(super) operator: &'program omega_typed_trees::operator::OperatorDefinition,
...
fn operator_statement_operands<'program>(
    ...
    &'program omega_typed_trees::operator::OperatorDefinition,
...
pub(super) fn append_operator_statement_ensures(
    ...
    {
        if contract.kind != omega_typed_trees::signature::SignatureContractKind::Ensures {
            continue;
        }
