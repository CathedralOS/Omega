...
mod tests {
    ...
    fn operator_acceptance_counts_contract_evidence() {
        ...
        let operator_use = ContractOperatorUseFact {
            requires: HandleSpan::from_parts(omega_core::arena::Handle::from_arena_index(1), 2),
            ensures: HandleSpan::from_parts(omega_core::arena::Handle::from_arena_index(3), 1),
            boundary: HandleSpan::from_parts(omega_core::arena::Handle::from_arena_index(4), 1),
            ..Default::default()
        };
