...
fn task_activation_manifest_retains_exact_target_overload_identity() {
    ...
    let plan =
        omega_task_plans::validate_activation_plan(omega_task_plans::ActivationPlanCandidate {
            ...
            terminal_outcome_layout: omega_task_plans::ValueLayoutId::from_normalized_identity(4)
            ...
            stack_plan: omega_task_plans::StackPlan {
                bytes: 4096,
                alignment: 16,
                representation: omega_task_plans::StackRepresentationId::from_normalized_identity(
                    6,
                )
