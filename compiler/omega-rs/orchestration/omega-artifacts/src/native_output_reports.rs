//! Native emission, installation, and finalization artifact presentation.
...
use super::{ArtifactWriter, EmissionPlan, ExecutableFinalization, ExecutableFinalizationStatus};
