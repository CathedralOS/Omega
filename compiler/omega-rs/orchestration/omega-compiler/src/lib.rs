...
pub use pipeline::{
    ...
    BuildEvaluationUsage, ByteOrder, CheckedCompilation, CompileOptions, CompileReport,
    ConsumptionInstant, DataSymbolId, EntryStubId, ExecutableTcbBuildPolicy,
    ...
    ValidatedAccessPlan, ValidatedPlacementPlan, bind_external_root_post_handoff_writer_invocation,
    bind_generated_program_storage_entry_plan, bind_program_storage_entry_plan, compile,
    compile_to_checked, compile_with_policy, compute_access_plan, compute_layout_plan,
    compute_placement_plan, decode_scalar_layout, derive_symbolic_materialization,
    evaluate_calling_policy_plan, install_program_storage_entry_roots,
