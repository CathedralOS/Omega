...
pub use pipeline::{
    ...
    MaterializationDiagnostic, MaterializationWrite, ProgramStorageEntryDiagnostic,
    ProgramStorageEntryParameter, ProgramStorageEntryPlanBinding, ProgramStorageRootInput,
