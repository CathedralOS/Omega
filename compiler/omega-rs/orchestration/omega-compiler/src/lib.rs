...
pub use pipeline::{
    ...
    CompileReport, ConsumptionInstant, DataSymbolId, EntryStubId, LayoutFieldEntryReport,
    ...
    ScalarFieldValue, SelectedExternalRootEntryFactBinding, SelectedExternalRootProviderPlan,
