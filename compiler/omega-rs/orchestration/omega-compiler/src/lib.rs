...
pub use pipeline::{
    ...
    ProgramStorageEntryProviderInvocation, ProgramStorageEntryRootRole,
    ProgramStorageEntrySourceContinuationHandoff, ProgramStorageEntryWrapperReceiverTransfer,
