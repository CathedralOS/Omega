...
pub use pipeline::{
    ...
    SelectedExternalRootProviderPlan, SymbolicFieldValue, SymbolicMaterializationPlan,
    ValidatedAccessPlan, ValidatedPlacementPlan, compile, compile_to_checked, compute_access_plan,
    compute_layout_plan, compute_placement_plan, decode_scalar_layout,
    derive_symbolic_materialization, evaluate_calling_policy_plan, materialize_scalar_layout_into,
