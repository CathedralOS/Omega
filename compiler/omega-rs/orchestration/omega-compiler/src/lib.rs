...
pub use pipeline::{
    ...
    RelocationTarget, ScalarFieldSchema, ScalarFieldValue, SelectedExternalRootEntryFactBinding,
    SelectedExternalRootProviderPlan, SelectedProgramStorageEntryPlan, SymbolicFieldValue,
