...
pub use pipeline::{
    ...
    MaterializationDiagnostic, MaterializationWrite, RelocationTarget, ScalarFieldValue,
    ...
    lower_populated_idt_writer, lower_prepared_idt_load, materialize_scalar_layout_into,
