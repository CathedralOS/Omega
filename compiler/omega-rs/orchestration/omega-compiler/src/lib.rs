...
pub use pipeline::{
    ...
    ValidatedAccessPlan, ValidatedPlacementPlan, bind_emitted_program_storage_entry_native_bridge,
    bind_external_root_post_handoff_writer_invocation, bind_generated_program_storage_entry_plan,
    bind_program_storage_entry_plan, compile, compile_to_checked, compile_with_artifact_policy,
    compile_with_policy, compile_with_test_entry, compile_with_test_entry_and_artifact_policy,
    compile_with_test_entry_and_worker_count,
    compile_with_test_entry_worker_count_and_artifact_policy,
    compile_with_worker_count_and_artifact_policy, compute_access_plan, compute_layout_plan,
