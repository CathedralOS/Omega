...
const PENDING_RUNTIME_DIVERGENCES: &[(&str, i32, PendingInterpOutcome)] = &[
    ...
    // The fused call-arg computation is silently DROPPED natively (no
    // MachineIndexed operand variant + a missing blocker); interp correct.
    ("slices/machine_array_element_fused_call_arg", 71, PendingInterpOutcome::Exit(70)),
];
