...
const PENDING_RUNTIME_DIVERGENCES: &[(&str, i32, PendingInterpOutcome)] = &[
    ...
    // The bind-first pairing's missing result->local copy (composition-
    // dependent; see the canary header). Interp correct.
    ("calls/recursive_result_bind_first_arg", 73, PendingInterpOutcome::Exit(70)),
];
