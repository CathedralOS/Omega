#!/usr/bin/env python3
"""Lower-rooted OMGRFN17 reference orchestration."""
...
def reference_gate() -> None:
    ...
    print(
        f"OMGRFN17 reference integration: Python owners {python_elapsed:.2f}s; "
...
if __name__ == "__main__":
    try:
        ...
        print(f"OMGRFN17 reference integration: {error}", file=sys.stderr)
        raise SystemExit(1)
