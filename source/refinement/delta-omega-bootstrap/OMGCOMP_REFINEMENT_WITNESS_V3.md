...
[`role3_resolution_fixture.py`](../../on-ramp/omega-bootstrap/gates/role3_resolution_fixture.py).
...
[`OMEGA_BOOTSTRAP_CHECKED_IR_V2.md`](../../on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V2.md).
