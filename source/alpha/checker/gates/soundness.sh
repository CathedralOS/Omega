...
no "late rewrite changes lemma meaning" "(data 2 0 0 0) (fun 7 2 z) (def 0 (= (f 7 (k 2)) z) (refl z)) (fun 7 2 (s z)) (= (f 7 (k 2)) z) (use 0)"
no "duplicate rewrite rule"      "(data 2 0 0 0) (fun 7 2 z) (fun 7 2 z) (-> P P) (lam P (hyp 0))"
no "function id outside table"  "(fun 768 2 z) (-> P P) (lam P (hyp 0))"
no "constructor id outside table" "(data 64 0 0 0) (-> P P) (lam P (hyp 0))"
no "duplicate lemma id"         "(def 0 (-> P P) (lam P (hyp 0))) (def 0 (-> P P) (lam P (hyp 0))) (-> P P) (use 0)"
no "trailing certificate form"  "(-> P P) (lam P (hyp 0)) P"
