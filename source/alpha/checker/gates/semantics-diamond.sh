...
b implementations/gamma/eq.gamma "$T/eq.exe"           || { echo "build implementations/gamma/eq.gamma failed"; exit 1; }
b "${OMEGA_PATH_DELTA}"/interp.gamma "$T/interp.exe" || { echo "build interp.gamma failed"; exit 1; }
