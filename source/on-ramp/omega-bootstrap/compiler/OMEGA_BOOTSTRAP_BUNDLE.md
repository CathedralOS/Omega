...
```sh
python3 source/on-ramp/omega-bootstrap/compiler/omega_bootstrap_bundle.py pack \
  src/main.omg=src/main.omg lib/math.omg=lib/math.omg > sources.omg0b
python3 source/on-ramp/omega-bootstrap/compiler/omega_bootstrap_bundle.py verify sources.omg0b
python3 source/on-ramp/omega-bootstrap/compiler/omega_bootstrap_bundle.py manifest sources.omg0b
python3 source/on-ramp/omega-bootstrap/compiler/omega_bootstrap_bundle.py get sources.omg0b src/main.omg
```
