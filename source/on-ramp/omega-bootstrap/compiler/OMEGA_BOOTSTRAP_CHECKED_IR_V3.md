...
1. The exact standalone
   `source/psi/generated/unicode_tables.omg` bytes plus a same-logical-module
...
8. Lower-rooted CKIR3 refinement uses the distinct `OMGRFN4` version-4 carrier
   ...
   [`OMGCOMP_REFINEMENT_WITNESS_V4.md`](../../../refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V4.md).
