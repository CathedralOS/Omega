...
signed-D0 carrier. The exact `source/psi/source/source.omg` evidence uses a
...
1. The exact `source/psi/source/source.omg` bytes plus a same-logical-module
...
7. Lower-rooted refinement uses the distinct
   [`OMGRFN5`](../../../refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V5.md)
