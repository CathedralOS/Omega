...
[`../../../../tests/lattice/corpus/cli_mvp/main.omg`](../../../../tests/lattice/corpus/cli_mvp/main.omg):
...
that front end in D0. `source/delta/samples/omega-bootstrap-frontend.alp`
is a rung-local symlink for the shared compiler slice. The historical
`source/delta/samples/omega0-frontend.alp` entry remains a role-local
