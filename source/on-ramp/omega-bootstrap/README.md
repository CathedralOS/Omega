...
| [`../../omega/source-checkpoints/`](../../omega/source-checkpoints/) | exact product-source closures and provisional `Ωself` evidence |
...
| product-source coverage | checkpoint 000001 has source/profile evidence; typed semantics, later phases, general lowering, and final profile remain open | [`../../omega/source-checkpoints/README.md`](../../omega/source-checkpoints/README.md) |
