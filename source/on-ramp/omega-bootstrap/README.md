# `source/on-ramp/omega-bootstrap/` — Delta-built bridge
...
| [`gates/`](gates/) | source-only meaning, deterministic reference, resource, and regression gates plus private fixtures; producer replay stays absent until canonical Delta publication |
| [`../../refinement/delta-omega-bootstrap/`](../../refinement/delta-omega-bootstrap/) | independent lower-rooted reconstruction and source-to-artifact refinement |
| [`../../omega/{psi,omega}/`](../../omega/) | Omega-written production compiler source; not owned here |
...
| --- | --- | --- |
| source bundle and multi-unit custody | canonical bounded transport, generic OMGCOMP1 checking, exact Linux-x86-64/native-provider configuration custody in OMGCOMP2, exactly one explicit root-package build-source role in OMGCOMP3, and bounded Delta SHA-256 over exact raw envelopes. Path-independent source-closure V1 now binds the canonical Delta compiler source image and one provisional three-root fixed-buffer action DAG with normalized unsigned imported-tool identity; neither snapshot is a final complete bridge closure or package authority | [`OMEGA_BOOTSTRAP_BUNDLE.md`](compiler/OMEGA_BOOTSTRAP_BUNDLE.md), [`OMEGA_BOOTSTRAP_COMPILATION.md`](compiler/OMEGA_BOOTSTRAP_COMPILATION.md), [`OMEGA_BOOTSTRAP_COMPILATION_V2.md`](compiler/OMEGA_BOOTSTRAP_COMPILATION_V2.md), [`OMEGA_BOOTSTRAP_COMPILATION_V3.md`](compiler/OMEGA_BOOTSTRAP_COMPILATION_V3.md), [`OMEGA_BOOTSTRAP_SHA256.md`](compiler/OMEGA_BOOTSTRAP_SHA256.md), [`DELTA_SOURCE_CLOSURE_SNAPSHOT_V1.md`](../../delta/DELTA_SOURCE_CLOSURE_SNAPSHOT_V1.md) |
| generated ordinary-source custody | the historical Unicode tuple retains sealed locked/offline two-run reproduction, generic provenance roles, bounded/no-publication teeth, exact OMGCOMP1 extent, and CKIR3/OMGRFN4 preflight composition as bounded cost evidence; it is not a live product checkpoint | [`OMEGA_BOOTSTRAP_GENERATED_SOURCE_CUSTODY.md`](compiler/OMEGA_BOOTSTRAP_GENERATED_SOURCE_CUSTODY.md) |
| resolution | selected public multi-unit, call, data, receiver, scalar, view, bounded-provider, and full-width arithmetic relations; OMGRSWC12 closes the actual `TokenStream::push` owner over eight records, five copyable pure-sum families, two actual-capacity record arrays, semantic structural copies, fifteen data writes, a ten-argument call, and indexed Float-payload dispatch | [`OMEGA_BOOTSTRAP_RESOLUTION_V12.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V12.md), preceding [`OMEGA_BOOTSTRAP_RESOLUTION_V11.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V11.md), and their versioned predecessors under [`compiler/`](compiler/) |
| checked lowering and conservative emission | OMGLOWL21/CKIR20 close the selected entry-bearing TokenStream projection through full-width index bounds, independently derived record/sum layout, active-payload Copy, exact count increment, nested `source.value` transport, two real calls, exhaustive dispatch, exact execution, and a conservative Linux-x86-64 artifact. The separate CKIR17 relation retains platform-neutral `Console` adapter events without provider/native-effect authority | [`OMEGA_BOOTSTRAP_CHECKED_IR_V20.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V20.md), [`OMEGA_BOOTSTRAP_LOWERING_V21.md`](compiler/OMEGA_BOOTSTRAP_LOWERING_V21.md), and the preceding versioned contracts under [`compiler/`](compiler/) |
| lower-rooted reconstruction | OMGRFN23 retains independent responsibility-local R1–R5 definitions for exact OMGCOMP1→OMGRSWC12→CKIR20→ELF, persisted-Beta projections, and deterministic reference carriers across renamed/reordered/inert variants, cross-pairs, resources, semantic mutations, and artifact mutation. Actual producer replay is suspended until canonical Delta publication. It grants no product, package, provider, compilation, or final-profile authority | [`OMGCOMP_REFINEMENT_WITNESS_V23.md`](../../refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V23.md), preceding [`OMGCOMP_REFINEMENT_WITNESS_V22.md`](../../refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V22.md), and the [assurance index](../../refinement/delta-omega-bootstrap/README.md) |
| product-source coverage | the bridge must consume the live resolver-derived closure; typed semantics, later phases, general lowering, and the final profile remain open | [`../../../TASKS_BOOTSTRAP.md`](../../../TASKS_BOOTSTRAP.md#2-complete-omega-bootstrap-in-delta) |
...
- [`../../refinement/delta-omega-bootstrap/`](../../refinement/delta-omega-bootstrap/)
