...
| --- | --- | --- |
| `unicode-harness.omg` | Compile as a separate source unit in the **same logical module** as the exact `source/psi/generated/unicode_tables.omg`. | status 0 from compilation and executable result 70 |
