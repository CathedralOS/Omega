pub(in crate::semantic_calls) struct CallSiteTraversal<'program, 'ordinal> {
    pub(super) program: &'program psi_typed_trees::TypedTrees,
    pub(super) machine: &'program psi_typed_trees::machine::Machine,
    pub(super) state: &'program psi_typed_trees::state::State,
