...
use omega_terminal_machine_code::{
    TerminalInternalCallRelocation, TerminalScalarCallStackEvidence, TerminalScalarStackEvidence,
    TerminalScalarStackMutationKind, TerminalUnitAffineCleanupRecord,
};
...
use super::{TerminalObjectError, TerminalObjectScalarCallStack};

pub(super) fn validate_scalar_call_stack(
    architecture: Architecture,
    caller: MachineId,
    bytes: &[u8],
    relocation: TerminalInternalCallRelocation,
    call: TerminalScalarCallStackEvidence,
    function: &TerminalScalarStackEvidence,
    replay_depth: u32,
    scalar_affine_cleanup: Option<&TerminalUnitAffineCleanupRecord>,
