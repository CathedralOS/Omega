...
fn source_canary() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR"))
        ...
        .nth(6)
        .expect(
            "omega-native-differential-test lives under source/on-ramp/rust/omega/orchestration",
        )
        .join("tests/canaries/pass/terminal_psi/structural_content_passthrough/main.omg")
}
