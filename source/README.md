...
The directory currently contains the baseline rung order, not a promise to keep
it. Instruction sets, whole languages, compiler edges, protocols, and checker
placement are subject to the backward audit in
[`bootstrap_minimization.md`](../wiki/design_briefs/bootstrap_minimization.md)
and the comparative experiment in
