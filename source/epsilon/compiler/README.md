...
through the current Delta frontend gate.
...
type-checks through the Delta frontend; no census behavior is claimed as
executed while the canonical Delta compiler edge is incomplete.
...
The superseded Gamma Epsilon-to-Delta route, Darwin-native publication tree, and
