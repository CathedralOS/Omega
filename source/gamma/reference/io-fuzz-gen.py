#!/usr/bin/env python3
# io-fuzz-gen.py SEED — emit ONE random Gamma program that READS a single input byte and produces
# input-dependent output + exit, chosen deterministically from SEED. gamma-io-exhaust.sh verifies each
