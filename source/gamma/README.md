...
The older imperative experiment does not select the new compiler edge. OWNER Q3 must
...
| `LANGUAGE.md` | The current accepted Gamma surface pending OWNER Q3's executable-contract ruling. | Replace only atomically with the ruled contract and synchronized compiler/reference tests. |
...
must be absorbed, adapted, or deleted when OWNER Q3 freezes the executable Gamma
