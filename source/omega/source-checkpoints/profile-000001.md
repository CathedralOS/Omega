...
Run `source/omega/source-checkpoints/checkpoint-000001.sh`. The checkpoint is
accepted only when all of the following hold:

1. `python3 source/omega/source-checkpoints/verify_profile.py` composes the manifest
