...
[`LANGUAGE.md`](LANGUAGE.md) currently records the OWNER Q5 contract proposal; it
...
samples. After OWNER Q5, a future facility belongs to Delta only when at least one
