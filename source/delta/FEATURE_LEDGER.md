...
[`LANGUAGE.md`](LANGUAGE.md) currently records the OWNER Q8 contract proposal; it
...
samples. After OWNER Q8, a future facility belongs to Delta only when at least one
