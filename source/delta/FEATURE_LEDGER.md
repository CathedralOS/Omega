...
[`LANGUAGE.md`](LANGUAGE.md) currently records the OWNER Q4 contract proposal; it
...
samples. After OWNER Q4, a future facility belongs to Delta only when at least one
