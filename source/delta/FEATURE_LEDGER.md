...
an admission list. D0, the sample corpus, and the retired Rust producer established
...
| integer arithmetic | D0 and the retired producer accepted several overflow policies and disagreed at some edges | use Exact throughout; add only a narrow modular operation if artifact encoding requires it | unresolved |
...
[`omega-bootstrap` status](../on-ramp/omega-bootstrap/README.md), the base
[`checked-IR contract`](../on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR.md),
the current entry-bearing
[`CKIR20`](../on-ramp/omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V20.md)
successor, and the current
[`OMGRFN23`](../../source/refinement/delta-omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V23.md)
