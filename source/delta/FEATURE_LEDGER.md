...
[`LANGUAGE.md`](LANGUAGE.md) currently records the OWNER Q3 contract proposal; it
...
samples. After OWNER Q3, a future facility belongs to Delta only when at least one
