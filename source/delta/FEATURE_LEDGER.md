...
[`LANGUAGE.md`](LANGUAGE.md) currently records the OWNER Q6 contract proposal; it
...
samples. After OWNER Q6, a future facility belongs to Delta only when at least one
