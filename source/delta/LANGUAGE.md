...
Delta source obeys the chain-wide closed textual-ASCII envelope:
...
Gamma-compiler artifact rather than supplied as a host runtime input. A returned
...
Gamma translator, Delta evaluator, Alpha Tape assembler, host compiler, or other
