# Delta v1 language-contract draft — DESIGN-BLOCKED OWNER Q4
...
This document is non-authoritative decision material until OWNER Q4 is resolved. It
...
those choices as Delta v1. OWNER Q4 must select and reconcile the result taxonomy,
