# Delta v1 language-contract draft — DESIGN-BLOCKED OWNER Q8
...
This document is non-authoritative decision material until OWNER Q8 is resolved. It
...
those choices as Delta v1. OWNER Q8 must select and reconcile the result taxonomy,
