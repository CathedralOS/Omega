...
revalidated once the Beta-written Gamma compiler exists.
...
claimed as executed while the canonical Gamma compiler edge is absent.
...
The superseded Gamma Delta-to-Gamma route, Darwin-native publication tree, and
