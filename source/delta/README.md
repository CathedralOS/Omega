...
- `compiler/` owns the in-progress `delta_compiler.gamma`, its eventual
  ...
  Remaining final body/control checking, Q3-blocked entry diagnostics, Q6
  bare-state-transfer spelling, Q7 invalid-`self` diagnostic, Q8
  resultless-argument anchor, the Q9-blocked exit/falloff judgment,
  Q10-blocked transition-pattern/coverage diagnostics, reachability, and the
