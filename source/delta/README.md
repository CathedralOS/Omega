...
[`LANGUAGE.md`](LANGUAGE.md) is Q13 decision material, not yet a normative Delta
v1 contract. It deliberately cannot authorize implementation while its open
choices remain contradictory. After Q13 selects one coherent contract, a
...
The root retains only the Q13 contract draft, its feature/change ledger, and
this owner map. Proposed programs without a runner are not retained as tests;
the draft is replaced atomically by the normative contract after Q13.
