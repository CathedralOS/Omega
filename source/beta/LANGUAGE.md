# Beta assembly language and encoding

This document defines the source language whose deterministic encoding produces
an Alpha bytecode payload. [`../alpha/SEMANTICS.md`](../alpha/SEMANTICS.md)
defines execution of that payload; Beta defines only the text-to-bytes
correspondence.
