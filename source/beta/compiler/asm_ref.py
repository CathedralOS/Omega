#!/usr/bin/env python3
# asm_ref.py - an INDEPENDENT reference assembler: Beta assembly text (stdin) -> raw bytecode tape (stdout),
# written from ../LANGUAGE.md + the 21-opcode encoding, NOT ported from assembler.beta.
#
