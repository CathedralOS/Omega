...
/// caller-isolated call producers in up to seven unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 7;
...
/// two-shell frontier instead of inheriting the seven direct-scalar shells.
/// Aggregate fields remain at two shells as well, and an eighth direct-scalar
