...
/// caller-isolated call producers in up to twenty unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 20;
...
/// two-shell frontier instead of inheriting the twenty direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a twenty-first direct-scalar
