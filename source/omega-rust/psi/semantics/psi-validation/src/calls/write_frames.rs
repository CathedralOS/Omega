...
/// caller-isolated call producers in up to seventeen unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 17;
...
/// two-shell frontier instead of inheriting the seventeen direct-scalar shells.
/// Aggregate fields remain at two shells as well, and an eighteenth direct-scalar
