...
/// caller-isolated call producers in up to four unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 4;
...
/// two-shell frontier instead of inheriting the four direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a fifth direct-scalar
