...
/// caller-isolated call producers in up to nineteen unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 19;
...
/// two-shell frontier instead of inheriting the nineteen direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a twentieth direct-scalar
