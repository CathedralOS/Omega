...
/// caller-isolated call producers in up to ten unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 10;
...
/// two-shell frontier instead of inheriting the ten direct-scalar shells.
/// Aggregate fields remain at two shells as well, and an eleventh direct-scalar
