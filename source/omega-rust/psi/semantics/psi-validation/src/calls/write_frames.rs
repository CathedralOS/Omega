...
/// caller-isolated call producers in up to twenty-four unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 24;
...
/// two-shell frontier instead of inheriting the twenty-four direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a twenty-fifth direct-scalar
