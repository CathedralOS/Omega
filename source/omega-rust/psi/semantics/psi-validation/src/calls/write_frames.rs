...
/// caller-isolated call producers in up to twenty-six unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 26;
...
/// two-shell frontier instead of inheriting the twenty-six direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a twenty-seventh direct-scalar
