...
/// caller-isolated call producers in up to eighteen unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 18;
...
/// two-shell frontier instead of inheriting the eighteen direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a nineteenth direct-scalar
