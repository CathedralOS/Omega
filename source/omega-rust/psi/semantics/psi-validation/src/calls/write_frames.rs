...
/// caller-isolated call producers in up to sixteen unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 16;
...
/// two-shell frontier instead of inheriting the sixteen direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a seventeenth direct-scalar
