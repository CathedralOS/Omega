...
/// caller-isolated call producers in up to fifteen unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 15;
...
/// two-shell frontier instead of inheriting the fifteen direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a sixteenth direct-scalar
