...
/// caller-isolated call producers in up to twenty-seven unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 27;
...
/// two-shell frontier instead of inheriting the twenty-seven direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a twenty-eighth direct-scalar
