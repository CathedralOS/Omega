...
/// caller-isolated call producers in up to thirteen unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 13;
...
/// two-shell frontier instead of inheriting the thirteen direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a fourteenth direct-scalar
