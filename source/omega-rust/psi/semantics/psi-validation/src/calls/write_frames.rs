...
/// caller-isolated call producers in up to twelve unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 12;
...
/// two-shell frontier instead of inheriting the twelve direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a thirteenth direct-scalar
