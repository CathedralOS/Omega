...
/// caller-isolated call producers in up to thirty unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 30;
...
/// two-shell frontier instead of inheriting the thirty direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a thirty-first direct-scalar
