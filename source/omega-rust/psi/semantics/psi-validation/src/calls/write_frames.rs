...
/// caller-isolated call producers in up to eleven unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 11;
...
/// two-shell frontier instead of inheriting the eleven direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a twelfth direct-scalar
