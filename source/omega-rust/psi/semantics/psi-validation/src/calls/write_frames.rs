...
/// caller-isolated call producers in up to thirty-two unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 32;
...
/// two-shell frontier instead of inheriting the thirty-two direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a thirty-third direct-scalar
