...
/// caller-isolated call producers in up to twenty-five unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 25;
...
/// two-shell frontier instead of inheriting the twenty-five direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a twenty-sixth direct-scalar
