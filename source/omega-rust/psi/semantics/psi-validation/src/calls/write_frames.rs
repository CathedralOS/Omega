...
/// caller-isolated call producers in up to thirty-one unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 31;
...
/// two-shell frontier instead of inheriting the thirty-one direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a thirty-second direct-scalar
