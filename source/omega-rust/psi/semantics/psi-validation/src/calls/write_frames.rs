...
/// caller-isolated call producers in up to twenty-eight unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 28;
...
/// two-shell frontier instead of inheriting the twenty-eight direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a twenty-ninth direct-scalar
