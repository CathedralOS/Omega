...
/// caller-isolated call producers in up to six unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 6;
...
/// two-shell frontier instead of inheriting the six direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a seventh direct-scalar
