...
/// caller-isolated call producers in up to twenty-one unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 21;
...
/// two-shell frontier instead of inheriting the twenty-one direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a twenty-second direct-scalar
