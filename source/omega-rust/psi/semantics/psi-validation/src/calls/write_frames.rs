...
/// caller-isolated call producers in up to twenty-nine unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 29;
...
/// two-shell frontier instead of inheriting the twenty-nine direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a thirtieth direct-scalar
