...
/// caller-isolated call producers in up to five unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 5;
...
/// two-shell frontier instead of inheriting the five direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a sixth direct-scalar
