...
/// caller-isolated call producers in up to fourteen unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 14;
...
/// two-shell frontier instead of inheriting the fourteen direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a fifteenth direct-scalar
