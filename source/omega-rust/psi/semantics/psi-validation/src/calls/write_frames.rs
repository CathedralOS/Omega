...
/// caller-isolated call producers in up to eight unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 8;
...
/// two-shell frontier instead of inheriting the eight direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a ninth direct-scalar
