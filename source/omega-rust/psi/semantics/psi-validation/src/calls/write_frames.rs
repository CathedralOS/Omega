...
/// caller-isolated call producers in up to nine unary, binary, primitive-cast,
...
const TRANSPARENT_ASSIGNMENT_VALUE_DIRECT_COMPUTED_DEPTH: usize = 9;
...
/// two-shell frontier instead of inheriting the nine direct-scalar shells.
/// Aggregate fields remain at two shells as well, and a tenth direct-scalar
