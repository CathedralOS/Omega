...
fn current_vocabulary_has_one_stable_canonical_encoding_and_identity() {
    ...
    assert_eq!(&bytes[8..10], 62_u16.to_le_bytes());
    ...
    assert_eq!(
        ...
        "74d856cbeeb60b110536c664fadf11e0c9029de6f9234e2405b5a8cd2a7da30b"
    );
    assert_eq!(
...
fn decoder_rejects_noncanonical_or_ambiguous_bytes() {
    ...
    future_format[8..10].copy_from_slice(&63_u16.to_le_bytes());
    assert_eq!(
        decode_module(&future_format),
        Err(CodecError::UnsupportedFormatMarker(63))
    );
