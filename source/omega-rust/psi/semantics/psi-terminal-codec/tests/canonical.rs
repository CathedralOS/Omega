...
fn current_vocabulary_has_one_stable_canonical_encoding_and_identity() {
    ...
    assert_eq!(&bytes[8..10], 63_u16.to_le_bytes());
    ...
    assert_eq!(
        ...
        "52fc95715d86562d84a1e2d84e2c1fb89efd420a085167bd126d3d3937b95e5d"
    );
    assert_eq!(
...
fn decoder_rejects_noncanonical_or_ambiguous_bytes() {
    ...
    future_format[8..10].copy_from_slice(&64_u16.to_le_bytes());
    assert_eq!(
        decode_module(&future_format),
        Err(CodecError::UnsupportedFormatMarker(64))
    );
