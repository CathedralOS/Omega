...
fn current_vocabulary_has_one_stable_canonical_encoding_and_identity() {
    ...
    assert_eq!(&bytes[8..10], 72_u16.to_le_bytes());
    ...
    assert_eq!(
        ...
        "45b4f9678467691f053775c4f47e32a0f201bf30afc7f73774698d5de918b56e"
    );
    assert_eq!(
...
fn decoder_rejects_noncanonical_or_ambiguous_bytes() {
    ...
    future_format[8..10].copy_from_slice(&73_u16.to_le_bytes());
    assert_eq!(
