...
fn current_vocabulary_has_one_stable_canonical_encoding_and_identity() {
    ...
    assert_eq!(&bytes[8..10], 37_u16.to_le_bytes());
    ...
    assert_eq!(
        ...
        "bab85e4d627e4bc8265f5947499976a0b8e667d1be216969748290f03b35ea45"
    );
    assert_eq!(
...
fn decoder_rejects_noncanonical_or_ambiguous_bytes() {
    ...
    future_format[8..10].copy_from_slice(&38_u16.to_le_bytes());
    assert_eq!(
        decode_module(&future_format),
        Err(CodecError::UnsupportedFormatMarker(38))
    );
