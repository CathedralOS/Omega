...
fn current_vocabulary_has_one_stable_canonical_encoding_and_identity() {
    ...
    assert_eq!(&bytes[8..10], 69_u16.to_le_bytes());
    ...
    assert_eq!(
        ...
        "519ba335e3661e95cb6b5aa1f8e7e3705306f05f74f257cc3067bb52f30032b1"
    );
    assert_eq!(
...
fn decoder_rejects_noncanonical_or_ambiguous_bytes() {
    ...
    future_format[8..10].copy_from_slice(&70_u16.to_le_bytes());
    assert_eq!(
        decode_module(&future_format),
        Err(CodecError::UnsupportedFormatMarker(70))
    );
