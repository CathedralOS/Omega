...
fn canonical_terminal_bytes_identity() -> &'static str {
    "root:canonical-terminal-bytes-format-58-vocabulary-61"
}
...
fn canonical_proof_calculus_identity() -> &'static str {
    "root:canonical-proof-calculus-format-22"
}
    ...
    OperationSemanticRow::ALL
        ...
        .map(|row| {
            ...
            if proof_bearing_scalar.is_some() {
                ...
                exact_sources.push((
                    "psi-terminal-semantics/proof_bearing_scalar/canonical_goal.rs",
