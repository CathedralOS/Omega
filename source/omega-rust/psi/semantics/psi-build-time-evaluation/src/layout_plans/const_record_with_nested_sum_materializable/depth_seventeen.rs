...
pub type ValidatedConstDepthSeventeenNestedSumOccurrenceMaterialization =
...
pub type ValidatedConstRecordWithDepthSeventeenNestedSumsMaterialization =
...
impl ValidatedConstRecordWithDepthSeventeenNestedSumsMaterialization {
    ...
    pub(super) fn replay_against_with_reachability(
        ...
        replay_recursive_nested_sums_with_reachability(
            ...
            derive_depth_seventeen_nested_sums_bytes_with_reachability,
            ValidatedConstRecordWithDepthSixteenNestedSumsMaterialization::replay_against_with_reachability,
            ValidatedConstRecordWithDepthSixteenNestedSumsMaterialization::schema_name,
            ValidatedConstRecordWithDepthSixteenNestedSumsMaterialization::value,
            ValidatedConstRecordWithDepthSixteenNestedSumsMaterialization::non_authoritative_materialization_report_fingerprint,
        )
    }
...
pub(super) fn validate_const_materializable_record_with_depth_seventeen_nested_sums_with_reachability(
    typed: &TypedTrees,
    schema_name: &str,
    path_layout: &ConventionalDepthSeventeenRecordSumPathsLayoutReport,
    value: &BuildTimeValue,
...
type DerivedDepthSeventeenNestedSumsMaterialization = DerivedRecursiveNestedSumsMaterialization<
    ValidatedConstRecordWithDepthSixteenNestedSumsMaterialization,
>;
...
fn derive_depth_seventeen_nested_sums_bytes_with_reachability(
    ...
    derive_recursive_nested_sums_bytes_with_reachability(
        ...
        ValidatedConstRecordWithDepthSixteenNestedSumsMaterialization::bytes,
    )
}
