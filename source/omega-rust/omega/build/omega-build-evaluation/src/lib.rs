...
pub fn execute_admitted_build_program(
    ...
    let replay = if filesystem_reachable {
            ...
            source_input_replay_prefix_end(attempts).filter(|end| *end < attempts.len())
        {
            ...
            {
                psi_checked_interpreter::FilesystemReplay::from_input_unknown_descriptor_seek_observations(
                    measured.observations(),
                )
                .ok()
            } else if attempts.len() - operation_suffix_start == 1
            ...
            {
                psi_checked_interpreter::FilesystemReplay::from_input_unknown_descriptor_unlink_at_observations(
                    measured.observations(),
                )
                .ok()
            } else if attempts.len() - operation_suffix_start == 1
            ...
            {
                psi_checked_interpreter::FilesystemReplay::from_input_unknown_descriptor_write_operation_observations(
                    measured.observations(),
                )
                .ok()
            } else if attempts.len() - operation_suffix_start == 1
            ...
            {
                psi_checked_interpreter::FilesystemReplay::from_input_unknown_descriptor_set_file_times_observations(
                    measured.observations(),
                )
                .ok()
            } else if attempts.len() - operation_suffix_start == 1
            ...
            {
                psi_checked_interpreter::FilesystemReplay::from_input_unknown_descriptor_read_observations(
                    measured.observations(),
                )
                .ok()
            } else if attempts.len() - operation_suffix_start == 1
            ...
            {
                psi_checked_interpreter::FilesystemReplay::from_input_unknown_descriptor_get_osfhandle_observations(
                    measured.observations(),
                )
                .ok()
            } else if attempts.len() - operation_suffix_start == 1
            ...
            {
                psi_checked_interpreter::FilesystemReplay::from_input_unknown_native_handle_close_handle_observations(
                    measured.observations(),
                )
                .ok()
            } else if attempts.len() - operation_suffix_start == 1
