...
pub(super) fn rehydrate_source_read_link_shape(
    ...
    psi_checked_interpreter::FilesystemSourceReadLinkReplayRecord,
...
> {
    ...
    let completeness = match returned.completeness {
        COMPLETE => psi_checked_interpreter::FilesystemReturnedPathCompleteness::Complete,
        LIMIT_REACHED => psi_checked_interpreter::FilesystemReturnedPathCompleteness::LimitReached,
        _ => unreachable!("decoded returned-path completeness is closed"),
    };

    psi_checked_interpreter::FilesystemSourceReadLinkReplayRecord::new(
