    ...
    plan.functions.push(LegalizedFunction {
        ...
        condition: LegalizedCondition::U64NotEqualZeroParameterV1 {
            ...
            zero: LegalizedImmediate {
                ...
                definition_site: omega_optimization_unit::ValueDefinitionSite::Node {
                    block: entry,
                    node: 0,
                },
...
fn identity_binds_not_equal_zero_custody_append_only() {
    ...
    for corrupt in [
        ...
        |parameter: &mut LegalizedConditionParameter| {
            parameter.definition_site =
                omega_optimization_unit::ValueDefinitionSite::FunctionParameter(1)
        },
    ] {
        assert_condition_corruption(&plan, identity, |condition| {
    ...
    for corrupt in [
        ...
        |zero: &mut LegalizedImmediate| {
            zero.definition_site = omega_optimization_unit::ValueDefinitionSite::Node {
                block: id(99),
                node: 0,
            }
        },
