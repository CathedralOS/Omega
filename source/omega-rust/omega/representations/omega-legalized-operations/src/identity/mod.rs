...
use plan::encode_structural_unit_function;
use scalar::{encode_bindings, encode_definition_site, encode_leaf, encode_register};
use shared::*;
...
pub fn legalized_operation_plan_identity(
    ...
    bytes.extend_from_slice(b"omega.terminal-legalized-operations.v9\0");
