...
) -> omega_terminal_psi_to_abstract_operations::VerifiedPsiOptimizationUnit {
...
fn guarded_source_call_replays_exact_classifier_and_rejects_independent_corruption() {
    ...
    let TerminalAbstractOperation::CallStructural {
    ...
    let TerminalAbstractOperation::EstablishPayloadlessCase { result_case, .. } =
