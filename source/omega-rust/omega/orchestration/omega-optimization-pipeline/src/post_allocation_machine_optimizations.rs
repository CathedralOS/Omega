use omega_machine_optimizer::{
    TerminalAarch64CbnzFusionError, TerminalAarch64CbnzFusionIdentity,
    ValidatedTerminalAarch64CbnzFusion, optimize_aarch64_compare_i64_zero_branch_nonzero_to_cbnz,
...
use omega_regalloc::{ValidatedTerminalLiveness, ValidatedTerminalSelectedAnalysis};
...
pub struct StagedOptimizedAarch64CbnzFusion {
    fusion: ValidatedTerminalAarch64CbnzFusion,
    custody: StagedOptimizedAarch64CbnzFusionCustodyReceipt,
}

impl StagedOptimizedAarch64CbnzFusion {
    pub const fn fusion(&self) -> &ValidatedTerminalAarch64CbnzFusion {
        &self.fusion
    }
...
pub struct StagedOptimizedAarch64CbnzFusionCustodyReceipt {
    ...
    source: omega_machine_optimizer::TerminalPostAllocationMachineIdentity,
...
impl StagedOptimizedAarch64CbnzFusionCustodyReceipt {
    ...
    pub const fn source(self) -> omega_machine_optimizer::TerminalPostAllocationMachineIdentity {
        self.source
    }
...
pub enum OptimizedPostAllocationMachineOptimizationError {
    ...
    Fusion(TerminalAarch64CbnzFusionError),
    ReceiptMismatch,
}
...
fn stage_with_inputs<S: ValidatedTerminalSelectedAnalysis>(
    selected: &S,
...
fn validate_with_inputs<S: ValidatedTerminalSelectedAnalysis>(
    selected: &S,
    liveness: &ValidatedTerminalLiveness,
    machine: &StagedOptimizedPostAllocationMachinePlan,
    physical: &ValidatedPhysicalRegisterModel,
