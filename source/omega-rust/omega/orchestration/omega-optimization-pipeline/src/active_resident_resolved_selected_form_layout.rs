use crate::{
    ...
    StagedOptimizedResolvedSelectedFormLayout, TerminalResolvedSelectedFormLayoutIdentity,
...
pub struct StagedOptimizedActiveResidentRematerializationResolvedSelectedFormLayoutCustodyReceipt {
    ...
    pre_layout: TerminalSelectedFormEncodingIdentity,
    physical: omega_register_model::PhysicalRegisterModelIdentity,
    layout: TerminalResolvedSelectedFormLayoutIdentity,
...
impl StagedOptimizedActiveResidentRematerializationResolvedSelectedFormLayoutCustodyReceipt {
    ...
    pub const fn pre_layout(&self) -> TerminalSelectedFormEncodingIdentity {
        self.pre_layout
    }
    ...
    pub const fn layout(&self) -> TerminalResolvedSelectedFormLayoutIdentity {
        self.layout
    }
