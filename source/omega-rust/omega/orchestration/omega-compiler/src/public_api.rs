...
pub use crate::pipeline::{
    ...
    CheckedPackageProviderReview, CheckedPackageReviewProjection, CompilerExecutableCommitment,
    CompilerExecutableCommitmentError, ConsumptionInstant, DataSymbolId,
    DecodedPackageReviewCanonicalRow, EntryStubId, ExecutableTcbBuildPolicy,
    ...
    TerminalComponentStagingInputBindingError, TerminalComponentStagingInputs,
    TerminalNativeArtifact, TerminalNativeArtifactParts, TerminalNativeProviderExecution,
    TerminalNativeProviderSettlement, ValidatedAccessPlan, ValidatedConstMaterialization,
