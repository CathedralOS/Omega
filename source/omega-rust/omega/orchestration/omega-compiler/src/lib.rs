...
pub use pipeline::{
    ...
    MaterializationDiagnostic, MaterializationWrite,
    ...
    OwnedTerminalComponentDeploymentError, PACKAGE_REVIEW_CANONICAL_ROW_RECOVERY_VERSION,
    ...
    PackageGeneratedSourceBundle, PackageReviewArithmeticDomain,
    ...
    RecordedProgramStorageInstallation, RelocationTarget, RequestedCompileProduct,
    ReservedProgramEntryReceiverStorage, RetainedNativeArtifact,
    ...
    SourceFeatureCensus, SourceFeatureCount, SourceInspectionRoot, SourceResourceObservation,
    SuppliedTerminalComponentDeploymentError, SymbolicFieldValue, SymbolicMaterializationPlan,
    TerminalComponentCandidate, TerminalComponentCandidateParts, TerminalComponentCompileError,
    ...
    compile_harness, compile_terminal_component_output, compile_to_checked,
    compile_to_checked_with_packages, compile_to_checked_with_packages_and_replay_record,
    ...
    compute_placement_plan, decode_ordinary_package_obligation_ledger,
    decode_package_review_canonical_row, decode_package_review_canonical_row_with_limits,
    decode_scalar_layout, deploy_and_write_terminal_component_output,
    ...
    normalized_layout_plan_fingerprint, ordinary_package_obligation_ledger_fingerprint,
    ...
    project_checked_package_review, realize_terminal_native_artifact,
