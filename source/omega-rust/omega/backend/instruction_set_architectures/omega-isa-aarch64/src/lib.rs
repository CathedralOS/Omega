...
pub use selected_form_encoding::{
    ...
    encode_aarch64_selected_nonzero_branch_form, encode_aarch64_selected_scalar_call_template,
    ...
    validate_aarch64_selected_nonzero_branch_form, validate_aarch64_selected_scalar_call_template,
