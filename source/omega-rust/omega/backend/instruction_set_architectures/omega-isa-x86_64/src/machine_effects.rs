...
pub fn x86_64_machine_effect_catalog(
    ...
    Ok(MachineEffectCatalog {
        ...
        structural_unit_call: selected_keys.structural_unit_call.map(|constraint| {
            omega_selected_instructions::StructuralUnitCallEffectDeclaration {
                constraint,
                memory: omega_selected_instructions::StructuralUnitCallMemoryEffect::ReadOwnedIndirectPairWriteCallerCopiesV1 {
                    root_byte_count: 16,
                    copy_stack_byte_offsets: [32, 48],
                },
                frame: omega_selected_instructions::StructuralUnitCallFrameEffect::BalancedCallerFrameV1 {
                    frame_byte_count: 72,
                    shadow_byte_count: 32,
                    pre_call_stack_alignment: 16,
                },
                trap: MachineTrapBehavior::MayArchitecturalFaultV1,
                barrier: omega_selected_instructions::StructuralUnitCallBarrier::CallV1,
                call: omega_selected_instructions::StructuralUnitCallEffect::DirectInternalUnitV1,
...
fn size(semantic: MachineSemanticKind) -> MachineSizeKnowledge {
    match semantic {
        MachineSemanticKind::CompareI64Zero | MachineSemanticKind::CopyI64 => {
            MachineSizeKnowledge::ExactBytes(3)
        }
