...
use omega_terminal_machine_code::{
    TerminalMachineCodePlan, TerminalNativeFuelAttribution, TerminalNativeFuelChargeRecord,
    TerminalNativeFuelInstrumentedFunction, TerminalNativeFuelInstrumentedPlan,
...
pub fn instrument_native_fuel(
    source: TerminalMachineCodePlan,
    target_policy: NativeFuelTargetPlanProjection,
) -> Result<TerminalNativeFuelInstrumentedPlan, NativeFuelInstrumentationError> {
    ...
    for (mut function, function_base) in prepared.into_iter().zip(function_bases) {
        ...
        functions.push(TerminalNativeFuelInstrumentedFunction {
    ...
    Ok(TerminalNativeFuelInstrumentedPlan {
        source,
        target_policy,
        functions,
    })
...
fn prepare_function(
    ...
    target_policy: &NativeFuelTargetPlanProjection,
    function: &omega_terminal_machine_code::TerminalMachineCodeFunction,
...
mod tests {
    ...
    fn source_function(machine: u64) -> omega_terminal_machine_code::TerminalMachineCodeFunction {
        ...
        omega_terminal_machine_code::TerminalMachineCodeFunction {
            ...
            fuel_attribution: vec![
                ...
                TerminalNativeFuelAttribution {
                    schedule,
                    site: TerminalNativeFuelSite::Edge(EdgeId::new(machine * 10 + 3).unwrap()),
                    units: 5,
                    operation_ordinal: 2,
                    code_offset: 4,
                    byte_count: 4,
    ...
    fn source(profile: TargetProfile, function_count: u64) -> TerminalMachineCodePlan {
