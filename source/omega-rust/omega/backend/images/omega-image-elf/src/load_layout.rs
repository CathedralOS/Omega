...
impl ValidatedElfDynamicLoadLayout {
    ...
    pub const fn final_image_layout(&self) -> omega_image::FinalImageLayout {
        omega_image::FinalImageLayout {
...
fn retained_image(relative: &ValidatedElfRelativeSectionPayloadLayout) -> &omega_image::FinalImage {
    relative
        .payloads()
        .section_headers()
        .roster()
