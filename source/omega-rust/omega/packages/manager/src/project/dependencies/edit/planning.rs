use crate::project::dependencies::edit::BUILD_FILE_NAME;
use crate::project::dependencies::edit::layout::discover_build_layout;
use crate::project::dependencies::edit::model::{
...
use crate::project::dependencies::edit::rendering::{
    canonical_dependency_statement, source_digest,
};
use crate::project::dependencies::read::{DependencySourceRequest, extract_from_source};
use std::fs;
