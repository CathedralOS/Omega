...
use crate::sources::{ResolvePackageSourceError, resolve_workspace_member_package_source};
#[cfg(unix)]
...
fn workspace_member_resolution_rejects_member_path_symlink_escape() {
    ...
    let error = crate::sources::resolve_workspace_member_package_source_with_storage(
