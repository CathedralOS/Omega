...
use crate::manifest::dependencies::read::error::DependencyProjectionError;
use crate::manifest::dependencies::read::model::DependencySourceRequest;
use crate::manifest::dependencies::read::source_literal::{
