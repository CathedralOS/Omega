...
fn workspace_member_resolution_rejects_member_path_symlink_escape() {
    ...
    let storage = crate::resolution::SourceResolverStorage::for_hardened_base(&cache)
...
"#,
    ...
    .into_custody();
    let error = crate::resolution::graph::reconciliation::resolve_package_source_closure::<
