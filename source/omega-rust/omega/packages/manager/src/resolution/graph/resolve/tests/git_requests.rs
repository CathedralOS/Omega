...
"#,
    ...
    let request = crate::resolution::source::GitPackageSourceRequest::new(
        ...
        crate::manifest::PackageSelection::Named(
            crate::manifest::PackageName::parse("matrix").expect("package name"),
        ),
    );
    let storage = SourceResolverStorage::for_hardened_base(&cache)
        .expect("create retained Git resolver storage");
...
"#,
    ...
    let request = crate::resolution::source::GitPackageSourceRequest::new(
        ...
        crate::manifest::PackageSelection::Named(
            crate::manifest::PackageName::parse("driver-console").expect("project name"),
        ),
    );
    let storage = SourceResolverStorage::for_hardened_base(&cache)
        .expect("create retained Git resolver storage");
...
"#,
    ...
    let request = crate::resolution::source::GitPackageSourceRequest::new(
        ...
        .expect("validated local Git root request"),
        crate::manifest::PackageSelection::Named(
            crate::manifest::PackageName::parse("left").expect("package name"),
        ),
    );
    let storage = SourceResolverStorage::for_hardened_base(&cache)
        .expect("create retained Git resolver storage");
