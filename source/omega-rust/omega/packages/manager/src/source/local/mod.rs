...
pub(in crate::source) use capture::is_executable;
#[cfg(test)]
pub(in crate::source) use capture::resolve_materialized_source;
...
pub(in crate::source) use snapshot::local_snapshot_custody_identity;
#[cfg(test)]
pub(in crate::source) use snapshot::publish_local_snapshot;
