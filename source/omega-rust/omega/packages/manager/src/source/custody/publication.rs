...
#[cfg(test)]
pub(in crate::source) fn publish_cache_directory(
...
pub(in crate::source) fn direct_cache_child_name<'a>(
    kind: CacheCustodyKind,
    parent: &Path,
    child: &'a Path,
...
pub(in crate::source) fn retained_cache_directory_exists(
    kind: CacheCustodyKind,
...
pub(in crate::source) fn publish_cache_directory_from_open_parent(
    kind: CacheCustodyKind,
    parent: &Path,
...
pub(in crate::source) struct PendingCacheEntry {
...
impl PendingCacheEntry {
    ...
    pub(in crate::source) fn create_private_directory(
        &self,
        name: &str,
        path: &Path,
    ) -> Result<(), SourceResolveError> {
    ...
    pub(in crate::source) fn verify_path_identity(
        &self,
    ...
    pub(in crate::source) fn verify_ambient_path_identity(
        &self,
        cache_dir: &Path,
    ) -> Result<(), SourceResolveError> {
...
pub(in crate::source) struct ProvisionalCacheDirectory<'a> {
    pub(in crate::source) parent: &'a CapabilityDirectory,
    pub(in crate::source) name: &'a OsStr,
    pub(in crate::source) armed: bool,
}

impl<'a> ProvisionalCacheDirectory<'a> {
    pub(in crate::source) fn new(parent: &'a CapabilityDirectory, name: &'a OsStr) -> Self {
        Self {
            parent,
            name,
            armed: true,
    ...
    pub(in crate::source) fn disarm(mut self) {
        self.armed = false;
    }
}
...
pub(in crate::source) fn create_private_cache_directory(
    parent: &CapabilityDirectory,
...
pub(in crate::source) fn retain_private_cache_directory(
    kind: CacheCustodyKind,
    parent: &CapabilityDirectory,
    name: &OsStr,
    path: &Path,
