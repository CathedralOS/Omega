...
pub struct GitSourceResolutionObservation {
    pub(in crate::source) schema_version: u32,
    pub(in crate::source) identity: String,
    pub(in crate::source) command_count: usize,
    pub(in crate::source) captured_output_ceiling: u64,
    pub(in crate::source) captured_output_observed: u64,
    pub(in crate::source) network_transfer_ceiling: u64,
    pub(in crate::source) network_transfer_uploaded: u64,
    pub(in crate::source) network_transfer_downloaded: u64,
}
...
pub(in crate::source) fn issue_git_source_resolution_observation(
