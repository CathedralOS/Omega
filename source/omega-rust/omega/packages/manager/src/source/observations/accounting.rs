...
pub struct GitCapturedOutputObservation {
    ...
    pub(in crate::source) observed: u64,
}
...
pub struct GitNetworkTransferObservation {
    pub(in crate::source) ceiling: u64,
    pub(in crate::source) uploaded: u64,
    pub(in crate::source) downloaded: u64,
}
...
pub(in crate::source) fn git_resolution_captured_output_ceiling(limits: LocalSourceLimits) -> u64 {
    limits
        .max_bytes
...
pub(in crate::source) fn git_resolution_network_transfer_ceiling(limits: LocalSourceLimits) -> u64 {
    limits
        .max_bytes
...
pub(in crate::source) fn git_network_transfer_observation(
...
pub(in crate::source) fn git_captured_output_observation(
    commands: &[GitCommandExecutionObservation],
    ceiling: u64,
