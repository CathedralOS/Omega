...
pub struct GitExecutableIdentity {
    ...
    pub(in crate::source) content_identity: String,
}
...
pub struct GitTransportExecutableIdentity {
    pub(in crate::source) invocation_path: PathBuf,
    pub(in crate::source) path: PathBuf,
    pub(in crate::source) content_identity: String,
}
...
pub struct GitCommandExecutionObservation {
    pub(in crate::source) phase: ResolverExecutionPhase,
    pub(in crate::source) policy_identity: String,
    pub(in crate::source) command_identity: String,
    pub(in crate::source) status_code: Option<i32>,
    pub(in crate::source) termination_signal: Option<i32>,
    pub(in crate::source) stdout_length: u64,
    pub(in crate::source) stdout_identity: String,
    pub(in crate::source) stderr_length: u64,
    pub(in crate::source) stderr_identity: String,
    pub(in crate::source) endpoint_observation: Option<ResolverExecutionEndpointObservation>,
    pub(in crate::source) completion: ResolverExecutionCompletionObservation,
}
