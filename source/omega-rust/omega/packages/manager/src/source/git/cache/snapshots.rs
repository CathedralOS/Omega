...
pub(in crate::source) struct RetainedGitSnapshots {
    ...
    pub(in crate::source) entry: CapabilityDirectory,
    pub(in crate::source) directory: CapabilityDirectory,
    pub(in crate::source) identity: CapabilityMetadata,
}

impl RetainedGitSnapshots {
    pub(in crate::source) fn verify_identity(&self) -> Result<(), SourceResolveError> {
    ...
    pub(in crate::source) fn publication_exists(
        &self,
        publication: &Path,
