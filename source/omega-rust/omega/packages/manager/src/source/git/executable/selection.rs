...
#[derive(Debug)]
pub(in crate::source) struct GitTransportExecutableObservation {
    pub(in crate::source) identity: GitTransportExecutableIdentity,
...
pub(in crate::source) fn open_https_transport_executable(
    git_executable: &Path,
) -> Result<GitTransportExecutableObservation, SourceResolveError> {
...
pub(in crate::source) fn open_git_transport_executable(
    requested_path: &Path,
) -> Result<GitTransportExecutableObservation, SourceResolveError> {
...
pub(in crate::source) fn verify_git_transport_executable(
...
#[cfg(target_os = "macos")]
pub(in crate::source) fn system_git_candidates() -> &'static [&'static str] {
    &[
