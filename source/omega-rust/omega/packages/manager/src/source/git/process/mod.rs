...
#[cfg(test)]
pub(in crate::source) use command::sealed_git_command;
#[allow(unused_imports)] // Preserve the former package-internal process API.
pub(in crate::source) use command::{
...
#[allow(unused_imports)] // Preserve the former package-internal process API.
pub(in crate::source) use invocation::{
    run_git, run_git_bytes_stdout, run_git_output, run_git_stdout,
};
#[allow(unused_imports)] // Preserve the former package-internal process API.
pub(in crate::source) use reconciliation::{
