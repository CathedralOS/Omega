...
pub(in crate::source) fn open_or_create_snapshot_directory(
...
pub(in crate::source) fn write_snapshot_file_from_open_root(
    kind: CacheCustodyKind,
    root: &CapabilityDirectory,
    relative_path: &Path,
    display_root: &Path,
...
#[cfg(unix)]
pub(in crate::source) fn create_snapshot_symlink_from_open_root(
    kind: CacheCustodyKind,
    root: &CapabilityDirectory,
    relative_path: &Path,
    display_root: &Path,
