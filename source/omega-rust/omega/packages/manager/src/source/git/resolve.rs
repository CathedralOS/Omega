...
pub(in crate::source) fn requested_network_endpoint(
    request: &GitSourceRequest,
...
pub(in crate::source) fn resolve_verified_git_cache_entry(
...
pub(in crate::source) fn validate_pending_git_request(
    pending: &PendingResolvedGitSource,
    request: &GitSourceRequest,
...
pub(in crate::source) fn verify_pending_git_snapshot(
    pending: &PendingResolvedGitSource,
    limits: LocalSourceLimits,
) -> Result<(), SourceResolveError> {
...
pub(in crate::source) fn bounded_git_fetch_arguments(
    fetch_locator: &str,
    requested_rev: &str,
    limits: LocalSourceLimits,
) -> Vec<OsString> {
...
pub(in crate::source) fn replace_canonical_git_control_file(
...
pub(in crate::source) fn replace_canonical_git_control_file_from_open_repository(
