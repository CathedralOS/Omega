...
pub(in crate::source) fn verify_exact_git_revision(
    requested_rev: &str,
    selected_commit: &str,
...
pub(in crate::source) fn authenticate_git_commit(
...
pub(in crate::source) fn authenticate_git_commit_payload(
    commit: &str,
    reported_tree: &str,
    payload: &[u8],
) -> Result<(), SourceResolveError> {
...
pub(in crate::source) fn authenticate_git_tree(
    expected_tree: &str,
