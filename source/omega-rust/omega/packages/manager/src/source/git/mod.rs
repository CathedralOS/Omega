...
pub(super) use executable::verify_macos_open_executable_acl_custody;
#[allow(unused_imports)] // Preserve the former source-internal Git facade explicitly.
pub(super) use executable::{
    CapturedOutputLimitExceeded, GitCapturedOutputBudget, GitExecutableMetadataIdentity,
    GitExecutor, GitTransportExecutableObservation, open_git_transport_executable,
    open_https_transport_executable, resolver_connect_helper_path, system_git_candidates,
    verify_git_transport_executable,
};
#[cfg(test)]
#[allow(unused_imports)]
pub(super) use executable::{test_file_network_endpoint, test_system_git_executor};
#[cfg(test)]
...
pub(super) use process::{
    ...
    run_git_stdout, sealed_git_command_with_route, sealed_ssh_command,
};
#[cfg(test)]
#[allow(unused_imports)]
pub(super) use process::{capture_stream_bounded, run_command_bounded, sealed_git_command};
#[allow(unused_imports)] // Preserve the former source-internal Git facade explicitly.
