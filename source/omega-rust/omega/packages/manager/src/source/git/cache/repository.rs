...
pub(in crate::source) struct VerifiedGitRepository {
    ...
    pub(in crate::source) repository_path: PathBuf,
    pub(in crate::source) entry_name: OsString,
    pub(in crate::source) expected_metadata: Vec<u8>,
    pub(in crate::source) cache_parent: CapabilityDirectory,
    pub(in crate::source) entry: CapabilityDirectory,
    pub(in crate::source) repository: CapabilityDirectory,
    pub(in crate::source) objects: CapabilityDirectory,
    pub(in crate::source) entry_identity: CapabilityMetadata,
    pub(in crate::source) repository_identity: CapabilityMetadata,
    pub(in crate::source) objects_identity: CapabilityMetadata,
}

impl VerifiedGitRepository {
    pub(in crate::source) fn open(
    ...
    pub(in crate::source) fn path(&self) -> &Path {
    ...
    pub(in crate::source) fn verify_current(
        &self,
        limits: LocalSourceLimits,
    ...
    pub(in crate::source) fn read_canonical_config(&self) -> Result<Vec<u8>, SourceResolveError> {
    ...
    pub(in crate::source) fn restore_canonical_config(
        &self,
        canonical_config: &[u8],
    ) -> Result<(), SourceResolveError> {
    ...
    pub(in crate::source) fn run_git<I, S>(
        &self,
    ...
    pub(in crate::source) fn run_git_stdout<I, S>(
        &self,
        executor: &GitExecutor,
        args: I,
    ...
    pub(in crate::source) fn run_git_bytes_stdout<I, S>(
        &self,
        executor: &GitExecutor,
        args: I,
    ...
    pub(in crate::source) fn open_or_create_snapshots(
        &self,
