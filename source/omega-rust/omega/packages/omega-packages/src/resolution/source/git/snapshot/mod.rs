...
pub(in crate::resolution::source) use construction::{
    create_snapshot_symlink_from_open_root, open_or_create_snapshot_directory,
    write_snapshot_file_from_open_root,
};
#[cfg(test)]
pub(in crate::resolution::source) use materialization::preflight_git_snapshot;
pub(in crate::resolution::source) use materialization::resolve_git_snapshot;
#[cfg(test)]
pub(in crate::resolution::source) use metadata::git_snapshot_metadata;
...
pub(in crate::resolution::source) use metadata::GitSnapshotMetadata;
pub(in crate::resolution::source) use metadata::{local_snapshot_metadata, verify_local_snapshot};
pub(in crate::resolution::source) use permissions::{
...
pub(in crate::resolution::source) use publication::PendingMaterializedSnapshot;
