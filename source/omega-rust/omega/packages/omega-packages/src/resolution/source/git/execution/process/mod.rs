...
#[cfg(test)]
pub(in crate::resolution::source) use capture::{capture_stream_bounded, run_command_bounded};
#[cfg(test)]
pub(in crate::resolution::source) use command::sealed_git_command;
#[allow(unused_imports)] // Preserve the former package-internal process API.
pub(in crate::resolution::source) use command::{
...
#[allow(unused_imports)] // Preserve the former package-internal process API.
pub(in crate::resolution::source) use invocation::{
    run_git, run_git_bytes_stdout, run_git_output, run_git_stdout,
};
#[allow(unused_imports)] // Preserve the former package-internal process API.
pub(in crate::resolution::source) use reconciliation::{
