...
#[derive(Debug, Clone)]
pub(in crate::resolution::acquisition) struct GitCapturedOutputBudget {
    pub(in crate::resolution::acquisition) ceiling: u64,
    pub(in crate::resolution::acquisition) observed: Arc<AtomicU64>,
}

impl GitCapturedOutputBudget {
    pub(in crate::resolution::acquisition) fn new(ceiling: u64) -> Self {
        Self {
            ceiling,
    ...
    pub(in crate::resolution::acquisition) fn observed(&self) -> u64 {
        self.observed.load(Ordering::Acquire)
    }

    pub(in crate::resolution::acquisition) fn charge(
        &self,
        count: usize,
...
pub(in crate::resolution::acquisition) struct CapturedOutputLimitExceeded {
    pub(in crate::resolution::acquisition) ceiling: u64,
    pub(in crate::resolution::acquisition) attempted: u64,
}
