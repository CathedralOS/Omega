...
#[cfg(not(unix))]
use crate::resolution::acquisition::git_tree_invalid;
...
pub(in crate::resolution::acquisition) fn open_or_create_snapshot_directory(
...
pub(in crate::resolution::acquisition) fn write_snapshot_file_from_open_root(
    kind: CacheCustodyKind,
    root: &CapabilityDirectory,
    relative_path: &Path,
    display_root: &Path,
...
#[cfg(unix)]
pub(in crate::resolution::acquisition) fn create_snapshot_symlink_from_open_root(
    kind: CacheCustodyKind,
    root: &CapabilityDirectory,
    relative_path: &Path,
    display_root: &Path,
