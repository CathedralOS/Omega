...
pub(in crate::resolution::acquisition) fn git_cache_identity(
    url: &str,
    requested_rev: &str,
...
pub(in crate::resolution::acquisition) fn git_cache_metadata(
    url: &str,
    requested_rev: &str,
    execution_transport: GitExecutionTransport,
) -> Vec<u8> {
...
pub(in crate::resolution::acquisition) fn append_framed_bytes(output: &mut Vec<u8>, bytes: &[u8]) {
    output.extend_from_slice(&(bytes.len() as u64).to_le_bytes());
    output.extend_from_slice(bytes);
}

pub(in crate::resolution::acquisition) fn cache_invalid(
    path: &Path,
...
pub(in crate::resolution::acquisition) fn local_snapshot_invalid(
    path: &Path,
    message: impl Into<String>,
) -> SourceResolveError {
