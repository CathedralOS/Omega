...
use crate::resolution::acquisition::git::execution::executable::GitExecutor;
use crate::resolution::acquisition::limits::{GIT_STDERR_LIMIT, GIT_STDOUT_LIMIT};
...
pub(in crate::resolution::acquisition) fn run_git_output<I, S>(
    executor: &GitExecutor,
    working_directory: &Path,
    phase: ResolverExecutionPhase,
    args: I,
