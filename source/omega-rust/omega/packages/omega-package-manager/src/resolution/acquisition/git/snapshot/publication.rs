...
#[cfg(test)]
use crate::resolution::acquisition::{open_absolute_directory_nofollow, verify_cache_custody_root};
...
pub(in crate::resolution::acquisition) struct PendingMaterializedSnapshot {
...
impl PendingMaterializedSnapshot {
    ...
    pub(in crate::resolution::acquisition) fn create_from_open_parent(
        kind: CacheCustodyKind,
        snapshots: &Path,
