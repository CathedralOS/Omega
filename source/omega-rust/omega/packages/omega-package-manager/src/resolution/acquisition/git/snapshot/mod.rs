...
pub(in crate::resolution::acquisition) use construction::{
    create_snapshot_symlink_from_open_root, open_or_create_snapshot_directory,
    write_snapshot_file_from_open_root,
};
#[cfg(test)]
pub(in crate::resolution::acquisition) use materialization::preflight_git_snapshot;
pub(in crate::resolution::acquisition) use materialization::resolve_git_snapshot;
#[cfg(test)]
pub(in crate::resolution::acquisition) use metadata::git_snapshot_metadata;
...
pub(in crate::resolution::acquisition) use metadata::GitSnapshotMetadata;
pub(in crate::resolution::acquisition) use metadata::{
    local_snapshot_metadata, verify_local_snapshot,
};
pub(in crate::resolution::acquisition) use permissions::{
    make_open_snapshot_read_only, make_open_tree_owner_writable, verify_open_snapshot_tree_modes,
};
#[cfg(test)]
pub(in crate::resolution::acquisition) use permissions::{
    make_snapshot_read_only, make_tree_owner_writable,
};
pub(in crate::resolution::acquisition) use publication::PendingMaterializedSnapshot;
