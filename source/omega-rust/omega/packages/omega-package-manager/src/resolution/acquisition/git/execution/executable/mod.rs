...
pub(in crate::resolution::acquisition) use budget::{
...
pub(in crate::resolution::acquisition) use custody::verify_macos_open_executable_acl_custody;
pub(in crate::resolution::acquisition) use executor::GitExecutor;
#[cfg(test)]
pub(in crate::resolution::acquisition) use executor::{
    test_file_network_endpoint, test_system_git_executor,
};
#[allow(unused_imports)] // Preserve the former package-internal executable API.
pub(in crate::resolution::acquisition) use identity::GitExecutableMetadataIdentity;
#[allow(unused_imports)] // Preserve the former package-internal executable API.
pub(in crate::resolution::acquisition) use selection::{
