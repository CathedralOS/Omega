...
use crate::resolution::acquisition::git::execution::{
    BoundedCommandOutput, duration_millis, format_sha256,
};
use crate::resolution::acquisition::git::request::GitExecutionTransport;
...
use crate::resolution::acquisition::observations::{
...
#[derive(Debug)]
pub(in crate::resolution::acquisition) struct GitExecutor {
    pub(in crate::resolution::acquisition) identity: GitExecutableIdentity,
    pub(in crate::resolution::acquisition) metadata_identity: GitExecutableMetadataIdentity,
    pub(in crate::resolution::acquisition) transport_executable:
        Option<GitTransportExecutableObservation>,
    pub(in crate::resolution::acquisition) execution_helpers:
        Vec<GitTransportExecutableObservation>,
    pub(in crate::resolution::acquisition) execution_transport: GitExecutionTransport,
    pub(in crate::resolution::acquisition) requested_network_endpoint:
        ResolverExecutionRequestedEndpoint,
    pub(in crate::resolution::acquisition) started: Instant,
    pub(in crate::resolution::acquisition) timeout: Duration,
    pub(in crate::resolution::acquisition) launches: Cell<usize>,
    pub(in crate::resolution::acquisition) execution_policy_observations:
        RefCell<Vec<ResolverExecutionPolicyObservation>>,
    pub(in crate::resolution::acquisition) command_execution_observations:
        RefCell<Vec<GitCommandExecutionObservation>>,
    pub(in crate::resolution::acquisition) captured_output_budget: GitCapturedOutputBudget,
    pub(in crate::resolution::acquisition) network_transfer_budget: ResolverExecutionTransferBudget,
    pub(in crate::resolution::acquisition) maximum_launches: usize,
    pub(in crate::resolution::acquisition) execution_backend: ResolverExecutionBackend,
}

impl GitExecutor {
    pub(in crate::resolution::acquisition) fn system(
    ...
    #[cfg(test)]
    pub(in crate::resolution::acquisition) fn open_with_budget(
        path: &Path,
    ...
    #[cfg(test)]
    pub(in crate::resolution::acquisition) fn open_with_resource_budgets(
        path: &Path,
        maximum_launches: usize,
        timeout: Duration,
    ...
    pub(in crate::resolution::acquisition) fn open_with_budget_for_transport(
        path: &Path,
        maximum_launches: usize,
        timeout: Duration,
        captured_output_ceiling: u64,
    ...
    pub(in crate::resolution::acquisition) fn verify(&self) -> Result<(), SourceResolveError> {
    ...
    pub(in crate::resolution::acquisition) fn verify_content(
        &self,
    ...
    pub(in crate::resolution::acquisition) fn validate_execution_policy_observations(
        &self,
    ) -> Result<(), SourceResolveError> {
    ...
    pub(in crate::resolution::acquisition) fn captured_output_observation(
        &self,
    ...
    pub(in crate::resolution::acquisition) fn network_transfer_observation(
        &self,
    ...
    pub(in crate::resolution::acquisition) fn record_command_execution(
        &self,
    ...
    pub(in crate::resolution::acquisition) fn resolver_connect_helper(
        &self,
    ) -> Option<&GitTransportExecutableObservation> {
    ...
    pub(in crate::resolution::acquisition) fn begin_launch(
        &self,
    ...
    pub(in crate::resolution::acquisition) fn verify_budget(
        &self,
    ) -> Result<(), SourceResolveError> {
        self.remaining_time().map(|_| ())
    }

    pub(in crate::resolution::acquisition) fn remaining_time(
        &self,
    ) -> Result<Duration, SourceResolveError> {
...
#[cfg(test)]
pub(in crate::resolution::acquisition) fn test_file_network_endpoint()
-> ResolverExecutionRequestedEndpoint {
...
#[cfg(test)]
pub(in crate::resolution::acquisition) fn test_system_git_executor(
