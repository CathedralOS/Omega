use crate::resolution::acquisition::git::request::GitTransportProfile;
use crate::resolution::acquisition::local::ResolvedLocalSource;
...
pub struct ResolvedGitSource {
    pub(in crate::resolution::acquisition) requested_locator: String,
    pub(in crate::resolution::acquisition) locator_identity: String,
    pub(in crate::resolution::acquisition) transport_profile: GitTransportProfile,
    pub(in crate::resolution::acquisition) requested_rev: String,
    pub(in crate::resolution::acquisition) commit: String,
    pub(in crate::resolution::acquisition) tree: String,
    pub(in crate::resolution::acquisition) snapshot_root: PathBuf,
    pub(in crate::resolution::acquisition) local: ResolvedLocalSource,
    ...
    pub(in crate::resolution::acquisition) git_executable: GitExecutableIdentity,
    ...
    pub(in crate::resolution::acquisition) transport_executable:
        Option<GitTransportExecutableIdentity>,
    ...
    pub(in crate::resolution::acquisition) execution_helper_executables:
    ...
    pub(in crate::resolution::acquisition) captured_output_observation:
        GitCapturedOutputObservation,
    pub(in crate::resolution::acquisition) network_transfer_observation:
        GitNetworkTransferObservation,
    pub(in crate::resolution::acquisition) resolution_observation: GitSourceResolutionObservation,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::resolution::acquisition) struct PendingResolvedGitSource {
    pub(in crate::resolution::acquisition) requested_locator: String,
    pub(in crate::resolution::acquisition) locator_identity: String,
    pub(in crate::resolution::acquisition) transport_profile: GitTransportProfile,
    pub(in crate::resolution::acquisition) requested_rev: String,
...
impl PendingResolvedGitSource {
    pub(in crate::resolution::acquisition) fn from_issued(resolved: &ResolvedGitSource) -> Self {
        Self {
