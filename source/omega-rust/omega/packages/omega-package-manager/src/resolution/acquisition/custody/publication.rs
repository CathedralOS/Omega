...
use crate::resolution::acquisition::git::cache::cache_invalid;
use crate::resolution::acquisition::git::snapshot::make_open_tree_owner_writable;
use crate::resolution::acquisition::limits::STAGING_SEQUENCE;
...
#[cfg(test)]
pub(in crate::resolution::acquisition) fn publish_cache_directory(
...
pub(in crate::resolution::acquisition) fn direct_cache_child_name<'a>(
    kind: CacheCustodyKind,
    parent: &Path,
    child: &'a Path,
...
pub(in crate::resolution::acquisition) fn retained_cache_directory_exists(
    kind: CacheCustodyKind,
...
pub(in crate::resolution::acquisition) fn publish_cache_directory_from_open_parent(
    kind: CacheCustodyKind,
    parent: &Path,
...
pub(in crate::resolution::acquisition) struct PendingCacheEntry {
    pub(in crate::resolution::acquisition) root: PathBuf,
    pub(in crate::resolution::acquisition) parent: CapabilityDirectory,
    pub(in crate::resolution::acquisition) directory: Option<CapabilityDirectory>,
    pub(in crate::resolution::acquisition) stage_name: OsString,
    pub(in crate::resolution::acquisition) published: bool,
}
...
impl PendingCacheEntry {
    ...
    pub(in crate::resolution::acquisition) fn directory(
        &self,
    ...
    pub(in crate::resolution::acquisition) fn create_private_directory(
        &self,
        name: &str,
        path: &Path,
    ) -> Result<(), SourceResolveError> {
    ...
    pub(in crate::resolution::acquisition) fn verify_ambient_path_identity(
        &self,
        cache_dir: &Path,
    ) -> Result<(), SourceResolveError> {
    ...
    pub(in crate::resolution::acquisition) fn publish(
        &mut self,
        cache_dir: &Path,
        entry_root: &Path,
        entry_name: &OsStr,
...
pub(in crate::resolution::acquisition) struct ProvisionalCacheDirectory<'a> {
    pub(in crate::resolution::acquisition) parent: &'a CapabilityDirectory,
    pub(in crate::resolution::acquisition) name: &'a OsStr,
    pub(in crate::resolution::acquisition) armed: bool,
}

impl<'a> ProvisionalCacheDirectory<'a> {
    pub(in crate::resolution::acquisition) fn new(
    ...
    pub(in crate::resolution::acquisition) fn disarm(mut self) {
        self.armed = false;
    }
}
...
pub(in crate::resolution::acquisition) fn create_private_cache_directory(
    parent: &CapabilityDirectory,
...
pub(in crate::resolution::acquisition) fn retain_private_cache_directory(
    kind: CacheCustodyKind,
    parent: &CapabilityDirectory,
    name: &OsStr,
    path: &Path,
