...
use crate::resolution::acquisition::git::{
...
use crate::resolution::acquisition::storage::RetainedStorageLane;
...
#[cfg(test)]
pub(in crate::resolution::acquisition) fn publish_local_snapshot(
...
pub(in crate::resolution::acquisition) fn local_snapshot_custody_identity(
    canonical_live_root: &Path,
