...
pub(in crate::resolution::acquisition) use capture::is_executable;
#[cfg(test)]
pub(in crate::resolution::acquisition) use capture::resolve_materialized_source;
...
pub(in crate::resolution::acquisition) use snapshot::local_snapshot_custody_identity;
#[cfg(test)]
pub(in crate::resolution::acquisition) use snapshot::publish_local_snapshot;
