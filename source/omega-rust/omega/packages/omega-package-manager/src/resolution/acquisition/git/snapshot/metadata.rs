...
pub(in crate::resolution::acquisition) fn local_snapshot_metadata(
...
pub(in crate::resolution::acquisition) fn verify_local_snapshot(
    publication: &Path,
...
#[derive(Debug, PartialEq, Eq)]
pub(in crate::resolution::acquisition) struct GitSnapshotMetadata {
...
pub(in crate::resolution::acquisition) fn git_snapshot_metadata(
    tree: &str,
    local: &ResolvedLocalSource,
) -> Vec<u8> {
