...
pub(in crate::resolution::acquisition) fn parse_git_tree_entries(
    listing: &[u8],
    repository: &Path,
...
pub(in crate::resolution::acquisition) fn git_directory_paths(
...
pub(in crate::resolution::acquisition) fn validate_git_symlink_target(
    link: &[u8],
    target: &[u8],
) -> Result<(), SourceResolveError> {
...
pub(in crate::resolution::acquisition) fn git_tree_invalid(
    path: impl AsRef<[u8]>,
