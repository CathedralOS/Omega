...
use crate::resolution::acquisition::local::io_error;
...
#[cfg(test)]
pub(in crate::resolution::acquisition) fn sealed_git_command(
    executor: &GitExecutor,
    working_directory: &Path,
    phase: ResolverExecutionPhase,
) -> Result<ResolverPreparedExecution, SourceResolveError> {
...
#[cfg(unix)]
pub(in crate::resolution::acquisition) fn git_helper_path(executor: &GitExecutor) -> OsString {
...
#[cfg(unix)]
pub(in crate::resolution::acquisition) fn sealed_ssh_command(ssh_executable: &Path) -> OsString {
...
#[cfg(unix)]
pub(in crate::resolution::acquisition) fn null_device() -> &'static str {
    "/dev/null"
}
