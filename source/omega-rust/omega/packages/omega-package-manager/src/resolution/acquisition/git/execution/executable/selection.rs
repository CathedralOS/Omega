...
use crate::resolution::acquisition::observations::GitTransportExecutableIdentity;
...
#[derive(Debug)]
pub(in crate::resolution::acquisition) struct GitTransportExecutableObservation {
    pub(in crate::resolution::acquisition) identity: GitTransportExecutableIdentity,
...
pub(in crate::resolution::acquisition) fn resolver_connect_helper_path()
...
pub(in crate::resolution::acquisition) fn open_https_transport_executable(
    git_executable: &Path,
) -> Result<GitTransportExecutableObservation, SourceResolveError> {
...
pub(in crate::resolution::acquisition) fn open_git_transport_executable(
    requested_path: &Path,
) -> Result<GitTransportExecutableObservation, SourceResolveError> {
...
pub(in crate::resolution::acquisition) fn verify_git_transport_executable(
...
#[cfg(target_os = "macos")]
pub(in crate::resolution::acquisition) fn system_git_candidates() -> &'static [&'static str] {
    &[
