...
pub(in crate::resolution::acquisition) use accounting::{
...
pub(in crate::resolution::acquisition) use resolution::issue_git_source_resolution_observation;
pub(in crate::resolution::acquisition) use resolved::PendingResolvedGitSource;
