...
fn repository_root_project_retains_application_role_and_package_entry_rejects() {
    ...
    crate::graph::resolve_git_package_closure_with_storage(
        &request,
        omega_target::TargetProfile::CrossPlatformCli,
        &storage,
        LocalSourceLimits::default(),
    ...
    let closure = crate::graph::resolve_git_project_closure_with_storage(
        &request,
        omega_target::TargetProfile::CrossPlatformCli,
        &storage,
        LocalSourceLimits::default(),
...
"#,
    ...
    let closure = crate::graph::resolve_selected_git_package_closure_with_storage(
        &request,
        omega_target::TargetProfile::CrossPlatformCli,
        &storage,
        LocalSourceLimits::default(),
...
"#,
    ...
    let closure = crate::graph::resolve_selected_git_project_closure_with_storage(
        &request,
        omega_target::TargetProfile::CrossPlatformCli,
        &storage,
        LocalSourceLimits::default(),
...
"#,
    ...
    let canonical = crate::graph::CanonicalSourceClosureSubject::from_resolved(
        &closure,
        crate::graph::CanonicalSourceClosureSubjectLimits::default(),
    )
...
"#,
    ...
    let error = crate::graph::resolve_selected_git_package_closure_with_storage(
        &request,
        omega_target::TargetProfile::CrossPlatformCli,
        &storage,
        LocalSourceLimits::default(),
