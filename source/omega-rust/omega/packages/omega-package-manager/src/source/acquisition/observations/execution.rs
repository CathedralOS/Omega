...
pub struct GitExecutableIdentity {
    ...
    pub(in crate::source::acquisition) content_identity: String,
}
...
pub struct GitTransportExecutableIdentity {
    pub(in crate::source::acquisition) invocation_path: PathBuf,
    pub(in crate::source::acquisition) path: PathBuf,
    pub(in crate::source::acquisition) content_identity: String,
}
...
pub struct GitCommandExecutionObservation {
    pub(in crate::source::acquisition) phase: ResolverExecutionPhase,
    pub(in crate::source::acquisition) policy_identity: String,
    pub(in crate::source::acquisition) command_identity: String,
    pub(in crate::source::acquisition) status_code: Option<i32>,
    pub(in crate::source::acquisition) termination_signal: Option<i32>,
    pub(in crate::source::acquisition) stdout_length: u64,
    pub(in crate::source::acquisition) stdout_identity: String,
    pub(in crate::source::acquisition) stderr_length: u64,
    pub(in crate::source::acquisition) stderr_identity: String,
    pub(in crate::source::acquisition) endpoint_observation:
