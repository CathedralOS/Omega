...
#[cfg(test)]
use crate::source::acquisition::{open_absolute_directory_nofollow, verify_cache_custody_root};
...
pub(in crate::source::acquisition) struct PendingMaterializedSnapshot {
    pub(in crate::source::acquisition) root: PathBuf,
    pub(in crate::source::acquisition) parent: CapabilityDirectory,
    pub(in crate::source::acquisition) directory: Option<CapabilityDirectory>,
    pub(in crate::source::acquisition) stage_name: OsString,
    pub(in crate::source::acquisition) kind: CacheCustodyKind,
    pub(in crate::source::acquisition) published: bool,
}
...
impl PendingMaterializedSnapshot {
    ...
    pub(in crate::source::acquisition) fn create_from_open_parent(
        kind: CacheCustodyKind,
        snapshots: &Path,
    ...
    pub(in crate::source::acquisition) fn directory(
        &self,
    ...
    pub(in crate::source::acquisition) fn publish(
        &mut self,
        snapshots: &Path,
        publication: &Path,
