...
use crate::source::acquisition::limits::{GIT_CONFIG_SHA256, LocalSourceLimits};
use crate::source::acquisition::local::{SourceTreePolicy, capture_local_source, io_error};
...
use crate::source::acquisition::storage::{RetainedStorageLane, SourceResolverStorage};
...
pub(in crate::source::acquisition) fn requested_network_endpoint(
    request: &GitSourceRequest,
...
pub(in crate::source::acquisition) fn resolve_verified_git_cache_entry(
...
pub(in crate::source::acquisition) fn validate_pending_git_request(
    pending: &PendingResolvedGitSource,
    request: &GitSourceRequest,
...
pub(in crate::source::acquisition) fn verify_pending_git_snapshot(
    pending: &PendingResolvedGitSource,
    limits: LocalSourceLimits,
) -> Result<(), SourceResolveError> {
...
pub(in crate::source::acquisition) fn bounded_git_fetch_arguments(
    fetch_locator: &str,
    requested_rev: &str,
    limits: LocalSourceLimits,
) -> Vec<OsString> {
...
pub(in crate::source::acquisition) fn replace_canonical_git_control_file(
...
pub(in crate::source::acquisition) fn replace_canonical_git_control_file_from_open_repository(
