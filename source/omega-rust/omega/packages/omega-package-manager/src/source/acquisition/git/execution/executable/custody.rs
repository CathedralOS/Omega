...
use crate::source::acquisition::custody::same_std_and_capability_file_identity;
#[cfg(any(target_os = "macos", windows))]
use crate::source::acquisition::local::capture::open_absolute_directory_nofollow;
#[cfg(any(target_os = "macos", windows))]
...
#[cfg(target_os = "macos")]
pub(in crate::source::acquisition) fn verify_macos_open_executable_acl_custody(
    path: &Path,
