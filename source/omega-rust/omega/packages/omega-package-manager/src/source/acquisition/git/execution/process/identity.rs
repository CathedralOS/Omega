...
use crate::source::acquisition::git::objects::{GitTreeEntry, GitTreeEntryKind};
use crate::source::acquisition::local::{hash_bytes, hash_length};
use omega_resolver_execution::ResolverExecutionPhase;
use sha2::{Digest, Sha256};
use std::ffi::OsStr;
use std::process::Command;

pub(in crate::source::acquisition) enum GitCommandStdinIdentity {
    Null,
    ExactBytes { length: u64, identity: String },
}

pub(in crate::source::acquisition) fn git_batch_stdin_identity(
...
pub(in crate::source::acquisition) fn git_command_configuration_identity(
    command: &Command,
