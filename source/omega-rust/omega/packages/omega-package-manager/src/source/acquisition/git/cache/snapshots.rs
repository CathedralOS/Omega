...
pub(in crate::source::acquisition) struct RetainedGitSnapshots {
    pub(in crate::source::acquisition) path: PathBuf,
    pub(in crate::source::acquisition) entry: CapabilityDirectory,
    pub(in crate::source::acquisition) directory: CapabilityDirectory,
    pub(in crate::source::acquisition) identity: CapabilityMetadata,
}
...
impl RetainedGitSnapshots {
    ...
    pub(in crate::source::acquisition) fn publication_exists(
        &self,
        publication: &Path,
