...
#[derive(Debug, Clone)]
pub(in crate::source::acquisition) struct GitCapturedOutputBudget {
    pub(in crate::source::acquisition) ceiling: u64,
    pub(in crate::source::acquisition) observed: Arc<AtomicU64>,
}

impl GitCapturedOutputBudget {
    pub(in crate::source::acquisition) fn new(ceiling: u64) -> Self {
        Self {
            ceiling,
    ...
    pub(in crate::source::acquisition) fn observed(&self) -> u64 {
        self.observed.load(Ordering::Acquire)
    }

    pub(in crate::source::acquisition) fn charge(
        &self,
        count: usize,
...
pub(in crate::source::acquisition) struct CapturedOutputLimitExceeded {
    pub(in crate::source::acquisition) ceiling: u64,
    pub(in crate::source::acquisition) attempted: u64,
}
