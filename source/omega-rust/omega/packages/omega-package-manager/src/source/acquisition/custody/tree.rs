...
use crate::source::acquisition::git::cache::{cache_invalid, local_snapshot_invalid};
...
pub(in crate::source::acquisition) enum CacheCustodyKind {
    Git,
    LocalSnapshot,
}

pub(in crate::source::acquisition) fn read_bounded_cache_record(
...
pub(in crate::source::acquisition) fn read_bounded_cache_record_from_open_directory(
    kind: CacheCustodyKind,
...
pub(in crate::source::acquisition) fn verify_git_cache_custody(
    root: &Path,
...
pub(in crate::source::acquisition) fn verify_git_cache_root_custody(
    root: &Path,
) -> Result<(), SourceResolveError> {
    verify_cache_custody_root(root, CacheCustodyKind::Git)
}

pub(in crate::source::acquisition) fn verify_local_cache_custody(
    root: &Path,
    limits: LocalSourceLimits,
) -> Result<(), SourceResolveError> {
    verify_cache_custody(
...
#[cfg(test)]
pub(in crate::source::acquisition) fn verify_local_cache_root_custody(
    root: &Path,
) -> Result<(), SourceResolveError> {
    verify_cache_custody_root(root, CacheCustodyKind::LocalSnapshot)
}

pub(in crate::source::acquisition) fn verify_cache_custody_root(
    root: &Path,
    kind: CacheCustodyKind,
) -> Result<(), SourceResolveError> {
...
pub(in crate::source::acquisition) fn git_cache_custody_byte_limit(
    limits: LocalSourceLimits,
) -> u64 {
    limits
        .max_bytes
...
pub(in crate::source::acquisition) fn local_cache_custody_byte_limit(
    limits: LocalSourceLimits,
) -> u64 {
    limits
        .max_bytes
...
pub(in crate::source::acquisition) fn verify_cache_custody(
    root: &Path,
    kind: CacheCustodyKind,
    byte_limit: u64,
) -> Result<(), SourceResolveError> {
...
pub(in crate::source::acquisition) fn verify_cache_custody_from_open_root(
    root: &Path,
...
pub(in crate::source::acquisition) fn cache_custody_has_capacity(
    observed: usize,
    pending: usize,
) -> bool {
    observed
...
pub(in crate::source::acquisition) fn open_cache_custody_directory(
...
pub(in crate::source::acquisition) fn cache_custody_invalid(
    kind: CacheCustodyKind,
    path: &Path,
