...
pub(in crate::source::acquisition) fn reconcile_git_command_endpoint_result<T>(
...
pub(in crate::source::acquisition) fn reconcile_git_command_result<T>(
    result: Result<T, SourceResolveError>,
    executable_result: Result<(), SourceResolveError>,
    budget_result: Result<(), SourceResolveError>,
) -> Result<T, SourceResolveError> {
...
pub(in crate::source::acquisition) fn reconcile_git_cache_operation_result<T>(
