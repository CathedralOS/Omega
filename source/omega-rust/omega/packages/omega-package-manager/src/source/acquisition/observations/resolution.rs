...
use crate::source::acquisition::git::objects::{git_object_algorithm, git_object_invalid};
...
pub struct GitSourceResolutionObservation {
    pub(in crate::source::acquisition) schema_version: u32,
    pub(in crate::source::acquisition) identity: String,
    pub(in crate::source::acquisition) command_count: usize,
    pub(in crate::source::acquisition) captured_output_ceiling: u64,
    pub(in crate::source::acquisition) captured_output_observed: u64,
    pub(in crate::source::acquisition) network_transfer_ceiling: u64,
    pub(in crate::source::acquisition) network_transfer_uploaded: u64,
    pub(in crate::source::acquisition) network_transfer_downloaded: u64,
}
...
pub(in crate::source::acquisition) fn issue_git_source_resolution_observation(
