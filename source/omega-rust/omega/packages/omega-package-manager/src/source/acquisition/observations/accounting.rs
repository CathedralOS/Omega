...
pub struct GitCapturedOutputObservation {
    ...
    pub(in crate::source::acquisition) observed: u64,
}
...
pub struct GitNetworkTransferObservation {
    pub(in crate::source::acquisition) ceiling: u64,
    pub(in crate::source::acquisition) uploaded: u64,
    pub(in crate::source::acquisition) downloaded: u64,
}
...
pub(in crate::source::acquisition) fn git_resolution_captured_output_ceiling(
...
pub(in crate::source::acquisition) fn git_resolution_network_transfer_ceiling(
    limits: LocalSourceLimits,
) -> u64 {
    limits
        .max_bytes
...
pub(in crate::source::acquisition) fn git_network_transfer_observation(
...
pub(in crate::source::acquisition) fn git_captured_output_observation(
    commands: &[GitCommandExecutionObservation],
    ceiling: u64,
