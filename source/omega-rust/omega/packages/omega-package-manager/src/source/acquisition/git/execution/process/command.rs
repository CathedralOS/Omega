...
use crate::source::acquisition::git::request::GitExecutionTransport;
use crate::source::acquisition::local::io_error;
...
pub(in crate::source::acquisition) fn sealed_git_command_with_route(
...
#[cfg(test)]
pub(in crate::source::acquisition) fn sealed_git_command(
    executor: &GitExecutor,
    working_directory: &Path,
    phase: ResolverExecutionPhase,
) -> Result<Command, SourceResolveError> {
...
#[cfg(unix)]
pub(in crate::source::acquisition) fn git_helper_path(executor: &GitExecutor) -> OsString {
...
#[cfg(unix)]
pub(in crate::source::acquisition) fn sealed_ssh_command(ssh_executable: &Path) -> OsString {
...
#[cfg(unix)]
pub(in crate::source::acquisition) fn null_device() -> &'static str {
    "/dev/null"
}
