use crate::source::acquisition::git::request::GitTransportProfile;
use crate::source::acquisition::local::ResolvedLocalSource;
...
pub struct ResolvedGitSource {
    ...
    pub(in crate::source::acquisition) transport_profile: GitTransportProfile,
    pub(in crate::source::acquisition) requested_rev: String,
    pub(in crate::source::acquisition) commit: String,
    pub(in crate::source::acquisition) tree: String,
    pub(in crate::source::acquisition) snapshot_root: PathBuf,
    pub(in crate::source::acquisition) local: ResolvedLocalSource,
    ...
    pub(in crate::source::acquisition) git_executable: GitExecutableIdentity,
    ...
    pub(in crate::source::acquisition) transport_executable: Option<GitTransportExecutableIdentity>,
    ...
    pub(in crate::source::acquisition) execution_helper_executables:
    ...
    pub(in crate::source::acquisition) captured_output_observation: GitCapturedOutputObservation,
    pub(in crate::source::acquisition) network_transfer_observation: GitNetworkTransferObservation,
    pub(in crate::source::acquisition) resolution_observation: GitSourceResolutionObservation,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::source::acquisition) struct PendingResolvedGitSource {
    pub(in crate::source::acquisition) requested_locator: String,
    pub(in crate::source::acquisition) locator_identity: String,
    pub(in crate::source::acquisition) transport_profile: GitTransportProfile,
    pub(in crate::source::acquisition) requested_rev: String,
...
impl PendingResolvedGitSource {
    pub(in crate::source::acquisition) fn from_issued(resolved: &ResolvedGitSource) -> Self {
        Self {
