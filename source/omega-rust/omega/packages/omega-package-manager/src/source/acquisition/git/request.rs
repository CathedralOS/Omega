...
use crate::source::acquisition::limits::{GIT_LOCATOR_BYTE_LIMIT, GIT_REVISION_BYTE_LIMIT};
...
pub struct GitSourceRequest {
    pub(in crate::source::acquisition) requested_locator: String,
    pub(in crate::source::acquisition) fetch_locator: String,
    pub(in crate::source::acquisition) locator_identity: String,
    pub(in crate::source::acquisition) requested_revision: String,
    pub(in crate::source::acquisition) lineage: SourceLineage,
    pub(in crate::source::acquisition) execution_transport: GitExecutionTransport,
    pub(in crate::source::acquisition) requested_network_endpoint: GitRequestedNetworkEndpoint,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::source::acquisition) enum GitExecutionTransport {
    Https,
    Ssh,
    #[cfg(test)]
    File,
...
impl GitExecutionTransport {
    ...
    pub(in crate::source::acquisition) fn resolver_network_transport(
        self,
    ) -> ResolverExecutionNetworkTransport {
        match self {
    ...
    pub(in crate::source::acquisition) fn cache_tag(self) -> &'static [u8] {
        match self {
            Self::Https => b"https",
            Self::Ssh => b"ssh",
            #[cfg(test)]
    ...
    pub(in crate::source::acquisition) fn allowed_protocol(self) -> &'static str {
        match self {
            Self::Https => "https",
            Self::Ssh => "ssh",
            #[cfg(test)]
    ...
    pub(in crate::source::acquisition) fn permits(self, transport: Self) -> &'static str {
        if self == transport { "always" } else { "never" }
    }

    pub(in crate::source::acquisition) fn profile(self) -> GitTransportProfile {
        match self {
...
impl GitSourceRequest {
    ...
    pub(in crate::source::acquisition) fn fetch_locator(&self) -> &str {
        &self.fetch_locator
    }

    pub(in crate::source::acquisition) fn execution_transport(&self) -> GitExecutionTransport {
