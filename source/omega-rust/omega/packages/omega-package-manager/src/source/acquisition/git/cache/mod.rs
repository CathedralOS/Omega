...
pub(in crate::source::acquisition) use creation::create_git_cache_entry;
#[allow(unused_imports)]
pub(in crate::source::acquisition) use creation::parse_git_remote_object_format;
...
pub(in crate::source::acquisition) use invalidation::invalidate_git_cache_entry_from_open_parent;
#[cfg(test)]
pub(in crate::source::acquisition) use invalidation::invalidate_git_cache_entry_from_retained_parent;
pub(in crate::source::acquisition) use repository::VerifiedGitRepository;
pub(in crate::source::acquisition) use snapshots::RetainedGitSnapshots;
