...
#[derive(Debug)]
pub(in crate::source::acquisition) struct GitExecutor {
    pub(in crate::source::acquisition) identity: GitExecutableIdentity,
    pub(in crate::source::acquisition) metadata_identity: GitExecutableMetadataIdentity,
    pub(in crate::source::acquisition) transport_executable:
        Option<GitTransportExecutableObservation>,
    pub(in crate::source::acquisition) execution_helpers: Vec<GitTransportExecutableObservation>,
    pub(in crate::source::acquisition) execution_transport: GitExecutionTransport,
    pub(in crate::source::acquisition) requested_network_endpoint:
        ResolverExecutionRequestedEndpoint,
    pub(in crate::source::acquisition) started: Instant,
    pub(in crate::source::acquisition) timeout: Duration,
    pub(in crate::source::acquisition) launches: Cell<usize>,
    pub(in crate::source::acquisition) execution_policy_observations:
        RefCell<Vec<ResolverExecutionPolicyObservation>>,
    pub(in crate::source::acquisition) command_execution_observations:
        RefCell<Vec<GitCommandExecutionObservation>>,
    pub(in crate::source::acquisition) captured_output_budget: GitCapturedOutputBudget,
    pub(in crate::source::acquisition) network_transfer_budget: ResolverExecutionTransferBudget,
    pub(in crate::source::acquisition) maximum_launches: usize,
    pub(in crate::source::acquisition) execution_backend: ResolverExecutionBackend,
}

impl GitExecutor {
    pub(in crate::source::acquisition) fn system(
    ...
    #[cfg(test)]
    pub(in crate::source::acquisition) fn open(path: &Path) -> Result<Self, SourceResolveError> {
    ...
    #[cfg(test)]
    pub(in crate::source::acquisition) fn open_with_budget(
        path: &Path,
    ...
    #[cfg(test)]
    pub(in crate::source::acquisition) fn open_with_resource_budgets(
        path: &Path,
        maximum_launches: usize,
        timeout: Duration,
    ...
    pub(in crate::source::acquisition) fn open_with_budget_for_transport(
        path: &Path,
        maximum_launches: usize,
        timeout: Duration,
        captured_output_ceiling: u64,
    ...
    pub(in crate::source::acquisition) fn verify(&self) -> Result<(), SourceResolveError> {
    ...
    pub(in crate::source::acquisition) fn verify_content(&self) -> Result<(), SourceResolveError> {
        self.verify()?;
    ...
    pub(in crate::source::acquisition) fn validate_execution_policy_observations(
        &self,
    ...
    pub(in crate::source::acquisition) fn captured_output_observation(
        &self,
    ...
    pub(in crate::source::acquisition) fn network_transfer_observation(
        &self,
    ...
    pub(in crate::source::acquisition) fn record_command_execution(
        &self,
    ...
    pub(in crate::source::acquisition) fn resolver_connect_helper(
        &self,
    ) -> Option<&GitTransportExecutableObservation> {
    ...
    pub(in crate::source::acquisition) fn begin_launch(
        &self,
    ...
    pub(in crate::source::acquisition) fn verify_budget(&self) -> Result<(), SourceResolveError> {
        self.remaining_time().map(|_| ())
    }

    pub(in crate::source::acquisition) fn remaining_time(
        &self,
    ) -> Result<Duration, SourceResolveError> {
...
#[cfg(test)]
pub(in crate::source::acquisition) fn test_file_network_endpoint()
-> ResolverExecutionRequestedEndpoint {
...
#[cfg(test)]
pub(in crate::source::acquisition) fn test_system_git_executor(
