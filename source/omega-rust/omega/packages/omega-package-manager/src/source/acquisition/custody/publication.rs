...
use crate::source::acquisition::git::cache::cache_invalid;
use crate::source::acquisition::git::snapshot::make_open_tree_owner_writable;
use crate::source::acquisition::limits::STAGING_SEQUENCE;
...
#[cfg(test)]
pub(in crate::source::acquisition) fn publish_cache_directory(
...
pub(in crate::source::acquisition) fn direct_cache_child_name<'a>(
    kind: CacheCustodyKind,
    parent: &Path,
    child: &'a Path,
...
pub(in crate::source::acquisition) fn retained_cache_directory_exists(
    kind: CacheCustodyKind,
...
pub(in crate::source::acquisition) fn publish_cache_directory_from_open_parent(
    kind: CacheCustodyKind,
    parent: &Path,
...
pub(in crate::source::acquisition) struct PendingCacheEntry {
...
impl PendingCacheEntry {
    ...
    pub(in crate::source::acquisition) fn create_private_directory(
        &self,
        name: &str,
        path: &Path,
    ) -> Result<(), SourceResolveError> {
    ...
    pub(in crate::source::acquisition) fn verify_ambient_path_identity(
        &self,
        cache_dir: &Path,
    ) -> Result<(), SourceResolveError> {
...
pub(in crate::source::acquisition) struct ProvisionalCacheDirectory<'a> {
    pub(in crate::source::acquisition) parent: &'a CapabilityDirectory,
    pub(in crate::source::acquisition) name: &'a OsStr,
    pub(in crate::source::acquisition) armed: bool,
}

impl<'a> ProvisionalCacheDirectory<'a> {
    pub(in crate::source::acquisition) fn new(
    ...
    pub(in crate::source::acquisition) fn disarm(mut self) {
        self.armed = false;
    }
}
...
pub(in crate::source::acquisition) fn create_private_cache_directory(
    parent: &CapabilityDirectory,
...
pub(in crate::source::acquisition) fn retain_private_cache_directory(
    kind: CacheCustodyKind,
    parent: &CapabilityDirectory,
    name: &OsStr,
    path: &Path,
