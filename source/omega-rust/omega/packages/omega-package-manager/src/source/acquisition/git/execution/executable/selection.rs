...
use crate::source::acquisition::observations::GitTransportExecutableIdentity;
...
#[derive(Debug)]
pub(in crate::source::acquisition) struct GitTransportExecutableObservation {
    pub(in crate::source::acquisition) identity: GitTransportExecutableIdentity,
...
pub(in crate::source::acquisition) fn resolver_connect_helper_path()
...
pub(in crate::source::acquisition) fn open_https_transport_executable(
    git_executable: &Path,
) -> Result<GitTransportExecutableObservation, SourceResolveError> {
...
pub(in crate::source::acquisition) fn open_git_transport_executable(
    requested_path: &Path,
) -> Result<GitTransportExecutableObservation, SourceResolveError> {
...
pub(in crate::source::acquisition) fn verify_git_transport_executable(
...
#[cfg(target_os = "macos")]
pub(in crate::source::acquisition) fn system_git_candidates() -> &'static [&'static str] {
    &[
