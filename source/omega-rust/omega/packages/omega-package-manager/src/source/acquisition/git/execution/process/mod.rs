...
#[cfg(test)]
pub(in crate::source::acquisition) use capture::{capture_stream_bounded, run_command_bounded};
#[cfg(test)]
pub(in crate::source::acquisition) use command::sealed_git_command;
#[allow(unused_imports)] // Preserve the former package-internal process API.
pub(in crate::source::acquisition) use command::{
...
#[allow(unused_imports)] // Preserve the former package-internal process API.
pub(in crate::source::acquisition) use invocation::{
    run_git, run_git_bytes_stdout, run_git_output, run_git_stdout,
};
#[allow(unused_imports)] // Preserve the former package-internal process API.
pub(in crate::source::acquisition) use reconciliation::{
    reconcile_git_cache_operation_result, reconcile_git_command_endpoint_result,
    reconcile_git_command_result,
};

pub(in crate::source::acquisition) fn format_sha256(bytes: &[u8]) -> String {
    identity::format_sha256(bytes)
}

pub(in crate::source::acquisition) fn format_hex(bytes: &[u8]) -> String {
