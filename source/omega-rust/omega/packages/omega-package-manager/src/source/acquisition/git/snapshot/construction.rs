...
#[cfg(not(unix))]
use crate::source::acquisition::git_tree_invalid;
...
pub(in crate::source::acquisition) fn open_or_create_snapshot_directory(
...
pub(in crate::source::acquisition) fn write_snapshot_file_from_open_root(
    kind: CacheCustodyKind,
    root: &CapabilityDirectory,
    relative_path: &Path,
    display_root: &Path,
...
#[cfg(unix)]
pub(in crate::source::acquisition) fn create_snapshot_symlink_from_open_root(
    kind: CacheCustodyKind,
    root: &CapabilityDirectory,
    relative_path: &Path,
    display_root: &Path,
