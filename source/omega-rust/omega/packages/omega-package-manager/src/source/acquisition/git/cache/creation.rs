...
#[cfg(unix)]
use crate::source::acquisition::{CapabilityOpenOptionsExt, CapabilityPermissionsExt};

use super::{VerifiedGitRepository, cache_invalid, git_cache_metadata};

pub(in crate::source::acquisition) fn create_git_cache_entry(
...
pub(in crate::source::acquisition) fn parse_git_remote_object_format(
    output: &[u8],
    working_directory: &Path,
) -> Result<GitObjectIdAlgorithm, SourceResolveError> {
