...
pub(in crate::source::acquisition) use construction::{
    create_snapshot_symlink_from_open_root, open_or_create_snapshot_directory,
    write_snapshot_file_from_open_root,
};
#[cfg(test)]
pub(in crate::source::acquisition) use materialization::preflight_git_snapshot;
pub(in crate::source::acquisition) use materialization::resolve_git_snapshot;
#[cfg(test)]
pub(in crate::source::acquisition) use metadata::git_snapshot_metadata;
...
pub(in crate::source::acquisition) use metadata::GitSnapshotMetadata;
pub(in crate::source::acquisition) use metadata::{local_snapshot_metadata, verify_local_snapshot};
pub(in crate::source::acquisition) use permissions::{
...
pub(in crate::source::acquisition) use publication::PendingMaterializedSnapshot;
