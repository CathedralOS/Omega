...
#[cfg(test)]
pub(in crate::source::acquisition) fn invalidate_git_cache_entry_from_retained_parent(
    entry_root: &Path,
...
pub(in crate::source::acquisition) fn invalidate_git_cache_entry_from_open_parent(
    cache_root: &Path,
