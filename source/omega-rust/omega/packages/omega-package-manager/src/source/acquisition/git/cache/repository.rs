...
pub(in crate::source::acquisition) struct VerifiedGitRepository {
    pub(in crate::source::acquisition) entry_root: PathBuf,
    pub(in crate::source::acquisition) repository_path: PathBuf,
    pub(in crate::source::acquisition) entry_name: OsString,
    pub(in crate::source::acquisition) expected_metadata: Vec<u8>,
    pub(in crate::source::acquisition) cache_parent: CapabilityDirectory,
    pub(in crate::source::acquisition) entry: CapabilityDirectory,
    pub(in crate::source::acquisition) repository: CapabilityDirectory,
    pub(in crate::source::acquisition) objects: CapabilityDirectory,
    pub(in crate::source::acquisition) entry_identity: CapabilityMetadata,
    pub(in crate::source::acquisition) repository_identity: CapabilityMetadata,
    pub(in crate::source::acquisition) objects_identity: CapabilityMetadata,
}

impl VerifiedGitRepository {
    pub(in crate::source::acquisition) fn open(
    ...
    pub(in crate::source::acquisition) fn path(&self) -> &Path {
        &self.repository_path
    }

    pub(in crate::source::acquisition) fn verify_identity(&self) -> Result<(), SourceResolveError> {
    ...
    pub(in crate::source::acquisition) fn verify_current(
        &self,
        limits: LocalSourceLimits,
    ...
    pub(in crate::source::acquisition) fn read_canonical_config(
        &self,
    ...
    pub(in crate::source::acquisition) fn restore_canonical_config(
        &self,
        canonical_config: &[u8],
    ) -> Result<(), SourceResolveError> {
    ...
    pub(in crate::source::acquisition) fn open_or_create_snapshots(
        &self,
