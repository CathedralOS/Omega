...
"#,
    ...
    assert_eq!(
        family.authority(),
        omega_package_evidence::evidence::PackageReviewProviderSelectionAuthority::BuildOverride
    );
    assert_eq!(
        family.coverage(),
        omega_package_evidence::evidence::PackageReviewProviderFamilyCoverage::CompleteDeclarationFamily
    );
    ...
    assert!(coordinates.iter().all(|coordinate| matches!(
        ...
        omega_package_evidence::evidence::PackageReviewProviderFamilyApplicationCoverage::NonGeneric
    )));
