...
fn identity(marker: u8) -> psi_core::PackageKeyIdentity {
    psi_core::PackageKeyIdentity::from_digest([marker; 32]).expect("nonzero package identity")
}
...
"#,
    ...
    fn child_inputs(
        ...
        let tree =
            omega_build_output::replayed_single_ordinary_file(b"generated.omg", generated_source)
                .expect("generated checkpoint source should form a retained output tree");
        let generated =
            omega_build_output::select_included_sources(&tree, &[b"generated.omg".to_vec()])
