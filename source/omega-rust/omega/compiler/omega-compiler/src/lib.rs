...
pub use compiler::{
    ...
    Compiler, ComponentDeploymentReportError, ExecutablePublicationDestination,
    ExecutablePublicationReceipt, RequestedCompileProduct, RetainedNativeArtifact, compile,
};
