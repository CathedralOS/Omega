...
impl MultiTargetCompileRequest {
    ...
    pub(in crate::compiler) fn validate_batch_for_execution(
        ...
        let package_source_inputs = first
            .package_inputs()
            .map(omega_package_compilation::PackageCompilationInputs::source_inputs);
...
mod tests {
    ...
    fn package_identity(marker: u8) -> psi_core::PackageKeyIdentity {
        psi_core::PackageKeyIdentity::from_digest([marker; 32])
