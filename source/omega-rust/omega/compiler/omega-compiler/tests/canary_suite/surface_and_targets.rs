...
fn contract_canary_visualizes_flow_contract_summaries() {
    ...
    assert!(
        executable_regions.contains(
            ...
            && executable_regions.contains("\"fixed_mechanics_validation_report_fingerprint\": \"0x")
            && executable_regions.contains("\"fixed_mechanics_boundary_contract_report_fingerprint\": \"0x")
            && executable_regions.contains("\"fixed_mechanics_footprint_report_fingerprint\": \"0x")
            && executable_regions.contains("\"body_specification_instruction_count\": ")
            && executable_regions.contains("\"body_specification_validation_report_fingerprint\": \"0x")
            && executable_regions.contains("\"body_specification_boundary_contract_report_fingerprint\": \"0x")
            && executable_regions.contains("\"body_specification_footprint_report_fingerprint\": \"0x")
            && executable_regions.contains("\"composed_footprint_report_fingerprint\": \"0x")
            ...
            && executable_regions.contains("\"relocation_envelope_report_fingerprint\": \"0x")
            && executable_regions.contains("\"derivation_report_fingerprint\": \"0x")
