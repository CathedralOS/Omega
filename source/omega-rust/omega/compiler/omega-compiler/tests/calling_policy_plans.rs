...
fn emitted_program_storage_bridge(
    ...
    let continuation_key = omega_function_identity::StateKey {
    ...
    object
        ...
        .insert(omega_object_file::FunctionSymbolPlan {
            identity: omega_function_identity::MachineFunctionIdentity::source(continuation_key),
            symbol: entry,
        });
        ...
        .dispatch_source_continuation_executor(
            ...
            |mut handoff| {
                ...
                assert_eq!(
                    ...
                    omega_function_identity::MachineFunctionIdentity::source(expected_continuation)
                );
                assert_eq!(
