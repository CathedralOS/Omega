...
pub(in crate::tests) fn saturating_integer_multiply_parameters_plan(
    ...
    let ScalarType::Integer(scalar_type) = function.parameters[left_parameter].scalar_type else {
        panic!("saturating-integer-multiply fixture requires integer operands")
    };
...
pub(in crate::tests) fn uniform_saturating_integer_multiply_plan(
    integer: IntegerType,
    parameter_count: usize,
) -> AbstractOperationPlan {
    saturating_integer_multiply_parameters_plan(
