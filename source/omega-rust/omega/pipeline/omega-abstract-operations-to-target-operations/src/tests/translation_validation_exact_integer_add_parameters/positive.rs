...
use psi_core::{EdgeId, IntegerSign, IntegerType, ObligationId, OperationId, ScalarType, ValueId};

#[test]
fn validates_all_exact_integer_add_types_and_operand_placements_on_every_target() {
    let targets = [
