//! Optimizer module role: stage group. Borrowed byte-sequence Unit-return custody by behavior.
...
use crate::{
    ...
    StraightLineByteSequenceLiteralUnitReturnTranslationError, lower_to_target_operations,
