//! Optimizer module role: stage group. Unused integer-literal Unit-return custody by behavior.
...
use crate::{
    ...
    StraightLineIntegerLiteralUnitReturnTranslationError, lower_to_target_operations,
