...
#[test]
fn validates_native_bitwise_xor_boundaries_on_every_native_target() {
        ...
        for scalar_type in native_types() {
            for (left_value, right_value) in boundary_pairs(scalar_type) {
                ...
                let AbstractToTargetFunctionTranslationDisposition::Validated(
                    ...
                    panic!("constant integer bitwise-XOR must publish only its exact immediate family")
                };
                ...
                assert_eq!(row.return_edge(), EdgeId::new(79_009).unwrap());
...
#[test]
fn classifier_is_disjoint_from_plain_not_and_or_and_parameter_xor() {
    ...
    *value = ValueId::new(79_004).unwrap();
    ...
    bitwise_not.functions[0].operations[1] = AbstractOperation::IntegerBitwiseNot {
        ...
        operand: ValueId::new(79_004).unwrap(),
    };
    ...
    for replacement in [
        ...
        assert!(
            !crate::validation::straight_line_integer_bitwise_xor_immediate::is_candidate(
    ...
    assert!(
        !crate::validation::straight_line_integer_bitwise_xor_immediate::is_candidate(
            &super::super::parameter_translation_fixture::uniform_integer_bitwise_xor_plan(
                scalar_type(),
                2,
            )
            .functions[0]
