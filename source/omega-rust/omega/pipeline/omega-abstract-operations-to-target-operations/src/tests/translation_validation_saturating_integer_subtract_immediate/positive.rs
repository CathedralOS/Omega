...
#[test]
fn validates_native_saturating_sub_boundaries_on_every_native_target() {
        ...
        for scalar_type in native_types() {
            for (left_value, right_value) in boundary_pairs(scalar_type) {
                ...
                let AbstractToTargetFunctionTranslationDisposition::Validated(
                    ...
                    panic!("constant saturating integer-subtract must publish only its exact immediate family")
                };
                ...
                assert_eq!(row.return_edge(), EdgeId::new(81_009).unwrap());
    ...
    *value = ValueId::new(81_004).unwrap();
    ...
    for replacement in [
        AbstractOperation::ExactIntegerSubtract {
            ...
            obligation: ObligationId::new(81_011).unwrap(),
        },
        ...
        assert!(
            !crate::validation::straight_line_saturating_integer_subtract_immediate::is_candidate(
    ...
    assert!(
        !crate::validation::straight_line_saturating_integer_subtract_immediate::is_candidate(
            &super::super::parameter_translation_fixture::uniform_saturating_integer_subtract_plan(
                scalar_type(),
                2,
            )
            .functions[0]
