...
use omega_target_operations::TargetBoundaryResult;
...
pub(super) fn lower(
    ...
    for (case_tag, (successor, declared_case)) in cases.iter().zip(declared_cases).enumerate() {
        ...
        for payload in &successor.payloads {
            ...
            target_payloads.push(omega_target_operations::TargetUnitStructuralCasePayload {
                field: payload.field,
        ...
        target_cases.push(omega_target_operations::TargetUnitStructuralCaseSuccessor {
