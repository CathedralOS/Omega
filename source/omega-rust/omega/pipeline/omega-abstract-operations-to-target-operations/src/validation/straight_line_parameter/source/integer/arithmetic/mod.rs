...
pub(in crate::validation::straight_line_parameter) mod saturating_divide;
pub(in crate::validation::straight_line_parameter) mod saturating_multiply;
pub(in crate::validation::straight_line_parameter) mod saturating_remainder;
...
pub(in crate::validation::straight_line_parameter) mod wrapping_remainder;
