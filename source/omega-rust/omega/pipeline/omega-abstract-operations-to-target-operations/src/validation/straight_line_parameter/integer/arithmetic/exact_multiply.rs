//! Exact integer-multiply-of-parameters target replay with range-obligation custody.
...
pub(crate) fn is_candidate(function: &AbstractFunction) -> bool {
    super::super::super::source::integer::arithmetic::exact_multiply::is_candidate(function)
}
...
pub(crate) fn validate(
    ...
    StraightLineExactIntegerMultiplyParametersTranslationError,
> {
    let reconstructed = super::reconstruct_exact_multiply(source, expected_target, target)?;
    ...
    let TargetOperation::ReturnIntegerExpression {
        ...
        return Err(StraightLineExactIntegerMultiplyParametersTranslationError::TargetOperation);
    };
    ...
    Ok(
        StraightLineExactIntegerMultiplyParametersTranslationReceipt::new(
            source.machine,
