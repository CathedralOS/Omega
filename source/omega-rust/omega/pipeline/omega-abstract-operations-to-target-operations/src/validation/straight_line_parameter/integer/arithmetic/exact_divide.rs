//! Exact integer-divide replay with defined-division obligation custody.
...
pub(crate) fn is_candidate(function: &AbstractFunction) -> bool {
    super::super::super::source::integer::arithmetic::exact_divide::is_candidate(function)
}
...
pub(crate) fn validate(
    ...
    StraightLineExactIntegerDivideParametersTranslationError,
> {
    let reconstructed = super::reconstruct_exact_divide(source, expected_target, target)?;
    ...
    let TargetOperation::ReturnIntegerExpression {
        ...
        return Err(StraightLineExactIntegerDivideParametersTranslationError::TargetOperation);
    };
    ...
    Ok(
        StraightLineExactIntegerDivideParametersTranslationReceipt::new(
            source.machine,
