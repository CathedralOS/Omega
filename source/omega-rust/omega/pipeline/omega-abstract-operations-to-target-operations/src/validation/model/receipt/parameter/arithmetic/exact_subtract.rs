...
use psi_core::{EdgeId, IntegerType, MachineId, ObligationId, OperationId, ValueId};

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct StraightLineExactIntegerSubtractParametersTranslationReceipt {
    machine: MachineId,
...
impl StraightLineExactIntegerSubtractParametersTranslationReceipt {
    ...
    pub const fn subtract_operation(self) -> OperationId {
