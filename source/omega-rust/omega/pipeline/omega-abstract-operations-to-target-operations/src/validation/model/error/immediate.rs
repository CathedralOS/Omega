...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum StraightLineWrappingIntegerDivideImmediateOperandsTranslationError {
    SourceParameters,
    SourceStructuralParameters,
    SourceResult,
    SourceEntryClaims,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum StraightLineWrappingIntegerRemainderImmediateOperandsTranslationError {
    SourceParameters,
    SourceStructuralParameters,
    SourceResult,
    SourceEntryClaims,
    ...
    SourceIntegerType,
    SourceConstantOutsideType,
    SourceRemainderOperands,
    SourceRemainderUndefined,
    SourceResultLink,
    SourceCleanup,
    TargetProvenance,
    TargetOperation,
