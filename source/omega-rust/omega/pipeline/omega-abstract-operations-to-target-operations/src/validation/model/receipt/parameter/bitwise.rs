...
pub struct StraightLineIntegerBitwiseAndParametersTranslationReceipt {
    machine: MachineId,
    and_operation: OperationId,
    return_edge: EdgeId,
...
impl StraightLineIntegerBitwiseAndParametersTranslationReceipt {
    ...
    pub const fn and_operation(self) -> OperationId {
        self.and_operation
    }
