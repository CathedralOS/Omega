//! Typed receipt for exact constant wrapping integer shift-right materialization.

use psi_core::{EdgeId, IntegerType, IntegerValue, MachineId, OperationId, ValueId};

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct StraightLineWrappingIntegerShiftRightImmediateTranslationReceipt {
    machine: MachineId,
...
impl StraightLineWrappingIntegerShiftRightImmediateTranslationReceipt {
