//! Exact source grammar for inclusively ordering two same-type integer constants.
...
pub(super) fn reconstruct(
...
) -> Result<ReconstructedIntegerLessOrEqualImmediate, Error> {
    ...
    if *left != *left_constant_result || *right != *right_constant_result {
        return Err(Error::SourceLessOrEqualOperands);
    }
