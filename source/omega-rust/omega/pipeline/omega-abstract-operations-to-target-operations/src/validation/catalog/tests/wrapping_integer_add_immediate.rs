//! Catalog selection canaries for the exact constant-integer-wrapping integer addition family.
    ...
    assert!(matches!(
        ...
        Err(
            AbstractToTargetTranslationValidationError::AmbiguousFunctionFamily {
                first: AbstractToTargetTranslationFamily::StraightLineWrappingIntegerAddImmediate,
                second: AbstractToTargetTranslationFamily::StraightLineWrappingIntegerAddImmediate,
                ..
            }
        )
    ));
...
fn pair() -> (AbstractFunction, TargetFunction) {
    ...
    let wrapping_add_operation = OperationId::new(73_307).unwrap();
    let wrapping_add_result = ValueId::new(73_308).unwrap();
        ...
        AbstractFunction {
            ...
            operations: vec![
                ...
                AbstractOperation::WrappingIntegerAdd {
                    psi_operation: wrapping_add_operation,
                    result: wrapping_add_result,
                    scalar_type,
...
mixed_structural_scalar_abi: None,
            ...
            operation: TargetOperation::ReturnIntegerImmediate {
                psi_edge: edge,
                source_value: wrapping_add_result,
                scalar_type,
                value: IntegerValue::Unsigned(0x64),
            },
        },
    )
}
