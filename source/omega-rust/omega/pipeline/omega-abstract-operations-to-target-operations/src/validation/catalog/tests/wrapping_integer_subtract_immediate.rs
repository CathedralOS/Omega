//! Catalog selection canaries for the exact constant-integer-wrapping integer subtraction family.
...
fn pair() -> (AbstractFunction, TargetFunction) {
    ...
    let wrapping_subtract_operation = OperationId::new(73_307).unwrap();
    let wrapping_subtract_result = ValueId::new(73_308).unwrap();
        ...
        AbstractFunction {
            ...
            operations: vec![
                ...
                AbstractOperation::WrappingIntegerSubtract {
                    psi_operation: wrapping_subtract_operation,
                    result: wrapping_subtract_result,
                    scalar_type,
                ...
                AbstractOperation::Return {
                    ...
                    value: wrapping_subtract_result,
                    scalar_type: ScalarType::Integer(scalar_type),
...
mixed_structural_scalar_abi: None,
            provenance: TerminalPsiProvenance {
                operations: vec![
                    ...
                    wrapping_subtract_operation,
                ],
                edges: vec![edge],
            },
            operation: TargetOperation::ReturnIntegerImmediate {
                psi_edge: edge,
                source_value: wrapping_subtract_result,
                scalar_type,
                value: IntegerValue::Unsigned(0x46),
            },
        },
    )
}
