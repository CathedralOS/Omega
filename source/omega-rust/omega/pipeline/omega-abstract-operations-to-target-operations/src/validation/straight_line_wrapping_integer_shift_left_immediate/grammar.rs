//! Exact source grammar for wrapping left shift of two independently typed integer constants.
...
use super::StraightLineWrappingIntegerShiftLeftImmediateTranslationError as Error;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) struct ReconstructedWrappingIntegerShiftLeftImmediate {
...
pub(super) fn reconstruct(
    ...
    Ok(ReconstructedWrappingIntegerShiftLeftImmediate {
