//! Exact source grammar for bitwise-XOR of two same-type integer constants.
...
pub(super) fn reconstruct(
...
) -> Result<ReconstructedIntegerBitwiseXorImmediate, Error> {
    ...
    if *left != *left_constant_result || *right != *right_constant_result {
        return Err(Error::SourceBitwiseXorOperands);
    }
