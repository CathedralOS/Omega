//! Exact source grammar for saturating multiplication of two same-type integer constants.
...
use super::StraightLineSaturatingIntegerMultiplyImmediateTranslationError as Error;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) struct ReconstructedSaturatingIntegerMultiplyImmediate {
    pub(super) machine: MachineId,
    pub(super) left_constant_operation: OperationId,
    pub(super) right_constant_operation: OperationId,
    pub(super) saturating_mul_operation: OperationId,
    pub(super) return_edge: EdgeId,
    pub(super) left_constant_result: ValueId,
    pub(super) right_constant_result: ValueId,
    pub(super) saturating_mul_result: ValueId,
...
pub(super) fn reconstruct(
...
) -> Result<ReconstructedSaturatingIntegerMultiplyImmediate, Error> {
    ...
    let [AbstractOperation::IntegerConstant {
        ...
        psi_operation: saturating_mul_operation,
        result: saturating_mul_result,
        scalar_type,
        left,
        right,
