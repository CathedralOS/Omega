...
//!
//! Owns the proof-certified exact integer-divide constant fold contract and proposal join.
...
pub struct ExactIntegerDivideConstantsRule;

impl ExactIntegerDivideConstantsRule {
...
impl PsiOptimizationRule for ExactIntegerDivideConstantsRule {
