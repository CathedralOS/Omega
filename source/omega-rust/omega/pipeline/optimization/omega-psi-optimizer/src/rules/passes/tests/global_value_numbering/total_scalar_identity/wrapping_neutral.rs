...
#[test]
fn rule_accepts_signed_and_wider_unsigned_typed_literals() {
...
#[test]
fn rule_emits_exactly_the_five_semantic_rows() {
    let cases = [
        (
            WrappingNeutralOperation::Add,
...
#[test]
fn rule_rejects_adjacent_but_unequal_partitions() {
    for unit in [
...
#[test]
fn rule_rejects_dead_non_pure_and_type_mismatched_inputs() {
...
#[test]
fn ties_choose_the_left_identity_row_canonically() {
