...
pub struct IntegerLessOrEqualRangeConstantRule;

impl IntegerLessOrEqualRangeConstantRule {
    pub fn contract() -> OptimizationRuleContract {
        super::contract(b"omega.psi-rule.integer-less-or-equal-range-constant.v1")
    }
}

impl PsiOptimizationRule for IntegerLessOrEqualRangeConstantRule {
