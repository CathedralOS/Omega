...
struct ProofRangeOperation {
    ...
    goal: psi_terminal_semantics::CanonicalScalarGoal,
}
    ...
    match kind {
        ProofRangeKind::Zero | ProofRangeKind::ZeroToThree => {
            ...
            ProofRangeOperation {
                ...
                goal: psi_terminal_semantics::CanonicalScalarGoal::ExactShiftCount {
                    value_type: input_type,
                    count_type: scalar_type,
                    count: psi_core::ScalarTerm::value(ranged, ScalarType::Integer(scalar_type)),
                },
            }
        }
        ProofRangeKind::Nonzero => ProofRangeOperation {
            ...
            goal: psi_terminal_semantics::CanonicalScalarGoal::NonzeroDivisor {
                integer_type: scalar_type,
                divisor: psi_core::ScalarTerm::value(ranged, ScalarType::Integer(scalar_type)),
            },
        },
    }
}
...
fn attach_proof_rows(
    ...
    rows: Vec<(
        OperationId,
        ObligationId,
        psi_terminal_semantics::CanonicalScalarGoal,
    )>,
) -> PsiOptimizationUnit {
