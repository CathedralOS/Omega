...
impl Case {
    pub(super) fn integer(
        ...
        Self {
            ...
            unit,
            rule,
            validator: omega_optimization_core::OptimizationValidatorIdentity::from_canonical_bytes(
...
pub(super) fn assert_operational_custody(cases: Vec<Case>) {
    ...
    for case in cases {
        ...
        {
            omega_optimization_unit::IntegerEvaluationWitness::Unary { .. } => 1,
            omega_optimization_unit::IntegerEvaluationWitness::Binary { .. }
            | omega_optimization_unit::IntegerEvaluationWitness::ProofCertifiedUnary { .. }
            | omega_optimization_unit::IntegerEvaluationWitness::RangeAgainstConstant { .. }
            | omega_optimization_unit::IntegerEvaluationWitness::RangeAgainstRange { .. } => 2,
            omega_optimization_unit::IntegerEvaluationWitness::ProofCertifiedBinary { .. } => 3,
        };
