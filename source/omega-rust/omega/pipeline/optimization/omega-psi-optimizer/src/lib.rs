...
pub use rules::{
    ...
    IntegerBitwiseXorConstantsRule, IntegerEqualConstantsRule, IntegerLessOrEqualConstantRangeRule,
    IntegerLessOrEqualConstantsRule, IntegerLessOrEqualRangeConstantRule,
    IntegerLessThanConstantRangeRule, IntegerLessThanConstantsRule,
    IntegerLessThanRangeConstantRule, IntegerWidenConstantsRule, LinearEmptyBlockThreadRule,
    ...
    NonAdjacentBlockMergeRule, PhiTranslatedObligationFreeScalarGvnRule,
    ...
    SaturatingIntegerSubtractConstantsRule, SharedJumpFusionRule, WrappingIntegerAddConstantsRule,
...
mod tests {
    ...
    fn edge(raw: u64, target: u64) -> AbstractSuccessor {
        AbstractSuccessor {
