//! Optimizer module role: executable entrance. Independent right-consumed copy-elision replay.
...
pub fn validate_aarch64_same_view_copy_i64_before_compare_i64_right_operand<
...
pub(crate) fn validate_from_inputs(
    ...
    if plan.policy
        != Aarch64SameViewCopyElisionPolicy::Aarch64ElideSameViewCopyI64BeforeCompareI64RightOperandV1
    {
