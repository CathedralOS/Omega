...
const COMPARED_LEFT: OperandCoordinate = OperandCoordinate {
...
const RELATIONS: [OperandRelation; 2] = [
    ...
    OperandRelation::SameVirtualRegister(DESTINATION, COMPARED_LEFT),
];

pub(crate) const AARCH64_SAME_VIEW_COPY_BEFORE_COMPARE_I64_LEFT_OPERAND_V1: InstructionPairPattern =
