...
fn two_pairs_pin_the_exact_nonzero_work_vector() {
    let fixture = fixture::two_pair_compare_fixture();
...
fn valid_non_candidates_are_retained_with_typed_outcomes() {
    let mut different_storage = fixture::compare_fixture();
    ...
    let mut wrong_value = fixture::compare_fixture();
    ...
    let mut semantic = fixture::compare_fixture();
