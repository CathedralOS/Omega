...
use omega_selected_instructions::{
    MachineAlternative, MachineAlternativeApplicability, SelectedBlock, SelectedInstruction,
    SelectedStructuralUnitFunction,
};

use crate::{
    BlockMachineEffects, InstructionMachineEffects, MachineAlternativeChoiceRule,
    PhysicalOperandFootprint, PostAllocationMachineBlock, PostAllocationMachineError,
...
mod tests {
    ...
    use omega_selected_instructions::{
        MachineAlternativeFamily, MachineAlternativeKey, MachineLatencyKnowledge,
        MachineSizeKnowledge, VirtualRegisterId,
    };
