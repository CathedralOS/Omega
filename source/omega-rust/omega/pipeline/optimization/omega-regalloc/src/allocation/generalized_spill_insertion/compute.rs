...
pub(super) struct PendingAction {
    ...
    pub store_instruction: omega_selected_instructions::SelectedInstructionId,
    pub before_reload: Option<GeneralizedSpillActionId>,
    pub store_source: omega_selected_instructions::VirtualRegisterId,
    pub source_view: omega_register_model::RegisterViewId,
    pub reload_instruction: omega_selected_instructions::SelectedInstructionId,
    pub destination_class: omega_register_model::RegisterClassId,
...
pub(super) struct PendingRewrite {
    ...
    pub instruction: omega_selected_instructions::SelectedInstructionId,
    pub operand: u16,
}
