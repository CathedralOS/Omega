...
use psi_core::{BlockId, IntegerCarrier, IntegerSign, IntegerType, IntegerValue, ScalarType};
...
pub(super) fn encode_target(bytes: &mut Vec<u8>, target: omega_target::NativeTarget) {
