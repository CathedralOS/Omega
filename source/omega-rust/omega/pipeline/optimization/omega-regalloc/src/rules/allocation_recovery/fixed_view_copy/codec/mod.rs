...
//!
//! Owns admission and authentication order. Public V9 carries the append-only
//! scalar-call selected vocabulary while retaining V4 through V8 decode.
...
use self::envelope::v9_identity;
use crate::{FixedViewCopyDecodeError, FixedViewCopyPlan};

#[cfg(test)]
use self::test_support::{encode_v4, encode_v5, encode_v6, encode_v7, encode_v8};
...
impl FixedViewCopyPlan {
    ...
    pub fn encode(&self) -> Vec<u8> {
        ...
        encoded.extend_from_slice(&v9_identity(self, &content));
