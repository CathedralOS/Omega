...
use crate::{
    ...
    LiveRangePoint, LiveRangeValidationReceipt, ValidatedLiveRanges, ValidatedLiveness,
    VirtualFixedConstraint, VirtualFixedConstraintSite, VirtualInterference, VirtualLiveRange,
    VirtualOccurrence, live_range_identity, validate_liveness,
};
...
pub fn validate_live_ranges(
    ...
    let receipt = LiveRangeValidationReceipt {
