...
fn compute_structural_unit_facts(
    ...
    entry_block: omega_selected_instructions::SelectedBlockId,
...
fn materialize_block(
    block: &SelectedBlock,
    positions: &BTreeMap<omega_selected_instructions::SelectedInstructionId, LivenessPosition>,
    ...
    virtual_exit: &BTreeMap<
        ...
        BTreeSet<VirtualRegisterId>,
    >,
    unit_entry: &BTreeMap<omega_selected_instructions::SelectedBlockId, BTreeSet<RegisterUnitId>>,
    unit_exit: &BTreeMap<omega_selected_instructions::SelectedBlockId, BTreeSet<RegisterUnitId>>,
) -> BlockLiveness {
...
pub(crate) mod tests {
    ...
    pub(crate) fn supported_tied_component_function() -> SelectedFunction {
        ...
        let SelectedTerminator::Return { instruction, .. } = &mut function.blocks[0].terminator
        else {
            unreachable!()
        };
