//! Public optimized-target custody for constant saturating integer-multiply materialization.

use super::super::*;

#[test]
fn optimized_target_lowering_retains_constant_saturating_integer_multiply_immediate_custody() {
    for target_profile in [
        ...
        for scalar_type in native_types() {
            for (left_value, right_value) in boundary_pairs(scalar_type) {
                ...
                let (semantic, proof) = saturating_integer_multiply_immediate_return_artifact(
                    scalar_type,
                    left_value,
                    right_value,
                );
                ...
                let AbstractToTargetFunctionTranslationDisposition::Validated(
                    ...
                    panic!("optimized saturating integer-multiply must retain its exact immediate family")
                };
                assert_eq!(
