...
pub(crate) fn wrapping_integer_remainder_parameters_return_artifact(
    integer_type: IntegerType,
    parameter_count: usize,
) -> (Vec<u8>, Vec<u8>) {
    assert!(
        parameter_count >= 2,
        "wrapping-remainder fixture needs two operands"
    );
    ...
    scalar_terminal_artifact(
        ...
        Some(OperationKind::WrappingIntegerRemainder {
