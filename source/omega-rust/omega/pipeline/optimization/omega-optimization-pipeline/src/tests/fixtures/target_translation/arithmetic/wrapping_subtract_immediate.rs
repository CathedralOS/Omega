//! Real Terminal fixture for constant integer wrapping integer subtraction materialization custody.

use super::super::*;

pub(crate) fn wrapping_integer_subtract_immediate_return_artifact(
    ...
    let wrapping_subtract = ValueId::new(73_008).unwrap();
