...
pub struct StagedSelectedLoweringOptimizationCustodyReceipt {
    ...
    final_liveness: omega_regalloc::LivenessIdentity,
    final_ranges: omega_regalloc::LiveRangeIdentity,
    final_legality: omega_regalloc::AllocationLegalityIdentity,
...
pub struct StagedOptimizedLiteralFoldAttemptReceipt {
    ...
    source_ranges: omega_regalloc::LiveRangeIdentity,
    source_legality: omega_regalloc::AllocationLegalityIdentity,
    choices: omega_regalloc::SpillChoiceIdentity,
    choice_policy: SpillChoicePolicy,
    choice_usage: OptimizationWorkUsage,
    recovery: omega_regalloc::RecoveryClassificationIdentity,
...
pub struct StagedOptimizedLiteralFoldIterationReceipt {
    ...
    fold_usage: OptimizationWorkUsage,
    transformed_selected: SelectedInstructionPlanIdentity,
    fresh_liveness: omega_regalloc::LivenessIdentity,
    fresh_ranges: omega_regalloc::LiveRangeIdentity,
    fresh_legality: omega_regalloc::AllocationLegalityIdentity,
}
...
fn spill_choice_policy_tag(policy: SpillChoicePolicy) -> u8 {
    match policy {
        SpillChoicePolicy::SingleBlockFarthestEndThenHighestVregV1 => 1,
    }
}

fn recovery_policy_tag(policy: RecoveryClassificationPolicy) -> u8 {
    match policy {
        RecoveryClassificationPolicy::SelectedVictimImmediateU64EligibilityV1 => 1,
    }
}

fn literal_fold_policy_tag(policy: LiteralFoldPolicy) -> u8 {
    match policy {
