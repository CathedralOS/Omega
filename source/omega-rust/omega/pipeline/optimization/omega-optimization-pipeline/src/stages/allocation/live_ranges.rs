...
use omega_regalloc::{
    LiveRangeError, LiveRangeIdentity, ValidatedLiveRanges, analyze_live_ranges,
...
pub fn stage_optimized_live_ranges(
    ...
    let ranges = analyze_live_ranges(liveness.selected_stage().selected(), liveness.liveness())
...
fn custody_receipt(
    ...
    ranges: omega_regalloc::LiveRangeValidationReceipt,
