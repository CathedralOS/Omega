...
use omega_selected_instructions::{
    MachineAlternativeFamily, MachineEncodedControlEffect, SelectedInstructionPlanIdentity,
};
...
use crate::{
    ...
    FunctionFragmentEmissionStage, ResolvedSelectedFormLayoutIdentity,
    SelectedFormEncodingIdentity, StagedOptimizedFunctionFragmentEmission,
    StagedOptimizedFunctionFragmentEmissionSource, WholeFunctionExitContractIdentity,
...
pub struct StagedOptimizedRelocationFreeTextSection {
    ...
    text_section: Box<RelocationFreeTextSectionPlacement>,
