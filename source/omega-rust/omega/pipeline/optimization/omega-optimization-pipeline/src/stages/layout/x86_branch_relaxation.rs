...
use omega_isa_x86_64::{
    X86_64SelectedFormEncodingError, encode_x86_64_selected_nonzero_branch_form,
    encode_x86_64_selected_short_nonzero_branch_form, validate_x86_64_selected_nonzero_branch_form,
...
mod tests {
    ...
    use crate::ResolvedSelectedBlockLayout;
    ...
    fn eligible_near_branch_shrinks_and_both_reflow_implementations_agree() {
        ...
        let short = encode_x86_64_selected_short_nonzero_branch_form(&physical, alternative(), 127)
            .unwrap();
    ...
    fn corrupted_action_changes_identity_and_is_rejected_by_replay_comparison() {
        let roots = RevisionRoots {
            ...
            selected: omega_selected_instructions::SelectedInstructionPlanIdentity::from_bytes(
                [2; 32],
            ),
