...
use crate::{
    ...
    WholeFunctionExitContractError, stage_whole_function_exit_contract,
...
pub struct StagedOptimizedActiveResidentRematerializationFunctionRelativeRealizationCustodyReceipt {
    ...
    exit_contract: crate::WholeFunctionExitContractIdentity,
...
struct SourceArtifacts<'source> {
    selected: &'source omega_regalloc::ValidatedPressureRematerialization,
