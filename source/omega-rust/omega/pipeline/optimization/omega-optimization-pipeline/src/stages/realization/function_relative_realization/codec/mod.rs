//! Optimizer module role: executable entrance. Frames and dispatches the v11 function-relative realization manifest protocol.
...
impl FunctionRelativeOptimizationRealizationManifest {
    pub fn recomputed_identity(&self) -> FunctionRelativeOptimizationRealizationManifestIdentity {
        ...
        canonical
            .extend_from_slice(b"omega.function-relative-optimization-realization-manifest.v11\0");
