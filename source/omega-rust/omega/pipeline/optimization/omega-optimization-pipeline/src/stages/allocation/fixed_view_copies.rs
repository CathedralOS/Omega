...
use omega_regalloc::{
    ...
    materialize_fixed_view_copies, validate_fixed_view_copies,
};
...
pub struct StagedOptimizedFixedViewCopyCustodyReceipt {
    ...
    source_liveness: omega_regalloc::LivenessIdentity,
...
pub fn stage_optimized_fixed_view_copies(
    ...
    let copies = materialize_fixed_view_copies(
...
fn custody_receipt(
    ...
    copies: omega_regalloc::FixedViewCopyValidationReceipt,
