...
use omega_selected_instructions::{
    ...
    MachineSizeKnowledge, SelectedBlock, SelectedBlockId, SelectedFunction, SelectedInstruction,
    SelectedInstructionId, SelectedTerminator,
};
...
pub struct ResolvedSelectedFormLayoutIdentity([u8; 32]);
...
pub struct StagedOptimizedResolvedSelectedFormLayout {
    ...
    structural_unit_functions: Vec<ResolvedStructuralUnitFunctionLayout>,
}
