...
impl ValidatedOptimizedObjectArtifactManifest {
    ...
    #[cfg(test)]
    pub(crate) fn record_mut(&mut self) -> &mut OptimizedObjectArtifactManifest {
        &mut self.record
    }
}
...
pub struct StagedValidatedOptimizedObjectArtifact {
    pub(super) terminal: psi_terminal_codec::CanonicalTerminalArtifact,
...
impl StagedValidatedOptimizedObjectArtifact {
    ...
    #[cfg(test)]
    pub(crate) fn artifact_mut(&mut self) -> &mut OptimizedObjectArtifactRecord {
        &mut self.artifact
    }

    #[cfg(test)]
    pub(crate) fn manifest_mut(&mut self) -> &mut ValidatedOptimizedObjectArtifactManifest {
        &mut self.manifest
    }
