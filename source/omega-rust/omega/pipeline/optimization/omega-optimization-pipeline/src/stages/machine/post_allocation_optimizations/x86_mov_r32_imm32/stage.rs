...
pub fn stage_optimized_x86_mov_r32_imm32_materialization_after_selected_lowering(
...
pub fn validate_optimized_x86_mov_r32_imm32_materialization_after_selected_lowering_custody(
    source: &StagedOptimizedRegisterHomesAfterSelectedLowering,
    machine: &StagedOptimizedPostAllocationMachinePlan,
    staged: &StagedOptimizedX86MovR32Imm32Materialization,
) -> Result<
