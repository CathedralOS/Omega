...
pub(super) fn identity(
    ...
    match schema {
        ...
        StructuralLegalizedIdentitySchema::V12 => {
            omega_legalized_operations::legalized_operation_plan_identity_v12_legacy(&legalized)
        }
        StructuralLegalizedIdentitySchema::V13 => {
            omega_legalized_operations::legalized_operation_plan_identity_v13_legacy(&legalized)
        }
        StructuralLegalizedIdentitySchema::V14 => {
            omega_legalized_operations::legalized_operation_plan_identity_v14_legacy(&legalized)
        }
    }
}
