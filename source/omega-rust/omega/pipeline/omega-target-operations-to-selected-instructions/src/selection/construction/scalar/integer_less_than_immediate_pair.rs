//! U64 parameter strict ordering controlling two immediate-return arms.
...
pub(super) fn is_candidate(source: &SourceFunction) -> bool {
    source.recipe == LegalizationRecipe::ReturnU64IntegerLessThanParametersConditionalV1
...
pub(super) fn build(
    ...
    let SourceLeafValue::Immediate {
        ...
        unreachable!("catalog selected less-than immediate pair")
    };
    let SourceLeafValue::Immediate {
