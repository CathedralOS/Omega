...
use omega_selected_instructions::{
    ...
    SelectedMicrosoftX64OwnedIndirectPairLayout, SelectedOperand, SelectedSelectionConstraints,
...
pub struct ValidatedLegalizedOperations {
    ...
    receipt: LegalizationValidationReceipt,
}
...
pub struct ValidatedSelectedInstructions {
    ...
    receipt: SelectedInstructionValidationReceipt,
}
...
pub struct SelectedInstructionValidationReceipt {
    identity: SelectedInstructionPlanIdentity,
    legalized: LegalizedOperationPlanIdentity,
...
mod structural_unit_tests {
    ...
    fn selected_structural_replay_rejects_abi_constraint_and_semantic_custody_mutations() {
        ...
        let linux_target =
            ...
            .unwrap();
        let linux_legalized =
            legalize_target_operations(&linux_target, &abstract_plan, &unit).unwrap();
