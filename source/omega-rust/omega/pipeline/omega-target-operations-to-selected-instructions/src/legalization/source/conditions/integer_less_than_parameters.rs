//! Exact ordered U64 entry-parameter strict-less-than condition reconstruction.
...
pub(super) fn derive<'a>(
    ...
    let fuel = exact_operation_fuel(less_than_node, *psi_operation, function)?;
    Ok(DerivedCondition {
        source: *condition_source,
        legalized: LegalizedCondition::IntegerLessThanParametersV1 {
