...
fn commit_and_coordinated_baseline_cost_corruption_fail_for_every_psi_suite() {
    for (optimization, fixture) in suite_cases() {
        ...
        assert_axis(
            project_optimization_run(commit_run),
        ...
        assert_axis(
            project_optimization_run(policy_run),
...
fn applied_manifest_pairing_rejects_each_identity_axis_and_roster_drift() {
    ...
    assert_axis(
        project_optimization_run(wrong_input),
    ...
    assert_axis(
        project_optimization_run(wrong_candidate),
    ...
    assert_axis(
        project_optimization_run(wrong_rule),
    ...
    assert_axis(
        project_optimization_run(missing_applied),
