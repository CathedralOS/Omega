...
pub(super) fn assign(
    ...
    provider: &psi_terminal::ProviderCandidateConformance,
    call_plan: &omega_calling_conventions::CallPlan,
    scalar_arguments: &[omega_target_operations::TargetUnitScalarCallArgument],
    source_arguments: &[psi_terminal::StructuralArgument],
    arguments: &[omega_target_operations::TargetStructuralArgument],
    claim_transfers: &[psi_terminal::ClaimTransfer],
    completion_claim_sources: &[omega_target_operations::CompletionClaimSource],
