...
use omega_terminal_isa_aarch64::{
    AARCH64_AAPCS64_RETURN, AARCH64_ADD_I64, AARCH64_COMPARE_I64_ZERO, AARCH64_CONDITIONAL_BRANCH,
    AARCH64_COPY_I64, AARCH64_DARWIN_RETURN, AARCH64_MATERIALIZE_I64,
...
use omega_terminal_isa_x86_64::{
    ...
    X86_64_MATERIALIZE_I64, X86_64_MICROSOFT_RETURN, X86_64_SYSTEM_V_RETURN,
...
mod tests {
    ...
    fn every_supported_native_target_builds_a_matching_closed_environment() {
        for target in [
            ...
            let (expected_copy, expected_add) = match target.architecture {
                Architecture::X86_64 => (X86_64_COPY_I64, X86_64_ADD_I64),
                Architecture::Aarch64 => (AARCH64_COPY_I64, AARCH64_ADD_I64),
            };
