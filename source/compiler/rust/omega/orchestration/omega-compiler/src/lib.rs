...
pub use pipeline::{
    ...
    ReservedProgramEntryReceiverStorage, ReviewOnlyBuildFilesystemReplayRecord,
    ...
    TerminalComponentStagingInputBindingError, TerminalComponentStagingInputs, ValidatedAccessPlan,
