...
pub use pipeline::{
    ...
    CompileOutputKind, CompileReport, CompileRequest, CompilerExecutableCommitment,
    ...
    TerminalComponentProviderExecution,
    ...
    compile_request, compile_to_checked, compile_to_checked_with_packages,
