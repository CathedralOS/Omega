...
pub use pipeline::{
    ...
    PackageDependencyBinding, PackageDependencyClosure, PackageReviewArithmeticDomain,
    ...
    TerminalComponentDeploymentOutputStage, TerminalComponentDeploymentReportError,
    TerminalComponentDeploymentSupply, TerminalComponentProviderExecution,
