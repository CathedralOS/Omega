...
The eventual Omega-written implementations belong under `source/compiler/omega/psi/` and
`source/compiler/omega/omega/`. Once the hosted path replaces this producer, the on-ramp can
