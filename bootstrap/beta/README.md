# `bootstrap/beta/` — the Beta compiler, written in Beta (SELF-HOSTING)
...
audited Alpha seed. `bootstrap/beta/rust/` remains available only as a
...
maximal-observation refinement gate under `source/assurance/refinement/beta/`.
