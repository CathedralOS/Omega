...
edge. The monotonic path now continues through byte/word memory and byte I/O,
then fixed-string emission plus the remaining exact capacities exercised by
`bc.beta`. Persisting and adopting a
...
source it has 271 states, 278 transitions, and 169 comparison nodes. It uses
