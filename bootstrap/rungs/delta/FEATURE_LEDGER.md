...
| implementation of Omega full-width trapping subtraction | OMGRSW5/OMGLOWE/CKIR13 preserve exact semantic `u32` words and implement six direct checkpoint forms through independent reference meaning, Rust-free Gamma publication, runtime underflow, least-version selection, conservative borrow-trapping artifacts, and OMGRFN15 persisted-Beta R1–R5; nine nested forms remain open | represent source semantic words with two exact limbs or positional signed cells while keeping structural IDs/counts narrow; do not infer a Delta `u32`, wrapping domain, or general arithmetic surface from the bridge implementation | selected direct product-source path demonstrated; Delta-v1 disposition unresolved |
...
the current compiler-side
[`CKIR13`](../../omega-bootstrap/compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V13.md)
successor, the admitted
[`OMGRFN15`](../../assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V15.md)
lower-rooted contract, and its predecessor
[`OMGRFN14`](../../assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V14.md).
Git and those versioned contract directories retain the
