#!/usr/bin/env python3
"""Canonical pack/verify/get tool for omega-bootstrap's Omega0 bundle format."""
...
def usage() -> BundleError:
    return BundleError(
        "usage: omega_bootstrap_bundle.py pack LABEL=FILE... | verify [BUNDLE] | "
...
if __name__ == "__main__":
    try:
        ...
        print(f"omega-bootstrap bundle: {error}", file=sys.stderr)
        raise SystemExit(2)
