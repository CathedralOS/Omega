...
| resolution | selected public multi-unit, call, data, receiver, scalar, view, bounded provider, recursive full-width arithmetic, and direct full-width `u64 < u64` relations; OMGRSW9 closes the product build's exact six-requirement `Console` selection and complete structural `ProviderPlan`, while checked-adapter execution and provider admission remain open | [`OMEGA_BOOTSTRAP_RESOLUTION_V9.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V9.md), [`OMEGA_BOOTSTRAP_RESOLUTION_V8.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V8.md), and their versioned predecessors under [`compiler/`](compiler/) |
...
| lower-rooted reconstruction | OMGRFN19 closes independent structural R1–R5 reconstruction for OMGCOMP3→OMGRSW9, representative persisted-Beta projections, and an actual native/self producer composite; it contains no checked IR, execution, artifact, provider admission, accepted-lock, or compilation authority | [`OMGCOMP_REFINEMENT_WITNESS_V19.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V19.md), preceding [`OMGCOMP_REFINEMENT_WITNESS_V18.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V18.md), and the [assurance index](../../source/assurance/refinement/omega-bootstrap/README.md) |
