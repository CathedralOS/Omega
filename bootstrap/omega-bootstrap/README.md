...
| lower-rooted reconstruction | selected source/checked-IR/artifact closures have independent R1–R5 reconstruction through admitted OMGRFN14; OMGRFN15 currently has only an explicitly non-admitting focused frame/reference seam | [`../assurance/refinement/omega-bootstrap/README.md`](../assurance/refinement/omega-bootstrap/README.md) and its versioned witness contracts |
