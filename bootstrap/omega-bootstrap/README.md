...
| checked lowering and conservative emission | private CKIR1–CKIR5 slices with focused native/self, meaning, resource, and artifact gates | [`OMEGA_BOOTSTRAP_CHECKED_IR.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V5.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V5.md) |
| lower-rooted reconstruction | selected CKIR4 closure complete; payload-sum OMGRFN7 partially complete | [`../assurance/refinement/omega-bootstrap/README.md`](../assurance/refinement/omega-bootstrap/README.md) |
