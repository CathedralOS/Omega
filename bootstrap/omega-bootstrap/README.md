...
| resolution | selected public multi-unit, call, data, receiver, scalar, view, bounded provider, recursive full-width arithmetic, and direct full-width `u64 < u64` relations; OMGRSW9 closes the product build's exact six-requirement `Console` selection and complete structural `ProviderPlan`, while provider admission remains open | [`OMEGA_BOOTSTRAP_RESOLUTION_V9.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V9.md), [`OMEGA_BOOTSTRAP_RESOLUTION_V8.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V8.md), and their versioned predecessors under [`compiler/`](compiler/) |
| checked lowering and conservative emission | OMGLOWI18/CKIR17 close native/self lowering of the selected receiverless `Console` adapters and ranked recurrent helper to ordered platform-neutral byte events, including exact explicit `u8 as i32` custody; the relation has no entry, admitted provider occurrence, evaluated calling-plan identity, syscall, backend, or artifact. Earlier CKIR16 retains its separate conservative unsigned artifact path | [`OMEGA_BOOTSTRAP_CHECKED_IR_V17.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V17.md), [`OMEGA_BOOTSTRAP_LOWERING_V18.md`](compiler/OMEGA_BOOTSTRAP_LOWERING_V18.md), and the preceding versioned contracts under [`compiler/`](compiler/) |
| lower-rooted reconstruction | OMGRFN20 closes independent R1–R5 reconstruction for exact OMGCOMP3→OMGRSW9→CKIR17, representative persisted-Beta projections, actual native/self producer bytes, and four abstract event observations; it contains no native artifact, provider admission, accepted-lock, or compilation authority | [`OMGCOMP_REFINEMENT_WITNESS_V20.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V20.md), preceding [`OMGCOMP_REFINEMENT_WITNESS_V19.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V19.md), and the [assurance index](../../source/assurance/refinement/omega-bootstrap/README.md) |
