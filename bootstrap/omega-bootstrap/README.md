...
| checked lowering and conservative emission | private CKIR1–CKIR6 vertical slices are closed through the selected bool-only logical-negation relation | [`OMEGA_BOOTSTRAP_CHECKED_IR.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V5.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V5.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V6.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V6.md) |
| lower-rooted reconstruction | selected CKIR4, payload-sum CKIR5/OMGRFN7, and logical-negation CKIR6/OMGRFN8 closures complete | [`../assurance/refinement/omega-bootstrap/README.md`](../assurance/refinement/omega-bootstrap/README.md) |
