...
| checked lowering and conservative emission | private CKIR1–CKIR10 vertical slices are closed through explicit exact pure-leaf `u8 as u32 in Trapping`, preserving the payload and all earlier selected forms | [`OMEGA_BOOTSTRAP_CHECKED_IR.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V10.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V10.md) |
| lower-rooted reconstruction | selected closures are complete through integer-widen CKIR10/OMGRFN12 | [`../assurance/refinement/omega-bootstrap/README.md`](../assurance/refinement/omega-bootstrap/README.md), [`OMGCOMP_REFINEMENT_WITNESS_V12.md`](../assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V12.md) |
