...
| checked lowering and conservative emission | private CKIR1–CKIR8 vertical slices are closed through selected pure/nontrapping same-carrier `bool`/`u8`/`u32` equality, preserving inherited logical, sum, and call forms | [`OMEGA_BOOTSTRAP_CHECKED_IR.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V5.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V5.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V6.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V6.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V7.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V7.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V8.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V8.md) |
| lower-rooted reconstruction | selected CKIR4, payload-sum CKIR5/OMGRFN7, logical-negation CKIR6/OMGRFN8, logical-binary CKIR7/OMGRFN9, and scalar-equality CKIR8/OMGRFN10 closures complete | [`../assurance/refinement/omega-bootstrap/README.md`](../assurance/refinement/omega-bootstrap/README.md) |
