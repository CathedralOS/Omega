...
| resolution | selected public multi-unit, calls, records, direct-field receivers, and first pure payload sums | [`OMEGA_BOOTSTRAP_RESOLUTION.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION.md), [`OMEGA_BOOTSTRAP_RESOLUTION_V2.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V2.md), [`OMEGA_BOOTSTRAP_RESOLUTION_V3.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V3.md) |
| checked lowering and conservative emission | private CKIR1–CKIR9 vertical slices are closed through selected pure/nontrapping authored-order same-carrier unsigned `u8`/`u32` `>`/`>=`, preserving inherited equality, logical, sum, and call forms | [`OMEGA_BOOTSTRAP_CHECKED_IR.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V5.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V5.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V6.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V6.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V7.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V7.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V8.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V8.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V9.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V9.md) |
| lower-rooted reconstruction | selected CKIR4, payload-sum CKIR5/OMGRFN7, logical-negation CKIR6/OMGRFN8, logical-binary CKIR7/OMGRFN9, scalar-equality CKIR8/OMGRFN10, and ordered-comparison CKIR9/OMGRFN11 closures complete | [`../assurance/refinement/omega-bootstrap/README.md`](../assurance/refinement/omega-bootstrap/README.md) |
