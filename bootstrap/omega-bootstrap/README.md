...
| checked lowering and conservative emission | private CKIR1–CKIR11 vertical slices are closed through selected canonical `u32 in Trapping` leaf-plus-literal addition, preserving all earlier selected forms | [`OMEGA_BOOTSTRAP_CHECKED_IR.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V11.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V11.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V11_BACKEND.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V11_BACKEND.md) |
| lower-rooted reconstruction | selected closures are complete through trapping-add CKIR11/OMGRFN13, including inherited CKIR10 widening | [`../assurance/refinement/omega-bootstrap/README.md`](../assurance/refinement/omega-bootstrap/README.md), [`OMGCOMP_REFINEMENT_WITNESS_V13.md`](../assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V13.md) |
