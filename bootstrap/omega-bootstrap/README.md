...
| lower-rooted reconstruction | persisted lower-rooted R1–R5 reconstruction is closed through OMGRFN16 for the bounded recursive full-width trapping-`u32` CKIR14 tranche: exhaustive responsibility-local Python evidence, representative identical native/self owner joins, first traps, complete Call/CaseDispatch argument vectors, inherited CKIR12 views, cross-pairs, and resource teeth now run as a precise cached lattice step | [`OMGCOMP_REFINEMENT_WITNESS_V16.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V16.md), preceding [`OMGCOMP_REFINEMENT_WITNESS_V14.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V14.md), and the [assurance index](../../source/assurance/refinement/omega-bootstrap/README.md) |
