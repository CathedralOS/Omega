...
| resolution | selected public multi-unit, call, data, receiver, scalar, view, bounded-provider, and full-width arithmetic relations; OMGRSWA10 adds a name/order-independent projection for guarded full-`u64` fixed-buffer load/store indexing and the Exact `length + 1` fact used by `SourceUnit` | [`OMEGA_BOOTSTRAP_RESOLUTION_V10.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V10.md), [`OMEGA_BOOTSTRAP_RESOLUTION_V9.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V9.md), and their versioned predecessors under [`compiler/`](compiler/) |
| checked lowering and conservative emission | OMGLOWJ19/CKIR18 close the selected entry-bearing fixed-buffer projection through full-width index bounds, load/store, defensive Add carry/result-range traps, exact execution, and a conservative Linux-x86-64 artifact. The authored increment remains Exact and statically justified; the lookup index remains Trapping. The separate CKIR17 relation retains platform-neutral `Console` adapter events without provider/native-effect authority | [`OMEGA_BOOTSTRAP_CHECKED_IR_V18.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V18.md), [`OMEGA_BOOTSTRAP_LOWERING_V19.md`](compiler/OMEGA_BOOTSTRAP_LOWERING_V19.md), and the preceding versioned contracts under [`compiler/`](compiler/) |
| lower-rooted reconstruction | OMGRFN21 closes independent R1–R5 reconstruction for exact OMGCOMP1→OMGRSWA10→CKIR18→ELF, representative persisted-Beta projections, and actual native/self producer bytes across renamed/reordered/inert variants, cross-pairs, resources, and artifact mutation. It grants no product, package, provider, compilation, or final-profile authority | [`OMGCOMP_REFINEMENT_WITNESS_V21.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V21.md), preceding [`OMGCOMP_REFINEMENT_WITNESS_V20.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V20.md), and the [assurance index](../../source/assurance/refinement/omega-bootstrap/README.md) |
