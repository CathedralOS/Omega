...
| checked lowering and conservative emission | private CKIR1–CKIR7 vertical slices are closed through selected pure/nontrapping bool-only `&&`/`||`, preserving inherited `!`, sums, and calls | [`OMEGA_BOOTSTRAP_CHECKED_IR.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V5.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V5.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V6.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V6.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V7.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V7.md) |
| lower-rooted reconstruction | selected CKIR4, payload-sum CKIR5/OMGRFN7, logical-negation CKIR6/OMGRFN8, and logical-binary CKIR7/OMGRFN9 closures complete | [`../assurance/refinement/omega-bootstrap/README.md`](../assurance/refinement/omega-bootstrap/README.md) |
