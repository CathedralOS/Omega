...
| checked lowering and conservative emission | private CKIR1–CKIR5 vertical slices are closed; focused OMGLOW7/CKIR6 bool-negation production, independent meaning, and backend evidence exists while its lower-rooted successor remains open | [`OMEGA_BOOTSTRAP_CHECKED_IR.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V5.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V5.md), [`OMEGA_BOOTSTRAP_CHECKED_IR_V6.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V6.md) |
| lower-rooted reconstruction | selected CKIR4 and payload-sum CKIR5/OMGRFN7 closures complete | [`../assurance/refinement/omega-bootstrap/README.md`](../assurance/refinement/omega-bootstrap/README.md) |
