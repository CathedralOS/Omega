...
| resolution | selected public multi-unit, call, data, receiver, scalar, view, bounded provider, and recursive full-width arithmetic relations; OMGRSW6 closes only one exact requirement/candidate/call relation with no selected plan, while OMGRSW7 is the least witness only when the complete source needs its selected `u32 in Trapping` relation | [`OMEGA_BOOTSTRAP_RESOLUTION_V6.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V6.md), [`OMEGA_BOOTSTRAP_RESOLUTION_V7.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V7.md), and their versioned predecessors under [`compiler/`](compiler/) |
| checked lowering and conservative emission | CKIR15 closes recurrent guarded head/tail over a runtime-capable direct shared-byte view, with the exact ordered direct-binder vector retained through both arms; native/self production, exact Rust-free meaning, conservative ELF, runtime-only/no-static-root custody, and inherited CKIR12/14 regressions are gated | [`OMEGA_BOOTSTRAP_CHECKED_IR_V15.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V15.md), [`OMEGA_BOOTSTRAP_LOWERING_V16.md`](compiler/OMEGA_BOOTSTRAP_LOWERING_V16.md), and [`OMEGA_BOOTSTRAP_CHECKED_IR_V15_BACKEND.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V15_BACKEND.md) |
| lower-rooted reconstruction | OMGRFN17 closes independent R1–R5 reconstruction for the CKIR15 recurrent-view tranche with exhaustive responsibility-local Python evidence, representative modular persisted-Beta owners, and an actual producer/backend same-frame composite; it remains bounded cost evidence rather than product-source admission | [`OMGCOMP_REFINEMENT_WITNESS_V17.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V17.md), preceding [`OMGCOMP_REFINEMENT_WITNESS_V16.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V16.md), and the [assurance index](../../source/assurance/refinement/omega-bootstrap/README.md) |
