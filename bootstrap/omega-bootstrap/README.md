...
| resolution | selected public multi-unit, call, data, receiver, scalar, view, bounded-provider, and full-width arithmetic relations; OMGRSWB11 extends guarded full-`u64` indexing to an actual-capacity fixed array of copyable records, chained field places, all nine scalar stores, and nine-argument calls | [`OMEGA_BOOTSTRAP_RESOLUTION_V11.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V11.md), [`OMEGA_BOOTSTRAP_RESOLUTION_V10.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V10.md), and their versioned predecessors under [`compiler/`](compiler/) |
| checked lowering and conservative emission | OMGLOWK20/CKIR19 close the selected entry-bearing record-array projection through full-width index bounds, record stride and field layout, nine typed stores, tag readback, defensive Add carry/result-range traps, two real calls, exact execution, and a conservative Linux-x86-64 artifact. The separate CKIR17 relation retains platform-neutral `Console` adapter events without provider/native-effect authority | [`OMEGA_BOOTSTRAP_CHECKED_IR_V19.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V19.md), [`OMEGA_BOOTSTRAP_LOWERING_V20.md`](compiler/OMEGA_BOOTSTRAP_LOWERING_V20.md), and the preceding versioned contracts under [`compiler/`](compiler/) |
| lower-rooted reconstruction | OMGRFN22 closes independent R1–R5 reconstruction for exact OMGCOMP1→OMGRSWB11→CKIR19→ELF, representative persisted-Beta projections, and actual native/self producer bytes across renamed/reordered/inert variants, cross-pairs, resources, and artifact mutation. It grants no product, package, provider, compilation, or final-profile authority | [`OMGCOMP_REFINEMENT_WITNESS_V22.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V22.md), preceding [`OMGCOMP_REFINEMENT_WITNESS_V21.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V21.md), and the [assurance index](../../source/assurance/refinement/omega-bootstrap/README.md) |
