...
| checked lowering and conservative emission | private versioned vertical slices preserve prior admitted forms while adding one selected compositional relation at a time; the current admitted frontier is CKIR12 | [`OMEGA_BOOTSTRAP_CHECKED_IR_V12.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V12.md) and its versioned predecessors/backend contracts under [`compiler/`](compiler/) |
