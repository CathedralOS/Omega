...
| resolution | selected public multi-unit, call, data, receiver, scalar, view, bounded provider, recursive full-width arithmetic, and direct full-width `u64 < u64` relations; OMGRSW6 closes only one exact requirement/candidate/call relation with no selected plan, OMGRSW7 is least only for its selected `u32 in Trapping` relation, and OMGRSW8 is least only for its selected direct pure `u64 < u64` relation | [`OMEGA_BOOTSTRAP_RESOLUTION_V8.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V8.md), [`OMEGA_BOOTSTRAP_RESOLUTION_V7.md`](compiler/OMEGA_BOOTSTRAP_RESOLUTION_V7.md), and their versioned predecessors under [`compiler/`](compiler/) |
| checked lowering and conservative emission | CKIR16 closes direct pure full-width same-carrier `u64 < u64`, paired-word storage/call/edge custody, and true-edge range narrowing while retaining optional inherited CKIR15 views and CKIR14 arithmetic; native/self production, exact Rust-free meaning, and conservative unsigned ELF emission are gated | [`OMEGA_BOOTSTRAP_CHECKED_IR_V16.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V16.md), [`OMEGA_BOOTSTRAP_LOWERING_V17.md`](compiler/OMEGA_BOOTSTRAP_LOWERING_V17.md), and [`OMEGA_BOOTSTRAP_CHECKED_IR_V16_BACKEND.md`](compiler/OMEGA_BOOTSTRAP_CHECKED_IR_V16_BACKEND.md) |
| lower-rooted reconstruction | OMGRFN18 closes independent R1–R5 reconstruction for the CKIR16 full-width `u64 < u64` tranche, including true-edge fact custody, representative persisted-Beta owners, and an actual producer/backend same-frame composite; it remains bounded cost evidence rather than product-source admission | [`OMGCOMP_REFINEMENT_WITNESS_V18.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V18.md), preceding [`OMGCOMP_REFINEMENT_WITNESS_V17.md`](../../source/assurance/refinement/omega-bootstrap/OMGCOMP_REFINEMENT_WITNESS_V17.md), and the [assurance index](../../source/assurance/refinement/omega-bootstrap/README.md) |
