...
fn source_canary() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR"))
        ...
        .nth(6)
        .expect(
            "omega-native-differential-test lives under bootstrap/onramps/omega-rust/omega/orchestration",
        )
        .join("canaries/pass/terminal_psi/content_custody_exit/main.omg")
}
