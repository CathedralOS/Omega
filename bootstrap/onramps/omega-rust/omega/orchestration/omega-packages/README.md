...
generated-symbol ownership gaps remain explicit, and provider/trust/proof/
reproducibility joins are incomplete. These pieces do not become an admission
path until the legacy name-keyed lock APIs are replaced and sealed
