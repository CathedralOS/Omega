...
pub use pipeline::{
    ...
    SOURCE_CLOSURE_SNAPSHOT_SCHEMA, ScalarFieldSchema, ScalarFieldValue,
    ...
    SourceClosureSnapshotEntry, SymbolicFieldValue, SymbolicMaterializationPlan,
    ...
    compile_with_artifact_policy, compile_with_packages, compile_with_policy,
