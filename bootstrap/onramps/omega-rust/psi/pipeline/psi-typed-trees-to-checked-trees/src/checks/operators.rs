use psi_checked_trees::{CheckFacts, CheckedOperatorResolutionIssue};
    ...
    fn rejects_ambiguous_operator_resolution_with_candidate_details() {
        ...
        let candidate_span = candidates.insert_many([
            CheckedOperatorCandidateFact::root(SymbolHandle::from_arena_index(10)).with_signature(
                Default::default(),
                Default::default(),
                HandleSpan::from_parts(psi_arena::Handle::from_arena_index(20), 1),
                0,
                2,
                false,
            ),
            ...
            .with_signature(
                Default::default(),
                Default::default(),
                HandleSpan::from_parts(psi_arena::Handle::from_arena_index(30), 3),
                1,
                2,
                false,
            ),
        ...
        let facts = CheckFacts {
            operators: psi_checked_trees::CheckedOperatorFacts::with_roots(
                uses,
                Default::default(),
                candidates,
            ),
