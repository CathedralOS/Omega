...
use psi_core::{
    ...
    ContentTerm, ContractId, DomainSemanticId, EdgeId, EvidenceIdentity, EvidenceTermId,
    ...
    ServiceId, StructuralCaseId, StructuralCaseSubject, StructuralDomainId, StructuralFieldId,
