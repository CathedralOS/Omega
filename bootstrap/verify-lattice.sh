...
step "omega-bootstrap OMGRFN2 layer 5 — complete CKIR/result and CKIR-to-ELF relations at v2 offsets below Delta" omega-bootstrap-refinement omgrfn2-ckir-elf-refinement.sh alpha alpha-assembler beta delta-rust omega-bootstrap omega-bootstrap-gates
