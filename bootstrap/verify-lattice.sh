...
step "omega-bootstrap CKIR4 resolved-source lowerer — bounded runtime records through structural Call/Copy" omega-bootstrap-gates delta-resolved-to-ckir4.sh omega-bootstrap-compiler delta-rust psi
step "omega-bootstrap CKIR4 lowering meaning (RUST-FREE) — constructor/Call/Copy 0/251/252 through Gamma" omega-bootstrap-gates delta-resolved-to-ckir4-meaning.sh omega-bootstrap-compiler omega-bootstrap-meaning delta-rust gamma psi
...
step "omega-bootstrap OMGRFN5 layer 1 — exact runtime-record frame, OMGCOMP graph, and source custody" omega-bootstrap-refinement omgrfn5-frame-omgcomp-custody.sh alpha alpha-assembler beta omega-bootstrap omega-bootstrap-gates
...
step "omega-bootstrap OMGRFN5 composite — all five independent responsibilities consume one exact runtime-record frame" omega-bootstrap-refinement omgrfn5-same-frame-composite.sh alpha alpha-assembler beta delta-rust omega-bootstrap omega-bootstrap-gates
