...
step "bc    — source control/effect/frame/data/expression/stack sites mapped to Alpha CFG" beta-refinement bc-block-control.sh alpha beta alpha-assembler
...
step "lowermachine meaning — real compiler executes through Gamma; exact state/tree/source ceilings fail closed" omega0-gates lowermachine-meaning.sh delta-rs gamma
