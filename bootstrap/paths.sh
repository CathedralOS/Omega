...
: "${OMEGA_PATH_COMPILER_ROOT:=$OMEGA_PATH_SOURCE_ROOT/compiler/omega}"
: "${OMEGA_PATH_BOOTSTRAP_ROOT:=$OMEGA_REPO_ROOT/bootstrap}"
: "${OMEGA_PATH_ASSURANCE_ROOT:=$OMEGA_PATH_SOURCE_ROOT/assurance}"
: "${OMEGA_PATH_REFINEMENT_ROOT:=$OMEGA_PATH_ASSURANCE_ROOT/refinement}"
: "${OMEGA_PATH_BOOTSTRAP_GATES_ROOT:=$OMEGA_PATH_BOOTSTRAP_ROOT/gates}"
...
: "${OMEGA_PATH_ALPHA:=$OMEGA_PATH_BOOTSTRAP_ROOT/alpha}"
: "${OMEGA_PATH_ALPHA_ASSEMBLER:=$OMEGA_PATH_ALPHA/assembler}"
: "${OMEGA_PATH_ALPHA_ASSEMBLER_RUST:=$OMEGA_PATH_ALPHA/assembler-rust}"
: "${OMEGA_PATH_BETA:=$OMEGA_PATH_BOOTSTRAP_ROOT/beta}"
: "${OMEGA_PATH_BETA_RUST:=$OMEGA_PATH_BETA/rust}"
: "${OMEGA_PATH_BETA_REFERENCE:=$OMEGA_PATH_BETA/reference}"
: "${OMEGA_PATH_BETA_REFINEMENT:=$OMEGA_PATH_REFINEMENT_ROOT/beta}"
: "${OMEGA_PATH_GAMMA:=$OMEGA_PATH_BOOTSTRAP_ROOT/gamma}"
: "${OMEGA_PATH_DELTA:=$OMEGA_PATH_BOOTSTRAP_ROOT/delta}"
: "${OMEGA_PATH_DELTA_RUST:=$OMEGA_PATH_DELTA/rust}"
...
: "${OMEGA_PATH_CORPUS:=$OMEGA_PATH_BOOTSTRAP_GATES_ROOT/corpus}"
: "${OMEGA_PATH_OMEGA_RUST_ONRAMP_ROOT:=$OMEGA_PATH_SOURCE_ROOT/compiler/rust}"
...
: "${OMEGA_PATH_PRODUCT_SOURCE_CHECKPOINTS:=$OMEGA_PATH_COMPILER_ROOT/source-checkpoints}"

export OMEGA_REPO_ROOT OMEGA_PATH_SOURCE_ROOT OMEGA_PATH_COMPILER_ROOT OMEGA_PATH_BOOTSTRAP_ROOT
export OMEGA_PATH_ASSURANCE_ROOT OMEGA_PATH_REFINEMENT_ROOT OMEGA_PATH_BOOTSTRAP_GATES_ROOT
