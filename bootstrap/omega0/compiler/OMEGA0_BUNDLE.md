...
`omega0_bundle.py` is an untrusted pack/inspection convenience, not part of the
language or trust base:

```sh
python3 bootstrap/omega0/compiler/omega0_bundle.py pack \
  src/main.omg=src/main.omg lib/math.omg=lib/math.omg > sources.omg0b
python3 bootstrap/omega0/compiler/omega0_bundle.py verify sources.omg0b
python3 bootstrap/omega0/compiler/omega0_bundle.py manifest sources.omg0b
python3 bootstrap/omega0/compiler/omega0_bundle.py get sources.omg0b src/main.omg
```
...
decoder canary is
[`../../../compiler/delta-rs/samples/omega0-bundle-decode.alp`](../../../compiler/delta-rs/samples/omega0-bundle-decode.alp).
