...
The [concatenative predecessor retirement](../../../wiki/pre_migration/design_briefs/bootstrap_cost_review.md#concatenative-delta-compiler-slice)
...
```text
3,445-line / 157,832-byte canonical entry plus shared Gamma implementation
