...
cat "$GATE_DIR/bc-block-control.alpha" \
  ...
  "$GATE_DIR/bc-parse-char-summary.alpha" > "$T/control-check.alpha"
...
cat "$GATE_DIR/bc-block-control.alpha" \
  ...
  "$GATE_DIR/bc-parse-char-shape.alpha" \
  "$GATE_DIR/bc-parse-char-cases.alpha" \
  "$GATE_DIR/bc-parse-char-summary.alpha" > "$T/flat-check.alpha"
