...
cat "$GATE_DIR/bc-block-control.alpha" \
  ...
  "$GATE_DIR/bc-parse-number-summary.alpha" > "$T/control-check.alpha"
...
cat "$GATE_DIR/bc-block-control.alpha" \
  ...
  "$GATE_DIR/bc-gen-stmts-boundary-summary.alpha" \
  "$GATE_DIR/bc-parse-number-shape.alpha" \
  "$GATE_DIR/bc-parse-number-summary.alpha" > "$T/flat-check.alpha"
