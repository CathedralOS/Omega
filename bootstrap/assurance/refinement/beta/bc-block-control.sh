...
cat "$GATE_DIR/bc-block-control.alpha" \
  ...
  "$GATE_DIR/bc-fixed-decimal-emitters-summary.alpha" > "$T/control-check.alpha"
...
cat "$GATE_DIR/bc-block-control.alpha" \
  ...
  "$GATE_DIR/bc-emit-dec-summary.alpha" \
  "$GATE_DIR/bc-fixed-decimal-emitters-shape.alpha" \
  "$GATE_DIR/bc-fixed-decimal-emitters-summary.alpha" > "$T/flat-check.alpha"
