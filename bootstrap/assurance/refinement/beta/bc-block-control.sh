...
cat "$GATE_DIR/bc-block-control.alpha" \
  ...
  "$GATE_DIR/bc-parse-output-prefix-summary.alpha" > "$T/control-check.alpha"
...
cat "$GATE_DIR/bc-block-control.alpha" \
  ...
  "$GATE_DIR/bc-fixed-decimal-emitters-summary.alpha" \
  "$GATE_DIR/bc-parse-output-prefix-shape.alpha" \
  "$GATE_DIR/bc-parse-output-prefix-summary.alpha" > "$T/flat-check.alpha"
