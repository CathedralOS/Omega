# `bootstrap/gamma/` — safe definitional computation
...
sh bootstrap/gamma/test-interp-arena.sh
sh bootstrap/gamma/test-typeck.sh
sh source/assurance/proof-kernel/gates/gamma-checker.sh
sh bootstrap/gamma/test-canonical-bytes.sh
sh bootstrap/gamma/test-terminal-codec-primitives.sh
```
