...
| `beta_encoding/` | Source-owned artifact-specific Beta definitions: byte classifiers, nibble conversion, fixed-width word serialization, and checked counter increment. | Replace only with a faithful complete Beta theory and independently reconstructed encoding root. |
