...
| `beta_encoding/` | Source-owned artifact-specific Beta definitions: byte classifiers, nibble conversion, and fixed-width word serialization. | Replace only with a faithful complete Beta theory and independently reconstructed encoding root. |
