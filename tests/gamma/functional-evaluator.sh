...
require_seed_execution_host "Functional Gamma evaluator"
...
echo "Functional Gamma evaluator: reconstruction, semantics, bounded capacities, and augmentation passed"
