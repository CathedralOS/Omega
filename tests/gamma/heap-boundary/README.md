...
The AlphaBootstrapV4 evaluator owns pair bytes
`[0x10000000, 0x70000000)`. Each pair occupies 40 bytes, admitting exactly
40,265,318 pairs with 16 unusable tail bytes. This is a private evaluator
...
| `scalar_adjacent.gamma` | attempts 40,265,319 | status 3, empty stdout |
| `application_exact.gamma` | 40,265,317 loop pairs plus one result pair | status 0, byte `A` |
| `application_adjacent.gamma` | 40,265,318 loop pairs plus one refused result pair | status 252, empty stdout |
