...
The retired streaming scalar Delta compiler used this layer directly. Its
historical source comparison was:
...
The Gamma1 compiler had 23 named-cell declarations, 8 named layout constants,
20 exact-text declarations, and zero authored `output-word` sites. Its generated
Delta receipts were byte-for-byte identical to the Gamma0 experiment.
...
The cold-start total did not improve: counting the lowerer, the authored surface
was 859 lines. D88 subsequently selected direct functional Gamma instead. This
lowerer's own retained surface comparison is not selected-chain authority or
justification to seek hypothetical new customers.
