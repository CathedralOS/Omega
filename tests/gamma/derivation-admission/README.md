...
and exact/adjacent 130 MiB request provision. All 70 vectors execute once,
including the six large boundary vectors. Every complete Gamma request, including diagnostic
