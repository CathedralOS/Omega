#!/usr/bin/env python3
# io-verify.py PROGRAM.gamma EXE — EXHAUSTIVE all-inputs check for a single-byte-reading program: for every
...
from gamma_parser import lex, Parser
from gamma_interp import interpret
