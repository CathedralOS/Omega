...
| `product-comparison-experiment/` | Exploratory `GAMMA-PRODUCT-COMPARISON` evidence: the seven-field Delta continuation as nested pairs versus a source-emulated checked named product versus a boundary kind check, with failure, forgery, size, and reference-interpreter cost observations. | Delete when the board item is decided and its evidence is retained elsewhere. |
