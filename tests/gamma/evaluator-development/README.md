...
```text
1,472-line / 33,857-byte symbolic addressed-Beta source
81-line / 2,070-byte test-only label resolver
1,472-line / 41,536-byte canonical addressed Beta with named control targets
8,119-byte evaluator tape
```
...
the direct candidate is 1,472 Beta lines versus 2,337 lines across the former
