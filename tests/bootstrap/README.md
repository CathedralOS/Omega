...
| --- | --- | --- |
| `alpha-beta-edge.sh` | Checks the selected Alpha seed, Alpha conformance, and exact trusted Beta compiler reconstruction. | Delete only when a stronger Alpha-to-Beta edge gate subsumes all three observations. |
