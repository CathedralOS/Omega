...
const CONSOLE_BUILD_PROGRAM: &str = r#"use omega::language::core::service;
use omega::language::std::console;
// Granted-build console probe.
...
const BEEPER_BUILD_PROGRAM: &str = r#"use omega::language::core::service;
// Granted-build unsupported-boundary probe.
pub boundary trait Beeper { machine beep(count: i32); }
