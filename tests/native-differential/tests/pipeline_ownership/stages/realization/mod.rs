//! Optimizer module role: stage group. Function-relative, structural-Unit, and callable-entry tests.

mod call_site_alignment;
mod callable_entry;
...
mod runtime_signed_integer_less_or_equal_conditional;
