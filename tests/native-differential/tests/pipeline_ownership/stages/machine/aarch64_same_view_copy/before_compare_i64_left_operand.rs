use crate::tests::*;
use post_allocation_machine_to_post_allocation_machine::Aarch64SameViewCopyElisionPolicy;
...
fn exact_selection_is_deterministic_and_retains_distinct_policy_custody() {
    ...
    let StagedOptimizedPostAllocationMachineOptimization::Aarch64SameViewCopyElision(elision) =
        ...
        panic!("the exact before-compare-left selection must retain same-view-copy custody")
    };
    assert_eq!(
