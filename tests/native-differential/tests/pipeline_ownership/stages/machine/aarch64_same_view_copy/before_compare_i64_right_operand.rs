...
const RULE: Optimization = Optimization::Aarch64ElideSameViewCopyI64BeforeCompareI64RightOperandV1;
...
fn exact_selection_is_deterministic_and_retains_distinct_policy_custody() {
    ...
    let StagedOptimizedPostAllocationMachineOptimization::Aarch64SameViewCopyElision(elision) =
        ...
        panic!("the exact before-compare-right selection must retain same-view-copy custody")
    };
    assert_eq!(
