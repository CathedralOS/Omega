...
fn two_explicit_u12_exact_add_folds_close_one_view_pressure_on_both_architectures() {
    for (target, sole_view_name) in [
        ...
        let homes = selected_instructions_to_register_homes::assign_register_homes(
            &legality_two,
            &ranges_two,
            environment.identity(),
            environment.physical(),
        ...
        let staged_environment = staged_folds
            ...
            .register_environment();
        assert!(matches!(
            selected_instructions_to_register_homes::assign_register_homes(
        ...
        let retained =
            selected_instructions_to_register_homes::RetainedAllocation::try_from(staged_homes)
                .unwrap();
