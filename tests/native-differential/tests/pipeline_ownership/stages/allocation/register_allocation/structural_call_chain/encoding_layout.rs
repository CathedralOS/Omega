...
use crate::tests::{
    ...
    STRUCTURAL_CALL_PRESERVING_CALLEE_BASE, SelectedFormEncodingState,
...
#[test]
fn structural_call_template_and_layout_corruption_fail_independent_replay() {
    for target in [
        ...
        for mutation in 0..6 {
            ...
            match mutation {
                ...
                1 => {
                    fixup.callee =
                        MachineId::new(STRUCTURAL_CALL_PRESERVING_CALLEE_BASE + 2).unwrap()
                }
