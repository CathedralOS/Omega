...
use crate::tests::{
    ...
    canonical_artifact, stage_fixed_frame_function_relative_realization,
    ...
    stage_validated_optimized_object_artifact, structural_call_preserving_artifact,
    validate_optimized_object_artifact, validate_optimized_relocation_free_object_container,
};

use super::fixture::staged_homes;

fn planned_frame_count(fragments: &StagedOptimizedFunctionFragmentEmission) -> usize {
...
#[test]
fn structural_call_fixed_frames_reach_object_artifacts_on_both_isas() {
...
#[test]
fn structural_call_object_entrance_rejects_corrupt_fixed_frame_custody() {
