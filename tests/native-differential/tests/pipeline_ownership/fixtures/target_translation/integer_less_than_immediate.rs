//! Real Terminal fixture for constant integer less-than materialization custody.

use super::*;

pub(crate) fn integer_less_than_immediate_return_artifact(
    scalar_type: IntegerType,
    left_value: IntegerValue,
    right_value: IntegerValue,
) -> (Vec<u8>, Vec<u8>) {
    let machine = MachineId::new(71_001).unwrap();
    let entry = BlockId::new(71_002).unwrap();
    let left = ValueId::new(71_004).unwrap();
        ...
        machines: vec![TerminalMachine {
            ...
            blocks: vec![Block {
                ...
                terminator: Terminator::Return {
                    edge: EdgeId::new(71_009).unwrap(),
                    value: less_than,
                    cleanup_actions: Vec::new(),
                },
            }],
            contract: MachineContract {
                id: ContractId::new(71_011).unwrap(),
