//! Real Terminal fixture for constant wrapping integer shift-right materialization custody.

use super::super::*;

pub(crate) fn wrapping_integer_shift_right_immediate_return_artifact(
