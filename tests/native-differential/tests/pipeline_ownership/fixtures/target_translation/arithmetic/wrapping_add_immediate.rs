//! Real Terminal fixture for constant integer wrapping integer addition materialization custody.

use super::super::*;

pub(crate) fn wrapping_integer_add_immediate_return_artifact(
    ...
    let wrapping_add = ValueId::new(73_008).unwrap();
