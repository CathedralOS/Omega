//! Real Terminal fixture for constant integer bitwise-OR materialization custody.

use super::super::*;

pub(crate) fn integer_bitwise_or_immediate_return_artifact(
    scalar_type: IntegerType,
    left_value: IntegerValue,
    right_value: IntegerValue,
) -> (Vec<u8>, Vec<u8>) {
    let machine = MachineId::new(78_001).unwrap();
    let entry = BlockId::new(78_002).unwrap();
    let left = ValueId::new(78_004).unwrap();
            ...
            blocks: vec![Block {
                ...
                operations: vec![
                    ...
                    Operation {
                        ...
                        kind: OperationKind::IntegerBitwiseOr { left, right },
                    },
                ],
                terminator: Terminator::Return {
                    edge: EdgeId::new(78_009).unwrap(),
                    value: bitwise_or,
                    cleanup_actions: Vec::new(),
                },
            }],
            contract: MachineContract {
                id: ContractId::new(78_011).unwrap(),
