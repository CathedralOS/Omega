use crate::tests::{
    ...
    ExplicitOptimizationRequest, IntegerSign, IntegerType, IntegerValue, MachineId, NativeTarget,
    ObligationId, OperationId, Optimization, OptimizationPipelineError,
    OptimizationPipelineRequest, OptimizationRunError, OptimizationSelections,
    OptimizationWorkBudget, OptimizedTargetLoweringRequest, ValueId, adjacent_block_merge_artifact,
    adjacent_conditional_merge_artifact, artifact, budget, compiler_baseline_request_v1,
