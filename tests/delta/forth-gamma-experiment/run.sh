...
LEGACY_COMPILER="$OMEGA_PATH_CONCATENATIVE_DELTA_COMPILER_SOURCE"
...
functional_compiler_lines=1821
functional_compiler_definitions=156
functional_compiler_lets=578'
