...
functional Delta compiler      1,457 source lines, 131 definitions
Forth-Gamma Delta compiler      1,451 source lines, 555 definitions

total functional route         2,782 authored lines
...
remaining dynamic cell operations. The functional compiler contains 427 named
...
uniqueness census plus lexical-scope validation that the retained Forth
compiler lacks.
