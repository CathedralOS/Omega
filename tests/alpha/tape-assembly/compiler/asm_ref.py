#!/usr/bin/env python3
# asm_ref.py - an INDEPENDENT reference assembler: Alpha Tape Assembly text (stdin) -> raw bytecode tape (stdout),
# written from ../LANGUAGE.md + the 21-opcode encoding, NOT ported from assembler.alphaasm.
#
# WHY THIS EXISTS - executable reference and regression coverage for the Alpha
# assembly encoding. asm-diamond.sh assembles real programs with the canonical
