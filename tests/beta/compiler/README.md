...
arm64, Linux x86-64, or from Git Bash on Windows x64 with Python 3 available as `python3`.
...
published tape. `register-address-regression.sh` runs on seed hosts (macOS arm64, Linux x86-64, or Git Bash on Windows x64; other hosts refuse)
