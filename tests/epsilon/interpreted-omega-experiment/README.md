...
the Delta-written Epsilon implementation. The evaluator is currently 9,835
lines / 492,367 bytes.
...
The exact evaluator plus eight-line driver compiles to a 580,445-byte Gamma
receipt. Forty-five retained controls cover
...
return/Console continuations, and a 1,024-transfer countdown. The explicit
