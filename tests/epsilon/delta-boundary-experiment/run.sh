...
expect_metric 'source_lines=8658'
expect_metric 'top_level_forms=666'
expect_metric 'data_forms=148'
expect_metric 'definition_forms=518'
...
expect_metric 'combined_gross_ceiling_per_mille=97'
