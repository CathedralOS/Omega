...
expect_metric 'source_lines=9108'
expect_metric 'top_level_forms=695'
expect_metric 'data_forms=153'
expect_metric 'definition_forms=542'
...
expect_metric 'recursive_list_forms=25'
expect_metric 'recursive_list_lines=82'
expect_metric 'recursive_list_shapes=0/2:25'
expect_metric 'ordinary_list_forms=25'
expect_metric 'ordinary_list_lines=82'
...
expect_metric 'generic_list_gross_ceiling_lines=263'
expect_metric 'exact_list_family_forms=50'
expect_metric 'exact_list_family_lines=249'
expect_metric 'exact_list_family_bytes=11579'
...
expect_metric 'combined_gross_ceiling_lines=848'
expect_metric 'combined_gross_ceiling_per_mille=93'
...
list_artifacts = {
    ...
    "list_family.delta-plus": (25, 3605, "dee9bbe25f9e9585629949e43ee750cb181cf31620e55e8e65785dd55ccd9fe0"),
...
if status != 0 or len(family_expansion) != 10876:
    raise SystemExit("derived Epsilon list family did not expand")
if hashlib.sha256(family_expansion).hexdigest() != "99b879172a0862feba62f3c35c223d49592e675c900c60eaac76e09bdf958d64":
