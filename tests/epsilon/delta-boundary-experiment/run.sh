...
expect_metric 'source_lines=11984'
expect_metric 'top_level_forms=906'
expect_metric 'data_forms=186'
expect_metric 'definition_forms=720'
...
expect_metric 'recursive_list_forms=31'
expect_metric 'recursive_list_lines=102'
expect_metric 'recursive_list_shapes=0/2:27,0/3:4'
...
expect_metric 'generic_list_gross_ceiling_lines=283'
...
expect_metric 'combined_gross_ceiling_lines=872'
expect_metric 'combined_gross_ceiling_per_mille=72'
