...
expect_metric 'source_lines=8794'
expect_metric 'top_level_forms=673'
expect_metric 'data_forms=150'
expect_metric 'definition_forms=523'
...
expect_metric 'recursive_list_forms=24'
expect_metric 'recursive_list_lines=78'
expect_metric 'recursive_list_shapes=0/2:24'
expect_metric 'ordinary_list_forms=24'
expect_metric 'ordinary_list_lines=78'
...
expect_metric 'generic_list_gross_ceiling_lines=259'
expect_metric 'exact_list_family_forms=49'
expect_metric 'exact_list_family_lines=245'
expect_metric 'exact_list_family_bytes=11409'
...
expect_metric 'combined_gross_ceiling_lines=844'
expect_metric 'combined_gross_ceiling_per_mille=95'
...
list_artifacts = {
    ...
    "list_family.delta-plus": (24, 3474, "9af1c9b2c7d7041c1f787631711b8870392cbdc9868cc44f8f46572b5afed43c"),
...
if status != 0 or len(family_expansion) != 10714:
    raise SystemExit("derived Epsilon list family did not expand")
if hashlib.sha256(family_expansion).hexdigest() != "7fe29c58138198bd54fe1a1214f288a8262a2cc3f5c25bd0c4aba4cf263cbac8":
...
if wanted != actual or len(actual) != 49:
