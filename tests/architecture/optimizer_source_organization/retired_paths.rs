...
pub(crate) fn check(audit: &mut Audit) {
    ...
    for obsolete in [
        ...
        "omega-rust/omega/pipeline/optimization/omega-optimization-validation/src/candidates/sparse_conditional_constant_propagation/candidate_validation.rs",
        "omega-rust/omega/pipeline/optimization/omega-optimization-validation/src/candidates/sparse_conditional_constant_propagation/boolean_evaluation/integer_comparisons.rs",
        "omega-rust/omega/pipeline/optimization/omega-optimization-validation/src/candidates/sparse_conditional_constant_propagation/range_comparisons.rs",
        ...
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/control_flow_cleanup/block_merging.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/control_flow_cleanup/empty_block_threading.rs",
        "omega-rust/omega/pipeline/optimization/omega-optimization-validation/src/candidates/control_flow_cleanup/block_merging.rs",
        "omega-rust/omega/pipeline/optimization/omega-optimization-validation/src/candidates/control_flow_cleanup/empty_block_threading.rs",
        "omega-rust/omega/pipeline/optimization/omega-optimization-validation/src/candidates/control_flow_cleanup/constant_conditionals.rs",
        "omega-rust/omega/pipeline/optimization/omega-optimization-validation/src/candidates/control_flow_cleanup/shared_jump_fusion.rs",
        "omega-rust/omega/pipeline/optimization/omega-optimization-validation/src/candidates/control_flow_cleanup/unreachable_private_machines.rs",
        "omega-rust/omega/pipeline/optimization/omega-optimization-validation/src/candidates/control_flow_cleanup/empty_block_threading/linear.rs",
        "omega-rust/omega/pipeline/optimization/omega-optimization-validation/src/candidates/control_flow_cleanup/empty_block_threading/path_qualified.rs",
        "omega-rust/omega/pipeline/optimization/omega-optimization-validation/src/candidates/control_flow_cleanup/block_merging/adjacent.rs",
        "omega-rust/omega/pipeline/optimization/omega-optimization-validation/src/candidates/control_flow_cleanup/block_merging/non_adjacent.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/global_value_numbering/accounting.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/proof_check_elision/identity_rewrite.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/dead_scalar_elimination/proof_certified/mod.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/dead_scalar_elimination/family.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/dead_scalar_elimination/proposal.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/dead_scalar_elimination/shapes.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/dead_scalar_elimination/accounting.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/sparse_conditional_constant_propagation/constant_evaluation/boolean.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/sparse_conditional_constant_propagation/constant_evaluation/integer/cast.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/sparse_conditional_constant_propagation/constant_evaluation/integer/unary.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/sparse_conditional_constant_propagation/constant_evaluation/integer/binary/arithmetic.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/sparse_conditional_constant_propagation/constant_evaluation/integer/binary/quotient.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/sparse_conditional_constant_propagation/constant_evaluation/integer/binary/shifts.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/sparse_conditional_constant_propagation/constant_evaluation/integer/binary/bitwise.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/sparse_conditional_constant_propagation/range_comparisons.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/tests/sparse_conditional_constant_propagation.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/tests/sparse_conditional_constant_propagation/constant_evaluation.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/tests/sparse_conditional_constant_propagation/constant_evaluation/integer.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/tests/global_value_numbering/identities.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/tests/global_value_numbering/multiply_zero.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/tests/global_value_numbering/saturating_neutral.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/tests/global_value_numbering/saturating_multiply_zero.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/tests/global_value_numbering/bitwise_neutral.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/tests/global_value_numbering/bitwise_absorbing.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/tests/global_value_numbering/same_block.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/tests/global_value_numbering/dominating.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/tests/global_value_numbering/phi_translated.rs",
    ...
    for obsolete in [
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/global_value_numbering/identities/rule.rs",
        "omega-rust/omega/pipeline/optimization/omega-psi-optimizer/src/rules/passes/global_value_numbering/identities/shapes.rs",
    ] {
        if repository.join(obsolete).exists() {
            violations.insert(format!(
