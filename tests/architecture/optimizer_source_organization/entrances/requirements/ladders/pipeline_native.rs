...
pub(crate) const LADDERS: &[SemanticLadder] = &[
    ...
    SemanticLadder {
        ...
        paths: &[
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/stages/realization/function_relative_realization/codec/mod.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/stages/realization/function_relative_realization/codec/encoding.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/stages/realization/function_relative_realization/codec/decoding.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/stages/realization/function_relative_realization/codec/post_allocation.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/stages/realization/function_relative_realization/codec/target.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/stages/realization/function_relative_realization/codec/rendering.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/stages/realization/function_relative_realization/codec/cursor.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/stages/realization/function_relative_realization/codec/error.rs",
        ],
    },
    SemanticLadder {
        family: "function-relative realization mutation tests",
        paths: &[
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/tests/stages/realization/function_relative_manifest_mutation_matrix/mod.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/tests/stages/realization/function_relative_manifest_mutation_matrix/fixture.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/tests/stages/realization/function_relative_manifest_mutation_matrix/manifest_fields.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/tests/stages/realization/function_relative_manifest_mutation_matrix/manifest_wire.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/tests/stages/realization/function_relative_manifest_mutation_matrix/wire_offsets.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/tests/stages/realization/function_relative_manifest_mutation_matrix/custody.rs",
        ],
    },
    SemanticLadder {
        family: "hosted post-allocation publication matrix",
        paths: &[
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/tests/stages/artifacts/output_artifacts/function_fragment_emission/post_allocation_machine/mod.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/tests/stages/artifacts/output_artifacts/function_fragment_emission/post_allocation_machine/cases.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/tests/stages/artifacts/output_artifacts/function_fragment_emission/post_allocation_machine/realization.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/tests/stages/artifacts/output_artifacts/function_fragment_emission/post_allocation_machine/artifacts.rs",
            "omega-rust/omega/pipeline/omega-optimization-pipeline/src/tests/stages/artifacts/output_artifacts/function_fragment_emission/post_allocation_machine/refusals.rs",
        ],
    },
    SemanticLadder {
