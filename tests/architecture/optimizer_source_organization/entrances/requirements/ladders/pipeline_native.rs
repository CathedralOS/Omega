...
pub(crate) const LADDERS: &[SemanticLadder] = &[
    ...
    SemanticLadder {
        ...
        paths: &[
            "omega-rust/omega/backend/omega-machine-emission/src/function_realization/codec/mod.rs",
            "omega-rust/omega/backend/omega-machine-emission/src/function_realization/codec/encoding.rs",
            "omega-rust/omega/backend/omega-machine-emission/src/function_realization/codec/decoding.rs",
            "omega-rust/omega/backend/omega-machine-emission/src/function_realization/codec/post_allocation.rs",
            "omega-rust/omega/backend/omega-machine-emission/src/function_realization/codec/target.rs",
            "omega-rust/omega/backend/omega-machine-emission/src/function_realization/codec/rendering.rs",
            "omega-rust/omega/backend/omega-machine-emission/src/function_realization/codec/cursor.rs",
            "omega-rust/omega/backend/omega-machine-emission/src/function_realization/codec/error.rs",
        ],
    },
    SemanticLadder {
    ...
    SemanticLadder {
        ...
        paths: &[
            ...
            "omega-rust/omega/pipeline/omega-terminal-psi-to-native-artifact/src/native_pipeline/physical_pipeline/routes/composition/tests/wrong_architecture.rs",
        ],
    },
    SemanticLadder {
