...
pub(super) const PRODUCTION: SemanticLadder = SemanticLadder {
    ...
    paths: &[
        ...
        "omega-rust/omega/backend/machine-emission/src/frame_layout/save_storage/validation.rs",
        "omega-rust/omega/backend/machine-emission/src/frame_layout/save_storage/compute/mod.rs",
        "omega-rust/omega/backend/machine-emission/src/frame_layout/save_storage/compute/groups.rs",
        "omega-rust/omega/backend/machine-emission/src/frame_layout/save_storage/compute/work.rs",
        "omega-rust/omega/backend/machine-emission/src/frame_layout/save_storage/replay/mod.rs",
        "omega-rust/omega/backend/machine-emission/src/frame_layout/save_storage/replay/groups.rs",
        "omega-rust/omega/backend/machine-emission/src/frame_layout/save_storage/replay/work.rs",
    ],
};
