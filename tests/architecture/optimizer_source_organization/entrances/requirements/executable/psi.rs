...
pub(crate) const ENTRANCES: &[RequiredCoordinationEntrance] = &[
    ...
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/pass_manager/external_policy/mod.rs",
        coordination_marker: "pub(super) fn validated_candidate_features",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/ranked_rewrites/countdown_invariant_constant_relocation/mod.rs",
        coordination_marker: "apply::validated(session, validated)",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/ranked_rewrites/loop_invariant_scalar_motion/mod.rs",
        coordination_marker: "apply::validated(session, validated)",
    },
    RequiredCoordinationEntrance {
    ...
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/control_flow_cleanup.rs",
        coordination_marker: "fn built_in_registrations",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/copy_propagation.rs",
        coordination_marker: "fn built_in_registrations",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/copy_propagation/redundant_block_parameter.rs",
    ...
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/dead_scalar_elimination.rs",
        coordination_marker: "fn built_in_registrations",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/dead_scalar_elimination/dead_scalar_literal_elimination.rs",
        coordination_marker: "fn propose(",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/dead_scalar_elimination/dead_unconditionally_total_scalar_elimination.rs",
        coordination_marker: "fn propose(",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/proof_check_elision/proof_certified_dead_scalar_elimination.rs",
        coordination_marker: "fn propose(",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/global_value_numbering.rs",
        coordination_marker: "fn built_in_registrations",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/proof_check_elision.rs",
        coordination_marker: "fn built_in_registrations",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/sparse_conditional_constant_propagation.rs",
        coordination_marker: "fn built_in_registrations",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/sparse_conditional_constant_propagation/boolean_constants.rs",
        coordination_marker: "fn propose(",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/sparse_conditional_constant_propagation/boolean_constants.rs",
    ...
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/sparse_conditional_constant_propagation/integer_binary_constants.rs",
        coordination_marker: "fn propose(",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/sparse_conditional_constant_propagation/integer_binary_constants.rs",
    ...
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/sparse_conditional_constant_propagation/integer_cast_constants.rs",
        coordination_marker: "fn propose(",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/sparse_conditional_constant_propagation/integer_unary_constants.rs",
        coordination_marker: "fn propose(",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/sparse_conditional_constant_propagation/integer_unary_constants.rs",
    ...
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/sparse_conditional_constant_propagation/range_against_constant.rs",
        coordination_marker: "fn propose(",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/sparse_conditional_constant_propagation/range_against_constant.rs",
    ...
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/sparse_conditional_constant_propagation/range_against_range.rs",
        coordination_marker: "fn propose(",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/rules/sparse_conditional_constant_propagation/range_against_range.rs",
    ...
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/validation/prephysical_manifest/mod.rs",
    ...
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/analyses/semantic/value_ranges/mod.rs",
        coordination_marker: "pub(in crate::analyses) fn value_ranges",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/analyses/control_flow/countdown_induction/mod.rs",
        coordination_marker: "pub(crate) fn analyze_counted_loops",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/analyses/control_flow/countdown_invariant_constants/mod.rs",
        coordination_marker: "pub(crate) fn analyze_countdown_invariant_constants",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/analyses/control_flow/countdown_invariant_constant_placement/mod.rs",
    ...
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/validation/context/mod.rs",
        coordination_marker: "fn validate_psi_optimization_unit_with_context",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/validation/context/ranked_cycles/mod.rs",
        coordination_marker: "fn validate_exact_ranked_cycles",
    },
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/validation/context/ranked_cycles/countdown_ranking/mod.rs",
    ...
    RequiredCoordinationEntrance {
        path: "omega-rust/omega/pipeline/04_abstract-operations-to-abstract-operations/src/validation/projection/mod.rs",
