...
pub(crate) const ENTRANCES: &[RequiredCoordinationEntrance] = &[
    ...
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-regalloc/src/allocation/fixed_precolored_segment_homes/mod.rs",
    ...
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-regalloc/src/allocation/spill_recovery_choice/mod.rs",
        coordination_marker: "pub fn choose_spill_recovery_victims",
    },
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-regalloc/src/allocation/spill_recovery_actions/mod.rs",
        coordination_marker: "pub fn plan_spill_recovery_actions",
    },
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-regalloc/src/allocation/generalized_spill_insertion/mod.rs",
        coordination_marker: "pub fn schedule_generalized_spill_insertion",
    },
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-regalloc/src/allocation/generalized_reload_value_homes/mod.rs",
        coordination_marker: "pub fn assign_generalized_reload_value_homes",
    },
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-regalloc/src/allocation/generalized_spill_recovery_worklist/mod.rs",
        coordination_marker: "pub fn seed_generalized_spill_recovery_worklist",
    },
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-regalloc/src/allocation/generalized_spill_recovery_choice/mod.rs",
    ...
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-regalloc/src/allocation/recursive_spill_insertion/mod.rs",
    ...
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-regalloc/src/allocation/spill_pseudo_instructions/homed/mod.rs",
    ...
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-regalloc/src/allocation/abstract_spill_access_constraints/mod.rs",
        coordination_marker: "pub fn constrain_abstract_spill_accesses",
    },
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-optimization-pipeline/src/stages/allocation/callee_saved_requirements/mod.rs",
    ...
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-regalloc/src/analyses/fixed_precolored_intervals/mod.rs",
