...
pub(crate) const ENTRANCES: &[RequiredCoordinationEntrance] = &[
    ...
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-machine-optimizer/src/rules/aarch64/elide_same_view_copy_before_return/mod.rs",
    ...
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-machine-optimizer/src/rules/aarch64/elide_same_view_copy_before_compare_i64_left_operand/mod.rs",
        coordination_marker: "pub fn optimize_aarch64_same_view_copy_i64_before_compare_i64_left_operand",
    },
    RequiredCoordinationEntrance {
        path: "source/omega-rust/omega/pipeline/optimization/omega-machine-optimizer/src/rules/aarch64/elide_same_view_copy_before_compare_i64_left_operand/validate.rs",
