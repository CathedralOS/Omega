...
pub(super) const RULE_STAGES: &[RuleStageDescriptor] = &[
    ...
    RuleStageDescriptor {
        entrance: "omega-rust/omega/pipeline/07_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/mod.rs",
        catalog: "omega-rust/omega/pipeline/07_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/catalog.rs",
        coordination_marker: "pub fn resolve_selected_lowering_rules",
        catalog_marker: "SELECTED_LOWERING_RULE_CATALOG",
        next_rungs: &[
            "omega-rust/omega/pipeline/07_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold",
        ],
        output_marker: "resolve_selected_lowering_rules",
        consumers: &[
            "omega-rust/omega/pipeline/07_selected-instructions-to-selected-instructions/src/rewrites/literal_folds/mod.rs",
        ],
    },
    RuleStageDescriptor {
        entrance: "omega-rust/omega/pipeline/07_selected-instructions-to-selected-instructions/src/rewrites/pre_allocation.rs",
        catalog: "omega-rust/omega/pipeline/07_selected-instructions-to-selected-instructions/src/rewrites/pre_allocation/catalog.rs",
        coordination_marker: "pub fn resolve_pre_allocation_rules",
        catalog_marker: "PRE_ALLOCATION_RULE_CATALOG",
        next_rungs: &[
            "omega-rust/omega/pipeline/07_selected-instructions-to-selected-instructions/src/rewrites/copy_removal",
        ],
        output_marker: "run_pre_allocation_optimizations",
        consumers: &[
            "omega-rust/omega/pipeline/07_selected-instructions-to-selected-instructions/src/selected_optimization.rs",
        ],
    },
    RuleStageDescriptor {
        entrance: "omega-rust/omega/pipeline/07_selected-instructions-to-selected-instructions/src/rewrites/allocation_recovery/mod.rs",
        catalog: "omega-rust/omega/pipeline/07_selected-instructions-to-selected-instructions/src/rewrites/allocation_recovery/catalog.rs",
        ...
        next_rungs: &[
            ...
            "omega-rust/omega/pipeline/07_selected-instructions-to-selected-instructions/src/rewrites/allocation_recovery/pressure_rematerialization",
        ],
