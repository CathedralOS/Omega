...
const GOVERNED_ROOTS: &[&str] = &[
    ...
    "omega-rust/omega/backend/omega-machine-emission/src/function_realization",
    "omega-rust/omega/backend/omega-machine-emission/src/fragment_emission",
    "omega-rust/omega/backend/object/omega-object-file/src/fragment_container",
    "omega-rust/omega/backend/object/omega-object-file/src/artifact_custody",
    "omega-rust/omega/backend/artifacts/omega-native-artifact/src/callable_entry",
    ...
    "omega-rust/omega/pipeline/omega-post-allocation-machine-to-frame-layout",
    "omega-rust/omega/pipeline/omega-post-allocation-machine-to-selected-form-encoding",
    "omega-rust/omega/pipeline/omega-selected-form-encoding-to-resolved-layout",
...
pub(super) const RULE_STAGES: &[RuleStageDescriptor] = &[
    ...
    RuleStageDescriptor {
        entrance: "omega-rust/omega/pipeline/omega-selected-instructions-to-register-homes/src/rewrites/selected_lowering/mod.rs",
        catalog: "omega-rust/omega/pipeline/omega-selected-instructions-to-register-homes/src/rewrites/selected_lowering/catalog.rs",
        coordination_marker: "pub fn resolve_selected_lowering_rules",
        catalog_marker: "SELECTED_LOWERING_RULE_CATALOG",
        next_rungs: &[
            "omega-rust/omega/pipeline/omega-selected-instructions-to-register-homes/src/rewrites/selected_lowering/literal_fold",
        ],
    },
    RuleStageDescriptor {
        entrance: "omega-rust/omega/pipeline/omega-selected-instructions-to-register-homes/src/rewrites/allocation_recovery/mod.rs",
        catalog: "omega-rust/omega/pipeline/omega-selected-instructions-to-register-homes/src/rewrites/allocation_recovery/catalog.rs",
        ...
        next_rungs: &[
            ...
            "omega-rust/omega/pipeline/omega-selected-instructions-to-register-homes/src/rewrites/allocation_recovery/pressure_rematerialization",
        ],
    },
    RuleStageDescriptor {
    ...
    RuleStageDescriptor {
        entrance: "omega-rust/omega/pipeline/omega-selected-form-encoding-to-resolved-layout/src/x86_branch_relaxation/mod.rs",
        catalog: "omega-rust/omega/pipeline/omega-selected-form-encoding-to-resolved-layout/src/x86_branch_relaxation/catalog.rs",
        coordination_marker: "pub fn stage_optimized_x86_branch_relaxation",
        catalog_marker: "FUNCTION_RELATIVE_LAYOUT_RULE_CATALOG",
        next_rungs: &[
            "omega-rust/omega/pipeline/omega-selected-form-encoding-to-resolved-layout/src/x86_branch_relaxation/compute.rs",
            "omega-rust/omega/pipeline/omega-selected-form-encoding-to-resolved-layout/src/x86_branch_relaxation/validation.rs",
        ],
    },
];
