...
fn native_inventory_compact_coordinates_are_report_only_and_publication_keeps_the_digest() {
    ...
    for report_field in [
        ...
        "fragment_manifest_report_fingerprint: u64",
        "frame_application_report_fingerprint: u64",
    ...
    for ambiguous_field in [
        ...
        "pub fragment_manifest_fingerprint: u64",
        "pub frame_application_fingerprint: u64",
        "pub final_text_validation_fingerprint: u64",
    ...
    let publication = source("omega-rust/omega/compiler/src/report/executable_publication.rs");
    assert!(
