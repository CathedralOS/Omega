...
const FAMILIES: &[Family] = &[
    ...
    Family {
        ...
        domain: "omega.terminal-allocation-legality.v6",
    ...
    Family {
        ...
        domain: "omega.fixed-precolored-point-intervals.v2",
    ...
    Family {
        ...
        domain: "omega.fixed-precolored-split-requirements.v2",
    ...
    Family {
        ...
        domain: "omega.fixed-precolored-segment-homes.v2",
    ...
    Family {
        ...
        domain: "omega.terminal-recovery-classification.v7",
...
fn allocation_analysis_admission_stays_sealed_in_the_transform() {
    ...
    let stage = root.join(
        "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/analyses",
    );
    for family in FAMILIES {
        let model =
