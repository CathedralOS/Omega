...
const COVERAGE: &[RuleCoverage] = &[
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/01_abstract-operations-to-abstract-operations/src/pass_manager/tests/evidence_matrix/control_flow_cleanup.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/01_abstract-operations-to-abstract-operations/src/pass_manager/tests/evidence_matrix/sparse_conditional_constant_propagation.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/01_abstract-operations-to-abstract-operations/src/pass_manager/tests/evidence_matrix/copy_propagation.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/01_abstract-operations-to-abstract-operations/src/pass_manager/tests/evidence_matrix/global_value_numbering.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/01_abstract-operations-to-abstract-operations/src/pass_manager/tests/evidence_matrix/dead_pure_scalar_elimination.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/01_abstract-operations-to-abstract-operations/src/pass_manager/tests/evidence_matrix/proof_check_elision.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/01_abstract-operations-to-abstract-operations/src/pass_manager/tests/evidence_matrix/state_specialization.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/01_abstract-operations-to-abstract-operations/src/pass_manager/tests/evidence_matrix/representation_specialization.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/compare_subtract_add_folds.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/extension_and_copy_folds.rs",
    ...
    RuleCoverage {
        ...
        negative: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/load_and_byte_view_folds.rs",
    ...
    RuleCoverage {
        ...
        disabled: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/divide_and_remainder_folds.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/bitwise_and_zero_folds.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/bitwise_xor_zero_copies.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/wrapping_add_zero_copies.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/bitwise_and_ones_copies.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/saturating_add_zero_copies.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/saturating_subtract_zero_copies.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/saturating_divide_one_copies.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/saturating_divide_zero_dividend_materializations.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/saturating_subtract_zero_minuend_materializations.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/saturating_add_upper_bound_materializations.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/selected_lowering/literal_fold/tests/saturating_subtract_upper_bound_subtrahend_materializations.rs",
    ...
    RuleCoverage {
        rule: "SelectedSameBlockCopyI64RemovalV1",
        positive: covered(
            "tests/native-differential/tests/pipeline_ownership/stages/selection/pre_allocation.rs",
            "positive_removes_every_admissible_normalization_copy",
        ),
        negative: covered(
            "tests/native-differential/tests/pipeline_ownership/stages/selection/pre_allocation.rs",
        ...
        boundary: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/copy_removal/tests.rs",
    ...
    RuleCoverage {
        ...
        boundary: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/redundant_extension/tests.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/allocation_recovery/fixed_view_copy/compute/tests.rs",
        ...
        disabled: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/allocation_recovery/tests.rs",
        ...
        fixed_point: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/allocation_recovery/fixed_view_copy/validate/source_exit/tests.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/allocation_recovery/pressure_rematerialization/tests/multiple_use.rs",
        ...
        boundary: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/allocation_recovery/pressure_rematerialization/tests/sole_use.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/09_resolved-layout-to-resolved-layout/src/x86_branch_relaxation/compute/tests.rs",
    ...
    RuleCoverage {
        ...
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/runtime_rematerialization/tests.rs",
    ...
    RuleCoverage {
        rule: "runtime_spill",
        positive: covered(
            "omega-rust/omega/pipeline/04_selected-instructions-to-selected-instructions/src/rewrites/runtime_spill/tests.rs",
