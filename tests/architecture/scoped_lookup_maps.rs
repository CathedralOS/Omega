...
const JUSTIFIED_LOOKUP_MAP_FILES: &[(&str, &str)] = &[
    ...
    (
        "omega-rust/psi/pipeline/04_typed-trees-to-checked-trees/src/execution/terminal_unit/types/mod.rs",
        "one unit's type spellings bound to structural type plans",
    ),
    (
        "omega-rust/psi/pipeline/04_typed-trees-to-checked-trees/src/execution/terminal_unit/cleanup/partial_affine_cleanup.rs",
        "one unit's type spellings bound to structural type plans",
    ),
    (
        "omega-rust/psi/pipeline/04_typed-trees-to-checked-trees/src/execution/terminal_unit/cleanup/residuals.rs",
        "one unit's type spellings bound to structural type plans",
    ),
    (
        "omega-rust/psi/pipeline/04_typed-trees-to-checked-trees/src/execution/terminal_scalar/mod.rs",
        "one unit's type spellings bound to structural type plans",
    ),
