...
const ANCHOR_HEADER_EXCEPTIONS: &[(&str, usize)] = &[
    ...
    (
        "omega-rust/omega/backend/images/omega-image-pe/src/lib.rs",
        0,
    ),
    ("omega-rust/omega/backend/images/omega-image/src/lib.rs", 0),
    (
    ...
    (
        "omega-rust/omega/representations/omega-effects/src/lib.rs",
        0,
    ),
    (
    ...
    (
        "omega-rust/omega/tooling/omega-visualizations/src/lib.rs",
        0,
    ),
